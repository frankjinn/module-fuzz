...
void Vtb___024root___eval_act(Vtb___024root* vlSelf) {
    ...
    if ((0xccc18ULL & vlSelfRef.__VactTriggered.word(0U))) {
        Vtb___024root___act_comb__TOP__1(vlSelf);
    }
    if ((0xccc38ULL & vlSelfRef.__VactTriggered.word(0U))) {
        Vtb___024root___act_comb__TOP__2(vlSelf);
    }
    if ((0xcee38ULL & vlSelfRef.__VactTriggered.word(0U))) {
        Vtb___024root___act_comb__TOP__3(vlSelf);
    }
    if ((0xcfef8ULL & vlSelfRef.__VactTriggered.word(0U))) {
        Vtb___024root___act_comb__TOP__4(vlSelf);
    }
    if ((0xcff38ULL & vlSelfRef.__VactTriggered.word(0U))) {
        Vtb___024root___act_comb__TOP__5(vlSelf);
    }
    if ((0xcee78ULL & vlSelfRef.__VactTriggered.word(0U))) {
        Vtb___024root___act_comb__TOP__6(vlSelf);
    }
    if ((0xcff78ULL & vlSelfRef.__VactTriggered.word(0U))) {
        Vtb___024root___act_comb__TOP__7(vlSelf);
    }
    if ((0xcff7cULL & vlSelfRef.__VactTriggered.word(0U))) {
        Vtb___024root___act_comb__TOP__8(vlSelf);
    }
    if ((0xcff7aULL & vlSelfRef.__VactTriggered.word(0U))) {
        Vtb___024root___act_comb__TOP__9(vlSelf);
    }
    if ((0xcff7eULL & vlSelfRef.__VactTriggered.word(0U))) {
        Vtb___024root___act_comb__TOP__10(vlSelf);
    }
    if ((0xcff7bULL & vlSelfRef.__VactTriggered.word(0U))) {
        Vtb___024root___act_comb__TOP__11(vlSelf);
    }
    if ((0xcfffbULL & vlSelfRef.__VactTriggered.word(0U))) {
        Vtb___024root___act_comb__TOP__12(vlSelf);
    }
    if ((0xcffffULL & vlSelfRef.__VactTriggered.word(0U))) {
...
void Vtb___024root___eval_nba(Vtb___024root* vlSelf) {
    ...
    if ((0xf0228ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
    ...
    if ((0xf037cULL & vlSelfRef.__VnbaTriggered.word(0U))) {
    ...
    if ((0xf037bULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vtb___024root___nba_comb__TOP__13(vlSelf);
    }
    if ((0xf03fbULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vtb___024root___act_comb__TOP__12(vlSelf);
    }
    if ((0xf03ffULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vtb___024root___act_comb__TOP__13(vlSelf);
    }
}
...
void Vtb___024root___timing_commit(Vtb___024root* vlSelf) {
    ...
    if ((! (0x80000ULL & vlSelfRef.__VactTriggered.word(0U)))) {
        vlSelfRef.__VtrigSched_h3f6eaf1d__0.commit(
                                                   "@(posedge tb.clk)");
    }
}
...
void Vtb___024root___timing_resume(Vtb___024root* vlSelf) {
    ...
    // Body
    if ((0x80000ULL & vlSelfRef.__VactTriggered.word(0U))) {
        vlSelfRef.__VtrigSched_h3f6eaf1d__0.resume(
                                                   "@(posedge tb.clk)");
    }
