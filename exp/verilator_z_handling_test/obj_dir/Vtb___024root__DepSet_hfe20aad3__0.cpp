...
VL_INLINE_OPT VlCoroutine Vtb___024root___eval_initial__TOP__Vtiming__0(Vtb___024root* vlSelf) {
    ...
    VL_WRITEF_NX("|    0 | %b | %b |\n",0,6,vlSelfRef.tb__DOT__in_flat,
                 8,((((0x80U & ((IData)(vlSelfRef.tb__DOT__dut__DOT__adder_wrapper_out_flat) 
                                << 7U)) | (0x40U & 
                                           (((1U & (IData)(vlSelfRef.tb__DOT__dut__DOT__adder_wrapper_out_flat)) 
                                             * (IData)(vlSelfRef.tb__DOT__dut__DOT__u_multiplier_wrapper__DOT__b)) 
                                            << 6U))) 
                     | ((0x20U & (((1U & (IData)(vlSelfRef.tb__DOT__dut__DOT__adder_wrapper_out_flat)) 
                                   * (IData)(vlSelfRef.tb__DOT__dut__DOT__u_multiplier_wrapper__DOT__b)) 
                                  << 4U)) | (0x10U 
                                             & ((IData)(vlSelfRef.tb__DOT__dut__DOT__adder_wrapper_out_flat) 
                                                << 3U)))) 
                    | ((0xcU & (((1U & (IData)(vlSelfRef.tb__DOT__dut__DOT__adder_wrapper_out_flat)) 
                                 * (IData)(vlSelfRef.tb__DOT__dut__DOT__u_multiplier_wrapper__DOT__b)) 
                                >> 1U)) | ((2U & ((IData)(vlSelfRef.tb__DOT__dut__DOT__adder_wrapper_out_flat) 
                                                  >> 1U)) 
                                           | (1U & 
                                              (((1U 
                                                 & (IData)(vlSelfRef.tb__DOT__dut__DOT__adder_wrapper_out_flat)) 
    ...
    if (((1U & (~ (IData)(vlSelfRef.tb__DOT__out_flat__en))) 
         && (1U & (~ (1U & (((1U & (IData)(vlSelfRef.tb__DOT__dut__DOT__adder_wrapper_out_flat)) 
                             * (IData)(vlSelfRef.tb__DOT__dut__DOT__u_multiplier_wrapper__DOT__b)) 
                            >> 2U)))))) {
    ...
    if (((1U & (~ ((IData)(vlSelfRef.tb__DOT__out_flat__en) 
                   >> 1U))) && (1U & (~ ((IData)(vlSelfRef.tb__DOT__dut__DOT__adder_wrapper_out_flat) 
                                         >> 2U))))) {
        tb__DOT__z_count = ((IData)(1U) + tb__DOT__z_count);
    } else {
        tb__DOT__normal_count = ((IData)(1U) + tb__DOT__normal_count);
    ...
    if (((1U & (~ ((IData)(vlSelfRef.tb__DOT__out_flat__en) 
                   >> 4U))) && (1U & (~ ((IData)(vlSelfRef.tb__DOT__dut__DOT__adder_wrapper_out_flat) 
                                         >> 1U))))) {
        tb__DOT__z_count = ((IData)(1U) + tb__DOT__z_count);
    } else {
        tb__DOT__normal_count = ((IData)(1U) + tb__DOT__normal_count);
    ...
    if (((1U & (~ ((IData)(vlSelfRef.tb__DOT__out_flat__en) 
                   >> 7U))) && (1U & (~ (IData)(vlSelfRef.tb__DOT__dut__DOT__adder_wrapper_out_flat))))) {
        tb__DOT__z_count = ((IData)(1U) + tb__DOT__z_count);
    } else {
        tb__DOT__normal_count = ((IData)(1U) + tb__DOT__normal_count);
    }
