...
assign bitwise_logic_wrapper_in_flat[6] = in_flat[33];
assign bitwise_logic_wrapper_in_flat[7] = in_flat[34];
assign bitwise_logic_wrapper_in_flat[8] = in_flat[35];
assign bitwise_logic_wrapper_in_flat[9] = in_flat[36];
assign bitwise_logic_wrapper_in_flat[10] = in_flat[37];
assign bitwise_logic_wrapper_in_flat[11] = in_flat[38];
assign bitwise_logic_wrapper_in_flat[12] = in_flat[39];
assign bitwise_logic_wrapper_in_flat[14] = in_flat[40];
assign bitwise_logic_wrapper_in_flat[15] = in_flat[41];
assign bitwise_reduce_wrapper_in_flat[1] = in_flat[42];
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[43];
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[44];
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[45];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[46];
assign cast_wrapper_in_flat[1] = in_flat[47];
assign cast_wrapper_in_flat[2] = in_flat[48];
assign cast_wrapper_in_flat[3] = in_flat[49];
assign cast_wrapper_in_flat[5] = in_flat[50];
assign cast_wrapper_in_flat[6] = in_flat[51];
assign cast_wrapper_in_flat[7] = in_flat[52];
assign cast_wrapper_in_flat[8] = in_flat[53];
assign cast_wrapper_in_flat[9] = in_flat[54];
assign cast_wrapper_in_flat[10] = in_flat[55];
assign cast_wrapper_in_flat[11] = in_flat[56];
assign conditional_wrapper_in_flat[0] = in_flat[57];
assign conditional_wrapper_in_flat[2] = in_flat[58];
assign conditional_wrapper_in_flat[4] = in_flat[59];
assign conditional_wrapper_in_flat[5] = in_flat[60];
assign conditional_wrapper_in_flat[8] = in_flat[61];
...
assign const_arith_wrapper_in_flat[5] = in_flat[65];
assign const_arith_wrapper_in_flat[6] = in_flat[66];
...
assign const_compare_wrapper_in_flat[12] = in_flat[84];
assign const_compare_wrapper_in_flat[13] = in_flat[85];
assign const_compare_wrapper_in_flat[14] = in_flat[86];
...
assign const_nested_wrapper_in_flat[1] = in_flat[138];
...
assign const_partselect_wrapper_in_flat[15] = in_flat[175];
assign const_partselect_wrapper_in_flat[16] = in_flat[176];
assign const_partselect_wrapper_in_flat[17] = in_flat[177];
assign const_partselect_wrapper_in_flat[19] = in_flat[178];
assign const_reduce_wrapper_in_flat[0] = in_flat[179];
...
assign const_shift_wrapper_in_flat[5] = in_flat[185];
assign const_shift_wrapper_in_flat[6] = in_flat[186];
assign const_shift_wrapper_in_flat[7] = in_flat[187];
...
assign select_wrapper_in_flat[3] = in_flat[213];
assign select_wrapper_in_flat[4] = in_flat[214];
assign select_wrapper_in_flat[5] = in_flat[215];
assign select_wrapper_in_flat[6] = in_flat[216];
assign select_wrapper_in_flat[7] = in_flat[217];
assign select_wrapper_in_flat[8] = in_flat[218];
assign select_wrapper_in_flat[9] = in_flat[219];
assign select_wrapper_in_flat[10] = in_flat[220];
assign select_wrapper_in_flat[12] = in_flat[221];
assign select_wrapper_in_flat[13] = in_flat[222];
assign select_wrapper_in_flat[15] = in_flat[223];
...
assign width_logic_wrapper_in_flat[0] = in_flat[233];
...
assign width_union_wrapper_in_flat[10] = in_flat[254];
assign width_union_wrapper_in_flat[11] = in_flat[255];
assign width_union_wrapper_in_flat[12] = in_flat[256];
assign width_union_wrapper_in_flat[13] = in_flat[257];
assign width_union_wrapper_in_flat[14] = in_flat[258];
assign width_union_wrapper_in_flat[15] = in_flat[259];

// Internal MTM connections (module-to-module)
assign select_wrapper_in_flat[16] = arithmetic_reduce_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[13] = arithmetic_reduce_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[11] = arithmetic_reduce_wrapper_out_flat[3];
assign shift_wrapper_in_flat[8] = array_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[19] = array_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[2] = array_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[2] = array_wrapper_out_flat[9];
assign width_union_wrapper_in_flat[5] = array_wrapper_out_flat[10];
assign relational_wrapper_in_flat[0] = array_wrapper_out_flat[12];
assign width_logic_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[13];
assign logical_op_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[20];
assign bitwise_logic_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[1] = cast_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[3] = cast_wrapper_out_flat[10];
assign numbers_concat_repl_wrapper_in_flat[2] = conditional_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[3] = const_arith_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[4] = const_arith_wrapper_out_flat[3];
assign cast_wrapper_in_flat[4] = const_arith_wrapper_out_flat[31];
assign const_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[36];
assign select_wrapper_in_flat[14] = const_compare_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[0] = const_compare_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[13];
assign partselect_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[17];
assign const_compare_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[18];
assign shift_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[20];
assign width_logic_wrapper_in_flat[7] = const_logic_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[13] = const_logic_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[0] = const_logic_wrapper_out_flat[8];
assign width_enum_wrapper_in_flat[1] = const_logic_wrapper_out_flat[12];
assign numbers_concat_repl_wrapper_in_flat[4] = const_logic_wrapper_out_flat[14];
assign arithmetic_reduce_wrapper_in_flat[3] = const_nested_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[7] = const_nested_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[33] = const_nested_wrapper_out_flat[4];
assign shift_wrapper_in_flat[5] = const_nested_wrapper_out_flat[4];
assign shift_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[2];
assign array_wrapper_in_flat[17] = const_partselect_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[0];
assign select_wrapper_in_flat[11] = const_reduce_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[9] = const_reduce_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[12] = const_shift_wrapper_out_flat[0];
assign relational_wrapper_in_flat[4] = const_shift_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[23] = const_shift_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[10] = const_shift_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[6] = const_shift_wrapper_out_flat[10];
assign array_wrapper_in_flat[3] = const_shift_wrapper_out_flat[17];
assign const_conditional_wrapper_in_flat[16] = const_shift_wrapper_out_flat[21];
assign width_union_wrapper_in_flat[6] = const_shift_wrapper_out_flat[22];
assign const_partselect_wrapper_in_flat[18] = const_shift_wrapper_out_flat[22];
assign width_logic_wrapper_in_flat[5] = logical_op_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[17];
assign const_concat_repl_wrapper_in_flat[6] = partselect_wrapper_out_flat[0];
assign shift_wrapper_in_flat[0] = partselect_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[17] = relational_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[10] = relational_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[1] = relational_wrapper_out_flat[6];
assign cast_wrapper_in_flat[0] = relational_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[9] = relational_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[0] = select_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[14] = select_wrapper_out_flat[1];
assign shift_wrapper_in_flat[3] = select_wrapper_out_flat[8];
assign const_concat_repl_wrapper_in_flat[8] = shift_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[2] = shift_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[9] = shift_wrapper_out_flat[13];
assign bitwise_logic_wrapper_in_flat[4] = width_enum_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[7] = width_logic_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[2] = width_struct_wrapper_out_flat[4];
assign select_wrapper_in_flat[1] = width_union_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[7] = width_union_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[9] = width_union_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[21] = width_union_wrapper_out_flat[13];
