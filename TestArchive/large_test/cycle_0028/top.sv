...
assign conditional_wrapper_in_flat[0] = in_flat[55];
...
assign const_logic_wrapper_in_flat[8] = in_flat[136];
...
assign partselect_wrapper_in_flat[3] = in_flat[196];
...
assign partselect_wrapper_in_flat[13] = in_flat[205];
...
assign select_wrapper_in_flat[19] = in_flat[227];
assign shift_wrapper_in_flat[0] = in_flat[228];
...
assign width_logic_wrapper_in_flat[2] = in_flat[235];
assign width_logic_wrapper_in_flat[3] = in_flat[236];
...
assign width_enum_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[2];
assign array_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[18] = arithmetic_reduce_wrapper_out_flat[7];
assign logical_op_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[9];
assign relational_wrapper_in_flat[5] = array_wrapper_out_flat[9];
assign select_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[4];
assign cast_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[10];
assign const_compare_wrapper_in_flat[22] = bitwise_logic_wrapper_out_flat[16];
assign const_conditional_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[20];
assign const_reduce_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[8] = bitwise_reduce_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[4] = bitwise_reduce_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[4] = cast_wrapper_out_flat[0];
assign shift_wrapper_in_flat[5] = cast_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[8] = cast_wrapper_out_flat[5];
assign relational_wrapper_in_flat[0] = cast_wrapper_out_flat[5];
assign select_wrapper_in_flat[18] = cast_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[3] = cast_wrapper_out_flat[8];
assign shift_wrapper_in_flat[9] = conditional_wrapper_out_flat[3];
assign shift_wrapper_in_flat[8] = const_arith_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[17] = const_arith_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[7] = const_arith_wrapper_out_flat[10];
assign numbers_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[19];
assign array_wrapper_in_flat[16] = const_arith_wrapper_out_flat[25];
assign const_logic_wrapper_in_flat[2] = const_compare_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[11] = const_compare_wrapper_out_flat[6];
assign logical_op_wrapper_in_flat[0] = const_compare_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[7];
assign relational_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[16];
assign partselect_wrapper_in_flat[18] = const_concat_repl_wrapper_out_flat[20];
assign select_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[0];
assign cast_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[14];
assign partselect_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[17];
assign numbers_concat_repl_wrapper_in_flat[5] = const_logic_wrapper_out_flat[8];
assign shift_wrapper_in_flat[7] = const_logic_wrapper_out_flat[9];
assign const_arith_wrapper_in_flat[3] = const_logic_wrapper_out_flat[15];
assign const_arith_wrapper_in_flat[2] = const_nested_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[5] = const_nested_wrapper_out_flat[6];
assign array_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[1] = const_shift_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[7] = const_shift_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[22] = const_shift_wrapper_out_flat[12];
assign select_wrapper_in_flat[6] = const_shift_wrapper_out_flat[17];
assign bitwise_logic_wrapper_in_flat[14] = const_shift_wrapper_out_flat[17];
assign bitwise_reduce_wrapper_in_flat[6] = logical_op_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[2] = logical_op_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[9] = logical_op_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[1];
assign relational_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[4] = partselect_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[2] = relational_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[1] = relational_wrapper_out_flat[6];
assign shift_wrapper_in_flat[2] = relational_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[16] = select_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[0] = select_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[3] = select_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[9] = select_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[6] = shift_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[14] = shift_wrapper_out_flat[14];
assign partselect_wrapper_in_flat[9] = width_enum_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[1] = width_enum_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[4] = width_enum_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[0] = width_logic_wrapper_out_flat[4];
assign relational_wrapper_in_flat[4] = width_struct_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[1] = width_struct_wrapper_out_flat[8];
assign shift_wrapper_in_flat[6] = width_struct_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[1] = width_union_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[8] = width_union_wrapper_out_flat[3];
assign cast_wrapper_in_flat[7] = width_union_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[8] = width_union_wrapper_out_flat[11];
assign bitwise_logic_wrapper_in_flat[8] = width_union_wrapper_out_flat[15];
