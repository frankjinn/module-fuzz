...
assign bitwise_reduce_wrapper_in_flat[1] = in_flat[41];
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[42];
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[43];
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[44];
assign bitwise_reduce_wrapper_in_flat[7] = in_flat[45];
assign cast_wrapper_in_flat[0] = in_flat[46];
assign cast_wrapper_in_flat[1] = in_flat[47];
assign cast_wrapper_in_flat[2] = in_flat[48];
assign cast_wrapper_in_flat[3] = in_flat[49];
assign cast_wrapper_in_flat[4] = in_flat[50];
assign cast_wrapper_in_flat[5] = in_flat[51];
assign cast_wrapper_in_flat[6] = in_flat[52];
assign cast_wrapper_in_flat[8] = in_flat[53];
...
assign const_arith_wrapper_in_flat[1] = in_flat[59];
...
assign const_compare_wrapper_in_flat[23] = in_flat[90];
...
assign const_concat_repl_wrapper_in_flat[5] = in_flat[94];
assign const_concat_repl_wrapper_in_flat[7] = in_flat[95];
assign const_concat_repl_wrapper_in_flat[8] = in_flat[96];
assign const_concat_repl_wrapper_in_flat[9] = in_flat[97];
...
assign const_conditional_wrapper_in_flat[3] = in_flat[101];
assign const_conditional_wrapper_in_flat[4] = in_flat[102];
...
assign const_conditional_wrapper_in_flat[33] = in_flat[131];
assign const_logic_wrapper_in_flat[0] = in_flat[132];
assign const_logic_wrapper_in_flat[1] = in_flat[133];
assign const_logic_wrapper_in_flat[2] = in_flat[134];
...
assign const_nested_wrapper_in_flat[0] = in_flat[139];
assign const_nested_wrapper_in_flat[1] = in_flat[140];
...
assign const_nested_wrapper_in_flat[6] = in_flat[144];
assign const_nested_wrapper_in_flat[7] = in_flat[145];
assign const_nested_wrapper_in_flat[8] = in_flat[146];
assign const_nested_wrapper_in_flat[9] = in_flat[147];
assign const_nested_wrapper_in_flat[10] = in_flat[148];
assign const_nested_wrapper_in_flat[11] = in_flat[149];
...
assign const_partselect_wrapper_in_flat[12] = in_flat[171];
assign const_partselect_wrapper_in_flat[13] = in_flat[172];
assign const_partselect_wrapper_in_flat[14] = in_flat[173];
assign const_partselect_wrapper_in_flat[16] = in_flat[174];
assign const_partselect_wrapper_in_flat[18] = in_flat[175];
assign const_partselect_wrapper_in_flat[19] = in_flat[176];
assign const_reduce_wrapper_in_flat[2] = in_flat[177];
...
assign const_shift_wrapper_in_flat[5] = in_flat[181];
assign const_shift_wrapper_in_flat[6] = in_flat[182];
assign const_shift_wrapper_in_flat[7] = in_flat[183];
assign const_shift_wrapper_in_flat[9] = in_flat[184];
assign const_shift_wrapper_in_flat[10] = in_flat[185];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[186];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[187];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[188];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[189];
assign partselect_wrapper_in_flat[1] = in_flat[190];
assign partselect_wrapper_in_flat[2] = in_flat[191];
assign partselect_wrapper_in_flat[3] = in_flat[192];
assign partselect_wrapper_in_flat[4] = in_flat[193];
assign partselect_wrapper_in_flat[5] = in_flat[194];
...
assign partselect_wrapper_in_flat[18] = in_flat[205];
...
assign relational_wrapper_in_flat[5] = in_flat[210];
assign relational_wrapper_in_flat[7] = in_flat[211];
assign select_wrapper_in_flat[0] = in_flat[212];
assign select_wrapper_in_flat[1] = in_flat[213];
assign select_wrapper_in_flat[2] = in_flat[214];
assign select_wrapper_in_flat[3] = in_flat[215];
assign select_wrapper_in_flat[4] = in_flat[216];
assign select_wrapper_in_flat[5] = in_flat[217];
assign select_wrapper_in_flat[7] = in_flat[218];
assign select_wrapper_in_flat[9] = in_flat[219];
assign select_wrapper_in_flat[10] = in_flat[220];
assign select_wrapper_in_flat[11] = in_flat[221];
assign select_wrapper_in_flat[12] = in_flat[222];
assign select_wrapper_in_flat[13] = in_flat[223];
assign select_wrapper_in_flat[14] = in_flat[224];
assign select_wrapper_in_flat[15] = in_flat[225];
...
assign shift_wrapper_in_flat[6] = in_flat[231];
assign shift_wrapper_in_flat[7] = in_flat[232];
assign shift_wrapper_in_flat[8] = in_flat[233];
assign shift_wrapper_in_flat[9] = in_flat[234];
assign shift_wrapper_in_flat[10] = in_flat[235];
assign width_logic_wrapper_in_flat[0] = in_flat[236];
assign width_logic_wrapper_in_flat[4] = in_flat[237];
assign width_logic_wrapper_in_flat[5] = in_flat[238];
assign width_logic_wrapper_in_flat[7] = in_flat[239];
assign width_struct_wrapper_in_flat[0] = in_flat[240];
assign width_struct_wrapper_in_flat[3] = in_flat[241];
assign width_struct_wrapper_in_flat[4] = in_flat[242];
assign width_struct_wrapper_in_flat[5] = in_flat[243];
assign width_struct_wrapper_in_flat[6] = in_flat[244];
assign width_struct_wrapper_in_flat[7] = in_flat[245];
assign width_struct_wrapper_in_flat[8] = in_flat[246];
assign width_struct_wrapper_in_flat[9] = in_flat[247];
...
assign width_union_wrapper_in_flat[15] = in_flat[259];

// Internal MTM connections (module-to-module)
assign relational_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[3];
assign select_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[1] = array_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[1] = array_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[7] = array_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[8] = array_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[2] = array_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[9];
assign shift_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[12];
assign numbers_concat_repl_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[14];
assign width_logic_wrapper_in_flat[6] = cast_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[7] = cast_wrapper_out_flat[5];
assign logical_op_wrapper_in_flat[0] = cast_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[17] = cast_wrapper_out_flat[10];
assign width_enum_wrapper_in_flat[2] = conditional_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[1] = const_arith_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[18];
assign select_wrapper_in_flat[19] = const_arith_wrapper_out_flat[28];
assign width_union_wrapper_in_flat[10] = const_arith_wrapper_out_flat[34];
assign arithmetic_reduce_wrapper_in_flat[14] = const_concat_repl_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[6];
assign cast_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[16];
assign shift_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[16];
assign const_logic_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[11];
assign bitwise_logic_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[15];
assign const_reduce_wrapper_in_flat[3] = const_logic_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[6] = const_logic_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[0] = const_logic_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[8] = const_logic_wrapper_out_flat[8];
assign const_shift_wrapper_in_flat[3] = const_logic_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[2] = const_logic_wrapper_out_flat[12];
assign width_struct_wrapper_in_flat[11] = const_logic_wrapper_out_flat[16];
assign cast_wrapper_in_flat[9] = const_logic_wrapper_out_flat[18];
assign array_wrapper_in_flat[9] = const_logic_wrapper_out_flat[18];
assign const_concat_repl_wrapper_in_flat[2] = const_nested_wrapper_out_flat[0];
assign shift_wrapper_in_flat[4] = const_nested_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[14] = const_nested_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[15] = const_reduce_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[19] = const_shift_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[1] = const_shift_wrapper_out_flat[11];
assign cast_wrapper_in_flat[11] = const_shift_wrapper_out_flat[15];
assign const_compare_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[14] = numbers_concat_repl_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[17] = partselect_wrapper_out_flat[1];
assign array_wrapper_in_flat[11] = partselect_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[2] = partselect_wrapper_out_flat[8];
assign width_enum_wrapper_in_flat[3] = relational_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[0] = relational_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[0] = select_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[1] = select_wrapper_out_flat[7];
assign relational_wrapper_in_flat[2] = select_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[13] = shift_wrapper_out_flat[3];
assign cast_wrapper_in_flat[10] = shift_wrapper_out_flat[5];
assign select_wrapper_in_flat[6] = shift_wrapper_out_flat[9];
assign width_union_wrapper_in_flat[8] = shift_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[2] = shift_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[6] = shift_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[15] = width_enum_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[6] = width_logic_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[0] = width_logic_wrapper_out_flat[2];
assign array_wrapper_in_flat[5] = width_struct_wrapper_out_flat[3];
assign shift_wrapper_in_flat[1] = width_struct_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[24] = width_struct_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[4] = width_struct_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[0] = width_struct_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[5] = width_union_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[1] = width_union_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[10] = width_union_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[8] = width_union_wrapper_out_flat[14];
