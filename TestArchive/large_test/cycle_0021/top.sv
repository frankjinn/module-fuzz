...
assign array_wrapper_in_flat[14] = in_flat[25];
...
assign conditional_wrapper_in_flat[1] = in_flat[54];
assign conditional_wrapper_in_flat[2] = in_flat[55];
...
assign conditional_wrapper_in_flat[6] = in_flat[59];
assign conditional_wrapper_in_flat[7] = in_flat[60];
...
assign const_compare_wrapper_in_flat[12] = in_flat[87];
...
assign const_concat_repl_wrapper_in_flat[3] = in_flat[97];
...
assign const_conditional_wrapper_in_flat[2] = in_flat[103];
...
assign const_conditional_wrapper_in_flat[8] = in_flat[107];
assign const_conditional_wrapper_in_flat[9] = in_flat[108];
...
assign const_partselect_wrapper_in_flat[0] = in_flat[163];
...
assign const_partselect_wrapper_in_flat[6] = in_flat[168];
assign const_partselect_wrapper_in_flat[7] = in_flat[169];
...
assign const_partselect_wrapper_in_flat[12] = in_flat[173];
...
assign relational_wrapper_in_flat[1] = in_flat[206];
...
assign select_wrapper_in_flat[10] = in_flat[219];
assign select_wrapper_in_flat[11] = in_flat[220];
assign select_wrapper_in_flat[12] = in_flat[221];
assign select_wrapper_in_flat[14] = in_flat[222];
assign select_wrapper_in_flat[15] = in_flat[223];
assign select_wrapper_in_flat[16] = in_flat[224];
assign select_wrapper_in_flat[17] = in_flat[225];
...
assign width_enum_wrapper_in_flat[3] = in_flat[236];
...
assign width_logic_wrapper_in_flat[6] = in_flat[242];
...
assign width_struct_wrapper_in_flat[5] = in_flat[248];
assign width_struct_wrapper_in_flat[6] = in_flat[249];
assign width_struct_wrapper_in_flat[7] = in_flat[250];
assign width_struct_wrapper_in_flat[8] = in_flat[251];
assign width_struct_wrapper_in_flat[9] = in_flat[252];
assign width_struct_wrapper_in_flat[11] = in_flat[253];
assign width_union_wrapper_in_flat[1] = in_flat[254];
assign width_union_wrapper_in_flat[2] = in_flat[255];
assign width_union_wrapper_in_flat[3] = in_flat[256];
...
assign width_union_wrapper_in_flat[9] = in_flat[260];
...
assign relational_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[3];
assign select_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[11] = arithmetic_reduce_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[13] = arithmetic_reduce_wrapper_out_flat[8];
assign numbers_concat_repl_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[5] = array_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[12] = array_wrapper_out_flat[9];
assign partselect_wrapper_in_flat[16] = bitwise_logic_wrapper_out_flat[3];
assign cast_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[13];
assign width_union_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[17];
assign const_arith_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[22];
assign relational_wrapper_in_flat[2] = bitwise_reduce_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[4] = cast_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[17] = cast_wrapper_out_flat[6];
assign select_wrapper_in_flat[1] = cast_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[6] = cast_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[20] = conditional_wrapper_out_flat[0];
assign shift_wrapper_in_flat[7] = conditional_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[20] = conditional_wrapper_out_flat[1];
assign array_wrapper_in_flat[17] = conditional_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[5] = const_arith_wrapper_out_flat[21];
assign cast_wrapper_in_flat[9] = const_arith_wrapper_out_flat[36];
assign bitwise_reduce_wrapper_in_flat[6] = const_arith_wrapper_out_flat[37];
assign select_wrapper_in_flat[19] = const_arith_wrapper_out_flat[39];
assign const_partselect_wrapper_in_flat[17] = const_compare_wrapper_out_flat[4];
assign select_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[11];
assign numbers_concat_repl_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[16];
assign array_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[16];
assign arithmetic_reduce_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[16];
assign const_compare_wrapper_in_flat[19] = const_conditional_wrapper_out_flat[18];
assign const_concat_repl_wrapper_in_flat[7] = const_logic_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[10] = const_logic_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[1] = const_logic_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[7] = const_logic_wrapper_out_flat[6];
assign select_wrapper_in_flat[18] = const_logic_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[4] = const_logic_wrapper_out_flat[6];
assign bitwise_logic_wrapper_in_flat[0] = const_logic_wrapper_out_flat[13];
assign width_union_wrapper_in_flat[4] = const_nested_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[8] = const_nested_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[7] = const_nested_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[1] = const_nested_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[3] = const_nested_wrapper_out_flat[6];
assign array_wrapper_in_flat[12] = const_nested_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[31] = const_partselect_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[0] = const_shift_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[8] = const_shift_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[5] = const_shift_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[18] = const_shift_wrapper_out_flat[21];
assign const_partselect_wrapper_in_flat[18] = logical_op_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[8] = logical_op_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[3];
assign cast_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[11];
assign bitwise_reduce_wrapper_in_flat[0] = partselect_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[8] = relational_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[2] = relational_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[27] = select_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[1] = select_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[6] = select_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[1] = width_enum_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[26] = width_logic_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[11] = width_logic_wrapper_out_flat[4];
assign relational_wrapper_in_flat[5] = width_logic_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[9] = width_struct_wrapper_out_flat[1];
assign cast_wrapper_in_flat[5] = width_struct_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[9] = width_struct_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[0] = width_struct_wrapper_out_flat[9];
assign const_shift_wrapper_in_flat[8] = width_struct_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[24] = width_union_wrapper_out_flat[2];
assign shift_wrapper_in_flat[8] = width_union_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[1] = width_union_wrapper_out_flat[11];
