...
assign const_conditional_wrapper_in_flat[0] = in_flat[100];
...
assign const_logic_wrapper_in_flat[3] = in_flat[134];
...
assign const_nested_wrapper_in_flat[6] = in_flat[143];
...
assign const_partselect_wrapper_in_flat[0] = in_flat[162];
...
assign partselect_wrapper_in_flat[6] = in_flat[195];
assign partselect_wrapper_in_flat[7] = in_flat[196];
assign partselect_wrapper_in_flat[8] = in_flat[197];
assign partselect_wrapper_in_flat[9] = in_flat[198];
assign partselect_wrapper_in_flat[10] = in_flat[199];
...
assign select_wrapper_in_flat[7] = in_flat[216];
assign select_wrapper_in_flat[8] = in_flat[217];
assign select_wrapper_in_flat[9] = in_flat[218];
assign select_wrapper_in_flat[11] = in_flat[219];
assign select_wrapper_in_flat[12] = in_flat[220];
assign select_wrapper_in_flat[13] = in_flat[221];
...
assign width_logic_wrapper_in_flat[4] = in_flat[239];
assign width_logic_wrapper_in_flat[5] = in_flat[240];
assign width_logic_wrapper_in_flat[7] = in_flat[241];
...
assign width_enum_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[3] = array_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[8] = array_wrapper_out_flat[9];
assign cast_wrapper_in_flat[0] = array_wrapper_out_flat[10];
assign logical_op_wrapper_in_flat[0] = array_wrapper_out_flat[13];
assign width_union_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[2] = bitwise_reduce_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[0] = cast_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[1] = cast_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[7] = cast_wrapper_out_flat[9];
assign select_wrapper_in_flat[19] = conditional_wrapper_out_flat[0];
assign array_wrapper_in_flat[9] = conditional_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[8] = const_arith_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[25] = const_arith_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[7] = const_arith_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[6] = const_arith_wrapper_out_flat[18];
assign const_logic_wrapper_in_flat[6] = const_arith_wrapper_out_flat[23];
assign const_compare_wrapper_in_flat[20] = const_arith_wrapper_out_flat[30];
assign partselect_wrapper_in_flat[3] = const_arith_wrapper_out_flat[31];
assign const_partselect_wrapper_in_flat[2] = const_arith_wrapper_out_flat[35];
assign conditional_wrapper_in_flat[4] = const_compare_wrapper_out_flat[0];
assign relational_wrapper_in_flat[7] = const_compare_wrapper_out_flat[2];
assign select_wrapper_in_flat[1] = const_compare_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[2] = const_compare_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[6] = const_compare_wrapper_out_flat[6];
assign array_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[22] = const_concat_repl_wrapper_out_flat[13];
assign const_logic_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[16];
assign numbers_concat_repl_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[16];
assign const_nested_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[20];
assign conditional_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[21];
assign const_arith_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[23] = const_conditional_wrapper_out_flat[13];
assign const_reduce_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[16];
assign cast_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[20];
assign partselect_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[21];
assign width_struct_wrapper_in_flat[2] = const_logic_wrapper_out_flat[1];
assign select_wrapper_in_flat[10] = const_logic_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[6] = const_logic_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[9] = const_logic_wrapper_out_flat[14];
assign relational_wrapper_in_flat[6] = const_logic_wrapper_out_flat[14];
assign const_shift_wrapper_in_flat[10] = const_nested_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[3] = const_nested_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[14] = const_partselect_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[0] = const_shift_wrapper_out_flat[3];
assign relational_wrapper_in_flat[0] = const_shift_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[2] = const_shift_wrapper_out_flat[4];
assign cast_wrapper_in_flat[3] = const_shift_wrapper_out_flat[9];
assign width_union_wrapper_in_flat[0] = const_shift_wrapper_out_flat[21];
assign bitwise_logic_wrapper_in_flat[13] = logical_op_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[28] = numbers_concat_repl_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[12] = numbers_concat_repl_wrapper_out_flat[10];
assign const_logic_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[16];
assign const_reduce_wrapper_in_flat[3] = partselect_wrapper_out_flat[2];
assign relational_wrapper_in_flat[1] = partselect_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[1] = partselect_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[18] = partselect_wrapper_out_flat[6];
assign array_wrapper_in_flat[12] = relational_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[10] = relational_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[3] = relational_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[10] = shift_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[5] = shift_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[6] = shift_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[16] = shift_wrapper_out_flat[10];
assign const_compare_wrapper_in_flat[21] = shift_wrapper_out_flat[12];
assign bitwise_logic_wrapper_in_flat[1] = width_enum_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[2] = width_logic_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[1] = width_struct_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[12] = width_struct_wrapper_out_flat[5];
assign cast_wrapper_in_flat[1] = width_struct_wrapper_out_flat[10];
assign width_enum_wrapper_in_flat[1] = width_union_wrapper_out_flat[4];
assign array_wrapper_in_flat[15] = width_union_wrapper_out_flat[5];
assign select_wrapper_in_flat[14] = width_union_wrapper_out_flat[7];
