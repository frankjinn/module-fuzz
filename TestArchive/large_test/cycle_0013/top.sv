...
assign cast_wrapper_in_flat[10] = in_flat[54];
assign cast_wrapper_in_flat[11] = in_flat[55];
assign conditional_wrapper_in_flat[1] = in_flat[56];
assign conditional_wrapper_in_flat[2] = in_flat[57];
assign conditional_wrapper_in_flat[4] = in_flat[58];
assign conditional_wrapper_in_flat[5] = in_flat[59];
assign conditional_wrapper_in_flat[6] = in_flat[60];
assign conditional_wrapper_in_flat[7] = in_flat[61];
assign conditional_wrapper_in_flat[8] = in_flat[62];
...
assign const_arith_wrapper_in_flat[10] = in_flat[73];
assign const_arith_wrapper_in_flat[11] = in_flat[74];
...
assign const_concat_repl_wrapper_in_flat[2] = in_flat[97];
assign const_concat_repl_wrapper_in_flat[3] = in_flat[98];
assign const_concat_repl_wrapper_in_flat[4] = in_flat[99];
...
assign const_partselect_wrapper_in_flat[12] = in_flat[166];
assign const_partselect_wrapper_in_flat[13] = in_flat[167];
...
assign const_reduce_wrapper_in_flat[0] = in_flat[171];
assign const_shift_wrapper_in_flat[1] = in_flat[172];
assign const_shift_wrapper_in_flat[2] = in_flat[173];
assign const_shift_wrapper_in_flat[3] = in_flat[174];
assign const_shift_wrapper_in_flat[4] = in_flat[175];
assign const_shift_wrapper_in_flat[5] = in_flat[176];
...
assign logical_op_wrapper_in_flat[1] = in_flat[180];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[181];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[182];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[183];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[184];
assign partselect_wrapper_in_flat[0] = in_flat[185];
assign partselect_wrapper_in_flat[4] = in_flat[186];
assign partselect_wrapper_in_flat[5] = in_flat[187];
assign partselect_wrapper_in_flat[6] = in_flat[188];
assign partselect_wrapper_in_flat[7] = in_flat[189];
assign partselect_wrapper_in_flat[8] = in_flat[190];
assign partselect_wrapper_in_flat[9] = in_flat[191];
assign partselect_wrapper_in_flat[10] = in_flat[192];
assign partselect_wrapper_in_flat[11] = in_flat[193];
assign partselect_wrapper_in_flat[13] = in_flat[194];
assign partselect_wrapper_in_flat[14] = in_flat[195];
assign partselect_wrapper_in_flat[15] = in_flat[196];
assign partselect_wrapper_in_flat[16] = in_flat[197];
assign partselect_wrapper_in_flat[18] = in_flat[198];
assign relational_wrapper_in_flat[0] = in_flat[199];
assign relational_wrapper_in_flat[6] = in_flat[200];
assign relational_wrapper_in_flat[7] = in_flat[201];
...
assign select_wrapper_in_flat[7] = in_flat[207];
assign select_wrapper_in_flat[8] = in_flat[208];
assign select_wrapper_in_flat[9] = in_flat[209];
assign select_wrapper_in_flat[10] = in_flat[210];
assign select_wrapper_in_flat[12] = in_flat[211];
assign select_wrapper_in_flat[13] = in_flat[212];
assign select_wrapper_in_flat[14] = in_flat[213];
assign select_wrapper_in_flat[15] = in_flat[214];
...
assign width_logic_wrapper_in_flat[2] = in_flat[229];
assign width_logic_wrapper_in_flat[3] = in_flat[230];
assign width_logic_wrapper_in_flat[4] = in_flat[231];
...
assign const_reduce_wrapper_in_flat[2] = array_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[1] = array_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[17] = array_wrapper_out_flat[12];
assign const_conditional_wrapper_in_flat[25] = bitwise_logic_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[24] = bitwise_logic_wrapper_out_flat[11];
assign relational_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[13];
assign shift_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[15];
assign const_partselect_wrapper_in_flat[18] = cast_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[10] = cast_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[2] = cast_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[4] = cast_wrapper_out_flat[8];
assign const_shift_wrapper_in_flat[10] = cast_wrapper_out_flat[8];
assign numbers_concat_repl_wrapper_in_flat[4] = cast_wrapper_out_flat[10];
assign const_compare_wrapper_in_flat[14] = conditional_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[2] = conditional_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[17] = conditional_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[5] = conditional_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[11] = const_arith_wrapper_out_flat[1];
assign shift_wrapper_in_flat[3] = const_arith_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[8] = const_arith_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[13] = const_arith_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[11] = const_arith_wrapper_out_flat[16];
assign relational_wrapper_in_flat[4] = const_arith_wrapper_out_flat[17];
assign bitwise_logic_wrapper_in_flat[15] = const_arith_wrapper_out_flat[22];
assign select_wrapper_in_flat[2] = const_arith_wrapper_out_flat[25];
assign array_wrapper_in_flat[13] = const_arith_wrapper_out_flat[26];
assign conditional_wrapper_in_flat[0] = const_arith_wrapper_out_flat[39];
assign bitwise_reduce_wrapper_in_flat[4] = const_compare_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[14] = const_compare_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[6] = const_compare_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[7] = const_compare_wrapper_out_flat[7];
assign select_wrapper_in_flat[16] = const_concat_repl_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[19];
assign relational_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[8];
assign width_enum_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[21];
assign width_struct_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[23];
assign cast_wrapper_in_flat[5] = const_logic_wrapper_out_flat[1];
...
assign const_arith_wrapper_in_flat[13] = const_logic_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[16] = const_logic_wrapper_out_flat[9];
assign numbers_concat_repl_wrapper_in_flat[0] = const_logic_wrapper_out_flat[15];
assign const_reduce_wrapper_in_flat[1] = const_nested_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[15] = const_nested_wrapper_out_flat[7];
assign relational_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[1];
assign array_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[4];
assign select_wrapper_in_flat[11] = const_shift_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[7] = const_shift_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[15] = const_shift_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[2] = const_shift_wrapper_out_flat[12];
assign const_conditional_wrapper_in_flat[8] = const_shift_wrapper_out_flat[18];
assign relational_wrapper_in_flat[5] = const_shift_wrapper_out_flat[23];
assign const_arith_wrapper_in_flat[12] = const_shift_wrapper_out_flat[23];
assign const_nested_wrapper_in_flat[25] = logical_op_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[10];
assign select_wrapper_in_flat[0] = partselect_wrapper_out_flat[2];
assign array_wrapper_in_flat[4] = partselect_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[10] = partselect_wrapper_out_flat[8];
assign const_concat_repl_wrapper_in_flat[5] = relational_wrapper_out_flat[1];
assign array_wrapper_in_flat[11] = relational_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[21] = select_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[12] = shift_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[12] = shift_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[1] = shift_wrapper_out_flat[9];
assign logical_op_wrapper_in_flat[0] = shift_wrapper_out_flat[9];
assign array_wrapper_in_flat[9] = width_enum_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[2] = width_enum_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[4] = width_logic_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[13] = width_struct_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[3] = width_struct_wrapper_out_flat[8];
assign select_wrapper_in_flat[19] = width_struct_wrapper_out_flat[11];
assign const_conditional_wrapper_in_flat[22] = width_union_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[0] = width_union_wrapper_out_flat[6];
assign bitwise_logic_wrapper_in_flat[12] = width_union_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[0] = width_union_wrapper_out_flat[14];
