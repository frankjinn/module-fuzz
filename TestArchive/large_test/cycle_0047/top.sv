...
assign cast_wrapper_in_flat[10] = in_flat[52];
...
assign conditional_wrapper_in_flat[3] = in_flat[56];
assign conditional_wrapper_in_flat[4] = in_flat[57];
assign conditional_wrapper_in_flat[6] = in_flat[58];
assign conditional_wrapper_in_flat[8] = in_flat[59];
...
assign const_compare_wrapper_in_flat[16] = in_flat[89];
assign const_compare_wrapper_in_flat[17] = in_flat[90];
...
assign const_concat_repl_wrapper_in_flat[0] = in_flat[96];
assign const_concat_repl_wrapper_in_flat[1] = in_flat[97];
...
assign const_conditional_wrapper_in_flat[12] = in_flat[114];
assign const_conditional_wrapper_in_flat[13] = in_flat[115];
assign const_conditional_wrapper_in_flat[14] = in_flat[116];
assign const_conditional_wrapper_in_flat[15] = in_flat[117];
assign const_conditional_wrapper_in_flat[16] = in_flat[118];
...
assign const_conditional_wrapper_in_flat[22] = in_flat[123];
assign const_conditional_wrapper_in_flat[23] = in_flat[124];
assign const_conditional_wrapper_in_flat[24] = in_flat[125];
assign const_conditional_wrapper_in_flat[25] = in_flat[126];
assign const_conditional_wrapper_in_flat[26] = in_flat[127];
assign const_conditional_wrapper_in_flat[27] = in_flat[128];
assign const_conditional_wrapper_in_flat[28] = in_flat[129];
assign const_conditional_wrapper_in_flat[29] = in_flat[130];
...
assign const_logic_wrapper_in_flat[4] = in_flat[135];
assign const_logic_wrapper_in_flat[5] = in_flat[136];
...
assign const_nested_wrapper_in_flat[6] = in_flat[146];
assign const_nested_wrapper_in_flat[7] = in_flat[147];
...
assign const_nested_wrapper_in_flat[17] = in_flat[156];
...
assign const_nested_wrapper_in_flat[26] = in_flat[164];
...
assign const_partselect_wrapper_in_flat[4] = in_flat[168];
assign const_partselect_wrapper_in_flat[5] = in_flat[169];
assign const_partselect_wrapper_in_flat[6] = in_flat[170];
assign const_partselect_wrapper_in_flat[7] = in_flat[171];
...
assign const_reduce_wrapper_in_flat[1] = in_flat[182];
...
assign const_shift_wrapper_in_flat[3] = in_flat[186];
assign const_shift_wrapper_in_flat[4] = in_flat[187];
assign const_shift_wrapper_in_flat[5] = in_flat[188];
assign const_shift_wrapper_in_flat[6] = in_flat[189];
assign const_shift_wrapper_in_flat[7] = in_flat[190];
assign const_shift_wrapper_in_flat[8] = in_flat[191];
assign const_shift_wrapper_in_flat[9] = in_flat[192];
assign const_shift_wrapper_in_flat[10] = in_flat[193];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[194];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[195];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[196];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[197];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[198];
assign partselect_wrapper_in_flat[1] = in_flat[199];
assign partselect_wrapper_in_flat[2] = in_flat[200];
assign partselect_wrapper_in_flat[3] = in_flat[201];
assign partselect_wrapper_in_flat[4] = in_flat[202];
assign partselect_wrapper_in_flat[5] = in_flat[203];
assign partselect_wrapper_in_flat[6] = in_flat[204];
assign partselect_wrapper_in_flat[7] = in_flat[205];
assign partselect_wrapper_in_flat[8] = in_flat[206];
assign partselect_wrapper_in_flat[9] = in_flat[207];
assign partselect_wrapper_in_flat[11] = in_flat[208];
assign partselect_wrapper_in_flat[12] = in_flat[209];
assign partselect_wrapper_in_flat[13] = in_flat[210];
assign partselect_wrapper_in_flat[14] = in_flat[211];
assign partselect_wrapper_in_flat[16] = in_flat[212];
assign partselect_wrapper_in_flat[17] = in_flat[213];
assign partselect_wrapper_in_flat[18] = in_flat[214];
assign relational_wrapper_in_flat[0] = in_flat[215];
assign relational_wrapper_in_flat[1] = in_flat[216];
assign relational_wrapper_in_flat[2] = in_flat[217];
assign relational_wrapper_in_flat[3] = in_flat[218];
assign relational_wrapper_in_flat[4] = in_flat[219];
assign relational_wrapper_in_flat[6] = in_flat[220];
assign relational_wrapper_in_flat[7] = in_flat[221];
assign select_wrapper_in_flat[0] = in_flat[222];
assign select_wrapper_in_flat[1] = in_flat[223];
assign select_wrapper_in_flat[2] = in_flat[224];
assign select_wrapper_in_flat[3] = in_flat[225];
assign select_wrapper_in_flat[4] = in_flat[226];
assign select_wrapper_in_flat[5] = in_flat[227];
assign select_wrapper_in_flat[6] = in_flat[228];
assign select_wrapper_in_flat[7] = in_flat[229];
assign select_wrapper_in_flat[8] = in_flat[230];
assign select_wrapper_in_flat[9] = in_flat[231];
assign select_wrapper_in_flat[10] = in_flat[232];
assign select_wrapper_in_flat[11] = in_flat[233];
assign select_wrapper_in_flat[12] = in_flat[234];
assign select_wrapper_in_flat[13] = in_flat[235];
assign select_wrapper_in_flat[14] = in_flat[236];
assign select_wrapper_in_flat[15] = in_flat[237];
assign select_wrapper_in_flat[17] = in_flat[238];
assign select_wrapper_in_flat[18] = in_flat[239];
assign select_wrapper_in_flat[19] = in_flat[240];
assign shift_wrapper_in_flat[0] = in_flat[241];
assign shift_wrapper_in_flat[1] = in_flat[242];
assign shift_wrapper_in_flat[2] = in_flat[243];
assign shift_wrapper_in_flat[3] = in_flat[244];
assign shift_wrapper_in_flat[4] = in_flat[245];
assign shift_wrapper_in_flat[5] = in_flat[246];
assign shift_wrapper_in_flat[9] = in_flat[247];
assign width_enum_wrapper_in_flat[2] = in_flat[248];
assign width_enum_wrapper_in_flat[3] = in_flat[249];
...
assign width_struct_wrapper_in_flat[0] = in_flat[255];
assign width_struct_wrapper_in_flat[1] = in_flat[256];
assign width_struct_wrapper_in_flat[3] = in_flat[257];
assign width_struct_wrapper_in_flat[6] = in_flat[258];
assign width_struct_wrapper_in_flat[7] = in_flat[259];
assign width_struct_wrapper_in_flat[9] = in_flat[260];
assign width_struct_wrapper_in_flat[10] = in_flat[261];
assign width_struct_wrapper_in_flat[11] = in_flat[262];
assign width_union_wrapper_in_flat[0] = in_flat[263];
assign width_union_wrapper_in_flat[2] = in_flat[264];
assign width_union_wrapper_in_flat[3] = in_flat[265];
assign width_union_wrapper_in_flat[4] = in_flat[266];
assign width_union_wrapper_in_flat[5] = in_flat[267];
assign width_union_wrapper_in_flat[6] = in_flat[268];
assign width_union_wrapper_in_flat[7] = in_flat[269];
assign width_union_wrapper_in_flat[8] = in_flat[270];
assign width_union_wrapper_in_flat[9] = in_flat[271];
assign width_union_wrapper_in_flat[10] = in_flat[272];
assign width_union_wrapper_in_flat[11] = in_flat[273];
assign width_union_wrapper_in_flat[12] = in_flat[274];
assign width_union_wrapper_in_flat[14] = in_flat[275];
assign width_union_wrapper_in_flat[15] = in_flat[276];

// Internal MTM connections (module-to-module)
assign cast_wrapper_in_flat[2] = array_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[3];
assign shift_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[16];
assign partselect_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[0];
assign cast_wrapper_in_flat[8] = bitwise_reduce_wrapper_out_flat[0];
assign array_wrapper_in_flat[10] = bitwise_reduce_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[7] = cast_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[8] = cast_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[0] = cast_wrapper_out_flat[11];
assign bitwise_logic_wrapper_in_flat[12] = const_arith_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[13];
assign const_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[17];
assign width_union_wrapper_in_flat[1] = const_arith_wrapper_out_flat[25];
assign const_conditional_wrapper_in_flat[32] = const_arith_wrapper_out_flat[32];
assign shift_wrapper_in_flat[10] = const_arith_wrapper_out_flat[33];
assign bitwise_reduce_wrapper_in_flat[3] = const_compare_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[0] = const_compare_wrapper_out_flat[2];
assign array_wrapper_in_flat[9] = const_compare_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[13];
assign width_struct_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[9];
assign bitwise_logic_wrapper_in_flat[0] = const_logic_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[2] = const_logic_wrapper_out_flat[14];
assign shift_wrapper_in_flat[8] = const_nested_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[30] = const_nested_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[15] = const_reduce_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[3] = const_shift_wrapper_out_flat[5];
assign select_wrapper_in_flat[16] = const_shift_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[5] = const_shift_wrapper_out_flat[16];
assign arithmetic_reduce_wrapper_in_flat[4] = const_shift_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[9] = const_shift_wrapper_out_flat[19];
assign array_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[15] = numbers_concat_repl_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[11];
assign width_enum_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[12];
assign relational_wrapper_in_flat[5] = partselect_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[0] = partselect_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[11] = relational_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[6] = relational_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[1] = select_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[6] = select_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[2] = select_wrapper_out_flat[6];
assign array_wrapper_in_flat[4] = select_wrapper_out_flat[8];
assign logical_op_wrapper_in_flat[1] = shift_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[7] = shift_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[4] = width_enum_wrapper_out_flat[0];
assign array_wrapper_in_flat[0] = width_enum_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[5] = width_enum_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[6] = width_enum_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[23] = width_enum_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[5] = width_logic_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[13] = width_logic_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[7] = width_logic_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[11] = width_logic_wrapper_out_flat[5];
assign shift_wrapper_in_flat[7] = width_struct_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[21] = width_union_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[7] = width_union_wrapper_out_flat[12];
assign width_struct_wrapper_in_flat[8] = width_union_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[18] = width_union_wrapper_out_flat[15];
