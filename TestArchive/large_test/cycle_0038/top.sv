...
assign const_compare_wrapper_in_flat[5] = in_flat[79];
assign const_compare_wrapper_in_flat[6] = in_flat[80];
...
assign const_compare_wrapper_in_flat[15] = in_flat[88];
...
assign const_concat_repl_wrapper_in_flat[0] = in_flat[95];
assign const_concat_repl_wrapper_in_flat[1] = in_flat[96];
...
assign const_logic_wrapper_in_flat[0] = in_flat[134];
assign const_logic_wrapper_in_flat[1] = in_flat[135];
assign const_logic_wrapper_in_flat[2] = in_flat[136];
assign const_logic_wrapper_in_flat[3] = in_flat[137];
...
assign const_nested_wrapper_in_flat[11] = in_flat[151];
...
assign const_reduce_wrapper_in_flat[0] = in_flat[181];
assign const_reduce_wrapper_in_flat[2] = in_flat[182];
...
assign partselect_wrapper_in_flat[0] = in_flat[199];
assign partselect_wrapper_in_flat[1] = in_flat[200];
assign partselect_wrapper_in_flat[2] = in_flat[201];
assign partselect_wrapper_in_flat[3] = in_flat[202];
assign partselect_wrapper_in_flat[4] = in_flat[203];
assign partselect_wrapper_in_flat[5] = in_flat[204];
assign partselect_wrapper_in_flat[6] = in_flat[205];
assign partselect_wrapper_in_flat[7] = in_flat[206];
assign partselect_wrapper_in_flat[8] = in_flat[207];
assign partselect_wrapper_in_flat[9] = in_flat[208];
assign partselect_wrapper_in_flat[10] = in_flat[209];
assign partselect_wrapper_in_flat[11] = in_flat[210];
assign partselect_wrapper_in_flat[12] = in_flat[211];
assign partselect_wrapper_in_flat[13] = in_flat[212];
assign partselect_wrapper_in_flat[14] = in_flat[213];
assign partselect_wrapper_in_flat[15] = in_flat[214];
assign partselect_wrapper_in_flat[16] = in_flat[215];
assign partselect_wrapper_in_flat[18] = in_flat[216];
assign relational_wrapper_in_flat[1] = in_flat[217];
assign relational_wrapper_in_flat[4] = in_flat[218];
assign relational_wrapper_in_flat[5] = in_flat[219];
...
assign select_wrapper_in_flat[2] = in_flat[223];
assign select_wrapper_in_flat[3] = in_flat[224];
assign select_wrapper_in_flat[4] = in_flat[225];
assign select_wrapper_in_flat[5] = in_flat[226];
assign select_wrapper_in_flat[6] = in_flat[227];
assign select_wrapper_in_flat[7] = in_flat[228];
assign select_wrapper_in_flat[8] = in_flat[229];
assign select_wrapper_in_flat[9] = in_flat[230];
assign select_wrapper_in_flat[11] = in_flat[231];
assign select_wrapper_in_flat[13] = in_flat[232];
assign select_wrapper_in_flat[14] = in_flat[233];
assign select_wrapper_in_flat[15] = in_flat[234];
assign select_wrapper_in_flat[16] = in_flat[235];
assign select_wrapper_in_flat[17] = in_flat[236];
assign select_wrapper_in_flat[19] = in_flat[237];
assign shift_wrapper_in_flat[0] = in_flat[238];
assign shift_wrapper_in_flat[1] = in_flat[239];
assign shift_wrapper_in_flat[2] = in_flat[240];
assign shift_wrapper_in_flat[3] = in_flat[241];
assign shift_wrapper_in_flat[4] = in_flat[242];
...
assign width_logic_wrapper_in_flat[6] = in_flat[249];
assign width_logic_wrapper_in_flat[7] = in_flat[250];
assign width_struct_wrapper_in_flat[0] = in_flat[251];
assign width_struct_wrapper_in_flat[1] = in_flat[252];
assign width_struct_wrapper_in_flat[2] = in_flat[253];
assign width_struct_wrapper_in_flat[3] = in_flat[254];
assign width_struct_wrapper_in_flat[4] = in_flat[255];
assign width_struct_wrapper_in_flat[7] = in_flat[256];
assign width_struct_wrapper_in_flat[10] = in_flat[257];
assign width_struct_wrapper_in_flat[11] = in_flat[258];
assign width_union_wrapper_in_flat[0] = in_flat[259];
assign width_union_wrapper_in_flat[1] = in_flat[260];
assign width_union_wrapper_in_flat[2] = in_flat[261];
assign width_union_wrapper_in_flat[3] = in_flat[262];
assign width_union_wrapper_in_flat[5] = in_flat[263];
assign width_union_wrapper_in_flat[6] = in_flat[264];
assign width_union_wrapper_in_flat[7] = in_flat[265];
assign width_union_wrapper_in_flat[8] = in_flat[266];
assign width_union_wrapper_in_flat[9] = in_flat[267];
assign width_union_wrapper_in_flat[10] = in_flat[268];
assign width_union_wrapper_in_flat[11] = in_flat[269];
assign width_union_wrapper_in_flat[12] = in_flat[270];
assign width_union_wrapper_in_flat[13] = in_flat[271];
assign width_union_wrapper_in_flat[14] = in_flat[272];
assign width_union_wrapper_in_flat[15] = in_flat[273];

// Internal MTM connections (module-to-module)
assign width_struct_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[2];
assign array_wrapper_in_flat[17] = arithmetic_reduce_wrapper_out_flat[3];
assign shift_wrapper_in_flat[5] = array_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[8] = array_wrapper_out_flat[8];
assign select_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[12];
assign logical_op_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[16] = cast_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[2] = cast_wrapper_out_flat[7];
assign relational_wrapper_in_flat[2] = cast_wrapper_out_flat[8];
assign bitwise_logic_wrapper_in_flat[1] = conditional_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[0] = conditional_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[14] = conditional_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[12] = conditional_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[10] = const_arith_wrapper_out_flat[14];
assign width_enum_wrapper_in_flat[3] = const_arith_wrapper_out_flat[24];
assign bitwise_logic_wrapper_in_flat[9] = const_arith_wrapper_out_flat[24];
assign array_wrapper_in_flat[11] = const_arith_wrapper_out_flat[28];
assign bitwise_reduce_wrapper_in_flat[2] = const_compare_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[1] = const_compare_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[14] = const_concat_repl_wrapper_out_flat[21];
assign width_logic_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[10] = const_logic_wrapper_out_flat[4];
assign select_wrapper_in_flat[18] = const_logic_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[6] = const_logic_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[17] = const_logic_wrapper_out_flat[10];
assign conditional_wrapper_in_flat[8] = const_nested_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[3] = const_nested_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[2];
assign select_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[19] = const_reduce_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[4];
assign cast_wrapper_in_flat[2] = const_shift_wrapper_out_flat[0];
assign relational_wrapper_in_flat[3] = const_shift_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[8] = const_shift_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[0] = const_shift_wrapper_out_flat[17];
assign const_nested_wrapper_in_flat[12] = numbers_concat_repl_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[19] = numbers_concat_repl_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[11];
assign width_struct_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[14];
assign width_enum_wrapper_in_flat[1] = partselect_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[8] = partselect_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[0] = partselect_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[5] = partselect_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[15] = partselect_wrapper_out_flat[6];
...
assign const_conditional_wrapper_in_flat[12] = shift_wrapper_out_flat[8];
...
assign select_wrapper_in_flat[12] = width_enum_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[3] = width_enum_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[4] = width_enum_wrapper_out_flat[4];
assign logical_op_wrapper_in_flat[1] = width_logic_wrapper_out_flat[2];
assign relational_wrapper_in_flat[0] = width_logic_wrapper_out_flat[2];
assign cast_wrapper_in_flat[4] = width_struct_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[26] = width_struct_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[5] = width_struct_wrapper_out_flat[10];
assign bitwise_logic_wrapper_in_flat[12] = width_union_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[5] = width_union_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[2] = width_union_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[9] = width_union_wrapper_out_flat[12];
