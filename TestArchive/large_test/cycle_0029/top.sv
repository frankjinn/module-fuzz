...
assign cast_wrapper_in_flat[3] = in_flat[48];
assign cast_wrapper_in_flat[4] = in_flat[49];
assign cast_wrapper_in_flat[6] = in_flat[50];
assign cast_wrapper_in_flat[7] = in_flat[51];
assign cast_wrapper_in_flat[8] = in_flat[52];
assign cast_wrapper_in_flat[9] = in_flat[53];
...
assign conditional_wrapper_in_flat[3] = in_flat[57];
assign conditional_wrapper_in_flat[4] = in_flat[58];
assign conditional_wrapper_in_flat[7] = in_flat[59];
assign const_arith_wrapper_in_flat[0] = in_flat[60];
assign const_arith_wrapper_in_flat[1] = in_flat[61];
assign const_arith_wrapper_in_flat[2] = in_flat[62];
assign const_arith_wrapper_in_flat[3] = in_flat[63];
assign const_arith_wrapper_in_flat[4] = in_flat[64];
assign const_arith_wrapper_in_flat[5] = in_flat[65];
assign const_arith_wrapper_in_flat[6] = in_flat[66];
assign const_arith_wrapper_in_flat[7] = in_flat[67];
...
assign const_compare_wrapper_in_flat[7] = in_flat[81];
...
assign const_concat_repl_wrapper_in_flat[7] = in_flat[102];
...
assign const_conditional_wrapper_in_flat[11] = in_flat[113];
...
assign const_conditional_wrapper_in_flat[30] = in_flat[131];
assign const_conditional_wrapper_in_flat[31] = in_flat[132];
...
assign const_logic_wrapper_in_flat[9] = in_flat[140];
...
assign const_nested_wrapper_in_flat[17] = in_flat[157];
assign const_nested_wrapper_in_flat[18] = in_flat[158];
...
assign const_shift_wrapper_in_flat[1] = in_flat[183];
assign const_shift_wrapper_in_flat[2] = in_flat[184];
assign const_shift_wrapper_in_flat[3] = in_flat[185];
assign const_shift_wrapper_in_flat[4] = in_flat[186];
assign const_shift_wrapper_in_flat[5] = in_flat[187];
assign const_shift_wrapper_in_flat[6] = in_flat[188];
assign const_shift_wrapper_in_flat[8] = in_flat[189];
assign const_shift_wrapper_in_flat[9] = in_flat[190];
assign logical_op_wrapper_in_flat[1] = in_flat[191];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[192];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[193];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[194];
assign partselect_wrapper_in_flat[0] = in_flat[195];
assign partselect_wrapper_in_flat[1] = in_flat[196];
assign partselect_wrapper_in_flat[2] = in_flat[197];
assign partselect_wrapper_in_flat[3] = in_flat[198];
assign partselect_wrapper_in_flat[4] = in_flat[199];
assign partselect_wrapper_in_flat[5] = in_flat[200];
assign partselect_wrapper_in_flat[6] = in_flat[201];
assign partselect_wrapper_in_flat[7] = in_flat[202];
assign partselect_wrapper_in_flat[9] = in_flat[203];
assign partselect_wrapper_in_flat[10] = in_flat[204];
assign partselect_wrapper_in_flat[11] = in_flat[205];
assign partselect_wrapper_in_flat[13] = in_flat[206];
assign partselect_wrapper_in_flat[14] = in_flat[207];
assign partselect_wrapper_in_flat[15] = in_flat[208];
assign partselect_wrapper_in_flat[16] = in_flat[209];
assign partselect_wrapper_in_flat[18] = in_flat[210];
assign relational_wrapper_in_flat[0] = in_flat[211];
assign relational_wrapper_in_flat[2] = in_flat[212];
...
assign select_wrapper_in_flat[4] = in_flat[220];
assign select_wrapper_in_flat[5] = in_flat[221];
assign select_wrapper_in_flat[6] = in_flat[222];
assign select_wrapper_in_flat[7] = in_flat[223];
assign select_wrapper_in_flat[8] = in_flat[224];
assign select_wrapper_in_flat[9] = in_flat[225];
assign select_wrapper_in_flat[11] = in_flat[226];
assign select_wrapper_in_flat[13] = in_flat[227];
assign select_wrapper_in_flat[15] = in_flat[228];
assign select_wrapper_in_flat[16] = in_flat[229];
assign select_wrapper_in_flat[17] = in_flat[230];
assign shift_wrapper_in_flat[0] = in_flat[231];
assign shift_wrapper_in_flat[1] = in_flat[232];
assign shift_wrapper_in_flat[2] = in_flat[233];
assign shift_wrapper_in_flat[3] = in_flat[234];
assign shift_wrapper_in_flat[4] = in_flat[235];
assign shift_wrapper_in_flat[8] = in_flat[236];
...
assign width_struct_wrapper_in_flat[3] = in_flat[245];
assign width_struct_wrapper_in_flat[5] = in_flat[246];
...
assign width_union_wrapper_in_flat[0] = in_flat[251];
assign width_union_wrapper_in_flat[1] = in_flat[252];
...
assign width_union_wrapper_in_flat[9] = in_flat[259];
assign width_union_wrapper_in_flat[10] = in_flat[260];
assign width_union_wrapper_in_flat[11] = in_flat[261];
...
assign bitwise_logic_wrapper_in_flat[13] = arithmetic_reduce_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[9];
assign select_wrapper_in_flat[12] = array_wrapper_out_flat[6];
assign bitwise_logic_wrapper_in_flat[1] = array_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[0] = array_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[21] = array_wrapper_out_flat[12];
assign relational_wrapper_in_flat[1] = array_wrapper_out_flat[13];
assign relational_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[29] = bitwise_logic_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[13] = bitwise_logic_wrapper_out_flat[15];
assign select_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[17];
assign shift_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[21];
assign bitwise_logic_wrapper_in_flat[2] = cast_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[9] = cast_wrapper_out_flat[1];
assign array_wrapper_in_flat[17] = cast_wrapper_out_flat[2];
assign shift_wrapper_in_flat[10] = conditional_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[16] = conditional_wrapper_out_flat[1];
assign relational_wrapper_in_flat[3] = const_arith_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[19] = const_arith_wrapper_out_flat[12];
assign arithmetic_reduce_wrapper_in_flat[7] = const_arith_wrapper_out_flat[17];
assign partselect_wrapper_in_flat[17] = const_arith_wrapper_out_flat[17];
assign shift_wrapper_in_flat[6] = const_arith_wrapper_out_flat[21];
assign const_concat_repl_wrapper_in_flat[6] = const_arith_wrapper_out_flat[30];
assign array_wrapper_in_flat[14] = const_arith_wrapper_out_flat[33];
assign width_union_wrapper_in_flat[8] = const_arith_wrapper_out_flat[35];
assign width_logic_wrapper_in_flat[6] = const_compare_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[6] = const_compare_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[18];
assign const_shift_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[21];
assign partselect_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[21];
assign width_logic_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[14];
assign width_enum_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[20];
assign const_compare_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[20];
assign width_logic_wrapper_in_flat[3] = const_nested_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[5] = const_nested_wrapper_out_flat[6];
assign cast_wrapper_in_flat[11] = const_partselect_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[6] = const_shift_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[22] = const_shift_wrapper_out_flat[1];
assign shift_wrapper_in_flat[7] = const_shift_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[2] = const_shift_wrapper_out_flat[11];
assign bitwise_reduce_wrapper_in_flat[2] = const_shift_wrapper_out_flat[12];
assign cast_wrapper_in_flat[10] = const_shift_wrapper_out_flat[17];
assign width_struct_wrapper_in_flat[8] = const_shift_wrapper_out_flat[17];
assign select_wrapper_in_flat[14] = const_shift_wrapper_out_flat[21];
assign numbers_concat_repl_wrapper_in_flat[1] = logical_op_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[0] = logical_op_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[1];
assign array_wrapper_in_flat[3] = partselect_wrapper_out_flat[2];
...
assign const_compare_wrapper_in_flat[0] = select_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[2] = shift_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[3] = width_enum_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[0] = width_logic_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[4] = width_logic_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[5] = width_struct_wrapper_out_flat[0];
assign select_wrapper_in_flat[18] = width_struct_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[8] = width_struct_wrapper_out_flat[8];
assign shift_wrapper_in_flat[5] = width_struct_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[3] = width_struct_wrapper_out_flat[9];
assign cast_wrapper_in_flat[5] = width_struct_wrapper_out_flat[10];
assign const_shift_wrapper_in_flat[0] = width_union_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[8] = width_union_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[6] = width_union_wrapper_out_flat[3];
assign select_wrapper_in_flat[19] = width_union_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[3] = width_union_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[19] = width_union_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[8] = width_union_wrapper_out_flat[14];
