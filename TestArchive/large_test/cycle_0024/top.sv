...
assign arithmetic_reduce_wrapper_in_flat[14] = in_flat[13];
...
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[44];
...
assign const_compare_wrapper_in_flat[1] = in_flat[69];
assign const_compare_wrapper_in_flat[2] = in_flat[70];
...
assign const_conditional_wrapper_in_flat[1] = in_flat[102];
...
assign const_nested_wrapper_in_flat[2] = in_flat[139];
assign const_nested_wrapper_in_flat[3] = in_flat[140];
assign const_nested_wrapper_in_flat[4] = in_flat[141];
assign const_nested_wrapper_in_flat[5] = in_flat[142];
...
assign const_reduce_wrapper_in_flat[3] = in_flat[175];
...
assign partselect_wrapper_in_flat[0] = in_flat[189];
...
assign partselect_wrapper_in_flat[18] = in_flat[206];
assign relational_wrapper_in_flat[0] = in_flat[207];
...
assign select_wrapper_in_flat[14] = in_flat[225];
assign select_wrapper_in_flat[15] = in_flat[226];
assign select_wrapper_in_flat[16] = in_flat[227];
assign select_wrapper_in_flat[17] = in_flat[228];
assign select_wrapper_in_flat[18] = in_flat[229];
assign select_wrapper_in_flat[19] = in_flat[230];
assign shift_wrapper_in_flat[1] = in_flat[231];
assign shift_wrapper_in_flat[3] = in_flat[232];
assign shift_wrapper_in_flat[4] = in_flat[233];
...
assign width_logic_wrapper_in_flat[0] = in_flat[237];
...
assign width_union_wrapper_in_flat[5] = in_flat[255];
assign width_union_wrapper_in_flat[6] = in_flat[256];
assign width_union_wrapper_in_flat[7] = in_flat[257];
assign width_union_wrapper_in_flat[8] = in_flat[258];
...
assign logical_op_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[10] = arithmetic_reduce_wrapper_out_flat[9];
assign shift_wrapper_in_flat[2] = array_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[14] = array_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[8] = array_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[3] = array_wrapper_out_flat[14];
assign cast_wrapper_in_flat[11] = array_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[16] = bitwise_logic_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[10];
assign cast_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[23];
assign logical_op_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[8] = bitwise_reduce_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[16] = cast_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[12] = cast_wrapper_out_flat[6];
assign cast_wrapper_in_flat[8] = conditional_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[1] = conditional_wrapper_out_flat[3];
assign array_wrapper_in_flat[6] = const_arith_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[9] = const_arith_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[11];
assign numbers_concat_repl_wrapper_in_flat[4] = const_arith_wrapper_out_flat[13];
assign const_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[19];
assign const_nested_wrapper_in_flat[26] = const_arith_wrapper_out_flat[25];
assign width_struct_wrapper_in_flat[2] = const_arith_wrapper_out_flat[30];
assign const_logic_wrapper_in_flat[7] = const_compare_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[1] = const_compare_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[9];
assign cast_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[20];
assign width_struct_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[18];
assign conditional_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[21];
assign width_struct_wrapper_in_flat[4] = const_logic_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[5] = const_logic_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[0] = const_logic_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[2] = const_logic_wrapper_out_flat[13];
assign cast_wrapper_in_flat[6] = const_logic_wrapper_out_flat[16];
assign const_nested_wrapper_in_flat[10] = const_logic_wrapper_out_flat[16];
assign const_conditional_wrapper_in_flat[2] = const_logic_wrapper_out_flat[18];
assign array_wrapper_in_flat[1] = const_nested_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[1] = const_nested_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[1];
assign shift_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[6];
assign relational_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[0];
assign array_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[5];
assign relational_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[5];
assign const_arith_wrapper_in_flat[6] = const_shift_wrapper_out_flat[0];
assign select_wrapper_in_flat[4] = const_shift_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[6] = const_shift_wrapper_out_flat[12];
assign shift_wrapper_in_flat[7] = const_shift_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[0] = const_shift_wrapper_out_flat[13];
assign width_struct_wrapper_in_flat[7] = const_shift_wrapper_out_flat[14];
assign numbers_concat_repl_wrapper_in_flat[1] = const_shift_wrapper_out_flat[19];
assign arithmetic_reduce_wrapper_in_flat[6] = const_shift_wrapper_out_flat[20];
assign width_enum_wrapper_in_flat[2] = const_shift_wrapper_out_flat[22];
assign const_conditional_wrapper_in_flat[26] = logical_op_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[8];
assign const_conditional_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[17];
assign const_arith_wrapper_in_flat[12] = partselect_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[6] = partselect_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[0] = partselect_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[4] = partselect_wrapper_out_flat[8];
assign width_logic_wrapper_in_flat[1] = relational_wrapper_out_flat[0];
assign shift_wrapper_in_flat[10] = relational_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[12] = select_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[3] = select_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[3] = width_logic_wrapper_out_flat[0];
assign cast_wrapper_in_flat[5] = width_struct_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[23] = width_struct_wrapper_out_flat[4];
assign array_wrapper_in_flat[11] = width_struct_wrapper_out_flat[5];
assign shift_wrapper_in_flat[0] = width_struct_wrapper_out_flat[8];
assign bitwise_logic_wrapper_in_flat[0] = width_struct_wrapper_out_flat[9];
assign relational_wrapper_in_flat[2] = width_union_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[7] = width_union_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[19] = width_union_wrapper_out_flat[15];
