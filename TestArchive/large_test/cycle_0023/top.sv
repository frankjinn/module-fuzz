...
assign array_wrapper_in_flat[10] = in_flat[17];
assign array_wrapper_in_flat[11] = in_flat[18];
...
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[43];
assign bitwise_reduce_wrapper_in_flat[7] = in_flat[44];
assign cast_wrapper_in_flat[0] = in_flat[45];
...
assign const_compare_wrapper_in_flat[10] = in_flat[79];
assign const_compare_wrapper_in_flat[11] = in_flat[80];
assign const_compare_wrapper_in_flat[12] = in_flat[81];
assign const_compare_wrapper_in_flat[13] = in_flat[82];
assign const_compare_wrapper_in_flat[14] = in_flat[83];
...
assign const_nested_wrapper_in_flat[14] = in_flat[149];
assign const_nested_wrapper_in_flat[15] = in_flat[150];
...
assign const_reduce_wrapper_in_flat[3] = in_flat[179];
assign const_shift_wrapper_in_flat[1] = in_flat[180];
assign const_shift_wrapper_in_flat[2] = in_flat[181];
assign const_shift_wrapper_in_flat[3] = in_flat[182];
assign const_shift_wrapper_in_flat[4] = in_flat[183];
assign const_shift_wrapper_in_flat[5] = in_flat[184];
assign const_shift_wrapper_in_flat[6] = in_flat[185];
assign const_shift_wrapper_in_flat[7] = in_flat[186];
assign const_shift_wrapper_in_flat[9] = in_flat[187];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[188];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[189];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[190];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[191];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[192];
assign partselect_wrapper_in_flat[0] = in_flat[193];
assign partselect_wrapper_in_flat[2] = in_flat[194];
assign partselect_wrapper_in_flat[3] = in_flat[195];
assign partselect_wrapper_in_flat[4] = in_flat[196];
assign partselect_wrapper_in_flat[5] = in_flat[197];
assign partselect_wrapper_in_flat[6] = in_flat[198];
assign partselect_wrapper_in_flat[7] = in_flat[199];
assign partselect_wrapper_in_flat[8] = in_flat[200];
assign partselect_wrapper_in_flat[10] = in_flat[201];
assign partselect_wrapper_in_flat[13] = in_flat[202];
assign partselect_wrapper_in_flat[14] = in_flat[203];
assign partselect_wrapper_in_flat[16] = in_flat[204];
assign partselect_wrapper_in_flat[18] = in_flat[205];
assign relational_wrapper_in_flat[2] = in_flat[206];
assign relational_wrapper_in_flat[3] = in_flat[207];
assign relational_wrapper_in_flat[4] = in_flat[208];
assign relational_wrapper_in_flat[5] = in_flat[209];
assign relational_wrapper_in_flat[7] = in_flat[210];
assign select_wrapper_in_flat[0] = in_flat[211];
assign select_wrapper_in_flat[2] = in_flat[212];
...
assign width_enum_wrapper_in_flat[2] = in_flat[236];
assign width_logic_wrapper_in_flat[1] = in_flat[237];
assign width_logic_wrapper_in_flat[2] = in_flat[238];
assign width_logic_wrapper_in_flat[3] = in_flat[239];
assign width_logic_wrapper_in_flat[4] = in_flat[240];
assign width_struct_wrapper_in_flat[0] = in_flat[241];
assign width_struct_wrapper_in_flat[2] = in_flat[242];
assign width_struct_wrapper_in_flat[3] = in_flat[243];
assign width_struct_wrapper_in_flat[5] = in_flat[244];
assign width_struct_wrapper_in_flat[6] = in_flat[245];
...
assign width_struct_wrapper_in_flat[10] = in_flat[249];
assign width_struct_wrapper_in_flat[11] = in_flat[250];
...
assign width_logic_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[7];
assign select_wrapper_in_flat[4] = array_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[0] = array_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[2] = array_wrapper_out_flat[10];
assign const_compare_wrapper_in_flat[23] = array_wrapper_out_flat[13];
assign cast_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[2];
assign relational_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[19] = bitwise_logic_wrapper_out_flat[12];
assign const_shift_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[17];
assign shift_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[19];
assign partselect_wrapper_in_flat[17] = cast_wrapper_out_flat[3];
assign select_wrapper_in_flat[7] = cast_wrapper_out_flat[3];
assign relational_wrapper_in_flat[1] = cast_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[1] = cast_wrapper_out_flat[10];
assign array_wrapper_in_flat[9] = cast_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[7] = conditional_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[1] = const_arith_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[25] = const_arith_wrapper_out_flat[11];
assign select_wrapper_in_flat[5] = const_arith_wrapper_out_flat[12];
assign width_union_wrapper_in_flat[9] = const_arith_wrapper_out_flat[21];
assign const_conditional_wrapper_in_flat[31] = const_arith_wrapper_out_flat[24];
assign cast_wrapper_in_flat[1] = const_arith_wrapper_out_flat[27];
assign array_wrapper_in_flat[4] = const_arith_wrapper_out_flat[33];
assign width_struct_wrapper_in_flat[1] = const_compare_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[9];
assign const_shift_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[15];
assign cast_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[16];
assign arithmetic_reduce_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[19];
assign conditional_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[20];
assign bitwise_reduce_wrapper_in_flat[0] = const_logic_wrapper_out_flat[14];
assign cast_wrapper_in_flat[8] = const_nested_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[12] = const_nested_wrapper_out_flat[4];
assign array_wrapper_in_flat[3] = const_nested_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[32] = const_partselect_wrapper_out_flat[6];
assign cast_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[6];
assign shift_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[2];
assign cast_wrapper_in_flat[10] = const_shift_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[8] = const_shift_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[16] = const_shift_wrapper_out_flat[10];
assign select_wrapper_in_flat[3] = const_shift_wrapper_out_flat[15];
assign relational_wrapper_in_flat[0] = const_shift_wrapper_out_flat[18];
assign const_nested_wrapper_in_flat[21] = numbers_concat_repl_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[14];
assign const_reduce_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[14];
assign partselect_wrapper_in_flat[15] = numbers_concat_repl_wrapper_out_flat[15];
assign conditional_wrapper_in_flat[5] = partselect_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[4] = partselect_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[0] = partselect_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[2] = partselect_wrapper_out_flat[8];
assign width_logic_wrapper_in_flat[5] = partselect_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[6] = relational_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[1] = relational_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[20] = select_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[4] = select_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[7] = select_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[1] = select_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[8] = shift_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[29] = shift_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[8] = shift_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[15] = shift_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[18] = shift_wrapper_out_flat[9];
assign array_wrapper_in_flat[1] = width_enum_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[13] = width_enum_wrapper_out_flat[3];
assign select_wrapper_in_flat[1] = width_enum_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[5] = width_logic_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[4] = width_struct_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[7] = width_union_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[3] = width_union_wrapper_out_flat[8];
assign width_logic_wrapper_in_flat[7] = width_union_wrapper_out_flat[10];
