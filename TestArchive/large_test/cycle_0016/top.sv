...
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[39];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[40];
...
assign const_arith_wrapper_in_flat[10] = in_flat[63];
assign const_arith_wrapper_in_flat[11] = in_flat[64];
assign const_arith_wrapper_in_flat[12] = in_flat[65];
assign const_arith_wrapper_in_flat[13] = in_flat[66];
...
assign const_compare_wrapper_in_flat[3] = in_flat[71];
...
assign const_compare_wrapper_in_flat[9] = in_flat[76];
...
assign const_compare_wrapper_in_flat[19] = in_flat[83];
assign const_compare_wrapper_in_flat[20] = in_flat[84];
assign const_compare_wrapper_in_flat[21] = in_flat[85];
assign const_compare_wrapper_in_flat[23] = in_flat[86];
assign const_concat_repl_wrapper_in_flat[2] = in_flat[87];
assign const_concat_repl_wrapper_in_flat[3] = in_flat[88];
assign const_concat_repl_wrapper_in_flat[4] = in_flat[89];
assign const_concat_repl_wrapper_in_flat[5] = in_flat[90];
assign const_concat_repl_wrapper_in_flat[6] = in_flat[91];
assign const_concat_repl_wrapper_in_flat[7] = in_flat[92];
assign const_concat_repl_wrapper_in_flat[8] = in_flat[93];
assign const_concat_repl_wrapper_in_flat[9] = in_flat[94];
assign const_conditional_wrapper_in_flat[0] = in_flat[95];
assign const_conditional_wrapper_in_flat[1] = in_flat[96];
assign const_conditional_wrapper_in_flat[3] = in_flat[97];
assign const_conditional_wrapper_in_flat[4] = in_flat[98];
assign const_conditional_wrapper_in_flat[5] = in_flat[99];
...
assign const_logic_wrapper_in_flat[4] = in_flat[128];
assign const_logic_wrapper_in_flat[5] = in_flat[129];
assign const_logic_wrapper_in_flat[6] = in_flat[130];
assign const_logic_wrapper_in_flat[7] = in_flat[131];
assign const_logic_wrapper_in_flat[8] = in_flat[132];
...
assign const_nested_wrapper_in_flat[22] = in_flat[155];
assign const_nested_wrapper_in_flat[23] = in_flat[156];
assign const_nested_wrapper_in_flat[24] = in_flat[157];
assign const_nested_wrapper_in_flat[25] = in_flat[158];
...
assign const_partselect_wrapper_in_flat[19] = in_flat[178];
...
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[189];
...
assign partselect_wrapper_in_flat[8] = in_flat[197];
assign partselect_wrapper_in_flat[9] = in_flat[198];
...
assign relational_wrapper_in_flat[0] = in_flat[205];
...
assign width_logic_wrapper_in_flat[1] = in_flat[238];
...
assign width_struct_wrapper_in_flat[4] = in_flat[245];
assign width_struct_wrapper_in_flat[6] = in_flat[246];
assign width_struct_wrapper_in_flat[7] = in_flat[247];
assign width_struct_wrapper_in_flat[8] = in_flat[248];
...
assign cast_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[1];
assign relational_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[3] = array_wrapper_out_flat[0];
assign relational_wrapper_in_flat[1] = array_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[8] = array_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[4] = array_wrapper_out_flat[11];
assign bitwise_reduce_wrapper_in_flat[3] = array_wrapper_out_flat[14];
assign const_shift_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[10];
assign numbers_concat_repl_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[13];
assign const_arith_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[16];
assign width_union_wrapper_in_flat[4] = bitwise_reduce_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[22] = conditional_wrapper_out_flat[0];
assign array_wrapper_in_flat[1] = conditional_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[0] = conditional_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[16];
assign const_compare_wrapper_in_flat[8] = const_arith_wrapper_out_flat[19];
assign bitwise_reduce_wrapper_in_flat[7] = const_compare_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[0] = const_compare_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[0] = const_compare_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[10] = const_compare_wrapper_out_flat[5];
assign relational_wrapper_in_flat[6] = const_compare_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[10];
assign logical_op_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[19];
assign const_shift_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[6];
assign bitwise_logic_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[7];
assign select_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[13];
assign width_enum_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[18];
assign width_union_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[22];
assign select_wrapper_in_flat[5] = const_logic_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[11] = const_logic_wrapper_out_flat[2];
assign array_wrapper_in_flat[2] = const_logic_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[5] = const_logic_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[2] = const_logic_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[5] = const_logic_wrapper_out_flat[14];
assign const_concat_repl_wrapper_in_flat[1] = const_logic_wrapper_out_flat[16];
assign bitwise_logic_wrapper_in_flat[2] = const_nested_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[32] = const_nested_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[9] = const_reduce_wrapper_out_flat[1];
assign cast_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[2] = const_shift_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[3] = const_shift_wrapper_out_flat[11];
assign array_wrapper_in_flat[16] = const_shift_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[3] = const_shift_wrapper_out_flat[14];
assign select_wrapper_in_flat[2] = const_shift_wrapper_out_flat[17];
assign width_struct_wrapper_in_flat[0] = logical_op_wrapper_out_flat[1];
assign array_wrapper_in_flat[17] = numbers_concat_repl_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[15];
assign const_partselect_wrapper_in_flat[11] = relational_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[3] = relational_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[7] = relational_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[4] = relational_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[2] = relational_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[1] = select_wrapper_out_flat[3];
assign array_wrapper_in_flat[6] = select_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[4] = select_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[10] = shift_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[10] = shift_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[11] = shift_wrapper_out_flat[11];
assign width_enum_wrapper_in_flat[3] = shift_wrapper_out_flat[11];
assign const_conditional_wrapper_in_flat[2] = shift_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[18] = shift_wrapper_out_flat[15];
assign arithmetic_reduce_wrapper_in_flat[11] = width_enum_wrapper_out_flat[2];
assign cast_wrapper_in_flat[0] = width_enum_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[14] = width_enum_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[1] = width_enum_wrapper_out_flat[4];
assign relational_wrapper_in_flat[5] = width_logic_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[1] = width_logic_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[2] = width_logic_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[0] = width_union_wrapper_out_flat[13];
assign const_concat_repl_wrapper_in_flat[0] = width_union_wrapper_out_flat[14];
assign partselect_wrapper_in_flat[12] = width_union_wrapper_out_flat[15];
