...
assign array_wrapper_in_flat[17] = in_flat[27];
...
assign conditional_wrapper_in_flat[7] = in_flat[55];
...
assign const_compare_wrapper_in_flat[11] = in_flat[81];
...
assign const_compare_wrapper_in_flat[23] = in_flat[91];
assign const_concat_repl_wrapper_in_flat[0] = in_flat[92];
...
assign const_concat_repl_wrapper_in_flat[6] = in_flat[97];
assign const_concat_repl_wrapper_in_flat[7] = in_flat[98];
assign const_concat_repl_wrapper_in_flat[8] = in_flat[99];
assign const_concat_repl_wrapper_in_flat[9] = in_flat[100];
assign const_conditional_wrapper_in_flat[0] = in_flat[101];
assign const_conditional_wrapper_in_flat[2] = in_flat[102];
assign const_conditional_wrapper_in_flat[3] = in_flat[103];
assign const_conditional_wrapper_in_flat[4] = in_flat[104];
assign const_conditional_wrapper_in_flat[5] = in_flat[105];
assign const_conditional_wrapper_in_flat[6] = in_flat[106];
assign const_conditional_wrapper_in_flat[7] = in_flat[107];
assign const_conditional_wrapper_in_flat[8] = in_flat[108];
assign const_conditional_wrapper_in_flat[10] = in_flat[109];
assign const_conditional_wrapper_in_flat[11] = in_flat[110];
assign const_conditional_wrapper_in_flat[12] = in_flat[111];
assign const_conditional_wrapper_in_flat[13] = in_flat[112];
assign const_conditional_wrapper_in_flat[14] = in_flat[113];
assign const_conditional_wrapper_in_flat[15] = in_flat[114];
assign const_conditional_wrapper_in_flat[16] = in_flat[115];
assign const_conditional_wrapper_in_flat[17] = in_flat[116];
assign const_conditional_wrapper_in_flat[18] = in_flat[117];
assign const_conditional_wrapper_in_flat[19] = in_flat[118];
assign const_conditional_wrapper_in_flat[20] = in_flat[119];
assign const_conditional_wrapper_in_flat[21] = in_flat[120];
assign const_conditional_wrapper_in_flat[22] = in_flat[121];
assign const_conditional_wrapper_in_flat[23] = in_flat[122];
assign const_conditional_wrapper_in_flat[24] = in_flat[123];
assign const_conditional_wrapper_in_flat[25] = in_flat[124];
assign const_conditional_wrapper_in_flat[26] = in_flat[125];
...
assign const_logic_wrapper_in_flat[3] = in_flat[133];
assign const_logic_wrapper_in_flat[5] = in_flat[134];
assign const_logic_wrapper_in_flat[6] = in_flat[135];
assign const_logic_wrapper_in_flat[9] = in_flat[136];
assign const_nested_wrapper_in_flat[0] = in_flat[137];
...
assign const_nested_wrapper_in_flat[23] = in_flat[153];
...
assign const_partselect_wrapper_in_flat[4] = in_flat[157];
assign const_partselect_wrapper_in_flat[5] = in_flat[158];
...
assign const_partselect_wrapper_in_flat[16] = in_flat[167];
assign const_partselect_wrapper_in_flat[17] = in_flat[168];
...
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[184];
...
assign relational_wrapper_in_flat[6] = in_flat[203];
...
assign select_wrapper_in_flat[4] = in_flat[208];
assign select_wrapper_in_flat[5] = in_flat[209];
assign select_wrapper_in_flat[6] = in_flat[210];
assign select_wrapper_in_flat[7] = in_flat[211];
assign select_wrapper_in_flat[8] = in_flat[212];
assign select_wrapper_in_flat[9] = in_flat[213];
assign select_wrapper_in_flat[10] = in_flat[214];
assign select_wrapper_in_flat[11] = in_flat[215];
assign select_wrapper_in_flat[12] = in_flat[216];
assign select_wrapper_in_flat[13] = in_flat[217];
assign select_wrapper_in_flat[14] = in_flat[218];
assign select_wrapper_in_flat[15] = in_flat[219];
...
assign shift_wrapper_in_flat[2] = in_flat[224];
...
assign width_logic_wrapper_in_flat[1] = in_flat[232];
...
assign const_nested_wrapper_in_flat[26] = arithmetic_reduce_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[0] = array_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[11] = array_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[12] = array_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[1] = array_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[4] = array_wrapper_out_flat[15];
assign width_logic_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[16];
assign bitwise_logic_wrapper_in_flat[11] = bitwise_reduce_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[1] = cast_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[7] = cast_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[5] = conditional_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[15] = conditional_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[9] = const_arith_wrapper_out_flat[4];
assign relational_wrapper_in_flat[5] = const_arith_wrapper_out_flat[19];
assign width_logic_wrapper_in_flat[2] = const_arith_wrapper_out_flat[26];
assign const_logic_wrapper_in_flat[8] = const_arith_wrapper_out_flat[38];
assign width_logic_wrapper_in_flat[5] = const_compare_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[21] = const_compare_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[6] = const_compare_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[14] = const_compare_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[10] = const_compare_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[3];
assign shift_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[7];
assign cast_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[12];
assign select_wrapper_in_flat[16] = const_concat_repl_wrapper_out_flat[16];
assign logical_op_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[2];
assign relational_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[14];
assign conditional_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[17];
assign const_logic_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[17];
assign width_struct_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[18];
assign arithmetic_reduce_wrapper_in_flat[6] = const_logic_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[3] = const_logic_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[2] = const_logic_wrapper_out_flat[8];
assign logical_op_wrapper_in_flat[0] = const_logic_wrapper_out_flat[9];
assign partselect_wrapper_in_flat[6] = const_logic_wrapper_out_flat[10];
assign width_union_wrapper_in_flat[14] = const_logic_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[4] = const_logic_wrapper_out_flat[11];
assign relational_wrapper_in_flat[2] = const_logic_wrapper_out_flat[18];
assign bitwise_logic_wrapper_in_flat[1] = const_nested_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[4] = const_nested_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[3] = const_nested_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[18] = const_partselect_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[15] = const_reduce_wrapper_out_flat[3];
assign shift_wrapper_in_flat[4] = const_shift_wrapper_out_flat[0];
assign select_wrapper_in_flat[2] = const_shift_wrapper_out_flat[12];
assign relational_wrapper_in_flat[3] = const_shift_wrapper_out_flat[13];
assign cast_wrapper_in_flat[4] = const_shift_wrapper_out_flat[14];
assign array_wrapper_in_flat[4] = const_shift_wrapper_out_flat[15];
assign const_logic_wrapper_in_flat[0] = const_shift_wrapper_out_flat[16];
assign const_arith_wrapper_in_flat[1] = const_shift_wrapper_out_flat[16];
assign const_concat_repl_wrapper_in_flat[3] = const_shift_wrapper_out_flat[18];
assign const_nested_wrapper_in_flat[22] = const_shift_wrapper_out_flat[22];
assign const_nested_wrapper_in_flat[19] = logical_op_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[11];
assign bitwise_logic_wrapper_in_flat[8] = partselect_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[2] = partselect_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[3] = partselect_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[11] = relational_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[3] = relational_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[3] = relational_wrapper_out_flat[3];
assign shift_wrapper_in_flat[10] = select_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[27] = select_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[5] = select_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[1] = select_wrapper_out_flat[8];
assign numbers_concat_repl_wrapper_in_flat[2] = shift_wrapper_out_flat[2];
assign cast_wrapper_in_flat[9] = shift_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[24] = shift_wrapper_out_flat[11];
assign width_enum_wrapper_in_flat[0] = shift_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[2] = shift_wrapper_out_flat[11];
...
assign conditional_wrapper_in_flat[4] = width_struct_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[7] = width_struct_wrapper_out_flat[11];
assign width_enum_wrapper_in_flat[3] = width_struct_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[2] = width_union_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[3] = width_union_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[19] = width_union_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[11] = width_union_wrapper_out_flat[8];
assign bitwise_logic_wrapper_in_flat[13] = width_union_wrapper_out_flat[11];
