...
assign arithmetic_reduce_wrapper_in_flat[9] = in_flat[9];
...
assign const_compare_wrapper_in_flat[1] = in_flat[74];
assign const_compare_wrapper_in_flat[2] = in_flat[75];
assign const_compare_wrapper_in_flat[3] = in_flat[76];
assign const_compare_wrapper_in_flat[4] = in_flat[77];
assign const_compare_wrapper_in_flat[5] = in_flat[78];
...
assign const_concat_repl_wrapper_in_flat[6] = in_flat[98];
assign const_concat_repl_wrapper_in_flat[8] = in_flat[99];
assign const_concat_repl_wrapper_in_flat[9] = in_flat[100];
assign const_conditional_wrapper_in_flat[1] = in_flat[101];
...
assign const_conditional_wrapper_in_flat[9] = in_flat[109];
assign const_conditional_wrapper_in_flat[10] = in_flat[110];
assign const_conditional_wrapper_in_flat[11] = in_flat[111];
assign const_conditional_wrapper_in_flat[12] = in_flat[112];
assign const_conditional_wrapper_in_flat[13] = in_flat[113];
assign const_conditional_wrapper_in_flat[14] = in_flat[114];
assign const_conditional_wrapper_in_flat[15] = in_flat[115];
assign const_conditional_wrapper_in_flat[16] = in_flat[116];
assign const_conditional_wrapper_in_flat[17] = in_flat[117];
...
assign const_conditional_wrapper_in_flat[27] = in_flat[126];
assign const_conditional_wrapper_in_flat[28] = in_flat[127];
assign const_conditional_wrapper_in_flat[29] = in_flat[128];
assign const_conditional_wrapper_in_flat[30] = in_flat[129];
assign const_conditional_wrapper_in_flat[31] = in_flat[130];
assign const_conditional_wrapper_in_flat[32] = in_flat[131];
assign const_conditional_wrapper_in_flat[33] = in_flat[132];
assign const_logic_wrapper_in_flat[0] = in_flat[133];
...
assign const_logic_wrapper_in_flat[7] = in_flat[139];
...
assign const_nested_wrapper_in_flat[11] = in_flat[150];
assign const_nested_wrapper_in_flat[12] = in_flat[151];
assign const_nested_wrapper_in_flat[13] = in_flat[152];
assign const_nested_wrapper_in_flat[14] = in_flat[153];
assign const_nested_wrapper_in_flat[15] = in_flat[154];
assign const_nested_wrapper_in_flat[16] = in_flat[155];
...
assign const_nested_wrapper_in_flat[25] = in_flat[163];
assign const_partselect_wrapper_in_flat[0] = in_flat[164];
assign const_partselect_wrapper_in_flat[1] = in_flat[165];
assign const_partselect_wrapper_in_flat[2] = in_flat[166];
assign const_partselect_wrapper_in_flat[3] = in_flat[167];
assign const_partselect_wrapper_in_flat[5] = in_flat[168];
assign const_partselect_wrapper_in_flat[6] = in_flat[169];
assign const_partselect_wrapper_in_flat[7] = in_flat[170];
assign const_partselect_wrapper_in_flat[8] = in_flat[171];
assign const_partselect_wrapper_in_flat[9] = in_flat[172];
assign const_partselect_wrapper_in_flat[10] = in_flat[173];
...
assign const_partselect_wrapper_in_flat[15] = in_flat[177];
assign const_partselect_wrapper_in_flat[16] = in_flat[178];
assign const_partselect_wrapper_in_flat[17] = in_flat[179];
assign const_partselect_wrapper_in_flat[18] = in_flat[180];
assign const_partselect_wrapper_in_flat[19] = in_flat[181];
assign const_reduce_wrapper_in_flat[0] = in_flat[182];
assign const_shift_wrapper_in_flat[0] = in_flat[183];
assign const_shift_wrapper_in_flat[1] = in_flat[184];
assign const_shift_wrapper_in_flat[2] = in_flat[185];
assign const_shift_wrapper_in_flat[4] = in_flat[186];
assign const_shift_wrapper_in_flat[5] = in_flat[187];
assign const_shift_wrapper_in_flat[8] = in_flat[188];
assign const_shift_wrapper_in_flat[9] = in_flat[189];
assign const_shift_wrapper_in_flat[10] = in_flat[190];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[191];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[192];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[193];
assign partselect_wrapper_in_flat[0] = in_flat[194];
assign partselect_wrapper_in_flat[1] = in_flat[195];
...
assign partselect_wrapper_in_flat[9] = in_flat[201];
assign partselect_wrapper_in_flat[10] = in_flat[202];
assign partselect_wrapper_in_flat[12] = in_flat[203];
assign partselect_wrapper_in_flat[13] = in_flat[204];
...
assign relational_wrapper_in_flat[0] = in_flat[208];
assign relational_wrapper_in_flat[1] = in_flat[209];
assign relational_wrapper_in_flat[2] = in_flat[210];
assign relational_wrapper_in_flat[4] = in_flat[211];
assign relational_wrapper_in_flat[6] = in_flat[212];
assign select_wrapper_in_flat[0] = in_flat[213];
assign select_wrapper_in_flat[1] = in_flat[214];
...
assign select_wrapper_in_flat[6] = in_flat[218];
assign select_wrapper_in_flat[7] = in_flat[219];
assign select_wrapper_in_flat[9] = in_flat[220];
assign select_wrapper_in_flat[10] = in_flat[221];
assign select_wrapper_in_flat[11] = in_flat[222];
assign select_wrapper_in_flat[12] = in_flat[223];
assign select_wrapper_in_flat[13] = in_flat[224];
...
assign shift_wrapper_in_flat[2] = in_flat[232];
assign shift_wrapper_in_flat[3] = in_flat[233];
assign shift_wrapper_in_flat[5] = in_flat[234];
assign shift_wrapper_in_flat[6] = in_flat[235];
assign shift_wrapper_in_flat[7] = in_flat[236];
assign shift_wrapper_in_flat[8] = in_flat[237];
assign shift_wrapper_in_flat[9] = in_flat[238];
assign width_enum_wrapper_in_flat[1] = in_flat[239];
assign width_enum_wrapper_in_flat[2] = in_flat[240];
assign width_logic_wrapper_in_flat[1] = in_flat[241];
assign width_logic_wrapper_in_flat[2] = in_flat[242];
assign width_logic_wrapper_in_flat[3] = in_flat[243];
assign width_logic_wrapper_in_flat[5] = in_flat[244];
assign width_logic_wrapper_in_flat[7] = in_flat[245];
assign width_struct_wrapper_in_flat[0] = in_flat[246];
assign width_struct_wrapper_in_flat[2] = in_flat[247];
assign width_struct_wrapper_in_flat[3] = in_flat[248];
assign width_struct_wrapper_in_flat[4] = in_flat[249];
assign width_struct_wrapper_in_flat[6] = in_flat[250];
assign width_struct_wrapper_in_flat[9] = in_flat[251];
assign width_struct_wrapper_in_flat[11] = in_flat[252];
assign width_union_wrapper_in_flat[0] = in_flat[253];
assign width_union_wrapper_in_flat[1] = in_flat[254];
assign width_union_wrapper_in_flat[3] = in_flat[255];
assign width_union_wrapper_in_flat[4] = in_flat[256];
assign width_union_wrapper_in_flat[5] = in_flat[257];
assign width_union_wrapper_in_flat[6] = in_flat[258];
assign width_union_wrapper_in_flat[7] = in_flat[259];
assign width_union_wrapper_in_flat[8] = in_flat[260];
assign width_union_wrapper_in_flat[9] = in_flat[261];
assign width_union_wrapper_in_flat[12] = in_flat[262];
assign width_union_wrapper_in_flat[13] = in_flat[263];
assign width_union_wrapper_in_flat[14] = in_flat[264];
assign width_union_wrapper_in_flat[15] = in_flat[265];

// Internal MTM connections (module-to-module)
assign cast_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[7] = array_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[17] = array_wrapper_out_flat[9];
assign const_shift_wrapper_in_flat[7] = array_wrapper_out_flat[10];
assign conditional_wrapper_in_flat[2] = array_wrapper_out_flat[11];
assign width_struct_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[15];
assign numbers_concat_repl_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[21];
assign const_reduce_wrapper_in_flat[2] = bitwise_reduce_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[4] = bitwise_reduce_wrapper_out_flat[1];
assign array_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[2];
assign relational_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[2];
assign select_wrapper_in_flat[2] = cast_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[3] = cast_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[18] = cast_wrapper_out_flat[6];
assign select_wrapper_in_flat[14] = conditional_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[3] = conditional_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[2] = const_arith_wrapper_out_flat[14];
assign array_wrapper_in_flat[1] = const_arith_wrapper_out_flat[22];
assign const_compare_wrapper_in_flat[23] = const_arith_wrapper_out_flat[24];
assign const_concat_repl_wrapper_in_flat[7] = const_arith_wrapper_out_flat[27];
assign const_conditional_wrapper_in_flat[18] = const_arith_wrapper_out_flat[33];
assign conditional_wrapper_in_flat[1] = const_compare_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[0] = const_compare_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[19] = const_concat_repl_wrapper_out_flat[11];
assign shift_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[15];
assign partselect_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[13];
assign array_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[18];
assign const_nested_wrapper_in_flat[26] = const_logic_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[5] = const_logic_wrapper_out_flat[11];
assign logical_op_wrapper_in_flat[0] = const_nested_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[5] = const_nested_wrapper_out_flat[3];
assign array_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[6];
assign relational_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[5];
assign cast_wrapper_in_flat[8] = const_shift_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[3] = const_shift_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[10] = const_shift_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[8] = const_shift_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[4] = const_shift_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[6] = logical_op_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[10];
assign select_wrapper_in_flat[8] = partselect_wrapper_out_flat[3];
assign shift_wrapper_in_flat[10] = relational_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[14] = shift_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[9] = shift_wrapper_out_flat[12];
assign array_wrapper_in_flat[2] = shift_wrapper_out_flat[14];
assign bitwise_logic_wrapper_in_flat[8] = shift_wrapper_out_flat[15];
assign arithmetic_reduce_wrapper_in_flat[11] = width_enum_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[2] = width_enum_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[1] = width_enum_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = width_enum_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[5] = width_logic_wrapper_out_flat[0];
assign cast_wrapper_in_flat[4] = width_logic_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[11] = width_logic_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[10] = width_struct_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[8] = width_struct_wrapper_out_flat[4];
assign relational_wrapper_in_flat[5] = width_union_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[7] = width_union_wrapper_out_flat[3];
assign array_wrapper_in_flat[3] = width_union_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[0] = width_union_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[3] = width_union_wrapper_out_flat[13];
assign bitwise_reduce_wrapper_in_flat[3] = width_union_wrapper_out_flat[13];
