...
assign arithmetic_reduce_wrapper_in_flat[10] = in_flat[10];
assign arithmetic_reduce_wrapper_in_flat[11] = in_flat[11];
assign arithmetic_reduce_wrapper_in_flat[12] = in_flat[12];
assign arithmetic_reduce_wrapper_in_flat[13] = in_flat[13];
assign arithmetic_reduce_wrapper_in_flat[14] = in_flat[14];
assign arithmetic_reduce_wrapper_in_flat[15] = in_flat[15];
assign array_wrapper_in_flat[0] = in_flat[16];
assign array_wrapper_in_flat[2] = in_flat[17];
assign array_wrapper_in_flat[3] = in_flat[18];
assign array_wrapper_in_flat[4] = in_flat[19];
assign array_wrapper_in_flat[5] = in_flat[20];
assign array_wrapper_in_flat[6] = in_flat[21];
assign array_wrapper_in_flat[7] = in_flat[22];
assign array_wrapper_in_flat[8] = in_flat[23];
assign array_wrapper_in_flat[9] = in_flat[24];
assign array_wrapper_in_flat[10] = in_flat[25];
assign array_wrapper_in_flat[11] = in_flat[26];
assign array_wrapper_in_flat[12] = in_flat[27];
assign array_wrapper_in_flat[13] = in_flat[28];
assign array_wrapper_in_flat[14] = in_flat[29];
assign array_wrapper_in_flat[15] = in_flat[30];
assign bitwise_logic_wrapper_in_flat[1] = in_flat[31];
assign bitwise_logic_wrapper_in_flat[2] = in_flat[32];
assign bitwise_logic_wrapper_in_flat[3] = in_flat[33];
assign bitwise_logic_wrapper_in_flat[5] = in_flat[34];
assign bitwise_logic_wrapper_in_flat[7] = in_flat[35];
assign bitwise_logic_wrapper_in_flat[8] = in_flat[36];
assign bitwise_logic_wrapper_in_flat[9] = in_flat[37];
assign bitwise_logic_wrapper_in_flat[10] = in_flat[38];
assign bitwise_logic_wrapper_in_flat[11] = in_flat[39];
assign bitwise_logic_wrapper_in_flat[12] = in_flat[40];
...
assign bitwise_reduce_wrapper_in_flat[0] = in_flat[44];
...
assign bitwise_reduce_wrapper_in_flat[7] = in_flat[48];
assign cast_wrapper_in_flat[0] = in_flat[49];
...
assign conditional_wrapper_in_flat[6] = in_flat[61];
assign conditional_wrapper_in_flat[7] = in_flat[62];
assign conditional_wrapper_in_flat[8] = in_flat[63];
assign const_arith_wrapper_in_flat[0] = in_flat[64];
assign const_arith_wrapper_in_flat[1] = in_flat[65];
assign const_arith_wrapper_in_flat[2] = in_flat[66];
assign const_arith_wrapper_in_flat[3] = in_flat[67];
assign const_arith_wrapper_in_flat[4] = in_flat[68];
...
assign const_partselect_wrapper_in_flat[1] = in_flat[166];
assign const_partselect_wrapper_in_flat[2] = in_flat[167];
assign const_partselect_wrapper_in_flat[3] = in_flat[168];
...
assign const_reduce_wrapper_in_flat[1] = in_flat[181];
assign const_shift_wrapper_in_flat[0] = in_flat[182];
...
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[191];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[192];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[193];
...
assign partselect_wrapper_in_flat[4] = in_flat[197];
assign partselect_wrapper_in_flat[5] = in_flat[198];
assign partselect_wrapper_in_flat[6] = in_flat[199];
assign partselect_wrapper_in_flat[7] = in_flat[200];
...
assign partselect_wrapper_in_flat[14] = in_flat[205];
assign partselect_wrapper_in_flat[15] = in_flat[206];
assign partselect_wrapper_in_flat[16] = in_flat[207];
assign partselect_wrapper_in_flat[17] = in_flat[208];
assign partselect_wrapper_in_flat[18] = in_flat[209];
assign relational_wrapper_in_flat[0] = in_flat[210];
assign relational_wrapper_in_flat[1] = in_flat[211];
...
assign shift_wrapper_in_flat[5] = in_flat[236];
assign shift_wrapper_in_flat[6] = in_flat[237];
assign shift_wrapper_in_flat[7] = in_flat[238];
assign shift_wrapper_in_flat[9] = in_flat[239];
assign shift_wrapper_in_flat[10] = in_flat[240];
assign width_enum_wrapper_in_flat[3] = in_flat[241];
...
assign width_struct_wrapper_in_flat[4] = in_flat[246];
assign width_struct_wrapper_in_flat[5] = in_flat[247];
assign width_struct_wrapper_in_flat[6] = in_flat[248];
assign width_struct_wrapper_in_flat[7] = in_flat[249];
assign width_struct_wrapper_in_flat[9] = in_flat[250];
assign width_struct_wrapper_in_flat[10] = in_flat[251];
...
assign const_compare_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[4];
assign cast_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[2] = array_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[22] = array_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[5] = array_wrapper_out_flat[8];
assign width_enum_wrapper_in_flat[1] = array_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[23] = array_wrapper_out_flat[13];
assign width_struct_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[21];
assign width_union_wrapper_in_flat[14] = bitwise_reduce_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[2];
assign array_wrapper_in_flat[1] = cast_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[2] = cast_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[2] = cast_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[32] = cast_wrapper_out_flat[9];
assign logical_op_wrapper_in_flat[0] = conditional_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[4] = conditional_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[18] = const_arith_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[0] = const_arith_wrapper_out_flat[21];
assign conditional_wrapper_in_flat[2] = const_arith_wrapper_out_flat[34];
assign logical_op_wrapper_in_flat[1] = const_arith_wrapper_out_flat[36];
assign const_reduce_wrapper_in_flat[2] = const_compare_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[6] = const_compare_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[13] = const_compare_wrapper_out_flat[5];
assign shift_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[17] = const_concat_repl_wrapper_out_flat[0];
assign cast_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[5];
assign array_wrapper_in_flat[17] = const_concat_repl_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[14];
assign const_logic_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[18];
assign select_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[19];
assign const_reduce_wrapper_in_flat[3] = const_logic_wrapper_out_flat[6];
assign shift_wrapper_in_flat[8] = const_logic_wrapper_out_flat[9];
assign select_wrapper_in_flat[7] = const_logic_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[6] = const_nested_wrapper_out_flat[0];
assign array_wrapper_in_flat[16] = const_nested_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[4] = const_nested_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[3] = const_nested_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[1] = const_nested_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[13] = const_reduce_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[0] = const_shift_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[25] = const_shift_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[8] = const_shift_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[5] = const_shift_wrapper_out_flat[14];
assign select_wrapper_in_flat[15] = const_shift_wrapper_out_flat[20];
assign relational_wrapper_in_flat[2] = logical_op_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[18] = numbers_concat_repl_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[10] = partselect_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[4] = partselect_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[1] = partselect_wrapper_out_flat[8];
assign numbers_concat_repl_wrapper_in_flat[4] = select_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[20] = select_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[6] = select_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[9] = shift_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[16] = shift_wrapper_out_flat[8];
assign select_wrapper_in_flat[16] = shift_wrapper_out_flat[10];
assign width_union_wrapper_in_flat[12] = shift_wrapper_out_flat[15];
assign relational_wrapper_in_flat[6] = width_enum_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[8] = width_enum_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[5] = width_enum_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[1] = width_logic_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[11] = width_logic_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[0] = width_logic_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[8] = width_struct_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[0] = width_struct_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[12] = width_union_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[15] = width_union_wrapper_out_flat[10];
assign width_enum_wrapper_in_flat[2] = width_union_wrapper_out_flat[13];
