...
assign cast_wrapper_in_flat[7] = in_flat[45];
...
assign const_compare_wrapper_in_flat[19] = in_flat[85];
...
assign const_concat_repl_wrapper_in_flat[8] = in_flat[97];
...
assign const_logic_wrapper_in_flat[1] = in_flat[131];
...
assign const_logic_wrapper_in_flat[8] = in_flat[137];
assign const_logic_wrapper_in_flat[9] = in_flat[138];
assign const_nested_wrapper_in_flat[0] = in_flat[139];
assign const_nested_wrapper_in_flat[1] = in_flat[140];
assign const_nested_wrapper_in_flat[2] = in_flat[141];
...
assign const_nested_wrapper_in_flat[9] = in_flat[146];
assign const_nested_wrapper_in_flat[10] = in_flat[147];
assign const_nested_wrapper_in_flat[11] = in_flat[148];
assign const_nested_wrapper_in_flat[12] = in_flat[149];
assign const_nested_wrapper_in_flat[13] = in_flat[150];
assign const_nested_wrapper_in_flat[14] = in_flat[151];
assign const_nested_wrapper_in_flat[15] = in_flat[152];
assign const_nested_wrapper_in_flat[16] = in_flat[153];
assign const_nested_wrapper_in_flat[17] = in_flat[154];
assign const_nested_wrapper_in_flat[18] = in_flat[155];
assign const_nested_wrapper_in_flat[19] = in_flat[156];
assign const_nested_wrapper_in_flat[20] = in_flat[157];
assign const_nested_wrapper_in_flat[21] = in_flat[158];
assign const_nested_wrapper_in_flat[22] = in_flat[159];
assign const_nested_wrapper_in_flat[23] = in_flat[160];
assign const_nested_wrapper_in_flat[24] = in_flat[161];
assign const_nested_wrapper_in_flat[25] = in_flat[162];
...
assign const_partselect_wrapper_in_flat[19] = in_flat[180];
...
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[190];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[191];
assign partselect_wrapper_in_flat[0] = in_flat[192];
assign partselect_wrapper_in_flat[1] = in_flat[193];
...
assign partselect_wrapper_in_flat[9] = in_flat[200];
...
assign partselect_wrapper_in_flat[16] = in_flat[205];
...
assign shift_wrapper_in_flat[6] = in_flat[230];
...
assign width_logic_wrapper_in_flat[3] = in_flat[237];
assign width_logic_wrapper_in_flat[4] = in_flat[238];
assign width_logic_wrapper_in_flat[5] = in_flat[239];
assign width_logic_wrapper_in_flat[6] = in_flat[240];
...
assign cast_wrapper_in_flat[1] = array_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[4] = array_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[0] = array_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[15] = bitwise_logic_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[6] = cast_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[12] = cast_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[1] = const_arith_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[6] = const_arith_wrapper_out_flat[14];
assign width_union_wrapper_in_flat[10] = const_arith_wrapper_out_flat[18];
assign arithmetic_reduce_wrapper_in_flat[15] = const_arith_wrapper_out_flat[26];
assign array_wrapper_in_flat[6] = const_arith_wrapper_out_flat[28];
assign const_conditional_wrapper_in_flat[21] = const_arith_wrapper_out_flat[32];
assign const_shift_wrapper_in_flat[9] = const_arith_wrapper_out_flat[35];
assign conditional_wrapper_in_flat[1] = const_compare_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[18] = const_compare_wrapper_out_flat[5];
assign relational_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[7];
assign shift_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[12];
assign array_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[14];
assign select_wrapper_in_flat[19] = const_concat_repl_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[15];
assign const_compare_wrapper_in_flat[18] = const_concat_repl_wrapper_out_flat[16];
assign arithmetic_reduce_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[19];
assign width_enum_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[20];
assign const_conditional_wrapper_in_flat[20] = const_concat_repl_wrapper_out_flat[20];
assign width_logic_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[1];
assign shift_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[5];
assign select_wrapper_in_flat[18] = const_conditional_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[16];
assign width_struct_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[17];
assign relational_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[18];
assign width_union_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[21];
assign width_enum_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[22];
assign width_enum_wrapper_in_flat[2] = const_logic_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[6] = const_logic_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[5] = const_logic_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[5] = const_logic_wrapper_out_flat[5];
assign select_wrapper_in_flat[13] = const_logic_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[20] = const_logic_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[5] = const_logic_wrapper_out_flat[11];
assign const_arith_wrapper_in_flat[15] = const_logic_wrapper_out_flat[17];
assign relational_wrapper_in_flat[2] = const_logic_wrapper_out_flat[17];
assign shift_wrapper_in_flat[5] = const_logic_wrapper_out_flat[18];
assign const_reduce_wrapper_in_flat[0] = const_nested_wrapper_out_flat[3];
assign select_wrapper_in_flat[8] = const_nested_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[16] = const_partselect_wrapper_out_flat[3];
assign cast_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[7] = const_shift_wrapper_out_flat[0];
assign array_wrapper_in_flat[9] = const_shift_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[18] = const_shift_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[12] = const_shift_wrapper_out_flat[10];
assign cast_wrapper_in_flat[6] = const_shift_wrapper_out_flat[12];
assign const_shift_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[4];
assign array_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[12];
assign arithmetic_reduce_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[15];
assign const_reduce_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[16];
assign conditional_wrapper_in_flat[8] = partselect_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[14] = relational_wrapper_out_flat[5];
assign array_wrapper_in_flat[0] = relational_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[2] = shift_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[3] = shift_wrapper_out_flat[7];
assign select_wrapper_in_flat[11] = shift_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[12] = shift_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[15] = shift_wrapper_out_flat[14];
assign const_reduce_wrapper_in_flat[3] = shift_wrapper_out_flat[15];
assign partselect_wrapper_in_flat[5] = width_enum_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[13] = width_struct_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[8] = width_union_wrapper_out_flat[2];
assign cast_wrapper_in_flat[5] = width_union_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[7] = width_union_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[1] = width_union_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[11] = width_union_wrapper_out_flat[12];
