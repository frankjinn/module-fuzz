...
assign cast_wrapper_in_flat[1] = in_flat[46];
assign cast_wrapper_in_flat[2] = in_flat[47];
...
assign conditional_wrapper_in_flat[1] = in_flat[53];
...
assign const_arith_wrapper_in_flat[2] = in_flat[60];
assign const_arith_wrapper_in_flat[3] = in_flat[61];
...
assign const_compare_wrapper_in_flat[19] = in_flat[91];
assign const_compare_wrapper_in_flat[20] = in_flat[92];
assign const_compare_wrapper_in_flat[21] = in_flat[93];
assign const_compare_wrapper_in_flat[22] = in_flat[94];
assign const_compare_wrapper_in_flat[23] = in_flat[95];
assign const_concat_repl_wrapper_in_flat[0] = in_flat[96];
assign const_concat_repl_wrapper_in_flat[1] = in_flat[97];
assign const_concat_repl_wrapper_in_flat[4] = in_flat[98];
assign const_concat_repl_wrapper_in_flat[5] = in_flat[99];
assign const_concat_repl_wrapper_in_flat[6] = in_flat[100];
assign const_concat_repl_wrapper_in_flat[9] = in_flat[101];
assign const_conditional_wrapper_in_flat[0] = in_flat[102];
assign const_conditional_wrapper_in_flat[1] = in_flat[103];
assign const_conditional_wrapper_in_flat[3] = in_flat[104];
...
assign const_logic_wrapper_in_flat[2] = in_flat[132];
...
assign const_partselect_wrapper_in_flat[11] = in_flat[173];
assign const_partselect_wrapper_in_flat[12] = in_flat[174];
assign const_partselect_wrapper_in_flat[13] = in_flat[175];
assign const_partselect_wrapper_in_flat[14] = in_flat[176];
assign const_partselect_wrapper_in_flat[16] = in_flat[177];
assign const_partselect_wrapper_in_flat[17] = in_flat[178];
assign const_partselect_wrapper_in_flat[18] = in_flat[179];
assign const_reduce_wrapper_in_flat[0] = in_flat[180];
assign const_shift_wrapper_in_flat[0] = in_flat[181];
...
assign logical_op_wrapper_in_flat[1] = in_flat[186];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[187];
...
assign partselect_wrapper_in_flat[5] = in_flat[196];
...
assign partselect_wrapper_in_flat[17] = in_flat[203];
assign partselect_wrapper_in_flat[18] = in_flat[204];
assign relational_wrapper_in_flat[3] = in_flat[205];
...
assign width_logic_wrapper_in_flat[6] = in_flat[237];
...
assign width_struct_wrapper_in_flat[11] = in_flat[247];
...
assign const_shift_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[10] = arithmetic_reduce_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[11] = array_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[8] = array_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[7];
assign select_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[16];
assign relational_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[18];
assign const_concat_repl_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[23];
assign array_wrapper_in_flat[0] = cast_wrapper_out_flat[4];
assign select_wrapper_in_flat[0] = cast_wrapper_out_flat[8];
assign relational_wrapper_in_flat[4] = cast_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[13] = conditional_wrapper_out_flat[1];
assign array_wrapper_in_flat[4] = conditional_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[7] = const_arith_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[8] = const_arith_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[15] = const_arith_wrapper_out_flat[8];
assign const_logic_wrapper_in_flat[1] = const_arith_wrapper_out_flat[19];
assign const_conditional_wrapper_in_flat[15] = const_arith_wrapper_out_flat[21];
assign const_partselect_wrapper_in_flat[15] = const_arith_wrapper_out_flat[24];
assign cast_wrapper_in_flat[3] = const_arith_wrapper_out_flat[34];
assign select_wrapper_in_flat[14] = const_arith_wrapper_out_flat[34];
assign width_logic_wrapper_in_flat[0] = const_arith_wrapper_out_flat[34];
assign width_struct_wrapper_in_flat[8] = const_arith_wrapper_out_flat[38];
assign width_union_wrapper_in_flat[15] = const_arith_wrapper_out_flat[39];
assign bitwise_logic_wrapper_in_flat[11] = const_compare_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[14] = const_compare_wrapper_out_flat[3];
assign array_wrapper_in_flat[8] = const_compare_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[4] = const_compare_wrapper_out_flat[7];
assign relational_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[8];
assign select_wrapper_in_flat[19] = const_concat_repl_wrapper_out_flat[11];
assign partselect_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[14];
assign conditional_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[15];
assign const_conditional_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[17];
assign cast_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[18];
assign cast_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[6];
assign shift_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[10];
assign const_shift_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[12];
assign relational_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[16];
assign const_compare_wrapper_in_flat[5] = const_logic_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[7] = const_logic_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[21] = const_logic_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[12] = const_logic_wrapper_out_flat[7];
assign relational_wrapper_in_flat[2] = const_logic_wrapper_out_flat[8];
assign const_shift_wrapper_in_flat[10] = const_logic_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[0] = const_logic_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[7] = const_logic_wrapper_out_flat[12];
assign width_enum_wrapper_in_flat[1] = const_logic_wrapper_out_flat[13];
assign const_concat_repl_wrapper_in_flat[3] = const_nested_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[3] = const_nested_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[0];
assign shift_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[1];
assign shift_wrapper_in_flat[10] = const_shift_wrapper_out_flat[8];
assign select_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[13];
assign cast_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[17];
assign const_shift_wrapper_in_flat[1] = partselect_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[2] = relational_wrapper_out_flat[1];
assign select_wrapper_in_flat[6] = relational_wrapper_out_flat[2];
assign array_wrapper_in_flat[11] = relational_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[7] = select_wrapper_out_flat[7];
assign array_wrapper_in_flat[6] = select_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[2] = select_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[6] = shift_wrapper_out_flat[4];
assign logical_op_wrapper_in_flat[0] = shift_wrapper_out_flat[15];
assign const_conditional_wrapper_in_flat[19] = width_enum_wrapper_out_flat[1];
...
assign conditional_wrapper_in_flat[4] = width_struct_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[3] = width_struct_wrapper_out_flat[6];
assign array_wrapper_in_flat[16] = width_struct_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[7] = width_union_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[11] = width_union_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[2] = width_union_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[13] = width_union_wrapper_out_flat[12];
assign conditional_wrapper_in_flat[0] = width_union_wrapper_out_flat[12];
