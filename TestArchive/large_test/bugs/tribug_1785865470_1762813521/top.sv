...
assign bitwise_reduce_wrapper_in_flat[0] = in_flat[41];
...
assign cast_wrapper_in_flat[10] = in_flat[53];
assign cast_wrapper_in_flat[11] = in_flat[54];
assign conditional_wrapper_in_flat[3] = in_flat[55];
assign conditional_wrapper_in_flat[5] = in_flat[56];
assign conditional_wrapper_in_flat[6] = in_flat[57];
assign conditional_wrapper_in_flat[7] = in_flat[58];
...
assign const_logic_wrapper_in_flat[3] = in_flat[136];
assign const_logic_wrapper_in_flat[4] = in_flat[137];
assign const_logic_wrapper_in_flat[5] = in_flat[138];
assign const_logic_wrapper_in_flat[6] = in_flat[139];
assign const_logic_wrapper_in_flat[7] = in_flat[140];
assign const_logic_wrapper_in_flat[8] = in_flat[141];
...
assign const_nested_wrapper_in_flat[4] = in_flat[147];
assign const_nested_wrapper_in_flat[5] = in_flat[148];
assign const_nested_wrapper_in_flat[6] = in_flat[149];
assign const_nested_wrapper_in_flat[7] = in_flat[150];
...
assign const_nested_wrapper_in_flat[14] = in_flat[156];
assign const_nested_wrapper_in_flat[16] = in_flat[157];
assign const_nested_wrapper_in_flat[17] = in_flat[158];
assign const_nested_wrapper_in_flat[19] = in_flat[159];
assign const_nested_wrapper_in_flat[20] = in_flat[160];
assign const_nested_wrapper_in_flat[21] = in_flat[161];
assign const_nested_wrapper_in_flat[22] = in_flat[162];
assign const_nested_wrapper_in_flat[23] = in_flat[163];
assign const_nested_wrapper_in_flat[24] = in_flat[164];
assign const_nested_wrapper_in_flat[25] = in_flat[165];
assign const_nested_wrapper_in_flat[26] = in_flat[166];
assign const_partselect_wrapper_in_flat[2] = in_flat[167];
...
assign const_partselect_wrapper_in_flat[9] = in_flat[171];
assign const_partselect_wrapper_in_flat[10] = in_flat[172];
...
assign const_partselect_wrapper_in_flat[18] = in_flat[178];
assign const_partselect_wrapper_in_flat[19] = in_flat[179];
...
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[189];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[190];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[191];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[192];
...
assign partselect_wrapper_in_flat[2] = in_flat[196];
assign partselect_wrapper_in_flat[3] = in_flat[197];
...
assign partselect_wrapper_in_flat[8] = in_flat[201];
assign partselect_wrapper_in_flat[9] = in_flat[202];
assign partselect_wrapper_in_flat[11] = in_flat[203];
assign partselect_wrapper_in_flat[12] = in_flat[204];
...
assign relational_wrapper_in_flat[1] = in_flat[208];
...
assign select_wrapper_in_flat[9] = in_flat[217];
assign select_wrapper_in_flat[10] = in_flat[218];
...
assign width_logic_wrapper_in_flat[1] = in_flat[234];
...
assign width_union_wrapper_in_flat[14] = in_flat[257];
assign width_union_wrapper_in_flat[15] = in_flat[258];

// Internal MTM connections (module-to-module)
assign array_wrapper_in_flat[15] = arithmetic_reduce_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[6] = array_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[1] = array_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[5] = array_wrapper_out_flat[7];
assign relational_wrapper_in_flat[7] = array_wrapper_out_flat[11];
assign select_wrapper_in_flat[0] = array_wrapper_out_flat[12];
assign width_struct_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[5];
assign relational_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[19];
assign select_wrapper_in_flat[19] = bitwise_logic_wrapper_out_flat[21];
assign array_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[23];
assign const_reduce_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[10] = cast_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[0] = cast_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[10] = cast_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[4] = cast_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[7] = conditional_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[14] = conditional_wrapper_out_flat[0];
assign relational_wrapper_in_flat[0] = const_arith_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[1] = const_arith_wrapper_out_flat[22];
assign partselect_wrapper_in_flat[14] = const_arith_wrapper_out_flat[24];
assign bitwise_reduce_wrapper_in_flat[4] = const_compare_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[2] = const_compare_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[0] = const_compare_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[6];
assign array_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[19];
assign partselect_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[3];
assign select_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[4];
assign cast_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[16];
assign conditional_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[22];
assign partselect_wrapper_in_flat[18] = const_logic_wrapper_out_flat[1];
...
assign const_conditional_wrapper_in_flat[30] = const_logic_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[6] = const_logic_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[6] = const_logic_wrapper_out_flat[11];
assign cast_wrapper_in_flat[0] = const_logic_wrapper_out_flat[13];
assign shift_wrapper_in_flat[7] = const_nested_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[4] = const_nested_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[9] = const_reduce_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[2];
assign relational_wrapper_in_flat[3] = const_shift_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[2] = const_shift_wrapper_out_flat[4];
assign logical_op_wrapper_in_flat[1] = const_shift_wrapper_out_flat[4];
assign select_wrapper_in_flat[7] = const_shift_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[11] = const_shift_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[1] = const_shift_wrapper_out_flat[19];
assign const_concat_repl_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[21] = numbers_concat_repl_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[15];
assign const_arith_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[17];
assign logical_op_wrapper_in_flat[0] = partselect_wrapper_out_flat[8];
assign cast_wrapper_in_flat[3] = partselect_wrapper_out_flat[8];
assign width_enum_wrapper_in_flat[0] = relational_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[15] = relational_wrapper_out_flat[4];
assign select_wrapper_in_flat[13] = relational_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[8] = relational_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[3] = select_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[18] = select_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[7] = shift_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[1] = shift_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[0] = width_enum_wrapper_out_flat[1];
assign select_wrapper_in_flat[17] = width_enum_wrapper_out_flat[2];
assign shift_wrapper_in_flat[8] = width_enum_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[7] = width_struct_wrapper_out_flat[1];
assign shift_wrapper_in_flat[2] = width_struct_wrapper_out_flat[6];
assign select_wrapper_in_flat[8] = width_struct_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[8] = width_struct_wrapper_out_flat[11];
assign relational_wrapper_in_flat[4] = width_union_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[7] = width_union_wrapper_out_flat[9];
assign shift_wrapper_in_flat[10] = width_union_wrapper_out_flat[13];
