...
assign const_concat_repl_wrapper_in_flat[6] = in_flat[94];
...
assign const_reduce_wrapper_in_flat[1] = in_flat[180];
assign const_shift_wrapper_in_flat[0] = in_flat[181];
assign const_shift_wrapper_in_flat[1] = in_flat[182];
assign const_shift_wrapper_in_flat[2] = in_flat[183];
assign const_shift_wrapper_in_flat[3] = in_flat[184];
assign const_shift_wrapper_in_flat[4] = in_flat[185];
assign const_shift_wrapper_in_flat[5] = in_flat[186];
...
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[191];
...
assign width_struct_wrapper_in_flat[8] = in_flat[249];
...
assign shift_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[5];
assign cast_wrapper_in_flat[10] = arithmetic_reduce_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[9];
assign partselect_wrapper_in_flat[15] = bitwise_logic_wrapper_out_flat[10];
assign const_logic_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[16];
assign shift_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[20];
assign const_nested_wrapper_in_flat[18] = bitwise_reduce_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[11] = bitwise_reduce_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[1] = cast_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[7] = cast_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[15] = cast_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[22] = cast_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[2] = conditional_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[1] = conditional_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[5] = const_arith_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[9] = const_arith_wrapper_out_flat[2];
assign shift_wrapper_in_flat[3] = const_arith_wrapper_out_flat[6];
assign relational_wrapper_in_flat[1] = const_arith_wrapper_out_flat[10];
assign bitwise_logic_wrapper_in_flat[0] = const_arith_wrapper_out_flat[12];
assign partselect_wrapper_in_flat[3] = const_arith_wrapper_out_flat[14];
assign const_logic_wrapper_in_flat[7] = const_arith_wrapper_out_flat[33];
assign width_union_wrapper_in_flat[2] = const_compare_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[13];
assign bitwise_logic_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[16];
assign shift_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[17];
assign const_shift_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[18];
assign const_logic_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[9];
assign bitwise_logic_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[17];
assign partselect_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[18];
assign width_logic_wrapper_in_flat[0] = const_logic_wrapper_out_flat[2];
assign cast_wrapper_in_flat[8] = const_logic_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[7] = const_logic_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[3] = const_logic_wrapper_out_flat[8];
assign logical_op_wrapper_in_flat[0] = const_logic_wrapper_out_flat[14];
assign numbers_concat_repl_wrapper_in_flat[0] = const_logic_wrapper_out_flat[14];
assign array_wrapper_in_flat[9] = const_nested_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[8] = const_nested_wrapper_out_flat[5];
assign cast_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[13] = const_partselect_wrapper_out_flat[3];
assign relational_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[1];
assign relational_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[18] = const_reduce_wrapper_out_flat[4];
assign cast_wrapper_in_flat[7] = const_reduce_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[11] = const_reduce_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[6] = const_shift_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[20] = const_shift_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[7] = const_shift_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[7] = const_shift_wrapper_out_flat[19];
assign const_reduce_wrapper_in_flat[0] = const_shift_wrapper_out_flat[21];
assign select_wrapper_in_flat[13] = logical_op_wrapper_out_flat[2];
assign relational_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[8];
assign cast_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[10];
assign const_compare_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[1] = partselect_wrapper_out_flat[1];
assign cast_wrapper_in_flat[3] = relational_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[2] = shift_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[3] = shift_wrapper_out_flat[8];
assign numbers_concat_repl_wrapper_in_flat[2] = shift_wrapper_out_flat[15];
assign bitwise_reduce_wrapper_in_flat[5] = width_enum_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[4] = width_enum_wrapper_out_flat[2];
assign select_wrapper_in_flat[16] = width_enum_wrapper_out_flat[2];
assign array_wrapper_in_flat[3] = width_logic_wrapper_out_flat[5];
assign cast_wrapper_in_flat[2] = width_struct_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[10] = width_struct_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[19] = width_struct_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[2] = width_union_wrapper_out_flat[2];
