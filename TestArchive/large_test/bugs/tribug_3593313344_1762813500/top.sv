...
assign const_concat_repl_wrapper_in_flat[2] = in_flat[92];
assign const_concat_repl_wrapper_in_flat[3] = in_flat[93];
assign const_concat_repl_wrapper_in_flat[4] = in_flat[94];
assign const_concat_repl_wrapper_in_flat[5] = in_flat[95];
...
assign const_nested_wrapper_in_flat[8] = in_flat[145];
...
assign const_nested_wrapper_in_flat[16] = in_flat[151];
assign const_nested_wrapper_in_flat[17] = in_flat[152];
assign const_nested_wrapper_in_flat[18] = in_flat[153];
assign const_nested_wrapper_in_flat[19] = in_flat[154];
...
assign const_partselect_wrapper_in_flat[8] = in_flat[170];
...
assign const_reduce_wrapper_in_flat[2] = in_flat[181];
assign const_reduce_wrapper_in_flat[3] = in_flat[182];
...
assign const_shift_wrapper_in_flat[6] = in_flat[187];
...
assign const_shift_wrapper_in_flat[10] = in_flat[191];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[192];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[193];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[194];
...
assign partselect_wrapper_in_flat[11] = in_flat[206];
assign partselect_wrapper_in_flat[12] = in_flat[207];
assign partselect_wrapper_in_flat[13] = in_flat[208];
assign partselect_wrapper_in_flat[14] = in_flat[209];
...
assign relational_wrapper_in_flat[1] = in_flat[214];
assign relational_wrapper_in_flat[2] = in_flat[215];
assign relational_wrapper_in_flat[5] = in_flat[216];
assign relational_wrapper_in_flat[6] = in_flat[217];
assign relational_wrapper_in_flat[7] = in_flat[218];
assign select_wrapper_in_flat[0] = in_flat[219];
assign select_wrapper_in_flat[1] = in_flat[220];
assign select_wrapper_in_flat[2] = in_flat[221];
assign select_wrapper_in_flat[3] = in_flat[222];
assign select_wrapper_in_flat[4] = in_flat[223];
assign select_wrapper_in_flat[5] = in_flat[224];
assign select_wrapper_in_flat[6] = in_flat[225];
assign select_wrapper_in_flat[7] = in_flat[226];
assign select_wrapper_in_flat[8] = in_flat[227];
assign select_wrapper_in_flat[9] = in_flat[228];
assign select_wrapper_in_flat[10] = in_flat[229];
assign select_wrapper_in_flat[11] = in_flat[230];
assign select_wrapper_in_flat[12] = in_flat[231];
assign select_wrapper_in_flat[13] = in_flat[232];
assign select_wrapper_in_flat[14] = in_flat[233];
assign select_wrapper_in_flat[16] = in_flat[234];
assign select_wrapper_in_flat[17] = in_flat[235];
assign select_wrapper_in_flat[18] = in_flat[236];
...
assign width_enum_wrapper_in_flat[0] = in_flat[248];
...
assign width_struct_wrapper_in_flat[0] = in_flat[254];
assign width_struct_wrapper_in_flat[1] = in_flat[255];
assign width_struct_wrapper_in_flat[2] = in_flat[256];
assign width_struct_wrapper_in_flat[4] = in_flat[257];
assign width_struct_wrapper_in_flat[5] = in_flat[258];
assign width_struct_wrapper_in_flat[6] = in_flat[259];
assign width_struct_wrapper_in_flat[7] = in_flat[260];
assign width_struct_wrapper_in_flat[8] = in_flat[261];
assign width_struct_wrapper_in_flat[9] = in_flat[262];
assign width_struct_wrapper_in_flat[10] = in_flat[263];
assign width_union_wrapper_in_flat[1] = in_flat[264];
assign width_union_wrapper_in_flat[2] = in_flat[265];
assign width_union_wrapper_in_flat[3] = in_flat[266];
assign width_union_wrapper_in_flat[4] = in_flat[267];
assign width_union_wrapper_in_flat[5] = in_flat[268];
assign width_union_wrapper_in_flat[6] = in_flat[269];
assign width_union_wrapper_in_flat[7] = in_flat[270];
assign width_union_wrapper_in_flat[8] = in_flat[271];
...
assign array_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[12] = arithmetic_reduce_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[6] = array_wrapper_out_flat[11];
assign relational_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[9];
assign array_wrapper_in_flat[13] = bitwise_reduce_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[1] = cast_wrapper_out_flat[2];
assign array_wrapper_in_flat[9] = cast_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[4] = cast_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[6] = conditional_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[2] = const_arith_wrapper_out_flat[14];
assign width_struct_wrapper_in_flat[3] = const_arith_wrapper_out_flat[32];
assign logical_op_wrapper_in_flat[0] = const_compare_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[6] = const_compare_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[13] = const_compare_wrapper_out_flat[4];
assign array_wrapper_in_flat[16] = const_compare_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[6];
assign select_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[9];
assign cast_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[10];
assign shift_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[19] = const_conditional_wrapper_out_flat[16];
assign const_shift_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[20];
assign const_arith_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[22];
assign width_union_wrapper_in_flat[9] = const_logic_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[4] = const_logic_wrapper_out_flat[11];
assign arithmetic_reduce_wrapper_in_flat[13] = const_logic_wrapper_out_flat[11];
assign cast_wrapper_in_flat[7] = const_nested_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[15] = const_nested_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[0];
assign cast_wrapper_in_flat[8] = const_shift_wrapper_out_flat[11];
assign numbers_concat_repl_wrapper_in_flat[0] = const_shift_wrapper_out_flat[14];
assign width_logic_wrapper_in_flat[1] = const_shift_wrapper_out_flat[17];
assign width_enum_wrapper_in_flat[1] = logical_op_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[14] = numbers_concat_repl_wrapper_out_flat[0];
assign cast_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[12] = numbers_concat_repl_wrapper_out_flat[16];
assign array_wrapper_in_flat[17] = numbers_concat_repl_wrapper_out_flat[17];
assign const_logic_wrapper_in_flat[4] = partselect_wrapper_out_flat[2];
...
assign arithmetic_reduce_wrapper_in_flat[7] = shift_wrapper_out_flat[8];
assign const_logic_wrapper_in_flat[9] = shift_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[11] = shift_wrapper_out_flat[12];
assign const_arith_wrapper_in_flat[14] = shift_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[16] = shift_wrapper_out_flat[13];
assign const_reduce_wrapper_in_flat[1] = width_logic_wrapper_out_flat[2];
assign cast_wrapper_in_flat[6] = width_logic_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[22] = width_logic_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[11] = width_logic_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[15] = width_struct_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[1] = width_struct_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[8] = width_struct_wrapper_out_flat[5];
assign cast_wrapper_in_flat[11] = width_struct_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[5] = width_struct_wrapper_out_flat[10];
assign relational_wrapper_in_flat[3] = width_union_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[14] = width_union_wrapper_out_flat[13];
