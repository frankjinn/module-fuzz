...
assign const_compare_wrapper_in_flat[8] = in_flat[80];
assign const_compare_wrapper_in_flat[9] = in_flat[81];
assign const_compare_wrapper_in_flat[10] = in_flat[82];
assign const_compare_wrapper_in_flat[11] = in_flat[83];
...
assign const_concat_repl_wrapper_in_flat[3] = in_flat[96];
assign const_concat_repl_wrapper_in_flat[4] = in_flat[97];
assign const_concat_repl_wrapper_in_flat[6] = in_flat[98];
assign const_concat_repl_wrapper_in_flat[7] = in_flat[99];
assign const_concat_repl_wrapper_in_flat[8] = in_flat[100];
...
assign const_conditional_wrapper_in_flat[10] = in_flat[112];
...
assign const_conditional_wrapper_in_flat[18] = in_flat[118];
assign const_conditional_wrapper_in_flat[19] = in_flat[119];
assign const_conditional_wrapper_in_flat[20] = in_flat[120];
...
assign const_nested_wrapper_in_flat[18] = in_flat[157];
assign const_nested_wrapper_in_flat[19] = in_flat[158];
assign const_nested_wrapper_in_flat[20] = in_flat[159];
assign const_nested_wrapper_in_flat[21] = in_flat[160];
assign const_nested_wrapper_in_flat[22] = in_flat[161];
...
assign const_partselect_wrapper_in_flat[0] = in_flat[165];
...
assign const_partselect_wrapper_in_flat[8] = in_flat[172];
...
assign const_partselect_wrapper_in_flat[15] = in_flat[178];
assign const_partselect_wrapper_in_flat[16] = in_flat[179];
assign const_partselect_wrapper_in_flat[17] = in_flat[180];
assign const_partselect_wrapper_in_flat[18] = in_flat[181];
assign const_partselect_wrapper_in_flat[19] = in_flat[182];
assign const_reduce_wrapper_in_flat[3] = in_flat[183];
...
assign const_shift_wrapper_in_flat[7] = in_flat[188];
assign const_shift_wrapper_in_flat[9] = in_flat[189];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[190];
...
assign partselect_wrapper_in_flat[6] = in_flat[197];
assign partselect_wrapper_in_flat[7] = in_flat[198];
assign partselect_wrapper_in_flat[8] = in_flat[199];
...
assign partselect_wrapper_in_flat[17] = in_flat[206];
assign partselect_wrapper_in_flat[18] = in_flat[207];
assign relational_wrapper_in_flat[0] = in_flat[208];
assign relational_wrapper_in_flat[2] = in_flat[209];
assign relational_wrapper_in_flat[3] = in_flat[210];
...
assign select_wrapper_in_flat[6] = in_flat[219];
assign select_wrapper_in_flat[7] = in_flat[220];
assign select_wrapper_in_flat[8] = in_flat[221];
assign select_wrapper_in_flat[9] = in_flat[222];
assign select_wrapper_in_flat[11] = in_flat[223];
...
assign width_logic_wrapper_in_flat[0] = in_flat[238];
assign width_logic_wrapper_in_flat[2] = in_flat[239];
assign width_logic_wrapper_in_flat[3] = in_flat[240];
assign width_struct_wrapper_in_flat[0] = in_flat[241];
assign width_struct_wrapper_in_flat[1] = in_flat[242];
...
assign width_struct_wrapper_in_flat[10] = in_flat[248];
...
assign width_union_wrapper_in_flat[3] = in_flat[253];
assign width_union_wrapper_in_flat[4] = in_flat[254];
...
assign width_union_wrapper_in_flat[11] = in_flat[259];
assign width_union_wrapper_in_flat[12] = in_flat[260];
...
assign cast_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[27] = arithmetic_reduce_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[12] = arithmetic_reduce_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[9];
assign logical_op_wrapper_in_flat[1] = array_wrapper_out_flat[10];
assign const_logic_wrapper_in_flat[8] = array_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[10];
assign width_union_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[10];
assign numbers_concat_repl_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[0];
assign select_wrapper_in_flat[14] = bitwise_reduce_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[0];
assign shift_wrapper_in_flat[5] = cast_wrapper_out_flat[9];
assign relational_wrapper_in_flat[1] = conditional_wrapper_out_flat[1];
assign select_wrapper_in_flat[5] = conditional_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[9] = conditional_wrapper_out_flat[2];
assign array_wrapper_in_flat[4] = conditional_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[13] = const_arith_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[5] = const_arith_wrapper_out_flat[4];
assign shift_wrapper_in_flat[4] = const_arith_wrapper_out_flat[11];
assign arithmetic_reduce_wrapper_in_flat[5] = const_arith_wrapper_out_flat[19];
assign bitwise_logic_wrapper_in_flat[11] = const_arith_wrapper_out_flat[22];
assign const_compare_wrapper_in_flat[4] = const_arith_wrapper_out_flat[26];
assign partselect_wrapper_in_flat[9] = const_arith_wrapper_out_flat[31];
assign array_wrapper_in_flat[10] = const_arith_wrapper_out_flat[37];
assign shift_wrapper_in_flat[9] = const_compare_wrapper_out_flat[1];
assign array_wrapper_in_flat[9] = const_compare_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[10];
assign const_shift_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[19];
assign width_union_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[19];
assign arithmetic_reduce_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[21];
assign numbers_concat_repl_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[18];
assign partselect_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[19];
assign const_nested_wrapper_in_flat[8] = const_logic_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[7] = const_logic_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[8] = const_nested_wrapper_out_flat[0];
assign select_wrapper_in_flat[12] = const_partselect_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[4];
assign array_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[3];
assign array_wrapper_in_flat[13] = const_shift_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[5] = const_shift_wrapper_out_flat[21];
assign select_wrapper_in_flat[10] = logical_op_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[1];
assign cast_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[24] = numbers_concat_repl_wrapper_out_flat[16];
assign shift_wrapper_in_flat[2] = partselect_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[6] = partselect_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[4] = partselect_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[3] = partselect_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[21] = partselect_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[4] = partselect_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[1] = relational_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[6] = select_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[2] = select_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[2] = shift_wrapper_out_flat[1];
assign array_wrapper_in_flat[11] = shift_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[0] = shift_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[2] = width_enum_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[1] = width_enum_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[10] = width_logic_wrapper_out_flat[4];
assign relational_wrapper_in_flat[5] = width_union_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[11] = width_union_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[1] = width_union_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[22] = width_union_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[0] = width_union_wrapper_out_flat[7];
assign cast_wrapper_in_flat[7] = width_union_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[8] = width_union_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[2] = width_union_wrapper_out_flat[8];
