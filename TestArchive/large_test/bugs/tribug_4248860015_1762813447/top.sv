...
assign bitwise_logic_wrapper_in_flat[3] = in_flat[29];
...
assign cast_wrapper_in_flat[9] = in_flat[51];
...
assign conditional_wrapper_in_flat[4] = in_flat[55];
assign conditional_wrapper_in_flat[5] = in_flat[56];
...
assign const_compare_wrapper_in_flat[6] = in_flat[78];
assign const_compare_wrapper_in_flat[7] = in_flat[79];
...
assign const_conditional_wrapper_in_flat[14] = in_flat[107];
assign const_conditional_wrapper_in_flat[15] = in_flat[108];
assign const_conditional_wrapper_in_flat[16] = in_flat[109];
assign const_conditional_wrapper_in_flat[17] = in_flat[110];
...
assign const_nested_wrapper_in_flat[5] = in_flat[138];
assign const_nested_wrapper_in_flat[6] = in_flat[139];
...
assign const_nested_wrapper_in_flat[19] = in_flat[149];
assign const_nested_wrapper_in_flat[20] = in_flat[150];
assign const_nested_wrapper_in_flat[21] = in_flat[151];
assign const_nested_wrapper_in_flat[22] = in_flat[152];
assign const_nested_wrapper_in_flat[23] = in_flat[153];
assign const_nested_wrapper_in_flat[24] = in_flat[154];
assign const_nested_wrapper_in_flat[25] = in_flat[155];
assign const_nested_wrapper_in_flat[26] = in_flat[156];
assign const_partselect_wrapper_in_flat[0] = in_flat[157];
assign const_partselect_wrapper_in_flat[1] = in_flat[158];
...
assign const_partselect_wrapper_in_flat[15] = in_flat[170];
assign const_partselect_wrapper_in_flat[16] = in_flat[171];
assign const_partselect_wrapper_in_flat[18] = in_flat[172];
assign const_partselect_wrapper_in_flat[19] = in_flat[173];
assign const_reduce_wrapper_in_flat[0] = in_flat[174];
assign const_reduce_wrapper_in_flat[1] = in_flat[175];
...
assign const_shift_wrapper_in_flat[3] = in_flat[179];
assign const_shift_wrapper_in_flat[4] = in_flat[180];
...
assign select_wrapper_in_flat[16] = in_flat[220];
...
assign shift_wrapper_in_flat[7] = in_flat[229];
assign shift_wrapper_in_flat[8] = in_flat[230];
...
assign width_struct_wrapper_in_flat[8] = in_flat[242];
assign width_struct_wrapper_in_flat[9] = in_flat[243];
assign width_struct_wrapper_in_flat[10] = in_flat[244];
assign width_union_wrapper_in_flat[0] = in_flat[245];
assign width_union_wrapper_in_flat[1] = in_flat[246];
...
assign const_concat_repl_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[14] = arithmetic_reduce_wrapper_out_flat[8];
assign width_enum_wrapper_in_flat[3] = array_wrapper_out_flat[9];
assign numbers_concat_repl_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[19] = bitwise_logic_wrapper_out_flat[4];
assign select_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[10];
assign relational_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[14];
assign width_union_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[18];
assign const_nested_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[21];
assign shift_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[1] = cast_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[13] = cast_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[7] = cast_wrapper_out_flat[4];
assign select_wrapper_in_flat[13] = cast_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[33] = cast_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[3] = cast_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[5] = conditional_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[1] = const_arith_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[0] = const_arith_wrapper_out_flat[9];
assign cast_wrapper_in_flat[10] = const_arith_wrapper_out_flat[17];
assign const_reduce_wrapper_in_flat[3] = const_arith_wrapper_out_flat[19];
assign partselect_wrapper_in_flat[17] = const_arith_wrapper_out_flat[20];
assign const_nested_wrapper_in_flat[7] = const_arith_wrapper_out_flat[35];
assign relational_wrapper_in_flat[4] = const_compare_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[11] = const_compare_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[3] = const_compare_wrapper_out_flat[7];
assign array_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[2];
assign relational_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[12];
assign logical_op_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[14];
assign width_enum_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[19];
assign arithmetic_reduce_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[23];
assign select_wrapper_in_flat[11] = const_logic_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[4] = const_logic_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[16] = const_logic_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[7] = const_logic_wrapper_out_flat[12];
assign cast_wrapper_in_flat[8] = const_logic_wrapper_out_flat[17];
assign bitwise_reduce_wrapper_in_flat[2] = const_nested_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[4] = const_nested_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[5] = const_nested_wrapper_out_flat[2];
assign select_wrapper_in_flat[14] = const_nested_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[5] = const_nested_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[4] = const_nested_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[11] = const_reduce_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[7] = const_shift_wrapper_out_flat[9];
assign cast_wrapper_in_flat[6] = const_shift_wrapper_out_flat[13];
assign partselect_wrapper_in_flat[18] = const_shift_wrapper_out_flat[15];
assign relational_wrapper_in_flat[7] = const_shift_wrapper_out_flat[20];
assign width_logic_wrapper_in_flat[5] = const_shift_wrapper_out_flat[21];
assign bitwise_logic_wrapper_in_flat[14] = const_shift_wrapper_out_flat[21];
assign arithmetic_reduce_wrapper_in_flat[15] = logical_op_wrapper_out_flat[0];
assign shift_wrapper_in_flat[10] = logical_op_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[3];
assign select_wrapper_in_flat[17] = numbers_concat_repl_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[7];
assign shift_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[17] = numbers_concat_repl_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[17];
assign bitwise_logic_wrapper_in_flat[7] = partselect_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[8] = partselect_wrapper_out_flat[6];
assign logical_op_wrapper_in_flat[0] = relational_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[0] = relational_wrapper_out_flat[5];
assign relational_wrapper_in_flat[0] = select_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[2] = select_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[13] = select_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[7] = select_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[8] = shift_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[12] = shift_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[9] = width_logic_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[8] = width_struct_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[2] = width_struct_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[4] = width_struct_wrapper_out_flat[11];
assign partselect_wrapper_in_flat[1] = width_struct_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[12] = width_union_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[6] = width_union_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[12] = width_union_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[12] = width_union_wrapper_out_flat[8];
assign const_logic_wrapper_in_flat[6] = width_union_wrapper_out_flat[15];
