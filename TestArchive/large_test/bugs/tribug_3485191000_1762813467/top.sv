...
assign conditional_wrapper_in_flat[1] = in_flat[57];
...
assign const_arith_wrapper_in_flat[5] = in_flat[67];
assign const_arith_wrapper_in_flat[6] = in_flat[68];
assign const_arith_wrapper_in_flat[7] = in_flat[69];
assign const_arith_wrapper_in_flat[8] = in_flat[70];
assign const_arith_wrapper_in_flat[9] = in_flat[71];
...
assign const_concat_repl_wrapper_in_flat[6] = in_flat[101];
...
assign const_nested_wrapper_in_flat[12] = in_flat[152];
...
assign const_reduce_wrapper_in_flat[1] = in_flat[178];
...
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[188];
...
assign select_wrapper_in_flat[9] = in_flat[221];
assign select_wrapper_in_flat[10] = in_flat[222];
assign select_wrapper_in_flat[11] = in_flat[223];
assign select_wrapper_in_flat[12] = in_flat[224];
assign select_wrapper_in_flat[13] = in_flat[225];
assign select_wrapper_in_flat[14] = in_flat[226];
assign select_wrapper_in_flat[15] = in_flat[227];
assign select_wrapper_in_flat[16] = in_flat[228];
assign select_wrapper_in_flat[17] = in_flat[229];
...
assign const_partselect_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[11] = arithmetic_reduce_wrapper_out_flat[8];
assign logical_op_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[5] = array_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[3] = array_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[0] = array_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[14] = array_wrapper_out_flat[12];
assign width_union_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[19] = bitwise_logic_wrapper_out_flat[14];
assign width_struct_wrapper_in_flat[9] = bitwise_reduce_wrapper_out_flat[1];
assign array_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[4] = cast_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[3] = cast_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[2] = cast_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[11] = cast_wrapper_out_flat[10];
assign relational_wrapper_in_flat[7] = cast_wrapper_out_flat[11];
assign width_enum_wrapper_in_flat[0] = conditional_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[9] = const_arith_wrapper_out_flat[13];
assign bitwise_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[13];
assign arithmetic_reduce_wrapper_in_flat[12] = const_arith_wrapper_out_flat[31];
assign const_nested_wrapper_in_flat[22] = const_arith_wrapper_out_flat[33];
assign numbers_concat_repl_wrapper_in_flat[4] = const_arith_wrapper_out_flat[36];
assign const_partselect_wrapper_in_flat[7] = const_compare_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[2];
assign select_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[11];
assign arithmetic_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[13];
assign bitwise_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[17];
assign width_enum_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[19];
assign width_struct_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[20];
assign const_concat_repl_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[1];
assign shift_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[15];
assign const_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[17];
assign const_compare_wrapper_in_flat[18] = const_conditional_wrapper_out_flat[19];
assign const_nested_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[21];
assign width_struct_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[22];
...
assign bitwise_logic_wrapper_in_flat[2] = const_logic_wrapper_out_flat[17];
assign const_shift_wrapper_in_flat[2] = const_logic_wrapper_out_flat[17];
assign const_partselect_wrapper_in_flat[18] = const_nested_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[16] = const_nested_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[7] = const_nested_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[1];
assign shift_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[1];
assign relational_wrapper_in_flat[3] = const_shift_wrapper_out_flat[12];
assign width_union_wrapper_in_flat[12] = const_shift_wrapper_out_flat[18];
assign const_conditional_wrapper_in_flat[27] = const_shift_wrapper_out_flat[22];
assign conditional_wrapper_in_flat[0] = const_shift_wrapper_out_flat[23];
assign select_wrapper_in_flat[18] = logical_op_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[10];
assign const_reduce_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[11];
assign bitwise_reduce_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[12];
assign width_logic_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[13];
assign const_conditional_wrapper_in_flat[22] = numbers_concat_repl_wrapper_out_flat[15];
assign const_arith_wrapper_in_flat[14] = partselect_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[1] = partselect_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[10] = relational_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[0] = relational_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[3] = relational_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[9] = relational_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[4] = shift_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[9] = shift_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[6] = width_enum_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[3] = width_enum_wrapper_out_flat[1];
assign array_wrapper_in_flat[12] = width_enum_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[13] = width_logic_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[7] = width_logic_wrapper_out_flat[1];
assign select_wrapper_in_flat[19] = width_logic_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[9] = width_logic_wrapper_out_flat[3];
assign array_wrapper_in_flat[11] = width_logic_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[18] = width_struct_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[0] = width_struct_wrapper_out_flat[8];
assign shift_wrapper_in_flat[5] = width_union_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[3] = width_union_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[6] = width_union_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[3] = width_union_wrapper_out_flat[15];
