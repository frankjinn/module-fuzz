...
assign conditional_wrapper_in_flat[0] = in_flat[56];
...
assign relational_wrapper_in_flat[0] = in_flat[204];
...
assign width_enum_wrapper_in_flat[0] = in_flat[236];
...
assign width_logic_wrapper_in_flat[6] = in_flat[241];
...
assign conditional_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[5];
assign array_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[9];
assign numbers_concat_repl_wrapper_in_flat[3] = array_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[1] = array_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[4] = array_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[4] = array_wrapper_out_flat[12];
assign const_concat_repl_wrapper_in_flat[9] = array_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[22] = bitwise_logic_wrapper_out_flat[0];
assign relational_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[12] = bitwise_logic_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[17] = bitwise_logic_wrapper_out_flat[9];
assign width_union_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[16];
assign numbers_concat_repl_wrapper_in_flat[1] = cast_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[15] = cast_wrapper_out_flat[3];
assign relational_wrapper_in_flat[1] = cast_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[9] = cast_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[12] = cast_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[16] = const_arith_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[32] = const_arith_wrapper_out_flat[6];
assign array_wrapper_in_flat[14] = const_arith_wrapper_out_flat[19];
assign shift_wrapper_in_flat[10] = const_arith_wrapper_out_flat[30];
assign arithmetic_reduce_wrapper_in_flat[7] = const_arith_wrapper_out_flat[32];
assign relational_wrapper_in_flat[4] = const_arith_wrapper_out_flat[35];
assign const_partselect_wrapper_in_flat[19] = const_compare_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[13] = const_compare_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[8] = const_compare_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[2] = const_compare_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[4] = const_compare_wrapper_out_flat[7];
assign select_wrapper_in_flat[18] = const_concat_repl_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[0];
assign array_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[17];
assign width_struct_wrapper_in_flat[3] = const_logic_wrapper_out_flat[5];
assign select_wrapper_in_flat[5] = const_logic_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[4] = const_logic_wrapper_out_flat[10];
assign logical_op_wrapper_in_flat[0] = const_logic_wrapper_out_flat[13];
assign const_reduce_wrapper_in_flat[3] = const_logic_wrapper_out_flat[16];
assign conditional_wrapper_in_flat[5] = const_nested_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[4];
...
assign const_conditional_wrapper_in_flat[15] = const_shift_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[6] = const_shift_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[1] = const_shift_wrapper_out_flat[16];
assign const_arith_wrapper_in_flat[2] = const_shift_wrapper_out_flat[21];
assign bitwise_logic_wrapper_in_flat[2] = const_shift_wrapper_out_flat[23];
assign width_enum_wrapper_in_flat[1] = logical_op_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[2] = logical_op_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[1] = logical_op_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[6] = logical_op_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[7];
assign shift_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[17] = numbers_concat_repl_wrapper_out_flat[16];
assign logical_op_wrapper_in_flat[1] = partselect_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[1] = partselect_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[8] = partselect_wrapper_out_flat[8];
assign const_conditional_wrapper_in_flat[8] = relational_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[8] = relational_wrapper_out_flat[5];
assign array_wrapper_in_flat[12] = relational_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[4] = select_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[4] = select_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[7] = shift_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[4] = shift_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[5] = shift_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[3] = shift_wrapper_out_flat[8];
assign const_logic_wrapper_in_flat[6] = shift_wrapper_out_flat[10];
assign width_enum_wrapper_in_flat[2] = width_logic_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[6] = width_struct_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[18] = width_union_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[0] = width_union_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[7] = width_union_wrapper_out_flat[14];
