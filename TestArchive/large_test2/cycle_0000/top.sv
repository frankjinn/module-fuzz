...
assign const_compare_wrapper_in_flat[6] = in_flat[82];
...
assign const_concat_repl_wrapper_in_flat[2] = in_flat[99];
...
assign const_conditional_wrapper_in_flat[1] = in_flat[108];
assign const_conditional_wrapper_in_flat[2] = in_flat[109];
assign const_conditional_wrapper_in_flat[3] = in_flat[110];
assign const_conditional_wrapper_in_flat[4] = in_flat[111];
assign const_conditional_wrapper_in_flat[5] = in_flat[112];
assign const_conditional_wrapper_in_flat[6] = in_flat[113];
assign const_conditional_wrapper_in_flat[7] = in_flat[114];
assign const_conditional_wrapper_in_flat[8] = in_flat[115];
assign const_conditional_wrapper_in_flat[9] = in_flat[116];
assign const_conditional_wrapper_in_flat[11] = in_flat[117];
assign const_conditional_wrapper_in_flat[12] = in_flat[118];
assign const_conditional_wrapper_in_flat[13] = in_flat[119];
assign const_conditional_wrapper_in_flat[14] = in_flat[120];
...
assign const_conditional_wrapper_in_flat[20] = in_flat[125];
assign const_conditional_wrapper_in_flat[21] = in_flat[126];
...
assign const_conditional_wrapper_in_flat[30] = in_flat[135];
assign const_conditional_wrapper_in_flat[31] = in_flat[136];
assign const_conditional_wrapper_in_flat[32] = in_flat[137];
...
assign const_logic_wrapper_in_flat[3] = in_flat[142];
assign const_logic_wrapper_in_flat[7] = in_flat[143];
assign const_logic_wrapper_in_flat[9] = in_flat[144];
assign const_nested_wrapper_in_flat[0] = in_flat[145];
assign const_nested_wrapper_in_flat[1] = in_flat[146];
assign const_nested_wrapper_in_flat[2] = in_flat[147];
assign const_nested_wrapper_in_flat[3] = in_flat[148];
assign const_nested_wrapper_in_flat[4] = in_flat[149];
assign const_nested_wrapper_in_flat[6] = in_flat[150];
assign const_nested_wrapper_in_flat[7] = in_flat[151];
assign const_nested_wrapper_in_flat[8] = in_flat[152];
assign const_nested_wrapper_in_flat[10] = in_flat[153];
...
assign const_nested_wrapper_in_flat[15] = in_flat[157];
assign const_nested_wrapper_in_flat[16] = in_flat[158];
assign const_nested_wrapper_in_flat[17] = in_flat[159];
assign const_nested_wrapper_in_flat[18] = in_flat[160];
assign const_nested_wrapper_in_flat[19] = in_flat[161];
assign const_nested_wrapper_in_flat[20] = in_flat[162];
assign const_nested_wrapper_in_flat[21] = in_flat[163];
...
assign const_partselect_wrapper_in_flat[0] = in_flat[167];
assign const_partselect_wrapper_in_flat[1] = in_flat[168];
assign const_partselect_wrapper_in_flat[2] = in_flat[169];
assign const_partselect_wrapper_in_flat[3] = in_flat[170];
assign const_partselect_wrapper_in_flat[4] = in_flat[171];
assign const_partselect_wrapper_in_flat[6] = in_flat[172];
assign const_partselect_wrapper_in_flat[7] = in_flat[173];
assign const_partselect_wrapper_in_flat[8] = in_flat[174];
assign const_partselect_wrapper_in_flat[9] = in_flat[175];
assign const_partselect_wrapper_in_flat[10] = in_flat[176];
assign const_partselect_wrapper_in_flat[11] = in_flat[177];
assign const_partselect_wrapper_in_flat[12] = in_flat[178];
assign const_partselect_wrapper_in_flat[13] = in_flat[179];
assign const_partselect_wrapper_in_flat[14] = in_flat[180];
assign const_partselect_wrapper_in_flat[15] = in_flat[181];
assign const_partselect_wrapper_in_flat[16] = in_flat[182];
assign const_partselect_wrapper_in_flat[17] = in_flat[183];
assign const_partselect_wrapper_in_flat[18] = in_flat[184];
assign const_partselect_wrapper_in_flat[19] = in_flat[185];
assign const_reduce_wrapper_in_flat[2] = in_flat[186];
assign const_reduce_wrapper_in_flat[3] = in_flat[187];
assign const_shift_wrapper_in_flat[0] = in_flat[188];
assign const_shift_wrapper_in_flat[2] = in_flat[189];
assign const_shift_wrapper_in_flat[3] = in_flat[190];
assign const_shift_wrapper_in_flat[5] = in_flat[191];
assign const_shift_wrapper_in_flat[6] = in_flat[192];
assign const_shift_wrapper_in_flat[7] = in_flat[193];
assign const_shift_wrapper_in_flat[8] = in_flat[194];
assign const_shift_wrapper_in_flat[9] = in_flat[195];
assign logical_op_wrapper_in_flat[0] = in_flat[196];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[197];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[198];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[199];
...
assign partselect_wrapper_in_flat[10] = in_flat[208];
assign partselect_wrapper_in_flat[11] = in_flat[209];
assign partselect_wrapper_in_flat[12] = in_flat[210];
assign partselect_wrapper_in_flat[16] = in_flat[211];
assign partselect_wrapper_in_flat[17] = in_flat[212];
assign partselect_wrapper_in_flat[18] = in_flat[213];
assign relational_wrapper_in_flat[1] = in_flat[214];
assign relational_wrapper_in_flat[2] = in_flat[215];
assign relational_wrapper_in_flat[3] = in_flat[216];
assign relational_wrapper_in_flat[5] = in_flat[217];
assign relational_wrapper_in_flat[6] = in_flat[218];
assign relational_wrapper_in_flat[7] = in_flat[219];
assign select_wrapper_in_flat[0] = in_flat[220];
assign select_wrapper_in_flat[1] = in_flat[221];
assign select_wrapper_in_flat[2] = in_flat[222];
assign select_wrapper_in_flat[3] = in_flat[223];
assign select_wrapper_in_flat[4] = in_flat[224];
assign select_wrapper_in_flat[5] = in_flat[225];
assign select_wrapper_in_flat[6] = in_flat[226];
assign select_wrapper_in_flat[8] = in_flat[227];
assign select_wrapper_in_flat[10] = in_flat[228];
assign select_wrapper_in_flat[11] = in_flat[229];
assign select_wrapper_in_flat[12] = in_flat[230];
assign select_wrapper_in_flat[13] = in_flat[231];
assign select_wrapper_in_flat[14] = in_flat[232];
...
assign shift_wrapper_in_flat[0] = in_flat[236];
assign shift_wrapper_in_flat[1] = in_flat[237];
assign shift_wrapper_in_flat[2] = in_flat[238];
assign shift_wrapper_in_flat[4] = in_flat[239];
...
assign width_enum_wrapper_in_flat[0] = in_flat[245];
assign width_logic_wrapper_in_flat[0] = in_flat[246];
assign width_logic_wrapper_in_flat[2] = in_flat[247];
...
assign width_struct_wrapper_in_flat[2] = in_flat[252];
assign width_struct_wrapper_in_flat[3] = in_flat[253];
assign width_struct_wrapper_in_flat[4] = in_flat[254];
assign width_struct_wrapper_in_flat[6] = in_flat[255];
assign width_struct_wrapper_in_flat[7] = in_flat[256];
assign width_struct_wrapper_in_flat[8] = in_flat[257];
assign width_union_wrapper_in_flat[0] = in_flat[258];
assign width_union_wrapper_in_flat[2] = in_flat[259];
assign width_union_wrapper_in_flat[3] = in_flat[260];
assign width_union_wrapper_in_flat[4] = in_flat[261];
assign width_union_wrapper_in_flat[5] = in_flat[262];
assign width_union_wrapper_in_flat[6] = in_flat[263];
assign width_union_wrapper_in_flat[8] = in_flat[264];
assign width_union_wrapper_in_flat[9] = in_flat[265];
assign width_union_wrapper_in_flat[11] = in_flat[266];
assign width_union_wrapper_in_flat[12] = in_flat[267];
assign width_union_wrapper_in_flat[13] = in_flat[268];
assign width_union_wrapper_in_flat[14] = in_flat[269];
assign width_union_wrapper_in_flat[15] = in_flat[270];

// Internal MTM connections (module-to-module)
assign array_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[4];
assign select_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[1] = array_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[0] = array_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[9] = array_wrapper_out_flat[1];
...
assign shift_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[0];
assign cast_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[0];
assign select_wrapper_in_flat[15] = bitwise_reduce_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[25] = bitwise_reduce_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[1] = cast_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[17] = cast_wrapper_out_flat[4];
assign relational_wrapper_in_flat[0] = cast_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[7] = conditional_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[14] = const_arith_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[6] = const_arith_wrapper_out_flat[34];
assign const_partselect_wrapper_in_flat[5] = const_arith_wrapper_out_flat[39];
assign width_union_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[6];
...
assign select_wrapper_in_flat[19] = const_conditional_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[14];
assign width_union_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[22] = const_conditional_wrapper_out_flat[18];
assign array_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[18];
assign arithmetic_reduce_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[21];
assign shift_wrapper_in_flat[3] = const_logic_wrapper_out_flat[17];
assign cast_wrapper_in_flat[8] = const_logic_wrapper_out_flat[18];
...
assign bitwise_reduce_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[3];
assign array_wrapper_in_flat[11] = const_reduce_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[3] = const_shift_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[1] = const_shift_wrapper_out_flat[14];
assign numbers_concat_repl_wrapper_in_flat[4] = const_shift_wrapper_out_flat[19];
assign bitwise_logic_wrapper_in_flat[9] = const_shift_wrapper_out_flat[19];
assign arithmetic_reduce_wrapper_in_flat[11] = logical_op_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[10] = logical_op_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[10] = logical_op_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[15];
assign width_struct_wrapper_in_flat[11] = partselect_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[4] = relational_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[10] = relational_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[1] = relational_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[8] = select_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[4] = select_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[11] = select_wrapper_out_flat[7];
assign array_wrapper_in_flat[1] = select_wrapper_out_flat[7];
assign relational_wrapper_in_flat[4] = shift_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[15] = shift_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[5] = width_enum_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[7] = width_enum_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[14] = width_enum_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[9] = width_logic_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[0] = width_logic_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[5] = width_struct_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[2] = width_struct_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[0] = width_union_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[14] = width_union_wrapper_out_flat[3];
assign array_wrapper_in_flat[8] = width_union_wrapper_out_flat[4];
assign select_wrapper_in_flat[9] = width_union_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[4] = width_union_wrapper_out_flat[15];
