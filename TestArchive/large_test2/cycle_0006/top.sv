...
assign conditional_wrapper_in_flat[3] = in_flat[54];
...
assign const_conditional_wrapper_in_flat[27] = in_flat[119];
assign const_conditional_wrapper_in_flat[28] = in_flat[120];
assign const_conditional_wrapper_in_flat[29] = in_flat[121];
...
assign const_logic_wrapper_in_flat[4] = in_flat[129];
assign const_logic_wrapper_in_flat[5] = in_flat[130];
...
assign const_nested_wrapper_in_flat[7] = in_flat[140];
assign const_nested_wrapper_in_flat[8] = in_flat[141];
...
assign const_partselect_wrapper_in_flat[17] = in_flat[172];
assign const_partselect_wrapper_in_flat[18] = in_flat[173];
assign const_partselect_wrapper_in_flat[19] = in_flat[174];
...
assign width_enum_wrapper_in_flat[3] = in_flat[235];
...
assign width_logic_wrapper_in_flat[6] = in_flat[239];
assign width_logic_wrapper_in_flat[7] = in_flat[240];
...
assign width_struct_wrapper_in_flat[3] = in_flat[244];
...
assign const_compare_wrapper_in_flat[17] = arithmetic_reduce_wrapper_out_flat[0];
assign relational_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[7];
assign select_wrapper_in_flat[18] = arithmetic_reduce_wrapper_out_flat[9];
assign bitwise_logic_wrapper_in_flat[15] = array_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[5] = array_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[3] = cast_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[10] = cast_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[3] = cast_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[12] = cast_wrapper_out_flat[9];
assign array_wrapper_in_flat[16] = conditional_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[5] = conditional_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[1] = const_arith_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[5];
assign shift_wrapper_in_flat[10] = const_arith_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[19] = const_arith_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[5] = const_arith_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[2] = const_arith_wrapper_out_flat[27];
assign const_conditional_wrapper_in_flat[15] = const_arith_wrapper_out_flat[27];
assign const_partselect_wrapper_in_flat[14] = const_arith_wrapper_out_flat[33];
assign width_struct_wrapper_in_flat[11] = const_compare_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[2] = const_compare_wrapper_out_flat[1];
assign relational_wrapper_in_flat[2] = const_compare_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[14] = const_compare_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[4] = const_compare_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[12];
assign bitwise_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[20];
assign width_union_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[20];
assign const_nested_wrapper_in_flat[26] = const_conditional_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[5];
assign shift_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[5] = const_logic_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[26] = const_logic_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[2] = const_logic_wrapper_out_flat[16];
assign select_wrapper_in_flat[4] = const_logic_wrapper_out_flat[18];
assign const_shift_wrapper_in_flat[6] = const_nested_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[0] = const_nested_wrapper_out_flat[5];
assign shift_wrapper_in_flat[5] = const_nested_wrapper_out_flat[7];
assign array_wrapper_in_flat[14] = const_partselect_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[13] = const_reduce_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[2];
assign relational_wrapper_in_flat[1] = const_shift_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[5] = const_shift_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[6] = const_shift_wrapper_out_flat[10];
assign array_wrapper_in_flat[1] = const_shift_wrapper_out_flat[14];
...
assign const_concat_repl_wrapper_in_flat[9] = logical_op_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[23] = logical_op_wrapper_out_flat[2];
assign shift_wrapper_in_flat[3] = logical_op_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[10];
assign cast_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[15] = numbers_concat_repl_wrapper_out_flat[17];
assign partselect_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[17];
assign const_arith_wrapper_in_flat[0] = partselect_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[1] = relational_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[12] = relational_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[7] = relational_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[2] = select_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[4] = select_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[7] = shift_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[15] = shift_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[3] = shift_wrapper_out_flat[12];
assign select_wrapper_in_flat[19] = shift_wrapper_out_flat[15];
assign width_union_wrapper_in_flat[11] = width_enum_wrapper_out_flat[0];
assign select_wrapper_in_flat[6] = width_enum_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[4] = width_enum_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[1] = width_enum_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[16] = width_logic_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[1] = width_logic_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[0] = width_logic_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[1] = width_logic_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[9] = width_logic_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[9] = width_struct_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[4] = width_struct_wrapper_out_flat[3];
assign array_wrapper_in_flat[9] = width_struct_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[16] = width_union_wrapper_out_flat[15];
