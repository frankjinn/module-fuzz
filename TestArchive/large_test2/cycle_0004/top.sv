...
assign const_shift_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[1];
assign array_wrapper_in_flat[14] = arithmetic_reduce_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[16] = array_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[1] = array_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[2] = array_wrapper_out_flat[9];
assign relational_wrapper_in_flat[4] = array_wrapper_out_flat[14];
assign cast_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[13] = bitwise_logic_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[11];
assign width_struct_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[11];
assign partselect_wrapper_in_flat[18] = bitwise_logic_wrapper_out_flat[16];
assign numbers_concat_repl_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[21];
assign select_wrapper_in_flat[4] = bitwise_reduce_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[1] = cast_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[3] = cast_wrapper_out_flat[5];
assign logical_op_wrapper_in_flat[1] = cast_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[3] = cast_wrapper_out_flat[6];
assign shift_wrapper_in_flat[7] = cast_wrapper_out_flat[10];
assign shift_wrapper_in_flat[4] = conditional_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[6] = const_arith_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[9] = const_arith_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[4] = const_arith_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[18] = const_arith_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[1] = const_arith_wrapper_out_flat[15];
assign const_conditional_wrapper_in_flat[10] = const_arith_wrapper_out_flat[17];
assign const_logic_wrapper_in_flat[2] = const_arith_wrapper_out_flat[18];
assign bitwise_reduce_wrapper_in_flat[6] = const_arith_wrapper_out_flat[26];
assign bitwise_logic_wrapper_in_flat[8] = const_arith_wrapper_out_flat[31];
assign const_shift_wrapper_in_flat[1] = const_arith_wrapper_out_flat[32];
assign width_logic_wrapper_in_flat[6] = const_arith_wrapper_out_flat[33];
assign cast_wrapper_in_flat[8] = const_arith_wrapper_out_flat[38];
assign const_shift_wrapper_in_flat[5] = const_compare_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[7] = const_compare_wrapper_out_flat[5];
assign cast_wrapper_in_flat[9] = const_compare_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[3] = const_compare_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[1];
assign cast_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[15];
assign partselect_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[17];
assign width_struct_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[20];
assign bitwise_logic_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[20];
assign array_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[11];
assign arithmetic_reduce_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[18];
assign numbers_concat_repl_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[18];
assign const_shift_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[21];
assign arithmetic_reduce_wrapper_in_flat[4] = const_logic_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[24] = const_logic_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[2] = const_logic_wrapper_out_flat[13];
assign array_wrapper_in_flat[15] = const_logic_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[4] = const_nested_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[9] = const_nested_wrapper_out_flat[1];
assign relational_wrapper_in_flat[2] = const_nested_wrapper_out_flat[6];
assign cast_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[5] = const_shift_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[3] = const_shift_wrapper_out_flat[22];
assign relational_wrapper_in_flat[3] = const_shift_wrapper_out_flat[22];
assign select_wrapper_in_flat[17] = logical_op_wrapper_out_flat[2];
assign select_wrapper_in_flat[18] = numbers_concat_repl_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[10];
assign array_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[12];
assign array_wrapper_in_flat[0] = partselect_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[0] = partselect_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[6] = partselect_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[5] = relational_wrapper_out_flat[4];
assign shift_wrapper_in_flat[0] = relational_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[2] = relational_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[0] = select_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[3] = shift_wrapper_out_flat[2];
assign select_wrapper_in_flat[2] = shift_wrapper_out_flat[10];
assign width_union_wrapper_in_flat[15] = width_enum_wrapper_out_flat[1];
assign select_wrapper_in_flat[8] = width_enum_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[17] = width_logic_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[1] = width_logic_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[21] = width_struct_wrapper_out_flat[0];
assign cast_wrapper_in_flat[7] = width_struct_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[23] = width_struct_wrapper_out_flat[5];
assign shift_wrapper_in_flat[2] = width_struct_wrapper_out_flat[8];
assign relational_wrapper_in_flat[0] = width_struct_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[5] = width_struct_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[4] = width_struct_wrapper_out_flat[11];
