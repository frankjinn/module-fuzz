...
assign const_reduce_wrapper_in_flat[2] = in_flat[113];
...
assign bitwise_reduce_wrapper_in_flat[6] = const_arith_wrapper_out_flat[5];
assign cast_wrapper_in_flat[9] = const_arith_wrapper_out_flat[10];
assign width_union_wrapper_in_flat[6] = const_arith_wrapper_out_flat[18];
assign const_partselect_wrapper_in_flat[9] = const_arith_wrapper_out_flat[18];
assign select_wrapper_in_flat[1] = const_arith_wrapper_out_flat[25];
assign const_concat_repl_wrapper_in_flat[1] = const_arith_wrapper_out_flat[37];
assign bitwise_logic_wrapper_in_flat[2] = const_compare_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[6] = const_compare_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[3];
assign cast_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[9];
assign width_enum_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[13];
assign arithmetic_reduce_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[19] = const_conditional_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[22] = const_conditional_wrapper_out_flat[3];
assign relational_wrapper_in_flat[0] = const_logic_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[0] = const_logic_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[1] = const_logic_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[1] = const_logic_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[5] = const_logic_wrapper_out_flat[17];
assign conditional_wrapper_in_flat[2] = const_nested_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[13] = const_nested_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[5] = const_nested_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[11] = const_nested_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[1];
assign select_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[3];
assign array_wrapper_in_flat[14] = const_reduce_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[1];
assign relational_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[4] = const_shift_wrapper_out_flat[6];
assign cast_wrapper_in_flat[3] = const_shift_wrapper_out_flat[11];
assign const_conditional_wrapper_in_flat[1] = const_shift_wrapper_out_flat[16];
assign bitwise_reduce_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[8];
assign const_logic_wrapper_in_flat[9] = bitwise_reduce_wrapper_out_flat[2];
assign cast_wrapper_in_flat[10] = logical_op_wrapper_out_flat[1];
assign select_wrapper_in_flat[6] = relational_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[6] = relational_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[0] = select_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[15] = select_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[4] = shift_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[10] = shift_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[2] = shift_wrapper_out_flat[11];
assign logical_op_wrapper_in_flat[1] = shift_wrapper_out_flat[14];
assign width_logic_wrapper_in_flat[1] = array_wrapper_out_flat[0];
assign select_wrapper_in_flat[17] = array_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[4] = array_wrapper_out_flat[4];
assign relational_wrapper_in_flat[4] = array_wrapper_out_flat[9];
assign bitwise_logic_wrapper_in_flat[3] = array_wrapper_out_flat[10];
assign conditional_wrapper_in_flat[5] = array_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[10] = cast_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[15] = cast_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[17] = conditional_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[0] = partselect_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[14] = partselect_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[4] = partselect_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[13] = partselect_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[22] = width_enum_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[6] = width_enum_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[5] = width_struct_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[0] = width_struct_wrapper_out_flat[1];
assign cast_wrapper_in_flat[7] = width_struct_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[8] = width_struct_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[18] = width_struct_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[3] = width_union_wrapper_out_flat[2];
assign select_wrapper_in_flat[18] = width_union_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[6] = width_union_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[10] = width_union_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[24] = width_union_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[7] = width_union_wrapper_out_flat[8];
assign cast_wrapper_in_flat[11] = width_union_wrapper_out_flat[12];
assign bitwise_logic_wrapper_in_flat[12] = width_logic_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[15] = numbers_concat_repl_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[17];
