...
assign select_wrapper_in_flat[14] = in_flat[179];
...
assign shift_wrapper_in_flat[4] = in_flat[186];
assign shift_wrapper_in_flat[5] = in_flat[187];
...
assign width_enum_wrapper_in_flat[1] = in_flat[235];
...
assign shift_wrapper_in_flat[0] = const_arith_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[0] = const_arith_wrapper_out_flat[23];
assign const_shift_wrapper_in_flat[1] = const_arith_wrapper_out_flat[23];
assign const_conditional_wrapper_in_flat[1] = const_arith_wrapper_out_flat[24];
assign partselect_wrapper_in_flat[11] = const_arith_wrapper_out_flat[31];
assign const_concat_repl_wrapper_in_flat[2] = const_compare_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[1];
assign select_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[2];
assign relational_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[20] = const_concat_repl_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[19] = const_conditional_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[15];
assign cast_wrapper_in_flat[0] = const_logic_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[2] = const_nested_wrapper_out_flat[2];
assign array_wrapper_in_flat[10] = const_nested_wrapper_out_flat[2];
assign relational_wrapper_in_flat[7] = const_nested_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[1];
assign cast_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[2];
assign array_wrapper_in_flat[12] = const_reduce_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[3] = const_shift_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[6] = const_shift_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[7] = const_shift_wrapper_out_flat[16];
assign bitwise_logic_wrapper_in_flat[0] = const_shift_wrapper_out_flat[22];
assign conditional_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[21] = arithmetic_reduce_wrapper_out_flat[9];
assign bitwise_reduce_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[9];
assign width_union_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[13];
assign relational_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[1];
assign shift_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[4] = logical_op_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[6] = relational_wrapper_out_flat[0];
assign select_wrapper_in_flat[15] = relational_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[4] = relational_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[7] = select_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[3] = select_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[0] = shift_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[10] = shift_wrapper_out_flat[8];
assign relational_wrapper_in_flat[6] = shift_wrapper_out_flat[11];
assign array_wrapper_in_flat[15] = shift_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[13] = shift_wrapper_out_flat[14];
assign conditional_wrapper_in_flat[3] = shift_wrapper_out_flat[14];
assign cast_wrapper_in_flat[5] = array_wrapper_out_flat[4];
assign select_wrapper_in_flat[16] = array_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[7] = conditional_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[18] = conditional_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[10] = partselect_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[2] = partselect_wrapper_out_flat[6];
assign logical_op_wrapper_in_flat[1] = partselect_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[3] = partselect_wrapper_out_flat[8];
assign const_logic_wrapper_in_flat[1] = width_enum_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[16] = width_enum_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[2] = width_struct_wrapper_out_flat[2];
...
assign relational_wrapper_in_flat[5] = width_struct_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[5] = width_union_wrapper_out_flat[1];
assign shift_wrapper_in_flat[8] = width_union_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[0] = width_union_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[13] = width_union_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[0] = width_union_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[6] = width_union_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[3] = width_logic_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[15] = numbers_concat_repl_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[12] = numbers_concat_repl_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[10];
assign width_enum_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[11];
