...
assign const_reduce_wrapper_in_flat[1] = in_flat[119];
...
assign arithmetic_reduce_wrapper_in_flat[3] = in_flat[134];
assign arithmetic_reduce_wrapper_in_flat[4] = in_flat[135];
...
assign bitwise_reduce_wrapper_in_flat[1] = in_flat[159];
...
assign const_logic_wrapper_in_flat[6] = const_arith_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[23] = const_arith_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[10] = const_arith_wrapper_out_flat[9];
assign cast_wrapper_in_flat[10] = const_arith_wrapper_out_flat[29];
assign numbers_concat_repl_wrapper_in_flat[4] = const_arith_wrapper_out_flat[37];
assign cast_wrapper_in_flat[1] = const_compare_wrapper_out_flat[3];
assign shift_wrapper_in_flat[6] = const_compare_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[15] = const_compare_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[0];
assign shift_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[12];
assign conditional_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[12];
assign relational_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[16];
assign arithmetic_reduce_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[21];
assign shift_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[8];
assign width_enum_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[11];
assign arithmetic_reduce_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[15];
assign bitwise_reduce_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[15];
assign conditional_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[23];
assign const_conditional_wrapper_in_flat[27] = const_logic_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[10] = const_logic_wrapper_out_flat[10];
assign width_union_wrapper_in_flat[10] = const_logic_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[6] = const_logic_wrapper_out_flat[14];
assign const_logic_wrapper_in_flat[3] = const_nested_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[7] = const_nested_wrapper_out_flat[4];
assign relational_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[1];
assign select_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[4];
assign shift_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[3] = const_shift_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[3] = const_shift_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[12] = const_shift_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[3] = const_shift_wrapper_out_flat[5];
assign cast_wrapper_in_flat[5] = const_shift_wrapper_out_flat[6];
assign shift_wrapper_in_flat[4] = const_shift_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[13] = const_shift_wrapper_out_flat[15];
assign const_concat_repl_wrapper_in_flat[4] = const_shift_wrapper_out_flat[16];
assign width_struct_wrapper_in_flat[5] = const_shift_wrapper_out_flat[17];
assign select_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[11] = arithmetic_reduce_wrapper_out_flat[2];
...
assign conditional_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[13];
assign const_concat_repl_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[16];
assign const_conditional_wrapper_in_flat[12] = bitwise_logic_wrapper_out_flat[17];
assign bitwise_reduce_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[19];
assign width_struct_wrapper_in_flat[4] = bitwise_reduce_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[1] = logical_op_wrapper_out_flat[2];
...
assign array_wrapper_in_flat[8] = shift_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[0] = shift_wrapper_out_flat[13];
assign relational_wrapper_in_flat[4] = array_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[1] = array_wrapper_out_flat[12];
assign width_enum_wrapper_in_flat[2] = array_wrapper_out_flat[13];
assign partselect_wrapper_in_flat[16] = array_wrapper_out_flat[13];
assign const_logic_wrapper_in_flat[1] = cast_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[7] = cast_wrapper_out_flat[8];
assign logical_op_wrapper_in_flat[0] = partselect_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[3] = partselect_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[0] = partselect_wrapper_out_flat[8];
assign select_wrapper_in_flat[9] = width_enum_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[1] = width_struct_wrapper_out_flat[3];
assign select_wrapper_in_flat[18] = width_struct_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[7] = width_struct_wrapper_out_flat[7];
assign array_wrapper_in_flat[14] = width_struct_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[21] = width_union_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[0] = width_union_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[7] = width_union_wrapper_out_flat[6];
assign array_wrapper_in_flat[17] = width_union_wrapper_out_flat[14];
assign conditional_wrapper_in_flat[2] = width_union_wrapper_out_flat[14];
assign arithmetic_reduce_wrapper_in_flat[7] = width_logic_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[3];
assign cast_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[23] = numbers_concat_repl_wrapper_out_flat[5];
