...
assign bitwise_logic_wrapper_in_flat[7] = in_flat[140];
assign bitwise_logic_wrapper_in_flat[8] = in_flat[141];
assign bitwise_logic_wrapper_in_flat[9] = in_flat[142];
...
assign bitwise_reduce_wrapper_in_flat[0] = in_flat[146];
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[147];
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[148];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[149];
assign relational_wrapper_in_flat[1] = in_flat[150];
assign relational_wrapper_in_flat[2] = in_flat[151];
assign relational_wrapper_in_flat[5] = in_flat[152];
assign relational_wrapper_in_flat[6] = in_flat[153];
assign relational_wrapper_in_flat[7] = in_flat[154];
...
assign select_wrapper_in_flat[18] = in_flat[172];
...
assign numbers_concat_repl_wrapper_in_flat[1] = const_arith_wrapper_out_flat[0];
assign array_wrapper_in_flat[0] = const_arith_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[12] = const_arith_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[16];
assign width_union_wrapper_in_flat[15] = const_arith_wrapper_out_flat[17];
assign const_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[19];
assign const_shift_wrapper_in_flat[9] = const_compare_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[12] = const_compare_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[3] = const_compare_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[10];
assign const_compare_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[16];
assign const_arith_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[18];
assign const_nested_wrapper_in_flat[20] = const_conditional_wrapper_out_flat[19];
assign relational_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[20];
assign numbers_concat_repl_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[21];
assign array_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[21];
assign conditional_wrapper_in_flat[0] = const_logic_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[8] = const_nested_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[4] = const_nested_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[10] = const_nested_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[1] = const_nested_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[13] = const_nested_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[7];
assign cast_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[9] = const_reduce_wrapper_out_flat[2];
assign relational_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[7] = const_shift_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[17] = const_shift_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[9] = const_shift_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[11];
assign cast_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[19];
assign partselect_wrapper_in_flat[16] = bitwise_logic_wrapper_out_flat[20];
assign arithmetic_reduce_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[23];
assign const_partselect_wrapper_in_flat[19] = logical_op_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[2] = relational_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[3] = relational_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[33] = select_wrapper_out_flat[0];
assign array_wrapper_in_flat[14] = select_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[1] = shift_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[15] = shift_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[10] = shift_wrapper_out_flat[5];
assign const_arith_wrapper_in_flat[9] = shift_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[3] = shift_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[0] = array_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[7] = array_wrapper_out_flat[2];
assign relational_wrapper_in_flat[0] = array_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[14] = array_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[1] = cast_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[1] = cast_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[22] = cast_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[4] = cast_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[3] = cast_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[9] = cast_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[14] = partselect_wrapper_out_flat[6];
assign logical_op_wrapper_in_flat[0] = width_enum_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[17] = width_struct_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[0] = width_struct_wrapper_out_flat[7];
assign select_wrapper_in_flat[17] = width_struct_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[2] = width_struct_wrapper_out_flat[9];
assign array_wrapper_in_flat[7] = width_struct_wrapper_out_flat[9];
assign shift_wrapper_in_flat[3] = width_struct_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[9] = width_union_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[4] = width_union_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[1] = width_union_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[11] = width_union_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[7] = width_union_wrapper_out_flat[13];
assign arithmetic_reduce_wrapper_in_flat[2] = width_logic_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[2] = width_logic_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[9];
assign width_enum_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[9];
assign cast_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[17];
