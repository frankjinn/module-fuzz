...
assign const_nested_wrapper_in_flat[26] = in_flat[105];
...
assign const_partselect_wrapper_in_flat[16] = in_flat[119];
assign const_partselect_wrapper_in_flat[17] = in_flat[120];
assign const_partselect_wrapper_in_flat[18] = in_flat[121];
assign const_partselect_wrapper_in_flat[19] = in_flat[122];
assign const_reduce_wrapper_in_flat[1] = in_flat[123];
...
assign const_shift_wrapper_in_flat[10] = in_flat[131];
...
assign arithmetic_reduce_wrapper_in_flat[5] = in_flat[136];
assign arithmetic_reduce_wrapper_in_flat[6] = in_flat[137];
assign arithmetic_reduce_wrapper_in_flat[7] = in_flat[138];
assign arithmetic_reduce_wrapper_in_flat[8] = in_flat[139];
assign arithmetic_reduce_wrapper_in_flat[9] = in_flat[140];
...
assign arithmetic_reduce_wrapper_in_flat[14] = in_flat[144];
...
assign bitwise_logic_wrapper_in_flat[2] = in_flat[148];
assign bitwise_logic_wrapper_in_flat[3] = in_flat[149];
assign bitwise_logic_wrapper_in_flat[4] = in_flat[150];
assign bitwise_logic_wrapper_in_flat[5] = in_flat[151];
assign bitwise_logic_wrapper_in_flat[6] = in_flat[152];
assign bitwise_logic_wrapper_in_flat[7] = in_flat[153];
assign bitwise_logic_wrapper_in_flat[8] = in_flat[154];
assign bitwise_logic_wrapper_in_flat[10] = in_flat[155];
assign bitwise_logic_wrapper_in_flat[11] = in_flat[156];
...
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[161];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[162];
...
assign relational_wrapper_in_flat[6] = in_flat[168];
...
assign select_wrapper_in_flat[11] = in_flat[178];
assign select_wrapper_in_flat[12] = in_flat[179];
assign select_wrapper_in_flat[13] = in_flat[180];
assign select_wrapper_in_flat[14] = in_flat[181];
assign select_wrapper_in_flat[16] = in_flat[182];
assign select_wrapper_in_flat[17] = in_flat[183];
assign select_wrapper_in_flat[18] = in_flat[184];
assign select_wrapper_in_flat[19] = in_flat[185];
assign shift_wrapper_in_flat[0] = in_flat[186];
assign shift_wrapper_in_flat[2] = in_flat[187];
assign shift_wrapper_in_flat[3] = in_flat[188];
assign shift_wrapper_in_flat[4] = in_flat[189];
assign shift_wrapper_in_flat[5] = in_flat[190];
assign shift_wrapper_in_flat[6] = in_flat[191];
assign shift_wrapper_in_flat[7] = in_flat[192];
assign shift_wrapper_in_flat[8] = in_flat[193];
assign shift_wrapper_in_flat[9] = in_flat[194];
assign shift_wrapper_in_flat[10] = in_flat[195];
assign array_wrapper_in_flat[1] = in_flat[196];
assign array_wrapper_in_flat[2] = in_flat[197];
assign array_wrapper_in_flat[4] = in_flat[198];
assign array_wrapper_in_flat[5] = in_flat[199];
assign array_wrapper_in_flat[6] = in_flat[200];
assign array_wrapper_in_flat[7] = in_flat[201];
assign array_wrapper_in_flat[9] = in_flat[202];
assign array_wrapper_in_flat[10] = in_flat[203];
assign array_wrapper_in_flat[11] = in_flat[204];
assign array_wrapper_in_flat[12] = in_flat[205];
assign array_wrapper_in_flat[13] = in_flat[206];
assign array_wrapper_in_flat[14] = in_flat[207];
assign array_wrapper_in_flat[15] = in_flat[208];
assign array_wrapper_in_flat[17] = in_flat[209];
...
assign cast_wrapper_in_flat[8] = in_flat[213];
assign cast_wrapper_in_flat[9] = in_flat[214];
assign cast_wrapper_in_flat[10] = in_flat[215];
assign cast_wrapper_in_flat[11] = in_flat[216];
assign conditional_wrapper_in_flat[4] = in_flat[217];
assign conditional_wrapper_in_flat[6] = in_flat[218];
assign conditional_wrapper_in_flat[7] = in_flat[219];
assign partselect_wrapper_in_flat[0] = in_flat[220];
assign partselect_wrapper_in_flat[1] = in_flat[221];
assign partselect_wrapper_in_flat[2] = in_flat[222];
assign partselect_wrapper_in_flat[3] = in_flat[223];
assign partselect_wrapper_in_flat[4] = in_flat[224];
assign partselect_wrapper_in_flat[5] = in_flat[225];
assign partselect_wrapper_in_flat[6] = in_flat[226];
assign partselect_wrapper_in_flat[10] = in_flat[227];
...
assign partselect_wrapper_in_flat[18] = in_flat[233];
assign width_enum_wrapper_in_flat[1] = in_flat[234];
...
assign width_union_wrapper_in_flat[9] = in_flat[253];
...
assign width_logic_wrapper_in_flat[1] = in_flat[258];
assign width_logic_wrapper_in_flat[3] = in_flat[259];
assign width_logic_wrapper_in_flat[5] = in_flat[260];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[261];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[262];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[263];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[264];

// Internal MTM connections (module-to-module)
assign width_union_wrapper_in_flat[14] = const_arith_wrapper_out_flat[20];
assign width_struct_wrapper_in_flat[9] = const_arith_wrapper_out_flat[30];
assign width_enum_wrapper_in_flat[0] = const_arith_wrapper_out_flat[30];
assign cast_wrapper_in_flat[2] = const_arith_wrapper_out_flat[36];
assign partselect_wrapper_in_flat[7] = const_arith_wrapper_out_flat[37];
assign const_logic_wrapper_in_flat[3] = const_compare_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[6] = const_compare_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[9] = const_compare_wrapper_out_flat[4];
assign array_wrapper_in_flat[3] = const_compare_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[10] = const_compare_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[3];
assign cast_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[12];
assign select_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[16];
assign const_conditional_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[19];
assign conditional_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[0] = const_logic_wrapper_out_flat[5];
assign relational_wrapper_in_flat[5] = const_logic_wrapper_out_flat[11];
assign const_arith_wrapper_in_flat[7] = const_logic_wrapper_out_flat[12];
assign array_wrapper_in_flat[0] = const_logic_wrapper_out_flat[13];
assign shift_wrapper_in_flat[1] = const_logic_wrapper_out_flat[15];
assign conditional_wrapper_in_flat[3] = const_nested_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[2] = const_nested_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[4];
...
assign const_reduce_wrapper_in_flat[0] = const_shift_wrapper_out_flat[1];
assign relational_wrapper_in_flat[7] = const_shift_wrapper_out_flat[5];
assign const_arith_wrapper_in_flat[14] = const_shift_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[7] = const_shift_wrapper_out_flat[8];
assign const_conditional_wrapper_in_flat[9] = const_shift_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[5] = const_shift_wrapper_out_flat[14];
assign const_concat_repl_wrapper_in_flat[5] = const_shift_wrapper_out_flat[16];
assign partselect_wrapper_in_flat[8] = const_shift_wrapper_out_flat[17];
assign select_wrapper_in_flat[1] = const_shift_wrapper_out_flat[21];
assign const_partselect_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[9] = bitwise_reduce_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[6] = relational_wrapper_out_flat[0];
assign array_wrapper_in_flat[16] = relational_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[2] = relational_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[1] = select_wrapper_out_flat[4];
assign cast_wrapper_in_flat[4] = select_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[13] = select_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[8] = shift_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[0] = shift_wrapper_out_flat[3];
assign array_wrapper_in_flat[8] = shift_wrapper_out_flat[6];
assign relational_wrapper_in_flat[1] = shift_wrapper_out_flat[13];
assign const_shift_wrapper_in_flat[1] = shift_wrapper_out_flat[15];
assign const_reduce_wrapper_in_flat[3] = array_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[9] = array_wrapper_out_flat[12];
assign width_enum_wrapper_in_flat[2] = array_wrapper_out_flat[13];
assign width_logic_wrapper_in_flat[2] = cast_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[18] = cast_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[5] = conditional_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[1] = conditional_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[12] = conditional_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[12] = conditional_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[3] = partselect_wrapper_out_flat[0];
assign select_wrapper_in_flat[5] = partselect_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[8] = partselect_wrapper_out_flat[4];
assign cast_wrapper_in_flat[3] = width_enum_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[1] = width_enum_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[11] = width_enum_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[6] = width_struct_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[17] = width_union_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[3] = width_union_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[3] = width_union_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[2] = width_union_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[0] = width_union_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[15] = width_logic_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[16] = width_logic_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[14] = width_logic_wrapper_out_flat[5];
assign cast_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[12];
