...
assign partselect_wrapper_in_flat[16] = in_flat[221];
...
assign partselect_wrapper_in_flat[7] = const_arith_wrapper_out_flat[13];
assign const_shift_wrapper_in_flat[0] = const_arith_wrapper_out_flat[15];
assign numbers_concat_repl_wrapper_in_flat[0] = const_arith_wrapper_out_flat[19];
assign const_reduce_wrapper_in_flat[3] = const_arith_wrapper_out_flat[24];
assign array_wrapper_in_flat[9] = const_arith_wrapper_out_flat[24];
assign const_nested_wrapper_in_flat[17] = const_arith_wrapper_out_flat[35];
assign width_union_wrapper_in_flat[10] = const_arith_wrapper_out_flat[37];
assign const_nested_wrapper_in_flat[22] = const_compare_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[1] = const_compare_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[5] = const_compare_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[0];
assign cast_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[8];
assign const_concat_repl_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[15];
assign const_conditional_wrapper_in_flat[12] = const_logic_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[6] = const_logic_wrapper_out_flat[8];
assign cast_wrapper_in_flat[11] = const_logic_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[8] = const_logic_wrapper_out_flat[9];
assign cast_wrapper_in_flat[2] = const_nested_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[7] = const_nested_wrapper_out_flat[3];
assign cast_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[5] = const_shift_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[9] = const_shift_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[7] = const_shift_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[0] = const_shift_wrapper_out_flat[10];
assign select_wrapper_in_flat[1] = const_shift_wrapper_out_flat[16];
assign const_nested_wrapper_in_flat[9] = const_shift_wrapper_out_flat[16];
assign const_compare_wrapper_in_flat[20] = arithmetic_reduce_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[8];
assign logical_op_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[31] = bitwise_logic_wrapper_out_flat[6];
assign shift_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[6];
assign select_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[12];
assign const_concat_repl_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[13];
assign arithmetic_reduce_wrapper_in_flat[13] = bitwise_logic_wrapper_out_flat[14];
assign conditional_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[14];
assign relational_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[16];
...
assign width_struct_wrapper_in_flat[8] = bitwise_reduce_wrapper_out_flat[1];
assign select_wrapper_in_flat[12] = relational_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[4] = select_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[4] = select_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[15] = select_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[24] = select_wrapper_out_flat[5];
assign select_wrapper_in_flat[5] = shift_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[6] = shift_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[1] = shift_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[0] = shift_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[6] = shift_wrapper_out_flat[11];
assign partselect_wrapper_in_flat[9] = shift_wrapper_out_flat[11];
assign numbers_concat_repl_wrapper_in_flat[5] = array_wrapper_out_flat[1];
assign relational_wrapper_in_flat[4] = array_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[3] = array_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[5] = array_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[1] = array_wrapper_out_flat[10];
assign const_shift_wrapper_in_flat[2] = array_wrapper_out_flat[15];
assign width_struct_wrapper_in_flat[0] = cast_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[1] = conditional_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[6] = partselect_wrapper_out_flat[5];
assign logical_op_wrapper_in_flat[1] = partselect_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[18] = partselect_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[2] = width_enum_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[18] = width_enum_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[9] = width_enum_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[2] = width_struct_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[2] = width_union_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[6] = width_union_wrapper_out_flat[5];
assign array_wrapper_in_flat[15] = width_union_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[2];
assign relational_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[13];
assign const_reduce_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[13];
