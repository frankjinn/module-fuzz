...
assign select_wrapper_in_flat[17] = in_flat[171];
...
assign const_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[4];
assign cast_wrapper_in_flat[10] = const_arith_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[3] = const_arith_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[12] = const_arith_wrapper_out_flat[10];
assign array_wrapper_in_flat[9] = const_arith_wrapper_out_flat[13];
assign width_logic_wrapper_in_flat[2] = const_arith_wrapper_out_flat[17];
assign const_conditional_wrapper_in_flat[16] = const_arith_wrapper_out_flat[34];
assign conditional_wrapper_in_flat[1] = const_compare_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[2] = const_compare_wrapper_out_flat[3];
assign select_wrapper_in_flat[18] = const_compare_wrapper_out_flat[4];
assign relational_wrapper_in_flat[0] = const_compare_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[19];
assign const_shift_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[10];
assign width_enum_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[11];
assign select_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[13];
assign const_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[16];
assign width_struct_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[19];
assign width_logic_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[20];
assign const_compare_wrapper_in_flat[19] = const_conditional_wrapper_out_flat[21];
assign numbers_concat_repl_wrapper_in_flat[2] = const_logic_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[1] = const_logic_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[6] = const_logic_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[3] = const_logic_wrapper_out_flat[4];
assign relational_wrapper_in_flat[7] = const_logic_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[7] = const_logic_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[9] = const_logic_wrapper_out_flat[10];
assign select_wrapper_in_flat[7] = const_logic_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[15] = const_nested_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[4];
assign cast_wrapper_in_flat[7] = const_shift_wrapper_out_flat[6];
assign relational_wrapper_in_flat[6] = const_shift_wrapper_out_flat[19];
assign select_wrapper_in_flat[9] = const_shift_wrapper_out_flat[23];
assign conditional_wrapper_in_flat[4] = const_shift_wrapper_out_flat[23];
assign bitwise_reduce_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[12] = bitwise_logic_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[12] = bitwise_logic_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[11] = logical_op_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[3] = logical_op_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[1] = relational_wrapper_out_flat[2];
assign select_wrapper_in_flat[0] = relational_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[24] = select_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[0] = select_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[4] = select_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[3] = shift_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[5] = shift_wrapper_out_flat[10];
assign relational_wrapper_in_flat[3] = array_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[8] = array_wrapper_out_flat[8];
assign logical_op_wrapper_in_flat[1] = array_wrapper_out_flat[8];
assign width_enum_wrapper_in_flat[1] = array_wrapper_out_flat[13];
assign width_logic_wrapper_in_flat[4] = cast_wrapper_out_flat[0];
assign array_wrapper_in_flat[10] = cast_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[8] = conditional_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[15] = conditional_wrapper_out_flat[1];
assign select_wrapper_in_flat[16] = conditional_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[21] = partselect_wrapper_out_flat[0];
assign cast_wrapper_in_flat[9] = partselect_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[4] = width_enum_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[0] = width_enum_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[1] = width_enum_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[7] = width_enum_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[4] = width_struct_wrapper_out_flat[8];
assign shift_wrapper_in_flat[1] = width_struct_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[12] = width_struct_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[27] = width_union_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[3] = width_union_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[14] = width_union_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[18] = width_union_wrapper_out_flat[11];
assign cast_wrapper_in_flat[5] = width_union_wrapper_out_flat[12];
assign const_shift_wrapper_in_flat[6] = width_union_wrapper_out_flat[13];
assign width_struct_wrapper_in_flat[10] = width_logic_wrapper_out_flat[1];
assign array_wrapper_in_flat[14] = width_logic_wrapper_out_flat[5];
assign select_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[14];
