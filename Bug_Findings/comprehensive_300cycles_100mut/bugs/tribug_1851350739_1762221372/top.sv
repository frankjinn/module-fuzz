...
assign const_shift_wrapper_in_flat[6] = in_flat[122];
...
assign relational_wrapper_in_flat[1] = in_flat[162];
...
assign const_shift_wrapper_in_flat[0] = const_arith_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[7] = const_arith_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[4] = const_arith_wrapper_out_flat[12];
assign width_logic_wrapper_in_flat[6] = const_arith_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[6] = const_arith_wrapper_out_flat[15];
assign bitwise_reduce_wrapper_in_flat[5] = const_arith_wrapper_out_flat[17];
assign arithmetic_reduce_wrapper_in_flat[13] = const_arith_wrapper_out_flat[26];
assign bitwise_logic_wrapper_in_flat[0] = const_arith_wrapper_out_flat[30];
assign width_struct_wrapper_in_flat[0] = const_arith_wrapper_out_flat[32];
assign const_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[35];
assign partselect_wrapper_in_flat[10] = const_compare_wrapper_out_flat[3];
assign select_wrapper_in_flat[16] = const_compare_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[7] = const_compare_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[3];
assign relational_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[17];
assign array_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[11];
assign relational_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[14];
assign conditional_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[15];
assign const_reduce_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[21];
assign const_partselect_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[21];
assign const_conditional_wrapper_in_flat[9] = const_logic_wrapper_out_flat[0];
assign array_wrapper_in_flat[7] = const_logic_wrapper_out_flat[17];
assign const_nested_wrapper_in_flat[24] = const_logic_wrapper_out_flat[18];
assign width_struct_wrapper_in_flat[5] = const_logic_wrapper_out_flat[18];
assign width_enum_wrapper_in_flat[0] = const_nested_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[3];
assign cast_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[3];
...
assign numbers_concat_repl_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[14] = const_reduce_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[9] = const_shift_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[5] = const_shift_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[6] = const_shift_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[0] = const_shift_wrapper_out_flat[4];
assign select_wrapper_in_flat[4] = const_shift_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[11] = const_shift_wrapper_out_flat[18];
assign const_nested_wrapper_in_flat[11] = arithmetic_reduce_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[2];
assign array_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[12];
assign shift_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[13];
assign const_logic_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[22];
assign width_struct_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[22];
assign const_compare_wrapper_in_flat[4] = bitwise_reduce_wrapper_out_flat[0];
assign select_wrapper_in_flat[11] = bitwise_reduce_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[3] = logical_op_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[1] = logical_op_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[0] = logical_op_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[14] = relational_wrapper_out_flat[5];
assign cast_wrapper_in_flat[4] = relational_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[17] = relational_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[32] = select_wrapper_out_flat[0];
assign cast_wrapper_in_flat[2] = select_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[1] = select_wrapper_out_flat[2];
assign array_wrapper_in_flat[17] = select_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[14] = select_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[2] = shift_wrapper_out_flat[5];
assign logical_op_wrapper_in_flat[0] = shift_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[17] = shift_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[1] = shift_wrapper_out_flat[11];
assign numbers_concat_repl_wrapper_in_flat[3] = array_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[5] = array_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[7] = array_wrapper_out_flat[9];
assign width_union_wrapper_in_flat[7] = array_wrapper_out_flat[11];
assign relational_wrapper_in_flat[5] = array_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[13] = cast_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[1] = cast_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[3] = conditional_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[16] = conditional_wrapper_out_flat[3];
assign select_wrapper_in_flat[0] = width_struct_wrapper_out_flat[10];
assign cast_wrapper_in_flat[8] = width_struct_wrapper_out_flat[11];
assign logical_op_wrapper_in_flat[1] = width_union_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[2] = width_union_wrapper_out_flat[2];
assign shift_wrapper_in_flat[8] = width_union_wrapper_out_flat[4];
assign relational_wrapper_in_flat[4] = width_union_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[0] = width_union_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[21] = width_logic_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[6] = width_logic_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[5];
