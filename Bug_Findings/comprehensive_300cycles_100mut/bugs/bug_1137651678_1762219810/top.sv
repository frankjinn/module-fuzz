...
assign const_nested_wrapper_in_flat[18] = in_flat[101];
...
assign const_partselect_wrapper_in_flat[4] = in_flat[111];
...
assign const_partselect_wrapper_in_flat[15] = in_flat[118];
...
assign const_logic_wrapper_in_flat[1] = const_arith_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[0] = const_arith_wrapper_out_flat[12];
assign width_union_wrapper_in_flat[4] = const_arith_wrapper_out_flat[21];
assign width_struct_wrapper_in_flat[5] = const_arith_wrapper_out_flat[22];
assign relational_wrapper_in_flat[4] = const_arith_wrapper_out_flat[28];
assign const_shift_wrapper_in_flat[2] = const_arith_wrapper_out_flat[29];
assign const_concat_repl_wrapper_in_flat[4] = const_arith_wrapper_out_flat[35];
assign const_concat_repl_wrapper_in_flat[6] = const_compare_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[1] = const_compare_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[0] = const_compare_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[3];
assign select_wrapper_in_flat[19] = const_concat_repl_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[7];
assign shift_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[8];
assign relational_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[12];
assign width_union_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[13];
assign array_wrapper_in_flat[17] = const_concat_repl_wrapper_out_flat[18];
assign const_nested_wrapper_in_flat[25] = const_concat_repl_wrapper_out_flat[19];
assign const_partselect_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[21];
assign const_shift_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[17];
assign const_reduce_wrapper_in_flat[0] = const_logic_wrapper_out_flat[6];
assign bitwise_logic_wrapper_in_flat[11] = const_logic_wrapper_out_flat[11];
assign select_wrapper_in_flat[1] = const_logic_wrapper_out_flat[12];
assign relational_wrapper_in_flat[3] = const_logic_wrapper_out_flat[14];
assign arithmetic_reduce_wrapper_in_flat[8] = const_logic_wrapper_out_flat[17];
assign width_logic_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[7] = const_reduce_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[14] = const_reduce_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[4];
assign relational_wrapper_in_flat[6] = const_shift_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[18] = const_shift_wrapper_out_flat[8];
assign width_logic_wrapper_in_flat[0] = const_shift_wrapper_out_flat[16];
assign select_wrapper_in_flat[5] = const_shift_wrapper_out_flat[18];
assign const_logic_wrapper_in_flat[8] = const_shift_wrapper_out_flat[19];
assign array_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[10] = arithmetic_reduce_wrapper_out_flat[1];
assign select_wrapper_in_flat[11] = arithmetic_reduce_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[0];
assign array_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[6];
assign logical_op_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[12] = bitwise_logic_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[11];
assign select_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[13];
assign relational_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[15];
assign bitwise_reduce_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[20];
assign width_logic_wrapper_in_flat[7] = logical_op_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[1] = relational_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[10] = relational_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[18] = select_wrapper_out_flat[6];
assign cast_wrapper_in_flat[9] = shift_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[5] = shift_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[17] = shift_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[10] = array_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[1] = array_wrapper_out_flat[2];
assign shift_wrapper_in_flat[1] = array_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[5] = array_wrapper_out_flat[13];
assign select_wrapper_in_flat[13] = array_wrapper_out_flat[13];
assign width_union_wrapper_in_flat[3] = array_wrapper_out_flat[14];
assign const_nested_wrapper_in_flat[19] = cast_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[7] = conditional_wrapper_out_flat[1];
...
assign cast_wrapper_in_flat[11] = partselect_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[0] = partselect_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[0] = partselect_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[2] = width_enum_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[10] = width_struct_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[8] = width_struct_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[6] = width_struct_wrapper_out_flat[9];
assign select_wrapper_in_flat[8] = width_union_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[3] = width_union_wrapper_out_flat[11];
assign shift_wrapper_in_flat[8] = width_union_wrapper_out_flat[14];
assign cast_wrapper_in_flat[8] = width_logic_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[31] = numbers_concat_repl_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[9];
