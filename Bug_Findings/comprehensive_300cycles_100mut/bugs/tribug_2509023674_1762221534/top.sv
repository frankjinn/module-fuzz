...
assign cast_wrapper_in_flat[8] = in_flat[206];
...
assign width_struct_wrapper_in_flat[0] = in_flat[225];
assign width_struct_wrapper_in_flat[1] = in_flat[226];
assign width_struct_wrapper_in_flat[2] = in_flat[227];
...
assign width_struct_wrapper_in_flat[9] = in_flat[231];
...
assign width_union_wrapper_in_flat[4] = in_flat[237];
...
assign const_concat_repl_wrapper_in_flat[8] = const_arith_wrapper_out_flat[11];
assign const_conditional_wrapper_in_flat[0] = const_arith_wrapper_out_flat[15];
assign relational_wrapper_in_flat[5] = const_arith_wrapper_out_flat[15];
assign const_partselect_wrapper_in_flat[14] = const_arith_wrapper_out_flat[19];
assign const_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[29];
assign partselect_wrapper_in_flat[17] = const_arith_wrapper_out_flat[35];
assign width_enum_wrapper_in_flat[1] = const_compare_wrapper_out_flat[1];
assign cast_wrapper_in_flat[6] = const_compare_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[12];
assign const_conditional_wrapper_in_flat[31] = const_concat_repl_wrapper_out_flat[12];
assign arithmetic_reduce_wrapper_in_flat[14] = const_concat_repl_wrapper_out_flat[16];
assign partselect_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[18];
assign const_logic_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[19];
assign const_partselect_wrapper_in_flat[19] = const_conditional_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[2];
assign array_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[8];
assign relational_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[20];
assign relational_wrapper_in_flat[0] = const_logic_wrapper_out_flat[7];
assign array_wrapper_in_flat[10] = const_logic_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[8] = const_logic_wrapper_out_flat[9];
assign partselect_wrapper_in_flat[3] = const_logic_wrapper_out_flat[10];
...
assign const_compare_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[4];
assign logical_op_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[4];
assign cast_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[8] = const_shift_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[4] = const_shift_wrapper_out_flat[2];
assign relational_wrapper_in_flat[6] = const_shift_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[3] = const_shift_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[1] = const_shift_wrapper_out_flat[4];
assign array_wrapper_in_flat[11] = const_shift_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[4] = const_shift_wrapper_out_flat[23];
assign const_compare_wrapper_in_flat[11] = arithmetic_reduce_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[15] = arithmetic_reduce_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[5];
assign cast_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[8];
assign width_enum_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[13];
assign width_struct_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[16];
assign const_partselect_wrapper_in_flat[18] = bitwise_logic_wrapper_out_flat[19];
assign conditional_wrapper_in_flat[5] = logical_op_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[0] = logical_op_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[6] = relational_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[15] = relational_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[13] = select_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[0] = select_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[3] = select_wrapper_out_flat[4];
assign shift_wrapper_in_flat[0] = select_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[5] = select_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[10] = shift_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[6] = shift_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[9] = array_wrapper_out_flat[12];
assign bitwise_reduce_wrapper_in_flat[6] = cast_wrapper_out_flat[7];
...
assign const_nested_wrapper_in_flat[16] = conditional_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[11] = partselect_wrapper_out_flat[5];
assign cast_wrapper_in_flat[10] = width_enum_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[1] = width_struct_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[6] = width_struct_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = width_struct_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[2] = width_struct_wrapper_out_flat[6];
assign array_wrapper_in_flat[7] = width_union_wrapper_out_flat[10];
assign const_arith_wrapper_in_flat[11] = width_logic_wrapper_out_flat[1];
assign select_wrapper_in_flat[5] = width_logic_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[0] = width_logic_wrapper_out_flat[5];
assign select_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[18] = numbers_concat_repl_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[3];
assign shift_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[25] = numbers_concat_repl_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[16];
