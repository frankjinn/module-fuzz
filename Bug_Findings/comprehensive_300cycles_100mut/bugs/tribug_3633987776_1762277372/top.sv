...
assign const_nested_wrapper_in_flat[4] = in_flat[82];
assign const_nested_wrapper_in_flat[5] = in_flat[83];
assign const_nested_wrapper_in_flat[6] = in_flat[84];
...
assign const_partselect_wrapper_in_flat[7] = in_flat[110];
...
assign const_partselect_wrapper_in_flat[16] = in_flat[117];
assign const_reduce_wrapper_in_flat[0] = in_flat[118];
assign const_shift_wrapper_in_flat[0] = in_flat[119];
...
assign const_shift_wrapper_in_flat[10] = in_flat[126];
assign arithmetic_reduce_wrapper_in_flat[0] = in_flat[127];
assign arithmetic_reduce_wrapper_in_flat[1] = in_flat[128];
assign arithmetic_reduce_wrapper_in_flat[2] = in_flat[129];
assign arithmetic_reduce_wrapper_in_flat[3] = in_flat[130];
...
assign arithmetic_reduce_wrapper_in_flat[12] = in_flat[136];
assign arithmetic_reduce_wrapper_in_flat[13] = in_flat[137];
assign arithmetic_reduce_wrapper_in_flat[14] = in_flat[138];
assign arithmetic_reduce_wrapper_in_flat[15] = in_flat[139];
assign bitwise_logic_wrapper_in_flat[0] = in_flat[140];
assign bitwise_logic_wrapper_in_flat[1] = in_flat[141];
assign bitwise_logic_wrapper_in_flat[2] = in_flat[142];
assign bitwise_logic_wrapper_in_flat[3] = in_flat[143];
assign bitwise_logic_wrapper_in_flat[4] = in_flat[144];
...
assign bitwise_logic_wrapper_in_flat[14] = in_flat[152];
assign bitwise_logic_wrapper_in_flat[15] = in_flat[153];
assign bitwise_reduce_wrapper_in_flat[0] = in_flat[154];
...
assign relational_wrapper_in_flat[6] = in_flat[161];
...
assign array_wrapper_in_flat[0] = in_flat[182];
...
assign array_wrapper_in_flat[5] = in_flat[186];
assign array_wrapper_in_flat[6] = in_flat[187];
assign array_wrapper_in_flat[7] = in_flat[188];
assign array_wrapper_in_flat[8] = in_flat[189];
assign array_wrapper_in_flat[9] = in_flat[190];
...
assign array_wrapper_in_flat[15] = in_flat[195];
...
assign conditional_wrapper_in_flat[5] = in_flat[210];
assign conditional_wrapper_in_flat[6] = in_flat[211];
assign conditional_wrapper_in_flat[7] = in_flat[212];
assign conditional_wrapper_in_flat[8] = in_flat[213];
...
assign partselect_wrapper_in_flat[10] = in_flat[224];
assign partselect_wrapper_in_flat[11] = in_flat[225];
assign partselect_wrapper_in_flat[12] = in_flat[226];
assign partselect_wrapper_in_flat[13] = in_flat[227];
assign partselect_wrapper_in_flat[15] = in_flat[228];
assign partselect_wrapper_in_flat[16] = in_flat[229];
assign partselect_wrapper_in_flat[17] = in_flat[230];
assign partselect_wrapper_in_flat[18] = in_flat[231];
assign width_enum_wrapper_in_flat[0] = in_flat[232];
assign width_enum_wrapper_in_flat[2] = in_flat[233];
assign width_enum_wrapper_in_flat[3] = in_flat[234];
...
assign width_logic_wrapper_in_flat[1] = in_flat[259];
assign width_logic_wrapper_in_flat[2] = in_flat[260];
assign width_logic_wrapper_in_flat[3] = in_flat[261];
assign width_logic_wrapper_in_flat[4] = in_flat[262];
assign width_logic_wrapper_in_flat[5] = in_flat[263];
assign width_logic_wrapper_in_flat[7] = in_flat[264];
...
assign select_wrapper_in_flat[8] = const_arith_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[18] = const_arith_wrapper_out_flat[17];
assign numbers_concat_repl_wrapper_in_flat[1] = const_arith_wrapper_out_flat[22];
assign const_conditional_wrapper_in_flat[19] = const_arith_wrapper_out_flat[26];
assign arithmetic_reduce_wrapper_in_flat[10] = const_arith_wrapper_out_flat[33];
assign shift_wrapper_in_flat[10] = const_compare_wrapper_out_flat[5];
assign logical_op_wrapper_in_flat[0] = const_compare_wrapper_out_flat[7];
assign relational_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[3];
assign shift_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[17] = const_conditional_wrapper_out_flat[10];
assign numbers_concat_repl_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[10];
assign const_shift_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[17];
assign select_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[19];
assign const_shift_wrapper_in_flat[3] = const_logic_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[6] = const_logic_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[3] = const_logic_wrapper_out_flat[15];
assign const_compare_wrapper_in_flat[1] = const_logic_wrapper_out_flat[16];
assign width_union_wrapper_in_flat[15] = const_logic_wrapper_out_flat[18];
assign const_concat_repl_wrapper_in_flat[2] = const_logic_wrapper_out_flat[18];
assign conditional_wrapper_in_flat[3] = const_nested_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[4] = const_nested_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[1] = const_nested_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[14] = const_partselect_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[1];
assign shift_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[3];
assign relational_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[1] = const_shift_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[5] = const_shift_wrapper_out_flat[12];
assign cast_wrapper_in_flat[8] = const_shift_wrapper_out_flat[16];
assign select_wrapper_in_flat[6] = const_shift_wrapper_out_flat[22];
assign shift_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[1];
assign select_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[5];
assign relational_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[19] = bitwise_logic_wrapper_out_flat[14];
assign array_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[17];
assign logical_op_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[19];
assign bitwise_reduce_wrapper_in_flat[3] = logical_op_wrapper_out_flat[0];
assign cast_wrapper_in_flat[0] = logical_op_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[13] = relational_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[10] = relational_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[6] = select_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[15] = select_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[9] = select_wrapper_out_flat[5];
assign relational_wrapper_in_flat[4] = select_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[8] = select_wrapper_out_flat[8];
assign width_logic_wrapper_in_flat[0] = array_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[7] = array_wrapper_out_flat[13];
assign array_wrapper_in_flat[4] = cast_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[2] = conditional_wrapper_out_flat[0];
assign select_wrapper_in_flat[0] = conditional_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[1] = partselect_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[4] = partselect_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[2] = partselect_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[5] = partselect_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[14] = width_struct_wrapper_out_flat[2];
assign select_wrapper_in_flat[18] = width_struct_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[1] = width_struct_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[3] = width_struct_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[2] = width_struct_wrapper_out_flat[10];
assign numbers_concat_repl_wrapper_in_flat[0] = width_struct_wrapper_out_flat[11];
assign bitwise_reduce_wrapper_in_flat[2] = width_union_wrapper_out_flat[4];
assign cast_wrapper_in_flat[7] = width_union_wrapper_out_flat[4];
assign shift_wrapper_in_flat[4] = width_union_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[21] = width_union_wrapper_out_flat[12];
assign select_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[16];
