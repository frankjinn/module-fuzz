...
assign arithmetic_reduce_wrapper_in_flat[4] = in_flat[137];
assign arithmetic_reduce_wrapper_in_flat[5] = in_flat[138];
assign arithmetic_reduce_wrapper_in_flat[6] = in_flat[139];
assign arithmetic_reduce_wrapper_in_flat[8] = in_flat[140];
assign arithmetic_reduce_wrapper_in_flat[9] = in_flat[141];
assign arithmetic_reduce_wrapper_in_flat[10] = in_flat[142];
assign arithmetic_reduce_wrapper_in_flat[11] = in_flat[143];
assign arithmetic_reduce_wrapper_in_flat[12] = in_flat[144];
assign arithmetic_reduce_wrapper_in_flat[13] = in_flat[145];
assign arithmetic_reduce_wrapper_in_flat[14] = in_flat[146];
assign arithmetic_reduce_wrapper_in_flat[15] = in_flat[147];
assign bitwise_logic_wrapper_in_flat[0] = in_flat[148];
assign bitwise_logic_wrapper_in_flat[1] = in_flat[149];
...
assign bitwise_logic_wrapper_in_flat[10] = in_flat[157];
...
assign bitwise_reduce_wrapper_in_flat[1] = in_flat[162];
assign bitwise_reduce_wrapper_in_flat[3] = in_flat[163];
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[164];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[165];
assign relational_wrapper_in_flat[0] = in_flat[166];
assign relational_wrapper_in_flat[2] = in_flat[167];
assign relational_wrapper_in_flat[4] = in_flat[168];
assign relational_wrapper_in_flat[5] = in_flat[169];
assign relational_wrapper_in_flat[6] = in_flat[170];
assign select_wrapper_in_flat[0] = in_flat[171];
assign select_wrapper_in_flat[1] = in_flat[172];
assign select_wrapper_in_flat[2] = in_flat[173];
assign select_wrapper_in_flat[3] = in_flat[174];
assign select_wrapper_in_flat[4] = in_flat[175];
assign select_wrapper_in_flat[5] = in_flat[176];
assign select_wrapper_in_flat[6] = in_flat[177];
assign select_wrapper_in_flat[7] = in_flat[178];
assign select_wrapper_in_flat[11] = in_flat[179];
assign select_wrapper_in_flat[12] = in_flat[180];
assign select_wrapper_in_flat[13] = in_flat[181];
assign select_wrapper_in_flat[14] = in_flat[182];
assign select_wrapper_in_flat[15] = in_flat[183];
assign select_wrapper_in_flat[17] = in_flat[184];
assign select_wrapper_in_flat[19] = in_flat[185];
assign shift_wrapper_in_flat[0] = in_flat[186];
assign shift_wrapper_in_flat[1] = in_flat[187];
assign shift_wrapper_in_flat[2] = in_flat[188];
assign shift_wrapper_in_flat[3] = in_flat[189];
assign shift_wrapper_in_flat[4] = in_flat[190];
assign shift_wrapper_in_flat[5] = in_flat[191];
assign shift_wrapper_in_flat[6] = in_flat[192];
assign shift_wrapper_in_flat[9] = in_flat[193];
assign shift_wrapper_in_flat[10] = in_flat[194];
assign array_wrapper_in_flat[0] = in_flat[195];
...
assign array_wrapper_in_flat[8] = in_flat[202];
assign array_wrapper_in_flat[9] = in_flat[203];
assign array_wrapper_in_flat[10] = in_flat[204];
assign array_wrapper_in_flat[11] = in_flat[205];
assign array_wrapper_in_flat[12] = in_flat[206];
...
assign cast_wrapper_in_flat[3] = in_flat[213];
assign cast_wrapper_in_flat[4] = in_flat[214];
assign cast_wrapper_in_flat[5] = in_flat[215];
...
assign conditional_wrapper_in_flat[0] = in_flat[221];
...
assign conditional_wrapper_in_flat[8] = in_flat[225];
assign partselect_wrapper_in_flat[0] = in_flat[226];
assign partselect_wrapper_in_flat[2] = in_flat[227];
assign partselect_wrapper_in_flat[3] = in_flat[228];
assign partselect_wrapper_in_flat[4] = in_flat[229];
assign partselect_wrapper_in_flat[5] = in_flat[230];
assign partselect_wrapper_in_flat[6] = in_flat[231];
assign partselect_wrapper_in_flat[7] = in_flat[232];
assign partselect_wrapper_in_flat[8] = in_flat[233];
assign partselect_wrapper_in_flat[9] = in_flat[234];
assign partselect_wrapper_in_flat[10] = in_flat[235];
assign partselect_wrapper_in_flat[11] = in_flat[236];
assign partselect_wrapper_in_flat[12] = in_flat[237];
assign partselect_wrapper_in_flat[13] = in_flat[238];
assign partselect_wrapper_in_flat[14] = in_flat[239];
...
assign width_enum_wrapper_in_flat[1] = in_flat[243];
assign width_enum_wrapper_in_flat[3] = in_flat[244];
...
assign width_union_wrapper_in_flat[10] = in_flat[261];
assign width_union_wrapper_in_flat[11] = in_flat[262];
assign width_union_wrapper_in_flat[12] = in_flat[263];
assign width_union_wrapper_in_flat[13] = in_flat[264];
assign width_union_wrapper_in_flat[14] = in_flat[265];
assign width_union_wrapper_in_flat[15] = in_flat[266];
assign width_logic_wrapper_in_flat[0] = in_flat[267];
assign width_logic_wrapper_in_flat[1] = in_flat[268];
assign width_logic_wrapper_in_flat[3] = in_flat[269];
...
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[273];

// Internal MTM connections (module-to-module)
assign shift_wrapper_in_flat[7] = const_arith_wrapper_out_flat[31];
assign bitwise_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[37];
...
assign cast_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[15];
assign const_compare_wrapper_in_flat[20] = const_concat_repl_wrapper_out_flat[16];
assign bitwise_reduce_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[12];
assign const_arith_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[16];
assign partselect_wrapper_in_flat[1] = const_logic_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[4] = const_logic_wrapper_out_flat[4];
assign select_wrapper_in_flat[16] = const_logic_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[2];
assign array_wrapper_in_flat[13] = const_partselect_wrapper_out_flat[2];
assign cast_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[6];
assign shift_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[2];
assign relational_wrapper_in_flat[7] = const_reduce_wrapper_out_flat[3];
assign array_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[3] = const_shift_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[0] = const_shift_wrapper_out_flat[8];
assign select_wrapper_in_flat[8] = const_shift_wrapper_out_flat[20];
assign const_conditional_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[0];
assign relational_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[16];
assign conditional_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[19] = bitwise_reduce_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[6] = bitwise_reduce_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[8] = logical_op_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[14] = logical_op_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[29] = relational_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[5] = select_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[11] = shift_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[0] = shift_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[1] = shift_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[10] = shift_wrapper_out_flat[15];
assign arithmetic_reduce_wrapper_in_flat[7] = array_wrapper_out_flat[3];
assign relational_wrapper_in_flat[3] = array_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[2] = array_wrapper_out_flat[9];
assign const_shift_wrapper_in_flat[9] = cast_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[0] = cast_wrapper_out_flat[2];
assign select_wrapper_in_flat[18] = cast_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[0] = cast_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[22] = conditional_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[10] = conditional_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[0] = conditional_wrapper_out_flat[1];
assign select_wrapper_in_flat[10] = conditional_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[8] = conditional_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[11] = width_enum_wrapper_out_flat[3];
assign select_wrapper_in_flat[9] = width_struct_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[9] = width_struct_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[7] = width_struct_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[26] = width_struct_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[6] = width_union_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[2] = width_union_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[1] = width_union_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[7] = width_union_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[2] = width_union_wrapper_out_flat[11];
...
assign partselect_wrapper_in_flat[18] = numbers_concat_repl_wrapper_out_flat[8];
