...
assign const_concat_repl_wrapper_in_flat[0] = in_flat[34];
...
assign const_conditional_wrapper_in_flat[0] = in_flat[41];
assign const_conditional_wrapper_in_flat[1] = in_flat[42];
assign const_conditional_wrapper_in_flat[2] = in_flat[43];
assign const_conditional_wrapper_in_flat[3] = in_flat[44];
assign const_conditional_wrapper_in_flat[4] = in_flat[45];
assign const_conditional_wrapper_in_flat[5] = in_flat[46];
assign const_conditional_wrapper_in_flat[6] = in_flat[47];
assign const_conditional_wrapper_in_flat[7] = in_flat[48];
assign const_conditional_wrapper_in_flat[8] = in_flat[49];
assign const_conditional_wrapper_in_flat[9] = in_flat[50];
assign const_conditional_wrapper_in_flat[10] = in_flat[51];
assign const_conditional_wrapper_in_flat[11] = in_flat[52];
assign const_conditional_wrapper_in_flat[12] = in_flat[53];
...
assign const_conditional_wrapper_in_flat[32] = in_flat[72];
assign const_conditional_wrapper_in_flat[33] = in_flat[73];
assign const_logic_wrapper_in_flat[0] = in_flat[74];
assign const_logic_wrapper_in_flat[1] = in_flat[75];
assign const_logic_wrapper_in_flat[3] = in_flat[76];
assign const_logic_wrapper_in_flat[4] = in_flat[77];
assign const_logic_wrapper_in_flat[5] = in_flat[78];
assign const_logic_wrapper_in_flat[6] = in_flat[79];
assign const_logic_wrapper_in_flat[7] = in_flat[80];
assign const_logic_wrapper_in_flat[8] = in_flat[81];
assign const_logic_wrapper_in_flat[9] = in_flat[82];
assign const_nested_wrapper_in_flat[1] = in_flat[83];
assign const_nested_wrapper_in_flat[2] = in_flat[84];
assign const_nested_wrapper_in_flat[3] = in_flat[85];
assign const_nested_wrapper_in_flat[4] = in_flat[86];
assign const_nested_wrapper_in_flat[5] = in_flat[87];
...
assign const_nested_wrapper_in_flat[19] = in_flat[100];
...
assign const_partselect_wrapper_in_flat[4] = in_flat[110];
assign const_partselect_wrapper_in_flat[5] = in_flat[111];
assign const_partselect_wrapper_in_flat[6] = in_flat[112];
assign const_partselect_wrapper_in_flat[7] = in_flat[113];
assign const_partselect_wrapper_in_flat[8] = in_flat[114];
...
assign const_shift_wrapper_in_flat[0] = in_flat[121];
assign const_shift_wrapper_in_flat[1] = in_flat[122];
...
assign arithmetic_reduce_wrapper_in_flat[3] = in_flat[132];
assign arithmetic_reduce_wrapper_in_flat[4] = in_flat[133];
assign arithmetic_reduce_wrapper_in_flat[6] = in_flat[134];
assign arithmetic_reduce_wrapper_in_flat[8] = in_flat[135];
assign arithmetic_reduce_wrapper_in_flat[9] = in_flat[136];
assign arithmetic_reduce_wrapper_in_flat[10] = in_flat[137];
assign arithmetic_reduce_wrapper_in_flat[11] = in_flat[138];
assign arithmetic_reduce_wrapper_in_flat[12] = in_flat[139];
assign arithmetic_reduce_wrapper_in_flat[13] = in_flat[140];
assign arithmetic_reduce_wrapper_in_flat[14] = in_flat[141];
...
assign bitwise_logic_wrapper_in_flat[3] = in_flat[145];
assign bitwise_logic_wrapper_in_flat[4] = in_flat[146];
assign bitwise_logic_wrapper_in_flat[5] = in_flat[147];
...
assign bitwise_logic_wrapper_in_flat[11] = in_flat[153];
assign bitwise_logic_wrapper_in_flat[12] = in_flat[154];
assign bitwise_logic_wrapper_in_flat[13] = in_flat[155];
assign bitwise_logic_wrapper_in_flat[14] = in_flat[156];
assign bitwise_logic_wrapper_in_flat[15] = in_flat[157];
assign bitwise_reduce_wrapper_in_flat[1] = in_flat[158];
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[159];
assign bitwise_reduce_wrapper_in_flat[3] = in_flat[160];
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[161];
assign relational_wrapper_in_flat[0] = in_flat[162];
assign relational_wrapper_in_flat[1] = in_flat[163];
assign relational_wrapper_in_flat[4] = in_flat[164];
assign relational_wrapper_in_flat[5] = in_flat[165];
assign select_wrapper_in_flat[0] = in_flat[166];
assign select_wrapper_in_flat[1] = in_flat[167];
assign select_wrapper_in_flat[2] = in_flat[168];
assign select_wrapper_in_flat[3] = in_flat[169];
assign select_wrapper_in_flat[4] = in_flat[170];
assign select_wrapper_in_flat[5] = in_flat[171];
assign select_wrapper_in_flat[6] = in_flat[172];
assign select_wrapper_in_flat[7] = in_flat[173];
assign select_wrapper_in_flat[9] = in_flat[174];
assign select_wrapper_in_flat[10] = in_flat[175];
assign select_wrapper_in_flat[11] = in_flat[176];
assign select_wrapper_in_flat[12] = in_flat[177];
assign select_wrapper_in_flat[13] = in_flat[178];
assign select_wrapper_in_flat[15] = in_flat[179];
assign select_wrapper_in_flat[16] = in_flat[180];
...
assign shift_wrapper_in_flat[1] = in_flat[185];
...
assign array_wrapper_in_flat[2] = in_flat[194];
assign array_wrapper_in_flat[3] = in_flat[195];
assign array_wrapper_in_flat[4] = in_flat[196];
assign array_wrapper_in_flat[5] = in_flat[197];
assign array_wrapper_in_flat[6] = in_flat[198];
assign array_wrapper_in_flat[7] = in_flat[199];
assign array_wrapper_in_flat[8] = in_flat[200];
assign array_wrapper_in_flat[9] = in_flat[201];
...
assign array_wrapper_in_flat[13] = in_flat[205];
assign array_wrapper_in_flat[14] = in_flat[206];
assign array_wrapper_in_flat[15] = in_flat[207];
assign array_wrapper_in_flat[17] = in_flat[208];
assign cast_wrapper_in_flat[0] = in_flat[209];
assign cast_wrapper_in_flat[1] = in_flat[210];
assign cast_wrapper_in_flat[2] = in_flat[211];
assign cast_wrapper_in_flat[4] = in_flat[212];
assign cast_wrapper_in_flat[7] = in_flat[213];
assign cast_wrapper_in_flat[8] = in_flat[214];
assign cast_wrapper_in_flat[9] = in_flat[215];
assign cast_wrapper_in_flat[10] = in_flat[216];
assign cast_wrapper_in_flat[11] = in_flat[217];
assign conditional_wrapper_in_flat[1] = in_flat[218];
assign conditional_wrapper_in_flat[4] = in_flat[219];
assign conditional_wrapper_in_flat[6] = in_flat[220];
assign conditional_wrapper_in_flat[7] = in_flat[221];
assign conditional_wrapper_in_flat[8] = in_flat[222];
assign partselect_wrapper_in_flat[0] = in_flat[223];
assign partselect_wrapper_in_flat[2] = in_flat[224];
assign partselect_wrapper_in_flat[3] = in_flat[225];
assign partselect_wrapper_in_flat[4] = in_flat[226];
assign partselect_wrapper_in_flat[6] = in_flat[227];
assign partselect_wrapper_in_flat[7] = in_flat[228];
assign partselect_wrapper_in_flat[9] = in_flat[229];
assign partselect_wrapper_in_flat[10] = in_flat[230];
assign partselect_wrapper_in_flat[11] = in_flat[231];
assign partselect_wrapper_in_flat[12] = in_flat[232];
assign partselect_wrapper_in_flat[13] = in_flat[233];
assign partselect_wrapper_in_flat[16] = in_flat[234];
assign partselect_wrapper_in_flat[17] = in_flat[235];
assign partselect_wrapper_in_flat[18] = in_flat[236];
assign width_enum_wrapper_in_flat[0] = in_flat[237];
...
assign width_logic_wrapper_in_flat[0] = in_flat[261];
assign width_logic_wrapper_in_flat[1] = in_flat[262];
assign width_logic_wrapper_in_flat[3] = in_flat[263];
assign width_logic_wrapper_in_flat[4] = in_flat[264];
assign width_logic_wrapper_in_flat[5] = in_flat[265];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[266];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[267];

// Internal MTM connections (module-to-module)
assign partselect_wrapper_in_flat[5] = const_arith_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[12];
assign const_conditional_wrapper_in_flat[21] = const_arith_wrapper_out_flat[20];
assign numbers_concat_repl_wrapper_in_flat[5] = const_arith_wrapper_out_flat[31];
assign conditional_wrapper_in_flat[5] = const_compare_wrapper_out_flat[2];
assign shift_wrapper_in_flat[9] = const_compare_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[2];
assign array_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[21];
assign conditional_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[20];
assign width_enum_wrapper_in_flat[2] = const_logic_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[0] = const_logic_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[1] = const_logic_wrapper_out_flat[6];
assign select_wrapper_in_flat[14] = const_logic_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[4] = const_logic_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[3] = const_logic_wrapper_out_flat[12];
assign array_wrapper_in_flat[16] = const_logic_wrapper_out_flat[14];
assign width_logic_wrapper_in_flat[7] = const_nested_wrapper_out_flat[1];
assign relational_wrapper_in_flat[3] = const_nested_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[20] = const_reduce_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[2] = const_shift_wrapper_out_flat[23];
assign numbers_concat_repl_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[3];
assign select_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[13];
assign const_shift_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[17];
assign const_partselect_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[15] = bitwise_logic_wrapper_out_flat[19];
assign const_logic_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[20];
assign cast_wrapper_in_flat[5] = bitwise_reduce_wrapper_out_flat[1];
assign shift_wrapper_in_flat[2] = logical_op_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[9] = logical_op_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[0] = relational_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[1] = select_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[6] = select_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[1] = select_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[1] = shift_wrapper_out_flat[12];
assign cast_wrapper_in_flat[3] = shift_wrapper_out_flat[15];
assign const_reduce_wrapper_in_flat[1] = array_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[14] = array_wrapper_out_flat[5];
assign const_arith_wrapper_in_flat[7] = array_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[5] = conditional_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[8] = conditional_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[4] = partselect_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[15] = partselect_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[0] = partselect_wrapper_out_flat[8];
assign logical_op_wrapper_in_flat[1] = width_enum_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[5] = width_struct_wrapper_out_flat[7];
assign cast_wrapper_in_flat[6] = width_struct_wrapper_out_flat[8];
assign relational_wrapper_in_flat[2] = width_struct_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[8] = width_union_wrapper_out_flat[3];
assign relational_wrapper_in_flat[7] = width_union_wrapper_out_flat[10];
assign const_shift_wrapper_in_flat[6] = width_logic_wrapper_out_flat[0];
assign relational_wrapper_in_flat[6] = width_logic_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[19] = width_logic_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[6] = width_logic_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[9];
