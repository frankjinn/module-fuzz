...
assign conditional_wrapper_in_flat[7] = in_flat[217];
...
assign const_logic_wrapper_in_flat[8] = const_arith_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[2] = const_arith_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[2] = const_arith_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[18] = const_arith_wrapper_out_flat[14];
assign numbers_concat_repl_wrapper_in_flat[0] = const_compare_wrapper_out_flat[3];
assign cast_wrapper_in_flat[8] = const_compare_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[1] = const_compare_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[18] = const_concat_repl_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[22] = const_concat_repl_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[11];
assign const_conditional_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[16];
assign select_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[21];
assign width_logic_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[12];
assign const_reduce_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[15];
assign shift_wrapper_in_flat[0] = const_logic_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[7] = const_logic_wrapper_out_flat[4];
assign logical_op_wrapper_in_flat[1] = const_logic_wrapper_out_flat[10];
...
assign const_logic_wrapper_in_flat[0] = const_nested_wrapper_out_flat[7];
assign logical_op_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[2];
assign relational_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[5];
assign select_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[14] = const_shift_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[2] = const_shift_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[23] = const_shift_wrapper_out_flat[23];
assign shift_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[8];
assign const_conditional_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[0];
assign shift_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[13];
assign const_logic_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[14];
assign width_enum_wrapper_in_flat[2] = logical_op_wrapper_out_flat[1];
assign select_wrapper_in_flat[7] = logical_op_wrapper_out_flat[1];
assign relational_wrapper_in_flat[2] = logical_op_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[2] = relational_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[0] = relational_wrapper_out_flat[1];
...
assign const_conditional_wrapper_in_flat[27] = shift_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[7] = shift_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[2] = shift_wrapper_out_flat[12];
assign cast_wrapper_in_flat[10] = array_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[0] = array_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[10] = array_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[1] = array_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[13] = array_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[15] = array_wrapper_out_flat[13];
assign bitwise_logic_wrapper_in_flat[13] = cast_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[3] = cast_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[10] = cast_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[6] = conditional_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[2] = partselect_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[4] = partselect_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[2] = width_enum_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[1] = width_enum_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[3] = width_struct_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[6] = width_struct_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[0] = width_union_wrapper_out_flat[7];
assign cast_wrapper_in_flat[11] = width_union_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[0] = width_union_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[7] = width_union_wrapper_out_flat[13];
assign bitwise_reduce_wrapper_in_flat[3] = width_logic_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[4];
assign cast_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[17] = numbers_concat_repl_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[16];
assign array_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[17];
