...
assign width_logic_wrapper_in_flat[2] = in_flat[261];
assign width_logic_wrapper_in_flat[5] = in_flat[262];
assign width_logic_wrapper_in_flat[7] = in_flat[263];
...
assign const_shift_wrapper_in_flat[8] = const_arith_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[4] = const_arith_wrapper_out_flat[6];
assign bitwise_logic_wrapper_in_flat[15] = const_arith_wrapper_out_flat[10];
assign conditional_wrapper_in_flat[0] = const_compare_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[23] = const_compare_wrapper_out_flat[5];
assign select_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[5];
assign logical_op_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[9];
assign const_shift_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[18];
assign partselect_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[19];
assign numbers_concat_repl_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[21];
assign const_partselect_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[1];
assign select_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[14];
assign partselect_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[19];
assign const_concat_repl_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[20];
assign const_logic_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[23];
assign bitwise_reduce_wrapper_in_flat[2] = const_logic_wrapper_out_flat[4];
assign select_wrapper_in_flat[10] = const_logic_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[11] = const_logic_wrapper_out_flat[15];
assign const_compare_wrapper_in_flat[21] = const_logic_wrapper_out_flat[16];
assign const_reduce_wrapper_in_flat[1] = const_nested_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[5] = const_nested_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[6] = const_nested_wrapper_out_flat[7];
assign select_wrapper_in_flat[19] = const_partselect_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[5];
assign shift_wrapper_in_flat[0] = const_shift_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[5] = const_shift_wrapper_out_flat[14];
assign select_wrapper_in_flat[3] = const_shift_wrapper_out_flat[19];
assign width_union_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[9];
assign width_enum_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[7];
assign cast_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[9];
assign bitwise_reduce_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[18];
assign const_partselect_wrapper_in_flat[19] = bitwise_logic_wrapper_out_flat[20];
assign const_concat_repl_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[22];
assign numbers_concat_repl_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[23];
...
assign array_wrapper_in_flat[6] = logical_op_wrapper_out_flat[2];
assign shift_wrapper_in_flat[2] = logical_op_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[2] = shift_wrapper_out_flat[0];
assign array_wrapper_in_flat[10] = shift_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[1] = shift_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[9] = shift_wrapper_out_flat[14];
assign relational_wrapper_in_flat[2] = shift_wrapper_out_flat[15];
assign const_compare_wrapper_in_flat[1] = shift_wrapper_out_flat[15];
assign bitwise_reduce_wrapper_in_flat[6] = array_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[3] = array_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[1] = array_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[2] = array_wrapper_out_flat[12];
assign relational_wrapper_in_flat[7] = array_wrapper_out_flat[14];
assign const_conditional_wrapper_in_flat[24] = cast_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[1] = cast_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[6] = cast_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[12] = conditional_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[0] = conditional_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[10] = partselect_wrapper_out_flat[0];
assign select_wrapper_in_flat[0] = partselect_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[2] = partselect_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[4] = width_enum_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[2] = width_struct_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[12] = width_struct_wrapper_out_flat[7];
assign array_wrapper_in_flat[17] = width_struct_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[6] = width_union_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[17] = numbers_concat_repl_wrapper_out_flat[1];
assign array_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[3];
assign relational_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[15];
assign select_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[15];
