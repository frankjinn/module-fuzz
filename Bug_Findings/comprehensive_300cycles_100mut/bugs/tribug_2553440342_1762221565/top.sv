...
assign const_compare_wrapper_in_flat[14] = in_flat[26];
...
assign const_logic_wrapper_in_flat[3] = in_flat[77];
assign const_logic_wrapper_in_flat[4] = in_flat[78];
...
assign const_nested_wrapper_in_flat[0] = in_flat[84];
assign const_nested_wrapper_in_flat[4] = in_flat[85];
assign const_nested_wrapper_in_flat[5] = in_flat[86];
assign const_nested_wrapper_in_flat[6] = in_flat[87];
assign const_nested_wrapper_in_flat[7] = in_flat[88];
assign const_nested_wrapper_in_flat[8] = in_flat[89];
assign const_nested_wrapper_in_flat[9] = in_flat[90];
assign const_nested_wrapper_in_flat[10] = in_flat[91];
...
assign const_partselect_wrapper_in_flat[11] = in_flat[115];
assign const_partselect_wrapper_in_flat[12] = in_flat[116];
assign const_partselect_wrapper_in_flat[13] = in_flat[117];
assign const_partselect_wrapper_in_flat[14] = in_flat[118];
assign const_partselect_wrapper_in_flat[15] = in_flat[119];
assign const_partselect_wrapper_in_flat[16] = in_flat[120];
assign const_partselect_wrapper_in_flat[17] = in_flat[121];
assign const_partselect_wrapper_in_flat[18] = in_flat[122];
assign const_reduce_wrapper_in_flat[2] = in_flat[123];
assign const_shift_wrapper_in_flat[0] = in_flat[124];
assign const_shift_wrapper_in_flat[1] = in_flat[125];
assign const_shift_wrapper_in_flat[2] = in_flat[126];
assign const_shift_wrapper_in_flat[3] = in_flat[127];
assign const_shift_wrapper_in_flat[4] = in_flat[128];
assign const_shift_wrapper_in_flat[5] = in_flat[129];
assign const_shift_wrapper_in_flat[6] = in_flat[130];
...
assign arithmetic_reduce_wrapper_in_flat[9] = in_flat[138];
assign arithmetic_reduce_wrapper_in_flat[10] = in_flat[139];
assign arithmetic_reduce_wrapper_in_flat[12] = in_flat[140];
...
assign select_wrapper_in_flat[0] = in_flat[164];
...
assign select_wrapper_in_flat[5] = in_flat[168];
...
assign shift_wrapper_in_flat[9] = in_flat[182];
...
assign conditional_wrapper_in_flat[3] = in_flat[207];
assign conditional_wrapper_in_flat[4] = in_flat[208];
...
assign partselect_wrapper_in_flat[3] = in_flat[214];
assign partselect_wrapper_in_flat[4] = in_flat[215];
...
assign width_struct_wrapper_in_flat[5] = in_flat[231];
assign width_struct_wrapper_in_flat[6] = in_flat[232];
...
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[257];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[258];

// Internal MTM connections (module-to-module)
assign const_shift_wrapper_in_flat[10] = const_arith_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[6] = const_arith_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[9] = const_arith_wrapper_out_flat[2];
assign cast_wrapper_in_flat[11] = const_arith_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[2] = const_arith_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[8] = const_arith_wrapper_out_flat[31];
assign width_struct_wrapper_in_flat[3] = const_arith_wrapper_out_flat[35];
assign bitwise_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[36];
assign bitwise_logic_wrapper_in_flat[8] = const_arith_wrapper_out_flat[38];
assign select_wrapper_in_flat[4] = const_compare_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[6] = const_compare_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[8];
assign array_wrapper_in_flat[17] = const_concat_repl_wrapper_out_flat[11];
assign bitwise_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[18];
assign const_arith_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[18];
assign cast_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[21];
assign width_logic_wrapper_in_flat[0] = const_logic_wrapper_out_flat[2];
assign shift_wrapper_in_flat[7] = const_logic_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[11] = const_logic_wrapper_out_flat[12];
assign const_shift_wrapper_in_flat[7] = const_logic_wrapper_out_flat[13];
assign arithmetic_reduce_wrapper_in_flat[7] = const_logic_wrapper_out_flat[16];
assign const_conditional_wrapper_in_flat[6] = const_nested_wrapper_out_flat[7];
assign relational_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[15] = const_partselect_wrapper_out_flat[4];
assign relational_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[0];
assign select_wrapper_in_flat[19] = const_reduce_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[15] = const_shift_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[2] = const_shift_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[8] = const_shift_wrapper_out_flat[9];
assign shift_wrapper_in_flat[0] = const_shift_wrapper_out_flat[11];
assign bitwise_logic_wrapper_in_flat[4] = const_shift_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[1] = const_shift_wrapper_out_flat[16];
assign array_wrapper_in_flat[15] = arithmetic_reduce_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[19] = arithmetic_reduce_wrapper_out_flat[8];
assign numbers_concat_repl_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[2];
assign cast_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[11];
assign relational_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[17] = bitwise_logic_wrapper_out_flat[13];
assign select_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[17];
assign const_reduce_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[20];
assign select_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[1];
assign shift_wrapper_in_flat[1] = logical_op_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[2] = logical_op_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[2] = relational_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = relational_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[3] = select_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[17] = shift_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[13] = shift_wrapper_out_flat[8];
assign shift_wrapper_in_flat[10] = array_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[2] = array_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[3] = array_wrapper_out_flat[10];
assign const_compare_wrapper_in_flat[15] = cast_wrapper_out_flat[0];
assign select_wrapper_in_flat[9] = cast_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[4] = cast_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[3] = cast_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[4] = conditional_wrapper_out_flat[1];
assign array_wrapper_in_flat[9] = conditional_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[8] = conditional_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[0] = conditional_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[7] = conditional_wrapper_out_flat[3];
assign shift_wrapper_in_flat[2] = partselect_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[0] = width_enum_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[0] = width_enum_wrapper_out_flat[4];
assign cast_wrapper_in_flat[7] = width_struct_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[11] = width_struct_wrapper_out_flat[9];
assign cast_wrapper_in_flat[3] = width_union_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[4] = width_union_wrapper_out_flat[12];
assign select_wrapper_in_flat[6] = width_union_wrapper_out_flat[13];
assign const_concat_repl_wrapper_in_flat[2] = width_union_wrapper_out_flat[13];
assign const_arith_wrapper_in_flat[4] = width_union_wrapper_out_flat[14];
assign shift_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[14];
