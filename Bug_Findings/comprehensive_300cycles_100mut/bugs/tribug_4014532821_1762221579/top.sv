...
assign const_logic_wrapper_in_flat[5] = const_arith_wrapper_out_flat[34];
assign const_compare_wrapper_in_flat[21] = const_arith_wrapper_out_flat[34];
assign width_logic_wrapper_in_flat[3] = const_compare_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[6] = const_compare_wrapper_out_flat[7];
assign relational_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[22] = const_concat_repl_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[7];
assign cast_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[24] = const_concat_repl_wrapper_out_flat[12];
assign width_enum_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[17];
assign bitwise_reduce_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[17] = const_conditional_wrapper_out_flat[11];
assign arithmetic_reduce_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[12];
assign const_reduce_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[16];
assign select_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[23];
assign arithmetic_reduce_wrapper_in_flat[1] = const_logic_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[3] = const_logic_wrapper_out_flat[10];
assign cast_wrapper_in_flat[3] = const_logic_wrapper_out_flat[12];
assign array_wrapper_in_flat[7] = const_logic_wrapper_out_flat[13];
assign const_conditional_wrapper_in_flat[17] = const_logic_wrapper_out_flat[16];
assign partselect_wrapper_in_flat[1] = const_nested_wrapper_out_flat[0];
assign array_wrapper_in_flat[9] = const_nested_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[0] = const_nested_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[4] = const_nested_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[3] = const_nested_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[7];
assign cast_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[2];
assign array_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[0] = const_shift_wrapper_out_flat[1];
assign shift_wrapper_in_flat[10] = const_shift_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[4] = const_shift_wrapper_out_flat[9];
assign partselect_wrapper_in_flat[0] = const_shift_wrapper_out_flat[19];
assign const_arith_wrapper_in_flat[5] = const_shift_wrapper_out_flat[20];
assign select_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[7];
assign relational_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[17];
...
assign conditional_wrapper_in_flat[2] = bitwise_reduce_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[1];
assign shift_wrapper_in_flat[4] = bitwise_reduce_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[8] = logical_op_wrapper_out_flat[0];
assign cast_wrapper_in_flat[8] = relational_wrapper_out_flat[1];
assign shift_wrapper_in_flat[8] = relational_wrapper_out_flat[7];
assign relational_wrapper_in_flat[5] = select_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[5] = select_wrapper_out_flat[2];
assign cast_wrapper_in_flat[1] = select_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[6] = shift_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[18] = shift_wrapper_out_flat[12];
assign arithmetic_reduce_wrapper_in_flat[14] = array_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[2] = array_wrapper_out_flat[2];
assign select_wrapper_in_flat[16] = array_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[2] = array_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[9] = array_wrapper_out_flat[13];
assign partselect_wrapper_in_flat[16] = array_wrapper_out_flat[14];
assign shift_wrapper_in_flat[0] = cast_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[2] = cast_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[0] = cast_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[0] = cast_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[11] = conditional_wrapper_out_flat[0];
assign relational_wrapper_in_flat[6] = partselect_wrapper_out_flat[1];
assign select_wrapper_in_flat[14] = partselect_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[6] = partselect_wrapper_out_flat[8];
assign const_conditional_wrapper_in_flat[32] = width_enum_wrapper_out_flat[1];
assign shift_wrapper_in_flat[3] = width_union_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[0] = width_union_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[6] = width_union_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[6] = width_union_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[1] = width_union_wrapper_out_flat[11];
assign const_concat_repl_wrapper_in_flat[6] = width_union_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[11];
assign width_struct_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[13];
