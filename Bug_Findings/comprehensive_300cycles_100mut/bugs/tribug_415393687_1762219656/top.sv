...
assign const_reduce_wrapper_in_flat[2] = in_flat[116];
...
assign bitwise_logic_wrapper_in_flat[1] = in_flat[145];
...
assign array_wrapper_in_flat[12] = in_flat[201];
...
assign array_wrapper_in_flat[16] = in_flat[205];
assign array_wrapper_in_flat[17] = in_flat[206];
...
assign cast_wrapper_in_flat[11] = in_flat[215];
assign conditional_wrapper_in_flat[0] = in_flat[216];
assign conditional_wrapper_in_flat[1] = in_flat[217];
assign conditional_wrapper_in_flat[2] = in_flat[218];
...
assign partselect_wrapper_in_flat[13] = in_flat[231];
assign partselect_wrapper_in_flat[14] = in_flat[232];
assign partselect_wrapper_in_flat[15] = in_flat[233];
assign partselect_wrapper_in_flat[18] = in_flat[234];
assign width_enum_wrapper_in_flat[2] = in_flat[235];
...
assign width_logic_wrapper_in_flat[6] = in_flat[260];
assign width_logic_wrapper_in_flat[7] = in_flat[261];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[262];
...
assign const_partselect_wrapper_in_flat[15] = const_arith_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[0] = const_arith_wrapper_out_flat[10];
assign const_compare_wrapper_in_flat[17] = const_arith_wrapper_out_flat[21];
assign const_logic_wrapper_in_flat[9] = const_compare_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[2] = const_compare_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[2] = const_compare_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[16] = const_concat_repl_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[20] = const_concat_repl_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[12];
assign cast_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[14];
assign logical_op_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[14];
assign bitwise_reduce_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[21];
assign bitwise_logic_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[8];
assign relational_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[11];
assign partselect_wrapper_in_flat[17] = const_conditional_wrapper_out_flat[13];
assign bitwise_reduce_wrapper_in_flat[4] = const_logic_wrapper_out_flat[18];
assign select_wrapper_in_flat[13] = const_nested_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[0] = const_nested_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[5] = const_nested_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[9] = const_nested_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[1] = const_nested_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[10] = const_shift_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[3] = const_shift_wrapper_out_flat[8];
assign width_enum_wrapper_in_flat[0] = const_shift_wrapper_out_flat[12];
assign array_wrapper_in_flat[0] = const_shift_wrapper_out_flat[19];
assign const_conditional_wrapper_in_flat[8] = const_shift_wrapper_out_flat[22];
assign const_partselect_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[17] = bitwise_logic_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[7];
assign cast_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[11];
assign width_enum_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[12];
assign select_wrapper_in_flat[17] = bitwise_logic_wrapper_out_flat[20];
assign numbers_concat_repl_wrapper_in_flat[3] = logical_op_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[14] = relational_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[0] = select_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[13] = select_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[4] = select_wrapper_out_flat[8];
assign select_wrapper_in_flat[16] = shift_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[7] = shift_wrapper_out_flat[14];
assign bitwise_reduce_wrapper_in_flat[2] = array_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[7] = array_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[9] = array_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[4] = array_wrapper_out_flat[8];
assign cast_wrapper_in_flat[7] = array_wrapper_out_flat[10];
assign bitwise_logic_wrapper_in_flat[12] = array_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[26] = cast_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[6] = cast_wrapper_out_flat[4];
...
assign relational_wrapper_in_flat[5] = partselect_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[14] = partselect_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[3] = partselect_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[3] = partselect_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[6] = partselect_wrapper_out_flat[8];
assign const_concat_repl_wrapper_in_flat[2] = width_struct_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[2] = width_struct_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[11] = width_union_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[22] = width_union_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[1] = width_union_wrapper_out_flat[4];
assign select_wrapper_in_flat[4] = width_union_wrapper_out_flat[14];
assign width_union_wrapper_in_flat[8] = width_logic_wrapper_out_flat[1];
assign shift_wrapper_in_flat[3] = width_logic_wrapper_out_flat[5];
assign select_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[7];
