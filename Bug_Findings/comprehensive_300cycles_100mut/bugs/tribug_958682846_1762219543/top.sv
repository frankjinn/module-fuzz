...
assign const_nested_wrapper_in_flat[7] = in_flat[92];
assign const_nested_wrapper_in_flat[8] = in_flat[93];
assign const_nested_wrapper_in_flat[9] = in_flat[94];
assign const_nested_wrapper_in_flat[10] = in_flat[95];
assign const_nested_wrapper_in_flat[11] = in_flat[96];
assign const_nested_wrapper_in_flat[14] = in_flat[97];
assign const_nested_wrapper_in_flat[15] = in_flat[98];
...
assign const_partselect_wrapper_in_flat[0] = in_flat[108];
...
assign arithmetic_reduce_wrapper_in_flat[1] = in_flat[134];
assign arithmetic_reduce_wrapper_in_flat[2] = in_flat[135];
assign arithmetic_reduce_wrapper_in_flat[3] = in_flat[136];
...
assign relational_wrapper_in_flat[6] = in_flat[169];
assign relational_wrapper_in_flat[7] = in_flat[170];
...
assign select_wrapper_in_flat[17] = in_flat[185];
assign select_wrapper_in_flat[18] = in_flat[186];
assign select_wrapper_in_flat[19] = in_flat[187];
assign shift_wrapper_in_flat[0] = in_flat[188];
...
assign array_wrapper_in_flat[0] = in_flat[194];
...
assign partselect_wrapper_in_flat[14] = in_flat[234];
assign partselect_wrapper_in_flat[15] = in_flat[235];
assign partselect_wrapper_in_flat[16] = in_flat[236];
assign partselect_wrapper_in_flat[17] = in_flat[237];
assign partselect_wrapper_in_flat[18] = in_flat[238];
...
assign width_logic_wrapper_in_flat[1] = in_flat[261];
assign width_logic_wrapper_in_flat[4] = in_flat[262];
assign width_logic_wrapper_in_flat[5] = in_flat[263];
assign width_logic_wrapper_in_flat[6] = in_flat[264];
assign width_logic_wrapper_in_flat[7] = in_flat[265];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[266];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[267];
...
assign logical_op_wrapper_in_flat[0] = const_arith_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[1] = const_arith_wrapper_out_flat[5];
assign select_wrapper_in_flat[8] = const_arith_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[16] = const_arith_wrapper_out_flat[11];
assign partselect_wrapper_in_flat[8] = const_arith_wrapper_out_flat[17];
assign arithmetic_reduce_wrapper_in_flat[11] = const_arith_wrapper_out_flat[24];
assign shift_wrapper_in_flat[8] = const_arith_wrapper_out_flat[27];
assign const_shift_wrapper_in_flat[4] = const_arith_wrapper_out_flat[30];
assign cast_wrapper_in_flat[0] = const_arith_wrapper_out_flat[32];
assign width_enum_wrapper_in_flat[3] = const_arith_wrapper_out_flat[33];
assign conditional_wrapper_in_flat[3] = const_compare_wrapper_out_flat[0];
assign array_wrapper_in_flat[10] = const_compare_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[18];
assign shift_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[19];
assign const_partselect_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[9];
assign bitwise_reduce_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[0] = const_logic_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[15] = const_nested_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[6] = const_nested_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[5];
assign logical_op_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[7] = const_reduce_wrapper_out_flat[1];
assign cast_wrapper_in_flat[9] = const_reduce_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[2];
assign array_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[1] = const_shift_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[19] = const_shift_wrapper_out_flat[9];
assign shift_wrapper_in_flat[4] = const_shift_wrapper_out_flat[17];
assign const_conditional_wrapper_in_flat[2] = const_shift_wrapper_out_flat[20];
assign arithmetic_reduce_wrapper_in_flat[0] = const_shift_wrapper_out_flat[20];
assign select_wrapper_in_flat[12] = const_shift_wrapper_out_flat[21];
assign relational_wrapper_in_flat[5] = const_shift_wrapper_out_flat[23];
assign width_union_wrapper_in_flat[11] = arithmetic_reduce_wrapper_out_flat[1];
assign shift_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[8] = bitwise_reduce_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[4] = bitwise_reduce_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[9] = logical_op_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[10] = logical_op_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[8] = relational_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[1] = relational_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[6] = relational_wrapper_out_flat[4];
assign select_wrapper_in_flat[11] = relational_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[17] = relational_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[2] = relational_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[12] = select_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[3] = select_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[1] = select_wrapper_out_flat[1];
...
assign const_partselect_wrapper_in_flat[5] = shift_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[3] = shift_wrapper_out_flat[10];
assign cast_wrapper_in_flat[6] = shift_wrapper_out_flat[11];
assign width_struct_wrapper_in_flat[6] = cast_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[2] = cast_wrapper_out_flat[0];
assign shift_wrapper_in_flat[5] = partselect_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[1] = partselect_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[13] = width_enum_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[1] = width_enum_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[4] = width_struct_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[26] = width_union_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[4] = width_union_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[6] = width_logic_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[8] = width_logic_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[12] = numbers_concat_repl_wrapper_out_flat[15];
