...
assign const_nested_wrapper_in_flat[11] = const_arith_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[12] = const_arith_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[14] = const_arith_wrapper_out_flat[17];
assign const_logic_wrapper_in_flat[1] = const_arith_wrapper_out_flat[26];
assign const_reduce_wrapper_in_flat[3] = const_arith_wrapper_out_flat[29];
assign arithmetic_reduce_wrapper_in_flat[9] = const_arith_wrapper_out_flat[31];
assign conditional_wrapper_in_flat[7] = const_arith_wrapper_out_flat[32];
assign cast_wrapper_in_flat[4] = const_arith_wrapper_out_flat[39];
assign const_nested_wrapper_in_flat[12] = const_compare_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[13] = const_compare_wrapper_out_flat[1];
assign relational_wrapper_in_flat[0] = const_compare_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[16] = const_concat_repl_wrapper_out_flat[10];
assign const_arith_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[11];
assign width_struct_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[11];
assign const_conditional_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[17] = const_concat_repl_wrapper_out_flat[14];
assign conditional_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[14];
assign array_wrapper_in_flat[15] = const_logic_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[4] = const_nested_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[0] = const_nested_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[1] = const_nested_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[14] = const_partselect_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[7] = const_reduce_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[2] = const_shift_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[7] = const_shift_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[15] = const_shift_wrapper_out_flat[19];
assign width_struct_wrapper_in_flat[5] = const_shift_wrapper_out_flat[22];
assign width_logic_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[6];
assign relational_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[8];
assign logical_op_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[15] = bitwise_logic_wrapper_out_flat[9];
assign shift_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[11];
assign width_enum_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[15];
assign width_union_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[16];
assign const_logic_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[19];
assign shift_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[2];
assign select_wrapper_in_flat[11] = bitwise_reduce_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[4] = logical_op_wrapper_out_flat[0];
assign cast_wrapper_in_flat[11] = logical_op_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[8] = select_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[18] = select_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[6] = select_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[30] = shift_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[27] = array_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[11] = array_wrapper_out_flat[14];
assign array_wrapper_in_flat[10] = cast_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[5] = conditional_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[13] = conditional_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[4] = conditional_wrapper_out_flat[3];
assign select_wrapper_in_flat[6] = conditional_wrapper_out_flat[3];
assign cast_wrapper_in_flat[2] = partselect_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[2] = partselect_wrapper_out_flat[8];
assign shift_wrapper_in_flat[5] = width_enum_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[4] = width_enum_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[5] = width_struct_wrapper_out_flat[3];
assign select_wrapper_in_flat[5] = width_struct_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[22] = width_struct_wrapper_out_flat[10];
assign width_enum_wrapper_in_flat[2] = width_union_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[16] = width_union_wrapper_out_flat[12];
assign relational_wrapper_in_flat[2] = width_union_wrapper_out_flat[13];
assign bitwise_logic_wrapper_in_flat[4] = width_logic_wrapper_out_flat[0];
assign array_wrapper_in_flat[6] = width_logic_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[3];
assign select_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[14] = numbers_concat_repl_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[10];
assign logical_op_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[13];
