...
assign const_nested_wrapper_in_flat[2] = in_flat[88];
assign const_nested_wrapper_in_flat[3] = in_flat[89];
assign const_nested_wrapper_in_flat[4] = in_flat[90];
assign const_nested_wrapper_in_flat[5] = in_flat[91];
assign const_nested_wrapper_in_flat[6] = in_flat[92];
assign const_nested_wrapper_in_flat[7] = in_flat[93];
assign const_nested_wrapper_in_flat[8] = in_flat[94];
assign const_nested_wrapper_in_flat[10] = in_flat[95];
assign const_nested_wrapper_in_flat[11] = in_flat[96];
assign const_nested_wrapper_in_flat[12] = in_flat[97];
...
assign const_partselect_wrapper_in_flat[6] = in_flat[115];
assign const_partselect_wrapper_in_flat[7] = in_flat[116];
assign const_partselect_wrapper_in_flat[8] = in_flat[117];
assign const_partselect_wrapper_in_flat[9] = in_flat[118];
assign const_partselect_wrapper_in_flat[11] = in_flat[119];
assign const_partselect_wrapper_in_flat[12] = in_flat[120];
...
assign const_reduce_wrapper_in_flat[1] = in_flat[127];
assign const_reduce_wrapper_in_flat[2] = in_flat[128];
...
assign const_shift_wrapper_in_flat[10] = in_flat[137];
assign arithmetic_reduce_wrapper_in_flat[0] = in_flat[138];
assign arithmetic_reduce_wrapper_in_flat[1] = in_flat[139];
assign arithmetic_reduce_wrapper_in_flat[4] = in_flat[140];
assign arithmetic_reduce_wrapper_in_flat[6] = in_flat[141];
assign arithmetic_reduce_wrapper_in_flat[7] = in_flat[142];
assign arithmetic_reduce_wrapper_in_flat[9] = in_flat[143];
...
assign shift_wrapper_in_flat[9] = in_flat[192];
...
assign conditional_wrapper_in_flat[8] = in_flat[224];
...
assign partselect_wrapper_in_flat[6] = in_flat[228];
...
assign partselect_wrapper_in_flat[17] = in_flat[236];
assign partselect_wrapper_in_flat[18] = in_flat[237];
...
assign const_nested_wrapper_in_flat[16] = const_arith_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[0] = const_arith_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[3] = const_arith_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[12] = const_arith_wrapper_out_flat[8];
assign array_wrapper_in_flat[3] = const_arith_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[2] = const_arith_wrapper_out_flat[17];
assign width_logic_wrapper_in_flat[5] = const_arith_wrapper_out_flat[20];
assign shift_wrapper_in_flat[2] = const_arith_wrapper_out_flat[20];
assign partselect_wrapper_in_flat[1] = const_compare_wrapper_out_flat[1];
assign select_wrapper_in_flat[3] = const_compare_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[4] = const_compare_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[8] = const_compare_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[7];
assign shift_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[14];
assign conditional_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[15];
assign width_logic_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[18];
assign relational_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[20];
assign numbers_concat_repl_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[20];
assign const_nested_wrapper_in_flat[19] = const_conditional_wrapper_out_flat[23];
assign const_nested_wrapper_in_flat[13] = const_logic_wrapper_out_flat[12];
assign width_logic_wrapper_in_flat[4] = const_logic_wrapper_out_flat[14];
assign array_wrapper_in_flat[11] = const_logic_wrapper_out_flat[17];
assign shift_wrapper_in_flat[1] = const_nested_wrapper_out_flat[0];
assign cast_wrapper_in_flat[3] = const_nested_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[6];
...
assign arithmetic_reduce_wrapper_in_flat[5] = const_shift_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[0] = const_shift_wrapper_out_flat[5];
assign logical_op_wrapper_in_flat[1] = const_shift_wrapper_out_flat[14];
assign const_concat_repl_wrapper_in_flat[0] = const_shift_wrapper_out_flat[22];
assign relational_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[1];
assign select_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[20];
assign partselect_wrapper_in_flat[5] = bitwise_reduce_wrapper_out_flat[0];
assign select_wrapper_in_flat[14] = bitwise_reduce_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[4] = logical_op_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[2] = relational_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[4] = relational_wrapper_out_flat[4];
assign cast_wrapper_in_flat[9] = shift_wrapper_out_flat[10];
assign const_reduce_wrapper_in_flat[3] = shift_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[3] = shift_wrapper_out_flat[13];
assign width_logic_wrapper_in_flat[3] = array_wrapper_out_flat[0];
...
assign const_nested_wrapper_in_flat[9] = array_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[0] = array_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[13] = array_wrapper_out_flat[11];
assign const_conditional_wrapper_in_flat[27] = array_wrapper_out_flat[11];
assign arithmetic_reduce_wrapper_in_flat[15] = cast_wrapper_out_flat[0];
assign relational_wrapper_in_flat[4] = cast_wrapper_out_flat[3];
assign select_wrapper_in_flat[7] = cast_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[0] = cast_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[21] = cast_wrapper_out_flat[9];
assign select_wrapper_in_flat[8] = partselect_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[11] = width_enum_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[14] = width_enum_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[13] = width_struct_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[0] = width_struct_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[0] = width_struct_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[0] = width_struct_wrapper_out_flat[11];
assign bitwise_reduce_wrapper_in_flat[3] = width_union_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[5] = width_union_wrapper_out_flat[11];
assign const_shift_wrapper_in_flat[2] = width_union_wrapper_out_flat[14];
...
assign width_struct_wrapper_in_flat[4] = width_logic_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[10] = width_logic_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[14] = numbers_concat_repl_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[13];
assign const_shift_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[17];
