...
assign const_reduce_wrapper_in_flat[1] = in_flat[114];
...
assign select_wrapper_in_flat[17] = in_flat[169];
...
assign shift_wrapper_in_flat[6] = in_flat[176];
...
assign array_wrapper_in_flat[4] = in_flat[183];
assign array_wrapper_in_flat[5] = in_flat[184];
assign array_wrapper_in_flat[7] = in_flat[185];
assign array_wrapper_in_flat[8] = in_flat[186];
assign array_wrapper_in_flat[9] = in_flat[187];
assign array_wrapper_in_flat[10] = in_flat[188];
assign array_wrapper_in_flat[11] = in_flat[189];
assign array_wrapper_in_flat[12] = in_flat[190];
assign array_wrapper_in_flat[13] = in_flat[191];
...
assign conditional_wrapper_in_flat[7] = in_flat[207];
...
assign width_struct_wrapper_in_flat[8] = in_flat[233];
...
assign numbers_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[9];
assign array_wrapper_in_flat[6] = const_arith_wrapper_out_flat[20];
assign const_logic_wrapper_in_flat[1] = const_arith_wrapper_out_flat[24];
assign const_nested_wrapper_in_flat[3] = const_arith_wrapper_out_flat[28];
assign width_struct_wrapper_in_flat[6] = const_arith_wrapper_out_flat[35];
assign select_wrapper_in_flat[16] = const_arith_wrapper_out_flat[38];
assign const_concat_repl_wrapper_in_flat[6] = const_arith_wrapper_out_flat[39];
assign bitwise_reduce_wrapper_in_flat[1] = const_compare_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[4];
assign relational_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[18] = const_concat_repl_wrapper_out_flat[12];
assign partselect_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[15];
...
assign select_wrapper_in_flat[12] = const_logic_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[5] = const_logic_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[4] = const_logic_wrapper_out_flat[6];
assign cast_wrapper_in_flat[8] = const_logic_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[3] = const_logic_wrapper_out_flat[16];
assign relational_wrapper_in_flat[0] = const_logic_wrapper_out_flat[16];
assign const_compare_wrapper_in_flat[21] = const_nested_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[10] = const_nested_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[7];
assign cast_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[2] = const_shift_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[8] = const_shift_wrapper_out_flat[8];
assign width_logic_wrapper_in_flat[1] = const_shift_wrapper_out_flat[13];
assign partselect_wrapper_in_flat[16] = const_shift_wrapper_out_flat[16];
assign const_nested_wrapper_in_flat[23] = const_shift_wrapper_out_flat[20];
assign width_union_wrapper_in_flat[12] = const_shift_wrapper_out_flat[21];
assign bitwise_reduce_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[2];
assign select_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[6];
assign relational_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[11] = arithmetic_reduce_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[0];
...
assign const_compare_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[15];
assign width_logic_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[16];
assign const_shift_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[19];
assign const_nested_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[23];
assign width_union_wrapper_in_flat[6] = relational_wrapper_out_flat[0];
assign shift_wrapper_in_flat[7] = relational_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[9] = relational_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[9] = relational_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[0] = select_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[13] = select_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[12] = select_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[14] = select_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[2] = shift_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[15] = shift_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[0] = shift_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[6] = array_wrapper_out_flat[0];
assign relational_wrapper_in_flat[1] = array_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[1] = array_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[11] = array_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[16] = cast_wrapper_out_flat[3];
assign shift_wrapper_in_flat[5] = cast_wrapper_out_flat[5];
assign select_wrapper_in_flat[18] = cast_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[6] = cast_wrapper_out_flat[6];
assign relational_wrapper_in_flat[5] = cast_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[7] = cast_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[20] = conditional_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[14] = conditional_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[1] = conditional_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[0] = partselect_wrapper_out_flat[8];
assign select_wrapper_in_flat[2] = width_struct_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[3] = width_struct_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[5] = width_struct_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[0] = width_union_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[5] = width_union_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[14] = width_union_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[30] = width_union_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[6] = width_logic_wrapper_out_flat[2];
assign array_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[4];
assign select_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[11];
