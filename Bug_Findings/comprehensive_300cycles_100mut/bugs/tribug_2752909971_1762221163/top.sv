...
assign const_logic_wrapper_in_flat[1] = in_flat[74];
assign const_logic_wrapper_in_flat[2] = in_flat[75];
...
assign const_nested_wrapper_in_flat[2] = in_flat[83];
assign const_nested_wrapper_in_flat[3] = in_flat[84];
assign const_nested_wrapper_in_flat[4] = in_flat[85];
assign const_nested_wrapper_in_flat[5] = in_flat[86];
...
assign const_partselect_wrapper_in_flat[0] = in_flat[103];
assign const_partselect_wrapper_in_flat[1] = in_flat[104];
assign const_partselect_wrapper_in_flat[2] = in_flat[105];
assign const_partselect_wrapper_in_flat[3] = in_flat[106];
assign const_partselect_wrapper_in_flat[4] = in_flat[107];
assign const_partselect_wrapper_in_flat[5] = in_flat[108];
assign const_partselect_wrapper_in_flat[6] = in_flat[109];
...
assign const_reduce_wrapper_in_flat[0] = in_flat[120];
...
assign bitwise_reduce_wrapper_in_flat[1] = in_flat[153];
assign bitwise_reduce_wrapper_in_flat[3] = in_flat[154];
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[155];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[156];
assign bitwise_reduce_wrapper_in_flat[7] = in_flat[157];
...
assign cast_wrapper_in_flat[4] = in_flat[199];
assign cast_wrapper_in_flat[6] = in_flat[200];
assign cast_wrapper_in_flat[8] = in_flat[201];
assign cast_wrapper_in_flat[9] = in_flat[202];
assign cast_wrapper_in_flat[11] = in_flat[203];
assign conditional_wrapper_in_flat[1] = in_flat[204];
assign conditional_wrapper_in_flat[3] = in_flat[205];
assign conditional_wrapper_in_flat[5] = in_flat[206];
...
assign width_struct_wrapper_in_flat[8] = in_flat[235];
assign width_struct_wrapper_in_flat[9] = in_flat[236];
...
assign width_union_wrapper_in_flat[7] = in_flat[245];
assign width_union_wrapper_in_flat[8] = in_flat[246];
assign width_union_wrapper_in_flat[9] = in_flat[247];
assign width_union_wrapper_in_flat[10] = in_flat[248];
assign width_union_wrapper_in_flat[11] = in_flat[249];
...
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[259];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[260];

// Internal MTM connections (module-to-module)
assign bitwise_logic_wrapper_in_flat[4] = const_arith_wrapper_out_flat[0];
assign array_wrapper_in_flat[16] = const_arith_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[5] = const_arith_wrapper_out_flat[21];
assign shift_wrapper_in_flat[6] = const_arith_wrapper_out_flat[27];
assign select_wrapper_in_flat[8] = const_arith_wrapper_out_flat[33];
assign const_conditional_wrapper_in_flat[28] = const_compare_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[13];
assign array_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[18];
assign bitwise_logic_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[20];
assign partselect_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[23];
assign const_partselect_wrapper_in_flat[19] = const_logic_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[8] = const_logic_wrapper_out_flat[4];
assign cast_wrapper_in_flat[10] = const_logic_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[2] = const_logic_wrapper_out_flat[8];
assign relational_wrapper_in_flat[7] = const_logic_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[6] = const_nested_wrapper_out_flat[6];
assign cast_wrapper_in_flat[7] = const_nested_wrapper_out_flat[6];
assign logical_op_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[23] = const_partselect_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[26] = const_reduce_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[14] = const_reduce_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[1] = const_shift_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[8] = const_shift_wrapper_out_flat[6];
assign logical_op_wrapper_in_flat[1] = const_shift_wrapper_out_flat[7];
assign cast_wrapper_in_flat[5] = const_shift_wrapper_out_flat[22];
assign width_enum_wrapper_in_flat[1] = const_shift_wrapper_out_flat[22];
assign width_logic_wrapper_in_flat[0] = const_shift_wrapper_out_flat[23];
assign cast_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[10] = arithmetic_reduce_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[4];
assign relational_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[9];
assign array_wrapper_in_flat[13] = bitwise_logic_wrapper_out_flat[9];
assign numbers_concat_repl_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[12];
assign relational_wrapper_in_flat[4] = bitwise_reduce_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[15] = logical_op_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[3] = relational_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[3] = relational_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[27] = relational_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[4] = relational_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[0] = select_wrapper_out_flat[2];
assign relational_wrapper_in_flat[6] = select_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[6] = select_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[3] = select_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[25] = shift_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[9] = shift_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[2] = shift_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[8] = shift_wrapper_out_flat[9];
assign select_wrapper_in_flat[9] = shift_wrapper_out_flat[11];
assign const_shift_wrapper_in_flat[4] = array_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[5] = array_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[7] = array_wrapper_out_flat[15];
assign const_conditional_wrapper_in_flat[5] = cast_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[14] = cast_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[4] = cast_wrapper_out_flat[9];
assign partselect_wrapper_in_flat[11] = conditional_wrapper_out_flat[0];
assign cast_wrapper_in_flat[0] = width_enum_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[4] = width_struct_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[0] = width_struct_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[11] = width_struct_wrapper_out_flat[8];
assign cast_wrapper_in_flat[2] = width_struct_wrapper_out_flat[8];
assign select_wrapper_in_flat[15] = width_struct_wrapper_out_flat[9];
assign array_wrapper_in_flat[6] = width_struct_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[6] = width_struct_wrapper_out_flat[11];
assign array_wrapper_in_flat[10] = width_union_wrapper_out_flat[2];
assign select_wrapper_in_flat[2] = width_union_wrapper_out_flat[9];
assign numbers_concat_repl_wrapper_in_flat[0] = width_union_wrapper_out_flat[11];
assign bitwise_logic_wrapper_in_flat[11] = width_union_wrapper_out_flat[12];
assign relational_wrapper_in_flat[5] = width_union_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[0] = width_logic_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[12] = width_logic_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[12] = width_logic_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[0];
assign shift_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[10];
assign select_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[15];
assign const_shift_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[16];
