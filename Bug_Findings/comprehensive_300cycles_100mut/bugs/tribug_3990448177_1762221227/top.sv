...
assign shift_wrapper_in_flat[4] = const_arith_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[14] = const_arith_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[2] = const_arith_wrapper_out_flat[16];
assign const_concat_repl_wrapper_in_flat[6] = const_arith_wrapper_out_flat[28];
assign relational_wrapper_in_flat[0] = const_arith_wrapper_out_flat[29];
assign bitwise_logic_wrapper_in_flat[13] = const_arith_wrapper_out_flat[36];
assign select_wrapper_in_flat[19] = const_compare_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[5] = const_compare_wrapper_out_flat[2];
assign cast_wrapper_in_flat[0] = const_compare_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[6] = const_compare_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[4] = const_compare_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[12];
assign const_shift_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[14];
assign width_union_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[14];
assign width_logic_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[10];
assign const_logic_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[13];
assign array_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[15];
assign shift_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[20];
assign bitwise_logic_wrapper_in_flat[8] = const_logic_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[9] = const_logic_wrapper_out_flat[8];
assign array_wrapper_in_flat[0] = const_logic_wrapper_out_flat[11];
assign relational_wrapper_in_flat[3] = const_logic_wrapper_out_flat[15];
...
assign const_partselect_wrapper_in_flat[18] = const_reduce_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[6] = const_shift_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[8] = const_shift_wrapper_out_flat[21];
assign width_logic_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[11] = arithmetic_reduce_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[5];
assign shift_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[9];
...
assign const_nested_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[12];
assign array_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[13];
assign bitwise_reduce_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[19];
assign const_shift_wrapper_in_flat[5] = bitwise_reduce_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[3] = logical_op_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[5] = logical_op_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[2] = logical_op_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[1] = relational_wrapper_out_flat[0];
assign select_wrapper_in_flat[1] = relational_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[1] = relational_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[7] = select_wrapper_out_flat[1];
assign array_wrapper_in_flat[10] = select_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[3] = select_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[14] = shift_wrapper_out_flat[0];
assign relational_wrapper_in_flat[4] = shift_wrapper_out_flat[3];
assign array_wrapper_in_flat[8] = shift_wrapper_out_flat[10];
assign select_wrapper_in_flat[11] = shift_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[5] = array_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[2] = array_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[3] = array_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[4] = cast_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[7] = cast_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[0] = cast_wrapper_out_flat[9];
assign width_enum_wrapper_in_flat[2] = cast_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[23] = conditional_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[1] = conditional_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[0] = conditional_wrapper_out_flat[1];
assign shift_wrapper_in_flat[1] = partselect_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[9] = width_enum_wrapper_out_flat[3];
assign select_wrapper_in_flat[8] = width_enum_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[1] = width_struct_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[7] = width_struct_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[2] = width_struct_wrapper_out_flat[6];
assign cast_wrapper_in_flat[4] = width_struct_wrapper_out_flat[7];
assign shift_wrapper_in_flat[3] = width_struct_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[25] = width_union_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[10] = width_union_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[1] = width_union_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[8] = width_union_wrapper_out_flat[9];
assign partselect_wrapper_in_flat[15] = width_logic_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[6] = width_logic_wrapper_out_flat[2];
assign select_wrapper_in_flat[4] = width_logic_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[4] = width_logic_wrapper_out_flat[5];
