...
assign width_union_wrapper_in_flat[1] = const_arith_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[7] = const_arith_wrapper_out_flat[13];
assign partselect_wrapper_in_flat[5] = const_arith_wrapper_out_flat[14];
assign bitwise_reduce_wrapper_in_flat[6] = const_arith_wrapper_out_flat[17];
assign numbers_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[17];
assign cast_wrapper_in_flat[9] = const_arith_wrapper_out_flat[22];
assign array_wrapper_in_flat[17] = const_arith_wrapper_out_flat[23];
assign select_wrapper_in_flat[8] = const_arith_wrapper_out_flat[29];
assign const_nested_wrapper_in_flat[25] = const_arith_wrapper_out_flat[31];
assign width_enum_wrapper_in_flat[0] = const_arith_wrapper_out_flat[39];
assign width_logic_wrapper_in_flat[0] = const_compare_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[20] = const_compare_wrapper_out_flat[7];
assign shift_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[8];
assign const_concat_repl_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[19];
assign const_nested_wrapper_in_flat[15] = const_logic_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[6] = const_logic_wrapper_out_flat[2];
assign array_wrapper_in_flat[6] = const_logic_wrapper_out_flat[3];
assign relational_wrapper_in_flat[3] = const_logic_wrapper_out_flat[5];
assign select_wrapper_in_flat[13] = const_logic_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[2] = const_logic_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[5] = const_logic_wrapper_out_flat[13];
assign numbers_concat_repl_wrapper_in_flat[3] = const_logic_wrapper_out_flat[14];
assign conditional_wrapper_in_flat[3] = const_nested_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[18] = const_partselect_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[26] = const_shift_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[22] = const_shift_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[5] = const_shift_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[2] = const_shift_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[5] = const_shift_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[5] = const_shift_wrapper_out_flat[17];
assign width_logic_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[30] = bitwise_logic_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[11];
assign select_wrapper_in_flat[16] = bitwise_logic_wrapper_out_flat[12];
assign array_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[12];
assign const_logic_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[14];
assign const_shift_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[16];
assign relational_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[17];
assign const_nested_wrapper_in_flat[24] = bitwise_logic_wrapper_out_flat[18];
assign partselect_wrapper_in_flat[18] = bitwise_logic_wrapper_out_flat[23];
assign cast_wrapper_in_flat[3] = relational_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[2] = select_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[8] = select_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[3] = select_wrapper_out_flat[7];
assign cast_wrapper_in_flat[1] = select_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[3] = shift_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[17] = array_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[2] = array_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[2] = array_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[10] = array_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[0] = array_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[2] = array_wrapper_out_flat[9];
assign cast_wrapper_in_flat[4] = array_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[7] = cast_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[0] = cast_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[15] = cast_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[4] = conditional_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[0] = conditional_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[1] = partselect_wrapper_out_flat[4];
assign shift_wrapper_in_flat[2] = partselect_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[5] = width_enum_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = width_enum_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[1] = width_struct_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[18] = width_struct_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[10] = width_struct_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[3] = width_struct_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[0] = width_struct_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[0] = width_union_wrapper_out_flat[1];
assign cast_wrapper_in_flat[8] = width_union_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[8] = width_union_wrapper_out_flat[12];
assign bitwise_reduce_wrapper_in_flat[7] = width_union_wrapper_out_flat[13];
assign const_reduce_wrapper_in_flat[1] = width_logic_wrapper_out_flat[3];
assign cast_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[2];
assign relational_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[10];
assign width_union_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[13];
