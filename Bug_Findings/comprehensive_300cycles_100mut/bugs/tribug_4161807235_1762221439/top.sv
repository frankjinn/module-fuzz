...
assign bitwise_logic_wrapper_in_flat[9] = const_arith_wrapper_out_flat[12];
assign conditional_wrapper_in_flat[4] = const_arith_wrapper_out_flat[15];
assign const_compare_wrapper_in_flat[9] = const_arith_wrapper_out_flat[18];
assign shift_wrapper_in_flat[10] = const_arith_wrapper_out_flat[20];
assign conditional_wrapper_in_flat[6] = const_compare_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[5] = const_compare_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[0] = const_compare_wrapper_out_flat[5];
assign array_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[9];
assign width_union_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[17] = const_concat_repl_wrapper_out_flat[14];
assign bitwise_reduce_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[12];
assign partselect_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[19];
assign logical_op_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[21];
assign logical_op_wrapper_in_flat[0] = const_logic_wrapper_out_flat[1];
assign relational_wrapper_in_flat[1] = const_logic_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[10] = const_logic_wrapper_out_flat[10];
assign select_wrapper_in_flat[8] = const_nested_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[20] = const_nested_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[11] = const_partselect_wrapper_out_flat[2];
assign select_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[15] = const_reduce_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[7] = const_reduce_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[4];
assign cast_wrapper_in_flat[8] = const_shift_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[13] = const_shift_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[5] = const_shift_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[2] = const_shift_wrapper_out_flat[13];
...
assign shift_wrapper_in_flat[4] = const_shift_wrapper_out_flat[19];
assign width_enum_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[1];
assign shift_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[10];
assign const_reduce_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[13] = bitwise_logic_wrapper_out_flat[14];
assign bitwise_reduce_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[17];
assign cast_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[23];
assign arithmetic_reduce_wrapper_in_flat[14] = bitwise_reduce_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[4] = logical_op_wrapper_out_flat[0];
assign relational_wrapper_in_flat[0] = logical_op_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[18] = logical_op_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[5] = relational_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[13] = relational_wrapper_out_flat[6];
assign relational_wrapper_in_flat[4] = select_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[23] = select_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[10] = shift_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[15] = shift_wrapper_out_flat[5];
assign select_wrapper_in_flat[4] = shift_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[1] = shift_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[7] = shift_wrapper_out_flat[12];
assign conditional_wrapper_in_flat[3] = shift_wrapper_out_flat[12];
assign width_struct_wrapper_in_flat[3] = shift_wrapper_out_flat[15];
assign relational_wrapper_in_flat[5] = array_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[1] = array_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[19] = cast_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[7] = cast_wrapper_out_flat[4];
assign cast_wrapper_in_flat[6] = conditional_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[3] = partselect_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[3] = partselect_wrapper_out_flat[4];
assign relational_wrapper_in_flat[2] = partselect_wrapper_out_flat[6];
...
assign const_partselect_wrapper_in_flat[7] = width_struct_wrapper_out_flat[10];
assign select_wrapper_in_flat[11] = width_union_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[12] = width_union_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[15] = width_union_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[5] = width_logic_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[6] = width_logic_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[2];
assign shift_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[11];
assign cast_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[12];
