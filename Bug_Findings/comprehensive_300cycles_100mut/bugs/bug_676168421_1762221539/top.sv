...
assign const_nested_wrapper_in_flat[0] = in_flat[82];
...
assign arithmetic_reduce_wrapper_in_flat[9] = in_flat[137];
...
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[159];
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[160];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[161];
assign logical_op_wrapper_in_flat[0] = in_flat[162];
assign relational_wrapper_in_flat[0] = in_flat[163];
...
assign select_wrapper_in_flat[11] = in_flat[174];
assign select_wrapper_in_flat[12] = in_flat[175];
...
assign numbers_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[1] = const_arith_wrapper_out_flat[10];
assign shift_wrapper_in_flat[8] = const_arith_wrapper_out_flat[13];
assign partselect_wrapper_in_flat[1] = const_arith_wrapper_out_flat[15];
assign array_wrapper_in_flat[11] = const_arith_wrapper_out_flat[28];
assign const_compare_wrapper_in_flat[11] = const_arith_wrapper_out_flat[31];
assign const_concat_repl_wrapper_in_flat[9] = const_arith_wrapper_out_flat[38];
assign const_logic_wrapper_in_flat[8] = const_compare_wrapper_out_flat[0];
assign cast_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[2];
assign select_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[21];
assign bitwise_logic_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[4];
assign array_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[9];
assign cast_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[14];
assign shift_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[14];
assign width_struct_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[16];
assign select_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[20];
assign relational_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[20];
assign const_shift_wrapper_in_flat[6] = const_logic_wrapper_out_flat[7];
assign logical_op_wrapper_in_flat[1] = const_logic_wrapper_out_flat[8];
assign select_wrapper_in_flat[6] = const_logic_wrapper_out_flat[12];
assign numbers_concat_repl_wrapper_in_flat[0] = const_logic_wrapper_out_flat[16];
assign const_concat_repl_wrapper_in_flat[1] = const_logic_wrapper_out_flat[18];
assign width_logic_wrapper_in_flat[5] = const_nested_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[17] = const_shift_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[0] = const_shift_wrapper_out_flat[17];
assign cast_wrapper_in_flat[4] = const_shift_wrapper_out_flat[18];
assign const_partselect_wrapper_in_flat[13] = arithmetic_reduce_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[3];
assign cast_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[10];
assign relational_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[11];
assign partselect_wrapper_in_flat[17] = bitwise_logic_wrapper_out_flat[13];
assign array_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[16];
assign shift_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[17];
assign width_union_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[18];
assign bitwise_reduce_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[19];
assign const_compare_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[20];
assign select_wrapper_in_flat[5] = bitwise_reduce_wrapper_out_flat[0];
assign relational_wrapper_in_flat[5] = bitwise_reduce_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[4] = bitwise_reduce_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[3] = logical_op_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[2] = relational_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[4] = relational_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[0] = select_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[5] = select_wrapper_out_flat[7];
assign relational_wrapper_in_flat[3] = select_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[1] = shift_wrapper_out_flat[4];
assign array_wrapper_in_flat[15] = shift_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[10] = shift_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[6] = shift_wrapper_out_flat[15];
assign const_partselect_wrapper_in_flat[2] = array_wrapper_out_flat[7];
assign relational_wrapper_in_flat[7] = array_wrapper_out_flat[9];
assign width_union_wrapper_in_flat[15] = array_wrapper_out_flat[13];
assign width_struct_wrapper_in_flat[3] = array_wrapper_out_flat[15];
assign conditional_wrapper_in_flat[4] = cast_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[4] = partselect_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[3] = partselect_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[2] = partselect_wrapper_out_flat[1];
assign array_wrapper_in_flat[17] = partselect_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[13] = partselect_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[4] = width_enum_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[3] = width_enum_wrapper_out_flat[0];
assign select_wrapper_in_flat[19] = width_enum_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[1] = width_struct_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[13] = width_struct_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[3] = width_struct_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[11] = width_struct_wrapper_out_flat[9];
assign bitwise_reduce_wrapper_in_flat[3] = width_union_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[1] = width_union_wrapper_out_flat[12];
assign width_enum_wrapper_in_flat[2] = width_union_wrapper_out_flat[12];
assign conditional_wrapper_in_flat[6] = width_logic_wrapper_out_flat[3];
assign cast_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[14];
