...
assign select_wrapper_in_flat[6] = in_flat[162];
...
assign width_logic_wrapper_in_flat[4] = in_flat[260];
assign width_logic_wrapper_in_flat[5] = in_flat[261];
assign width_logic_wrapper_in_flat[6] = in_flat[262];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[263];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[264];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[265];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[266];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[267];

// Internal MTM connections (module-to-module)
assign bitwise_logic_wrapper_in_flat[4] = const_arith_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[0] = const_arith_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[14] = const_arith_wrapper_out_flat[11];
assign width_enum_wrapper_in_flat[0] = const_arith_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[23] = const_arith_wrapper_out_flat[14];
assign width_struct_wrapper_in_flat[4] = const_arith_wrapper_out_flat[17];
assign relational_wrapper_in_flat[3] = const_arith_wrapper_out_flat[19];
assign logical_op_wrapper_in_flat[0] = const_arith_wrapper_out_flat[38];
assign bitwise_logic_wrapper_in_flat[15] = const_compare_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[19] = const_compare_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[10] = const_compare_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[2] = const_compare_wrapper_out_flat[6];
assign select_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[14] = const_concat_repl_wrapper_out_flat[14];
assign const_reduce_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[21];
assign width_enum_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[6];
assign relational_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[15];
assign width_enum_wrapper_in_flat[3] = const_nested_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[15] = const_nested_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[16] = const_partselect_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[15] = const_reduce_wrapper_out_flat[3];
assign select_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[2] = const_shift_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[7] = const_shift_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[5] = const_shift_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[26] = const_shift_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[17] = const_shift_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[16];
assign const_conditional_wrapper_in_flat[18] = bitwise_logic_wrapper_out_flat[16];
assign width_struct_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[17];
assign width_logic_wrapper_in_flat[7] = relational_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[4] = relational_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[3] = select_wrapper_out_flat[3];
assign select_wrapper_in_flat[5] = shift_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[15] = shift_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[11] = shift_wrapper_out_flat[5];
assign cast_wrapper_in_flat[11] = shift_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[6] = shift_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[18] = shift_wrapper_out_flat[13];
assign const_concat_repl_wrapper_in_flat[3] = array_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[11] = array_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[1] = cast_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[8] = cast_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[3] = cast_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[31] = cast_wrapper_out_flat[6];
assign relational_wrapper_in_flat[5] = conditional_wrapper_out_flat[1];
assign select_wrapper_in_flat[16] = conditional_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[5] = conditional_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[2] = conditional_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[2] = partselect_wrapper_out_flat[0];
assign array_wrapper_in_flat[11] = partselect_wrapper_out_flat[2];
...
assign arithmetic_reduce_wrapper_in_flat[12] = width_enum_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[7] = width_struct_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[9] = width_struct_wrapper_out_flat[3];
assign relational_wrapper_in_flat[7] = width_struct_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[9] = width_struct_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[9] = width_union_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[1] = width_union_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[3] = width_union_wrapper_out_flat[7];
assign shift_wrapper_in_flat[6] = width_union_wrapper_out_flat[12];
assign bitwise_reduce_wrapper_in_flat[1] = width_logic_wrapper_out_flat[0];
...
assign cast_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[3];
assign array_wrapper_in_flat[16] = numbers_concat_repl_wrapper_out_flat[6];
assign shift_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[11];
