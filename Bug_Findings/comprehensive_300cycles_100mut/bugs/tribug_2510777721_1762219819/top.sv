...
assign const_nested_wrapper_in_flat[11] = in_flat[94];
...
assign const_reduce_wrapper_in_flat[1] = in_flat[125];
assign const_reduce_wrapper_in_flat[3] = in_flat[126];
assign const_shift_wrapper_in_flat[4] = in_flat[127];
...
assign arithmetic_reduce_wrapper_in_flat[14] = in_flat[143];
assign arithmetic_reduce_wrapper_in_flat[15] = in_flat[144];
assign bitwise_logic_wrapper_in_flat[0] = in_flat[145];
assign bitwise_logic_wrapper_in_flat[1] = in_flat[146];
...
assign cast_wrapper_in_flat[0] = in_flat[205];
assign cast_wrapper_in_flat[2] = in_flat[206];
assign cast_wrapper_in_flat[3] = in_flat[207];
assign cast_wrapper_in_flat[4] = in_flat[208];
assign cast_wrapper_in_flat[5] = in_flat[209];
...
assign partselect_wrapper_in_flat[9] = in_flat[226];
...
assign width_struct_wrapper_in_flat[5] = in_flat[238];
...
assign const_shift_wrapper_in_flat[0] = const_arith_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[9] = const_arith_wrapper_out_flat[2];
assign cast_wrapper_in_flat[9] = const_arith_wrapper_out_flat[3];
assign array_wrapper_in_flat[9] = const_arith_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[17] = const_arith_wrapper_out_flat[12];
assign shift_wrapper_in_flat[8] = const_arith_wrapper_out_flat[18];
assign width_union_wrapper_in_flat[14] = const_arith_wrapper_out_flat[21];
assign arithmetic_reduce_wrapper_in_flat[3] = const_arith_wrapper_out_flat[24];
assign partselect_wrapper_in_flat[16] = const_arith_wrapper_out_flat[25];
assign select_wrapper_in_flat[13] = const_arith_wrapper_out_flat[31];
assign const_partselect_wrapper_in_flat[2] = const_arith_wrapper_out_flat[33];
assign const_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[39];
assign const_partselect_wrapper_in_flat[8] = const_compare_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[18] = const_compare_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[2] = const_compare_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[1] = const_compare_wrapper_out_flat[6];
assign cast_wrapper_in_flat[1] = const_compare_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[10];
assign logical_op_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[19];
assign cast_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[6];
assign select_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[7] = const_logic_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[3] = const_logic_wrapper_out_flat[2];
assign shift_wrapper_in_flat[6] = const_logic_wrapper_out_flat[12];
assign const_concat_repl_wrapper_in_flat[1] = const_logic_wrapper_out_flat[13];
assign logical_op_wrapper_in_flat[0] = const_nested_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[6];
assign cast_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[0];
assign select_wrapper_in_flat[18] = const_reduce_wrapper_out_flat[3];
assign array_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[1] = const_shift_wrapper_out_flat[12];
assign const_logic_wrapper_in_flat[5] = const_shift_wrapper_out_flat[18];
assign relational_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[19] = bitwise_logic_wrapper_out_flat[13];
assign bitwise_logic_wrapper_in_flat[12] = relational_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[7] = relational_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[3] = select_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[2] = select_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[3] = shift_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[4] = shift_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[3] = shift_wrapper_out_flat[10];
assign const_shift_wrapper_in_flat[3] = array_wrapper_out_flat[13];
assign cast_wrapper_in_flat[10] = array_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[15] = array_wrapper_out_flat[15];
assign const_compare_wrapper_in_flat[3] = array_wrapper_out_flat[15];
assign partselect_wrapper_in_flat[3] = cast_wrapper_out_flat[0];
assign relational_wrapper_in_flat[1] = cast_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[0] = cast_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[0] = cast_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[0] = cast_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[1] = conditional_wrapper_out_flat[3];
assign relational_wrapper_in_flat[2] = conditional_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[6] = partselect_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[2] = partselect_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[12] = partselect_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[9] = partselect_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[8] = partselect_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[3] = width_enum_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[1] = width_enum_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[8] = width_enum_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[2] = width_struct_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[9] = width_union_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[4] = width_union_wrapper_out_flat[11];
assign numbers_concat_repl_wrapper_in_flat[4] = width_union_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[16] = width_logic_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[4] = width_logic_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[0];
...
assign width_struct_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[17];
