...
assign const_concat_repl_wrapper_in_flat[7] = in_flat[43];
assign const_concat_repl_wrapper_in_flat[8] = in_flat[44];
assign const_concat_repl_wrapper_in_flat[9] = in_flat[45];
assign const_conditional_wrapper_in_flat[0] = in_flat[46];
assign const_conditional_wrapper_in_flat[1] = in_flat[47];
assign const_conditional_wrapper_in_flat[2] = in_flat[48];
assign const_conditional_wrapper_in_flat[3] = in_flat[49];
assign const_conditional_wrapper_in_flat[4] = in_flat[50];
assign const_conditional_wrapper_in_flat[5] = in_flat[51];
assign const_conditional_wrapper_in_flat[6] = in_flat[52];
assign const_conditional_wrapper_in_flat[7] = in_flat[53];
assign const_conditional_wrapper_in_flat[8] = in_flat[54];
...
assign width_logic_wrapper_in_flat[0] = in_flat[256];
...
assign select_wrapper_in_flat[13] = const_arith_wrapper_out_flat[3];
assign array_wrapper_in_flat[0] = const_arith_wrapper_out_flat[17];
assign width_struct_wrapper_in_flat[6] = const_arith_wrapper_out_flat[30];
assign const_concat_repl_wrapper_in_flat[4] = const_arith_wrapper_out_flat[37];
assign const_arith_wrapper_in_flat[10] = const_compare_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[3] = const_compare_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[14] = const_compare_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[2] = const_compare_wrapper_out_flat[6];
assign array_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[8];
assign const_logic_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[12];
assign logical_op_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[12];
assign conditional_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[16];
assign partselect_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[19];
assign const_logic_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[19];
assign cast_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[23];
assign width_enum_wrapper_in_flat[1] = const_logic_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[7] = const_logic_wrapper_out_flat[3];
assign shift_wrapper_in_flat[10] = const_logic_wrapper_out_flat[3];
assign select_wrapper_in_flat[6] = const_logic_wrapper_out_flat[11];
...
assign conditional_wrapper_in_flat[6] = const_logic_wrapper_out_flat[18];
assign const_logic_wrapper_in_flat[5] = const_nested_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[4] = const_nested_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[1] = const_nested_wrapper_out_flat[5];
assign cast_wrapper_in_flat[6] = const_nested_wrapper_out_flat[5];
assign array_wrapper_in_flat[15] = const_partselect_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[4];
assign select_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[20] = const_reduce_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[31] = const_shift_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[7] = const_shift_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[24] = const_shift_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[13] = const_shift_wrapper_out_flat[16];
assign width_struct_wrapper_in_flat[9] = const_shift_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[4] = const_shift_wrapper_out_flat[19];
assign logical_op_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[17] = bitwise_logic_wrapper_out_flat[5];
assign select_wrapper_in_flat[11] = logical_op_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[6] = logical_op_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[18] = logical_op_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[3] = relational_wrapper_out_flat[3];
assign cast_wrapper_in_flat[1] = select_wrapper_out_flat[4];
assign relational_wrapper_in_flat[4] = select_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[8] = select_wrapper_out_flat[6];
assign bitwise_logic_wrapper_in_flat[13] = select_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[2] = shift_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[1] = shift_wrapper_out_flat[15];
assign cast_wrapper_in_flat[11] = array_wrapper_out_flat[0];
assign relational_wrapper_in_flat[3] = array_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[15] = array_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[5] = array_wrapper_out_flat[14];
assign const_reduce_wrapper_in_flat[2] = array_wrapper_out_flat[14];
assign bitwise_logic_wrapper_in_flat[4] = cast_wrapper_out_flat[6];
assign bitwise_logic_wrapper_in_flat[12] = conditional_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[0] = partselect_wrapper_out_flat[1];
assign shift_wrapper_in_flat[4] = partselect_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[0] = partselect_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[4] = width_enum_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[0] = width_struct_wrapper_out_flat[2];
...
assign const_conditional_wrapper_in_flat[22] = width_struct_wrapper_out_flat[7];
assign array_wrapper_in_flat[3] = width_union_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[19] = width_union_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[6] = width_union_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[7] = width_union_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[9] = width_union_wrapper_out_flat[13];
assign width_enum_wrapper_in_flat[2] = width_logic_wrapper_out_flat[1];
assign shift_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[4];
