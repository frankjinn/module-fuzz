...
assign relational_wrapper_in_flat[1] = const_arith_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[18] = const_arith_wrapper_out_flat[7];
assign array_wrapper_in_flat[12] = const_arith_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[4] = const_arith_wrapper_out_flat[18];
assign const_concat_repl_wrapper_in_flat[9] = const_arith_wrapper_out_flat[19];
assign const_compare_wrapper_in_flat[14] = const_arith_wrapper_out_flat[24];
assign const_shift_wrapper_in_flat[8] = const_arith_wrapper_out_flat[27];
assign const_shift_wrapper_in_flat[3] = const_compare_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[2] = const_compare_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[11];
assign arithmetic_reduce_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[12];
assign relational_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[12];
assign width_enum_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[18] = const_conditional_wrapper_out_flat[7];
...
assign arithmetic_reduce_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[21];
assign const_logic_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[22];
assign logical_op_wrapper_in_flat[1] = const_logic_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[0] = const_logic_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[6] = const_logic_wrapper_out_flat[17];
assign cast_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[3];
assign select_wrapper_in_flat[8] = const_shift_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[6] = const_shift_wrapper_out_flat[16];
assign width_logic_wrapper_in_flat[6] = const_shift_wrapper_out_flat[19];
assign cast_wrapper_in_flat[10] = const_shift_wrapper_out_flat[21];
...
assign const_logic_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[3];
assign shift_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[15] = bitwise_logic_wrapper_out_flat[9];
assign numbers_concat_repl_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[10];
...
assign shift_wrapper_in_flat[8] = bitwise_reduce_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[2] = bitwise_reduce_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[9] = logical_op_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[13] = relational_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[3] = relational_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[7] = select_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[5] = select_wrapper_out_flat[1];
assign shift_wrapper_in_flat[9] = select_wrapper_out_flat[2];
...
assign const_logic_wrapper_in_flat[3] = shift_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[11] = shift_wrapper_out_flat[14];
assign arithmetic_reduce_wrapper_in_flat[0] = shift_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[5] = array_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[9] = array_wrapper_out_flat[10];
assign relational_wrapper_in_flat[5] = array_wrapper_out_flat[12];
assign const_concat_repl_wrapper_in_flat[1] = array_wrapper_out_flat[15];
assign bitwise_logic_wrapper_in_flat[12] = cast_wrapper_out_flat[0];
assign select_wrapper_in_flat[14] = cast_wrapper_out_flat[9];
assign bitwise_reduce_wrapper_in_flat[0] = cast_wrapper_out_flat[11];
assign logical_op_wrapper_in_flat[0] = conditional_wrapper_out_flat[2];
assign shift_wrapper_in_flat[6] = conditional_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[8] = partselect_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[11] = partselect_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[8] = width_enum_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[5] = width_struct_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[0] = width_union_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[14] = width_union_wrapper_out_flat[3];
assign array_wrapper_in_flat[7] = width_union_wrapper_out_flat[15];
assign bitwise_reduce_wrapper_in_flat[2] = width_logic_wrapper_out_flat[4];
assign select_wrapper_in_flat[12] = width_logic_wrapper_out_flat[5];
assign cast_wrapper_in_flat[8] = width_logic_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[17] = numbers_concat_repl_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[14];
assign arithmetic_reduce_wrapper_in_flat[14] = numbers_concat_repl_wrapper_out_flat[15];
assign bitwise_reduce_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[15];
