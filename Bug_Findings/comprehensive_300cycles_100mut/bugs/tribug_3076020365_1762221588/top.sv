...
assign const_conditional_wrapper_in_flat[13] = in_flat[57];
assign const_conditional_wrapper_in_flat[14] = in_flat[58];
assign const_conditional_wrapper_in_flat[15] = in_flat[59];
assign const_conditional_wrapper_in_flat[16] = in_flat[60];
assign const_conditional_wrapper_in_flat[17] = in_flat[61];
assign const_conditional_wrapper_in_flat[18] = in_flat[62];
assign const_conditional_wrapper_in_flat[19] = in_flat[63];
assign const_conditional_wrapper_in_flat[20] = in_flat[64];
...
assign const_reduce_wrapper_in_flat[3] = in_flat[120];
...
assign relational_wrapper_in_flat[3] = in_flat[161];
...
assign array_wrapper_in_flat[1] = in_flat[188];
assign array_wrapper_in_flat[2] = in_flat[189];
...
assign conditional_wrapper_in_flat[6] = in_flat[216];
...
assign const_conditional_wrapper_in_flat[27] = const_arith_wrapper_out_flat[9];
assign shift_wrapper_in_flat[2] = const_arith_wrapper_out_flat[14];
assign bitwise_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[14];
assign partselect_wrapper_in_flat[5] = const_arith_wrapper_out_flat[15];
assign const_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[22];
assign const_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[27];
assign relational_wrapper_in_flat[5] = const_arith_wrapper_out_flat[29];
assign const_nested_wrapper_in_flat[12] = const_arith_wrapper_out_flat[37];
assign const_reduce_wrapper_in_flat[1] = const_compare_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[0] = const_compare_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[11] = const_compare_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[5] = const_compare_wrapper_out_flat[5];
assign select_wrapper_in_flat[6] = const_compare_wrapper_out_flat[6];
assign shift_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[15];
assign conditional_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[16];
assign const_shift_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[21];
...
assign bitwise_reduce_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[13];
assign width_logic_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[19];
assign const_logic_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[22];
assign const_nested_wrapper_in_flat[26] = const_logic_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[2] = const_logic_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[4] = const_logic_wrapper_out_flat[4];
assign shift_wrapper_in_flat[1] = const_logic_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[6] = const_logic_wrapper_out_flat[8];
assign width_enum_wrapper_in_flat[2] = const_logic_wrapper_out_flat[15];
assign width_struct_wrapper_in_flat[10] = const_logic_wrapper_out_flat[18];
assign width_union_wrapper_in_flat[3] = const_nested_wrapper_out_flat[0];
assign select_wrapper_in_flat[0] = const_nested_wrapper_out_flat[6];
assign logical_op_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[3] = const_shift_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[9] = const_shift_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[2] = const_shift_wrapper_out_flat[19];
assign select_wrapper_in_flat[9] = const_shift_wrapper_out_flat[22];
assign const_compare_wrapper_in_flat[7] = const_shift_wrapper_out_flat[23];
assign conditional_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[21] = bitwise_logic_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[22];
assign const_compare_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[5] = bitwise_reduce_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[0] = logical_op_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[0] = relational_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[8] = relational_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[5] = relational_wrapper_out_flat[7];
assign cast_wrapper_in_flat[9] = select_wrapper_out_flat[2];
assign array_wrapper_in_flat[7] = select_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[7] = shift_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[5] = shift_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[16] = shift_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[8] = shift_wrapper_out_flat[11];
assign logical_op_wrapper_in_flat[0] = array_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[8] = array_wrapper_out_flat[8];
assign cast_wrapper_in_flat[6] = array_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[13] = cast_wrapper_out_flat[0];
assign relational_wrapper_in_flat[1] = conditional_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[0] = conditional_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[2] = conditional_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[7] = conditional_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[0] = conditional_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[6] = partselect_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[1] = partselect_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[4] = partselect_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[4] = partselect_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[5] = width_enum_wrapper_out_flat[0];
assign relational_wrapper_in_flat[2] = width_enum_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[2] = width_struct_wrapper_out_flat[0];
assign cast_wrapper_in_flat[1] = width_union_wrapper_out_flat[12];
assign select_wrapper_in_flat[5] = width_union_wrapper_out_flat[14];
assign array_wrapper_in_flat[10] = width_union_wrapper_out_flat[15];
assign select_wrapper_in_flat[13] = width_logic_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[4] = width_logic_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[23] = width_logic_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[11];
