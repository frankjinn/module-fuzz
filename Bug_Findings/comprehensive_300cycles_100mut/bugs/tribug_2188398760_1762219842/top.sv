...
assign const_nested_wrapper_in_flat[19] = in_flat[98];
assign const_nested_wrapper_in_flat[20] = in_flat[99];
assign const_nested_wrapper_in_flat[21] = in_flat[100];
assign const_nested_wrapper_in_flat[22] = in_flat[101];
assign const_nested_wrapper_in_flat[23] = in_flat[102];
assign const_nested_wrapper_in_flat[24] = in_flat[103];
assign const_nested_wrapper_in_flat[25] = in_flat[104];
...
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[157];
...
assign relational_wrapper_in_flat[1] = in_flat[161];
assign relational_wrapper_in_flat[2] = in_flat[162];
assign relational_wrapper_in_flat[3] = in_flat[163];
...
assign select_wrapper_in_flat[15] = in_flat[178];
assign select_wrapper_in_flat[16] = in_flat[179];
assign select_wrapper_in_flat[18] = in_flat[180];
assign select_wrapper_in_flat[19] = in_flat[181];
...
assign array_wrapper_in_flat[4] = in_flat[192];
assign array_wrapper_in_flat[5] = in_flat[193];
...
assign array_wrapper_in_flat[11] = in_flat[198];
...
assign cast_wrapper_in_flat[1] = in_flat[204];
assign cast_wrapper_in_flat[2] = in_flat[205];
assign cast_wrapper_in_flat[4] = in_flat[206];
assign cast_wrapper_in_flat[5] = in_flat[207];
assign cast_wrapper_in_flat[6] = in_flat[208];
assign cast_wrapper_in_flat[7] = in_flat[209];
assign cast_wrapper_in_flat[8] = in_flat[210];
assign cast_wrapper_in_flat[10] = in_flat[211];
assign cast_wrapper_in_flat[11] = in_flat[212];
assign conditional_wrapper_in_flat[1] = in_flat[213];
assign conditional_wrapper_in_flat[4] = in_flat[214];
assign conditional_wrapper_in_flat[5] = in_flat[215];
assign conditional_wrapper_in_flat[8] = in_flat[216];
assign partselect_wrapper_in_flat[0] = in_flat[217];
assign partselect_wrapper_in_flat[1] = in_flat[218];
...
assign partselect_wrapper_in_flat[9] = in_flat[224];
...
assign select_wrapper_in_flat[9] = const_arith_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[7] = const_arith_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[6] = const_arith_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[16] = const_arith_wrapper_out_flat[15];
assign width_logic_wrapper_in_flat[1] = const_arith_wrapper_out_flat[18];
assign const_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[25];
assign partselect_wrapper_in_flat[3] = const_arith_wrapper_out_flat[26];
assign shift_wrapper_in_flat[3] = const_arith_wrapper_out_flat[31];
assign width_union_wrapper_in_flat[0] = const_arith_wrapper_out_flat[31];
assign numbers_concat_repl_wrapper_in_flat[5] = const_arith_wrapper_out_flat[31];
assign relational_wrapper_in_flat[5] = const_compare_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[5];
assign const_arith_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[9];
assign partselect_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[10];
assign width_union_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[12];
assign array_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[14];
assign const_conditional_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[14];
assign select_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[16];
assign width_logic_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[16];
assign const_arith_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[0];
assign array_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[12];
assign width_union_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[17];
assign width_logic_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[18];
assign select_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[18];
assign const_conditional_wrapper_in_flat[24] = const_logic_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[3] = const_logic_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[3] = const_logic_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[1] = const_logic_wrapper_out_flat[10];
assign array_wrapper_in_flat[3] = const_logic_wrapper_out_flat[16];
assign arithmetic_reduce_wrapper_in_flat[1] = const_nested_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[0] = const_nested_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[26] = const_partselect_wrapper_out_flat[1];
assign array_wrapper_in_flat[16] = const_partselect_wrapper_out_flat[7];
assign cast_wrapper_in_flat[9] = const_reduce_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[2] = const_shift_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[2] = const_shift_wrapper_out_flat[17];
assign relational_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[5];
assign logical_op_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[7];
assign cast_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[9];
assign bitwise_logic_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[6] = bitwise_reduce_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[10] = select_wrapper_out_flat[1];
assign shift_wrapper_in_flat[0] = select_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[14] = select_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[1] = select_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[16] = select_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[7] = shift_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[7] = shift_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[7] = shift_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[4] = shift_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[0] = array_wrapper_out_flat[2];
assign shift_wrapper_in_flat[2] = array_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[9] = array_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[0] = array_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[16] = array_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[1] = cast_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[14] = cast_wrapper_out_flat[1];
assign relational_wrapper_in_flat[6] = cast_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[2] = cast_wrapper_out_flat[6];
assign logical_op_wrapper_in_flat[1] = conditional_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[1] = partselect_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[22] = partselect_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[3] = partselect_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[6] = width_struct_wrapper_out_flat[10];
assign numbers_concat_repl_wrapper_in_flat[2] = width_union_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[3] = width_union_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[3] = width_union_wrapper_out_flat[11];
assign select_wrapper_in_flat[17] = width_union_wrapper_out_flat[14];
assign shift_wrapper_in_flat[10] = width_union_wrapper_out_flat[15];
assign const_shift_wrapper_in_flat[4] = width_logic_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[17];
