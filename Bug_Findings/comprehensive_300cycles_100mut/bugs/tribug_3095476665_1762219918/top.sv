...
assign const_nested_wrapper_in_flat[12] = in_flat[95];
...
assign numbers_concat_repl_wrapper_in_flat[3] = const_arith_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[1] = const_arith_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[18] = const_arith_wrapper_out_flat[15];
assign shift_wrapper_in_flat[1] = const_arith_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[21] = const_concat_repl_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[14];
assign width_logic_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[15];
assign partselect_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[15];
assign const_partselect_wrapper_in_flat[14] = const_concat_repl_wrapper_out_flat[17];
assign const_logic_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[19];
assign array_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[19];
assign const_arith_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[16];
assign const_reduce_wrapper_in_flat[2] = const_logic_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[11] = const_logic_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[22] = const_logic_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[4] = const_logic_wrapper_out_flat[13];
assign const_reduce_wrapper_in_flat[1] = const_nested_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[3] = const_nested_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[0];
assign select_wrapper_in_flat[19] = const_reduce_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[7] = const_reduce_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[1] = const_shift_wrapper_out_flat[5];
assign shift_wrapper_in_flat[7] = const_shift_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[2] = const_shift_wrapper_out_flat[15];
assign cast_wrapper_in_flat[0] = const_shift_wrapper_out_flat[17];
assign partselect_wrapper_in_flat[8] = const_shift_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[13] = arithmetic_reduce_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[3];
assign relational_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[18] = bitwise_logic_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[14];
assign relational_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[21];
assign width_logic_wrapper_in_flat[6] = bitwise_reduce_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[11] = bitwise_reduce_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[8] = logical_op_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[0] = logical_op_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[0] = relational_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[3] = relational_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[5] = relational_wrapper_out_flat[7];
assign logical_op_wrapper_in_flat[1] = select_wrapper_out_flat[3];
assign relational_wrapper_in_flat[4] = select_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[19] = select_wrapper_out_flat[8];
assign bitwise_logic_wrapper_in_flat[15] = shift_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[17] = shift_wrapper_out_flat[7];
assign array_wrapper_in_flat[13] = shift_wrapper_out_flat[8];
assign cast_wrapper_in_flat[11] = shift_wrapper_out_flat[11];
assign const_concat_repl_wrapper_in_flat[7] = shift_wrapper_out_flat[12];
assign numbers_concat_repl_wrapper_in_flat[0] = array_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[3] = array_wrapper_out_flat[1];
assign relational_wrapper_in_flat[6] = array_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[19] = array_wrapper_out_flat[9];
assign relational_wrapper_in_flat[5] = cast_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[6] = cast_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[5] = cast_wrapper_out_flat[3];
assign array_wrapper_in_flat[17] = cast_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[3] = cast_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[7] = cast_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[1] = conditional_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[4] = partselect_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[0] = partselect_wrapper_out_flat[6];
assign select_wrapper_in_flat[3] = partselect_wrapper_out_flat[6];
assign bitwise_logic_wrapper_in_flat[3] = partselect_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[5] = width_enum_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[5] = width_enum_wrapper_out_flat[4];
assign select_wrapper_in_flat[12] = width_enum_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[0] = width_struct_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[0] = width_struct_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[7] = width_struct_wrapper_out_flat[10];
assign bitwise_logic_wrapper_in_flat[0] = width_union_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[10] = width_union_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[8] = width_logic_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[8] = width_logic_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[14] = numbers_concat_repl_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[9];
assign width_union_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[15];
