...
assign bitwise_logic_wrapper_in_flat[8] = in_flat[153];
assign bitwise_logic_wrapper_in_flat[9] = in_flat[154];
...
assign relational_wrapper_in_flat[0] = in_flat[165];
assign relational_wrapper_in_flat[2] = in_flat[166];
assign relational_wrapper_in_flat[3] = in_flat[167];
...
assign select_wrapper_in_flat[10] = in_flat[181];
assign select_wrapper_in_flat[11] = in_flat[182];
assign select_wrapper_in_flat[12] = in_flat[183];
assign select_wrapper_in_flat[13] = in_flat[184];
assign select_wrapper_in_flat[14] = in_flat[185];
assign select_wrapper_in_flat[16] = in_flat[186];
assign select_wrapper_in_flat[17] = in_flat[187];
assign select_wrapper_in_flat[18] = in_flat[188];
assign select_wrapper_in_flat[19] = in_flat[189];
assign shift_wrapper_in_flat[0] = in_flat[190];
assign shift_wrapper_in_flat[1] = in_flat[191];
...
assign array_wrapper_in_flat[4] = in_flat[199];
...
assign array_wrapper_in_flat[16] = in_flat[208];
assign array_wrapper_in_flat[17] = in_flat[209];
assign cast_wrapper_in_flat[0] = in_flat[210];
...
assign cast_wrapper_in_flat[10] = in_flat[218];
assign cast_wrapper_in_flat[11] = in_flat[219];
assign conditional_wrapper_in_flat[0] = in_flat[220];
...
assign partselect_wrapper_in_flat[12] = in_flat[233];
assign partselect_wrapper_in_flat[13] = in_flat[234];
assign partselect_wrapper_in_flat[14] = in_flat[235];
...
assign width_enum_wrapper_in_flat[0] = in_flat[239];
assign width_enum_wrapper_in_flat[1] = in_flat[240];
assign width_struct_wrapper_in_flat[1] = in_flat[241];
...
assign width_logic_wrapper_in_flat[0] = in_flat[264];
assign width_logic_wrapper_in_flat[2] = in_flat[265];
assign width_logic_wrapper_in_flat[3] = in_flat[266];
assign width_logic_wrapper_in_flat[5] = in_flat[267];
assign width_logic_wrapper_in_flat[7] = in_flat[268];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[269];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[270];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[271];

// Internal MTM connections (module-to-module)
assign shift_wrapper_in_flat[2] = const_arith_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[32] = const_arith_wrapper_out_flat[10];
assign bitwise_logic_wrapper_in_flat[7] = const_arith_wrapper_out_flat[21];
assign const_compare_wrapper_in_flat[19] = const_arith_wrapper_out_flat[28];
assign logical_op_wrapper_in_flat[0] = const_compare_wrapper_out_flat[0];
assign array_wrapper_in_flat[15] = const_compare_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[3] = const_compare_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[1];
assign array_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[4];
assign shift_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[17];
assign partselect_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[17];
assign bitwise_reduce_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[23];
...
assign const_shift_wrapper_in_flat[7] = const_logic_wrapper_out_flat[16];
assign const_arith_wrapper_in_flat[9] = const_nested_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[23] = const_nested_wrapper_out_flat[4];
assign shift_wrapper_in_flat[7] = const_nested_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[0] = const_nested_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[0];
...
assign const_concat_repl_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[11] = const_shift_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[15] = const_shift_wrapper_out_flat[9];
assign relational_wrapper_in_flat[1] = const_shift_wrapper_out_flat[11];
assign const_concat_repl_wrapper_in_flat[8] = const_shift_wrapper_out_flat[12];
assign const_arith_wrapper_in_flat[5] = const_shift_wrapper_out_flat[19];
assign const_reduce_wrapper_in_flat[2] = const_shift_wrapper_out_flat[20];
assign bitwise_logic_wrapper_in_flat[13] = arithmetic_reduce_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[13];
assign numbers_concat_repl_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[15];
assign conditional_wrapper_in_flat[4] = bitwise_reduce_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[2];
assign select_wrapper_in_flat[1] = logical_op_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[21] = relational_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[11] = relational_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[2] = select_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[4] = select_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[7] = select_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[8] = select_wrapper_out_flat[8];
assign select_wrapper_in_flat[15] = shift_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[17] = shift_wrapper_out_flat[15];
assign const_partselect_wrapper_in_flat[18] = array_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[1] = array_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[9] = cast_wrapper_out_flat[0];
assign array_wrapper_in_flat[5] = cast_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[11] = cast_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[2] = cast_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[2] = conditional_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[3] = partselect_wrapper_out_flat[5];
assign array_wrapper_in_flat[10] = width_struct_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[0] = width_union_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[3] = width_union_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[5] = width_union_wrapper_out_flat[12];
assign bitwise_reduce_wrapper_in_flat[1] = width_union_wrapper_out_flat[13];
assign shift_wrapper_in_flat[6] = width_union_wrapper_out_flat[15];
assign conditional_wrapper_in_flat[1] = width_logic_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[3] = width_logic_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[18] = numbers_concat_repl_wrapper_out_flat[10];
assign shift_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[13];
assign cast_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[13];
assign const_conditional_wrapper_in_flat[26] = numbers_concat_repl_wrapper_out_flat[16];
