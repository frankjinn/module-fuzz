...
assign const_conditional_wrapper_in_flat[23] = in_flat[68];
assign const_conditional_wrapper_in_flat[24] = in_flat[69];
...
assign conditional_wrapper_in_flat[4] = in_flat[218];
...
assign partselect_wrapper_in_flat[8] = in_flat[229];
assign partselect_wrapper_in_flat[9] = in_flat[230];
...
assign width_enum_wrapper_in_flat[2] = in_flat[238];
...
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[265];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[266];

// Internal MTM connections (module-to-module)
assign const_partselect_wrapper_in_flat[2] = const_arith_wrapper_out_flat[0];
assign select_wrapper_in_flat[19] = const_arith_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[8] = const_arith_wrapper_out_flat[14];
assign arithmetic_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[22];
assign const_shift_wrapper_in_flat[8] = const_arith_wrapper_out_flat[37];
assign array_wrapper_in_flat[1] = const_arith_wrapper_out_flat[37];
assign const_compare_wrapper_in_flat[17] = const_arith_wrapper_out_flat[38];
assign const_shift_wrapper_in_flat[4] = const_compare_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[14] = const_compare_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[14] = const_compare_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[8];
assign cast_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[20];
assign const_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[1];
assign select_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[7];
assign shift_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[13];
assign width_logic_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[16];
assign width_struct_wrapper_in_flat[3] = const_logic_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[1] = const_logic_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[0] = const_nested_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[3] = const_nested_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[15] = const_nested_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[13] = const_nested_wrapper_out_flat[5];
assign select_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[2];
assign shift_wrapper_in_flat[3] = const_shift_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[5] = const_shift_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[5] = const_shift_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[14] = const_shift_wrapper_out_flat[4];
assign array_wrapper_in_flat[11] = const_shift_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[25] = const_shift_wrapper_out_flat[16];
assign width_enum_wrapper_in_flat[1] = const_shift_wrapper_out_flat[23];
assign const_conditional_wrapper_in_flat[27] = arithmetic_reduce_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[20] = arithmetic_reduce_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[15] = bitwise_logic_wrapper_out_flat[22];
assign const_nested_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[0];
assign relational_wrapper_in_flat[5] = bitwise_reduce_wrapper_out_flat[1];
...
assign bitwise_reduce_wrapper_in_flat[1] = logical_op_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[4] = relational_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[10] = relational_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[2] = relational_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[0] = select_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[3] = select_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[13] = select_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[2] = shift_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[1] = shift_wrapper_out_flat[15];
assign const_conditional_wrapper_in_flat[9] = array_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[13] = array_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[4] = array_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[5] = array_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[3] = array_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[5] = cast_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[9] = cast_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[9] = conditional_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[10] = partselect_wrapper_out_flat[0];
assign cast_wrapper_in_flat[7] = partselect_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[8] = partselect_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[3] = width_enum_wrapper_out_flat[0];
assign cast_wrapper_in_flat[10] = width_union_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[0] = width_union_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[8] = width_union_wrapper_out_flat[12];
assign const_concat_repl_wrapper_in_flat[4] = width_union_wrapper_out_flat[14];
assign partselect_wrapper_in_flat[16] = width_logic_wrapper_out_flat[1];
assign relational_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[11];
assign width_struct_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[13];
assign logical_op_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[14];
