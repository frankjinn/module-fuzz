...
assign logical_op_wrapper_in_flat[0] = in_flat[158];
...
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[262];
...
assign conditional_wrapper_in_flat[0] = const_arith_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[6] = const_arith_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[10] = const_arith_wrapper_out_flat[22];
assign width_enum_wrapper_in_flat[1] = const_arith_wrapper_out_flat[23];
assign partselect_wrapper_in_flat[8] = const_arith_wrapper_out_flat[24];
assign select_wrapper_in_flat[8] = const_arith_wrapper_out_flat[25];
assign shift_wrapper_in_flat[5] = const_compare_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[28] = const_concat_repl_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[3];
assign select_wrapper_in_flat[14] = const_concat_repl_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[19] = const_concat_repl_wrapper_out_flat[16];
assign const_compare_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[16];
assign arithmetic_reduce_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[20];
assign const_compare_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[10];
assign width_enum_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[13];
assign bitwise_logic_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[18];
assign conditional_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[18];
assign partselect_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[20];
assign const_arith_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[22];
assign width_union_wrapper_in_flat[9] = const_logic_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[17] = const_nested_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[18] = const_partselect_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[15] = const_reduce_wrapper_out_flat[2];
assign relational_wrapper_in_flat[7] = const_reduce_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[7] = const_shift_wrapper_out_flat[1];
assign shift_wrapper_in_flat[4] = const_shift_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[0] = const_shift_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[4] = const_shift_wrapper_out_flat[14];
assign relational_wrapper_in_flat[0] = const_shift_wrapper_out_flat[17];
assign const_reduce_wrapper_in_flat[3] = const_shift_wrapper_out_flat[19];
assign arithmetic_reduce_wrapper_in_flat[10] = const_shift_wrapper_out_flat[20];
assign width_logic_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[7];
assign relational_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[7];
assign cast_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[21];
assign cast_wrapper_in_flat[2] = bitwise_reduce_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[4] = relational_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[14] = relational_wrapper_out_flat[4];
assign cast_wrapper_in_flat[7] = select_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[15] = shift_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[2] = shift_wrapper_out_flat[6];
assign cast_wrapper_in_flat[9] = shift_wrapper_out_flat[12];
assign relational_wrapper_in_flat[3] = array_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[1] = array_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[2] = array_wrapper_out_flat[8];
assign const_concat_repl_wrapper_in_flat[4] = array_wrapper_out_flat[9];
assign const_shift_wrapper_in_flat[2] = array_wrapper_out_flat[10];
assign const_compare_wrapper_in_flat[20] = array_wrapper_out_flat[11];
assign partselect_wrapper_in_flat[12] = cast_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[13] = conditional_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[9] = partselect_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[15] = width_enum_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[2] = width_enum_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[13] = width_enum_wrapper_out_flat[3];
assign select_wrapper_in_flat[7] = width_enum_wrapper_out_flat[4];
...
assign array_wrapper_in_flat[6] = width_struct_wrapper_out_flat[8];
assign const_shift_wrapper_in_flat[3] = width_struct_wrapper_out_flat[10];
assign const_logic_wrapper_in_flat[7] = width_logic_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[2] = width_logic_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[25] = numbers_concat_repl_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[3];
assign array_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[12];
assign conditional_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[14];
assign const_shift_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[15];
assign width_logic_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[15];
assign arithmetic_reduce_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[17];
