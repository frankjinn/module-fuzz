...
assign select_wrapper_in_flat[15] = in_flat[182];
assign select_wrapper_in_flat[16] = in_flat[183];
...
assign shift_wrapper_in_flat[6] = in_flat[188];
assign shift_wrapper_in_flat[7] = in_flat[189];
assign shift_wrapper_in_flat[9] = in_flat[190];
assign shift_wrapper_in_flat[10] = in_flat[191];
...
assign partselect_wrapper_in_flat[0] = in_flat[219];
assign partselect_wrapper_in_flat[1] = in_flat[220];
assign partselect_wrapper_in_flat[2] = in_flat[221];
...
assign const_shift_wrapper_in_flat[1] = const_arith_wrapper_out_flat[5];
assign cast_wrapper_in_flat[0] = const_arith_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[15] = const_arith_wrapper_out_flat[27];
assign const_logic_wrapper_in_flat[7] = const_arith_wrapper_out_flat[30];
assign width_struct_wrapper_in_flat[6] = const_arith_wrapper_out_flat[39];
assign const_partselect_wrapper_in_flat[5] = const_compare_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[7] = const_compare_wrapper_out_flat[0];
assign cast_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[19];
assign const_partselect_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[17];
assign numbers_concat_repl_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[20];
assign logical_op_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[22];
assign const_concat_repl_wrapper_in_flat[0] = const_logic_wrapper_out_flat[5];
assign select_wrapper_in_flat[17] = const_logic_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[3] = const_logic_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[7] = const_logic_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[9] = const_logic_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[3] = const_logic_wrapper_out_flat[12];
assign array_wrapper_in_flat[13] = const_nested_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[3] = const_nested_wrapper_out_flat[1];
assign select_wrapper_in_flat[9] = const_nested_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[6];
assign array_wrapper_in_flat[15] = const_shift_wrapper_out_flat[8];
assign bitwise_logic_wrapper_in_flat[7] = const_shift_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[19] = const_shift_wrapper_out_flat[10];
assign shift_wrapper_in_flat[2] = const_shift_wrapper_out_flat[12];
...
assign partselect_wrapper_in_flat[12] = arithmetic_reduce_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[8];
assign cast_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[9];
assign shift_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[22] = bitwise_logic_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[23];
assign width_logic_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[0];
assign cast_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[22] = bitwise_reduce_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[7] = logical_op_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[2] = relational_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[9] = select_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[7] = select_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[4] = select_wrapper_out_flat[8];
assign const_conditional_wrapper_in_flat[10] = shift_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[3] = shift_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[9] = shift_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[15] = shift_wrapper_out_flat[11];
assign bitwise_reduce_wrapper_in_flat[2] = array_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[2] = array_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[1] = array_wrapper_out_flat[8];
assign width_logic_wrapper_in_flat[0] = array_wrapper_out_flat[9];
assign bitwise_logic_wrapper_in_flat[9] = array_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[13] = cast_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[3] = cast_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[1] = cast_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[4] = conditional_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[1] = partselect_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[1] = partselect_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[7] = partselect_wrapper_out_flat[8];
...
assign bitwise_reduce_wrapper_in_flat[1] = width_enum_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[5] = width_enum_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[11] = width_enum_wrapper_out_flat[3];
assign shift_wrapper_in_flat[8] = width_enum_wrapper_out_flat[4];
assign shift_wrapper_in_flat[0] = width_struct_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[4] = width_struct_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[14] = width_struct_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[9] = width_struct_wrapper_out_flat[10];
assign shift_wrapper_in_flat[5] = width_union_wrapper_out_flat[3];
assign array_wrapper_in_flat[4] = width_union_wrapper_out_flat[12];
assign bitwise_reduce_wrapper_in_flat[5] = width_union_wrapper_out_flat[15];
assign numbers_concat_repl_wrapper_in_flat[3] = width_logic_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[4];
assign relational_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[15];
