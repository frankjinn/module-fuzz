...
assign const_concat_repl_wrapper_in_flat[1] = in_flat[35];
...
assign const_conditional_wrapper_in_flat[23] = in_flat[65];
assign const_conditional_wrapper_in_flat[24] = in_flat[66];
...
assign const_logic_wrapper_in_flat[7] = in_flat[78];
...
assign const_nested_wrapper_in_flat[5] = in_flat[85];
assign const_nested_wrapper_in_flat[6] = in_flat[86];
assign const_nested_wrapper_in_flat[7] = in_flat[87];
assign const_nested_wrapper_in_flat[8] = in_flat[88];
assign const_nested_wrapper_in_flat[9] = in_flat[89];
assign const_nested_wrapper_in_flat[10] = in_flat[90];
assign const_nested_wrapper_in_flat[11] = in_flat[91];
assign const_nested_wrapper_in_flat[12] = in_flat[92];
assign const_nested_wrapper_in_flat[13] = in_flat[93];
assign const_nested_wrapper_in_flat[14] = in_flat[94];
assign const_nested_wrapper_in_flat[15] = in_flat[95];
assign const_nested_wrapper_in_flat[16] = in_flat[96];
assign const_nested_wrapper_in_flat[17] = in_flat[97];
assign const_nested_wrapper_in_flat[18] = in_flat[98];
assign const_nested_wrapper_in_flat[19] = in_flat[99];
...
assign const_partselect_wrapper_in_flat[0] = in_flat[106];
assign const_partselect_wrapper_in_flat[1] = in_flat[107];
...
assign const_shift_wrapper_in_flat[10] = in_flat[129];
...
assign arithmetic_reduce_wrapper_in_flat[5] = in_flat[134];
assign arithmetic_reduce_wrapper_in_flat[6] = in_flat[135];
...
assign bitwise_reduce_wrapper_in_flat[3] = in_flat[157];
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[158];
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[159];
assign bitwise_reduce_wrapper_in_flat[7] = in_flat[160];
assign logical_op_wrapper_in_flat[1] = in_flat[161];
assign relational_wrapper_in_flat[0] = in_flat[162];
assign relational_wrapper_in_flat[1] = in_flat[163];
assign relational_wrapper_in_flat[2] = in_flat[164];
...
assign select_wrapper_in_flat[8] = in_flat[174];
assign select_wrapper_in_flat[9] = in_flat[175];
assign select_wrapper_in_flat[10] = in_flat[176];
assign select_wrapper_in_flat[11] = in_flat[177];
...
assign shift_wrapper_in_flat[1] = in_flat[184];
...
assign shift_wrapper_in_flat[8] = in_flat[190];
assign shift_wrapper_in_flat[9] = in_flat[191];
...
assign array_wrapper_in_flat[11] = in_flat[202];
assign array_wrapper_in_flat[13] = in_flat[203];
assign array_wrapper_in_flat[14] = in_flat[204];
assign array_wrapper_in_flat[15] = in_flat[205];
assign array_wrapper_in_flat[16] = in_flat[206];
assign array_wrapper_in_flat[17] = in_flat[207];
...
assign cast_wrapper_in_flat[10] = in_flat[213];
assign cast_wrapper_in_flat[11] = in_flat[214];
...
assign width_struct_wrapper_in_flat[6] = in_flat[239];
...
assign width_logic_wrapper_in_flat[4] = in_flat[257];
...
assign cast_wrapper_in_flat[1] = const_arith_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[22] = const_arith_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[4] = const_arith_wrapper_out_flat[30];
assign array_wrapper_in_flat[10] = const_arith_wrapper_out_flat[32];
assign arithmetic_reduce_wrapper_in_flat[2] = const_compare_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[8] = const_compare_wrapper_out_flat[1];
assign select_wrapper_in_flat[15] = const_compare_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[2] = const_compare_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[5] = const_compare_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[0];
assign cast_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[11];
assign bitwise_reduce_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[12];
assign conditional_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[14];
assign const_nested_wrapper_in_flat[26] = const_concat_repl_wrapper_out_flat[18];
assign partselect_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[18];
assign logical_op_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[8];
assign relational_wrapper_in_flat[4] = const_logic_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[28] = const_logic_wrapper_out_flat[18];
assign arithmetic_reduce_wrapper_in_flat[8] = const_nested_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[1] = const_nested_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[14] = const_nested_wrapper_out_flat[6];
assign cast_wrapper_in_flat[8] = const_nested_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[23] = const_nested_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[5];
assign array_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[5];
assign const_arith_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[7];
assign cast_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[7];
assign relational_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[4];
assign cast_wrapper_in_flat[6] = const_shift_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[0] = const_shift_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[11] = const_shift_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[10] = const_shift_wrapper_out_flat[11];
assign relational_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[13] = arithmetic_reduce_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[10];
assign shift_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[13];
assign width_enum_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[13];
assign array_wrapper_in_flat[12] = bitwise_logic_wrapper_out_flat[21];
assign const_reduce_wrapper_in_flat[2] = bitwise_reduce_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[25] = relational_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[0] = select_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[1] = select_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[6] = select_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[5] = shift_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[7] = shift_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[7] = shift_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[4] = shift_wrapper_out_flat[12];
assign const_concat_repl_wrapper_in_flat[9] = array_wrapper_out_flat[14];
assign partselect_wrapper_in_flat[6] = cast_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[15] = cast_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[8] = cast_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[0] = cast_wrapper_out_flat[7];
assign select_wrapper_in_flat[19] = conditional_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[2] = conditional_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[12] = conditional_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[11] = partselect_wrapper_out_flat[1];
assign select_wrapper_in_flat[14] = partselect_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[2] = partselect_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[3] = partselect_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[13] = width_enum_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[5] = width_enum_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[14] = width_struct_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[5] = width_struct_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[3] = width_union_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[0] = width_union_wrapper_out_flat[7];
assign relational_wrapper_in_flat[7] = width_union_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[10] = width_union_wrapper_out_flat[13];
assign const_logic_wrapper_in_flat[2] = width_union_wrapper_out_flat[15];
assign const_reduce_wrapper_in_flat[1] = width_logic_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[1] = width_logic_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[17];
