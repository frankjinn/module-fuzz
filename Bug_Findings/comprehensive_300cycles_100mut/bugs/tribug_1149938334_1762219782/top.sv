...
assign relational_wrapper_in_flat[0] = in_flat[160];
...
assign conditional_wrapper_in_flat[2] = in_flat[214];
assign conditional_wrapper_in_flat[3] = in_flat[215];
...
assign partselect_wrapper_in_flat[6] = in_flat[223];
assign partselect_wrapper_in_flat[7] = in_flat[224];
assign partselect_wrapper_in_flat[8] = in_flat[225];
...
assign partselect_wrapper_in_flat[17] = in_flat[232];
...
assign width_union_wrapper_in_flat[3] = in_flat[247];
assign width_union_wrapper_in_flat[4] = in_flat[248];
...
assign width_logic_wrapper_in_flat[2] = in_flat[256];
assign width_logic_wrapper_in_flat[4] = in_flat[257];
assign width_logic_wrapper_in_flat[5] = in_flat[258];
assign width_logic_wrapper_in_flat[6] = in_flat[259];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[260];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[261];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[262];

// Internal MTM connections (module-to-module)
assign array_wrapper_in_flat[8] = const_arith_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[3] = const_arith_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[9] = const_arith_wrapper_out_flat[8];
assign relational_wrapper_in_flat[7] = const_arith_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[4] = const_arith_wrapper_out_flat[17];
assign cast_wrapper_in_flat[4] = const_arith_wrapper_out_flat[27];
assign arithmetic_reduce_wrapper_in_flat[4] = const_arith_wrapper_out_flat[37];
assign array_wrapper_in_flat[12] = const_compare_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[8];
assign const_shift_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[14];
assign cast_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[19];
assign const_compare_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[0];
assign relational_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[9];
assign const_shift_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[19];
assign const_reduce_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[19];
assign width_union_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[22];
assign width_struct_wrapper_in_flat[0] = const_logic_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[1] = const_logic_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[12] = const_partselect_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[14] = const_reduce_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[13] = const_shift_wrapper_out_flat[0];
assign array_wrapper_in_flat[9] = const_shift_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[6] = const_shift_wrapper_out_flat[16];
assign width_union_wrapper_in_flat[10] = const_shift_wrapper_out_flat[19];
assign shift_wrapper_in_flat[8] = const_shift_wrapper_out_flat[22];
assign width_union_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[18];
assign const_conditional_wrapper_in_flat[21] = bitwise_logic_wrapper_out_flat[21];
assign const_partselect_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[0];
assign relational_wrapper_in_flat[1] = logical_op_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[10] = select_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[2] = select_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[4] = select_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[0] = select_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[22] = shift_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[4] = shift_wrapper_out_flat[12];
assign partselect_wrapper_in_flat[5] = shift_wrapper_out_flat[13];
assign cast_wrapper_in_flat[5] = shift_wrapper_out_flat[14];
assign width_struct_wrapper_in_flat[6] = array_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[6] = array_wrapper_out_flat[8];
assign const_logic_wrapper_in_flat[6] = array_wrapper_out_flat[12];
assign conditional_wrapper_in_flat[4] = array_wrapper_out_flat[13];
assign width_enum_wrapper_in_flat[3] = cast_wrapper_out_flat[2];
assign array_wrapper_in_flat[16] = cast_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[2] = cast_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[12] = cast_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[2] = cast_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[7] = cast_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[16] = cast_wrapper_out_flat[9];
assign width_enum_wrapper_in_flat[1] = conditional_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[8] = partselect_wrapper_out_flat[4];
assign array_wrapper_in_flat[5] = partselect_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[6] = width_enum_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[3] = width_enum_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[5] = width_enum_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[0] = width_struct_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[0] = width_struct_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[1] = width_struct_wrapper_out_flat[9];
assign relational_wrapper_in_flat[3] = width_struct_wrapper_out_flat[10];
assign select_wrapper_in_flat[14] = width_struct_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[8] = width_union_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[9] = width_union_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[2] = width_union_wrapper_out_flat[6];
assign relational_wrapper_in_flat[6] = width_union_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[8] = width_union_wrapper_out_flat[9];
assign array_wrapper_in_flat[3] = width_union_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[11] = width_logic_wrapper_out_flat[2];
...
assign const_partselect_wrapper_in_flat[12] = numbers_concat_repl_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[6];
assign select_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[15];
