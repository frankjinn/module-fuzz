...
assign const_logic_wrapper_in_flat[9] = in_flat[85];
assign const_nested_wrapper_in_flat[0] = in_flat[86];
assign const_nested_wrapper_in_flat[2] = in_flat[87];
assign const_nested_wrapper_in_flat[3] = in_flat[88];
assign const_nested_wrapper_in_flat[4] = in_flat[89];
...
assign const_partselect_wrapper_in_flat[4] = in_flat[113];
assign const_partselect_wrapper_in_flat[5] = in_flat[114];
...
assign const_partselect_wrapper_in_flat[12] = in_flat[119];
assign const_partselect_wrapper_in_flat[13] = in_flat[120];
assign const_partselect_wrapper_in_flat[14] = in_flat[121];
assign const_partselect_wrapper_in_flat[15] = in_flat[122];
...
assign bitwise_reduce_wrapper_in_flat[1] = in_flat[156];
...
assign width_union_wrapper_in_flat[15] = const_arith_wrapper_out_flat[8];
assign array_wrapper_in_flat[9] = const_arith_wrapper_out_flat[14];
assign conditional_wrapper_in_flat[8] = const_arith_wrapper_out_flat[14];
assign bitwise_logic_wrapper_in_flat[11] = const_arith_wrapper_out_flat[20];
assign relational_wrapper_in_flat[0] = const_arith_wrapper_out_flat[23];
assign logical_op_wrapper_in_flat[1] = const_arith_wrapper_out_flat[25];
assign const_shift_wrapper_in_flat[5] = const_arith_wrapper_out_flat[27];
assign const_nested_wrapper_in_flat[1] = const_arith_wrapper_out_flat[37];
assign select_wrapper_in_flat[2] = const_arith_wrapper_out_flat[38];
assign logical_op_wrapper_in_flat[0] = const_compare_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[3] = const_compare_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[17] = const_concat_repl_wrapper_out_flat[5];
assign shift_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[11];
assign const_shift_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[12];
assign relational_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[17];
assign cast_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[20];
assign const_arith_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[5];
assign cast_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[9];
assign width_union_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[16];
assign relational_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[19];
assign relational_wrapper_in_flat[4] = const_logic_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[3] = const_logic_wrapper_out_flat[4];
assign shift_wrapper_in_flat[0] = const_logic_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[7] = const_logic_wrapper_out_flat[11];
assign width_enum_wrapper_in_flat[2] = const_nested_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[3] = const_nested_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[11] = const_partselect_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[16] = const_reduce_wrapper_out_flat[0];
assign shift_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[13] = const_shift_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[22] = const_shift_wrapper_out_flat[13];
assign const_reduce_wrapper_in_flat[2] = const_shift_wrapper_out_flat[15];
assign partselect_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[11];
assign const_shift_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[16];
assign arithmetic_reduce_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[17];
assign const_compare_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[21];
assign width_enum_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[22];
assign const_nested_wrapper_in_flat[5] = bitwise_reduce_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[19] = bitwise_reduce_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[17] = bitwise_reduce_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[0] = logical_op_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[26] = logical_op_wrapper_out_flat[1];
assign select_wrapper_in_flat[16] = relational_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[1] = relational_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[3] = relational_wrapper_out_flat[2];
assign array_wrapper_in_flat[2] = select_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[4] = select_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[3] = select_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[6] = select_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[6] = shift_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[13] = shift_wrapper_out_flat[10];
assign width_enum_wrapper_in_flat[1] = shift_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[9] = array_wrapper_out_flat[2];
...
assign const_compare_wrapper_in_flat[16] = array_wrapper_out_flat[11];
assign bitwise_logic_wrapper_in_flat[9] = array_wrapper_out_flat[15];
assign const_logic_wrapper_in_flat[5] = cast_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[4] = cast_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[1] = conditional_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[3] = conditional_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[18] = width_enum_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[1] = width_enum_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[0] = width_enum_wrapper_out_flat[3];
assign shift_wrapper_in_flat[9] = width_struct_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[3] = width_struct_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[4] = width_union_wrapper_out_flat[2];
assign select_wrapper_in_flat[4] = width_union_wrapper_out_flat[2];
assign relational_wrapper_in_flat[5] = width_union_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[0] = width_union_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[10];
