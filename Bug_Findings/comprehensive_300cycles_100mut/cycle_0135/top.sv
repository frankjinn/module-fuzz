...
assign arithmetic_reduce_wrapper_in_flat[7] = const_arith_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[1] = const_arith_wrapper_out_flat[14];
assign relational_wrapper_in_flat[5] = const_compare_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[2] = const_compare_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[19] = const_compare_wrapper_out_flat[6];
assign shift_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[8];
assign logical_op_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[16];
assign const_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[12];
assign bitwise_logic_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[12];
assign select_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[14];
assign partselect_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[14];
assign width_union_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[22];
assign relational_wrapper_in_flat[1] = const_logic_wrapper_out_flat[9];
assign shift_wrapper_in_flat[9] = const_logic_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[3] = const_logic_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[0] = const_logic_wrapper_out_flat[16];
assign width_struct_wrapper_in_flat[11] = const_nested_wrapper_out_flat[3];
assign select_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[2];
assign cast_wrapper_in_flat[3] = const_shift_wrapper_out_flat[14];
assign select_wrapper_in_flat[10] = const_shift_wrapper_out_flat[23];
assign const_shift_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[14] = arithmetic_reduce_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[6];
assign cast_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[13];
assign const_logic_wrapper_in_flat[8] = bitwise_reduce_wrapper_out_flat[0];
...
assign partselect_wrapper_in_flat[14] = bitwise_reduce_wrapper_out_flat[1];
assign array_wrapper_in_flat[16] = logical_op_wrapper_out_flat[1];
assign select_wrapper_in_flat[14] = logical_op_wrapper_out_flat[1];
assign shift_wrapper_in_flat[2] = select_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[5] = select_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[5] = select_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[0] = select_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[11] = shift_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[8] = shift_wrapper_out_flat[15];
assign width_struct_wrapper_in_flat[4] = shift_wrapper_out_flat[15];
assign const_logic_wrapper_in_flat[9] = array_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[8] = array_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[7] = array_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[3] = array_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[0] = cast_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[5] = cast_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[1] = cast_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[1] = cast_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[16] = cast_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[2] = partselect_wrapper_out_flat[1];
assign relational_wrapper_in_flat[6] = partselect_wrapper_out_flat[4];
assign logical_op_wrapper_in_flat[1] = width_enum_wrapper_out_flat[1];
assign select_wrapper_in_flat[1] = width_enum_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[2] = width_enum_wrapper_out_flat[4];
assign relational_wrapper_in_flat[4] = width_struct_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[4] = width_struct_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[1] = width_union_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[0] = width_union_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[4] = width_union_wrapper_out_flat[4];
assign shift_wrapper_in_flat[5] = width_union_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[6] = width_union_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[16] = width_union_wrapper_out_flat[10];
assign numbers_concat_repl_wrapper_in_flat[5] = width_union_wrapper_out_flat[12];
assign const_concat_repl_wrapper_in_flat[5] = width_union_wrapper_out_flat[14];
assign array_wrapper_in_flat[4] = width_logic_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[1] = width_logic_wrapper_out_flat[3];
assign shift_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[17];
