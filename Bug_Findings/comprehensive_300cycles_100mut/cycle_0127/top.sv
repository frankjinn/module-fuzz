...
assign width_struct_wrapper_in_flat[6] = const_arith_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[1] = const_arith_wrapper_out_flat[9];
assign shift_wrapper_in_flat[1] = const_arith_wrapper_out_flat[10];
assign const_shift_wrapper_in_flat[7] = const_arith_wrapper_out_flat[18];
assign array_wrapper_in_flat[11] = const_compare_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[6] = const_compare_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[13] = const_compare_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[8] = const_compare_wrapper_out_flat[7];
assign array_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[18] = const_concat_repl_wrapper_out_flat[14];
assign logical_op_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[3];
assign relational_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[13];
assign array_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[13];
assign const_reduce_wrapper_in_flat[0] = const_logic_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[0] = const_logic_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[6] = const_logic_wrapper_out_flat[13];
assign const_conditional_wrapper_in_flat[24] = const_nested_wrapper_out_flat[6];
assign array_wrapper_in_flat[17] = const_nested_wrapper_out_flat[7];
assign select_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[2] = const_shift_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[6] = const_shift_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[3] = const_shift_wrapper_out_flat[12];
assign numbers_concat_repl_wrapper_in_flat[4] = const_shift_wrapper_out_flat[15];
assign width_struct_wrapper_in_flat[0] = const_shift_wrapper_out_flat[18];
assign bitwise_reduce_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[12] = arithmetic_reduce_wrapper_out_flat[7];
...
assign cast_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[8];
assign select_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[9];
assign width_enum_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[1];
assign array_wrapper_in_flat[15] = bitwise_reduce_wrapper_out_flat[1];
...
assign array_wrapper_in_flat[0] = logical_op_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[1] = logical_op_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[8] = relational_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[0] = relational_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[14] = relational_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[16] = select_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[12] = select_wrapper_out_flat[8];
assign shift_wrapper_in_flat[4] = select_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[4] = shift_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[1] = shift_wrapper_out_flat[6];
assign array_wrapper_in_flat[4] = shift_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[0] = shift_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[12] = shift_wrapper_out_flat[10];
assign const_compare_wrapper_in_flat[1] = cast_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[1] = cast_wrapper_out_flat[9];
assign width_union_wrapper_in_flat[8] = cast_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[8] = cast_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[3] = conditional_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[5] = partselect_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[1] = partselect_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[5] = partselect_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[3] = partselect_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[10] = width_enum_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[3] = width_enum_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[21] = width_struct_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[25] = width_struct_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[1] = width_struct_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[10] = width_struct_wrapper_out_flat[11];
assign select_wrapper_in_flat[4] = width_union_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[22] = width_union_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[1] = width_union_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[2] = width_union_wrapper_out_flat[13];
assign array_wrapper_in_flat[8] = width_logic_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[1] = width_logic_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[21] = width_logic_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[0] = width_logic_wrapper_out_flat[4];
assign shift_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[23] = numbers_concat_repl_wrapper_out_flat[12];
