...
assign const_compare_wrapper_in_flat[12] = in_flat[23];
assign const_compare_wrapper_in_flat[13] = in_flat[24];
assign const_compare_wrapper_in_flat[14] = in_flat[25];
...
assign const_compare_wrapper_in_flat[20] = in_flat[30];
assign const_compare_wrapper_in_flat[21] = in_flat[31];
...
assign const_concat_repl_wrapper_in_flat[7] = in_flat[38];
assign const_concat_repl_wrapper_in_flat[8] = in_flat[39];
...
assign const_logic_wrapper_in_flat[1] = in_flat[73];
assign const_logic_wrapper_in_flat[2] = in_flat[74];
assign const_logic_wrapper_in_flat[5] = in_flat[75];
assign const_logic_wrapper_in_flat[6] = in_flat[76];
assign const_logic_wrapper_in_flat[7] = in_flat[77];
assign const_logic_wrapper_in_flat[8] = in_flat[78];
assign const_logic_wrapper_in_flat[9] = in_flat[79];
assign const_nested_wrapper_in_flat[0] = in_flat[80];
...
assign const_nested_wrapper_in_flat[4] = in_flat[84];
assign const_nested_wrapper_in_flat[7] = in_flat[85];
assign const_nested_wrapper_in_flat[8] = in_flat[86];
assign const_nested_wrapper_in_flat[9] = in_flat[87];
...
assign const_partselect_wrapper_in_flat[5] = in_flat[110];
assign const_partselect_wrapper_in_flat[6] = in_flat[111];
assign const_partselect_wrapper_in_flat[7] = in_flat[112];
assign const_partselect_wrapper_in_flat[8] = in_flat[113];
assign const_partselect_wrapper_in_flat[9] = in_flat[114];
assign const_partselect_wrapper_in_flat[10] = in_flat[115];
assign const_partselect_wrapper_in_flat[11] = in_flat[116];
assign const_partselect_wrapper_in_flat[12] = in_flat[117];
assign const_partselect_wrapper_in_flat[13] = in_flat[118];
assign const_partselect_wrapper_in_flat[14] = in_flat[119];
assign const_partselect_wrapper_in_flat[15] = in_flat[120];
assign const_partselect_wrapper_in_flat[16] = in_flat[121];
assign const_partselect_wrapper_in_flat[17] = in_flat[122];
assign const_partselect_wrapper_in_flat[18] = in_flat[123];
assign const_partselect_wrapper_in_flat[19] = in_flat[124];
assign const_reduce_wrapper_in_flat[0] = in_flat[125];
assign const_reduce_wrapper_in_flat[1] = in_flat[126];
assign const_shift_wrapper_in_flat[0] = in_flat[127];
assign const_shift_wrapper_in_flat[1] = in_flat[128];
assign const_shift_wrapper_in_flat[2] = in_flat[129];
assign const_shift_wrapper_in_flat[3] = in_flat[130];
assign const_shift_wrapper_in_flat[4] = in_flat[131];
assign const_shift_wrapper_in_flat[5] = in_flat[132];
assign const_shift_wrapper_in_flat[6] = in_flat[133];
assign const_shift_wrapper_in_flat[7] = in_flat[134];
assign const_shift_wrapper_in_flat[8] = in_flat[135];
assign const_shift_wrapper_in_flat[9] = in_flat[136];
assign arithmetic_reduce_wrapper_in_flat[1] = in_flat[137];
assign arithmetic_reduce_wrapper_in_flat[2] = in_flat[138];
assign arithmetic_reduce_wrapper_in_flat[4] = in_flat[139];
assign arithmetic_reduce_wrapper_in_flat[5] = in_flat[140];
assign arithmetic_reduce_wrapper_in_flat[6] = in_flat[141];
assign arithmetic_reduce_wrapper_in_flat[7] = in_flat[142];
assign arithmetic_reduce_wrapper_in_flat[8] = in_flat[143];
assign arithmetic_reduce_wrapper_in_flat[9] = in_flat[144];
assign arithmetic_reduce_wrapper_in_flat[11] = in_flat[145];
assign arithmetic_reduce_wrapper_in_flat[12] = in_flat[146];
assign arithmetic_reduce_wrapper_in_flat[13] = in_flat[147];
assign arithmetic_reduce_wrapper_in_flat[14] = in_flat[148];
assign bitwise_logic_wrapper_in_flat[0] = in_flat[149];
assign bitwise_logic_wrapper_in_flat[2] = in_flat[150];
assign bitwise_logic_wrapper_in_flat[3] = in_flat[151];
assign bitwise_logic_wrapper_in_flat[4] = in_flat[152];
assign bitwise_logic_wrapper_in_flat[5] = in_flat[153];
assign bitwise_logic_wrapper_in_flat[6] = in_flat[154];
assign bitwise_logic_wrapper_in_flat[8] = in_flat[155];
assign bitwise_logic_wrapper_in_flat[9] = in_flat[156];
assign bitwise_logic_wrapper_in_flat[11] = in_flat[157];
assign bitwise_logic_wrapper_in_flat[12] = in_flat[158];
assign bitwise_logic_wrapper_in_flat[13] = in_flat[159];
assign bitwise_logic_wrapper_in_flat[14] = in_flat[160];
assign bitwise_logic_wrapper_in_flat[15] = in_flat[161];
assign bitwise_reduce_wrapper_in_flat[0] = in_flat[162];
assign bitwise_reduce_wrapper_in_flat[1] = in_flat[163];
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[164];
assign bitwise_reduce_wrapper_in_flat[3] = in_flat[165];
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[166];
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[167];
assign bitwise_reduce_wrapper_in_flat[7] = in_flat[168];
assign logical_op_wrapper_in_flat[1] = in_flat[169];
assign relational_wrapper_in_flat[0] = in_flat[170];
assign relational_wrapper_in_flat[1] = in_flat[171];
assign relational_wrapper_in_flat[2] = in_flat[172];
assign relational_wrapper_in_flat[3] = in_flat[173];
assign relational_wrapper_in_flat[6] = in_flat[174];
assign relational_wrapper_in_flat[7] = in_flat[175];
assign select_wrapper_in_flat[0] = in_flat[176];
assign select_wrapper_in_flat[2] = in_flat[177];
assign select_wrapper_in_flat[3] = in_flat[178];
assign select_wrapper_in_flat[4] = in_flat[179];
assign select_wrapper_in_flat[5] = in_flat[180];
assign select_wrapper_in_flat[6] = in_flat[181];
assign select_wrapper_in_flat[7] = in_flat[182];
assign select_wrapper_in_flat[8] = in_flat[183];
assign select_wrapper_in_flat[9] = in_flat[184];
assign select_wrapper_in_flat[10] = in_flat[185];
assign select_wrapper_in_flat[11] = in_flat[186];
assign select_wrapper_in_flat[13] = in_flat[187];
assign select_wrapper_in_flat[14] = in_flat[188];
assign select_wrapper_in_flat[15] = in_flat[189];
assign select_wrapper_in_flat[16] = in_flat[190];
assign select_wrapper_in_flat[17] = in_flat[191];
assign select_wrapper_in_flat[18] = in_flat[192];
assign select_wrapper_in_flat[19] = in_flat[193];
assign shift_wrapper_in_flat[0] = in_flat[194];
assign shift_wrapper_in_flat[3] = in_flat[195];
assign shift_wrapper_in_flat[5] = in_flat[196];
assign shift_wrapper_in_flat[6] = in_flat[197];
assign shift_wrapper_in_flat[7] = in_flat[198];
assign shift_wrapper_in_flat[9] = in_flat[199];
assign array_wrapper_in_flat[0] = in_flat[200];
assign array_wrapper_in_flat[1] = in_flat[201];
assign array_wrapper_in_flat[2] = in_flat[202];
assign array_wrapper_in_flat[3] = in_flat[203];
assign array_wrapper_in_flat[4] = in_flat[204];
assign array_wrapper_in_flat[5] = in_flat[205];
assign array_wrapper_in_flat[6] = in_flat[206];
assign array_wrapper_in_flat[7] = in_flat[207];
assign array_wrapper_in_flat[8] = in_flat[208];
assign array_wrapper_in_flat[10] = in_flat[209];
assign array_wrapper_in_flat[11] = in_flat[210];
assign array_wrapper_in_flat[12] = in_flat[211];
assign array_wrapper_in_flat[13] = in_flat[212];
assign array_wrapper_in_flat[14] = in_flat[213];
assign array_wrapper_in_flat[15] = in_flat[214];
assign array_wrapper_in_flat[16] = in_flat[215];
assign array_wrapper_in_flat[17] = in_flat[216];
assign cast_wrapper_in_flat[0] = in_flat[217];
assign cast_wrapper_in_flat[1] = in_flat[218];
assign cast_wrapper_in_flat[3] = in_flat[219];
assign cast_wrapper_in_flat[4] = in_flat[220];
assign cast_wrapper_in_flat[6] = in_flat[221];
assign cast_wrapper_in_flat[7] = in_flat[222];
assign cast_wrapper_in_flat[8] = in_flat[223];
assign cast_wrapper_in_flat[9] = in_flat[224];
assign cast_wrapper_in_flat[10] = in_flat[225];
assign cast_wrapper_in_flat[11] = in_flat[226];
assign conditional_wrapper_in_flat[0] = in_flat[227];
assign conditional_wrapper_in_flat[1] = in_flat[228];
assign conditional_wrapper_in_flat[2] = in_flat[229];
assign conditional_wrapper_in_flat[4] = in_flat[230];
assign partselect_wrapper_in_flat[1] = in_flat[231];
assign partselect_wrapper_in_flat[2] = in_flat[232];
assign partselect_wrapper_in_flat[3] = in_flat[233];
assign partselect_wrapper_in_flat[4] = in_flat[234];
assign partselect_wrapper_in_flat[5] = in_flat[235];
assign partselect_wrapper_in_flat[6] = in_flat[236];
assign partselect_wrapper_in_flat[7] = in_flat[237];
assign partselect_wrapper_in_flat[8] = in_flat[238];
assign partselect_wrapper_in_flat[9] = in_flat[239];
assign partselect_wrapper_in_flat[10] = in_flat[240];
assign partselect_wrapper_in_flat[11] = in_flat[241];
assign partselect_wrapper_in_flat[13] = in_flat[242];
assign partselect_wrapper_in_flat[14] = in_flat[243];
assign partselect_wrapper_in_flat[15] = in_flat[244];
assign partselect_wrapper_in_flat[17] = in_flat[245];
assign partselect_wrapper_in_flat[18] = in_flat[246];
assign width_enum_wrapper_in_flat[0] = in_flat[247];
assign width_struct_wrapper_in_flat[1] = in_flat[248];
assign width_struct_wrapper_in_flat[2] = in_flat[249];
assign width_struct_wrapper_in_flat[3] = in_flat[250];
assign width_struct_wrapper_in_flat[5] = in_flat[251];
assign width_struct_wrapper_in_flat[6] = in_flat[252];
assign width_struct_wrapper_in_flat[7] = in_flat[253];
assign width_struct_wrapper_in_flat[9] = in_flat[254];
assign width_struct_wrapper_in_flat[10] = in_flat[255];
assign width_struct_wrapper_in_flat[11] = in_flat[256];
assign width_union_wrapper_in_flat[0] = in_flat[257];
assign width_union_wrapper_in_flat[2] = in_flat[258];
assign width_union_wrapper_in_flat[3] = in_flat[259];
assign width_union_wrapper_in_flat[4] = in_flat[260];
assign width_union_wrapper_in_flat[5] = in_flat[261];
assign width_union_wrapper_in_flat[6] = in_flat[262];
assign width_union_wrapper_in_flat[7] = in_flat[263];
assign width_union_wrapper_in_flat[9] = in_flat[264];
assign width_union_wrapper_in_flat[10] = in_flat[265];
assign width_union_wrapper_in_flat[11] = in_flat[266];
assign width_union_wrapper_in_flat[13] = in_flat[267];
assign width_union_wrapper_in_flat[14] = in_flat[268];
assign width_union_wrapper_in_flat[15] = in_flat[269];
assign width_logic_wrapper_in_flat[4] = in_flat[270];
assign width_logic_wrapper_in_flat[6] = in_flat[271];
assign width_logic_wrapper_in_flat[7] = in_flat[272];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[273];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[274];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[275];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[276];

// Internal MTM connections (module-to-module)
assign const_compare_wrapper_in_flat[16] = const_arith_wrapper_out_flat[11];
assign cast_wrapper_in_flat[5] = const_arith_wrapper_out_flat[15];
assign width_logic_wrapper_in_flat[1] = const_arith_wrapper_out_flat[30];
assign width_logic_wrapper_in_flat[0] = const_compare_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[19];
assign const_logic_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[5] = const_logic_wrapper_out_flat[13];
assign width_logic_wrapper_in_flat[2] = const_logic_wrapper_out_flat[18];
assign const_arith_wrapper_in_flat[1] = const_nested_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[1];
assign relational_wrapper_in_flat[5] = const_shift_wrapper_out_flat[1];
assign cast_wrapper_in_flat[2] = const_shift_wrapper_out_flat[10];
assign array_wrapper_in_flat[9] = const_shift_wrapper_out_flat[18];
assign partselect_wrapper_in_flat[16] = const_shift_wrapper_out_flat[21];
assign bitwise_reduce_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[15] = bitwise_logic_wrapper_out_flat[8];
assign shift_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[9];
assign numbers_concat_repl_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[14];
assign width_enum_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[14];
assign const_conditional_wrapper_in_flat[21] = bitwise_reduce_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[10] = logical_op_wrapper_out_flat[2];
assign select_wrapper_in_flat[1] = relational_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[1] = relational_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[0] = relational_wrapper_out_flat[0];
assign shift_wrapper_in_flat[1] = relational_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[7] = relational_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[6] = select_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[12] = select_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[1] = select_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[8] = shift_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[15] = shift_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[3] = shift_wrapper_out_flat[11];
assign relational_wrapper_in_flat[4] = array_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[12] = array_wrapper_out_flat[3];
assign select_wrapper_in_flat[12] = array_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[1] = array_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[2] = array_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[6] = array_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[22] = cast_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[3] = cast_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[2] = cast_wrapper_out_flat[9];
assign shift_wrapper_in_flat[10] = conditional_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[0] = partselect_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[7] = partselect_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[8] = partselect_wrapper_out_flat[8];
assign shift_wrapper_in_flat[8] = width_enum_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[9] = width_enum_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[0] = width_enum_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[8] = width_enum_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[13] = width_struct_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[5] = width_struct_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[0] = width_union_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[3] = width_union_wrapper_out_flat[11];
assign numbers_concat_repl_wrapper_in_flat[1] = width_union_wrapper_out_flat[12];
assign conditional_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[8];
assign shift_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[15];
