...
assign select_wrapper_in_flat[16] = in_flat[181];
assign select_wrapper_in_flat[17] = in_flat[182];
assign select_wrapper_in_flat[18] = in_flat[183];
assign select_wrapper_in_flat[19] = in_flat[184];
assign shift_wrapper_in_flat[0] = in_flat[185];
...
assign width_logic_wrapper_in_flat[4] = in_flat[265];
assign width_logic_wrapper_in_flat[5] = in_flat[266];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[267];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[268];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[269];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[270];

// Internal MTM connections (module-to-module)
assign partselect_wrapper_in_flat[8] = const_arith_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[4] = const_arith_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[6] = const_arith_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[0] = const_arith_wrapper_out_flat[7];
assign cast_wrapper_in_flat[9] = const_arith_wrapper_out_flat[12];
assign arithmetic_reduce_wrapper_in_flat[9] = const_arith_wrapper_out_flat[24];
assign const_conditional_wrapper_in_flat[3] = const_arith_wrapper_out_flat[33];
assign width_union_wrapper_in_flat[3] = const_compare_wrapper_out_flat[2];
assign array_wrapper_in_flat[14] = const_concat_repl_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[13];
assign width_union_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[14];
assign const_logic_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[15];
assign arithmetic_reduce_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[15];
assign shift_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[18];
assign bitwise_logic_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[22];
assign const_shift_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[22];
assign arithmetic_reduce_wrapper_in_flat[7] = const_logic_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[11] = const_logic_wrapper_out_flat[9];
assign shift_wrapper_in_flat[1] = const_logic_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[9] = const_logic_wrapper_out_flat[14];
assign width_enum_wrapper_in_flat[0] = const_logic_wrapper_out_flat[15];
assign const_partselect_wrapper_in_flat[11] = const_logic_wrapper_out_flat[17];
assign width_enum_wrapper_in_flat[3] = const_nested_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[5];
assign logical_op_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[6];
assign select_wrapper_in_flat[12] = const_reduce_wrapper_out_flat[1];
...
assign bitwise_reduce_wrapper_in_flat[3] = const_shift_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[1] = const_shift_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[12] = const_shift_wrapper_out_flat[16];
assign width_struct_wrapper_in_flat[1] = const_shift_wrapper_out_flat[20];
assign shift_wrapper_in_flat[10] = const_shift_wrapper_out_flat[21];
assign width_logic_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[8];
assign relational_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[1];
assign relational_wrapper_in_flat[2] = bitwise_reduce_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[3] = relational_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[4] = relational_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[5] = select_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[0] = shift_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[2] = shift_wrapper_out_flat[10];
assign shift_wrapper_in_flat[7] = array_wrapper_out_flat[15];
assign width_logic_wrapper_in_flat[7] = cast_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[6] = cast_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[1] = cast_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[2] = cast_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[5] = cast_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[5] = cast_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[2] = cast_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[8] = partselect_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[0] = partselect_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[5] = width_enum_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[5] = width_struct_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[19] = width_struct_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[3] = width_union_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[10] = width_union_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[1] = width_union_wrapper_out_flat[8];
assign select_wrapper_in_flat[14] = width_union_wrapper_out_flat[11];
assign const_shift_wrapper_in_flat[3] = width_logic_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[14] = numbers_concat_repl_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[11];
