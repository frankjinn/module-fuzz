...
assign const_partselect_wrapper_in_flat[4] = in_flat[112];
...
assign const_partselect_wrapper_in_flat[10] = in_flat[116];
assign const_partselect_wrapper_in_flat[11] = in_flat[117];
assign const_partselect_wrapper_in_flat[12] = in_flat[118];
...
assign const_reduce_wrapper_in_flat[3] = in_flat[124];
...
assign const_shift_wrapper_in_flat[10] = in_flat[132];
assign arithmetic_reduce_wrapper_in_flat[0] = in_flat[133];
...
assign select_wrapper_in_flat[0] = in_flat[170];
assign select_wrapper_in_flat[1] = in_flat[171];
assign select_wrapper_in_flat[2] = in_flat[172];
...
assign cast_wrapper_in_flat[9] = in_flat[217];
...
assign conditional_wrapper_in_flat[2] = in_flat[221];
...
assign partselect_wrapper_in_flat[1] = in_flat[227];
assign partselect_wrapper_in_flat[2] = in_flat[228];
assign partselect_wrapper_in_flat[3] = in_flat[229];
assign partselect_wrapper_in_flat[4] = in_flat[230];
assign partselect_wrapper_in_flat[5] = in_flat[231];
assign partselect_wrapper_in_flat[6] = in_flat[232];
...
assign partselect_wrapper_in_flat[16] = in_flat[240];
assign partselect_wrapper_in_flat[17] = in_flat[241];
assign width_enum_wrapper_in_flat[2] = in_flat[242];
assign width_enum_wrapper_in_flat[3] = in_flat[243];
...
assign width_logic_wrapper_in_flat[1] = in_flat[265];
assign width_logic_wrapper_in_flat[3] = in_flat[266];
assign width_logic_wrapper_in_flat[5] = in_flat[267];
assign width_logic_wrapper_in_flat[6] = in_flat[268];
assign width_logic_wrapper_in_flat[7] = in_flat[269];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[270];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[271];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[272];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[273];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[274];

// Internal MTM connections (module-to-module)
assign const_partselect_wrapper_in_flat[17] = const_arith_wrapper_out_flat[10];
assign array_wrapper_in_flat[14] = const_arith_wrapper_out_flat[11];
assign arithmetic_reduce_wrapper_in_flat[3] = const_arith_wrapper_out_flat[12];
assign bitwise_logic_wrapper_in_flat[14] = const_arith_wrapper_out_flat[17];
assign shift_wrapper_in_flat[3] = const_arith_wrapper_out_flat[30];
assign select_wrapper_in_flat[10] = const_arith_wrapper_out_flat[33];
assign bitwise_reduce_wrapper_in_flat[3] = const_arith_wrapper_out_flat[33];
assign width_union_wrapper_in_flat[4] = const_arith_wrapper_out_flat[34];
assign const_nested_wrapper_in_flat[4] = const_arith_wrapper_out_flat[36];
assign numbers_concat_repl_wrapper_in_flat[4] = const_arith_wrapper_out_flat[37];
assign width_logic_wrapper_in_flat[2] = const_compare_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[11];
assign select_wrapper_in_flat[19] = const_concat_repl_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[20];
assign bitwise_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[14];
assign relational_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[21];
assign width_enum_wrapper_in_flat[1] = const_logic_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[13] = const_logic_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[4] = const_logic_wrapper_out_flat[14];
assign select_wrapper_in_flat[11] = const_nested_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[9] = const_reduce_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[8] = const_shift_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[13] = arithmetic_reduce_wrapper_out_flat[9];
assign array_wrapper_in_flat[12] = arithmetic_reduce_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[18] = bitwise_logic_wrapper_out_flat[12];
assign width_union_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[16];
assign relational_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[20];
assign partselect_wrapper_in_flat[15] = bitwise_reduce_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[0] = relational_wrapper_out_flat[6];
assign shift_wrapper_in_flat[1] = relational_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[4] = select_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[6] = shift_wrapper_out_flat[11];
assign const_shift_wrapper_in_flat[8] = array_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[18] = array_wrapper_out_flat[1];
assign shift_wrapper_in_flat[10] = array_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[6] = array_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[0] = array_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[3] = array_wrapper_out_flat[15];
assign const_concat_repl_wrapper_in_flat[0] = cast_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[14] = cast_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[5] = cast_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[12] = cast_wrapper_out_flat[8];
...
assign bitwise_reduce_wrapper_in_flat[4] = width_enum_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[1] = width_enum_wrapper_out_flat[3];
assign select_wrapper_in_flat[6] = width_struct_wrapper_out_flat[11];
assign array_wrapper_in_flat[2] = width_union_wrapper_out_flat[3];
assign shift_wrapper_in_flat[9] = width_union_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[13] = width_union_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[8] = width_union_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[9] = width_union_wrapper_out_flat[11];
assign logical_op_wrapper_in_flat[0] = width_logic_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[18] = width_logic_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[12] = numbers_concat_repl_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[13];
