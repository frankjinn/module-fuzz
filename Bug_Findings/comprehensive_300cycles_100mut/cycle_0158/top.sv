...
assign select_wrapper_in_flat[0] = in_flat[156];
...
assign select_wrapper_in_flat[6] = in_flat[160];
assign select_wrapper_in_flat[7] = in_flat[161];
...
assign select_wrapper_in_flat[15] = in_flat[167];
assign select_wrapper_in_flat[16] = in_flat[168];
...
assign shift_wrapper_in_flat[5] = in_flat[176];
assign shift_wrapper_in_flat[7] = in_flat[177];
assign shift_wrapper_in_flat[8] = in_flat[178];
assign shift_wrapper_in_flat[9] = in_flat[179];
assign shift_wrapper_in_flat[10] = in_flat[180];
assign array_wrapper_in_flat[0] = in_flat[181];
...
assign conditional_wrapper_in_flat[0] = in_flat[204];
assign conditional_wrapper_in_flat[1] = in_flat[205];
assign conditional_wrapper_in_flat[4] = in_flat[206];
assign conditional_wrapper_in_flat[5] = in_flat[207];
...
assign const_nested_wrapper_in_flat[14] = const_arith_wrapper_out_flat[2];
assign select_wrapper_in_flat[13] = const_arith_wrapper_out_flat[8];
assign const_concat_repl_wrapper_in_flat[9] = const_arith_wrapper_out_flat[24];
assign arithmetic_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[28];
assign const_shift_wrapper_in_flat[10] = const_arith_wrapper_out_flat[28];
assign bitwise_reduce_wrapper_in_flat[6] = const_arith_wrapper_out_flat[33];
assign partselect_wrapper_in_flat[1] = const_arith_wrapper_out_flat[34];
assign width_struct_wrapper_in_flat[7] = const_arith_wrapper_out_flat[37];
assign numbers_concat_repl_wrapper_in_flat[1] = const_compare_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[14] = const_concat_repl_wrapper_out_flat[6];
...
assign const_partselect_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[20];
assign const_partselect_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[9];
assign bitwise_reduce_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[22];
assign cast_wrapper_in_flat[9] = const_logic_wrapper_out_flat[1];
assign array_wrapper_in_flat[4] = const_logic_wrapper_out_flat[5];
assign shift_wrapper_in_flat[6] = const_logic_wrapper_out_flat[17];
assign const_conditional_wrapper_in_flat[18] = const_logic_wrapper_out_flat[18];
assign partselect_wrapper_in_flat[13] = const_nested_wrapper_out_flat[5];
assign select_wrapper_in_flat[1] = const_nested_wrapper_out_flat[6];
assign relational_wrapper_in_flat[4] = const_nested_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[9] = const_reduce_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[4] = const_shift_wrapper_out_flat[2];
assign relational_wrapper_in_flat[7] = const_shift_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[22] = arithmetic_reduce_wrapper_out_flat[7];
assign logical_op_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[11];
assign relational_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[14];
assign select_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[16];
assign arithmetic_reduce_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[18];
assign numbers_concat_repl_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[19];
assign const_partselect_wrapper_in_flat[13] = bitwise_reduce_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[5] = logical_op_wrapper_out_flat[1];
assign select_wrapper_in_flat[5] = relational_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[21] = relational_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[2] = relational_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[12] = select_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[4] = select_wrapper_out_flat[4];
assign cast_wrapper_in_flat[5] = shift_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[7] = shift_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[0] = shift_wrapper_out_flat[12];
assign array_wrapper_in_flat[16] = shift_wrapper_out_flat[14];
assign width_enum_wrapper_in_flat[1] = array_wrapper_out_flat[0];
assign select_wrapper_in_flat[17] = array_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[3] = array_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[6] = array_wrapper_out_flat[8];
assign bitwise_logic_wrapper_in_flat[5] = array_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[1] = array_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[5] = array_wrapper_out_flat[11];
assign cast_wrapper_in_flat[1] = array_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[2] = array_wrapper_out_flat[11];
assign const_arith_wrapper_in_flat[0] = array_wrapper_out_flat[13];
assign const_shift_wrapper_in_flat[0] = cast_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[2] = cast_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[7] = conditional_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[4] = conditional_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[3] = conditional_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[7] = conditional_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[3] = conditional_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[4] = partselect_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[6] = width_enum_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[8] = width_enum_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[9] = width_enum_wrapper_out_flat[0];
assign relational_wrapper_in_flat[2] = width_enum_wrapper_out_flat[2];
assign cast_wrapper_in_flat[7] = width_enum_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[19] = width_enum_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[10] = width_struct_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[2] = width_struct_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[0] = width_union_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[5] = width_logic_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[18] = width_logic_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[14];
assign cast_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[16];
