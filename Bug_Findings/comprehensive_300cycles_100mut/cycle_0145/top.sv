...
assign logical_op_wrapper_in_flat[0] = in_flat[157];
...
assign width_enum_wrapper_in_flat[0] = const_arith_wrapper_out_flat[23];
assign conditional_wrapper_in_flat[2] = const_arith_wrapper_out_flat[24];
assign const_shift_wrapper_in_flat[10] = const_arith_wrapper_out_flat[32];
assign array_wrapper_in_flat[4] = const_arith_wrapper_out_flat[33];
assign const_nested_wrapper_in_flat[14] = const_arith_wrapper_out_flat[38];
assign select_wrapper_in_flat[4] = const_compare_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[9] = const_compare_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[4] = const_compare_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[12];
assign width_logic_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[14];
assign width_union_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[25] = const_conditional_wrapper_out_flat[21];
assign bitwise_logic_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[22];
assign partselect_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[22];
assign width_struct_wrapper_in_flat[4] = const_logic_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[4] = const_logic_wrapper_out_flat[7];
assign select_wrapper_in_flat[5] = const_logic_wrapper_out_flat[17];
assign cast_wrapper_in_flat[9] = const_logic_wrapper_out_flat[18];
assign select_wrapper_in_flat[18] = const_nested_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[1] = const_nested_wrapper_out_flat[7];
assign shift_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[4];
assign cast_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[5];
assign relational_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[1];
assign cast_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[1];
assign select_wrapper_in_flat[19] = const_reduce_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[1] = const_shift_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[7] = const_shift_wrapper_out_flat[17];
assign width_logic_wrapper_in_flat[2] = const_shift_wrapper_out_flat[23];
assign bitwise_logic_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[10] = arithmetic_reduce_wrapper_out_flat[2];
assign relational_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[28] = arithmetic_reduce_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[15] = arithmetic_reduce_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[18] = arithmetic_reduce_wrapper_out_flat[8];
assign const_shift_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[3];
...
assign width_struct_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[13];
assign const_logic_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[22] = bitwise_logic_wrapper_out_flat[15];
assign width_enum_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[19];
assign width_union_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[19];
assign shift_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[6] = logical_op_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[3] = relational_wrapper_out_flat[4];
assign array_wrapper_in_flat[10] = select_wrapper_out_flat[3];
assign cast_wrapper_in_flat[10] = select_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[4] = shift_wrapper_out_flat[9];
assign cast_wrapper_in_flat[11] = array_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[9] = array_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[0] = array_wrapper_out_flat[7];
...
assign relational_wrapper_in_flat[5] = cast_wrapper_out_flat[10];
assign shift_wrapper_in_flat[0] = cast_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[2] = conditional_wrapper_out_flat[0];
assign select_wrapper_in_flat[14] = conditional_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[6] = conditional_wrapper_out_flat[2];
assign array_wrapper_in_flat[15] = conditional_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[6] = partselect_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[15] = partselect_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[8] = width_enum_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[6] = width_enum_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[1] = width_enum_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[0] = width_struct_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[3] = width_struct_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[14] = width_struct_wrapper_out_flat[11];
assign const_shift_wrapper_in_flat[5] = width_union_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[5] = width_union_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[3] = width_union_wrapper_out_flat[9];
assign shift_wrapper_in_flat[3] = width_logic_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[19] = width_logic_wrapper_out_flat[5];
