...
assign adder_wrapper_in_flat[3] = in_flat[1];
assign subtractor_wrapper_in_flat[0] = in_flat[2];
assign subtractor_wrapper_in_flat[2] = in_flat[3];
assign subtractor_wrapper_in_flat[3] = in_flat[4];
...
assign subtractor_wrapper_in_flat[1] = adder_wrapper_out_flat[2];
assign adder_wrapper_in_flat[1] = subtractor_wrapper_out_reg[1];
assign adder_wrapper_in_flat[2] = multiplier_wrapper_out_flat[4];
...
assign out_flat[3] = subtractor_wrapper_out_reg[0];
assign out_flat[4] = subtractor_wrapper_out_reg[1];
assign out_flat[5] = subtractor_wrapper_out_reg[2];
assign out_flat[6] = multiplier_wrapper_out_flat[0];
assign out_flat[7] = multiplier_wrapper_out_flat[1];
assign out_flat[8] = multiplier_wrapper_out_flat[2];
assign out_flat[9] = multiplier_wrapper_out_flat[3];
assign out_flat[10] = multiplier_wrapper_out_flat[4];
