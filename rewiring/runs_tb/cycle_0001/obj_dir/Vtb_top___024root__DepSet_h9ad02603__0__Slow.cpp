...
VL_ATTR_COLD void Vtb_top___024root___ctor_var_reset(Vtb_top___024root* vlSelf) {
    ...
    vlSelf->tb_top__DOT__in_flat = VL_SCOPED_RAND_RESET_I(9, __VscopeHash, 1463764839160097536ull);
    ...
    vlSelf->tb_top__DOT__dut__DOT__subtractor_wrapper_out_reg = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 17709971478320304865ull);
    vlSelf->tb_top__DOT__dut__DOT__u_adder_wrapper__DOT__b = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 13044941749760718782ull);
