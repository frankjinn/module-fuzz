...
assign subtractor_wrapper_in_flat[0] = in_flat[7];
assign subtractor_wrapper_in_flat[1] = in_flat[8];
assign subtractor_wrapper_in_flat[3] = in_flat[9];

// Internal MTM connections (module-to-module)
assign subtractor_wrapper_in_flat[2] = adder_wrapper_out_flat[2];
assign multiplier_wrapper_in_flat[1] = subtractor_wrapper_out_flat[2];
