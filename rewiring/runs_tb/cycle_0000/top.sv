...
assign multiplier_wrapper_in_flat[0] = in_flat[6];
assign multiplier_wrapper_in_flat[3] = in_flat[7];

// Internal MTM connections (module-to-module)
assign multiplier_wrapper_in_flat[1] = adder_wrapper_out_flat[0];
assign subtractor_wrapper_in_flat[3] = adder_wrapper_out_flat[1];
assign multiplier_wrapper_in_flat[2] = subtractor_wrapper_out_flat[1];
assign adder_wrapper_in_flat[0] = multiplier_wrapper_out_reg[0];
