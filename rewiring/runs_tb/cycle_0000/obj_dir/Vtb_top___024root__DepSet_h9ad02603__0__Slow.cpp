...
#endif
            VL_FATAL_MT("/module-fuzz/rewiring/runs_tb/cycle_0000/tb_top.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb_top___024root___ctor_var_reset(Vtb_top___024root* vlSelf) {
    ...
    vlSelf->tb_top__DOT__in_flat = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 1463764839160097536ull);
    vlSelf->tb_top__DOT__out_flat = VL_SCOPED_RAND_RESET_I(11, __VscopeHash, 5570966996200448825ull);
    ...
    vlSelf->tb_top__DOT__dut__DOT__multiplier_wrapper_out_reg = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 705227285972650257ull);
    vlSelf->tb_top__DOT__dut__DOT__u_adder_wrapper__DOT__data_out = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 550894371902389811ull);
    vlSelf->tb_top__DOT__dut__DOT__u_multiplier_wrapper__DOT__b = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 5636436195926973980ull);
    vlSelf->tb_top__DOT__dut__DOT__u_subtractor_wrapper__DOT__data_out = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 333981145065271679ull);
