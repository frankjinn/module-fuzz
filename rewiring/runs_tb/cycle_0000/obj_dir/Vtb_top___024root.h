...
class alignas(VL_CACHE_LINE_BYTES) Vtb_top___024root final : public VerilatedModule {
  public:
    ...
    CData/*7:0*/ tb_top__DOT__in_flat;
    CData/*4:0*/ tb_top__DOT__dut__DOT__multiplier_wrapper_out_reg;
    CData/*2:0*/ tb_top__DOT__dut__DOT__u_adder_wrapper__DOT__data_out;
    CData/*1:0*/ tb_top__DOT__dut__DOT__u_multiplier_wrapper__DOT__b;
