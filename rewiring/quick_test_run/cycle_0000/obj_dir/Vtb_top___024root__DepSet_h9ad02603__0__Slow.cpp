...
#endif
            VL_FATAL_MT("/opt/module-fuzz/rewiring/quick_test_run/cycle_0000/tb_top.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb_top___024root___ctor_var_reset(Vtb_top___024root* vlSelf) {
    ...
    VL_SCOPED_RAND_RESET_W(153, vlSelf->tb_top__DOT__in_flat, __VscopeHash, 1463764839160097536ull);
