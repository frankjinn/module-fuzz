...
assign const_logic_wrapper_in_flat[1] = const_arith_wrapper_out_flat[11];
assign const_concat_repl_wrapper_in_flat[3] = const_arith_wrapper_out_flat[25];
assign const_shift_wrapper_in_flat[5] = const_arith_wrapper_out_flat[29];
assign const_nested_wrapper_in_flat[22] = const_arith_wrapper_out_flat[36];
assign const_nested_wrapper_in_flat[23] = const_compare_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[9];
assign const_arith_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[19];
assign const_compare_wrapper_in_flat[2] = const_logic_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[1] = const_logic_wrapper_out_flat[7];
...
assign const_partselect_wrapper_in_flat[19] = const_reduce_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[6] = const_shift_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[3] = const_shift_wrapper_out_flat[21];
