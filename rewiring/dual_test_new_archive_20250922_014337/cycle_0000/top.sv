...
assign const_logic_wrapper_in_flat[2] = in_flat[80];
assign const_logic_wrapper_in_flat[3] = in_flat[81];
assign const_logic_wrapper_in_flat[4] = in_flat[82];
assign const_logic_wrapper_in_flat[5] = in_flat[83];
assign const_logic_wrapper_in_flat[6] = in_flat[84];
assign const_logic_wrapper_in_flat[7] = in_flat[85];
assign const_logic_wrapper_in_flat[8] = in_flat[86];
assign const_logic_wrapper_in_flat[9] = in_flat[87];
assign const_nested_wrapper_in_flat[0] = in_flat[88];
assign const_nested_wrapper_in_flat[1] = in_flat[89];
assign const_nested_wrapper_in_flat[3] = in_flat[90];
assign const_nested_wrapper_in_flat[4] = in_flat[91];
assign const_nested_wrapper_in_flat[5] = in_flat[92];
assign const_nested_wrapper_in_flat[6] = in_flat[93];
assign const_nested_wrapper_in_flat[7] = in_flat[94];
assign const_nested_wrapper_in_flat[8] = in_flat[95];
assign const_nested_wrapper_in_flat[9] = in_flat[96];
assign const_nested_wrapper_in_flat[10] = in_flat[97];
assign const_nested_wrapper_in_flat[11] = in_flat[98];
assign const_nested_wrapper_in_flat[12] = in_flat[99];
assign const_nested_wrapper_in_flat[13] = in_flat[100];
assign const_nested_wrapper_in_flat[14] = in_flat[101];
assign const_nested_wrapper_in_flat[15] = in_flat[102];
assign const_nested_wrapper_in_flat[16] = in_flat[103];
assign const_nested_wrapper_in_flat[17] = in_flat[104];
assign const_nested_wrapper_in_flat[18] = in_flat[105];
assign const_nested_wrapper_in_flat[19] = in_flat[106];
assign const_nested_wrapper_in_flat[20] = in_flat[107];
assign const_nested_wrapper_in_flat[21] = in_flat[108];
assign const_nested_wrapper_in_flat[23] = in_flat[109];
assign const_nested_wrapper_in_flat[24] = in_flat[110];
assign const_nested_wrapper_in_flat[25] = in_flat[111];
assign const_nested_wrapper_in_flat[26] = in_flat[112];
assign const_partselect_wrapper_in_flat[0] = in_flat[113];
assign const_partselect_wrapper_in_flat[1] = in_flat[114];
assign const_partselect_wrapper_in_flat[2] = in_flat[115];
assign const_partselect_wrapper_in_flat[3] = in_flat[116];
assign const_partselect_wrapper_in_flat[4] = in_flat[117];
assign const_partselect_wrapper_in_flat[5] = in_flat[118];
assign const_partselect_wrapper_in_flat[7] = in_flat[119];
assign const_partselect_wrapper_in_flat[8] = in_flat[120];
assign const_partselect_wrapper_in_flat[9] = in_flat[121];
assign const_partselect_wrapper_in_flat[10] = in_flat[122];
assign const_partselect_wrapper_in_flat[11] = in_flat[123];
assign const_partselect_wrapper_in_flat[13] = in_flat[124];
assign const_partselect_wrapper_in_flat[15] = in_flat[125];
assign const_partselect_wrapper_in_flat[16] = in_flat[126];
assign const_partselect_wrapper_in_flat[17] = in_flat[127];
assign const_partselect_wrapper_in_flat[18] = in_flat[128];
assign const_reduce_wrapper_in_flat[3] = in_flat[129];
assign const_shift_wrapper_in_flat[0] = in_flat[130];
assign const_shift_wrapper_in_flat[1] = in_flat[131];
assign const_shift_wrapper_in_flat[2] = in_flat[132];
assign const_shift_wrapper_in_flat[3] = in_flat[133];
assign const_shift_wrapper_in_flat[4] = in_flat[134];
assign const_shift_wrapper_in_flat[5] = in_flat[135];
assign const_shift_wrapper_in_flat[7] = in_flat[136];
assign const_shift_wrapper_in_flat[9] = in_flat[137];
assign const_shift_wrapper_in_flat[10] = in_flat[138];

// Internal MTM connections (module-to-module)
assign const_partselect_wrapper_in_flat[12] = const_arith_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[22] = const_arith_wrapper_out_flat[14];
assign const_arith_wrapper_in_flat[0] = const_compare_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[14] = const_concat_repl_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[20] = const_concat_repl_wrapper_out_flat[16];
assign const_reduce_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[17];
assign const_arith_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[21];
assign const_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[6] = const_logic_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[9] = const_logic_wrapper_out_flat[6];
...
assign const_reduce_wrapper_in_flat[1] = const_nested_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[8] = const_nested_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[4] = const_shift_wrapper_out_flat[23];
