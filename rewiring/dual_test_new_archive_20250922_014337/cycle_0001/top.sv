...
assign const_compare_wrapper_in_flat[23] = const_arith_wrapper_out_flat[32];
assign const_shift_wrapper_in_flat[10] = const_arith_wrapper_out_flat[38];
assign const_nested_wrapper_in_flat[18] = const_compare_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[20] = const_compare_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[9] = const_compare_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[15];
...
assign const_concat_repl_wrapper_in_flat[9] = const_logic_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[1] = const_nested_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[6] = const_shift_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[15] = const_shift_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[6] = const_shift_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[13] = const_shift_wrapper_out_flat[9];
