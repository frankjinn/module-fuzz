...
assign const_partselect_wrapper_in_flat[8] = const_arith_wrapper_out_flat[14];
assign const_nested_wrapper_in_flat[17] = const_arith_wrapper_out_flat[17];
assign const_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[27];
assign const_compare_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[24] = const_logic_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[2] = const_logic_wrapper_out_flat[14];
...
assign const_conditional_wrapper_in_flat[30] = const_reduce_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[32] = const_shift_wrapper_out_flat[23];
assign const_reduce_wrapper_in_flat[3] = const_shift_wrapper_out_flat[23];
