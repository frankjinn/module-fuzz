...
assign const_logic_wrapper_in_flat[9] = in_flat[88];
assign const_nested_wrapper_in_flat[0] = in_flat[89];
assign const_nested_wrapper_in_flat[1] = in_flat[90];
assign const_nested_wrapper_in_flat[2] = in_flat[91];
assign const_nested_wrapper_in_flat[3] = in_flat[92];
assign const_nested_wrapper_in_flat[4] = in_flat[93];
...
assign const_reduce_wrapper_in_flat[1] = in_flat[137];
assign const_reduce_wrapper_in_flat[2] = in_flat[138];
assign const_reduce_wrapper_in_flat[3] = in_flat[139];
...
assign arithmetic_reduce_wrapper_in_flat[7] = in_flat[158];
assign arithmetic_reduce_wrapper_in_flat[8] = in_flat[159];
assign arithmetic_reduce_wrapper_in_flat[9] = in_flat[160];
assign arithmetic_reduce_wrapper_in_flat[10] = in_flat[161];
assign arithmetic_reduce_wrapper_in_flat[11] = in_flat[162];
assign arithmetic_reduce_wrapper_in_flat[12] = in_flat[163];
assign arithmetic_reduce_wrapper_in_flat[13] = in_flat[164];
assign arithmetic_reduce_wrapper_in_flat[14] = in_flat[165];
assign arithmetic_reduce_wrapper_in_flat[15] = in_flat[166];
assign bitwise_logic_wrapper_in_flat[0] = in_flat[167];
assign bitwise_logic_wrapper_in_flat[1] = in_flat[168];
assign bitwise_logic_wrapper_in_flat[2] = in_flat[169];
assign bitwise_logic_wrapper_in_flat[3] = in_flat[170];
assign bitwise_logic_wrapper_in_flat[4] = in_flat[171];
assign bitwise_logic_wrapper_in_flat[5] = in_flat[172];
assign bitwise_logic_wrapper_in_flat[6] = in_flat[173];
assign bitwise_logic_wrapper_in_flat[7] = in_flat[174];
assign bitwise_logic_wrapper_in_flat[8] = in_flat[175];
assign bitwise_logic_wrapper_in_flat[9] = in_flat[176];
assign bitwise_logic_wrapper_in_flat[10] = in_flat[177];
assign bitwise_logic_wrapper_in_flat[11] = in_flat[178];
assign bitwise_logic_wrapper_in_flat[12] = in_flat[179];
assign bitwise_logic_wrapper_in_flat[13] = in_flat[180];
assign bitwise_logic_wrapper_in_flat[14] = in_flat[181];
assign bitwise_logic_wrapper_in_flat[15] = in_flat[182];
assign bitwise_reduce_wrapper_in_flat[0] = in_flat[183];
assign bitwise_reduce_wrapper_in_flat[1] = in_flat[184];
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[185];
assign bitwise_reduce_wrapper_in_flat[3] = in_flat[186];
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[187];
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[188];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[189];
assign logical_op_wrapper_in_flat[0] = in_flat[190];
assign logical_op_wrapper_in_flat[1] = in_flat[191];
assign relational_wrapper_in_flat[0] = in_flat[192];
assign relational_wrapper_in_flat[1] = in_flat[193];
assign relational_wrapper_in_flat[2] = in_flat[194];
assign relational_wrapper_in_flat[3] = in_flat[195];
assign relational_wrapper_in_flat[4] = in_flat[196];
assign relational_wrapper_in_flat[5] = in_flat[197];
...
assign select_wrapper_in_flat[19] = in_flat[217];
assign shift_wrapper_in_flat[0] = in_flat[218];
assign shift_wrapper_in_flat[1] = in_flat[219];
assign shift_wrapper_in_flat[2] = in_flat[220];
assign shift_wrapper_in_flat[4] = in_flat[221];
assign shift_wrapper_in_flat[5] = in_flat[222];
assign shift_wrapper_in_flat[6] = in_flat[223];
assign shift_wrapper_in_flat[7] = in_flat[224];
assign shift_wrapper_in_flat[8] = in_flat[225];
assign shift_wrapper_in_flat[9] = in_flat[226];
assign shift_wrapper_in_flat[10] = in_flat[227];
assign array_wrapper_in_flat[0] = in_flat[228];
assign array_wrapper_in_flat[1] = in_flat[229];
assign array_wrapper_in_flat[2] = in_flat[230];
assign array_wrapper_in_flat[3] = in_flat[231];
assign array_wrapper_in_flat[4] = in_flat[232];
assign array_wrapper_in_flat[5] = in_flat[233];
assign array_wrapper_in_flat[6] = in_flat[234];
assign array_wrapper_in_flat[7] = in_flat[235];
...
assign array_wrapper_in_flat[12] = in_flat[239];
assign array_wrapper_in_flat[13] = in_flat[240];
assign array_wrapper_in_flat[14] = in_flat[241];
assign array_wrapper_in_flat[15] = in_flat[242];
assign array_wrapper_in_flat[16] = in_flat[243];
assign array_wrapper_in_flat[17] = in_flat[244];
assign cast_wrapper_in_flat[0] = in_flat[245];
assign cast_wrapper_in_flat[1] = in_flat[246];
assign cast_wrapper_in_flat[2] = in_flat[247];
assign cast_wrapper_in_flat[3] = in_flat[248];
assign cast_wrapper_in_flat[4] = in_flat[249];
assign cast_wrapper_in_flat[5] = in_flat[250];
assign cast_wrapper_in_flat[6] = in_flat[251];
assign cast_wrapper_in_flat[7] = in_flat[252];
assign cast_wrapper_in_flat[8] = in_flat[253];
assign cast_wrapper_in_flat[9] = in_flat[254];
assign cast_wrapper_in_flat[10] = in_flat[255];
assign cast_wrapper_in_flat[11] = in_flat[256];
assign conditional_wrapper_in_flat[0] = in_flat[257];
assign conditional_wrapper_in_flat[1] = in_flat[258];
assign conditional_wrapper_in_flat[2] = in_flat[259];
assign conditional_wrapper_in_flat[3] = in_flat[260];
assign conditional_wrapper_in_flat[4] = in_flat[261];
assign conditional_wrapper_in_flat[5] = in_flat[262];
assign conditional_wrapper_in_flat[7] = in_flat[263];
...
assign partselect_wrapper_in_flat[8] = in_flat[272];
assign partselect_wrapper_in_flat[9] = in_flat[273];
assign partselect_wrapper_in_flat[10] = in_flat[274];
assign partselect_wrapper_in_flat[11] = in_flat[275];
assign partselect_wrapper_in_flat[12] = in_flat[276];
assign partselect_wrapper_in_flat[13] = in_flat[277];
assign partselect_wrapper_in_flat[14] = in_flat[278];
assign partselect_wrapper_in_flat[15] = in_flat[279];
assign partselect_wrapper_in_flat[16] = in_flat[280];
assign partselect_wrapper_in_flat[17] = in_flat[281];
assign partselect_wrapper_in_flat[18] = in_flat[282];
assign width_enum_wrapper_in_flat[0] = in_flat[283];
assign width_enum_wrapper_in_flat[1] = in_flat[284];
assign width_enum_wrapper_in_flat[2] = in_flat[285];
assign width_enum_wrapper_in_flat[3] = in_flat[286];
assign width_struct_wrapper_in_flat[0] = in_flat[287];
assign width_struct_wrapper_in_flat[1] = in_flat[288];
assign width_struct_wrapper_in_flat[2] = in_flat[289];
assign width_struct_wrapper_in_flat[3] = in_flat[290];
assign width_struct_wrapper_in_flat[4] = in_flat[291];
assign width_struct_wrapper_in_flat[5] = in_flat[292];
assign width_struct_wrapper_in_flat[6] = in_flat[293];
assign width_struct_wrapper_in_flat[7] = in_flat[294];
assign width_struct_wrapper_in_flat[8] = in_flat[295];
assign width_struct_wrapper_in_flat[9] = in_flat[296];
assign width_struct_wrapper_in_flat[10] = in_flat[297];
assign width_struct_wrapper_in_flat[11] = in_flat[298];
assign width_union_wrapper_in_flat[0] = in_flat[299];
assign width_union_wrapper_in_flat[1] = in_flat[300];
assign width_union_wrapper_in_flat[2] = in_flat[301];
assign width_union_wrapper_in_flat[3] = in_flat[302];
assign width_union_wrapper_in_flat[4] = in_flat[303];
assign width_union_wrapper_in_flat[5] = in_flat[304];
assign width_union_wrapper_in_flat[6] = in_flat[305];
assign width_union_wrapper_in_flat[7] = in_flat[306];
assign width_union_wrapper_in_flat[8] = in_flat[307];
assign width_union_wrapper_in_flat[9] = in_flat[308];
assign width_union_wrapper_in_flat[10] = in_flat[309];
assign width_union_wrapper_in_flat[11] = in_flat[310];
assign width_union_wrapper_in_flat[12] = in_flat[311];
assign width_union_wrapper_in_flat[13] = in_flat[312];
assign width_union_wrapper_in_flat[14] = in_flat[313];
assign width_union_wrapper_in_flat[15] = in_flat[314];
assign width_logic_wrapper_in_flat[2] = in_flat[315];
...
assign partselect_wrapper_in_flat[7] = const_compare_wrapper_out_flat[1];
assign shift_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[14];
assign relational_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[17];
assign array_wrapper_in_flat[11] = const_logic_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[2];
assign select_wrapper_in_flat[12] = logical_op_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[1] = shift_wrapper_out_flat[13];
assign const_concat_repl_wrapper_in_flat[8] = array_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[6] = array_wrapper_out_flat[12];
assign width_logic_wrapper_in_flat[0] = conditional_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[8] = width_struct_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[1] = width_union_wrapper_out_flat[15];
