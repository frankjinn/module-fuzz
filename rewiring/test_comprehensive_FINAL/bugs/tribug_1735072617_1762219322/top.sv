...
assign arithmetic_reduce_wrapper_in_flat[2] = in_flat[156];
assign arithmetic_reduce_wrapper_in_flat[3] = in_flat[157];
assign arithmetic_reduce_wrapper_in_flat[4] = in_flat[158];
assign arithmetic_reduce_wrapper_in_flat[5] = in_flat[159];
assign arithmetic_reduce_wrapper_in_flat[6] = in_flat[160];
assign arithmetic_reduce_wrapper_in_flat[7] = in_flat[161];
assign arithmetic_reduce_wrapper_in_flat[8] = in_flat[162];
assign arithmetic_reduce_wrapper_in_flat[9] = in_flat[163];
assign arithmetic_reduce_wrapper_in_flat[10] = in_flat[164];
assign arithmetic_reduce_wrapper_in_flat[11] = in_flat[165];
assign arithmetic_reduce_wrapper_in_flat[12] = in_flat[166];
assign arithmetic_reduce_wrapper_in_flat[13] = in_flat[167];
assign arithmetic_reduce_wrapper_in_flat[14] = in_flat[168];
assign arithmetic_reduce_wrapper_in_flat[15] = in_flat[169];
assign bitwise_logic_wrapper_in_flat[0] = in_flat[170];
assign bitwise_logic_wrapper_in_flat[1] = in_flat[171];
assign bitwise_logic_wrapper_in_flat[2] = in_flat[172];
assign bitwise_logic_wrapper_in_flat[3] = in_flat[173];
assign bitwise_logic_wrapper_in_flat[4] = in_flat[174];
assign bitwise_logic_wrapper_in_flat[5] = in_flat[175];
assign bitwise_logic_wrapper_in_flat[6] = in_flat[176];
assign bitwise_logic_wrapper_in_flat[7] = in_flat[177];
assign bitwise_logic_wrapper_in_flat[8] = in_flat[178];
...
assign select_wrapper_in_flat[3] = in_flat[200];
assign select_wrapper_in_flat[4] = in_flat[201];
assign select_wrapper_in_flat[5] = in_flat[202];
assign select_wrapper_in_flat[6] = in_flat[203];
...
assign select_wrapper_in_flat[15] = in_flat[212];
...
assign array_wrapper_in_flat[7] = in_flat[234];
assign array_wrapper_in_flat[8] = in_flat[235];
assign array_wrapper_in_flat[9] = in_flat[236];
assign array_wrapper_in_flat[10] = in_flat[237];
assign array_wrapper_in_flat[11] = in_flat[238];
...
assign conditional_wrapper_in_flat[6] = in_flat[263];
assign conditional_wrapper_in_flat[7] = in_flat[264];
assign conditional_wrapper_in_flat[8] = in_flat[265];
assign partselect_wrapper_in_flat[0] = in_flat[266];
...
assign width_logic_wrapper_in_flat[3] = in_flat[315];
assign width_logic_wrapper_in_flat[4] = in_flat[316];
assign width_logic_wrapper_in_flat[5] = in_flat[317];
assign width_logic_wrapper_in_flat[6] = in_flat[318];
assign width_logic_wrapper_in_flat[7] = in_flat[319];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[320];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[321];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[322];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[323];
...
assign relational_wrapper_in_flat[5] = const_arith_wrapper_out_flat[30];
assign const_arith_wrapper_in_flat[8] = const_compare_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[11];
assign width_struct_wrapper_in_flat[6] = const_logic_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[0] = const_shift_wrapper_out_flat[22];
assign array_wrapper_in_flat[6] = shift_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[15] = shift_wrapper_out_flat[12];
assign bitwise_reduce_wrapper_in_flat[4] = shift_wrapper_out_flat[14];
assign width_logic_wrapper_in_flat[2] = cast_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[9] = partselect_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[1] = partselect_wrapper_out_flat[7];
assign logical_op_wrapper_in_flat[0] = width_enum_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[5] = width_struct_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[13];
