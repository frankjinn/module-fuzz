...
assign const_partselect_wrapper_in_flat[12] = in_flat[133];
assign const_partselect_wrapper_in_flat[13] = in_flat[134];
assign const_partselect_wrapper_in_flat[14] = in_flat[135];
assign const_partselect_wrapper_in_flat[15] = in_flat[136];
assign const_partselect_wrapper_in_flat[16] = in_flat[137];
assign const_partselect_wrapper_in_flat[17] = in_flat[138];
assign const_partselect_wrapper_in_flat[18] = in_flat[139];
assign const_partselect_wrapper_in_flat[19] = in_flat[140];
assign const_reduce_wrapper_in_flat[0] = in_flat[141];
...
assign const_shift_wrapper_in_flat[9] = in_flat[152];
assign const_shift_wrapper_in_flat[10] = in_flat[153];
assign arithmetic_reduce_wrapper_in_flat[0] = in_flat[154];
assign arithmetic_reduce_wrapper_in_flat[1] = in_flat[155];
...
assign logical_op_wrapper_in_flat[0] = in_flat[192];
assign relational_wrapper_in_flat[0] = in_flat[193];
assign relational_wrapper_in_flat[1] = in_flat[194];
assign relational_wrapper_in_flat[2] = in_flat[195];
assign relational_wrapper_in_flat[3] = in_flat[196];
assign relational_wrapper_in_flat[4] = in_flat[197];
assign relational_wrapper_in_flat[7] = in_flat[198];
assign select_wrapper_in_flat[0] = in_flat[199];
assign select_wrapper_in_flat[1] = in_flat[200];
assign select_wrapper_in_flat[2] = in_flat[201];
assign select_wrapper_in_flat[3] = in_flat[202];
assign select_wrapper_in_flat[4] = in_flat[203];
...
assign select_wrapper_in_flat[9] = in_flat[208];
assign select_wrapper_in_flat[10] = in_flat[209];
assign select_wrapper_in_flat[11] = in_flat[210];
...
assign array_wrapper_in_flat[0] = in_flat[229];
assign array_wrapper_in_flat[1] = in_flat[230];
assign array_wrapper_in_flat[2] = in_flat[231];
assign array_wrapper_in_flat[3] = in_flat[232];
assign array_wrapper_in_flat[4] = in_flat[233];
assign array_wrapper_in_flat[5] = in_flat[234];
assign array_wrapper_in_flat[6] = in_flat[235];
assign array_wrapper_in_flat[8] = in_flat[236];
assign array_wrapper_in_flat[9] = in_flat[237];
assign array_wrapper_in_flat[10] = in_flat[238];
assign array_wrapper_in_flat[11] = in_flat[239];
assign array_wrapper_in_flat[12] = in_flat[240];
assign array_wrapper_in_flat[13] = in_flat[241];
assign array_wrapper_in_flat[14] = in_flat[242];
assign array_wrapper_in_flat[15] = in_flat[243];
assign array_wrapper_in_flat[16] = in_flat[244];
assign array_wrapper_in_flat[17] = in_flat[245];
assign cast_wrapper_in_flat[0] = in_flat[246];
assign cast_wrapper_in_flat[1] = in_flat[247];
assign cast_wrapper_in_flat[2] = in_flat[248];
assign cast_wrapper_in_flat[3] = in_flat[249];
assign cast_wrapper_in_flat[4] = in_flat[250];
assign cast_wrapper_in_flat[5] = in_flat[251];
assign cast_wrapper_in_flat[6] = in_flat[252];
assign cast_wrapper_in_flat[7] = in_flat[253];
assign cast_wrapper_in_flat[8] = in_flat[254];
assign cast_wrapper_in_flat[9] = in_flat[255];
assign cast_wrapper_in_flat[10] = in_flat[256];
assign cast_wrapper_in_flat[11] = in_flat[257];
assign conditional_wrapper_in_flat[0] = in_flat[258];
assign conditional_wrapper_in_flat[1] = in_flat[259];
assign conditional_wrapper_in_flat[2] = in_flat[260];
assign conditional_wrapper_in_flat[3] = in_flat[261];
assign conditional_wrapper_in_flat[4] = in_flat[262];
assign conditional_wrapper_in_flat[5] = in_flat[263];
assign conditional_wrapper_in_flat[8] = in_flat[264];
assign partselect_wrapper_in_flat[0] = in_flat[265];
assign partselect_wrapper_in_flat[1] = in_flat[266];
assign partselect_wrapper_in_flat[2] = in_flat[267];
assign partselect_wrapper_in_flat[3] = in_flat[268];
assign partselect_wrapper_in_flat[4] = in_flat[269];
assign partselect_wrapper_in_flat[5] = in_flat[270];
assign partselect_wrapper_in_flat[6] = in_flat[271];
assign partselect_wrapper_in_flat[7] = in_flat[272];
assign partselect_wrapper_in_flat[8] = in_flat[273];
assign partselect_wrapper_in_flat[9] = in_flat[274];
assign partselect_wrapper_in_flat[10] = in_flat[275];
assign partselect_wrapper_in_flat[11] = in_flat[276];
assign partselect_wrapper_in_flat[12] = in_flat[277];
assign partselect_wrapper_in_flat[13] = in_flat[278];
assign partselect_wrapper_in_flat[14] = in_flat[279];
assign partselect_wrapper_in_flat[15] = in_flat[280];
assign partselect_wrapper_in_flat[16] = in_flat[281];
assign partselect_wrapper_in_flat[17] = in_flat[282];
assign partselect_wrapper_in_flat[18] = in_flat[283];
assign width_enum_wrapper_in_flat[0] = in_flat[284];
assign width_enum_wrapper_in_flat[3] = in_flat[285];
assign width_struct_wrapper_in_flat[0] = in_flat[286];
assign width_struct_wrapper_in_flat[1] = in_flat[287];
assign width_struct_wrapper_in_flat[2] = in_flat[288];
assign width_struct_wrapper_in_flat[3] = in_flat[289];
assign width_struct_wrapper_in_flat[4] = in_flat[290];
assign width_struct_wrapper_in_flat[5] = in_flat[291];
assign width_struct_wrapper_in_flat[6] = in_flat[292];
assign width_struct_wrapper_in_flat[7] = in_flat[293];
assign width_struct_wrapper_in_flat[8] = in_flat[294];
assign width_struct_wrapper_in_flat[9] = in_flat[295];
assign width_struct_wrapper_in_flat[10] = in_flat[296];
assign width_struct_wrapper_in_flat[11] = in_flat[297];
assign width_union_wrapper_in_flat[0] = in_flat[298];
assign width_union_wrapper_in_flat[1] = in_flat[299];
assign width_union_wrapper_in_flat[2] = in_flat[300];
assign width_union_wrapper_in_flat[3] = in_flat[301];
assign width_union_wrapper_in_flat[4] = in_flat[302];
assign width_union_wrapper_in_flat[5] = in_flat[303];
assign width_union_wrapper_in_flat[6] = in_flat[304];
assign width_union_wrapper_in_flat[7] = in_flat[305];
assign width_union_wrapper_in_flat[8] = in_flat[306];
assign width_union_wrapper_in_flat[9] = in_flat[307];
assign width_union_wrapper_in_flat[10] = in_flat[308];
assign width_union_wrapper_in_flat[11] = in_flat[309];
assign width_union_wrapper_in_flat[12] = in_flat[310];
assign width_union_wrapper_in_flat[13] = in_flat[311];
assign width_union_wrapper_in_flat[14] = in_flat[312];
assign width_union_wrapper_in_flat[15] = in_flat[313];
assign width_logic_wrapper_in_flat[0] = in_flat[314];
assign width_logic_wrapper_in_flat[1] = in_flat[315];
assign width_logic_wrapper_in_flat[3] = in_flat[316];
assign width_logic_wrapper_in_flat[4] = in_flat[317];
assign width_logic_wrapper_in_flat[5] = in_flat[318];
assign width_logic_wrapper_in_flat[6] = in_flat[319];
assign width_logic_wrapper_in_flat[7] = in_flat[320];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[321];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[322];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[323];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[324];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[325];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[326];

// Internal MTM connections (module-to-module)
assign logical_op_wrapper_in_flat[1] = const_compare_wrapper_out_flat[0];
assign shift_wrapper_in_flat[7] = const_compare_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[6] = const_logic_wrapper_out_flat[17];
assign conditional_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[3];
assign relational_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[3];
assign array_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[11];
assign width_enum_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[21];
assign const_reduce_wrapper_in_flat[2] = logical_op_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[2] = relational_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[1] = select_wrapper_out_flat[2];
assign relational_wrapper_in_flat[5] = shift_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[2] = cast_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[17];
