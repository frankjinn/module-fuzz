...
assign const_shift_wrapper_in_flat[10] = in_flat[151];
assign arithmetic_reduce_wrapper_in_flat[0] = in_flat[152];
assign arithmetic_reduce_wrapper_in_flat[1] = in_flat[153];
assign arithmetic_reduce_wrapper_in_flat[2] = in_flat[154];
assign arithmetic_reduce_wrapper_in_flat[3] = in_flat[155];
assign arithmetic_reduce_wrapper_in_flat[4] = in_flat[156];
assign arithmetic_reduce_wrapper_in_flat[5] = in_flat[157];
assign arithmetic_reduce_wrapper_in_flat[6] = in_flat[158];
...
assign relational_wrapper_in_flat[4] = in_flat[194];
assign relational_wrapper_in_flat[5] = in_flat[195];
assign relational_wrapper_in_flat[6] = in_flat[196];
assign relational_wrapper_in_flat[7] = in_flat[197];
assign select_wrapper_in_flat[0] = in_flat[198];
assign select_wrapper_in_flat[1] = in_flat[199];
assign select_wrapper_in_flat[2] = in_flat[200];
assign select_wrapper_in_flat[3] = in_flat[201];
assign select_wrapper_in_flat[4] = in_flat[202];
assign select_wrapper_in_flat[5] = in_flat[203];
assign select_wrapper_in_flat[6] = in_flat[204];
assign select_wrapper_in_flat[7] = in_flat[205];
assign select_wrapper_in_flat[8] = in_flat[206];
...
assign shift_wrapper_in_flat[3] = in_flat[221];
assign shift_wrapper_in_flat[4] = in_flat[222];
...
assign array_wrapper_in_flat[7] = in_flat[236];
assign array_wrapper_in_flat[8] = in_flat[237];
...
assign cast_wrapper_in_flat[11] = in_flat[258];
assign conditional_wrapper_in_flat[0] = in_flat[259];
assign conditional_wrapper_in_flat[1] = in_flat[260];
assign conditional_wrapper_in_flat[2] = in_flat[261];
assign conditional_wrapper_in_flat[3] = in_flat[262];
assign conditional_wrapper_in_flat[4] = in_flat[263];
assign conditional_wrapper_in_flat[5] = in_flat[264];
assign conditional_wrapper_in_flat[6] = in_flat[265];
assign conditional_wrapper_in_flat[7] = in_flat[266];
assign conditional_wrapper_in_flat[8] = in_flat[267];
assign partselect_wrapper_in_flat[0] = in_flat[268];
assign partselect_wrapper_in_flat[1] = in_flat[269];
assign partselect_wrapper_in_flat[2] = in_flat[270];
assign partselect_wrapper_in_flat[3] = in_flat[271];
assign partselect_wrapper_in_flat[4] = in_flat[272];
assign partselect_wrapper_in_flat[5] = in_flat[273];
assign partselect_wrapper_in_flat[6] = in_flat[274];
assign partselect_wrapper_in_flat[8] = in_flat[275];
assign partselect_wrapper_in_flat[9] = in_flat[276];
assign partselect_wrapper_in_flat[10] = in_flat[277];
assign partselect_wrapper_in_flat[11] = in_flat[278];
assign partselect_wrapper_in_flat[12] = in_flat[279];
assign partselect_wrapper_in_flat[13] = in_flat[280];
assign partselect_wrapper_in_flat[14] = in_flat[281];
assign partselect_wrapper_in_flat[15] = in_flat[282];
assign partselect_wrapper_in_flat[16] = in_flat[283];
assign partselect_wrapper_in_flat[17] = in_flat[284];
assign partselect_wrapper_in_flat[18] = in_flat[285];
assign width_enum_wrapper_in_flat[1] = in_flat[286];
assign width_enum_wrapper_in_flat[2] = in_flat[287];
assign width_enum_wrapper_in_flat[3] = in_flat[288];
assign width_struct_wrapper_in_flat[0] = in_flat[289];
assign width_struct_wrapper_in_flat[1] = in_flat[290];
assign width_struct_wrapper_in_flat[2] = in_flat[291];
assign width_struct_wrapper_in_flat[3] = in_flat[292];
assign width_struct_wrapper_in_flat[4] = in_flat[293];
assign width_struct_wrapper_in_flat[5] = in_flat[294];
assign width_struct_wrapper_in_flat[6] = in_flat[295];
assign width_struct_wrapper_in_flat[7] = in_flat[296];
assign width_struct_wrapper_in_flat[8] = in_flat[297];
assign width_struct_wrapper_in_flat[9] = in_flat[298];
assign width_struct_wrapper_in_flat[10] = in_flat[299];
assign width_struct_wrapper_in_flat[11] = in_flat[300];
assign width_union_wrapper_in_flat[0] = in_flat[301];
assign width_union_wrapper_in_flat[1] = in_flat[302];
assign width_union_wrapper_in_flat[2] = in_flat[303];
assign width_union_wrapper_in_flat[3] = in_flat[304];
...
assign width_logic_wrapper_in_flat[1] = in_flat[317];
assign width_logic_wrapper_in_flat[2] = in_flat[318];
assign width_logic_wrapper_in_flat[3] = in_flat[319];
assign width_logic_wrapper_in_flat[4] = in_flat[320];
assign width_logic_wrapper_in_flat[5] = in_flat[321];
assign width_logic_wrapper_in_flat[6] = in_flat[322];
assign width_logic_wrapper_in_flat[7] = in_flat[323];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[324];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[325];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[326];

// Internal MTM connections (module-to-module)
assign numbers_concat_repl_wrapper_in_flat[2] = const_logic_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[7] = const_reduce_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[3];
...
assign partselect_wrapper_in_flat[7] = shift_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[1] = shift_wrapper_out_flat[12];
assign logical_op_wrapper_in_flat[1] = array_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[0] = cast_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[3] = width_struct_wrapper_out_flat[10];
assign bitwise_logic_wrapper_in_flat[7] = width_union_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[0] = width_logic_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[22] = numbers_concat_repl_wrapper_out_flat[1];
