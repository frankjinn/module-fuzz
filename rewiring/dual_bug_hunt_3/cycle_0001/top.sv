...
assign const_conditional_wrapper_in_flat[10] = in_flat[56];
assign const_conditional_wrapper_in_flat[11] = in_flat[57];
assign const_conditional_wrapper_in_flat[12] = in_flat[58];
assign const_conditional_wrapper_in_flat[13] = in_flat[59];
assign const_conditional_wrapper_in_flat[14] = in_flat[60];
assign const_conditional_wrapper_in_flat[15] = in_flat[61];
assign const_conditional_wrapper_in_flat[16] = in_flat[62];
assign const_conditional_wrapper_in_flat[17] = in_flat[63];
assign const_conditional_wrapper_in_flat[18] = in_flat[64];
assign const_conditional_wrapper_in_flat[19] = in_flat[65];
assign const_conditional_wrapper_in_flat[20] = in_flat[66];
...
assign const_conditional_wrapper_in_flat[27] = in_flat[72];
assign const_conditional_wrapper_in_flat[28] = in_flat[73];
assign const_conditional_wrapper_in_flat[29] = in_flat[74];
assign const_conditional_wrapper_in_flat[30] = in_flat[75];
assign const_conditional_wrapper_in_flat[31] = in_flat[76];
assign const_conditional_wrapper_in_flat[32] = in_flat[77];
assign const_conditional_wrapper_in_flat[33] = in_flat[78];
assign const_logic_wrapper_in_flat[0] = in_flat[79];
assign const_logic_wrapper_in_flat[1] = in_flat[80];
...
assign const_nested_wrapper_in_flat[11] = in_flat[97];
...
assign const_partselect_wrapper_in_flat[1] = in_flat[112];
assign const_partselect_wrapper_in_flat[2] = in_flat[113];
assign const_partselect_wrapper_in_flat[3] = in_flat[114];
assign const_partselect_wrapper_in_flat[4] = in_flat[115];
assign const_partselect_wrapper_in_flat[5] = in_flat[116];
assign const_partselect_wrapper_in_flat[6] = in_flat[117];
...
assign const_partselect_wrapper_in_flat[11] = in_flat[121];
...
assign const_conditional_wrapper_in_flat[26] = const_arith_wrapper_out_flat[29];
assign const_partselect_wrapper_in_flat[19] = const_arith_wrapper_out_flat[30];
assign const_nested_wrapper_in_flat[10] = const_arith_wrapper_out_flat[30];
assign const_shift_wrapper_in_flat[8] = const_compare_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[13] = const_compare_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[20];
assign const_shift_wrapper_in_flat[3] = const_logic_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[10] = const_logic_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[10] = const_logic_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[3] = const_nested_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[12] = const_nested_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[3] = const_shift_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[25] = const_shift_wrapper_out_flat[14];
