...
assign const_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[21] = const_arith_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[24] = const_arith_wrapper_out_flat[26];
assign const_partselect_wrapper_in_flat[6] = const_arith_wrapper_out_flat[36];
assign const_conditional_wrapper_in_flat[0] = const_compare_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[18] = const_concat_repl_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[14];
assign const_nested_wrapper_in_flat[14] = const_concat_repl_wrapper_out_flat[20];
assign const_nested_wrapper_in_flat[11] = const_logic_wrapper_out_flat[0];
...
assign const_compare_wrapper_in_flat[14] = const_nested_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[22] = const_reduce_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[10] = const_shift_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[24] = const_shift_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[19] = const_shift_wrapper_out_flat[23];
