...
assign const_partselect_wrapper_in_flat[14] = const_arith_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[6] = const_arith_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[30] = const_arith_wrapper_out_flat[17];
assign const_nested_wrapper_in_flat[17] = const_compare_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[17] = const_compare_wrapper_out_flat[7];
...
assign const_concat_repl_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[14];
assign const_nested_wrapper_in_flat[14] = const_logic_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[14] = const_shift_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[2] = const_shift_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[19] = const_shift_wrapper_out_flat[17];
assign const_compare_wrapper_in_flat[8] = const_shift_wrapper_out_flat[21];
