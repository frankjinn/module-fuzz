...
assign const_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[18];
assign const_logic_wrapper_in_flat[1] = const_arith_wrapper_out_flat[23];
assign const_partselect_wrapper_in_flat[19] = const_compare_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[8];
assign const_shift_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[8];
...
assign const_partselect_wrapper_in_flat[16] = const_logic_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[16] = const_logic_wrapper_out_flat[17];
assign const_compare_wrapper_in_flat[18] = const_nested_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[4] = const_nested_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[3] = const_nested_wrapper_out_flat[2];
...
assign const_conditional_wrapper_in_flat[8] = const_shift_wrapper_out_flat[7];
