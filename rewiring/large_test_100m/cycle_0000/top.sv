...
assign const_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[28];
assign const_logic_wrapper_in_flat[4] = const_arith_wrapper_out_flat[34];
assign const_partselect_wrapper_in_flat[1] = const_compare_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[0] = const_compare_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[24] = const_concat_repl_wrapper_out_flat[21];
assign const_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[23] = const_conditional_wrapper_out_flat[5];
...
assign const_nested_wrapper_in_flat[9] = const_reduce_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[13] = const_shift_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[10] = const_shift_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[2] = const_shift_wrapper_out_flat[8];
