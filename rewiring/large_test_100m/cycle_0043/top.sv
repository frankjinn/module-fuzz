...
assign const_shift_wrapper_in_flat[1] = const_arith_wrapper_out_flat[37];
assign const_shift_wrapper_in_flat[3] = const_compare_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[8] = const_compare_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[1] = const_compare_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[23] = const_concat_repl_wrapper_out_flat[17];
assign const_partselect_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[20];
assign const_concat_repl_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[14];
assign const_nested_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[16];
assign const_partselect_wrapper_in_flat[12] = const_logic_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[22] = const_logic_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[10] = const_logic_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[5] = const_nested_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[14] = const_reduce_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[5];
