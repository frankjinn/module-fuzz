...
assign const_reduce_wrapper_in_flat[0] = in_flat[129];
...
assign const_shift_wrapper_in_flat[10] = in_flat[141];

// Internal MTM connections (module-to-module)
assign const_compare_wrapper_in_flat[23] = const_arith_wrapper_out_flat[17];
assign const_partselect_wrapper_in_flat[12] = const_arith_wrapper_out_flat[18];
assign const_concat_repl_wrapper_in_flat[7] = const_arith_wrapper_out_flat[30];
assign const_nested_wrapper_in_flat[22] = const_arith_wrapper_out_flat[31];
assign const_nested_wrapper_in_flat[26] = const_compare_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[18] = const_logic_wrapper_out_flat[16];
assign const_reduce_wrapper_in_flat[3] = const_nested_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[4] = const_nested_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[21] = const_partselect_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[19] = const_shift_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[14] = const_shift_wrapper_out_flat[16];
