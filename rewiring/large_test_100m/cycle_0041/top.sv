...
assign const_nested_wrapper_in_flat[22] = in_flat[109];
assign const_nested_wrapper_in_flat[23] = in_flat[110];
assign const_nested_wrapper_in_flat[24] = in_flat[111];
...
assign const_partselect_wrapper_in_flat[12] = in_flat[124];
...
assign const_partselect_wrapper_in_flat[17] = in_flat[129];
assign const_partselect_wrapper_in_flat[18] = in_flat[130];
assign const_partselect_wrapper_in_flat[19] = in_flat[131];
assign const_reduce_wrapper_in_flat[3] = in_flat[132];
assign const_shift_wrapper_in_flat[0] = in_flat[133];
assign const_shift_wrapper_in_flat[1] = in_flat[134];
assign const_shift_wrapper_in_flat[3] = in_flat[135];
assign const_shift_wrapper_in_flat[4] = in_flat[136];
assign const_shift_wrapper_in_flat[5] = in_flat[137];
assign const_shift_wrapper_in_flat[6] = in_flat[138];
assign const_shift_wrapper_in_flat[7] = in_flat[139];
assign const_shift_wrapper_in_flat[8] = in_flat[140];
assign const_shift_wrapper_in_flat[9] = in_flat[141];
assign const_shift_wrapper_in_flat[10] = in_flat[142];

// Internal MTM connections (module-to-module)
assign const_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[0] = const_arith_wrapper_out_flat[37];
assign const_shift_wrapper_in_flat[2] = const_compare_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[12];
assign const_logic_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[15];
assign const_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[17] = const_conditional_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[25] = const_logic_wrapper_out_flat[11];
...
assign const_logic_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[8] = const_shift_wrapper_out_flat[16];
