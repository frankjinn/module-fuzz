...
assign const_shift_wrapper_in_flat[0] = const_arith_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[20] = const_arith_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[7] = const_arith_wrapper_out_flat[23];
assign const_partselect_wrapper_in_flat[16] = const_compare_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[18] = const_compare_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[29] = const_compare_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[13];
assign const_conditional_wrapper_in_flat[16] = const_concat_repl_wrapper_out_flat[18];
assign const_nested_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[5];
...
assign const_partselect_wrapper_in_flat[9] = const_logic_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[8] = const_nested_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[3] = const_nested_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[10] = const_nested_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[22] = const_shift_wrapper_out_flat[20];
assign const_concat_repl_wrapper_in_flat[3] = const_shift_wrapper_out_flat[21];
assign const_partselect_wrapper_in_flat[14] = const_shift_wrapper_out_flat[21];
