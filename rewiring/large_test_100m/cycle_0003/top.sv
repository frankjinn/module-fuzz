...
assign const_shift_wrapper_in_flat[4] = const_arith_wrapper_out_flat[39];
assign const_nested_wrapper_in_flat[2] = const_compare_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[12];
assign const_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[14];
assign const_logic_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[19];
assign const_nested_wrapper_in_flat[18] = const_conditional_wrapper_out_flat[22];
assign const_compare_wrapper_in_flat[19] = const_logic_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[14] = const_partselect_wrapper_out_flat[1];
...
assign const_conditional_wrapper_in_flat[7] = const_shift_wrapper_out_flat[19];
assign const_partselect_wrapper_in_flat[12] = const_shift_wrapper_out_flat[21];
