...
assign const_conditional_wrapper_in_flat[19] = const_arith_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[4] = const_arith_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[9] = const_arith_wrapper_out_flat[35];
...
assign const_compare_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[16];
assign const_nested_wrapper_in_flat[19] = const_concat_repl_wrapper_out_flat[18];
assign const_concat_repl_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[18];
assign const_partselect_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[22];
assign const_reduce_wrapper_in_flat[3] = const_logic_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[6] = const_logic_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[1] = const_nested_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[17] = const_shift_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[17] = const_shift_wrapper_out_flat[19];
