...
assign const_logic_wrapper_in_flat[9] = in_flat[86];
assign const_nested_wrapper_in_flat[0] = in_flat[87];
assign const_nested_wrapper_in_flat[1] = in_flat[88];
assign const_nested_wrapper_in_flat[2] = in_flat[89];
...
assign const_nested_wrapper_in_flat[12] = in_flat[98];
assign const_nested_wrapper_in_flat[13] = in_flat[99];
assign const_nested_wrapper_in_flat[14] = in_flat[100];
assign const_nested_wrapper_in_flat[15] = in_flat[101];
assign const_nested_wrapper_in_flat[16] = in_flat[102];
assign const_nested_wrapper_in_flat[17] = in_flat[103];
assign const_nested_wrapper_in_flat[18] = in_flat[104];
assign const_nested_wrapper_in_flat[19] = in_flat[105];
...
assign const_partselect_wrapper_in_flat[11] = in_flat[122];
assign const_partselect_wrapper_in_flat[12] = in_flat[123];
...
assign const_reduce_wrapper_in_flat[3] = in_flat[131];
assign const_shift_wrapper_in_flat[1] = in_flat[132];
assign const_shift_wrapper_in_flat[2] = in_flat[133];
assign const_shift_wrapper_in_flat[3] = in_flat[134];
assign const_shift_wrapper_in_flat[4] = in_flat[135];
assign const_shift_wrapper_in_flat[6] = in_flat[136];
assign const_shift_wrapper_in_flat[7] = in_flat[137];
assign const_shift_wrapper_in_flat[8] = in_flat[138];
assign const_shift_wrapper_in_flat[9] = in_flat[139];
assign const_shift_wrapper_in_flat[10] = in_flat[140];

// Internal MTM connections (module-to-module)
assign const_compare_wrapper_in_flat[12] = const_arith_wrapper_out_flat[12];
assign const_shift_wrapper_in_flat[0] = const_arith_wrapper_out_flat[28];
assign const_partselect_wrapper_in_flat[19] = const_compare_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[21];
assign const_reduce_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[22];
assign const_logic_wrapper_in_flat[5] = const_nested_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[20] = const_partselect_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[23] = const_reduce_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[19] = const_shift_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[11] = const_shift_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[0] = const_shift_wrapper_out_flat[9];
