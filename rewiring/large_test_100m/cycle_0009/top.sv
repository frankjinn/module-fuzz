...
assign const_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[14];
assign const_conditional_wrapper_in_flat[22] = const_arith_wrapper_out_flat[22];
assign const_nested_wrapper_in_flat[16] = const_arith_wrapper_out_flat[29];
assign const_concat_repl_wrapper_in_flat[8] = const_arith_wrapper_out_flat[36];
assign const_logic_wrapper_in_flat[6] = const_arith_wrapper_out_flat[39];
assign const_compare_wrapper_in_flat[21] = const_concat_repl_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[21] = const_conditional_wrapper_out_flat[16];
assign const_partselect_wrapper_in_flat[2] = const_logic_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[4] = const_logic_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[9] = const_nested_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[1] = const_nested_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[23] = const_partselect_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[20] = const_reduce_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[32] = const_shift_wrapper_out_flat[9];
assign const_arith_wrapper_in_flat[10] = const_shift_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[6] = const_shift_wrapper_out_flat[12];
assign const_reduce_wrapper_in_flat[1] = const_shift_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[12] = const_shift_wrapper_out_flat[15];
assign const_logic_wrapper_in_flat[1] = const_shift_wrapper_out_flat[16];
