...
assign const_conditional_wrapper_in_flat[24] = const_arith_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[2] = const_arith_wrapper_out_flat[34];
assign const_partselect_wrapper_in_flat[16] = const_concat_repl_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[16] = const_concat_repl_wrapper_out_flat[18];
assign const_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[21];
assign const_concat_repl_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[22] = const_logic_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[1] = const_logic_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[13] = const_nested_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[11] = const_partselect_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[17] = const_reduce_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[4];
...
assign const_concat_repl_wrapper_in_flat[3] = const_shift_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[18] = const_shift_wrapper_out_flat[9];
