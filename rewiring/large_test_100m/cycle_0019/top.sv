...
assign const_compare_wrapper_in_flat[17] = const_arith_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[20] = const_arith_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[8] = const_arith_wrapper_out_flat[27];
...
assign const_shift_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[12];
assign const_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[14];
assign const_nested_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[17];
assign const_compare_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[19];
assign const_shift_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[8];
assign const_concat_repl_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[23] = const_conditional_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[23];
assign const_partselect_wrapper_in_flat[6] = const_logic_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[0] = const_nested_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[20] = const_nested_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[0] = const_nested_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[4] = const_nested_wrapper_out_flat[4];
...
assign const_compare_wrapper_in_flat[7] = const_shift_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[9] = const_shift_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[5] = const_shift_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[3] = const_shift_wrapper_out_flat[11];
