...
assign const_logic_wrapper_in_flat[6] = in_flat[83];
assign const_logic_wrapper_in_flat[7] = in_flat[84];
assign const_logic_wrapper_in_flat[8] = in_flat[85];
...
assign const_shift_wrapper_in_flat[0] = in_flat[128];
assign const_shift_wrapper_in_flat[1] = in_flat[129];
assign const_shift_wrapper_in_flat[2] = in_flat[130];
assign const_shift_wrapper_in_flat[3] = in_flat[131];
assign const_shift_wrapper_in_flat[4] = in_flat[132];
assign const_shift_wrapper_in_flat[5] = in_flat[133];
assign const_shift_wrapper_in_flat[6] = in_flat[134];
assign const_shift_wrapper_in_flat[7] = in_flat[135];
assign const_shift_wrapper_in_flat[8] = in_flat[136];
assign const_shift_wrapper_in_flat[9] = in_flat[137];

// Internal MTM connections (module-to-module)
assign const_compare_wrapper_in_flat[10] = const_arith_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[17] = const_arith_wrapper_out_flat[23];
assign const_nested_wrapper_in_flat[26] = const_arith_wrapper_out_flat[36];
assign const_reduce_wrapper_in_flat[2] = const_compare_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[12] = const_compare_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[13] = const_compare_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[15];
assign const_arith_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[21];
assign const_logic_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[15] = const_logic_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[2] = const_logic_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[15] = const_logic_wrapper_out_flat[16];
assign const_partselect_wrapper_in_flat[15] = const_nested_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[4] = const_shift_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[1] = const_shift_wrapper_out_flat[19];
assign const_nested_wrapper_in_flat[11] = const_shift_wrapper_out_flat[19];
