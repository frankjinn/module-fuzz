...
assign const_concat_repl_wrapper_in_flat[7] = const_arith_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[18] = const_arith_wrapper_out_flat[22];
assign const_shift_wrapper_in_flat[9] = const_arith_wrapper_out_flat[31];
assign const_logic_wrapper_in_flat[6] = const_compare_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[2] = const_compare_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[26] = const_concat_repl_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[19];
assign const_shift_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[21];
assign const_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[22];
assign const_logic_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[22];
assign const_nested_wrapper_in_flat[22] = const_conditional_wrapper_out_flat[23];
assign const_nested_wrapper_in_flat[9] = const_logic_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[31] = const_partselect_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[13] = const_reduce_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[4] = const_shift_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[3] = const_shift_wrapper_out_flat[21];
