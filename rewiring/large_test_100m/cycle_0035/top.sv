...
assign const_nested_wrapper_in_flat[12] = in_flat[100];
...
assign const_shift_wrapper_in_flat[2] = const_arith_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[22] = const_arith_wrapper_out_flat[34];
assign const_reduce_wrapper_in_flat[3] = const_compare_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[6] = const_compare_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[13] = const_compare_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[15] = const_compare_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[19] = const_concat_repl_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[19];
assign const_concat_repl_wrapper_in_flat[3] = const_logic_wrapper_out_flat[14];
assign const_nested_wrapper_in_flat[14] = const_logic_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[8] = const_nested_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[9] = const_reduce_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[7] = const_shift_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[4] = const_shift_wrapper_out_flat[22];
