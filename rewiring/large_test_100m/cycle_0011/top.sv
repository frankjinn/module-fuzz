...
assign const_partselect_wrapper_in_flat[1] = in_flat[111];
...
assign const_partselect_wrapper_in_flat[7] = in_flat[117];
assign const_partselect_wrapper_in_flat[8] = in_flat[118];
assign const_partselect_wrapper_in_flat[9] = in_flat[119];
assign const_partselect_wrapper_in_flat[10] = in_flat[120];
...
assign const_nested_wrapper_in_flat[21] = const_arith_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[2] = const_arith_wrapper_out_flat[25];
assign const_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[28];
assign const_shift_wrapper_in_flat[9] = const_arith_wrapper_out_flat[36];
assign const_partselect_wrapper_in_flat[17] = const_compare_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[13];
assign const_logic_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[18] = const_conditional_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[17];
assign const_arith_wrapper_in_flat[0] = const_logic_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[25] = const_logic_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[11] = const_nested_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[0] = const_nested_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[9] = const_reduce_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[11] = const_shift_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[23] = const_shift_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[2] = const_shift_wrapper_out_flat[7];
