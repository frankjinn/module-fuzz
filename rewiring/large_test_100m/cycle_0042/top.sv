...
assign const_partselect_wrapper_in_flat[13] = const_arith_wrapper_out_flat[33];
assign const_nested_wrapper_in_flat[5] = const_compare_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[4] = const_compare_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[3] = const_compare_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[20] = const_conditional_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[10];
assign const_logic_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[12];
assign const_arith_wrapper_in_flat[14] = const_logic_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[2] = const_logic_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[1] = const_nested_wrapper_out_flat[6];
