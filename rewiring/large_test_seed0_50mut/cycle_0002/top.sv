...
assign const_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[20];
...
assign const_reduce_wrapper_in_flat[1] = const_compare_wrapper_out_flat[2];
...
assign const_reduce_wrapper_in_flat[3] = const_shift_wrapper_out_flat[6];
