...
assign const_nested_wrapper_in_flat[16] = const_compare_wrapper_out_flat[0];
...
assign const_partselect_wrapper_in_flat[17] = const_nested_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[0];
