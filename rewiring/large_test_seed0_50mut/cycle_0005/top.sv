...
assign const_nested_wrapper_in_flat[19] = in_flat[102];
assign const_nested_wrapper_in_flat[20] = in_flat[103];
assign const_nested_wrapper_in_flat[21] = in_flat[104];
assign const_nested_wrapper_in_flat[22] = in_flat[105];
assign const_nested_wrapper_in_flat[23] = in_flat[106];
...
assign const_reduce_wrapper_in_flat[3] = in_flat[127];
...
assign const_conditional_wrapper_in_flat[32] = const_arith_wrapper_out_flat[15];
assign const_concat_repl_wrapper_in_flat[3] = const_arith_wrapper_out_flat[16];
assign const_shift_wrapper_in_flat[0] = const_arith_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[24] = const_arith_wrapper_out_flat[30];
assign const_conditional_wrapper_in_flat[8] = const_compare_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[13] = const_compare_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[21];
assign const_partselect_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[13];
assign const_conditional_wrapper_in_flat[4] = const_logic_wrapper_out_flat[10];
assign const_reduce_wrapper_in_flat[1] = const_logic_wrapper_out_flat[12];
assign const_arith_wrapper_in_flat[0] = const_logic_wrapper_out_flat[16];
assign const_compare_wrapper_in_flat[18] = const_logic_wrapper_out_flat[18];
assign const_conditional_wrapper_in_flat[19] = const_nested_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[14] = const_reduce_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[5] = const_shift_wrapper_out_flat[7];
