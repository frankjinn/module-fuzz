...
assign const_reduce_wrapper_in_flat[0] = in_flat[123];
assign const_reduce_wrapper_in_flat[1] = in_flat[124];
...
assign const_conditional_wrapper_in_flat[2] = const_arith_wrapper_out_flat[22];
assign const_compare_wrapper_in_flat[6] = const_arith_wrapper_out_flat[32];
...
assign const_nested_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[18] = const_conditional_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[13];
assign const_logic_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[23];
assign const_partselect_wrapper_in_flat[2] = const_logic_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[15] = const_logic_wrapper_out_flat[15];
assign const_arith_wrapper_in_flat[6] = const_nested_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[31] = const_nested_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[16] = const_reduce_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[1] = const_shift_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[24] = const_shift_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[12] = const_shift_wrapper_out_flat[10];
assign const_logic_wrapper_in_flat[7] = const_shift_wrapper_out_flat[13];
