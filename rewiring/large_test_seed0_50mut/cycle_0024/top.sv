...
assign const_shift_wrapper_in_flat[1] = const_compare_wrapper_out_flat[3];
...
assign const_compare_wrapper_in_flat[12] = const_nested_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[5] = const_nested_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[4] = const_nested_wrapper_out_flat[3];
