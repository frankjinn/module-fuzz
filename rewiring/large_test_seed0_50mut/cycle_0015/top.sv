...
assign const_nested_wrapper_in_flat[25] = in_flat[112];
assign const_nested_wrapper_in_flat[26] = in_flat[113];
assign const_partselect_wrapper_in_flat[0] = in_flat[114];
assign const_partselect_wrapper_in_flat[1] = in_flat[115];
assign const_partselect_wrapper_in_flat[2] = in_flat[116];
assign const_partselect_wrapper_in_flat[3] = in_flat[117];
assign const_partselect_wrapper_in_flat[4] = in_flat[118];
assign const_partselect_wrapper_in_flat[5] = in_flat[119];
assign const_partselect_wrapper_in_flat[6] = in_flat[120];
assign const_partselect_wrapper_in_flat[7] = in_flat[121];
assign const_partselect_wrapper_in_flat[8] = in_flat[122];
assign const_partselect_wrapper_in_flat[9] = in_flat[123];
assign const_partselect_wrapper_in_flat[10] = in_flat[124];
assign const_partselect_wrapper_in_flat[11] = in_flat[125];
assign const_partselect_wrapper_in_flat[12] = in_flat[126];
assign const_partselect_wrapper_in_flat[13] = in_flat[127];
assign const_partselect_wrapper_in_flat[14] = in_flat[128];
assign const_partselect_wrapper_in_flat[15] = in_flat[129];
assign const_partselect_wrapper_in_flat[18] = in_flat[130];
assign const_reduce_wrapper_in_flat[0] = in_flat[131];
assign const_reduce_wrapper_in_flat[1] = in_flat[132];
...
assign const_shift_wrapper_in_flat[6] = const_arith_wrapper_out_flat[15];
assign const_logic_wrapper_in_flat[1] = const_compare_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[17] = const_compare_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[1];
...
assign const_arith_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[16] = const_logic_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[3] = const_logic_wrapper_out_flat[16];
assign const_conditional_wrapper_in_flat[18] = const_partselect_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[9] = const_shift_wrapper_out_flat[10];
