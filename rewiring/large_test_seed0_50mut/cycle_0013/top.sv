...
assign const_conditional_wrapper_in_flat[24] = const_compare_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[19] = const_concat_repl_wrapper_out_flat[2];
...
assign const_nested_wrapper_in_flat[7] = const_logic_wrapper_out_flat[7];
...
assign const_partselect_wrapper_in_flat[16] = const_nested_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[4] = const_nested_wrapper_out_flat[7];
