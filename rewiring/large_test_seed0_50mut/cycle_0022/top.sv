...
assign const_nested_wrapper_in_flat[20] = in_flat[106];
assign const_nested_wrapper_in_flat[21] = in_flat[107];
assign const_nested_wrapper_in_flat[22] = in_flat[108];
...
assign const_partselect_wrapper_in_flat[7] = in_flat[118];
assign const_partselect_wrapper_in_flat[8] = in_flat[119];
assign const_partselect_wrapper_in_flat[9] = in_flat[120];
assign const_partselect_wrapper_in_flat[10] = in_flat[121];
assign const_partselect_wrapper_in_flat[11] = in_flat[122];
assign const_partselect_wrapper_in_flat[13] = in_flat[123];
assign const_partselect_wrapper_in_flat[14] = in_flat[124];
...
assign const_partselect_wrapper_in_flat[19] = in_flat[129];
assign const_reduce_wrapper_in_flat[0] = in_flat[130];
assign const_reduce_wrapper_in_flat[1] = in_flat[131];
assign const_reduce_wrapper_in_flat[2] = in_flat[132];
assign const_reduce_wrapper_in_flat[3] = in_flat[133];
assign const_shift_wrapper_in_flat[0] = in_flat[134];
assign const_shift_wrapper_in_flat[1] = in_flat[135];
assign const_shift_wrapper_in_flat[2] = in_flat[136];
assign const_shift_wrapper_in_flat[3] = in_flat[137];
assign const_shift_wrapper_in_flat[4] = in_flat[138];
assign const_shift_wrapper_in_flat[6] = in_flat[139];
assign const_shift_wrapper_in_flat[7] = in_flat[140];
assign const_shift_wrapper_in_flat[8] = in_flat[141];
assign const_shift_wrapper_in_flat[10] = in_flat[142];

// Internal MTM connections (module-to-module)
assign const_shift_wrapper_in_flat[5] = const_arith_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[12] = const_arith_wrapper_out_flat[31];
assign const_compare_wrapper_in_flat[7] = const_arith_wrapper_out_flat[38];
assign const_conditional_wrapper_in_flat[7] = const_arith_wrapper_out_flat[39];
assign const_conditional_wrapper_in_flat[2] = const_compare_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[19];
assign const_nested_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[17];
assign const_partselect_wrapper_in_flat[6] = const_logic_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[1] = const_logic_wrapper_out_flat[14];
assign const_shift_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[0] = const_shift_wrapper_out_flat[10];
