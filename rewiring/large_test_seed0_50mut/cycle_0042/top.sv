...
assign const_partselect_wrapper_in_flat[8] = const_arith_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[22] = const_arith_wrapper_out_flat[37];
assign const_reduce_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[15];
assign const_shift_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[18];
assign const_reduce_wrapper_in_flat[0] = const_logic_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[7] = const_logic_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[2] = const_logic_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[14] = const_logic_wrapper_out_flat[15];
assign const_arith_wrapper_in_flat[9] = const_nested_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[14] = const_nested_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[14] = const_reduce_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[7] = const_reduce_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[5] = const_shift_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[2] = const_shift_wrapper_out_flat[12];
