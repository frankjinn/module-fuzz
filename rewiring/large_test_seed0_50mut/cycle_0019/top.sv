...
assign const_logic_wrapper_in_flat[8] = in_flat[87];
...
assign const_partselect_wrapper_in_flat[6] = in_flat[119];
assign const_partselect_wrapper_in_flat[7] = in_flat[120];
assign const_partselect_wrapper_in_flat[8] = in_flat[121];
assign const_partselect_wrapper_in_flat[9] = in_flat[122];
assign const_partselect_wrapper_in_flat[10] = in_flat[123];
assign const_partselect_wrapper_in_flat[11] = in_flat[124];
assign const_partselect_wrapper_in_flat[13] = in_flat[125];
assign const_partselect_wrapper_in_flat[14] = in_flat[126];
assign const_partselect_wrapper_in_flat[15] = in_flat[127];
assign const_partselect_wrapper_in_flat[16] = in_flat[128];
...
assign const_shift_wrapper_in_flat[0] = in_flat[132];
...
assign const_shift_wrapper_in_flat[6] = in_flat[137];
assign const_shift_wrapper_in_flat[7] = in_flat[138];
assign const_shift_wrapper_in_flat[8] = in_flat[139];
assign const_shift_wrapper_in_flat[9] = in_flat[140];

// Internal MTM connections (module-to-module)
assign const_shift_wrapper_in_flat[10] = const_arith_wrapper_out_flat[17];
assign const_logic_wrapper_in_flat[0] = const_compare_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[4] = const_compare_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[19] = const_compare_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[27] = const_concat_repl_wrapper_out_flat[19];
assign const_compare_wrapper_in_flat[19] = const_conditional_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[1] = const_logic_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[1] = const_logic_wrapper_out_flat[16];
assign const_partselect_wrapper_in_flat[12] = const_logic_wrapper_out_flat[17];
assign const_arith_wrapper_in_flat[7] = const_nested_wrapper_out_flat[3];
...
assign const_reduce_wrapper_in_flat[1] = const_shift_wrapper_out_flat[8];
