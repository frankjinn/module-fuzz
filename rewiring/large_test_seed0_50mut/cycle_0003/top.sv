...
assign const_compare_wrapper_in_flat[13] = const_arith_wrapper_out_flat[36];
assign const_reduce_wrapper_in_flat[0] = const_compare_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[16];
assign const_nested_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[10];
assign const_logic_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[16];
assign const_nested_wrapper_in_flat[26] = const_logic_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[2] = const_logic_wrapper_out_flat[16];
...
assign const_logic_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[1] = const_shift_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[5] = const_shift_wrapper_out_flat[14];
