...
assign const_partselect_wrapper_in_flat[19] = in_flat[130];
...
assign const_shift_wrapper_in_flat[2] = in_flat[134];
...
assign const_conditional_wrapper_in_flat[29] = const_arith_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[3] = const_arith_wrapper_out_flat[35];
assign const_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[36];
assign const_partselect_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[17];
assign const_nested_wrapper_in_flat[11] = const_logic_wrapper_out_flat[4];
...
assign const_compare_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[7] = const_shift_wrapper_out_flat[16];
