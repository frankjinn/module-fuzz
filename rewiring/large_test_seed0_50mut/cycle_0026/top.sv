...
assign const_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[25] = const_arith_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[1] = const_compare_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[30] = const_concat_repl_wrapper_out_flat[1];
...
assign const_compare_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[15];
assign const_partselect_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[15];
assign const_logic_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[17];
assign const_shift_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[21];
assign const_compare_wrapper_in_flat[18] = const_logic_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[5] = const_logic_wrapper_out_flat[16];
assign const_shift_wrapper_in_flat[5] = const_logic_wrapper_out_flat[17];
assign const_logic_wrapper_in_flat[3] = const_nested_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[0] = const_nested_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[9] = const_nested_wrapper_out_flat[2];
...
assign const_compare_wrapper_in_flat[21] = const_shift_wrapper_out_flat[16];
