...
assign const_conditional_wrapper_in_flat[16] = const_arith_wrapper_out_flat[31];
assign const_shift_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[19];
assign const_compare_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[19];
