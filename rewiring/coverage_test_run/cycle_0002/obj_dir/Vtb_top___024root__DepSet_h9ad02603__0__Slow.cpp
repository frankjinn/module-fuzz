...
#endif
            VL_FATAL_MT("/opt/module-fuzz/rewiring/coverage_test_run/cycle_0002/tb_top.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb_top___024root___ctor_var_reset(Vtb_top___024root* vlSelf) {
    ...
    vlSelf->tb_top__DOT__dut__DOT__const_shift_wrapper_in_flat = VL_SCOPED_RAND_RESET_I(11, __VscopeHash, 6331654070474289026ull);
    ...
    vlSelf->tb_top__DOT__dut__DOT__u_const_logic_wrapper__DOT__or_c = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 9089648262316714970ull);
