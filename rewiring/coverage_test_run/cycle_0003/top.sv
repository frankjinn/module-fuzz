...
assign const_compare_wrapper_in_flat[9] = const_arith_wrapper_out_flat[23];
assign const_nested_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[18] = const_conditional_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[0] = const_logic_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[16] = const_shift_wrapper_out_flat[15];
