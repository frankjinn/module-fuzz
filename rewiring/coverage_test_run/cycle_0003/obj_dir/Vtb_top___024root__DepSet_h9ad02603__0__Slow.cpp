...
#endif
            VL_FATAL_MT("/opt/module-fuzz/rewiring/coverage_test_run/cycle_0003/tb_top.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb_top___024root___ctor_var_reset(Vtb_top___024root* vlSelf) {
    ...
    VL_SCOPED_RAND_RESET_W(151, vlSelf->tb_top__DOT__in_flat, __VscopeHash, 1463764839160097536ull);
    ...
    vlSelf->tb_top__DOT__dut__DOT__const_reduce_wrapper_in_flat = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 12080506985396606966ull);
    vlSelf->tb_top__DOT__dut__DOT__u_const_arith_wrapper__DOT__prod_c = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 823997307405649317ull);
    ...
    vlSelf->tb_top__DOT__dut__DOT__u_const_conditional_wrapper__DOT__cond3_c = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 13990406647898055840ull);
    vlSelf->tb_top__DOT__dut__DOT__u_const_logic_wrapper__DOT__lor_c = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13961213155567204392ull);
    vlSelf->tb_top__DOT__dut__DOT__u_const_shift_wrapper__DOT__shr_c = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 9645537226813113221ull);
    vlSelf->__VdfgRegularize_h3c5bdd75_0_0 = VL_SCOPED_RAND_RESET_I(18, __VscopeHash, 17939933138940668268ull);
    vlSelf->__VdfgRegularize_h3c5bdd75_0_1 = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 8906987226437233892ull);
