...
#endif
            VL_FATAL_MT("/opt/module-fuzz/rewiring/coverage_test_run/cycle_0004/tb_top.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb_top___024root___ctor_var_reset(Vtb_top___024root* vlSelf) {
    ...
    vlSelf->tb_top__DOT__dut__DOT__u_const_shift_wrapper__DOT__ashr_c = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 6017023681853278997ull);
