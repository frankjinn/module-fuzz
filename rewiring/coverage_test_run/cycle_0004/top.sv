...
assign const_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[6] = const_arith_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[16] = const_shift_wrapper_out_flat[7];
