...
assign const_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[25] = const_arith_wrapper_out_flat[25];
assign const_logic_wrapper_in_flat[5] = const_arith_wrapper_out_flat[27];
assign const_arith_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[3];
