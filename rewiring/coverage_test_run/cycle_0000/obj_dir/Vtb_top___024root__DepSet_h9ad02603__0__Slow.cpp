...
#endif
            VL_FATAL_MT("/opt/module-fuzz/rewiring/coverage_test_run/cycle_0000/tb_top.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb_top___024root___ctor_var_reset(Vtb_top___024root* vlSelf) {
    ...
    vlSelf->tb_top__DOT__dut__DOT__const_concat_repl_wrapper_in_flat = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 16697405034033368748ull);
    vlSelf->tb_top__DOT__dut__DOT__const_reduce_wrapper_in_flat = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 12080506985396606966ull);
    vlSelf->tb_top__DOT__dut__DOT__u_const_arith_wrapper__DOT__diff_c = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 13263315874112689673ull);
    ...
    vlSelf->__VdfgRegularize_h3c5bdd75_0_0 = VL_SCOPED_RAND_RESET_I(6, __VscopeHash, 17939933138940668268ull);
