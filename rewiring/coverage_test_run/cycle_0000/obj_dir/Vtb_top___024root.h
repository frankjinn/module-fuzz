...
class alignas(VL_CACHE_LINE_BYTES) Vtb_top___024root final : public VerilatedModule {
  public:
    ...
    CData/*3:0*/ tb_top__DOT__dut__DOT__const_reduce_wrapper_in_flat;
    CData/*7:0*/ tb_top__DOT__dut__DOT__u_const_arith_wrapper__DOT__diff_c;
    CData/*7:0*/ tb_top__DOT__dut__DOT__u_const_arith_wrapper__DOT__rem_c;
    CData/*7:0*/ tb_top__DOT__dut__DOT__u_const_conditional_wrapper__DOT__cond1_c;
    CData/*7:0*/ tb_top__DOT__dut__DOT__u_const_conditional_wrapper__DOT__cond3_c;
    CData/*5:0*/ __VdfgRegularize_h3c5bdd75_0_0;
    ...
    SData/*9:0*/ tb_top__DOT__dut__DOT__const_concat_repl_wrapper_in_flat;
