...
VL_ATTR_COLD void Vtb_top___024root___eval_initial__TOP(Vtb_top___024root* vlSelf) {
    ...
    vlSelfRef.tb_top__DOT__cycles = 0x14U;
    ...
    VL_PRINTF_MT("-Info: /opt/module-fuzz/rewiring/coverage_test_run/cycle_0000/tb_top.sv:27: $dumpvar ignored, as Verilated without --trace\n");
}
