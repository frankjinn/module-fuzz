...
VL_INLINE_OPT VlCoroutine Vtb_top___024root___eval_initial__TOP__Vtiming__0(Vtb_top___024root* vlSelf) {
    ...
    co_await vlSelfRef.__VtrigSched_h1586d63e__0.trigger(0U, 
                                                         nullptr, 
                                                         "@(negedge tb_top.clk)", 
                                                         "/opt/module-fuzz/rewiring/coverage_test_run/cycle_0000/tb_top.sv", 
                                                         48);
    tb_top__DOT__i = 0U;
    while (VL_LTS_III(32, tb_top__DOT__i, vlSelfRef.tb_top__DOT__cycles)) {
        ...
        vlSelfRef.tb_top__DOT__in_flat[4U] = (0x7fffffU 
                                              & __Vtemp_2[4U]);
        tb_top__DOT__i = ((IData)(1U) + tb_top__DOT__i);
    }
    VL_WRITEF_NX("TB_SIM_OK cycles=%0d\n",0,32,vlSelfRef.tb_top__DOT__cycles);
    VL_FINISH_MT("/opt/module-fuzz/rewiring/coverage_test_run/cycle_0000/tb_top.sv", 54, "");
}
...
VL_INLINE_OPT void Vtb_top___024root___act_comb__TOP__0(Vtb_top___024root* vlSelf) {
    ...
    vlSelfRef.tb_top__DOT__dut__DOT__u_const_conditional_wrapper__DOT__cond1_c 
        = (0xffU & ((0x20000U & vlSelfRef.tb_top__DOT__in_flat[1U])
                     ? ((vlSelfRef.tb_top__DOT__in_flat[2U] 
                         << 0x16U) | (vlSelfRef.tb_top__DOT__in_flat[2U] 
                                      >> 0xaU)) : (
                                                   (vlSelfRef.tb_top__DOT__in_flat[2U] 
                                                    << 0x1eU) 
                                                   | (vlSelfRef.tb_top__DOT__in_flat[2U] 
                                                      >> 2U))));
    vlSelfRef.tb_top__DOT__dut__DOT__u_const_conditional_wrapper__DOT__cond3_c 
        = (0xffU & (VL_LTS_III(8, (0xffU & ((vlSelfRef.tb_top__DOT__in_flat[2U] 
                                             << 6U) 
                                            | (vlSelfRef.tb_top__DOT__in_flat[1U] 
                                               >> 0x1aU))), 
                               (0xffU & (vlSelfRef.tb_top__DOT__in_flat[1U] 
                                         >> 0x12U)))
                     ? ((vlSelfRef.tb_top__DOT__in_flat[2U] 
                         << 0x16U) | (vlSelfRef.tb_top__DOT__in_flat[2U] 
                                      >> 0xaU)) : (
                                                   ...
                                                   | (vlSelfRef.tb_top__DOT__in_flat[2U] 
                                                      >> 2U))));
    vlSelfRef.tb_top__DOT__dut__DOT__const_arith_wrapper_in_flat 
        = ((0x8000U & (vlSelfRef.tb_top__DOT__in_flat[0U] 
                       << 1U)) | ((0x4000U & ((IData)(vlSelfRef.tb_top__DOT__dut__DOT__u_const_conditional_wrapper__DOT__cond3_c) 
                                              << 0xbU)) 
                                  | (0x3fffU & vlSelfRef.tb_top__DOT__in_flat[0U])));
    vlSelfRef.tb_top__DOT__dut__DOT__u_const_arith_wrapper__DOT__diff_c 
        = (0xffU & (((IData)(vlSelfRef.tb_top__DOT__dut__DOT__const_arith_wrapper_in_flat) 
                     >> 8U) - vlSelfRef.tb_top__DOT__in_flat[0U]));
    vlSelfRef.tb_top__DOT__dut__DOT__u_const_arith_wrapper__DOT__rem_c 
        = ((0U != (0xffU & vlSelfRef.tb_top__DOT__in_flat[0U]))
            ? (0xffU & VL_MODDIV_III(8, (0xffU & ((IData)(vlSelfRef.tb_top__DOT__dut__DOT__const_arith_wrapper_in_flat) 
                                                  >> 8U)), 
                                     (0xffU & vlSelfRef.tb_top__DOT__in_flat[0U])))
            : 0U);
    vlSelfRef.__VdfgRegularize_h3c5bdd75_0_0 = ((0x20U 
                                                 & ((IData)(vlSelfRef.tb_top__DOT__dut__DOT__u_const_arith_wrapper__DOT__diff_c) 
                                                    << 2U)) 
                                                | (0x1fU 
                                                   & (vlSelfRef.tb_top__DOT__in_flat[2U] 
                                                      >> 0x12U)));
    vlSelfRef.tb_top__DOT__dut__DOT__const_reduce_wrapper_in_flat 
        = ((8U & (vlSelfRef.tb_top__DOT__in_flat[4U] 
                  >> 8U)) | ((4U & ((IData)(vlSelfRef.tb_top__DOT__dut__DOT__u_const_arith_wrapper__DOT__rem_c) 
                                    >> 3U)) | (3U & 
                                               (vlSelfRef.tb_top__DOT__in_flat[4U] 
                                                >> 9U))));
    vlSelfRef.tb_top__DOT__dut__DOT__const_concat_repl_wrapper_in_flat 
        = ((0x380U & (vlSelfRef.tb_top__DOT__in_flat[1U] 
                      >> 6U)) | (((0xfU == (IData)(vlSelfRef.tb_top__DOT__dut__DOT__const_reduce_wrapper_in_flat)) 
                                  << 6U) | (0x3fU & 
                                            (vlSelfRef.tb_top__DOT__in_flat[1U] 
                                             >> 7U))));
}
...
VL_INLINE_OPT void Vtb_top___024root___nba_sequent__TOP__0(Vtb_top___024root* vlSelf) {
    ...
    tb_top__DOT__unnamedblk1__DOT__i = 0x96U;
    while (VL_LTES_III(32, 0U, tb_top__DOT__unnamedblk1__DOT__i)) {
        VL_WRITEF_NX("%0#",0,1,((0x96U >= (0xffU & tb_top__DOT__unnamedblk1__DOT__i)) 
                                                       ...
                                                       & (((0x10000U 
                                                           ...
                                                           ((vlSelfRef.tb_top__DOT__in_flat[2U] 
                                                            ...
                                                            | (vlSelfRef.tb_top__DOT__in_flat[1U] 
                                                               >> 0x1aU))) 
                                                          << 8U)) 
                                                      | (IData)(vlSelfRef.tb_top__DOT__dut__DOT__u_const_conditional_wrapper__DOT__cond3_c))))) 
                                  << 0x26U) | (((QData)((IData)(
                                                                ((0xff00U 
                                                                  & ((IData)(vlSelfRef.tb_top__DOT__dut__DOT__const_concat_repl_wrapper_in_flat) 
                                                                     << 6U)) 
                                                                 | (0xffU 
                                                                    & ((0xf0U 
                                                                        & ((IData)(vlSelfRef.tb_top__DOT__dut__DOT__const_concat_repl_wrapper_in_flat) 
                                                                         ...
                                                                         | ((((0xfU 
                                                                            ...
                                                                            | (0xffU 
                                                                               & (((IData)(vlSelfRef.tb_top__DOT__dut__DOT__const_arith_wrapper_in_flat) 
                                                                                ...
                                                                                vlSelfRef.tb_top__DOT__in_flat[0U])))))))))) 
                                 >> 0x20U));
        __Vtemp_2[0U] = ((((IData)(vlSelfRef.tb_top__DOT__dut__DOT__u_const_arith_wrapper__DOT__diff_c) 
                           << 0x18U) | (0xff0000U & 
                                        (((0xffU & 
                                           ((IData)(vlSelfRef.tb_top__DOT__dut__DOT__const_arith_wrapper_in_flat) 
                                            >> 8U)) 
                         ...
                         | ((((0U != (0xffU & vlSelfRef.tb_top__DOT__in_flat[0U]))
                               ? (0xffU & VL_DIV_III(8, 
                                                     ...
                                                     (0xffU 
                                                      & vlSelfRef.tb_top__DOT__in_flat[0U])))
                               : 0U) << 8U) | (IData)(vlSelfRef.tb_top__DOT__dut__DOT__u_const_arith_wrapper__DOT__rem_c)));
                                                                 ...
                                                                 (((0x1e000U 
                                                                    & (((vlSelfRef.tb_top__DOT__in_flat[2U] 
                                                                        ...
                                                                        | (0x3fe000U 
                                                                           & (vlSelfRef.tb_top__DOT__in_flat[2U] 
                                                                              >> 0xaU))) 
                                                                       & ((IData)(vlSelfRef.__VdfgRegularize_h3c5bdd75_0_0) 
                                                                          << 0xbU))) 
                                                                   | (0x1e00U 
                                                                      & (((vlSelfRef.tb_top__DOT__in_flat[2U] 
                                                                           << 0x12U) 
...
#endif
            VL_FATAL_MT("/opt/module-fuzz/rewiring/coverage_test_run/cycle_0000/tb_top.sv", 3, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("/opt/module-fuzz/rewiring/coverage_test_run/cycle_0000/tb_top.sv", 3, "", "Active region did not converge.");
            }
