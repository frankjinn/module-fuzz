...
assign const_partselect_wrapper_in_flat[19] = const_logic_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[17] = const_logic_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[19] = const_partselect_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[18] = const_reduce_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[13] = const_shift_wrapper_out_flat[11];
