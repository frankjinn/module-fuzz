...
#endif
            VL_FATAL_MT("/opt/module-fuzz/rewiring/coverage_test_run/cycle_0001/tb_top.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb_top___024root___ctor_var_reset(Vtb_top___024root* vlSelf) {
    ...
    vlSelf->tb_top__DOT__dut__DOT__u_const_logic_wrapper__DOT__xor_c = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 16754366338550986972ull);
    vlSelf->tb_top__DOT__dut__DOT__u_const_partselect_wrapper__DOT__sel2_c = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 1851362047178611868ull);
    ...
    vlSelf->__VdfgRegularize_h3c5bdd75_0_0 = VL_SCOPED_RAND_RESET_I(19, __VscopeHash, 17939933138940668268ull);
