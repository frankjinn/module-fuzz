...
assign arithmetic_wrapper_in_flat[0] = in_flat[154];
assign arithmetic_reduce_wrapper_in_flat[0] = in_flat[155];
assign arithmetic_reduce_wrapper_in_flat[1] = in_flat[156];
assign arithmetic_reduce_wrapper_in_flat[2] = in_flat[157];
assign arithmetic_reduce_wrapper_in_flat[3] = in_flat[158];
assign arithmetic_reduce_wrapper_in_flat[4] = in_flat[159];
assign arithmetic_reduce_wrapper_in_flat[5] = in_flat[160];
assign arithmetic_reduce_wrapper_in_flat[6] = in_flat[161];
assign arithmetic_reduce_wrapper_in_flat[7] = in_flat[162];
assign arithmetic_reduce_wrapper_in_flat[8] = in_flat[163];
assign arithmetic_reduce_wrapper_in_flat[9] = in_flat[164];
assign arithmetic_reduce_wrapper_in_flat[10] = in_flat[165];
assign arithmetic_reduce_wrapper_in_flat[11] = in_flat[166];
assign arithmetic_reduce_wrapper_in_flat[12] = in_flat[167];
assign arithmetic_reduce_wrapper_in_flat[13] = in_flat[168];
assign arithmetic_reduce_wrapper_in_flat[14] = in_flat[169];
assign arithmetic_reduce_wrapper_in_flat[15] = in_flat[170];
assign bitwise_logic_wrapper_in_flat[0] = in_flat[171];
assign bitwise_logic_wrapper_in_flat[1] = in_flat[172];
assign bitwise_logic_wrapper_in_flat[2] = in_flat[173];
assign bitwise_logic_wrapper_in_flat[3] = in_flat[174];
assign bitwise_logic_wrapper_in_flat[4] = in_flat[175];
assign bitwise_logic_wrapper_in_flat[5] = in_flat[176];
assign bitwise_logic_wrapper_in_flat[6] = in_flat[177];
assign bitwise_logic_wrapper_in_flat[7] = in_flat[178];
assign bitwise_logic_wrapper_in_flat[8] = in_flat[179];
assign bitwise_logic_wrapper_in_flat[9] = in_flat[180];
assign bitwise_logic_wrapper_in_flat[10] = in_flat[181];
assign bitwise_logic_wrapper_in_flat[11] = in_flat[182];
assign bitwise_logic_wrapper_in_flat[12] = in_flat[183];
assign bitwise_logic_wrapper_in_flat[13] = in_flat[184];
assign bitwise_logic_wrapper_in_flat[14] = in_flat[185];
assign bitwise_logic_wrapper_in_flat[15] = in_flat[186];
assign bitwise_reduce_wrapper_in_flat[0] = in_flat[187];
assign bitwise_reduce_wrapper_in_flat[1] = in_flat[188];
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[189];
assign bitwise_reduce_wrapper_in_flat[3] = in_flat[190];
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[191];
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[192];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[193];
assign bitwise_reduce_wrapper_in_flat[7] = in_flat[194];
assign concat_repl_wrapper_in_flat[0] = in_flat[195];
assign concat_repl_wrapper_in_flat[1] = in_flat[196];
assign concat_repl_wrapper_in_flat[2] = in_flat[197];
assign concat_repl_wrapper_in_flat[3] = in_flat[198];
assign concat_repl_wrapper_in_flat[4] = in_flat[199];
assign constant_wrapper_in_flat[0] = in_flat[200];
assign logical_op_wrapper_in_flat[1] = in_flat[201];
assign reduce_case_wrapper_in_flat[0] = in_flat[202];
assign reduce_case_wrapper_in_flat[1] = in_flat[203];
assign reduce_case_wrapper_in_flat[2] = in_flat[204];
assign reduce_case_wrapper_in_flat[3] = in_flat[205];
assign reduce_case_wrapper_in_flat[4] = in_flat[206];
assign reduce_case_wrapper_in_flat[5] = in_flat[207];
assign reduce_case_wrapper_in_flat[6] = in_flat[208];
assign reduce_case_wrapper_in_flat[7] = in_flat[209];
...
assign arith_wrapper_in_flat[0] = in_flat[248];
assign array_wrapper_in_flat[0] = in_flat[249];
assign array_wrapper_in_flat[1] = in_flat[250];
assign array_wrapper_in_flat[2] = in_flat[251];
assign array_wrapper_in_flat[3] = in_flat[252];
assign array_wrapper_in_flat[4] = in_flat[253];
assign array_wrapper_in_flat[5] = in_flat[254];
assign array_wrapper_in_flat[6] = in_flat[255];
assign array_wrapper_in_flat[7] = in_flat[256];
assign array_wrapper_in_flat[8] = in_flat[257];
assign array_wrapper_in_flat[9] = in_flat[258];
assign array_wrapper_in_flat[10] = in_flat[259];
assign array_wrapper_in_flat[11] = in_flat[260];
assign array_wrapper_in_flat[12] = in_flat[261];
assign array_wrapper_in_flat[13] = in_flat[262];
assign array_wrapper_in_flat[14] = in_flat[263];
assign array_wrapper_in_flat[15] = in_flat[264];
assign array_wrapper_in_flat[16] = in_flat[265];
assign array_wrapper_in_flat[17] = in_flat[266];
assign cast_wrapper_in_flat[0] = in_flat[267];
assign cast_wrapper_in_flat[1] = in_flat[268];
...
assign enum_wrapper_in_flat[0] = in_flat[286];
assign enum_wrapper_in_flat[1] = in_flat[287];
assign enum_wrapper_in_flat[2] = in_flat[288];
assign logic_wrapper_in_flat[0] = in_flat[289];
assign logic_wrapper_in_flat[1] = in_flat[290];
assign logic_wrapper_in_flat[2] = in_flat[291];
assign logic_wrapper_in_flat[3] = in_flat[292];
assign logic_wrapper_in_flat[5] = in_flat[293];
assign logic_wrapper_in_flat[6] = in_flat[294];
assign logic_wrapper_in_flat[7] = in_flat[295];
assign param_wrapper_in_flat[0] = in_flat[296];
assign partselect_wrapper_in_flat[0] = in_flat[297];
assign partselect_wrapper_in_flat[1] = in_flat[298];
assign partselect_wrapper_in_flat[2] = in_flat[299];
assign partselect_wrapper_in_flat[3] = in_flat[300];
assign partselect_wrapper_in_flat[4] = in_flat[301];
assign partselect_wrapper_in_flat[5] = in_flat[302];
assign partselect_wrapper_in_flat[6] = in_flat[303];
assign partselect_wrapper_in_flat[7] = in_flat[304];
assign partselect_wrapper_in_flat[8] = in_flat[305];
assign partselect_wrapper_in_flat[9] = in_flat[306];
assign partselect_wrapper_in_flat[10] = in_flat[307];
assign partselect_wrapper_in_flat[12] = in_flat[308];
assign partselect_wrapper_in_flat[13] = in_flat[309];
assign partselect_wrapper_in_flat[14] = in_flat[310];
assign partselect_wrapper_in_flat[15] = in_flat[311];
assign partselect_wrapper_in_flat[16] = in_flat[312];
assign partselect_wrapper_in_flat[17] = in_flat[313];
assign partselect_wrapper_in_flat[18] = in_flat[314];
assign struct_wrapper_in_flat[0] = in_flat[315];
assign struct_wrapper_in_flat[1] = in_flat[316];
assign struct_wrapper_in_flat[2] = in_flat[317];
assign struct_wrapper_in_flat[3] = in_flat[318];
assign struct_wrapper_in_flat[4] = in_flat[319];
assign struct_wrapper_in_flat[5] = in_flat[320];
assign struct_wrapper_in_flat[6] = in_flat[321];
assign struct_wrapper_in_flat[7] = in_flat[322];
assign struct_wrapper_in_flat[8] = in_flat[323];
assign struct_wrapper_in_flat[9] = in_flat[324];
assign struct_wrapper_in_flat[10] = in_flat[325];
assign struct_wrapper_in_flat[11] = in_flat[326];
assign union_wrapper_in_flat[0] = in_flat[327];
assign union_wrapper_in_flat[1] = in_flat[328];
assign union_wrapper_in_flat[2] = in_flat[329];
assign union_wrapper_in_flat[3] = in_flat[330];
assign union_wrapper_in_flat[4] = in_flat[331];
assign union_wrapper_in_flat[5] = in_flat[332];
assign union_wrapper_in_flat[6] = in_flat[333];
assign union_wrapper_in_flat[7] = in_flat[334];
assign union_wrapper_in_flat[8] = in_flat[335];
assign union_wrapper_in_flat[9] = in_flat[336];
assign union_wrapper_in_flat[10] = in_flat[337];
assign union_wrapper_in_flat[11] = in_flat[338];
assign union_wrapper_in_flat[12] = in_flat[339];
assign union_wrapper_in_flat[13] = in_flat[340];
assign union_wrapper_in_flat[14] = in_flat[341];
assign union_wrapper_in_flat[15] = in_flat[342];

// Internal MTM connections (module-to-module)
assign relational_wrapper_in_flat[3] = const_arith_wrapper_out_flat[32];
assign const_arith_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[3];
assign logic_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[9];
assign enum_wrapper_in_flat[3] = const_shift_wrapper_out_flat[0];
assign cast_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[0];
assign concat_repl_wrapper_in_flat[5] = constant_wrapper_out_flat[66];
assign logical_op_wrapper_in_flat[0] = cast_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[20] = enum_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[11] = union_wrapper_out_flat[8];
