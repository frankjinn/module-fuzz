...
assign const_logic_wrapper_in_flat[2] = in_flat[81];
assign const_logic_wrapper_in_flat[3] = in_flat[82];
assign const_logic_wrapper_in_flat[4] = in_flat[83];
assign const_logic_wrapper_in_flat[5] = in_flat[84];
assign const_logic_wrapper_in_flat[6] = in_flat[85];
assign const_logic_wrapper_in_flat[7] = in_flat[86];
...
assign const_nested_wrapper_in_flat[2] = in_flat[90];
assign const_nested_wrapper_in_flat[3] = in_flat[91];
assign const_nested_wrapper_in_flat[4] = in_flat[92];
assign const_nested_wrapper_in_flat[5] = in_flat[93];
assign const_nested_wrapper_in_flat[6] = in_flat[94];
assign const_nested_wrapper_in_flat[7] = in_flat[95];
assign const_nested_wrapper_in_flat[8] = in_flat[96];
assign const_nested_wrapper_in_flat[9] = in_flat[97];
assign const_nested_wrapper_in_flat[10] = in_flat[98];
assign const_nested_wrapper_in_flat[11] = in_flat[99];
...
assign const_partselect_wrapper_in_flat[12] = in_flat[122];
...
assign const_partselect_wrapper_in_flat[19] = in_flat[128];
assign const_reduce_wrapper_in_flat[1] = in_flat[129];
assign const_reduce_wrapper_in_flat[3] = in_flat[130];
...
assign const_shift_wrapper_in_flat[5] = in_flat[136];
...
assign const_logic_wrapper_in_flat[8] = const_arith_wrapper_out_flat[10];
assign const_compare_wrapper_in_flat[0] = const_arith_wrapper_out_flat[19];
assign const_partselect_wrapper_in_flat[15] = const_arith_wrapper_out_flat[39];
assign const_nested_wrapper_in_flat[12] = const_compare_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[10];
assign const_logic_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[18];
assign const_nested_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[20];
assign const_reduce_wrapper_in_flat[0] = const_logic_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[3] = const_logic_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[12] = const_reduce_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[13] = const_shift_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[20] = const_shift_wrapper_out_flat[15];
assign const_partselect_wrapper_in_flat[8] = const_shift_wrapper_out_flat[15];
