...
assign const_partselect_wrapper_in_flat[5] = const_arith_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[3] = const_arith_wrapper_out_flat[12];
assign const_reduce_wrapper_in_flat[3] = const_arith_wrapper_out_flat[30];
assign const_shift_wrapper_in_flat[5] = const_arith_wrapper_out_flat[37];
assign const_shift_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[13];
assign const_arith_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[17];
assign const_compare_wrapper_in_flat[11] = const_logic_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[8] = const_nested_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[0] = const_nested_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[17] = const_partselect_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[20] = const_reduce_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[1] = const_shift_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[2] = const_shift_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[12] = const_shift_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[5] = const_shift_wrapper_out_flat[15];
