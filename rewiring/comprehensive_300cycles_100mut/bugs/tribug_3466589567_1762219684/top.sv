...
assign const_concat_repl_wrapper_in_flat[2] = in_flat[29];
assign const_concat_repl_wrapper_in_flat[4] = in_flat[30];
assign const_concat_repl_wrapper_in_flat[5] = in_flat[31];
assign const_concat_repl_wrapper_in_flat[6] = in_flat[32];
assign const_concat_repl_wrapper_in_flat[8] = in_flat[33];
...
assign const_logic_wrapper_in_flat[6] = in_flat[73];
assign const_logic_wrapper_in_flat[7] = in_flat[74];
assign const_logic_wrapper_in_flat[8] = in_flat[75];
...
assign const_partselect_wrapper_in_flat[19] = in_flat[114];
assign const_reduce_wrapper_in_flat[0] = in_flat[115];
assign const_reduce_wrapper_in_flat[1] = in_flat[116];
assign const_reduce_wrapper_in_flat[2] = in_flat[117];
...
assign select_wrapper_in_flat[11] = in_flat[173];
...
assign width_struct_wrapper_in_flat[3] = in_flat[231];
...
assign width_union_wrapper_in_flat[4] = in_flat[240];
...
assign width_logic_wrapper_in_flat[2] = const_arith_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[6] = const_arith_wrapper_out_flat[7];
assign relational_wrapper_in_flat[7] = const_arith_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[4] = const_arith_wrapper_out_flat[22];
assign const_nested_wrapper_in_flat[10] = const_arith_wrapper_out_flat[32];
assign cast_wrapper_in_flat[5] = const_compare_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[8] = const_compare_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[18] = const_compare_wrapper_out_flat[4];
assign shift_wrapper_in_flat[4] = const_compare_wrapper_out_flat[5];
assign select_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[19] = const_concat_repl_wrapper_out_flat[5];
assign cast_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[12];
assign width_struct_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[21] = const_conditional_wrapper_out_flat[14];
assign const_arith_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[22];
assign shift_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[23];
assign const_concat_repl_wrapper_in_flat[3] = const_logic_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[15] = const_logic_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[7] = const_logic_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[5] = const_logic_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[12] = const_logic_wrapper_out_flat[9];
assign const_shift_wrapper_in_flat[2] = const_logic_wrapper_out_flat[14];
assign cast_wrapper_in_flat[3] = const_logic_wrapper_out_flat[16];
assign select_wrapper_in_flat[15] = const_logic_wrapper_out_flat[18];
assign conditional_wrapper_in_flat[7] = const_nested_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[3] = const_nested_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[1];
assign cast_wrapper_in_flat[8] = const_shift_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[1] = const_shift_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[5] = const_shift_wrapper_out_flat[8];
assign shift_wrapper_in_flat[0] = const_shift_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[6] = const_shift_wrapper_out_flat[8];
assign width_logic_wrapper_in_flat[6] = const_shift_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[13] = const_shift_wrapper_out_flat[13];
assign width_struct_wrapper_in_flat[11] = const_shift_wrapper_out_flat[19];
assign const_shift_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[5];
assign select_wrapper_in_flat[13] = arithmetic_reduce_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[14];
...
assign bitwise_logic_wrapper_in_flat[12] = relational_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[1] = relational_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[11] = select_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[0] = select_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[9] = select_wrapper_out_flat[2];
assign shift_wrapper_in_flat[7] = select_wrapper_out_flat[3];
assign cast_wrapper_in_flat[2] = shift_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[13] = shift_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[0] = shift_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[14] = array_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[7] = array_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[7] = array_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[9] = array_wrapper_out_flat[11];
assign arithmetic_reduce_wrapper_in_flat[4] = array_wrapper_out_flat[12];
assign numbers_concat_repl_wrapper_in_flat[4] = array_wrapper_out_flat[14];
assign bitwise_logic_wrapper_in_flat[10] = cast_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[1] = cast_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[18] = cast_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[1] = cast_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[2] = conditional_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[9] = partselect_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[5] = partselect_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[10] = width_struct_wrapper_out_flat[2];
assign cast_wrapper_in_flat[10] = width_struct_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[17] = width_struct_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[1] = width_struct_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[2] = width_union_wrapper_out_flat[8];
assign bitwise_logic_wrapper_in_flat[11] = width_union_wrapper_out_flat[9];
assign logical_op_wrapper_in_flat[0] = width_union_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[6] = width_logic_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[7] = width_logic_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[12] = numbers_concat_repl_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[12];
assign const_conditional_wrapper_in_flat[22] = numbers_concat_repl_wrapper_out_flat[14];
assign shift_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[17];
