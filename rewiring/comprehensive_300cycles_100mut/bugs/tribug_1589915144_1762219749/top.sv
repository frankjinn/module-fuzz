...
assign const_conditional_wrapper_in_flat[33] = in_flat[77];
assign const_logic_wrapper_in_flat[0] = in_flat[78];
assign const_logic_wrapper_in_flat[1] = in_flat[79];
assign const_logic_wrapper_in_flat[3] = in_flat[80];
assign const_logic_wrapper_in_flat[4] = in_flat[81];
assign const_logic_wrapper_in_flat[5] = in_flat[82];
...
assign const_nested_wrapper_in_flat[5] = in_flat[90];
assign const_nested_wrapper_in_flat[6] = in_flat[91];
...
assign const_nested_wrapper_in_flat[16] = in_flat[99];
assign const_nested_wrapper_in_flat[17] = in_flat[100];
...
assign const_partselect_wrapper_in_flat[1] = in_flat[109];
assign const_partselect_wrapper_in_flat[2] = in_flat[110];
...
assign bitwise_logic_wrapper_in_flat[6] = in_flat[151];
assign bitwise_logic_wrapper_in_flat[7] = in_flat[152];
...
assign relational_wrapper_in_flat[5] = in_flat[167];
assign relational_wrapper_in_flat[6] = in_flat[168];
assign relational_wrapper_in_flat[7] = in_flat[169];
...
assign select_wrapper_in_flat[16] = in_flat[184];
assign select_wrapper_in_flat[19] = in_flat[185];
assign shift_wrapper_in_flat[1] = in_flat[186];
assign shift_wrapper_in_flat[2] = in_flat[187];
assign shift_wrapper_in_flat[4] = in_flat[188];
assign shift_wrapper_in_flat[7] = in_flat[189];
assign shift_wrapper_in_flat[8] = in_flat[190];
assign shift_wrapper_in_flat[9] = in_flat[191];
assign array_wrapper_in_flat[0] = in_flat[192];
assign array_wrapper_in_flat[1] = in_flat[193];
...
assign array_wrapper_in_flat[6] = in_flat[197];
assign array_wrapper_in_flat[7] = in_flat[198];
assign array_wrapper_in_flat[8] = in_flat[199];
assign array_wrapper_in_flat[9] = in_flat[200];
assign array_wrapper_in_flat[10] = in_flat[201];
...
assign cast_wrapper_in_flat[0] = in_flat[208];
assign cast_wrapper_in_flat[1] = in_flat[209];
assign cast_wrapper_in_flat[2] = in_flat[210];
assign cast_wrapper_in_flat[3] = in_flat[211];
assign cast_wrapper_in_flat[4] = in_flat[212];
assign cast_wrapper_in_flat[5] = in_flat[213];
...
assign conditional_wrapper_in_flat[0] = in_flat[218];
assign conditional_wrapper_in_flat[1] = in_flat[219];
assign conditional_wrapper_in_flat[2] = in_flat[220];
assign conditional_wrapper_in_flat[3] = in_flat[221];
assign conditional_wrapper_in_flat[6] = in_flat[222];
assign conditional_wrapper_in_flat[7] = in_flat[223];
assign partselect_wrapper_in_flat[0] = in_flat[224];
assign partselect_wrapper_in_flat[1] = in_flat[225];
...
assign partselect_wrapper_in_flat[6] = in_flat[229];
assign partselect_wrapper_in_flat[7] = in_flat[230];
assign partselect_wrapper_in_flat[8] = in_flat[231];
assign partselect_wrapper_in_flat[9] = in_flat[232];
assign partselect_wrapper_in_flat[10] = in_flat[233];
assign partselect_wrapper_in_flat[11] = in_flat[234];
assign partselect_wrapper_in_flat[12] = in_flat[235];
assign partselect_wrapper_in_flat[13] = in_flat[236];
assign partselect_wrapper_in_flat[14] = in_flat[237];
assign partselect_wrapper_in_flat[15] = in_flat[238];
assign partselect_wrapper_in_flat[16] = in_flat[239];
assign partselect_wrapper_in_flat[18] = in_flat[240];
assign width_enum_wrapper_in_flat[1] = in_flat[241];
assign width_enum_wrapper_in_flat[2] = in_flat[242];
...
assign width_logic_wrapper_in_flat[0] = in_flat[262];
assign width_logic_wrapper_in_flat[1] = in_flat[263];
assign width_logic_wrapper_in_flat[2] = in_flat[264];
assign width_logic_wrapper_in_flat[3] = in_flat[265];
assign width_logic_wrapper_in_flat[6] = in_flat[266];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[267];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[268];

// Internal MTM connections (module-to-module)
assign const_concat_repl_wrapper_in_flat[4] = const_arith_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[2] = const_arith_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[23];
assign const_arith_wrapper_in_flat[9] = const_compare_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[2] = const_compare_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[11];
assign partselect_wrapper_in_flat[17] = const_concat_repl_wrapper_out_flat[17];
assign const_partselect_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[18];
assign shift_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[21];
assign width_struct_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[8];
assign array_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[10];
assign width_union_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[15];
assign conditional_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[21];
assign width_enum_wrapper_in_flat[0] = const_logic_wrapper_out_flat[9];
assign bitwise_reduce_wrapper_in_flat[7] = const_logic_wrapper_out_flat[17];
assign arithmetic_reduce_wrapper_in_flat[9] = const_nested_wrapper_out_flat[3];
assign select_wrapper_in_flat[17] = const_nested_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[8] = const_nested_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[4];
assign cast_wrapper_in_flat[7] = const_shift_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[4];
assign select_wrapper_in_flat[18] = arithmetic_reduce_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[13] = bitwise_logic_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[11];
assign array_wrapper_in_flat[16] = bitwise_logic_wrapper_out_flat[20];
assign shift_wrapper_in_flat[6] = logical_op_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[5] = relational_wrapper_out_flat[0];
assign shift_wrapper_in_flat[5] = relational_wrapper_out_flat[3];
assign select_wrapper_in_flat[0] = relational_wrapper_out_flat[4];
assign logical_op_wrapper_in_flat[0] = relational_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[18] = relational_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[2] = select_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[7] = select_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[2] = select_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[7] = select_wrapper_out_flat[7];
assign select_wrapper_in_flat[15] = shift_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[7] = shift_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[4] = shift_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[5] = shift_wrapper_out_flat[4];
...
assign const_nested_wrapper_in_flat[15] = array_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[17] = array_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[10] = array_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[0] = array_wrapper_out_flat[11];
assign numbers_concat_repl_wrapper_in_flat[0] = cast_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = cast_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[8] = cast_wrapper_out_flat[8];
assign relational_wrapper_in_flat[0] = cast_wrapper_out_flat[9];
assign shift_wrapper_in_flat[10] = cast_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[8] = conditional_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[11] = conditional_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[3] = partselect_wrapper_out_flat[0];
assign cast_wrapper_in_flat[6] = partselect_wrapper_out_flat[1];
assign relational_wrapper_in_flat[4] = partselect_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[4] = width_enum_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[1] = width_enum_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[1] = width_struct_wrapper_out_flat[9];
assign const_shift_wrapper_in_flat[8] = width_union_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[10] = width_union_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[6] = width_union_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[3] = width_union_wrapper_out_flat[9];
assign const_arith_wrapper_in_flat[13] = width_union_wrapper_out_flat[11];
assign bitwise_reduce_wrapper_in_flat[0] = width_logic_wrapper_out_flat[5];
assign relational_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[10];
assign shift_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[14];
assign arithmetic_reduce_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[16];
