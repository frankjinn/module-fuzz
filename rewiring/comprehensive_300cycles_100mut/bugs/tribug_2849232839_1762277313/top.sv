...
assign const_partselect_wrapper_in_flat[3] = in_flat[111];
assign const_partselect_wrapper_in_flat[5] = in_flat[112];
assign const_partselect_wrapper_in_flat[6] = in_flat[113];
assign const_partselect_wrapper_in_flat[7] = in_flat[114];
assign const_partselect_wrapper_in_flat[8] = in_flat[115];
assign const_partselect_wrapper_in_flat[9] = in_flat[116];
assign const_partselect_wrapper_in_flat[10] = in_flat[117];
...
assign const_shift_wrapper_in_flat[6] = in_flat[131];
...
assign arithmetic_reduce_wrapper_in_flat[6] = in_flat[140];
...
assign partselect_wrapper_in_flat[11] = in_flat[228];
...
assign width_struct_wrapper_in_flat[8] = const_arith_wrapper_out_flat[0];
assign relational_wrapper_in_flat[7] = const_arith_wrapper_out_flat[7];
assign select_wrapper_in_flat[16] = const_arith_wrapper_out_flat[11];
assign const_shift_wrapper_in_flat[7] = const_arith_wrapper_out_flat[15];
assign shift_wrapper_in_flat[8] = const_arith_wrapper_out_flat[16];
assign const_partselect_wrapper_in_flat[16] = const_arith_wrapper_out_flat[20];
assign numbers_concat_repl_wrapper_in_flat[4] = const_arith_wrapper_out_flat[22];
assign width_logic_wrapper_in_flat[3] = const_compare_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[2] = const_compare_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[32] = const_concat_repl_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[1];
assign relational_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[2];
assign shift_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[14];
assign select_wrapper_in_flat[19] = const_concat_repl_wrapper_out_flat[19];
assign arithmetic_reduce_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[22];
assign const_compare_wrapper_in_flat[5] = const_logic_wrapper_out_flat[2];
assign array_wrapper_in_flat[14] = const_logic_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[7] = const_logic_wrapper_out_flat[11];
assign bitwise_logic_wrapper_in_flat[2] = const_logic_wrapper_out_flat[16];
assign bitwise_reduce_wrapper_in_flat[3] = const_nested_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[16] = const_partselect_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[9] = const_shift_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[1] = const_shift_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[1] = const_shift_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[15] = const_shift_wrapper_out_flat[19];
assign relational_wrapper_in_flat[2] = const_shift_wrapper_out_flat[20];
assign width_enum_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[8];
assign const_conditional_wrapper_in_flat[11] = logical_op_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[2] = relational_wrapper_out_flat[0];
assign select_wrapper_in_flat[7] = relational_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[2] = select_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[20] = select_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[5] = select_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[1] = select_wrapper_out_flat[7];
assign logical_op_wrapper_in_flat[0] = select_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[1] = select_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[12] = select_wrapper_out_flat[8];
...
assign relational_wrapper_in_flat[5] = shift_wrapper_out_flat[13];
assign select_wrapper_in_flat[1] = shift_wrapper_out_flat[14];
assign cast_wrapper_in_flat[4] = array_wrapper_out_flat[9];
assign bitwise_reduce_wrapper_in_flat[5] = cast_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[8] = cast_wrapper_out_flat[5];
assign array_wrapper_in_flat[12] = conditional_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[1] = partselect_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[7] = partselect_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[0] = partselect_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[9] = partselect_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[4] = partselect_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[2] = width_enum_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[7] = width_enum_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[10] = width_enum_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[6] = width_struct_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[5] = width_struct_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[14] = width_struct_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = width_struct_wrapper_out_flat[10];
assign select_wrapper_in_flat[18] = width_struct_wrapper_out_flat[10];
assign const_reduce_wrapper_in_flat[3] = width_union_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[6] = width_union_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[11] = width_union_wrapper_out_flat[4];
assign array_wrapper_in_flat[9] = width_union_wrapper_out_flat[9];
assign width_union_wrapper_in_flat[6] = width_logic_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[3] = width_logic_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[1];
assign shift_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[3];
assign relational_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[3];
assign array_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[10];
assign select_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[15];
assign arithmetic_reduce_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[17];
