...
assign const_reduce_wrapper_in_flat[0] = in_flat[122];
...
assign const_shift_wrapper_in_flat[9] = in_flat[130];
...
assign arithmetic_reduce_wrapper_in_flat[11] = in_flat[140];
assign arithmetic_reduce_wrapper_in_flat[12] = in_flat[141];
...
assign bitwise_logic_wrapper_in_flat[5] = in_flat[148];
assign bitwise_logic_wrapper_in_flat[6] = in_flat[149];
assign bitwise_logic_wrapper_in_flat[7] = in_flat[150];
...
assign width_logic_wrapper_in_flat[4] = in_flat[259];
assign width_logic_wrapper_in_flat[5] = in_flat[260];
assign width_logic_wrapper_in_flat[6] = in_flat[261];
assign width_logic_wrapper_in_flat[7] = in_flat[262];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[263];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[264];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[265];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[266];

// Internal MTM connections (module-to-module)
assign width_union_wrapper_in_flat[10] = const_arith_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[21] = const_arith_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[3] = const_arith_wrapper_out_flat[8];
assign array_wrapper_in_flat[11] = const_arith_wrapper_out_flat[13];
assign shift_wrapper_in_flat[8] = const_arith_wrapper_out_flat[30];
assign const_shift_wrapper_in_flat[3] = const_arith_wrapper_out_flat[34];
assign array_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[7];
assign select_wrapper_in_flat[18] = const_concat_repl_wrapper_out_flat[18];
assign select_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[7];
assign shift_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[13];
assign const_arith_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[22];
assign const_reduce_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[23];
assign select_wrapper_in_flat[4] = const_nested_wrapper_out_flat[2];
assign array_wrapper_in_flat[10] = const_nested_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[0] = const_nested_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[13] = const_shift_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[18] = const_shift_wrapper_out_flat[11];
assign select_wrapper_in_flat[7] = const_shift_wrapper_out_flat[13];
assign numbers_concat_repl_wrapper_in_flat[4] = const_shift_wrapper_out_flat[16];
assign cast_wrapper_in_flat[4] = const_shift_wrapper_out_flat[22];
assign const_partselect_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[10] = arithmetic_reduce_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[16];
assign partselect_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[0];
assign relational_wrapper_in_flat[6] = bitwise_reduce_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[2] = logical_op_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[0] = logical_op_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[16] = logical_op_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[6] = logical_op_wrapper_out_flat[2];
assign cast_wrapper_in_flat[6] = relational_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[4] = relational_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[0] = relational_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[13] = relational_wrapper_out_flat[7];
assign cast_wrapper_in_flat[10] = select_wrapper_out_flat[5];
assign relational_wrapper_in_flat[5] = select_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[15] = shift_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[18] = shift_wrapper_out_flat[9];
assign width_union_wrapper_in_flat[3] = shift_wrapper_out_flat[10];
assign select_wrapper_in_flat[9] = array_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[2] = array_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[18] = array_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[0] = array_wrapper_out_flat[6];
assign logical_op_wrapper_in_flat[1] = cast_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[0] = cast_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[6] = conditional_wrapper_out_flat[0];
assign relational_wrapper_in_flat[3] = conditional_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[11] = conditional_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[0] = partselect_wrapper_out_flat[4];
assign relational_wrapper_in_flat[1] = partselect_wrapper_out_flat[6];
assign select_wrapper_in_flat[14] = partselect_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[2] = width_enum_wrapper_out_flat[2];
assign shift_wrapper_in_flat[2] = width_struct_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[11] = width_struct_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[0] = width_struct_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[8] = width_struct_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[2] = width_struct_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[6] = width_struct_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[29] = width_struct_wrapper_out_flat[11];
assign select_wrapper_in_flat[0] = width_union_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[2] = width_union_wrapper_out_flat[10];
assign array_wrapper_in_flat[14] = width_union_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[2] = width_union_wrapper_out_flat[15];
assign const_conditional_wrapper_in_flat[5] = width_logic_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[7] = width_logic_wrapper_out_flat[5];
assign cast_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[19] = numbers_concat_repl_wrapper_out_flat[9];
assign relational_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[9];
