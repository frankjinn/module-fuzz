...
assign arithmetic_reduce_wrapper_in_flat[3] = in_flat[125];
assign arithmetic_reduce_wrapper_in_flat[4] = in_flat[126];
...
assign bitwise_logic_wrapper_in_flat[15] = in_flat[144];
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[145];
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[146];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[147];
assign relational_wrapper_in_flat[0] = in_flat[148];
assign relational_wrapper_in_flat[2] = in_flat[149];
assign relational_wrapper_in_flat[3] = in_flat[150];
assign relational_wrapper_in_flat[4] = in_flat[151];
...
assign select_wrapper_in_flat[3] = in_flat[157];
assign select_wrapper_in_flat[5] = in_flat[158];
assign select_wrapper_in_flat[8] = in_flat[159];
assign select_wrapper_in_flat[9] = in_flat[160];
assign select_wrapper_in_flat[11] = in_flat[161];
assign select_wrapper_in_flat[12] = in_flat[162];
assign select_wrapper_in_flat[13] = in_flat[163];
assign select_wrapper_in_flat[14] = in_flat[164];
assign select_wrapper_in_flat[15] = in_flat[165];
assign select_wrapper_in_flat[16] = in_flat[166];
assign select_wrapper_in_flat[17] = in_flat[167];
assign shift_wrapper_in_flat[0] = in_flat[168];
assign shift_wrapper_in_flat[1] = in_flat[169];
assign shift_wrapper_in_flat[2] = in_flat[170];
assign shift_wrapper_in_flat[3] = in_flat[171];
assign shift_wrapper_in_flat[4] = in_flat[172];
assign shift_wrapper_in_flat[5] = in_flat[173];
assign shift_wrapper_in_flat[6] = in_flat[174];
assign shift_wrapper_in_flat[7] = in_flat[175];
assign shift_wrapper_in_flat[8] = in_flat[176];
assign shift_wrapper_in_flat[9] = in_flat[177];
assign shift_wrapper_in_flat[10] = in_flat[178];
assign array_wrapper_in_flat[0] = in_flat[179];
assign array_wrapper_in_flat[1] = in_flat[180];
assign array_wrapper_in_flat[2] = in_flat[181];
assign array_wrapper_in_flat[3] = in_flat[182];
assign array_wrapper_in_flat[4] = in_flat[183];
assign array_wrapper_in_flat[5] = in_flat[184];
assign array_wrapper_in_flat[6] = in_flat[185];
assign array_wrapper_in_flat[7] = in_flat[186];
...
assign array_wrapper_in_flat[15] = in_flat[192];
assign array_wrapper_in_flat[16] = in_flat[193];
assign array_wrapper_in_flat[17] = in_flat[194];
assign cast_wrapper_in_flat[0] = in_flat[195];
...
assign cast_wrapper_in_flat[6] = in_flat[199];
...
assign conditional_wrapper_in_flat[2] = in_flat[207];
...
assign array_wrapper_in_flat[14] = const_arith_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[3] = const_arith_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[3] = const_arith_wrapper_out_flat[18];
assign width_logic_wrapper_in_flat[0] = const_arith_wrapper_out_flat[26];
assign const_shift_wrapper_in_flat[1] = const_arith_wrapper_out_flat[27];
assign conditional_wrapper_in_flat[4] = const_arith_wrapper_out_flat[27];
assign bitwise_logic_wrapper_in_flat[6] = const_arith_wrapper_out_flat[27];
assign bitwise_logic_wrapper_in_flat[7] = const_compare_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[2];
assign select_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[12];
assign const_logic_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[13];
assign width_enum_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[20];
assign partselect_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[21];
assign const_partselect_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[18] = const_conditional_wrapper_out_flat[5];
assign logical_op_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[19];
assign bitwise_reduce_wrapper_in_flat[3] = const_logic_wrapper_out_flat[1];
assign select_wrapper_in_flat[18] = const_logic_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[1] = const_logic_wrapper_out_flat[12];
assign const_concat_repl_wrapper_in_flat[9] = const_nested_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[15] = const_nested_wrapper_out_flat[6];
assign select_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[9] = const_shift_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[6] = const_shift_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[8] = const_shift_wrapper_out_flat[15];
assign const_conditional_wrapper_in_flat[28] = const_shift_wrapper_out_flat[18];
assign select_wrapper_in_flat[19] = const_shift_wrapper_out_flat[19];
assign cast_wrapper_in_flat[4] = const_shift_wrapper_out_flat[19];
assign conditional_wrapper_in_flat[6] = const_shift_wrapper_out_flat[20];
assign select_wrapper_in_flat[10] = arithmetic_reduce_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[19] = bitwise_logic_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[8];
assign const_concat_repl_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[14];
assign select_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[17];
assign partselect_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[16] = bitwise_logic_wrapper_out_flat[21];
assign select_wrapper_in_flat[2] = logical_op_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[1] = select_wrapper_out_flat[1];
assign relational_wrapper_in_flat[1] = select_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[1] = select_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[5] = shift_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[4] = shift_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[18] = shift_wrapper_out_flat[2];
assign array_wrapper_in_flat[8] = shift_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[9] = shift_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[5] = shift_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[1] = shift_wrapper_out_flat[15];
...
assign numbers_concat_repl_wrapper_in_flat[3] = array_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[4] = array_wrapper_out_flat[11];
assign const_concat_repl_wrapper_in_flat[6] = cast_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[3] = cast_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[5] = cast_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[0] = cast_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[14] = cast_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[24] = conditional_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[7] = partselect_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[8] = partselect_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[0] = width_struct_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[23] = width_struct_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[4] = width_struct_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[18] = width_struct_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[9] = width_union_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[11] = width_union_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[7] = width_union_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[1] = width_union_wrapper_out_flat[15];
assign cast_wrapper_in_flat[2] = width_union_wrapper_out_flat[15];
assign const_shift_wrapper_in_flat[9] = width_logic_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[0] = width_logic_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[16] = width_logic_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[21] = numbers_concat_repl_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[14] = numbers_concat_repl_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[12] = numbers_concat_repl_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[10];
