...
assign cast_wrapper_in_flat[1] = in_flat[203];
assign cast_wrapper_in_flat[2] = in_flat[204];
assign cast_wrapper_in_flat[3] = in_flat[205];
...
assign width_struct_wrapper_in_flat[11] = in_flat[241];
...
assign width_logic_wrapper_in_flat[1] = in_flat[252];
assign width_logic_wrapper_in_flat[2] = in_flat[253];
assign width_logic_wrapper_in_flat[3] = in_flat[254];
...
assign numbers_concat_repl_wrapper_in_flat[4] = const_arith_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[4] = const_arith_wrapper_out_flat[12];
assign const_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[22];
assign logical_op_wrapper_in_flat[1] = const_arith_wrapper_out_flat[25];
assign bitwise_logic_wrapper_in_flat[0] = const_arith_wrapper_out_flat[33];
assign width_union_wrapper_in_flat[15] = const_compare_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[7] = const_compare_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[13];
assign bitwise_logic_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[15];
assign conditional_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[21];
assign const_partselect_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[11];
assign select_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[13];
assign width_struct_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[16];
assign const_logic_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[16];
assign arithmetic_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[20];
assign bitwise_reduce_wrapper_in_flat[5] = const_logic_wrapper_out_flat[14];
assign select_wrapper_in_flat[4] = const_logic_wrapper_out_flat[15];
assign arithmetic_reduce_wrapper_in_flat[0] = const_logic_wrapper_out_flat[17];
assign shift_wrapper_in_flat[10] = const_logic_wrapper_out_flat[18];
assign width_union_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[4];
assign relational_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[6];
assign cast_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[1];
assign select_wrapper_in_flat[2] = const_shift_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[0] = const_shift_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[15] = const_shift_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[2] = const_shift_wrapper_out_flat[13];
assign width_struct_wrapper_in_flat[3] = const_shift_wrapper_out_flat[15];
assign width_union_wrapper_in_flat[1] = const_shift_wrapper_out_flat[18];
assign cast_wrapper_in_flat[9] = const_shift_wrapper_out_flat[21];
assign const_conditional_wrapper_in_flat[9] = const_shift_wrapper_out_flat[22];
assign const_partselect_wrapper_in_flat[18] = arithmetic_reduce_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[7];
assign relational_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[16] = bitwise_logic_wrapper_out_flat[6];
assign shift_wrapper_in_flat[5] = bitwise_reduce_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[4] = relational_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[0] = relational_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[1] = relational_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[3] = select_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[11] = select_wrapper_out_flat[2];
assign cast_wrapper_in_flat[5] = select_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[0] = select_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[8] = select_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[14] = shift_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[10] = shift_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[19] = shift_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[3] = shift_wrapper_out_flat[12];
assign relational_wrapper_in_flat[4] = shift_wrapper_out_flat[14];
assign const_shift_wrapper_in_flat[7] = array_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[7] = array_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[1] = array_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[11] = array_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[5] = cast_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[0] = cast_wrapper_out_flat[7];
assign array_wrapper_in_flat[10] = partselect_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[9] = partselect_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[22] = partselect_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[8] = partselect_wrapper_out_flat[8];
assign cast_wrapper_in_flat[4] = width_enum_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[2] = width_struct_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[0] = width_struct_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[1] = width_struct_wrapper_out_flat[11];
assign const_arith_wrapper_in_flat[9] = width_union_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[0] = width_union_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[2] = width_union_wrapper_out_flat[9];
assign select_wrapper_in_flat[9] = width_union_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[1] = width_union_wrapper_out_flat[14];
assign conditional_wrapper_in_flat[3] = width_logic_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[13] = width_logic_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[23] = numbers_concat_repl_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[17];
