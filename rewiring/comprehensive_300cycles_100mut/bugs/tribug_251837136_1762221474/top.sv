...
assign width_enum_wrapper_in_flat[3] = in_flat[227];
...
assign const_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[3] = const_arith_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[10] = const_arith_wrapper_out_flat[8];
assign cast_wrapper_in_flat[5] = const_arith_wrapper_out_flat[24];
assign numbers_concat_repl_wrapper_in_flat[0] = const_arith_wrapper_out_flat[25];
assign select_wrapper_in_flat[1] = const_arith_wrapper_out_flat[28];
assign partselect_wrapper_in_flat[18] = const_arith_wrapper_out_flat[33];
assign width_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[39];
assign logical_op_wrapper_in_flat[0] = const_compare_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[4] = const_compare_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[9];
assign partselect_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[17];
assign conditional_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[18];
assign relational_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[21];
assign cast_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[22];
assign bitwise_logic_wrapper_in_flat[1] = const_logic_wrapper_out_flat[7];
assign cast_wrapper_in_flat[6] = const_logic_wrapper_out_flat[17];
assign const_compare_wrapper_in_flat[9] = const_logic_wrapper_out_flat[18];
assign cast_wrapper_in_flat[4] = const_nested_wrapper_out_flat[0];
assign relational_wrapper_in_flat[5] = const_nested_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[15] = const_partselect_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[22] = const_partselect_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[29] = const_shift_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[5] = const_shift_wrapper_out_flat[5];
assign relational_wrapper_in_flat[3] = const_shift_wrapper_out_flat[14];
assign cast_wrapper_in_flat[2] = const_shift_wrapper_out_flat[20];
assign const_shift_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[10] = arithmetic_reduce_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[13] = bitwise_logic_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[15] = bitwise_logic_wrapper_out_flat[12];
assign bitwise_reduce_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[12];
assign arithmetic_reduce_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[23];
assign const_partselect_wrapper_in_flat[14] = bitwise_reduce_wrapper_out_flat[0];
assign relational_wrapper_in_flat[1] = logical_op_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[1] = relational_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[20] = select_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[1] = select_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[4] = select_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[0] = select_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[4] = select_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[14] = shift_wrapper_out_flat[0];
assign select_wrapper_in_flat[2] = shift_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[6] = shift_wrapper_out_flat[5];
assign cast_wrapper_in_flat[10] = shift_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[1] = shift_wrapper_out_flat[15];
assign const_arith_wrapper_in_flat[9] = array_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[5] = array_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[7] = array_wrapper_out_flat[9];
assign shift_wrapper_in_flat[2] = array_wrapper_out_flat[10];
assign const_reduce_wrapper_in_flat[1] = array_wrapper_out_flat[12];
assign select_wrapper_in_flat[17] = array_wrapper_out_flat[12];
assign width_enum_wrapper_in_flat[2] = array_wrapper_out_flat[15];
assign bitwise_logic_wrapper_in_flat[9] = partselect_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[8] = partselect_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[26] = partselect_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[6] = width_enum_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[17] = width_enum_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[9] = width_struct_wrapper_out_flat[10];
assign const_logic_wrapper_in_flat[0] = width_struct_wrapper_out_flat[11];
assign array_wrapper_in_flat[6] = width_union_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[18] = width_union_wrapper_out_flat[1];
...
assign const_partselect_wrapper_in_flat[5] = width_union_wrapper_out_flat[15];
assign partselect_wrapper_in_flat[2] = width_logic_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[3] = width_logic_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[2] = width_logic_wrapper_out_flat[5];
assign cast_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[9];
assign partselect_wrapper_in_flat[17] = numbers_concat_repl_wrapper_out_flat[9];
assign select_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[9];
assign logical_op_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[11];
assign bitwise_logic_wrapper_in_flat[14] = numbers_concat_repl_wrapper_out_flat[14];
