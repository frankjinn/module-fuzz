...
assign const_nested_wrapper_in_flat[20] = const_arith_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[6] = const_arith_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[9] = const_arith_wrapper_out_flat[13];
assign width_enum_wrapper_in_flat[3] = const_arith_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[23] = const_arith_wrapper_out_flat[18];
assign bitwise_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[20];
assign array_wrapper_in_flat[12] = const_arith_wrapper_out_flat[34];
assign shift_wrapper_in_flat[0] = const_arith_wrapper_out_flat[39];
assign width_logic_wrapper_in_flat[4] = const_compare_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[1] = const_compare_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[17];
assign arithmetic_reduce_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[20];
assign const_nested_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[7];
assign relational_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[9];
assign width_enum_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[10];
assign const_logic_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[17];
assign array_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[18];
assign width_logic_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[21];
assign select_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[22];
assign cast_wrapper_in_flat[8] = const_logic_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[25] = const_logic_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[1] = const_logic_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[1] = const_logic_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[4] = const_logic_wrapper_out_flat[12];
assign logical_op_wrapper_in_flat[0] = const_logic_wrapper_out_flat[13];
assign relational_wrapper_in_flat[2] = const_logic_wrapper_out_flat[14];
assign width_union_wrapper_in_flat[6] = const_nested_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[24] = const_partselect_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[4] = const_shift_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[11] = const_shift_wrapper_out_flat[14];
assign const_conditional_wrapper_in_flat[27] = const_shift_wrapper_out_flat[15];
assign const_concat_repl_wrapper_in_flat[3] = const_shift_wrapper_out_flat[20];
assign select_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[4];
assign array_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[20] = arithmetic_reduce_wrapper_out_flat[8];
assign width_logic_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[22] = bitwise_logic_wrapper_out_flat[12];
assign bitwise_reduce_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[13];
assign shift_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[18];
assign const_partselect_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[20];
assign const_reduce_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[21];
assign select_wrapper_in_flat[17] = bitwise_logic_wrapper_out_flat[23];
assign conditional_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[15] = logical_op_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[1] = select_wrapper_out_flat[3];
assign relational_wrapper_in_flat[3] = select_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[2] = select_wrapper_out_flat[5];
assign array_wrapper_in_flat[13] = select_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[7] = select_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[22] = select_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[5] = shift_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[4] = shift_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[0] = shift_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[1] = shift_wrapper_out_flat[14];
assign arithmetic_reduce_wrapper_in_flat[10] = shift_wrapper_out_flat[15];
assign cast_wrapper_in_flat[9] = array_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[8] = array_wrapper_out_flat[4];
assign relational_wrapper_in_flat[1] = array_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[2] = array_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[6] = cast_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[5] = cast_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[5] = conditional_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[1] = width_enum_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[17] = width_struct_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[8] = width_struct_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[5] = width_struct_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[21] = width_struct_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[10] = width_logic_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[1] = width_logic_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[1];
assign array_wrapper_in_flat[16] = numbers_concat_repl_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[6];
