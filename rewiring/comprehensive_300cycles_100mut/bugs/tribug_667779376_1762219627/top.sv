...
assign const_concat_repl_wrapper_in_flat[0] = in_flat[30];
...
assign const_logic_wrapper_in_flat[3] = in_flat[72];
...
assign const_nested_wrapper_in_flat[25] = in_flat[101];
assign const_partselect_wrapper_in_flat[1] = in_flat[102];
assign const_partselect_wrapper_in_flat[2] = in_flat[103];
assign const_partselect_wrapper_in_flat[4] = in_flat[104];
assign const_partselect_wrapper_in_flat[5] = in_flat[105];
assign const_partselect_wrapper_in_flat[6] = in_flat[106];
assign const_partselect_wrapper_in_flat[7] = in_flat[107];
assign const_partselect_wrapper_in_flat[8] = in_flat[108];
assign const_partselect_wrapper_in_flat[9] = in_flat[109];
assign const_partselect_wrapper_in_flat[10] = in_flat[110];
assign const_partselect_wrapper_in_flat[11] = in_flat[111];
assign const_partselect_wrapper_in_flat[12] = in_flat[112];
assign const_partselect_wrapper_in_flat[13] = in_flat[113];
assign const_partselect_wrapper_in_flat[14] = in_flat[114];
assign const_partselect_wrapper_in_flat[15] = in_flat[115];
assign const_partselect_wrapper_in_flat[16] = in_flat[116];
assign const_partselect_wrapper_in_flat[17] = in_flat[117];
assign const_partselect_wrapper_in_flat[18] = in_flat[118];
assign const_partselect_wrapper_in_flat[19] = in_flat[119];
...
assign arithmetic_reduce_wrapper_in_flat[6] = in_flat[131];
assign arithmetic_reduce_wrapper_in_flat[7] = in_flat[132];
assign arithmetic_reduce_wrapper_in_flat[8] = in_flat[133];
assign arithmetic_reduce_wrapper_in_flat[9] = in_flat[134];
assign arithmetic_reduce_wrapper_in_flat[11] = in_flat[135];
...
assign bitwise_reduce_wrapper_in_flat[7] = in_flat[159];
assign logical_op_wrapper_in_flat[0] = in_flat[160];
assign relational_wrapper_in_flat[0] = in_flat[161];
assign relational_wrapper_in_flat[2] = in_flat[162];
assign relational_wrapper_in_flat[4] = in_flat[163];
assign relational_wrapper_in_flat[6] = in_flat[164];
assign relational_wrapper_in_flat[7] = in_flat[165];
...
assign select_wrapper_in_flat[12] = in_flat[176];
assign select_wrapper_in_flat[13] = in_flat[177];
assign select_wrapper_in_flat[14] = in_flat[178];
assign select_wrapper_in_flat[15] = in_flat[179];
assign select_wrapper_in_flat[16] = in_flat[180];
assign select_wrapper_in_flat[18] = in_flat[181];
assign select_wrapper_in_flat[19] = in_flat[182];
assign shift_wrapper_in_flat[0] = in_flat[183];
assign shift_wrapper_in_flat[2] = in_flat[184];
assign shift_wrapper_in_flat[3] = in_flat[185];
assign shift_wrapper_in_flat[6] = in_flat[186];
assign shift_wrapper_in_flat[9] = in_flat[187];
assign shift_wrapper_in_flat[10] = in_flat[188];
assign array_wrapper_in_flat[0] = in_flat[189];
assign array_wrapper_in_flat[1] = in_flat[190];
assign array_wrapper_in_flat[2] = in_flat[191];
assign array_wrapper_in_flat[3] = in_flat[192];
assign array_wrapper_in_flat[4] = in_flat[193];
assign array_wrapper_in_flat[5] = in_flat[194];
assign array_wrapper_in_flat[6] = in_flat[195];
...
assign array_wrapper_in_flat[16] = in_flat[203];
assign array_wrapper_in_flat[17] = in_flat[204];
assign cast_wrapper_in_flat[1] = in_flat[205];
...
assign cast_wrapper_in_flat[7] = in_flat[210];
assign cast_wrapper_in_flat[8] = in_flat[211];
...
assign partselect_wrapper_in_flat[4] = in_flat[219];
assign partselect_wrapper_in_flat[5] = in_flat[220];
assign partselect_wrapper_in_flat[6] = in_flat[221];
assign partselect_wrapper_in_flat[7] = in_flat[222];
assign partselect_wrapper_in_flat[8] = in_flat[223];
...
assign partselect_wrapper_in_flat[14] = in_flat[228];
...
assign width_enum_wrapper_in_flat[1] = in_flat[233];
...
assign width_struct_wrapper_in_flat[4] = in_flat[237];
...
assign width_logic_wrapper_in_flat[3] = in_flat[256];
...
assign width_struct_wrapper_in_flat[10] = const_arith_wrapper_out_flat[20];
assign conditional_wrapper_in_flat[8] = const_arith_wrapper_out_flat[32];
assign logical_op_wrapper_in_flat[1] = const_arith_wrapper_out_flat[38];
assign const_concat_repl_wrapper_in_flat[2] = const_compare_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[2] = const_compare_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[9] = const_compare_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[5] = const_compare_wrapper_out_flat[6];
assign cast_wrapper_in_flat[10] = const_compare_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[1];
assign relational_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[8];
assign const_shift_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[20];
assign cast_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[12];
assign width_logic_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[16];
assign width_union_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[18];
assign arithmetic_reduce_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[22];
assign select_wrapper_in_flat[17] = const_logic_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[7] = const_logic_wrapper_out_flat[10];
assign cast_wrapper_in_flat[9] = const_logic_wrapper_out_flat[10];
assign bitwise_logic_wrapper_in_flat[4] = const_logic_wrapper_out_flat[13];
assign width_union_wrapper_in_flat[11] = const_logic_wrapper_out_flat[16];
assign relational_wrapper_in_flat[3] = const_nested_wrapper_out_flat[1];
assign shift_wrapper_in_flat[1] = const_nested_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[4] = const_nested_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[0] = const_nested_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[24] = const_partselect_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[8] = const_shift_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[0] = const_shift_wrapper_out_flat[12];
assign shift_wrapper_in_flat[8] = const_shift_wrapper_out_flat[13];
assign const_reduce_wrapper_in_flat[2] = const_shift_wrapper_out_flat[18];
assign width_logic_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[3];
assign shift_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[8];
assign array_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[17];
assign conditional_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[16] = logical_op_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[11] = logical_op_wrapper_out_flat[1];
assign shift_wrapper_in_flat[5] = relational_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[9] = relational_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[7] = relational_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[3] = relational_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[18] = select_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[1] = select_wrapper_out_flat[4];
assign shift_wrapper_in_flat[7] = select_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[6] = select_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[5] = select_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[3] = shift_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[0] = shift_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[4] = array_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[5] = array_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[3] = array_wrapper_out_flat[12];
assign cast_wrapper_in_flat[11] = array_wrapper_out_flat[15];
assign select_wrapper_in_flat[2] = cast_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[1] = cast_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[1] = conditional_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[14] = width_enum_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[5] = width_enum_wrapper_out_flat[2];
assign select_wrapper_in_flat[10] = width_enum_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[7] = width_struct_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[20] = width_union_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[13] = width_union_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[14] = width_union_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[26] = width_union_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[8] = width_union_wrapper_out_flat[6];
assign relational_wrapper_in_flat[5] = width_union_wrapper_out_flat[8];
assign array_wrapper_in_flat[15] = width_union_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[7] = width_logic_wrapper_out_flat[1];
assign cast_wrapper_in_flat[0] = width_logic_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[1] = width_logic_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[15];
