...
assign select_wrapper_in_flat[5] = in_flat[161];
...
assign select_wrapper_in_flat[17] = in_flat[170];
...
assign shift_wrapper_in_flat[6] = in_flat[175];
...
assign array_wrapper_in_flat[6] = in_flat[184];
...
assign array_wrapper_in_flat[14] = in_flat[189];
assign array_wrapper_in_flat[15] = in_flat[190];
assign array_wrapper_in_flat[16] = in_flat[191];
assign array_wrapper_in_flat[17] = in_flat[192];
assign cast_wrapper_in_flat[0] = in_flat[193];
assign cast_wrapper_in_flat[1] = in_flat[194];
assign cast_wrapper_in_flat[2] = in_flat[195];
assign cast_wrapper_in_flat[3] = in_flat[196];
assign cast_wrapper_in_flat[4] = in_flat[197];
assign cast_wrapper_in_flat[5] = in_flat[198];
assign cast_wrapper_in_flat[8] = in_flat[199];
assign cast_wrapper_in_flat[9] = in_flat[200];
assign cast_wrapper_in_flat[10] = in_flat[201];
assign cast_wrapper_in_flat[11] = in_flat[202];
assign conditional_wrapper_in_flat[3] = in_flat[203];
assign conditional_wrapper_in_flat[4] = in_flat[204];
assign conditional_wrapper_in_flat[5] = in_flat[205];
assign conditional_wrapper_in_flat[6] = in_flat[206];
...
assign width_enum_wrapper_in_flat[1] = in_flat[226];
...
assign width_logic_wrapper_in_flat[5] = in_flat[250];
...
assign const_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[9];
assign bitwise_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[3] = const_arith_wrapper_out_flat[21];
assign relational_wrapper_in_flat[2] = const_arith_wrapper_out_flat[21];
assign conditional_wrapper_in_flat[7] = const_arith_wrapper_out_flat[21];
assign const_concat_repl_wrapper_in_flat[8] = const_arith_wrapper_out_flat[30];
assign const_nested_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[20] = const_concat_repl_wrapper_out_flat[6];
assign array_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[13];
assign width_logic_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[15];
assign select_wrapper_in_flat[18] = const_concat_repl_wrapper_out_flat[16];
assign const_partselect_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[17];
assign const_logic_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[20];
assign logical_op_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[20];
assign bitwise_reduce_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[21];
assign const_concat_repl_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[0];
assign select_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[15];
assign shift_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[17];
assign const_nested_wrapper_in_flat[25] = const_logic_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[2] = const_logic_wrapper_out_flat[5];
assign relational_wrapper_in_flat[7] = const_logic_wrapper_out_flat[8];
assign array_wrapper_in_flat[4] = const_logic_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[0] = const_logic_wrapper_out_flat[11];
assign const_shift_wrapper_in_flat[4] = const_nested_wrapper_out_flat[0];
assign array_wrapper_in_flat[7] = const_nested_wrapper_out_flat[0];
assign select_wrapper_in_flat[1] = const_nested_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[9] = const_nested_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[15] = const_partselect_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[3];
assign relational_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[16] = const_reduce_wrapper_out_flat[3];
assign cast_wrapper_in_flat[7] = const_reduce_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[0] = const_shift_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[1] = const_shift_wrapper_out_flat[14];
assign width_enum_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[7];
assign cast_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[16];
assign const_conditional_wrapper_in_flat[25] = bitwise_logic_wrapper_out_flat[20];
assign partselect_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[22];
assign relational_wrapper_in_flat[4] = bitwise_reduce_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[7] = logical_op_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[3] = logical_op_wrapper_out_flat[1];
assign array_wrapper_in_flat[5] = logical_op_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[9] = relational_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[8] = relational_wrapper_out_flat[5];
assign array_wrapper_in_flat[8] = select_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[2] = select_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[2] = select_wrapper_out_flat[4];
assign select_wrapper_in_flat[2] = shift_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[14] = shift_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[1] = shift_wrapper_out_flat[11];
assign const_arith_wrapper_in_flat[6] = shift_wrapper_out_flat[15];
assign const_partselect_wrapper_in_flat[10] = array_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[12] = array_wrapper_out_flat[1];
assign shift_wrapper_in_flat[4] = cast_wrapper_out_flat[9];
assign select_wrapper_in_flat[15] = cast_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[9] = cast_wrapper_out_flat[11];
assign arithmetic_reduce_wrapper_in_flat[13] = conditional_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[10] = conditional_wrapper_out_flat[3];
assign relational_wrapper_in_flat[5] = conditional_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[2] = partselect_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[7] = partselect_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[4] = width_struct_wrapper_out_flat[0];
assign select_wrapper_in_flat[13] = width_struct_wrapper_out_flat[5];
assign shift_wrapper_in_flat[5] = width_struct_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[2] = width_struct_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[14] = width_union_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[26] = width_union_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[1] = width_union_wrapper_out_flat[11];
assign select_wrapper_in_flat[9] = width_logic_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[15] = width_logic_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[0] = width_logic_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[4] = width_logic_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[13];
assign const_reduce_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[15];
