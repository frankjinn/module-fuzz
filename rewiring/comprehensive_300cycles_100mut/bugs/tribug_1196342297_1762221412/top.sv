...
assign const_logic_wrapper_in_flat[7] = const_arith_wrapper_out_flat[8];
assign numbers_concat_repl_wrapper_in_flat[0] = const_arith_wrapper_out_flat[9];
assign bitwise_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[15];
assign select_wrapper_in_flat[0] = const_arith_wrapper_out_flat[29];
assign shift_wrapper_in_flat[7] = const_arith_wrapper_out_flat[33];
assign cast_wrapper_in_flat[8] = const_arith_wrapper_out_flat[35];
assign width_enum_wrapper_in_flat[3] = const_compare_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[8] = const_compare_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[12];
assign width_logic_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[19] = const_concat_repl_wrapper_out_flat[14];
assign conditional_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[18];
assign const_nested_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[9];
assign relational_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[9];
assign bitwise_reduce_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[10];
assign width_union_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[16];
assign partselect_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[17];
assign cast_wrapper_in_flat[10] = const_logic_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[31] = const_logic_wrapper_out_flat[12];
assign const_shift_wrapper_in_flat[1] = const_logic_wrapper_out_flat[18];
assign const_partselect_wrapper_in_flat[18] = const_nested_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[8] = const_shift_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[28] = const_shift_wrapper_out_flat[15];
assign numbers_concat_repl_wrapper_in_flat[1] = const_shift_wrapper_out_flat[18];
...
assign arithmetic_reduce_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[9];
assign relational_wrapper_in_flat[6] = bitwise_reduce_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[2] = bitwise_reduce_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[5] = logical_op_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[16] = logical_op_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[4] = logical_op_wrapper_out_flat[1];
assign relational_wrapper_in_flat[1] = logical_op_wrapper_out_flat[1];
assign array_wrapper_in_flat[15] = logical_op_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[7] = logical_op_wrapper_out_flat[2];
assign shift_wrapper_in_flat[0] = relational_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[8] = relational_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[20] = relational_wrapper_out_flat[6];
assign array_wrapper_in_flat[4] = select_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[6] = select_wrapper_out_flat[1];
assign cast_wrapper_in_flat[7] = select_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[2] = select_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[2] = shift_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[2] = shift_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[2] = shift_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[5] = array_wrapper_out_flat[5];
assign relational_wrapper_in_flat[5] = array_wrapper_out_flat[12];
assign const_concat_repl_wrapper_in_flat[3] = array_wrapper_out_flat[15];
assign const_shift_wrapper_in_flat[10] = cast_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[19] = cast_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[13] = cast_wrapper_out_flat[10];
assign bitwise_logic_wrapper_in_flat[8] = conditional_wrapper_out_flat[3];
assign array_wrapper_in_flat[6] = partselect_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[6] = partselect_wrapper_out_flat[4];
assign logical_op_wrapper_in_flat[0] = partselect_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[5] = partselect_wrapper_out_flat[5];
assign relational_wrapper_in_flat[4] = partselect_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[2] = width_enum_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[12] = width_struct_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[4] = width_struct_wrapper_out_flat[6];
assign bitwise_logic_wrapper_in_flat[4] = width_struct_wrapper_out_flat[11];
assign width_struct_wrapper_in_flat[2] = width_union_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = width_union_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[12] = width_union_wrapper_out_flat[9];
assign partselect_wrapper_in_flat[3] = width_union_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[23] = width_union_wrapper_out_flat[10];
assign array_wrapper_in_flat[14] = width_union_wrapper_out_flat[11];
assign bitwise_reduce_wrapper_in_flat[2] = width_union_wrapper_out_flat[13];
assign const_reduce_wrapper_in_flat[0] = width_logic_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[22] = numbers_concat_repl_wrapper_out_flat[16];
