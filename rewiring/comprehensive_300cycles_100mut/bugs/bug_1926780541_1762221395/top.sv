...
assign const_compare_wrapper_in_flat[11] = in_flat[18];
assign const_compare_wrapper_in_flat[12] = in_flat[19];
...
assign const_logic_wrapper_in_flat[8] = in_flat[77];
assign const_nested_wrapper_in_flat[0] = in_flat[78];
assign const_nested_wrapper_in_flat[2] = in_flat[79];
assign const_nested_wrapper_in_flat[4] = in_flat[80];
assign const_nested_wrapper_in_flat[5] = in_flat[81];
assign const_nested_wrapper_in_flat[6] = in_flat[82];
assign const_nested_wrapper_in_flat[7] = in_flat[83];
...
assign const_nested_wrapper_in_flat[15] = in_flat[90];
assign const_nested_wrapper_in_flat[16] = in_flat[91];
assign const_nested_wrapper_in_flat[17] = in_flat[92];
...
assign const_partselect_wrapper_in_flat[1] = in_flat[101];
assign const_partselect_wrapper_in_flat[3] = in_flat[102];
assign const_partselect_wrapper_in_flat[4] = in_flat[103];
assign const_partselect_wrapper_in_flat[5] = in_flat[104];
assign const_partselect_wrapper_in_flat[6] = in_flat[105];
assign const_partselect_wrapper_in_flat[7] = in_flat[106];
assign const_partselect_wrapper_in_flat[8] = in_flat[107];
assign const_partselect_wrapper_in_flat[9] = in_flat[108];
...
assign const_reduce_wrapper_in_flat[0] = in_flat[117];
assign const_shift_wrapper_in_flat[1] = in_flat[118];
assign const_shift_wrapper_in_flat[3] = in_flat[119];
...
assign arithmetic_reduce_wrapper_in_flat[15] = in_flat[136];
...
assign bitwise_logic_wrapper_in_flat[7] = in_flat[144];
...
assign select_wrapper_in_flat[0] = in_flat[163];
...
assign cast_wrapper_in_flat[0] = in_flat[199];
assign cast_wrapper_in_flat[1] = in_flat[200];
assign cast_wrapper_in_flat[2] = in_flat[201];
assign cast_wrapper_in_flat[3] = in_flat[202];
assign cast_wrapper_in_flat[4] = in_flat[203];
...
assign conditional_wrapper_in_flat[7] = in_flat[209];
assign conditional_wrapper_in_flat[8] = in_flat[210];
...
assign partselect_wrapper_in_flat[10] = in_flat[219];
assign partselect_wrapper_in_flat[11] = in_flat[220];
assign partselect_wrapper_in_flat[12] = in_flat[221];
assign partselect_wrapper_in_flat[13] = in_flat[222];
assign partselect_wrapper_in_flat[14] = in_flat[223];
assign partselect_wrapper_in_flat[15] = in_flat[224];
assign partselect_wrapper_in_flat[16] = in_flat[225];
assign partselect_wrapper_in_flat[18] = in_flat[226];
assign width_enum_wrapper_in_flat[0] = in_flat[227];
assign width_enum_wrapper_in_flat[1] = in_flat[228];
assign width_struct_wrapper_in_flat[0] = in_flat[229];
assign width_struct_wrapper_in_flat[1] = in_flat[230];
assign width_struct_wrapper_in_flat[2] = in_flat[231];
assign width_struct_wrapper_in_flat[4] = in_flat[232];
assign width_struct_wrapper_in_flat[5] = in_flat[233];
assign width_struct_wrapper_in_flat[6] = in_flat[234];
...
assign width_union_wrapper_in_flat[5] = in_flat[243];
assign width_union_wrapper_in_flat[6] = in_flat[244];
...
assign width_logic_wrapper_in_flat[0] = in_flat[251];
assign width_logic_wrapper_in_flat[2] = in_flat[252];
...
assign const_shift_wrapper_in_flat[8] = const_arith_wrapper_out_flat[14];
assign relational_wrapper_in_flat[1] = const_arith_wrapper_out_flat[19];
assign const_logic_wrapper_in_flat[9] = const_arith_wrapper_out_flat[36];
assign width_logic_wrapper_in_flat[7] = const_compare_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[9] = const_compare_wrapper_out_flat[7];
assign array_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[19] = const_concat_repl_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[10];
assign relational_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[14];
assign width_enum_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[16];
assign const_shift_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[3];
assign shift_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[9];
assign const_arith_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[12];
assign bitwise_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[21];
assign const_partselect_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[23];
assign const_reduce_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[23];
assign const_shift_wrapper_in_flat[5] = const_logic_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[8] = const_logic_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[10] = const_logic_wrapper_out_flat[13];
assign const_concat_repl_wrapper_in_flat[7] = const_logic_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[18] = const_logic_wrapper_out_flat[16];
assign width_enum_wrapper_in_flat[3] = const_logic_wrapper_out_flat[18];
assign const_arith_wrapper_in_flat[15] = const_partselect_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[17] = const_partselect_wrapper_out_flat[7];
assign logical_op_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[0];
assign shift_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[1];
assign cast_wrapper_in_flat[11] = const_reduce_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[5] = const_shift_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[3] = const_shift_wrapper_out_flat[20];
assign relational_wrapper_in_flat[5] = const_shift_wrapper_out_flat[21];
assign select_wrapper_in_flat[17] = arithmetic_reduce_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[1];
assign cast_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[5];
assign shift_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[14];
assign numbers_concat_repl_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[22];
assign const_conditional_wrapper_in_flat[15] = bitwise_logic_wrapper_out_flat[23];
assign const_logic_wrapper_in_flat[5] = bitwise_reduce_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[0] = logical_op_wrapper_out_flat[0];
assign array_wrapper_in_flat[11] = relational_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[0] = select_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[3] = select_wrapper_out_flat[5];
assign const_arith_wrapper_in_flat[12] = select_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[2] = select_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[6] = shift_wrapper_out_flat[1];
assign cast_wrapper_in_flat[10] = shift_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[14] = shift_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[10] = shift_wrapper_out_flat[10];
assign select_wrapper_in_flat[15] = shift_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[3] = array_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[9] = array_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[11] = cast_wrapper_out_flat[3];
assign select_wrapper_in_flat[14] = cast_wrapper_out_flat[6];
assign array_wrapper_in_flat[6] = cast_wrapper_out_flat[10];
assign const_arith_wrapper_in_flat[1] = cast_wrapper_out_flat[11];
assign const_arith_wrapper_in_flat[10] = conditional_wrapper_out_flat[1];
assign select_wrapper_in_flat[3] = partselect_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[0] = partselect_wrapper_out_flat[3];
assign array_wrapper_in_flat[17] = width_enum_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[6] = width_struct_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[1] = width_struct_wrapper_out_flat[10];
assign cast_wrapper_in_flat[7] = width_union_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[11] = width_union_wrapper_out_flat[0];
assign select_wrapper_in_flat[8] = width_union_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[4] = width_union_wrapper_out_flat[11];
assign partselect_wrapper_in_flat[0] = width_union_wrapper_out_flat[13];
assign const_arith_wrapper_in_flat[8] = width_union_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[1] = width_logic_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[8];
assign shift_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[12] = numbers_concat_repl_wrapper_out_flat[11];
