...
assign const_concat_repl_wrapper_in_flat[8] = in_flat[42];
assign const_concat_repl_wrapper_in_flat[9] = in_flat[43];
...
assign const_conditional_wrapper_in_flat[14] = in_flat[56];
assign const_conditional_wrapper_in_flat[15] = in_flat[57];
assign const_conditional_wrapper_in_flat[16] = in_flat[58];
assign const_conditional_wrapper_in_flat[17] = in_flat[59];
assign const_conditional_wrapper_in_flat[18] = in_flat[60];
assign const_conditional_wrapper_in_flat[19] = in_flat[61];
assign const_conditional_wrapper_in_flat[20] = in_flat[62];
assign const_conditional_wrapper_in_flat[21] = in_flat[63];
assign const_conditional_wrapper_in_flat[22] = in_flat[64];
...
assign const_nested_wrapper_in_flat[23] = in_flat[99];
assign const_nested_wrapper_in_flat[24] = in_flat[100];
...
assign const_partselect_wrapper_in_flat[7] = in_flat[108];
assign const_partselect_wrapper_in_flat[8] = in_flat[109];
assign const_partselect_wrapper_in_flat[9] = in_flat[110];
assign const_partselect_wrapper_in_flat[10] = in_flat[111];
assign const_partselect_wrapper_in_flat[11] = in_flat[112];
assign const_partselect_wrapper_in_flat[12] = in_flat[113];
assign const_partselect_wrapper_in_flat[13] = in_flat[114];
assign const_partselect_wrapper_in_flat[14] = in_flat[115];
assign const_partselect_wrapper_in_flat[15] = in_flat[116];
assign const_partselect_wrapper_in_flat[16] = in_flat[117];
assign const_partselect_wrapper_in_flat[17] = in_flat[118];
assign const_partselect_wrapper_in_flat[18] = in_flat[119];
assign const_partselect_wrapper_in_flat[19] = in_flat[120];
assign const_reduce_wrapper_in_flat[1] = in_flat[121];
...
assign const_shift_wrapper_in_flat[10] = in_flat[127];
assign arithmetic_reduce_wrapper_in_flat[0] = in_flat[128];
assign arithmetic_reduce_wrapper_in_flat[1] = in_flat[129];
assign arithmetic_reduce_wrapper_in_flat[2] = in_flat[130];
...
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[160];
...
assign relational_wrapper_in_flat[7] = in_flat[166];
assign select_wrapper_in_flat[2] = in_flat[167];
assign select_wrapper_in_flat[3] = in_flat[168];
assign select_wrapper_in_flat[4] = in_flat[169];
assign select_wrapper_in_flat[5] = in_flat[170];
assign select_wrapper_in_flat[6] = in_flat[171];
assign select_wrapper_in_flat[7] = in_flat[172];
assign select_wrapper_in_flat[8] = in_flat[173];
...
assign select_wrapper_in_flat[14] = in_flat[177];
assign select_wrapper_in_flat[16] = in_flat[178];
assign select_wrapper_in_flat[17] = in_flat[179];
assign select_wrapper_in_flat[18] = in_flat[180];
assign shift_wrapper_in_flat[0] = in_flat[181];
assign shift_wrapper_in_flat[1] = in_flat[182];
assign shift_wrapper_in_flat[2] = in_flat[183];
...
assign array_wrapper_in_flat[6] = in_flat[196];
assign array_wrapper_in_flat[7] = in_flat[197];
assign array_wrapper_in_flat[8] = in_flat[198];
assign array_wrapper_in_flat[9] = in_flat[199];
assign array_wrapper_in_flat[10] = in_flat[200];
assign array_wrapper_in_flat[11] = in_flat[201];
assign array_wrapper_in_flat[13] = in_flat[202];
assign array_wrapper_in_flat[14] = in_flat[203];
assign array_wrapper_in_flat[15] = in_flat[204];
assign array_wrapper_in_flat[17] = in_flat[205];
assign cast_wrapper_in_flat[1] = in_flat[206];
assign cast_wrapper_in_flat[2] = in_flat[207];
assign cast_wrapper_in_flat[3] = in_flat[208];
assign cast_wrapper_in_flat[4] = in_flat[209];
assign cast_wrapper_in_flat[6] = in_flat[210];
assign cast_wrapper_in_flat[7] = in_flat[211];
assign cast_wrapper_in_flat[8] = in_flat[212];
assign cast_wrapper_in_flat[11] = in_flat[213];
assign conditional_wrapper_in_flat[0] = in_flat[214];
assign conditional_wrapper_in_flat[2] = in_flat[215];
assign conditional_wrapper_in_flat[4] = in_flat[216];
assign conditional_wrapper_in_flat[6] = in_flat[217];
assign conditional_wrapper_in_flat[7] = in_flat[218];
assign conditional_wrapper_in_flat[8] = in_flat[219];
assign partselect_wrapper_in_flat[0] = in_flat[220];
assign partselect_wrapper_in_flat[1] = in_flat[221];
assign partselect_wrapper_in_flat[3] = in_flat[222];
assign partselect_wrapper_in_flat[4] = in_flat[223];
assign partselect_wrapper_in_flat[5] = in_flat[224];
assign partselect_wrapper_in_flat[6] = in_flat[225];
assign partselect_wrapper_in_flat[7] = in_flat[226];
assign partselect_wrapper_in_flat[8] = in_flat[227];
assign partselect_wrapper_in_flat[9] = in_flat[228];
assign partselect_wrapper_in_flat[10] = in_flat[229];
assign partselect_wrapper_in_flat[11] = in_flat[230];
assign partselect_wrapper_in_flat[12] = in_flat[231];
assign partselect_wrapper_in_flat[13] = in_flat[232];
assign partselect_wrapper_in_flat[14] = in_flat[233];
assign partselect_wrapper_in_flat[15] = in_flat[234];
assign partselect_wrapper_in_flat[16] = in_flat[235];
assign partselect_wrapper_in_flat[18] = in_flat[236];
assign width_enum_wrapper_in_flat[3] = in_flat[237];
assign width_struct_wrapper_in_flat[0] = in_flat[238];
assign width_struct_wrapper_in_flat[1] = in_flat[239];
assign width_struct_wrapper_in_flat[2] = in_flat[240];
...
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[265];

// Internal MTM connections (module-to-module)
assign const_conditional_wrapper_in_flat[12] = const_arith_wrapper_out_flat[1];
assign select_wrapper_in_flat[12] = const_arith_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[2] = const_arith_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[17] = const_arith_wrapper_out_flat[7];
assign array_wrapper_in_flat[12] = const_arith_wrapper_out_flat[10];
assign const_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[14];
assign arithmetic_reduce_wrapper_in_flat[5] = const_arith_wrapper_out_flat[25];
assign conditional_wrapper_in_flat[1] = const_arith_wrapper_out_flat[31];
assign width_logic_wrapper_in_flat[5] = const_compare_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[4];
assign relational_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[13];
assign width_logic_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[17];
assign cast_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[19];
assign select_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[20];
assign const_nested_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[3];
assign cast_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[12];
assign arithmetic_reduce_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[13];
assign const_concat_repl_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[16];
assign width_struct_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[18];
assign const_logic_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[18];
assign select_wrapper_in_flat[19] = const_conditional_wrapper_out_flat[22];
assign const_compare_wrapper_in_flat[14] = const_logic_wrapper_out_flat[1];
assign relational_wrapper_in_flat[2] = const_nested_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[22] = const_shift_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[9] = const_shift_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[0];
assign select_wrapper_in_flat[15] = arithmetic_reduce_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[6];
assign shift_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[6];
assign cast_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[13];
assign array_wrapper_in_flat[16] = bitwise_logic_wrapper_out_flat[15];
assign const_arith_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[25] = bitwise_logic_wrapper_out_flat[23];
assign const_partselect_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[23];
assign numbers_concat_repl_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[2];
assign shift_wrapper_in_flat[4] = relational_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[1] = select_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[4] = shift_wrapper_out_flat[12];
assign const_shift_wrapper_in_flat[1] = shift_wrapper_out_flat[14];
assign partselect_wrapper_in_flat[2] = array_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[23] = array_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[3] = array_wrapper_out_flat[7];
assign select_wrapper_in_flat[1] = cast_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[2] = cast_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[2] = cast_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[0] = cast_wrapper_out_flat[9];
assign width_enum_wrapper_in_flat[0] = cast_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[7] = conditional_wrapper_out_flat[1];
assign cast_wrapper_in_flat[9] = partselect_wrapper_out_flat[2];
assign select_wrapper_in_flat[0] = partselect_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[6] = partselect_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[0] = partselect_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[21] = partselect_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[3] = partselect_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[4] = width_enum_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[2] = width_struct_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[4] = width_struct_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[5] = width_struct_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[3] = width_union_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[0] = width_union_wrapper_out_flat[2];
assign relational_wrapper_in_flat[5] = width_union_wrapper_out_flat[13];
assign logical_op_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[3];
