...
assign bitwise_logic_wrapper_in_flat[13] = const_arith_wrapper_out_flat[11];
assign const_conditional_wrapper_in_flat[10] = const_arith_wrapper_out_flat[13];
assign width_logic_wrapper_in_flat[0] = const_arith_wrapper_out_flat[21];
assign array_wrapper_in_flat[13] = const_arith_wrapper_out_flat[22];
assign width_union_wrapper_in_flat[6] = const_arith_wrapper_out_flat[25];
assign const_compare_wrapper_in_flat[13] = const_arith_wrapper_out_flat[28];
assign select_wrapper_in_flat[17] = const_arith_wrapper_out_flat[37];
assign width_union_wrapper_in_flat[11] = const_compare_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[0];
assign shift_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[12];
assign array_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[17];
assign cast_wrapper_in_flat[10] = const_logic_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[2] = const_logic_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[18] = const_logic_wrapper_out_flat[11];
assign relational_wrapper_in_flat[2] = const_logic_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[7] = const_logic_wrapper_out_flat[16];
assign width_enum_wrapper_in_flat[2] = const_nested_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[13] = const_nested_wrapper_out_flat[6];
assign select_wrapper_in_flat[11] = const_nested_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[2] = const_nested_wrapper_out_flat[7];
assign cast_wrapper_in_flat[8] = const_nested_wrapper_out_flat[7];
assign logical_op_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[1] = const_shift_wrapper_out_flat[0];
assign cast_wrapper_in_flat[11] = const_shift_wrapper_out_flat[11];
assign const_concat_repl_wrapper_in_flat[2] = const_shift_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[13] = const_shift_wrapper_out_flat[18];
assign numbers_concat_repl_wrapper_in_flat[5] = const_shift_wrapper_out_flat[19];
assign width_union_wrapper_in_flat[3] = const_shift_wrapper_out_flat[20];
assign bitwise_logic_wrapper_in_flat[14] = const_shift_wrapper_out_flat[22];
assign arithmetic_reduce_wrapper_in_flat[1] = const_shift_wrapper_out_flat[23];
assign const_conditional_wrapper_in_flat[31] = arithmetic_reduce_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[14];
assign select_wrapper_in_flat[12] = bitwise_logic_wrapper_out_flat[16];
assign shift_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[22];
...
assign const_arith_wrapper_in_flat[11] = relational_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[2] = relational_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[10] = relational_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[1] = relational_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[7] = relational_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[7] = relational_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[4] = select_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[1] = select_wrapper_out_flat[4];
assign shift_wrapper_in_flat[1] = select_wrapper_out_flat[8];
assign width_logic_wrapper_in_flat[6] = shift_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[5] = shift_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[7] = shift_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[17] = shift_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[4] = shift_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[6] = array_wrapper_out_flat[12];
assign bitwise_logic_wrapper_in_flat[7] = cast_wrapper_out_flat[2];
assign relational_wrapper_in_flat[6] = cast_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[3] = cast_wrapper_out_flat[7];
assign select_wrapper_in_flat[6] = partselect_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[3] = partselect_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[1] = width_enum_wrapper_out_flat[1];
assign shift_wrapper_in_flat[6] = width_enum_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[8] = width_enum_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[3] = width_struct_wrapper_out_flat[2];
assign array_wrapper_in_flat[9] = width_struct_wrapper_out_flat[6];
assign logical_op_wrapper_in_flat[1] = width_struct_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[4] = width_union_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[3] = width_union_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[15] = width_union_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[14] = width_logic_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[2] = width_logic_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[23] = width_logic_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[15] = width_logic_wrapper_out_flat[3];
assign relational_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[10];
assign select_wrapper_in_flat[19] = numbers_concat_repl_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[16];
assign width_union_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[16];
assign partselect_wrapper_in_flat[15] = numbers_concat_repl_wrapper_out_flat[16];
