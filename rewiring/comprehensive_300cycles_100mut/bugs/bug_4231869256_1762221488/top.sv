...
assign const_nested_wrapper_in_flat[13] = in_flat[96];
...
assign const_partselect_wrapper_in_flat[13] = in_flat[121];
assign const_partselect_wrapper_in_flat[14] = in_flat[122];
assign const_partselect_wrapper_in_flat[15] = in_flat[123];
assign const_partselect_wrapper_in_flat[16] = in_flat[124];
assign const_partselect_wrapper_in_flat[17] = in_flat[125];
assign const_partselect_wrapper_in_flat[18] = in_flat[126];
assign const_partselect_wrapper_in_flat[19] = in_flat[127];
assign const_reduce_wrapper_in_flat[0] = in_flat[128];
assign const_reduce_wrapper_in_flat[2] = in_flat[129];
...
assign const_shift_wrapper_in_flat[10] = in_flat[136];
assign arithmetic_reduce_wrapper_in_flat[0] = in_flat[137];
assign arithmetic_reduce_wrapper_in_flat[1] = in_flat[138];
assign arithmetic_reduce_wrapper_in_flat[2] = in_flat[139];
assign arithmetic_reduce_wrapper_in_flat[3] = in_flat[140];
assign arithmetic_reduce_wrapper_in_flat[4] = in_flat[141];
assign arithmetic_reduce_wrapper_in_flat[5] = in_flat[142];
assign arithmetic_reduce_wrapper_in_flat[7] = in_flat[143];
...
assign bitwise_logic_wrapper_in_flat[15] = in_flat[162];
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[163];
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[164];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[165];
assign bitwise_reduce_wrapper_in_flat[7] = in_flat[166];
assign logical_op_wrapper_in_flat[1] = in_flat[167];
...
assign relational_wrapper_in_flat[6] = in_flat[171];
...
assign select_wrapper_in_flat[6] = in_flat[178];
...
assign shift_wrapper_in_flat[5] = in_flat[192];
...
assign array_wrapper_in_flat[3] = in_flat[197];
...
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[264];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[265];
...
assign const_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[7] = const_arith_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[20] = const_arith_wrapper_out_flat[8];
assign numbers_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[8];
assign width_enum_wrapper_in_flat[0] = const_arith_wrapper_out_flat[12];
assign bitwise_logic_wrapper_in_flat[14] = const_arith_wrapper_out_flat[16];
assign width_struct_wrapper_in_flat[7] = const_arith_wrapper_out_flat[29];
assign select_wrapper_in_flat[14] = const_arith_wrapper_out_flat[34];
assign relational_wrapper_in_flat[7] = const_arith_wrapper_out_flat[38];
assign const_conditional_wrapper_in_flat[13] = const_compare_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[17];
assign const_shift_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[15];
assign shift_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[22];
assign arithmetic_reduce_wrapper_in_flat[13] = const_logic_wrapper_out_flat[5];
assign select_wrapper_in_flat[7] = const_logic_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[9] = const_logic_wrapper_out_flat[13];
assign width_enum_wrapper_in_flat[2] = const_logic_wrapper_out_flat[13];
assign width_logic_wrapper_in_flat[1] = const_nested_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[8] = const_nested_wrapper_out_flat[5];
assign shift_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[4];
assign relational_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[3];
assign cast_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[19] = const_shift_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[10];
assign relational_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[11];
assign shift_wrapper_in_flat[6] = logical_op_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[1] = logical_op_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[4] = logical_op_wrapper_out_flat[2];
assign select_wrapper_in_flat[17] = relational_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[4] = relational_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[16] = relational_wrapper_out_flat[7];
assign cast_wrapper_in_flat[3] = select_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[12] = select_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[4] = shift_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[3] = shift_wrapper_out_flat[6];
assign array_wrapper_in_flat[12] = shift_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[0] = array_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[10] = cast_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[26] = cast_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[2] = cast_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[11] = conditional_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[1] = partselect_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[8] = partselect_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[0] = partselect_wrapper_out_flat[2];
assign array_wrapper_in_flat[17] = partselect_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[7] = partselect_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[0] = partselect_wrapper_out_flat[7];
assign select_wrapper_in_flat[19] = width_enum_wrapper_out_flat[1];
assign cast_wrapper_in_flat[2] = width_enum_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[8] = width_struct_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[0] = width_struct_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[6] = width_struct_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[4] = width_union_wrapper_out_flat[11];
assign array_wrapper_in_flat[6] = width_union_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[1] = width_logic_wrapper_out_flat[0];
assign array_wrapper_in_flat[2] = width_logic_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[0] = width_logic_wrapper_out_flat[2];
assign shift_wrapper_in_flat[10] = width_logic_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[8];
assign relational_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[14];
assign partselect_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[15];
assign cast_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[17];
