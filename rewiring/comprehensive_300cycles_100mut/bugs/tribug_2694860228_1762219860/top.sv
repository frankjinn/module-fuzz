...
assign const_shift_wrapper_in_flat[0] = in_flat[117];
...
assign cast_wrapper_in_flat[5] = in_flat[200];
...
assign partselect_wrapper_in_flat[2] = in_flat[210];
assign partselect_wrapper_in_flat[3] = in_flat[211];
assign partselect_wrapper_in_flat[4] = in_flat[212];
assign partselect_wrapper_in_flat[6] = in_flat[213];
assign partselect_wrapper_in_flat[7] = in_flat[214];
assign partselect_wrapper_in_flat[8] = in_flat[215];
...
assign width_struct_wrapper_in_flat[4] = in_flat[229];
...
assign width_logic_wrapper_in_flat[2] = in_flat[248];
assign width_logic_wrapper_in_flat[3] = in_flat[249];
...
assign const_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[15];
assign array_wrapper_in_flat[5] = const_arith_wrapper_out_flat[24];
assign const_logic_wrapper_in_flat[6] = const_arith_wrapper_out_flat[32];
assign width_union_wrapper_in_flat[13] = const_arith_wrapper_out_flat[34];
assign const_nested_wrapper_in_flat[15] = const_compare_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[4] = const_compare_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[9];
assign select_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[10];
assign relational_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[13];
assign const_shift_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[13];
assign const_conditional_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[14];
assign const_logic_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[21];
assign const_arith_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[1];
assign select_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[5];
assign shift_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[1] = const_logic_wrapper_out_flat[0];
assign cast_wrapper_in_flat[6] = const_logic_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[17] = const_logic_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[7] = const_logic_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[7] = const_logic_wrapper_out_flat[17];
assign logical_op_wrapper_in_flat[0] = const_nested_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[1];
assign relational_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[1];
...
assign cast_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[3] = const_shift_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[8] = const_shift_wrapper_out_flat[18];
assign array_wrapper_in_flat[3] = const_shift_wrapper_out_flat[20];
assign const_conditional_wrapper_in_flat[7] = const_shift_wrapper_out_flat[22];
assign cast_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[4];
assign relational_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[11] = arithmetic_reduce_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[8];
assign array_wrapper_in_flat[12] = bitwise_logic_wrapper_out_flat[13];
assign partselect_wrapper_in_flat[13] = bitwise_logic_wrapper_out_flat[15];
assign const_conditional_wrapper_in_flat[19] = bitwise_logic_wrapper_out_flat[21];
assign logical_op_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[11] = bitwise_reduce_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[0] = relational_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[5] = relational_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[16] = relational_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[2] = select_wrapper_out_flat[8];
assign select_wrapper_in_flat[7] = shift_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[3] = shift_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[5] = shift_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[4] = array_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[0] = array_wrapper_out_flat[2];
assign relational_wrapper_in_flat[3] = array_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[2] = array_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[18] = array_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[26] = array_wrapper_out_flat[14];
assign array_wrapper_in_flat[11] = cast_wrapper_out_flat[9];
assign width_enum_wrapper_in_flat[1] = conditional_wrapper_out_flat[1];
assign cast_wrapper_in_flat[1] = conditional_wrapper_out_flat[2];
assign array_wrapper_in_flat[0] = conditional_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[1] = partselect_wrapper_out_flat[2];
assign select_wrapper_in_flat[18] = partselect_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[1] = width_enum_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[22] = width_enum_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[16] = width_struct_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[5] = width_struct_wrapper_out_flat[2];
assign select_wrapper_in_flat[6] = width_struct_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[5] = width_struct_wrapper_out_flat[5];
assign relational_wrapper_in_flat[2] = width_struct_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[9] = width_struct_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[2] = width_union_wrapper_out_flat[0];
assign cast_wrapper_in_flat[7] = width_union_wrapper_out_flat[1];
assign relational_wrapper_in_flat[4] = width_union_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[10] = width_union_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[4] = width_union_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[25] = width_logic_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[5] = width_logic_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[14] = numbers_concat_repl_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[8];
assign relational_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[11];
