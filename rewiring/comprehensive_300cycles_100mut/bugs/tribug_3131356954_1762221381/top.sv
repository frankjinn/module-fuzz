...
assign const_shift_wrapper_in_flat[4] = in_flat[120];
assign const_shift_wrapper_in_flat[5] = in_flat[121];
...
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[150];
...
assign width_union_wrapper_in_flat[15] = const_arith_wrapper_out_flat[14];
assign bitwise_logic_wrapper_in_flat[14] = const_arith_wrapper_out_flat[17];
assign numbers_concat_repl_wrapper_in_flat[5] = const_arith_wrapper_out_flat[24];
assign width_logic_wrapper_in_flat[2] = const_arith_wrapper_out_flat[28];
assign cast_wrapper_in_flat[2] = const_arith_wrapper_out_flat[31];
assign width_logic_wrapper_in_flat[5] = const_compare_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[18] = const_compare_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[18] = const_compare_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[13];
assign const_logic_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[15];
assign arithmetic_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[15];
assign arithmetic_reduce_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[1];
assign select_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[20];
assign shift_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[22];
assign const_arith_wrapper_in_flat[6] = const_logic_wrapper_out_flat[10];
assign bitwise_logic_wrapper_in_flat[3] = const_logic_wrapper_out_flat[13];
assign partselect_wrapper_in_flat[4] = const_logic_wrapper_out_flat[15];
assign arithmetic_reduce_wrapper_in_flat[11] = const_logic_wrapper_out_flat[16];
assign const_partselect_wrapper_in_flat[5] = const_nested_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[5];
assign shift_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[25] = const_shift_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[4] = const_shift_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[4] = const_shift_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[11] = const_shift_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[5] = const_shift_wrapper_out_flat[10];
assign select_wrapper_in_flat[11] = const_shift_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[21] = const_shift_wrapper_out_flat[19];
assign const_arith_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[4];
assign select_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[13];
assign cast_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[17];
assign conditional_wrapper_in_flat[6] = logical_op_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[1] = logical_op_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[5] = logical_op_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[8] = relational_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[0] = relational_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[32] = relational_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[4] = relational_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[9] = relational_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[2] = relational_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[23] = select_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[3] = select_wrapper_out_flat[1];
assign cast_wrapper_in_flat[9] = select_wrapper_out_flat[8];
assign const_concat_repl_wrapper_in_flat[9] = shift_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[4] = array_wrapper_out_flat[1];
assign shift_wrapper_in_flat[9] = array_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[22] = array_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[0] = array_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[9] = cast_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[3] = cast_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[20] = cast_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[4] = cast_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[2] = conditional_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[7] = conditional_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[16] = conditional_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[12] = partselect_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[1] = partselect_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[15] = partselect_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[13] = width_enum_wrapper_out_flat[1];
assign select_wrapper_in_flat[10] = width_enum_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[0] = width_enum_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = width_struct_wrapper_out_flat[0];
assign relational_wrapper_in_flat[4] = width_struct_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[3] = width_struct_wrapper_out_flat[1];
assign shift_wrapper_in_flat[5] = width_struct_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[5] = width_struct_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[0] = width_struct_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[12] = width_struct_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[5] = width_struct_wrapper_out_flat[11];
assign select_wrapper_in_flat[9] = width_union_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[8] = width_union_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[3] = width_union_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[12] = width_logic_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[13] = width_logic_wrapper_out_flat[5];
assign cast_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[12];
