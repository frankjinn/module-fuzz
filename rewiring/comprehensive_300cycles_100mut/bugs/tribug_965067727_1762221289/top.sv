...
assign width_struct_wrapper_in_flat[1] = const_arith_wrapper_out_flat[7];
assign array_wrapper_in_flat[2] = const_arith_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[14] = const_arith_wrapper_out_flat[12];
assign shift_wrapper_in_flat[0] = const_arith_wrapper_out_flat[21];
assign const_partselect_wrapper_in_flat[18] = const_arith_wrapper_out_flat[24];
assign select_wrapper_in_flat[18] = const_arith_wrapper_out_flat[31];
assign const_compare_wrapper_in_flat[15] = const_arith_wrapper_out_flat[33];
assign const_shift_wrapper_in_flat[7] = const_arith_wrapper_out_flat[35];
assign const_conditional_wrapper_in_flat[3] = const_compare_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[0] = const_compare_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[14];
assign const_conditional_wrapper_in_flat[20] = const_concat_repl_wrapper_out_flat[14];
assign const_logic_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[16];
assign relational_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[8];
assign select_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[10];
assign logical_op_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[18];
assign const_logic_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[21];
assign cast_wrapper_in_flat[3] = const_logic_wrapper_out_flat[10];
assign numbers_concat_repl_wrapper_in_flat[4] = const_logic_wrapper_out_flat[14];
assign width_struct_wrapper_in_flat[3] = const_nested_wrapper_out_flat[2];
assign array_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[4];
assign shift_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[4];
...
assign shift_wrapper_in_flat[8] = const_shift_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[8] = const_shift_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[1] = const_shift_wrapper_out_flat[8];
assign bitwise_logic_wrapper_in_flat[15] = const_shift_wrapper_out_flat[11];
assign const_conditional_wrapper_in_flat[9] = const_shift_wrapper_out_flat[12];
assign select_wrapper_in_flat[2] = const_shift_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[13] = const_shift_wrapper_out_flat[17];
assign const_reduce_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[23] = bitwise_logic_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[14];
assign arithmetic_reduce_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[14];
assign conditional_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[22];
assign relational_wrapper_in_flat[0] = logical_op_wrapper_out_flat[0];
assign select_wrapper_in_flat[16] = logical_op_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[0] = relational_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[2] = relational_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[0] = relational_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[6] = select_wrapper_out_flat[5];
assign relational_wrapper_in_flat[2] = select_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[8] = shift_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[3] = shift_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[13] = shift_wrapper_out_flat[7];
assign array_wrapper_in_flat[13] = shift_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[3] = array_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[2] = array_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[10] = array_wrapper_out_flat[9];
assign bitwise_logic_wrapper_in_flat[10] = array_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[1] = array_wrapper_out_flat[15];
assign width_enum_wrapper_in_flat[1] = cast_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[2] = cast_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[7] = cast_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[8] = conditional_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[0] = conditional_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[19] = conditional_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[1] = conditional_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[1] = conditional_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[7] = conditional_wrapper_out_flat[3];
...
assign const_partselect_wrapper_in_flat[4] = width_struct_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[3] = width_struct_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[5] = width_struct_wrapper_out_flat[6];
assign select_wrapper_in_flat[17] = width_struct_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[7] = width_struct_wrapper_out_flat[8];
assign width_logic_wrapper_in_flat[5] = width_struct_wrapper_out_flat[11];
assign partselect_wrapper_in_flat[17] = width_union_wrapper_out_flat[6];
assign cast_wrapper_in_flat[8] = width_union_wrapper_out_flat[14];
assign numbers_concat_repl_wrapper_in_flat[0] = width_logic_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[4] = width_logic_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[7] = width_logic_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[17];
