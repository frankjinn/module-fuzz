...
assign const_concat_repl_wrapper_in_flat[4] = in_flat[40];
assign const_concat_repl_wrapper_in_flat[5] = in_flat[41];
...
assign arithmetic_reduce_wrapper_in_flat[2] = in_flat[133];
...
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[160];
assign bitwise_reduce_wrapper_in_flat[7] = in_flat[161];
...
assign shift_wrapper_in_flat[0] = in_flat[182];
assign shift_wrapper_in_flat[1] = in_flat[183];
...
assign width_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[3] = const_arith_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[4] = const_arith_wrapper_out_flat[9];
assign select_wrapper_in_flat[7] = const_arith_wrapper_out_flat[15];
assign numbers_concat_repl_wrapper_in_flat[3] = const_arith_wrapper_out_flat[17];
assign bitwise_logic_wrapper_in_flat[5] = const_arith_wrapper_out_flat[19];
assign const_shift_wrapper_in_flat[3] = const_arith_wrapper_out_flat[31];
assign shift_wrapper_in_flat[3] = const_arith_wrapper_out_flat[38];
assign const_conditional_wrapper_in_flat[16] = const_compare_wrapper_out_flat[2];
assign array_wrapper_in_flat[14] = const_compare_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[15];
assign const_partselect_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[14];
assign width_struct_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[19];
assign array_wrapper_in_flat[17] = const_conditional_wrapper_out_flat[21];
assign conditional_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[22];
assign width_logic_wrapper_in_flat[6] = const_logic_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[2] = const_logic_wrapper_out_flat[9];
assign shift_wrapper_in_flat[6] = const_logic_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[15] = const_logic_wrapper_out_flat[15];
assign width_union_wrapper_in_flat[5] = const_nested_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[15] = const_nested_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[7] = const_nested_wrapper_out_flat[5];
assign relational_wrapper_in_flat[4] = const_nested_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[5];
assign select_wrapper_in_flat[13] = const_shift_wrapper_out_flat[2];
assign shift_wrapper_in_flat[4] = const_shift_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[3] = const_shift_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[2] = const_shift_wrapper_out_flat[6];
assign cast_wrapper_in_flat[4] = const_shift_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[5] = const_shift_wrapper_out_flat[8];
assign bitwise_logic_wrapper_in_flat[1] = const_shift_wrapper_out_flat[17];
assign partselect_wrapper_in_flat[16] = arithmetic_reduce_wrapper_out_flat[0];
assign relational_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[0];
assign cast_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[5];
assign shift_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[10];
assign const_compare_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[13];
assign array_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[21];
assign logical_op_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[21];
assign width_logic_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[21];
assign width_union_wrapper_in_flat[13] = logical_op_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[0] = logical_op_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[0] = relational_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[4] = relational_wrapper_out_flat[2];
assign cast_wrapper_in_flat[7] = select_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[16] = select_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[20] = shift_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[0] = shift_wrapper_out_flat[4];
assign select_wrapper_in_flat[6] = shift_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[9] = shift_wrapper_out_flat[11];
assign arithmetic_reduce_wrapper_in_flat[5] = shift_wrapper_out_flat[14];
assign partselect_wrapper_in_flat[6] = shift_wrapper_out_flat[15];
assign logical_op_wrapper_in_flat[1] = cast_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[18] = cast_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[4] = cast_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[31] = cast_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[3] = conditional_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[2] = partselect_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[2] = partselect_wrapper_out_flat[8];
assign relational_wrapper_in_flat[1] = partselect_wrapper_out_flat[8];
assign cast_wrapper_in_flat[8] = width_enum_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[15] = width_struct_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[17] = width_struct_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[1] = width_union_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[3] = width_union_wrapper_out_flat[11];
...
assign select_wrapper_in_flat[3] = width_logic_wrapper_out_flat[2];
assign relational_wrapper_in_flat[0] = width_logic_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[0] = width_logic_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[12] = numbers_concat_repl_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[6];
assign array_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[7];
assign cast_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[14];
assign arithmetic_reduce_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[15];
assign const_conditional_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[17];
