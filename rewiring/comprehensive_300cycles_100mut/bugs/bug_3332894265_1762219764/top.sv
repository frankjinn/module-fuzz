...
assign relational_wrapper_in_flat[4] = in_flat[165];
assign relational_wrapper_in_flat[5] = in_flat[166];
...
assign conditional_wrapper_in_flat[5] = in_flat[217];
...
assign conditional_wrapper_in_flat[7] = const_arith_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[23] = const_arith_wrapper_out_flat[27];
assign array_wrapper_in_flat[11] = const_arith_wrapper_out_flat[29];
assign conditional_wrapper_in_flat[1] = const_compare_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[2] = const_compare_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[5] = const_compare_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[2] = const_compare_wrapper_out_flat[6];
assign logical_op_wrapper_in_flat[0] = const_compare_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[6] = const_compare_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[0];
assign shift_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[6];
assign select_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[20];
assign width_logic_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[21];
assign conditional_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[23];
assign const_arith_wrapper_in_flat[15] = const_logic_wrapper_out_flat[1];
assign array_wrapper_in_flat[17] = const_logic_wrapper_out_flat[18];
assign width_union_wrapper_in_flat[11] = const_partselect_wrapper_out_flat[1];
...
assign const_compare_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[4];
assign relational_wrapper_in_flat[0] = const_shift_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[2] = const_shift_wrapper_out_flat[17];
assign cast_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[2];
assign select_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[3];
assign array_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[4];
assign shift_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[15] = arithmetic_reduce_wrapper_out_flat[9];
assign shift_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[18];
assign arithmetic_reduce_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[18];
assign cast_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[23];
assign width_logic_wrapper_in_flat[5] = bitwise_reduce_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[6] = logical_op_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[3] = relational_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[12] = select_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[9] = select_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[11] = select_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[2] = shift_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[13] = shift_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[9] = shift_wrapper_out_flat[4];
assign select_wrapper_in_flat[1] = shift_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[0] = shift_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[27] = array_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[14] = cast_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[21] = cast_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[6] = cast_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[4] = cast_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[6] = cast_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[3] = cast_wrapper_out_flat[10];
assign conditional_wrapper_in_flat[0] = cast_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[3] = conditional_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[2] = conditional_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[6] = partselect_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[5] = partselect_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[18] = partselect_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[0] = partselect_wrapper_out_flat[7];
assign logical_op_wrapper_in_flat[1] = width_struct_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[3] = width_struct_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[6] = width_struct_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[3] = width_struct_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[4] = width_struct_wrapper_out_flat[9];
assign select_wrapper_in_flat[16] = width_union_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[13] = width_union_wrapper_out_flat[12];
assign const_shift_wrapper_in_flat[9] = width_logic_wrapper_out_flat[5];
assign array_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[12];
assign const_reduce_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[15];
