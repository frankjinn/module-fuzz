...
assign const_conditional_wrapper_in_flat[22] = in_flat[56];
assign const_conditional_wrapper_in_flat[23] = in_flat[57];
...
assign const_logic_wrapper_in_flat[2] = in_flat[70];
assign const_logic_wrapper_in_flat[3] = in_flat[71];
...
assign select_wrapper_in_flat[14] = in_flat[173];
...
assign numbers_concat_repl_wrapper_in_flat[1] = const_arith_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[6] = const_arith_wrapper_out_flat[14];
assign partselect_wrapper_in_flat[17] = const_arith_wrapper_out_flat[25];
assign const_compare_wrapper_in_flat[2] = const_arith_wrapper_out_flat[32];
assign cast_wrapper_in_flat[0] = const_compare_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[1] = const_compare_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[13] = const_compare_wrapper_out_flat[3];
assign array_wrapper_in_flat[12] = const_compare_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[9] = const_compare_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[9];
assign partselect_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[10];
assign const_arith_wrapper_in_flat[14] = const_concat_repl_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[17] = const_conditional_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[15];
assign select_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[16];
assign width_union_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[18];
assign const_arith_wrapper_in_flat[10] = const_logic_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[4] = const_logic_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[10] = const_logic_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[7] = const_logic_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[2] = const_logic_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[6] = const_logic_wrapper_out_flat[11];
assign const_conditional_wrapper_in_flat[5] = const_logic_wrapper_out_flat[11];
assign const_shift_wrapper_in_flat[7] = const_logic_wrapper_out_flat[13];
assign relational_wrapper_in_flat[1] = const_logic_wrapper_out_flat[15];
assign width_struct_wrapper_in_flat[0] = const_nested_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[14] = const_partselect_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[1];
assign cast_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[13] = const_reduce_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[7] = const_shift_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[1] = const_shift_wrapper_out_flat[8];
assign cast_wrapper_in_flat[8] = const_shift_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[16] = const_shift_wrapper_out_flat[15];
assign const_concat_repl_wrapper_in_flat[8] = const_shift_wrapper_out_flat[17];
assign bitwise_reduce_wrapper_in_flat[3] = const_shift_wrapper_out_flat[18];
assign const_arith_wrapper_in_flat[8] = const_shift_wrapper_out_flat[19];
assign width_struct_wrapper_in_flat[11] = const_shift_wrapper_out_flat[23];
assign shift_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[2];
assign select_wrapper_in_flat[13] = bitwise_logic_wrapper_out_flat[4];
assign relational_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[8];
assign const_logic_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[10];
assign const_shift_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[19];
assign width_struct_wrapper_in_flat[9] = logical_op_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[6] = relational_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[0] = relational_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[4] = relational_wrapper_out_flat[3];
assign select_wrapper_in_flat[12] = relational_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[9] = relational_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[7] = relational_wrapper_out_flat[7];
assign cast_wrapper_in_flat[3] = select_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[11] = select_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[5] = select_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[4] = array_wrapper_out_flat[8];
assign width_enum_wrapper_in_flat[2] = array_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[16] = array_wrapper_out_flat[14];
assign width_struct_wrapper_in_flat[3] = cast_wrapper_out_flat[9];
assign numbers_concat_repl_wrapper_in_flat[3] = cast_wrapper_out_flat[10];
assign cast_wrapper_in_flat[7] = conditional_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[5] = conditional_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[2] = partselect_wrapper_out_flat[1];
assign array_wrapper_in_flat[3] = partselect_wrapper_out_flat[4];
assign logical_op_wrapper_in_flat[0] = partselect_wrapper_out_flat[4];
assign array_wrapper_in_flat[5] = width_struct_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[15] = width_struct_wrapper_out_flat[11];
assign select_wrapper_in_flat[9] = width_union_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[0] = width_union_wrapper_out_flat[5];
...
assign select_wrapper_in_flat[18] = width_logic_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[1] = width_logic_wrapper_out_flat[4];
assign relational_wrapper_in_flat[2] = width_logic_wrapper_out_flat[4];
assign array_wrapper_in_flat[16] = numbers_concat_repl_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[18] = numbers_concat_repl_wrapper_out_flat[17];
