...
assign const_logic_wrapper_in_flat[2] = in_flat[76];
...
assign const_nested_wrapper_in_flat[1] = in_flat[85];
...
assign const_reduce_wrapper_in_flat[3] = in_flat[119];
assign const_shift_wrapper_in_flat[0] = in_flat[120];
...
assign arithmetic_reduce_wrapper_in_flat[7] = in_flat[136];
assign arithmetic_reduce_wrapper_in_flat[8] = in_flat[137];
...
assign shift_wrapper_in_flat[2] = in_flat[180];
assign shift_wrapper_in_flat[3] = in_flat[181];
...
assign cast_wrapper_in_flat[4] = in_flat[204];
...
assign conditional_wrapper_in_flat[0] = in_flat[212];
...
assign width_enum_wrapper_in_flat[3] = in_flat[232];
...
assign width_logic_wrapper_in_flat[0] = in_flat[254];
...
assign numbers_concat_repl_wrapper_in_flat[5] = const_arith_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[4] = const_arith_wrapper_out_flat[18];
assign bitwise_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[19];
assign select_wrapper_in_flat[18] = const_arith_wrapper_out_flat[23];
assign width_logic_wrapper_in_flat[5] = const_arith_wrapper_out_flat[24];
assign const_nested_wrapper_in_flat[24] = const_compare_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[0] = const_compare_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[7] = const_compare_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[3];
assign array_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[11];
assign partselect_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[16];
assign cast_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[20];
assign width_struct_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[23];
assign arithmetic_reduce_wrapper_in_flat[10] = const_logic_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[30] = const_logic_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[8] = const_logic_wrapper_out_flat[8];
assign array_wrapper_in_flat[10] = const_logic_wrapper_out_flat[12];
assign const_shift_wrapper_in_flat[4] = const_logic_wrapper_out_flat[18];
assign bitwise_reduce_wrapper_in_flat[7] = const_nested_wrapper_out_flat[2];
assign shift_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[1];
assign relational_wrapper_in_flat[7] = const_reduce_wrapper_out_flat[1];
assign shift_wrapper_in_flat[7] = const_reduce_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[1] = const_shift_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = const_shift_wrapper_out_flat[6];
assign bitwise_logic_wrapper_in_flat[1] = const_shift_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[6] = const_shift_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[6] = const_shift_wrapper_out_flat[15];
assign const_partselect_wrapper_in_flat[10] = arithmetic_reduce_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[12] = arithmetic_reduce_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[6];
assign shift_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[10];
assign select_wrapper_in_flat[12] = bitwise_logic_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[15];
assign arithmetic_reduce_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[17];
assign width_union_wrapper_in_flat[0] = logical_op_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[25] = relational_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[8] = select_wrapper_out_flat[7];
assign select_wrapper_in_flat[8] = shift_wrapper_out_flat[11];
assign relational_wrapper_in_flat[3] = shift_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[5] = shift_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[5] = array_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[13] = array_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[20] = array_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[2] = array_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[3] = array_wrapper_out_flat[13];
assign width_union_wrapper_in_flat[7] = cast_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[0] = cast_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[0] = cast_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[9] = cast_wrapper_out_flat[6];
assign shift_wrapper_in_flat[6] = cast_wrapper_out_flat[11];
assign const_arith_wrapper_in_flat[2] = cast_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[0] = conditional_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[1] = partselect_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[17] = partselect_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[14] = partselect_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[2] = partselect_wrapper_out_flat[3];
assign array_wrapper_in_flat[15] = partselect_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[2] = partselect_wrapper_out_flat[6];
assign relational_wrapper_in_flat[2] = partselect_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[13] = width_struct_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[7] = width_struct_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[14] = width_struct_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[9] = width_union_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[6] = width_union_wrapper_out_flat[9];
assign width_enum_wrapper_in_flat[1] = width_union_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[4] = width_union_wrapper_out_flat[11];
assign arithmetic_reduce_wrapper_in_flat[3] = width_union_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[9] = width_logic_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[9];
assign shift_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[18] = numbers_concat_repl_wrapper_out_flat[13];
assign bitwise_reduce_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[14];
