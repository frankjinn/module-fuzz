...
assign select_wrapper_in_flat[0] = in_flat[168];
assign select_wrapper_in_flat[1] = in_flat[169];
...
assign shift_wrapper_in_flat[6] = in_flat[190];
assign shift_wrapper_in_flat[7] = in_flat[191];
assign shift_wrapper_in_flat[8] = in_flat[192];
...
assign cast_wrapper_in_flat[8] = in_flat[216];
assign cast_wrapper_in_flat[10] = in_flat[217];
assign cast_wrapper_in_flat[11] = in_flat[218];
assign conditional_wrapper_in_flat[0] = in_flat[219];
assign conditional_wrapper_in_flat[3] = in_flat[220];
assign conditional_wrapper_in_flat[4] = in_flat[221];
...
assign partselect_wrapper_in_flat[17] = in_flat[239];
...
assign width_logic_wrapper_in_flat[0] = in_flat[260];
...
assign conditional_wrapper_in_flat[7] = const_arith_wrapper_out_flat[24];
assign const_concat_repl_wrapper_in_flat[3] = const_compare_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[24] = const_compare_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[13];
assign width_union_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[21];
assign bitwise_reduce_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[21];
assign width_struct_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[15];
assign logical_op_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[20];
assign const_nested_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[20];
assign width_logic_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[23];
...
assign const_conditional_wrapper_in_flat[12] = const_logic_wrapper_out_flat[12];
assign relational_wrapper_in_flat[6] = const_logic_wrapper_out_flat[12];
assign arithmetic_reduce_wrapper_in_flat[10] = const_nested_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[1] = const_nested_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[2] = const_shift_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[4] = const_shift_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[0] = const_shift_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[1] = const_shift_wrapper_out_flat[9];
assign width_union_wrapper_in_flat[11] = const_shift_wrapper_out_flat[9];
assign cast_wrapper_in_flat[4] = const_shift_wrapper_out_flat[12];
assign partselect_wrapper_in_flat[16] = const_shift_wrapper_out_flat[17];
assign const_arith_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[2];
assign array_wrapper_in_flat[12] = bitwise_logic_wrapper_out_flat[8];
assign select_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[9];
assign shift_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[15];
assign const_compare_wrapper_in_flat[21] = bitwise_logic_wrapper_out_flat[19];
assign const_logic_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[21];
assign arithmetic_reduce_wrapper_in_flat[2] = bitwise_reduce_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[5] = logical_op_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[23] = relational_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[12] = relational_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[14] = relational_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[8] = select_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[13] = select_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[18] = select_wrapper_out_flat[4];
assign relational_wrapper_in_flat[5] = select_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[6] = select_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[4] = shift_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[5] = shift_wrapper_out_flat[1];
assign array_wrapper_in_flat[9] = shift_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[3] = shift_wrapper_out_flat[15];
assign select_wrapper_in_flat[6] = array_wrapper_out_flat[4];
assign relational_wrapper_in_flat[0] = array_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[18] = array_wrapper_out_flat[9];
assign width_enum_wrapper_in_flat[2] = cast_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[4] = cast_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[2] = partselect_wrapper_out_flat[1];
...
assign conditional_wrapper_in_flat[1] = width_enum_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[1] = width_enum_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[1] = width_enum_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[13] = width_struct_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[0] = width_union_wrapper_out_flat[1];
assign cast_wrapper_in_flat[0] = width_union_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[7] = width_union_wrapper_out_flat[14];
assign const_arith_wrapper_in_flat[15] = width_logic_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[5] = width_logic_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[4] = width_logic_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[12];
assign width_logic_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[13];
