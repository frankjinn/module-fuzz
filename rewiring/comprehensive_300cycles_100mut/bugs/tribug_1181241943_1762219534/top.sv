...
assign shift_wrapper_in_flat[1] = const_arith_wrapper_out_flat[13];
assign const_shift_wrapper_in_flat[9] = const_arith_wrapper_out_flat[14];
assign width_logic_wrapper_in_flat[0] = const_arith_wrapper_out_flat[21];
assign const_logic_wrapper_in_flat[4] = const_arith_wrapper_out_flat[25];
assign array_wrapper_in_flat[5] = const_arith_wrapper_out_flat[26];
assign cast_wrapper_in_flat[4] = const_arith_wrapper_out_flat[28];
assign bitwise_logic_wrapper_in_flat[5] = const_arith_wrapper_out_flat[35];
assign relational_wrapper_in_flat[1] = const_compare_wrapper_out_flat[0];
assign shift_wrapper_in_flat[5] = const_compare_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[0];
assign shift_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[10];
assign select_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[18] = const_concat_repl_wrapper_out_flat[20];
assign const_nested_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[10];
assign relational_wrapper_in_flat[4] = const_logic_wrapper_out_flat[0];
assign select_wrapper_in_flat[0] = const_logic_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[0] = const_logic_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[19] = const_logic_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[11] = const_logic_wrapper_out_flat[8];
assign const_concat_repl_wrapper_in_flat[0] = const_logic_wrapper_out_flat[8];
assign const_conditional_wrapper_in_flat[24] = const_logic_wrapper_out_flat[11];
assign logical_op_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[28] = const_partselect_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[5];
assign array_wrapper_in_flat[10] = const_shift_wrapper_out_flat[6];
assign select_wrapper_in_flat[1] = const_shift_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[1] = const_shift_wrapper_out_flat[12];
assign cast_wrapper_in_flat[1] = const_shift_wrapper_out_flat[13];
assign const_concat_repl_wrapper_in_flat[3] = const_shift_wrapper_out_flat[19];
assign const_nested_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[18] = arithmetic_reduce_wrapper_out_flat[6];
assign logical_op_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[2];
assign select_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[4];
assign array_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[10];
assign conditional_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[10];
assign relational_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[13];
assign width_union_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[18];
assign width_logic_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[18];
...
assign const_shift_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[22];
assign width_struct_wrapper_in_flat[2] = logical_op_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[6] = relational_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[3] = relational_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[30] = relational_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[5] = relational_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[6] = select_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[12] = select_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[3] = select_wrapper_out_flat[4];
assign relational_wrapper_in_flat[5] = shift_wrapper_out_flat[3];
...
assign const_logic_wrapper_in_flat[7] = array_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[8] = array_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[11] = array_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[1] = array_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[0] = array_wrapper_out_flat[14];
assign const_logic_wrapper_in_flat[5] = cast_wrapper_out_flat[0];
assign array_wrapper_in_flat[12] = cast_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[1] = cast_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[4] = conditional_wrapper_out_flat[0];
assign relational_wrapper_in_flat[6] = conditional_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[18] = partselect_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[9] = width_enum_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[8] = width_union_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[6] = width_union_wrapper_out_flat[1];
assign select_wrapper_in_flat[5] = width_union_wrapper_out_flat[10];
assign conditional_wrapper_in_flat[6] = width_union_wrapper_out_flat[11];
assign const_conditional_wrapper_in_flat[23] = width_union_wrapper_out_flat[12];
assign width_logic_wrapper_in_flat[3] = width_union_wrapper_out_flat[13];
assign width_struct_wrapper_in_flat[8] = width_logic_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[9];
