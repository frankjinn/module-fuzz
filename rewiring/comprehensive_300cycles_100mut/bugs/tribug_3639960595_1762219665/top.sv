...
assign const_compare_wrapper_in_flat[21] = in_flat[29];
...
assign relational_wrapper_in_flat[1] = in_flat[159];
assign relational_wrapper_in_flat[2] = in_flat[160];
assign relational_wrapper_in_flat[5] = in_flat[161];
assign relational_wrapper_in_flat[6] = in_flat[162];
assign relational_wrapper_in_flat[7] = in_flat[163];
assign select_wrapper_in_flat[1] = in_flat[164];
assign select_wrapper_in_flat[2] = in_flat[165];
assign select_wrapper_in_flat[3] = in_flat[166];
assign select_wrapper_in_flat[4] = in_flat[167];
assign select_wrapper_in_flat[6] = in_flat[168];
assign select_wrapper_in_flat[7] = in_flat[169];
assign select_wrapper_in_flat[8] = in_flat[170];
assign select_wrapper_in_flat[9] = in_flat[171];
assign select_wrapper_in_flat[10] = in_flat[172];
...
assign array_wrapper_in_flat[7] = in_flat[193];
...
assign conditional_wrapper_in_flat[6] = in_flat[212];
...
assign width_enum_wrapper_in_flat[0] = in_flat[231];
...
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[258];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[259];

// Internal MTM connections (module-to-module)
assign const_concat_repl_wrapper_in_flat[6] = const_arith_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[4] = const_arith_wrapper_out_flat[9];
assign width_enum_wrapper_in_flat[1] = const_arith_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[13] = const_arith_wrapper_out_flat[16];
assign shift_wrapper_in_flat[2] = const_arith_wrapper_out_flat[18];
assign width_union_wrapper_in_flat[11] = const_arith_wrapper_out_flat[19];
assign const_conditional_wrapper_in_flat[6] = const_arith_wrapper_out_flat[22];
assign bitwise_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[35];
assign numbers_concat_repl_wrapper_in_flat[0] = const_compare_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[7];
assign select_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[11];
assign shift_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[0];
assign cast_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[12];
assign relational_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[23];
assign const_conditional_wrapper_in_flat[9] = const_logic_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[14] = const_logic_wrapper_out_flat[5];
assign cast_wrapper_in_flat[3] = const_logic_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[0] = const_logic_wrapper_out_flat[10];
assign shift_wrapper_in_flat[0] = const_logic_wrapper_out_flat[18];
assign width_struct_wrapper_in_flat[9] = const_nested_wrapper_out_flat[2];
assign select_wrapper_in_flat[14] = const_nested_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[7] = const_nested_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[16] = const_partselect_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[3];
assign cast_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[5] = const_shift_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[7] = const_shift_wrapper_out_flat[10];
assign const_logic_wrapper_in_flat[2] = const_shift_wrapper_out_flat[17];
assign relational_wrapper_in_flat[0] = const_shift_wrapper_out_flat[22];
assign const_nested_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[3];
assign cast_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[12];
assign arithmetic_reduce_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[15];
assign logical_op_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[21];
assign conditional_wrapper_in_flat[3] = logical_op_wrapper_out_flat[0];
assign select_wrapper_in_flat[5] = logical_op_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[7] = relational_wrapper_out_flat[0];
assign array_wrapper_in_flat[1] = select_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[1] = select_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[23] = shift_wrapper_out_flat[9];
assign partselect_wrapper_in_flat[8] = shift_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[1] = shift_wrapper_out_flat[10];
assign numbers_concat_repl_wrapper_in_flat[5] = shift_wrapper_out_flat[11];
assign cast_wrapper_in_flat[8] = shift_wrapper_out_flat[13];
assign logical_op_wrapper_in_flat[1] = shift_wrapper_out_flat[15];
assign bitwise_reduce_wrapper_in_flat[6] = array_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[4] = cast_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[2] = cast_wrapper_out_flat[3];
assign relational_wrapper_in_flat[3] = cast_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[5] = cast_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[3] = cast_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[0] = conditional_wrapper_out_flat[3];
assign cast_wrapper_in_flat[2] = partselect_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[2] = partselect_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[16] = partselect_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[4] = partselect_wrapper_out_flat[7];
assign cast_wrapper_in_flat[10] = width_enum_wrapper_out_flat[4];
assign select_wrapper_in_flat[0] = width_struct_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[17] = width_union_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[10] = width_union_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[8] = width_union_wrapper_out_flat[15];
assign shift_wrapper_in_flat[1] = width_union_wrapper_out_flat[15];
assign width_struct_wrapper_in_flat[10] = width_logic_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[11];
