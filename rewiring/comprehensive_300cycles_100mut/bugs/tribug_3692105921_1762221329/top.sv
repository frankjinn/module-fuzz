...
assign const_concat_repl_wrapper_in_flat[9] = in_flat[39];
assign const_conditional_wrapper_in_flat[0] = in_flat[40];
...
assign const_logic_wrapper_in_flat[0] = in_flat[66];
assign const_logic_wrapper_in_flat[1] = in_flat[67];
assign const_logic_wrapper_in_flat[2] = in_flat[68];
assign const_logic_wrapper_in_flat[3] = in_flat[69];
...
assign const_nested_wrapper_in_flat[16] = in_flat[89];
assign const_nested_wrapper_in_flat[17] = in_flat[90];
...
assign const_partselect_wrapper_in_flat[12] = in_flat[107];
assign const_partselect_wrapper_in_flat[13] = in_flat[108];
assign const_partselect_wrapper_in_flat[14] = in_flat[109];
assign const_partselect_wrapper_in_flat[15] = in_flat[110];
assign const_partselect_wrapper_in_flat[16] = in_flat[111];
...
assign const_shift_wrapper_in_flat[7] = in_flat[121];
assign const_shift_wrapper_in_flat[8] = in_flat[122];
assign const_shift_wrapper_in_flat[9] = in_flat[123];
assign const_shift_wrapper_in_flat[10] = in_flat[124];
...
assign bitwise_logic_wrapper_in_flat[1] = in_flat[139];
...
assign bitwise_logic_wrapper_in_flat[8] = in_flat[145];
assign bitwise_logic_wrapper_in_flat[9] = in_flat[146];
assign bitwise_logic_wrapper_in_flat[10] = in_flat[147];
assign bitwise_logic_wrapper_in_flat[12] = in_flat[148];
assign bitwise_logic_wrapper_in_flat[13] = in_flat[149];
assign bitwise_reduce_wrapper_in_flat[0] = in_flat[150];
assign bitwise_reduce_wrapper_in_flat[1] = in_flat[151];
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[152];
...
assign select_wrapper_in_flat[8] = in_flat[165];
...
assign shift_wrapper_in_flat[1] = in_flat[175];
...
assign array_wrapper_in_flat[2] = in_flat[186];
...
assign cast_wrapper_in_flat[3] = in_flat[203];
assign cast_wrapper_in_flat[5] = in_flat[204];
assign cast_wrapper_in_flat[6] = in_flat[205];
assign cast_wrapper_in_flat[7] = in_flat[206];
...
assign partselect_wrapper_in_flat[1] = in_flat[216];
...
assign width_logic_wrapper_in_flat[1] = in_flat[255];
...
assign conditional_wrapper_in_flat[5] = const_arith_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[4] = const_arith_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[25] = const_arith_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[4] = const_arith_wrapper_out_flat[9];
assign width_enum_wrapper_in_flat[0] = const_arith_wrapper_out_flat[11];
assign bitwise_logic_wrapper_in_flat[7] = const_arith_wrapper_out_flat[12];
assign width_struct_wrapper_in_flat[8] = const_arith_wrapper_out_flat[15];
assign select_wrapper_in_flat[2] = const_arith_wrapper_out_flat[17];
assign const_nested_wrapper_in_flat[10] = const_arith_wrapper_out_flat[19];
assign array_wrapper_in_flat[1] = const_arith_wrapper_out_flat[20];
assign width_logic_wrapper_in_flat[4] = const_arith_wrapper_out_flat[28];
assign logical_op_wrapper_in_flat[0] = const_arith_wrapper_out_flat[33];
assign const_conditional_wrapper_in_flat[7] = const_compare_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[0] = const_compare_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[17];
assign width_enum_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[19];
assign const_partselect_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[21];
assign const_partselect_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[20];
assign conditional_wrapper_in_flat[2] = const_logic_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[21] = const_logic_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[3] = const_logic_wrapper_out_flat[12];
assign numbers_concat_repl_wrapper_in_flat[2] = const_nested_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[2] = const_nested_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[14] = const_reduce_wrapper_out_flat[5];
assign shift_wrapper_in_flat[0] = const_shift_wrapper_out_flat[6];
assign array_wrapper_in_flat[8] = const_shift_wrapper_out_flat[7];
assign cast_wrapper_in_flat[10] = const_shift_wrapper_out_flat[9];
assign const_arith_wrapper_in_flat[9] = const_shift_wrapper_out_flat[19];
assign const_compare_wrapper_in_flat[18] = const_shift_wrapper_out_flat[23];
assign relational_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[0];
assign select_wrapper_in_flat[17] = arithmetic_reduce_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[17] = bitwise_logic_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[9];
assign width_enum_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[15];
assign const_conditional_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[16];
assign conditional_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[20];
assign const_concat_repl_wrapper_in_flat[5] = bitwise_reduce_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[14] = logical_op_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[4] = relational_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[0] = relational_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[11] = relational_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[8] = select_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[2] = select_wrapper_out_flat[5];
assign logical_op_wrapper_in_flat[1] = select_wrapper_out_flat[6];
assign array_wrapper_in_flat[5] = select_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[9] = shift_wrapper_out_flat[1];
assign cast_wrapper_in_flat[4] = shift_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[3] = shift_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[5] = shift_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[2] = array_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[4] = cast_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[13] = cast_wrapper_out_flat[8];
assign relational_wrapper_in_flat[4] = cast_wrapper_out_flat[10];
assign width_union_wrapper_in_flat[5] = cast_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[5] = conditional_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[4] = conditional_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[5] = partselect_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[9] = width_enum_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[2] = width_struct_wrapper_out_flat[0];
assign relational_wrapper_in_flat[7] = width_struct_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[5] = width_struct_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[4] = width_struct_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[0] = width_struct_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[1] = width_struct_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[21] = width_struct_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[2] = width_struct_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[9] = width_union_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[6] = width_union_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[18] = width_union_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[14] = width_union_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[7] = width_logic_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[15] = numbers_concat_repl_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[8];
assign relational_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[13];
assign select_wrapper_in_flat[16] = numbers_concat_repl_wrapper_out_flat[13];
assign width_struct_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[17];
