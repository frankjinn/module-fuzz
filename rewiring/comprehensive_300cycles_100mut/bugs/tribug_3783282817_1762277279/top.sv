...
assign const_conditional_wrapper_in_flat[21] = in_flat[65];
assign const_conditional_wrapper_in_flat[22] = in_flat[66];
assign const_conditional_wrapper_in_flat[23] = in_flat[67];
...
assign const_conditional_wrapper_in_flat[27] = in_flat[71];
assign const_conditional_wrapper_in_flat[28] = in_flat[72];
assign const_conditional_wrapper_in_flat[29] = in_flat[73];
assign const_conditional_wrapper_in_flat[30] = in_flat[74];
assign const_conditional_wrapper_in_flat[31] = in_flat[75];
assign const_conditional_wrapper_in_flat[32] = in_flat[76];
...
assign cast_wrapper_in_flat[9] = in_flat[212];
...
assign numbers_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[0];
assign select_wrapper_in_flat[3] = const_arith_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[0] = const_arith_wrapper_out_flat[2];
assign cast_wrapper_in_flat[2] = const_arith_wrapper_out_flat[20];
assign bitwise_logic_wrapper_in_flat[13] = const_arith_wrapper_out_flat[26];
assign const_reduce_wrapper_in_flat[3] = const_arith_wrapper_out_flat[31];
assign array_wrapper_in_flat[4] = const_compare_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[10] = const_compare_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[1] = const_compare_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[10] = const_compare_wrapper_out_flat[6];
assign shift_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[14];
assign arithmetic_reduce_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[15];
assign width_enum_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[18];
assign const_nested_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[18] = const_conditional_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[17];
assign const_logic_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[20];
assign partselect_wrapper_in_flat[0] = const_logic_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[5] = const_logic_wrapper_out_flat[9];
assign relational_wrapper_in_flat[0] = const_logic_wrapper_out_flat[14];
assign bitwise_reduce_wrapper_in_flat[1] = const_nested_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[7] = const_nested_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[10] = const_nested_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[33] = const_partselect_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[2];
assign relational_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[1] = const_shift_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[7] = const_shift_wrapper_out_flat[5];
assign relational_wrapper_in_flat[1] = const_shift_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[19] = const_shift_wrapper_out_flat[13];
assign bitwise_logic_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[16] = arithmetic_reduce_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[9];
assign array_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[3] = logical_op_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[4] = relational_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[14] = relational_wrapper_out_flat[6];
assign cast_wrapper_in_flat[6] = select_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[13] = select_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[14] = shift_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[2] = shift_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[6] = shift_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[1] = shift_wrapper_out_flat[9];
...
assign const_reduce_wrapper_in_flat[0] = array_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[0] = array_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[2] = cast_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[2] = cast_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[2] = cast_wrapper_out_flat[10];
...
assign shift_wrapper_in_flat[2] = width_enum_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[7] = width_enum_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[8] = width_struct_wrapper_out_flat[1];
assign relational_wrapper_in_flat[3] = width_struct_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[6] = width_struct_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[2] = width_struct_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[3] = width_struct_wrapper_out_flat[9];
assign array_wrapper_in_flat[12] = width_union_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[15] = width_union_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[14] = numbers_concat_repl_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[14] = numbers_concat_repl_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[13];
assign array_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[13];
assign width_logic_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[14];
