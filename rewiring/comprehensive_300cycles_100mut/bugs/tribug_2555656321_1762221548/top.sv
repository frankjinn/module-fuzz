...
assign const_nested_wrapper_in_flat[1] = in_flat[87];
...
assign const_partselect_wrapper_in_flat[16] = in_flat[123];
assign const_partselect_wrapper_in_flat[17] = in_flat[124];
assign const_partselect_wrapper_in_flat[18] = in_flat[125];
assign const_partselect_wrapper_in_flat[19] = in_flat[126];
assign const_reduce_wrapper_in_flat[2] = in_flat[127];
assign const_reduce_wrapper_in_flat[3] = in_flat[128];
...
assign arithmetic_reduce_wrapper_in_flat[10] = in_flat[145];
...
assign arithmetic_reduce_wrapper_in_flat[15] = in_flat[149];
assign bitwise_logic_wrapper_in_flat[0] = in_flat[150];
...
assign bitwise_logic_wrapper_in_flat[11] = in_flat[158];
assign bitwise_logic_wrapper_in_flat[12] = in_flat[159];
assign bitwise_logic_wrapper_in_flat[13] = in_flat[160];
...
assign relational_wrapper_in_flat[1] = in_flat[166];
...
assign cast_wrapper_in_flat[10] = const_arith_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[5] = const_arith_wrapper_out_flat[24];
assign const_shift_wrapper_in_flat[9] = const_arith_wrapper_out_flat[32];
assign numbers_concat_repl_wrapper_in_flat[3] = const_arith_wrapper_out_flat[35];
assign select_wrapper_in_flat[1] = const_arith_wrapper_out_flat[38];
assign const_logic_wrapper_in_flat[6] = const_arith_wrapper_out_flat[39];
assign logical_op_wrapper_in_flat[0] = const_compare_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[8] = const_compare_wrapper_out_flat[1];
assign shift_wrapper_in_flat[9] = const_compare_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[2] = const_compare_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[5] = const_compare_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[17] = const_compare_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[15];
assign array_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[17];
assign shift_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[18];
assign partselect_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[1];
assign select_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[9];
assign cast_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[15];
assign array_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[22];
assign const_reduce_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[22];
assign numbers_concat_repl_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[22];
assign cast_wrapper_in_flat[2] = const_logic_wrapper_out_flat[8];
assign numbers_concat_repl_wrapper_in_flat[1] = const_logic_wrapper_out_flat[16];
assign conditional_wrapper_in_flat[1] = const_logic_wrapper_out_flat[17];
assign const_conditional_wrapper_in_flat[26] = const_logic_wrapper_out_flat[17];
assign bitwise_logic_wrapper_in_flat[1] = const_nested_wrapper_out_flat[0];
assign shift_wrapper_in_flat[8] = const_nested_wrapper_out_flat[6];
assign bitwise_logic_wrapper_in_flat[14] = const_partselect_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[3];
assign array_wrapper_in_flat[11] = const_reduce_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[2] = const_shift_wrapper_out_flat[12];
assign const_concat_repl_wrapper_in_flat[4] = const_shift_wrapper_out_flat[14];
assign width_union_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[5];
assign relational_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[23];
assign shift_wrapper_in_flat[10] = logical_op_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[2] = logical_op_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[6] = logical_op_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[4] = relational_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[7] = relational_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[3] = select_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[7] = shift_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[6] = shift_wrapper_out_flat[10];
assign width_enum_wrapper_in_flat[3] = array_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[11] = array_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[9] = array_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[2] = array_wrapper_out_flat[12];
assign bitwise_reduce_wrapper_in_flat[3] = array_wrapper_out_flat[13];
assign const_shift_wrapper_in_flat[5] = cast_wrapper_out_flat[7];
assign select_wrapper_in_flat[8] = cast_wrapper_out_flat[8];
assign const_concat_repl_wrapper_in_flat[5] = cast_wrapper_out_flat[11];
assign width_struct_wrapper_in_flat[11] = cast_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[5] = conditional_wrapper_out_flat[0];
assign relational_wrapper_in_flat[3] = conditional_wrapper_out_flat[0];
assign shift_wrapper_in_flat[0] = conditional_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[26] = conditional_wrapper_out_flat[3];
assign shift_wrapper_in_flat[5] = partselect_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = partselect_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[0] = partselect_wrapper_out_flat[8];
assign array_wrapper_in_flat[16] = width_struct_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[3] = width_struct_wrapper_out_flat[6];
assign shift_wrapper_in_flat[7] = width_struct_wrapper_out_flat[9];
assign bitwise_logic_wrapper_in_flat[4] = width_struct_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[5] = width_union_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[12] = width_logic_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[0] = width_logic_wrapper_out_flat[2];
assign cast_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[14];
