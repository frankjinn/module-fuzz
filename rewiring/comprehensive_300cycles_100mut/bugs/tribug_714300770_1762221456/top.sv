...
assign const_logic_wrapper_in_flat[3] = in_flat[73];
...
assign const_nested_wrapper_in_flat[3] = in_flat[80];
assign const_nested_wrapper_in_flat[4] = in_flat[81];
assign const_nested_wrapper_in_flat[5] = in_flat[82];
assign const_nested_wrapper_in_flat[6] = in_flat[83];
assign const_nested_wrapper_in_flat[7] = in_flat[84];
assign const_nested_wrapper_in_flat[8] = in_flat[85];
assign const_nested_wrapper_in_flat[9] = in_flat[86];
assign const_nested_wrapper_in_flat[11] = in_flat[87];
...
assign const_nested_wrapper_in_flat[18] = in_flat[93];
assign const_nested_wrapper_in_flat[19] = in_flat[94];
assign const_nested_wrapper_in_flat[20] = in_flat[95];
assign const_nested_wrapper_in_flat[21] = in_flat[96];
assign const_nested_wrapper_in_flat[22] = in_flat[97];
assign const_nested_wrapper_in_flat[23] = in_flat[98];
...
assign const_partselect_wrapper_in_flat[2] = in_flat[102];
assign const_partselect_wrapper_in_flat[3] = in_flat[103];
...
assign arithmetic_reduce_wrapper_in_flat[14] = in_flat[135];
...
assign shift_wrapper_in_flat[4] = in_flat[182];
assign shift_wrapper_in_flat[5] = in_flat[183];
assign shift_wrapper_in_flat[6] = in_flat[184];
assign shift_wrapper_in_flat[7] = in_flat[185];
...
assign array_wrapper_in_flat[8] = in_flat[192];
assign array_wrapper_in_flat[9] = in_flat[193];
assign array_wrapper_in_flat[10] = in_flat[194];
assign array_wrapper_in_flat[12] = in_flat[195];
assign array_wrapper_in_flat[13] = in_flat[196];
...
assign conditional_wrapper_in_flat[3] = in_flat[209];
...
assign partselect_wrapper_in_flat[2] = in_flat[215];
...
assign partselect_wrapper_in_flat[16] = in_flat[226];
assign partselect_wrapper_in_flat[17] = in_flat[227];
...
assign relational_wrapper_in_flat[0] = const_arith_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[28] = const_arith_wrapper_out_flat[15];
assign width_logic_wrapper_in_flat[6] = const_arith_wrapper_out_flat[21];
assign array_wrapper_in_flat[11] = const_arith_wrapper_out_flat[22];
assign const_shift_wrapper_in_flat[0] = const_arith_wrapper_out_flat[30];
assign const_partselect_wrapper_in_flat[12] = const_compare_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[0] = const_compare_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[9];
assign cast_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[9];
assign width_union_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[18];
assign const_shift_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[20];
assign width_enum_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[20];
assign arithmetic_reduce_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[4];
assign relational_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[9];
assign logical_op_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[10];
assign conditional_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[14];
assign partselect_wrapper_in_flat[4] = const_nested_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[5];
assign logical_op_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[14] = const_reduce_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[9] = const_reduce_wrapper_out_flat[3];
assign array_wrapper_in_flat[4] = const_shift_wrapper_out_flat[20];
assign const_conditional_wrapper_in_flat[20] = const_shift_wrapper_out_flat[21];
assign bitwise_reduce_wrapper_in_flat[4] = const_shift_wrapper_out_flat[22];
assign const_compare_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[2];
assign relational_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[9];
assign numbers_concat_repl_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[4];
assign select_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[5];
assign shift_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[24] = bitwise_logic_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[16];
assign width_enum_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[20];
assign width_logic_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[21];
assign const_compare_wrapper_in_flat[17] = bitwise_reduce_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[2] = bitwise_reduce_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[12] = relational_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[1] = relational_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[6] = select_wrapper_out_flat[0];
assign array_wrapper_in_flat[6] = select_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[2] = select_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[25] = select_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[0] = select_wrapper_out_flat[7];
assign cast_wrapper_in_flat[8] = shift_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[6] = shift_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[0] = shift_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[7] = shift_wrapper_out_flat[8];
assign relational_wrapper_in_flat[6] = array_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[19] = array_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[4] = array_wrapper_out_flat[10];
assign const_reduce_wrapper_in_flat[3] = array_wrapper_out_flat[12];
assign const_conditional_wrapper_in_flat[0] = array_wrapper_out_flat[12];
assign bitwise_reduce_wrapper_in_flat[0] = cast_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[1] = cast_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[7] = cast_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[6] = cast_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[3] = conditional_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[8] = partselect_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[13] = width_enum_wrapper_out_flat[1];
assign shift_wrapper_in_flat[10] = width_enum_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[10] = width_enum_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[0] = width_enum_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[2] = width_struct_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[9] = width_struct_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[8] = width_struct_wrapper_out_flat[11];
assign numbers_concat_repl_wrapper_in_flat[2] = width_struct_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[13] = width_union_wrapper_out_flat[9];
assign array_wrapper_in_flat[14] = width_union_wrapper_out_flat[9];
assign numbers_concat_repl_wrapper_in_flat[1] = width_union_wrapper_out_flat[12];
assign cast_wrapper_in_flat[3] = width_union_wrapper_out_flat[15];
assign const_shift_wrapper_in_flat[1] = width_logic_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[3] = width_logic_wrapper_out_flat[4];
assign array_wrapper_in_flat[7] = width_logic_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[12];
assign cast_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[13];
assign array_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[16];
assign const_shift_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[16];
