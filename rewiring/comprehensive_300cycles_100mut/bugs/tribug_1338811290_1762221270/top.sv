...
assign relational_wrapper_in_flat[5] = const_arith_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[1] = const_arith_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[23] = const_arith_wrapper_out_flat[38];
assign const_partselect_wrapper_in_flat[12] = const_arith_wrapper_out_flat[39];
assign const_nested_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[0];
...
assign array_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[11];
assign width_enum_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[12];
assign const_arith_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[13];
assign numbers_concat_repl_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[15];
assign logical_op_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[3];
assign select_wrapper_in_flat[12] = const_conditional_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[11];
assign shift_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[23];
assign select_wrapper_in_flat[8] = const_logic_wrapper_out_flat[0];
assign relational_wrapper_in_flat[6] = const_logic_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[2] = const_logic_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[13] = const_logic_wrapper_out_flat[13];
assign arithmetic_reduce_wrapper_in_flat[4] = const_nested_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[1] = const_nested_wrapper_out_flat[6];
assign cast_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[5];
...
assign width_logic_wrapper_in_flat[2] = const_shift_wrapper_out_flat[8];
assign cast_wrapper_in_flat[4] = const_shift_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[1] = const_shift_wrapper_out_flat[21];
assign width_logic_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[7] = arithmetic_reduce_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[8];
assign cast_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[20];
assign const_partselect_wrapper_in_flat[2] = logical_op_wrapper_out_flat[0];
assign cast_wrapper_in_flat[8] = relational_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[4] = select_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[16] = select_wrapper_out_flat[4];
assign relational_wrapper_in_flat[1] = select_wrapper_out_flat[6];
assign shift_wrapper_in_flat[2] = select_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[2] = select_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[1] = shift_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[10] = shift_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[8] = shift_wrapper_out_flat[9];
assign array_wrapper_in_flat[9] = shift_wrapper_out_flat[10];
assign partselect_wrapper_in_flat[0] = shift_wrapper_out_flat[12];
assign const_reduce_wrapper_in_flat[2] = array_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[14] = array_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[10] = array_wrapper_out_flat[5];
assign relational_wrapper_in_flat[7] = array_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[3] = array_wrapper_out_flat[8];
assign bitwise_logic_wrapper_in_flat[11] = array_wrapper_out_flat[12];
assign width_logic_wrapper_in_flat[3] = cast_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[6] = cast_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[6] = cast_wrapper_out_flat[9];
assign const_shift_wrapper_in_flat[0] = conditional_wrapper_out_flat[0];
assign array_wrapper_in_flat[16] = conditional_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[9] = partselect_wrapper_out_flat[7];
assign array_wrapper_in_flat[7] = partselect_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[6] = width_enum_wrapper_out_flat[1];
assign relational_wrapper_in_flat[4] = width_enum_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[19] = width_enum_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[5] = width_struct_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[7] = width_struct_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[19] = width_struct_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[0] = width_struct_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[4] = width_union_wrapper_out_flat[1];
assign select_wrapper_in_flat[13] = width_union_wrapper_out_flat[1];
assign shift_wrapper_in_flat[3] = width_union_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[1] = width_union_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[18] = width_union_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[23] = width_union_wrapper_out_flat[10];
assign const_logic_wrapper_in_flat[3] = width_union_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[23] = numbers_concat_repl_wrapper_out_flat[11];
assign bitwise_logic_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[12];
