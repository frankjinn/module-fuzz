...
assign const_logic_wrapper_in_flat[4] = in_flat[72];
assign const_logic_wrapper_in_flat[5] = in_flat[73];
...
assign const_nested_wrapper_in_flat[10] = in_flat[86];
assign const_nested_wrapper_in_flat[11] = in_flat[87];
assign const_nested_wrapper_in_flat[12] = in_flat[88];
assign const_nested_wrapper_in_flat[13] = in_flat[89];
...
assign const_partselect_wrapper_in_flat[6] = in_flat[107];
...
assign const_shift_wrapper_in_flat[1] = in_flat[120];
assign const_shift_wrapper_in_flat[2] = in_flat[121];
assign const_shift_wrapper_in_flat[3] = in_flat[122];
assign const_shift_wrapper_in_flat[4] = in_flat[123];
assign const_shift_wrapper_in_flat[5] = in_flat[124];
assign const_shift_wrapper_in_flat[6] = in_flat[125];
...
assign arithmetic_reduce_wrapper_in_flat[10] = in_flat[138];
assign arithmetic_reduce_wrapper_in_flat[11] = in_flat[139];
...
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[156];
...
assign select_wrapper_in_flat[19] = in_flat[173];
assign shift_wrapper_in_flat[0] = in_flat[174];
...
assign shift_wrapper_in_flat[9] = in_flat[179];
...
assign cast_wrapper_in_flat[7] = in_flat[200];
...
assign conditional_wrapper_in_flat[8] = in_flat[208];
assign partselect_wrapper_in_flat[0] = in_flat[209];
...
assign width_struct_wrapper_in_flat[1] = in_flat[229];
...
assign width_union_wrapper_in_flat[6] = in_flat[242];
...
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[256];
...
assign relational_wrapper_in_flat[1] = const_arith_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[14] = const_arith_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[10] = const_arith_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[7] = const_arith_wrapper_out_flat[27];
assign cast_wrapper_in_flat[0] = const_arith_wrapper_out_flat[38];
assign relational_wrapper_in_flat[2] = const_compare_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[6];
assign array_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[14] = const_concat_repl_wrapper_out_flat[16];
assign shift_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[16];
assign select_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[17];
assign width_logic_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[20];
assign const_compare_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[0];
assign relational_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[19];
assign cast_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[21];
assign bitwise_logic_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[21];
assign shift_wrapper_in_flat[3] = const_logic_wrapper_out_flat[9];
assign select_wrapper_in_flat[12] = const_logic_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[0] = const_logic_wrapper_out_flat[16];
assign const_conditional_wrapper_in_flat[19] = const_partselect_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[1];
assign select_wrapper_in_flat[16] = const_reduce_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[0] = const_shift_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[1] = const_shift_wrapper_out_flat[7];
assign shift_wrapper_in_flat[10] = const_shift_wrapper_out_flat[8];
assign const_logic_wrapper_in_flat[2] = const_shift_wrapper_out_flat[11];
assign select_wrapper_in_flat[18] = const_shift_wrapper_out_flat[18];
assign const_conditional_wrapper_in_flat[28] = arithmetic_reduce_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[13] = arithmetic_reduce_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[8];
assign cast_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[6];
assign relational_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[15] = bitwise_logic_wrapper_out_flat[16];
assign select_wrapper_in_flat[4] = bitwise_reduce_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[9] = logical_op_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[3] = logical_op_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[10] = select_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[14] = select_wrapper_out_flat[2];
assign cast_wrapper_in_flat[6] = select_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[10] = select_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[2] = shift_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = shift_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[0] = shift_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[14] = shift_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[6] = shift_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[2] = shift_wrapper_out_flat[14];
assign bitwise_reduce_wrapper_in_flat[5] = array_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[0] = array_wrapper_out_flat[6];
assign shift_wrapper_in_flat[5] = array_wrapper_out_flat[9];
assign bitwise_logic_wrapper_in_flat[2] = array_wrapper_out_flat[13];
assign relational_wrapper_in_flat[3] = cast_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[11] = cast_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[21] = conditional_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[7] = conditional_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[6] = partselect_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[3] = partselect_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[2] = partselect_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[4] = partselect_wrapper_out_flat[8];
assign select_wrapper_in_flat[1] = width_enum_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[1] = width_enum_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[4] = width_enum_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[0] = width_struct_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[2] = width_struct_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[3] = width_struct_wrapper_out_flat[6];
assign select_wrapper_in_flat[7] = width_struct_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[0] = width_struct_wrapper_out_flat[8];
assign width_enum_wrapper_in_flat[3] = width_struct_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[7] = width_union_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[17] = width_union_wrapper_out_flat[6];
assign logical_op_wrapper_in_flat[0] = width_logic_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[1] = width_logic_wrapper_out_flat[1];
assign shift_wrapper_in_flat[7] = width_logic_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[8];
