...
assign shift_wrapper_in_flat[8] = in_flat[179];
...
assign width_enum_wrapper_in_flat[2] = const_arith_wrapper_out_flat[5];
assign shift_wrapper_in_flat[3] = const_arith_wrapper_out_flat[6];
assign array_wrapper_in_flat[16] = const_arith_wrapper_out_flat[7];
assign select_wrapper_in_flat[3] = const_arith_wrapper_out_flat[14];
assign const_shift_wrapper_in_flat[7] = const_arith_wrapper_out_flat[16];
assign partselect_wrapper_in_flat[14] = const_arith_wrapper_out_flat[16];
assign const_conditional_wrapper_in_flat[0] = const_arith_wrapper_out_flat[18];
assign const_nested_wrapper_in_flat[12] = const_compare_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[1] = const_compare_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[6];
assign relational_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[13];
assign const_conditional_wrapper_in_flat[30] = const_concat_repl_wrapper_out_flat[15];
assign width_union_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[19];
assign const_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[7];
assign cast_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[15];
assign width_union_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[22];
assign const_conditional_wrapper_in_flat[28] = const_logic_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[0] = const_logic_wrapper_out_flat[17];
assign width_logic_wrapper_in_flat[7] = const_nested_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[6];
assign relational_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[6];
assign array_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[4];
assign shift_wrapper_in_flat[2] = const_shift_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[4] = const_shift_wrapper_out_flat[4];
assign relational_wrapper_in_flat[6] = const_shift_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[0] = const_shift_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[2] = const_shift_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[0] = const_shift_wrapper_out_flat[16];
assign const_concat_repl_wrapper_in_flat[8] = const_shift_wrapper_out_flat[21];
assign numbers_concat_repl_wrapper_in_flat[3] = const_shift_wrapper_out_flat[22];
assign const_compare_wrapper_in_flat[15] = arithmetic_reduce_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[10];
assign select_wrapper_in_flat[13] = bitwise_logic_wrapper_out_flat[13];
assign const_logic_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[15];
assign conditional_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[17];
assign const_shift_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[20];
assign shift_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[0] = relational_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[11] = select_wrapper_out_flat[4];
assign shift_wrapper_in_flat[7] = select_wrapper_out_flat[8];
assign numbers_concat_repl_wrapper_in_flat[0] = select_wrapper_out_flat[8];
assign const_shift_wrapper_in_flat[3] = select_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[2] = shift_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[3] = shift_wrapper_out_flat[2];
assign cast_wrapper_in_flat[4] = shift_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[5] = shift_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[6] = shift_wrapper_out_flat[15];
assign width_struct_wrapper_in_flat[3] = array_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[5] = array_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[4] = array_wrapper_out_flat[15];
assign width_struct_wrapper_in_flat[1] = cast_wrapper_out_flat[0];
assign relational_wrapper_in_flat[4] = cast_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[14] = cast_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[4] = conditional_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[5] = conditional_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[23] = partselect_wrapper_out_flat[0];
assign shift_wrapper_in_flat[9] = partselect_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[6] = partselect_wrapper_out_flat[6];
...
assign const_shift_wrapper_in_flat[2] = width_enum_wrapper_out_flat[3];
assign select_wrapper_in_flat[5] = width_enum_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[9] = width_enum_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[10] = width_struct_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[3] = width_struct_wrapper_out_flat[8];
assign logical_op_wrapper_in_flat[1] = width_struct_wrapper_out_flat[9];
assign relational_wrapper_in_flat[7] = width_union_wrapper_out_flat[0];
assign cast_wrapper_in_flat[0] = width_union_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[12] = width_union_wrapper_out_flat[7];
assign logical_op_wrapper_in_flat[0] = width_logic_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[12];
assign shift_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[13];
assign relational_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[14];
assign bitwise_reduce_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[16];
