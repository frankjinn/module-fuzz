...
assign logical_op_wrapper_in_flat[1] = in_flat[158];
...
assign array_wrapper_in_flat[13] = const_arith_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[7] = const_arith_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[9] = const_arith_wrapper_out_flat[10];
assign width_union_wrapper_in_flat[15] = const_arith_wrapper_out_flat[16];
assign const_compare_wrapper_in_flat[22] = const_arith_wrapper_out_flat[22];
assign select_wrapper_in_flat[0] = const_arith_wrapper_out_flat[22];
assign relational_wrapper_in_flat[1] = const_arith_wrapper_out_flat[27];
assign conditional_wrapper_in_flat[3] = const_arith_wrapper_out_flat[30];
assign width_enum_wrapper_in_flat[2] = const_arith_wrapper_out_flat[33];
assign arithmetic_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[39];
assign width_enum_wrapper_in_flat[3] = const_compare_wrapper_out_flat[4];
assign relational_wrapper_in_flat[3] = const_compare_wrapper_out_flat[5];
assign shift_wrapper_in_flat[1] = const_compare_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[9] = const_compare_wrapper_out_flat[6];
assign cast_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[11];
assign shift_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[11];
assign select_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[8];
assign shift_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[23];
assign partselect_wrapper_in_flat[4] = const_logic_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[0] = const_logic_wrapper_out_flat[7];
assign select_wrapper_in_flat[14] = const_logic_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[1] = const_logic_wrapper_out_flat[12];
assign relational_wrapper_in_flat[5] = const_logic_wrapper_out_flat[17];
assign width_logic_wrapper_in_flat[2] = const_nested_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[2];
assign cast_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[8] = const_shift_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[1] = const_shift_wrapper_out_flat[20];
assign conditional_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[0];
assign select_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[12] = bitwise_logic_wrapper_out_flat[8];
assign cast_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[15];
assign select_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[17];
assign cast_wrapper_in_flat[8] = bitwise_reduce_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[10] = logical_op_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[9] = relational_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[12] = relational_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[22] = relational_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[2] = select_wrapper_out_flat[1];
assign cast_wrapper_in_flat[10] = select_wrapper_out_flat[3];
assign shift_wrapper_in_flat[2] = select_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[6] = select_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[1] = shift_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[3] = shift_wrapper_out_flat[9];
assign const_shift_wrapper_in_flat[7] = shift_wrapper_out_flat[14];
assign numbers_concat_repl_wrapper_in_flat[1] = array_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[8] = array_wrapper_out_flat[10];
assign const_reduce_wrapper_in_flat[3] = array_wrapper_out_flat[11];
assign const_shift_wrapper_in_flat[10] = cast_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[14] = cast_wrapper_out_flat[7];
assign cast_wrapper_in_flat[5] = conditional_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[24] = conditional_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[23] = partselect_wrapper_out_flat[3];
assign select_wrapper_in_flat[5] = partselect_wrapper_out_flat[3];
assign relational_wrapper_in_flat[2] = partselect_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[1] = width_enum_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[13] = width_enum_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[15] = width_struct_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[1] = width_struct_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[5] = width_struct_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[0] = width_union_wrapper_out_flat[4];
assign cast_wrapper_in_flat[1] = width_union_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[29] = width_union_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[4] = width_union_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[14] = width_union_wrapper_out_flat[10];
assign select_wrapper_in_flat[10] = width_union_wrapper_out_flat[14];
assign const_shift_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[6];
