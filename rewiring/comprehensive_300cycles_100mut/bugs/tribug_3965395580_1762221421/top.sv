...
assign partselect_wrapper_in_flat[18] = in_flat[223];
assign width_enum_wrapper_in_flat[1] = in_flat[224];
assign width_enum_wrapper_in_flat[2] = in_flat[225];
...
assign width_union_wrapper_in_flat[5] = in_flat[237];
assign width_union_wrapper_in_flat[6] = in_flat[238];
assign width_union_wrapper_in_flat[7] = in_flat[239];
assign width_union_wrapper_in_flat[8] = in_flat[240];
assign width_union_wrapper_in_flat[9] = in_flat[241];
assign width_union_wrapper_in_flat[10] = in_flat[242];
...
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[251];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[252];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[253];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[254];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[255];

// Internal MTM connections (module-to-module)
assign width_struct_wrapper_in_flat[5] = const_arith_wrapper_out_flat[2];
assign select_wrapper_in_flat[6] = const_arith_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[4] = const_arith_wrapper_out_flat[12];
assign const_logic_wrapper_in_flat[1] = const_arith_wrapper_out_flat[12];
assign const_conditional_wrapper_in_flat[11] = const_arith_wrapper_out_flat[20];
assign const_partselect_wrapper_in_flat[7] = const_arith_wrapper_out_flat[33];
assign conditional_wrapper_in_flat[7] = const_compare_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[12];
assign width_logic_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[16];
assign array_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[9];
assign const_shift_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[18];
assign width_enum_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[19];
assign const_logic_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[21];
assign array_wrapper_in_flat[1] = const_logic_wrapper_out_flat[17];
assign width_union_wrapper_in_flat[0] = const_logic_wrapper_out_flat[17];
assign width_struct_wrapper_in_flat[9] = const_logic_wrapper_out_flat[18];
assign conditional_wrapper_in_flat[2] = const_nested_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[3] = const_nested_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[4];
assign array_wrapper_in_flat[15] = const_partselect_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[16] = const_reduce_wrapper_out_flat[2];
assign select_wrapper_in_flat[13] = const_shift_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[9] = const_shift_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[3] = const_shift_wrapper_out_flat[8];
assign array_wrapper_in_flat[13] = const_shift_wrapper_out_flat[11];
assign logical_op_wrapper_in_flat[0] = const_shift_wrapper_out_flat[20];
assign select_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[22] = arithmetic_reduce_wrapper_out_flat[1];
assign array_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[6];
assign bitwise_logic_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[7];
assign array_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[10];
assign conditional_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[26] = bitwise_logic_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[13];
assign bitwise_reduce_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[15];
assign partselect_wrapper_in_flat[10] = bitwise_logic_wrapper_out_flat[20];
assign const_reduce_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[21];
assign relational_wrapper_in_flat[2] = bitwise_reduce_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[8] = bitwise_reduce_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[17] = bitwise_reduce_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = relational_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[5] = relational_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[7] = select_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[4] = select_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[5] = select_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[17] = select_wrapper_out_flat[8];
assign width_logic_wrapper_in_flat[0] = shift_wrapper_out_flat[9];
assign relational_wrapper_in_flat[6] = shift_wrapper_out_flat[10];
assign conditional_wrapper_in_flat[8] = shift_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[11] = shift_wrapper_out_flat[15];
assign const_compare_wrapper_in_flat[9] = array_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[0] = array_wrapper_out_flat[13];
assign array_wrapper_in_flat[14] = cast_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[18] = cast_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[7] = cast_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[6] = partselect_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[0] = partselect_wrapper_out_flat[2];
...
assign partselect_wrapper_in_flat[9] = width_enum_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[25] = width_struct_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[6] = width_struct_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[2] = width_struct_wrapper_out_flat[8];
assign select_wrapper_in_flat[10] = width_union_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[12] = width_union_wrapper_out_flat[3];
assign array_wrapper_in_flat[3] = width_union_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[2] = width_union_wrapper_out_flat[9];
assign bitwise_logic_wrapper_in_flat[1] = width_union_wrapper_out_flat[13];
assign width_struct_wrapper_in_flat[6] = width_union_wrapper_out_flat[14];
assign const_concat_repl_wrapper_in_flat[1] = width_union_wrapper_out_flat[15];
assign relational_wrapper_in_flat[4] = width_logic_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[3] = width_logic_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[3];
assign cast_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[22] = numbers_concat_repl_wrapper_out_flat[14];
assign bitwise_logic_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[14];
