...
assign shift_wrapper_in_flat[10] = in_flat[181];
...
assign const_nested_wrapper_in_flat[6] = const_arith_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[6] = const_arith_wrapper_out_flat[15];
assign arithmetic_reduce_wrapper_in_flat[15] = const_arith_wrapper_out_flat[24];
assign const_conditional_wrapper_in_flat[29] = const_arith_wrapper_out_flat[24];
assign width_union_wrapper_in_flat[14] = const_arith_wrapper_out_flat[24];
assign partselect_wrapper_in_flat[18] = const_arith_wrapper_out_flat[25];
assign const_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[26];
assign const_shift_wrapper_in_flat[8] = const_arith_wrapper_out_flat[32];
assign const_partselect_wrapper_in_flat[5] = const_arith_wrapper_out_flat[38];
assign bitwise_reduce_wrapper_in_flat[0] = const_compare_wrapper_out_flat[4];
assign logical_op_wrapper_in_flat[0] = const_compare_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[9] = const_compare_wrapper_out_flat[4];
assign select_wrapper_in_flat[9] = const_compare_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[9];
assign numbers_concat_repl_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[13];
assign const_reduce_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[16];
assign const_conditional_wrapper_in_flat[26] = const_concat_repl_wrapper_out_flat[18];
assign bitwise_logic_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[12];
assign bitwise_logic_wrapper_in_flat[7] = const_logic_wrapper_out_flat[6];
assign relational_wrapper_in_flat[0] = const_logic_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[9] = const_logic_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[13] = const_logic_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[3] = const_logic_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[6] = const_logic_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[6] = const_logic_wrapper_out_flat[11];
assign bitwise_reduce_wrapper_in_flat[3] = const_nested_wrapper_out_flat[0];
assign cast_wrapper_in_flat[7] = const_nested_wrapper_out_flat[2];
assign array_wrapper_in_flat[4] = const_nested_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[15] = const_partselect_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[7] = const_shift_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[3] = const_shift_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[14] = const_shift_wrapper_out_flat[18];
assign const_reduce_wrapper_in_flat[1] = const_shift_wrapper_out_flat[20];
assign bitwise_reduce_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[4];
assign shift_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[6];
assign relational_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[13];
assign width_struct_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[20];
assign select_wrapper_in_flat[5] = bitwise_reduce_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[4] = logical_op_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[2] = logical_op_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[22] = relational_wrapper_out_flat[1];
...
assign const_nested_wrapper_in_flat[20] = relational_wrapper_out_flat[5];
assign cast_wrapper_in_flat[5] = shift_wrapper_out_flat[3];
assign select_wrapper_in_flat[4] = array_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[6] = array_wrapper_out_flat[15];
assign array_wrapper_in_flat[12] = cast_wrapper_out_flat[6];
assign select_wrapper_in_flat[16] = cast_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[8] = cast_wrapper_out_flat[11];
...
assign relational_wrapper_in_flat[3] = partselect_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[3] = partselect_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[13] = width_enum_wrapper_out_flat[0];
assign relational_wrapper_in_flat[4] = width_enum_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[8] = width_enum_wrapper_out_flat[4];
assign cast_wrapper_in_flat[6] = width_struct_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[24] = width_struct_wrapper_out_flat[10];
assign numbers_concat_repl_wrapper_in_flat[5] = width_struct_wrapper_out_flat[11];
assign const_concat_repl_wrapper_in_flat[2] = width_union_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[1] = width_union_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[6] = width_union_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[1] = width_logic_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[15] = width_logic_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[2] = width_logic_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[6] = width_logic_wrapper_out_flat[4];
assign shift_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[6];
