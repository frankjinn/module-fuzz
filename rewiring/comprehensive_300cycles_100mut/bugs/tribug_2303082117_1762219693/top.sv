...
assign const_nested_wrapper_in_flat[13] = in_flat[90];
...
assign const_reduce_wrapper_in_flat[1] = in_flat[118];
assign const_reduce_wrapper_in_flat[2] = in_flat[119];
...
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[154];
...
assign select_wrapper_in_flat[13] = in_flat[175];
assign select_wrapper_in_flat[14] = in_flat[176];
...
assign partselect_wrapper_in_flat[2] = in_flat[213];
...
assign width_struct_wrapper_in_flat[4] = in_flat[230];
...
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[258];
...
assign width_union_wrapper_in_flat[3] = const_arith_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[8] = const_arith_wrapper_out_flat[8];
assign select_wrapper_in_flat[6] = const_arith_wrapper_out_flat[15];
assign shift_wrapper_in_flat[4] = const_arith_wrapper_out_flat[15];
assign partselect_wrapper_in_flat[12] = const_arith_wrapper_out_flat[20];
assign bitwise_logic_wrapper_in_flat[5] = const_arith_wrapper_out_flat[26];
assign cast_wrapper_in_flat[3] = const_arith_wrapper_out_flat[34];
assign const_partselect_wrapper_in_flat[19] = const_arith_wrapper_out_flat[39];
assign width_enum_wrapper_in_flat[3] = const_compare_wrapper_out_flat[2];
assign cast_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[17];
assign const_logic_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[20];
assign conditional_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[14];
assign width_union_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[15];
assign partselect_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[18];
assign const_partselect_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[18];
assign conditional_wrapper_in_flat[8] = const_logic_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[11] = const_logic_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[8] = const_logic_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[10] = const_logic_wrapper_out_flat[9];
assign width_enum_wrapper_in_flat[1] = const_logic_wrapper_out_flat[11];
assign cast_wrapper_in_flat[10] = const_logic_wrapper_out_flat[14];
assign numbers_concat_repl_wrapper_in_flat[3] = const_logic_wrapper_out_flat[17];
assign partselect_wrapper_in_flat[4] = const_nested_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[4] = const_nested_wrapper_out_flat[6];
assign array_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[2];
assign select_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[2];
assign relational_wrapper_in_flat[3] = const_shift_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[4] = const_shift_wrapper_out_flat[1];
assign shift_wrapper_in_flat[5] = const_shift_wrapper_out_flat[10];
assign const_arith_wrapper_in_flat[12] = const_shift_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[13] = const_shift_wrapper_out_flat[11];
assign bitwise_logic_wrapper_in_flat[13] = const_shift_wrapper_out_flat[15];
assign const_concat_repl_wrapper_in_flat[9] = const_shift_wrapper_out_flat[15];
assign const_compare_wrapper_in_flat[23] = const_shift_wrapper_out_flat[16];
assign width_union_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[8];
assign select_wrapper_in_flat[15] = bitwise_logic_wrapper_out_flat[12];
assign shift_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[12];
assign array_wrapper_in_flat[15] = bitwise_logic_wrapper_out_flat[19];
assign arithmetic_reduce_wrapper_in_flat[10] = bitwise_reduce_wrapper_out_flat[0];
assign array_wrapper_in_flat[11] = bitwise_reduce_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[9] = relational_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[0] = relational_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[15] = relational_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[3] = select_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[7] = select_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[6] = select_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[10] = shift_wrapper_out_flat[1];
assign cast_wrapper_in_flat[6] = shift_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[11] = shift_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[1] = shift_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[13] = array_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[6] = cast_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[5] = cast_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[6] = cast_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[2] = cast_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[10] = cast_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[10] = cast_wrapper_out_flat[11];
assign array_wrapper_in_flat[4] = conditional_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[3] = conditional_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[5] = partselect_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[0] = width_enum_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[1] = width_struct_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[10] = width_struct_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[0] = width_union_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[4] = width_union_wrapper_out_flat[7];
assign array_wrapper_in_flat[12] = width_union_wrapper_out_flat[9];
assign conditional_wrapper_in_flat[6] = width_union_wrapper_out_flat[14];
assign array_wrapper_in_flat[13] = width_logic_wrapper_out_flat[4];
assign array_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[11];
assign arithmetic_reduce_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[13];
