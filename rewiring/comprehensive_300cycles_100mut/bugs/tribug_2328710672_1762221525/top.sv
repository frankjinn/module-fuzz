...
assign const_reduce_wrapper_in_flat[3] = in_flat[123];
...
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[162];
assign bitwise_reduce_wrapper_in_flat[7] = in_flat[163];
assign relational_wrapper_in_flat[1] = in_flat[164];
...
assign shift_wrapper_in_flat[2] = in_flat[186];
assign shift_wrapper_in_flat[3] = in_flat[187];
assign shift_wrapper_in_flat[4] = in_flat[188];
assign shift_wrapper_in_flat[5] = in_flat[189];
...
assign cast_wrapper_in_flat[3] = in_flat[210];
...
assign conditional_wrapper_in_flat[5] = in_flat[220];
assign conditional_wrapper_in_flat[6] = in_flat[221];
assign conditional_wrapper_in_flat[8] = in_flat[222];
assign partselect_wrapper_in_flat[1] = in_flat[223];
...
assign partselect_wrapper_in_flat[5] = in_flat[227];
...
assign width_enum_wrapper_in_flat[1] = in_flat[236];
...
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[264];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[265];

// Internal MTM connections (module-to-module)
assign array_wrapper_in_flat[13] = const_arith_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[9] = const_arith_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[13] = const_arith_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[9] = const_arith_wrapper_out_flat[9];
assign bitwise_reduce_wrapper_in_flat[6] = const_arith_wrapper_out_flat[26];
assign relational_wrapper_in_flat[7] = const_compare_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[3] = const_compare_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[2] = const_compare_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[2] = const_compare_wrapper_out_flat[3];
...
assign partselect_wrapper_in_flat[17] = const_concat_repl_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[14];
assign width_struct_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[13];
assign const_concat_repl_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[19];
assign select_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[19];
assign conditional_wrapper_in_flat[0] = const_logic_wrapper_out_flat[9];
assign logical_op_wrapper_in_flat[0] = const_logic_wrapper_out_flat[17];
assign partselect_wrapper_in_flat[6] = const_nested_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[7] = const_nested_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[7] = const_nested_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[24] = const_partselect_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[4];
...
assign partselect_wrapper_in_flat[15] = const_shift_wrapper_out_flat[5];
assign cast_wrapper_in_flat[2] = const_shift_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[11] = const_shift_wrapper_out_flat[18];
assign const_nested_wrapper_in_flat[1] = const_shift_wrapper_out_flat[22];
assign cast_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[3];
assign select_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[32] = bitwise_logic_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[13];
assign width_enum_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[19];
assign const_compare_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[22];
assign select_wrapper_in_flat[17] = relational_wrapper_out_flat[0];
assign cast_wrapper_in_flat[7] = relational_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[7] = relational_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[2] = relational_wrapper_out_flat[5];
assign cast_wrapper_in_flat[4] = select_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[4] = select_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[6] = select_wrapper_out_flat[8];
assign bitwise_logic_wrapper_in_flat[11] = shift_wrapper_out_flat[0];
assign relational_wrapper_in_flat[0] = shift_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[1] = shift_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[1] = shift_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[0] = array_wrapper_out_flat[1];
assign shift_wrapper_in_flat[7] = array_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[0] = array_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[0] = array_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[1] = array_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[3] = array_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[6] = array_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[2] = array_wrapper_out_flat[14];
assign const_concat_repl_wrapper_in_flat[1] = cast_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[5] = conditional_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[1] = partselect_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[1] = partselect_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[16] = width_enum_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[6] = width_struct_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[11] = width_struct_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[7] = width_union_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[3] = width_union_wrapper_out_flat[13];
assign const_arith_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[2];
assign select_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[4];
assign array_wrapper_in_flat[16] = numbers_concat_repl_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[7];
assign shift_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[8];
assign relational_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[14];
assign const_concat_repl_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[16];
assign const_compare_wrapper_in_flat[17] = numbers_concat_repl_wrapper_out_flat[17];
