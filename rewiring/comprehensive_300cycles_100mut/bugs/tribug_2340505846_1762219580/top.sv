...
assign const_concat_repl_wrapper_in_flat[2] = in_flat[36];
...
assign const_concat_repl_wrapper_in_flat[8] = in_flat[40];
assign const_concat_repl_wrapper_in_flat[9] = in_flat[41];
assign const_conditional_wrapper_in_flat[0] = in_flat[42];
assign const_conditional_wrapper_in_flat[1] = in_flat[43];
assign const_conditional_wrapper_in_flat[2] = in_flat[44];
assign const_conditional_wrapper_in_flat[3] = in_flat[45];
assign const_conditional_wrapper_in_flat[4] = in_flat[46];
...
assign const_conditional_wrapper_in_flat[12] = in_flat[54];
assign const_conditional_wrapper_in_flat[13] = in_flat[55];
...
assign const_nested_wrapper_in_flat[14] = in_flat[91];
...
assign const_nested_wrapper_in_flat[21] = in_flat[97];
assign const_nested_wrapper_in_flat[22] = in_flat[98];
assign const_nested_wrapper_in_flat[24] = in_flat[99];
assign const_nested_wrapper_in_flat[25] = in_flat[100];
assign const_nested_wrapper_in_flat[26] = in_flat[101];
assign const_partselect_wrapper_in_flat[0] = in_flat[102];
assign const_partselect_wrapper_in_flat[1] = in_flat[103];
assign const_partselect_wrapper_in_flat[2] = in_flat[104];
assign const_partselect_wrapper_in_flat[3] = in_flat[105];
assign const_partselect_wrapper_in_flat[4] = in_flat[106];
assign const_partselect_wrapper_in_flat[5] = in_flat[107];
assign const_partselect_wrapper_in_flat[6] = in_flat[108];
assign const_partselect_wrapper_in_flat[7] = in_flat[109];
assign const_partselect_wrapper_in_flat[8] = in_flat[110];
assign const_partselect_wrapper_in_flat[9] = in_flat[111];
...
assign const_shift_wrapper_in_flat[7] = in_flat[126];
assign const_shift_wrapper_in_flat[8] = in_flat[127];
...
assign arithmetic_reduce_wrapper_in_flat[3] = in_flat[131];
...
assign bitwise_logic_wrapper_in_flat[6] = in_flat[143];
...
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[152];
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[153];
assign bitwise_reduce_wrapper_in_flat[7] = in_flat[154];
...
assign select_wrapper_in_flat[3] = in_flat[159];
assign select_wrapper_in_flat[4] = in_flat[160];
assign select_wrapper_in_flat[6] = in_flat[161];
...
assign select_wrapper_in_flat[10] = in_flat[165];
assign select_wrapper_in_flat[11] = in_flat[166];
assign select_wrapper_in_flat[13] = in_flat[167];
assign select_wrapper_in_flat[15] = in_flat[168];
assign select_wrapper_in_flat[16] = in_flat[169];
assign select_wrapper_in_flat[18] = in_flat[170];
assign select_wrapper_in_flat[19] = in_flat[171];
assign shift_wrapper_in_flat[0] = in_flat[172];
assign shift_wrapper_in_flat[1] = in_flat[173];
...
assign conditional_wrapper_in_flat[2] = in_flat[211];
...
assign conditional_wrapper_in_flat[8] = in_flat[216];
assign partselect_wrapper_in_flat[0] = in_flat[217];
...
assign width_struct_wrapper_in_flat[10] = in_flat[240];
...
assign width_union_wrapper_in_flat[7] = in_flat[248];
assign width_union_wrapper_in_flat[8] = in_flat[249];
...
assign width_logic_wrapper_in_flat[5] = in_flat[258];
...
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[262];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[263];

// Internal MTM connections (module-to-module)
assign arithmetic_reduce_wrapper_in_flat[13] = const_arith_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[1] = const_arith_wrapper_out_flat[14];
assign const_logic_wrapper_in_flat[2] = const_arith_wrapper_out_flat[17];
assign partselect_wrapper_in_flat[17] = const_arith_wrapper_out_flat[18];
assign const_nested_wrapper_in_flat[20] = const_arith_wrapper_out_flat[27];
...
assign bitwise_logic_wrapper_in_flat[1] = const_compare_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[1] = const_compare_wrapper_out_flat[7];
assign select_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[2];
assign relational_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[13];
assign bitwise_reduce_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[21];
assign width_enum_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[11];
assign const_arith_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[13];
assign const_shift_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[18];
assign partselect_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[20];
assign select_wrapper_in_flat[17] = const_logic_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[0] = const_logic_wrapper_out_flat[6];
assign relational_wrapper_in_flat[3] = const_logic_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[7] = const_logic_wrapper_out_flat[13];
assign array_wrapper_in_flat[0] = const_logic_wrapper_out_flat[14];
assign bitwise_reduce_wrapper_in_flat[1] = const_nested_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[1] = const_nested_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[13] = const_partselect_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[14] = const_reduce_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[1] = const_shift_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[0] = const_shift_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[23] = const_shift_wrapper_out_flat[9];
assign numbers_concat_repl_wrapper_in_flat[3] = const_shift_wrapper_out_flat[12];
assign bitwise_logic_wrapper_in_flat[7] = const_shift_wrapper_out_flat[14];
assign arithmetic_reduce_wrapper_in_flat[2] = const_shift_wrapper_out_flat[14];
assign const_concat_repl_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[3];
assign array_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[13];
assign width_enum_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[14];
assign arithmetic_reduce_wrapper_in_flat[15] = bitwise_logic_wrapper_out_flat[16];
assign width_logic_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[17];
assign partselect_wrapper_in_flat[13] = bitwise_reduce_wrapper_out_flat[1];
assign select_wrapper_in_flat[12] = logical_op_wrapper_out_flat[2];
assign array_wrapper_in_flat[15] = select_wrapper_out_flat[2];
assign cast_wrapper_in_flat[5] = shift_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[7] = shift_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[0] = shift_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[21] = shift_wrapper_out_flat[9];
assign select_wrapper_in_flat[14] = shift_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[1] = shift_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[13] = shift_wrapper_out_flat[14];
assign relational_wrapper_in_flat[2] = array_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[5] = array_wrapper_out_flat[12];
assign const_reduce_wrapper_in_flat[3] = cast_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[11] = cast_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[17] = cast_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[3] = cast_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[10] = cast_wrapper_out_flat[8];
assign select_wrapper_in_flat[2] = partselect_wrapper_out_flat[0];
assign relational_wrapper_in_flat[1] = partselect_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[6] = width_struct_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[22] = width_struct_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[3] = width_struct_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[1] = width_struct_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[28] = width_struct_wrapper_out_flat[8];
assign const_shift_wrapper_in_flat[5] = width_union_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[15] = width_union_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[10] = width_union_wrapper_out_flat[14];
assign partselect_wrapper_in_flat[2] = width_logic_wrapper_out_flat[0];
assign relational_wrapper_in_flat[0] = width_logic_wrapper_out_flat[3];
assign select_wrapper_in_flat[1] = width_logic_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[0];
