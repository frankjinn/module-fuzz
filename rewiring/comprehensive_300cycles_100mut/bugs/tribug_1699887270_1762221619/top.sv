...
assign const_shift_wrapper_in_flat[2] = in_flat[114];
...
assign arithmetic_reduce_wrapper_in_flat[1] = in_flat[122];
...
assign bitwise_logic_wrapper_in_flat[6] = in_flat[137];
assign bitwise_logic_wrapper_in_flat[7] = in_flat[138];
assign bitwise_logic_wrapper_in_flat[8] = in_flat[139];
assign bitwise_logic_wrapper_in_flat[12] = in_flat[140];
assign bitwise_logic_wrapper_in_flat[13] = in_flat[141];
assign bitwise_logic_wrapper_in_flat[14] = in_flat[142];
assign bitwise_reduce_wrapper_in_flat[1] = in_flat[143];
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[144];
assign bitwise_reduce_wrapper_in_flat[3] = in_flat[145];
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[146];
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[147];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[148];
assign bitwise_reduce_wrapper_in_flat[7] = in_flat[149];
assign logical_op_wrapper_in_flat[0] = in_flat[150];
assign relational_wrapper_in_flat[3] = in_flat[151];
assign relational_wrapper_in_flat[4] = in_flat[152];
assign relational_wrapper_in_flat[5] = in_flat[153];
assign relational_wrapper_in_flat[6] = in_flat[154];
assign relational_wrapper_in_flat[7] = in_flat[155];
assign select_wrapper_in_flat[0] = in_flat[156];
assign select_wrapper_in_flat[1] = in_flat[157];
assign select_wrapper_in_flat[2] = in_flat[158];
...
assign select_wrapper_in_flat[11] = in_flat[164];
...
assign arithmetic_reduce_wrapper_in_flat[11] = const_arith_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[10] = const_arith_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[2] = const_arith_wrapper_out_flat[16];
assign conditional_wrapper_in_flat[0] = const_arith_wrapper_out_flat[19];
assign const_shift_wrapper_in_flat[10] = const_arith_wrapper_out_flat[19];
assign const_concat_repl_wrapper_in_flat[0] = const_arith_wrapper_out_flat[32];
assign const_conditional_wrapper_in_flat[25] = const_arith_wrapper_out_flat[32];
assign bitwise_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[32];
assign const_logic_wrapper_in_flat[8] = const_arith_wrapper_out_flat[36];
assign logical_op_wrapper_in_flat[1] = const_arith_wrapper_out_flat[39];
assign bitwise_logic_wrapper_in_flat[1] = const_compare_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[10];
assign relational_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[13];
assign numbers_concat_repl_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[15];
assign bitwise_logic_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[18];
assign bitwise_logic_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[13];
assign shift_wrapper_in_flat[6] = const_logic_wrapper_out_flat[0];
assign array_wrapper_in_flat[12] = const_logic_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[1] = const_logic_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[1] = const_logic_wrapper_out_flat[14];
assign width_enum_wrapper_in_flat[0] = const_logic_wrapper_out_flat[17];
assign const_partselect_wrapper_in_flat[17] = const_nested_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[20] = const_nested_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[14] = const_nested_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[18] = const_reduce_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[23] = const_shift_wrapper_out_flat[5];
assign shift_wrapper_in_flat[1] = const_shift_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[6] = const_shift_wrapper_out_flat[20];
assign conditional_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[9] = bitwise_reduce_wrapper_out_flat[1];
assign shift_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[2] = bitwise_reduce_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[20] = logical_op_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[0] = logical_op_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[4] = logical_op_wrapper_out_flat[2];
assign select_wrapper_in_flat[10] = relational_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[1] = select_wrapper_out_flat[5];
assign cast_wrapper_in_flat[5] = shift_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[8] = shift_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[4] = shift_wrapper_out_flat[8];
assign bitwise_logic_wrapper_in_flat[10] = shift_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[17] = shift_wrapper_out_flat[15];
...
assign width_enum_wrapper_in_flat[3] = array_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[11] = array_wrapper_out_flat[4];
assign cast_wrapper_in_flat[7] = array_wrapper_out_flat[13];
assign const_shift_wrapper_in_flat[1] = array_wrapper_out_flat[14];
assign bitwise_logic_wrapper_in_flat[11] = cast_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[3] = cast_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[5] = cast_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[9] = cast_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[11] = conditional_wrapper_out_flat[1];
assign cast_wrapper_in_flat[10] = conditional_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[0] = conditional_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[5] = partselect_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[7] = width_struct_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[18] = width_struct_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[8] = width_struct_wrapper_out_flat[5];
assign array_wrapper_in_flat[2] = width_struct_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[0] = width_struct_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[14] = width_struct_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[13] = width_union_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[6] = width_union_wrapper_out_flat[1];
assign relational_wrapper_in_flat[0] = width_union_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[5] = width_union_wrapper_out_flat[4];
assign select_wrapper_in_flat[4] = width_union_wrapper_out_flat[11];
assign numbers_concat_repl_wrapper_in_flat[1] = width_union_wrapper_out_flat[12];
assign cast_wrapper_in_flat[0] = width_union_wrapper_out_flat[13];
assign select_wrapper_in_flat[9] = width_logic_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[16] = numbers_concat_repl_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[4];
