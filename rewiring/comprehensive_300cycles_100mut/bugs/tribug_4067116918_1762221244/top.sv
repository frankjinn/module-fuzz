...
assign const_compare_wrapper_in_flat[23] = in_flat[29];
...
assign const_logic_wrapper_in_flat[2] = in_flat[71];
assign const_logic_wrapper_in_flat[5] = in_flat[72];
...
assign const_nested_wrapper_in_flat[2] = in_flat[77];
...
assign const_nested_wrapper_in_flat[18] = in_flat[88];
assign const_nested_wrapper_in_flat[20] = in_flat[89];
assign const_nested_wrapper_in_flat[21] = in_flat[90];
assign const_nested_wrapper_in_flat[22] = in_flat[91];
...
assign const_partselect_wrapper_in_flat[3] = in_flat[98];
assign const_partselect_wrapper_in_flat[4] = in_flat[99];
assign const_partselect_wrapper_in_flat[5] = in_flat[100];
...
assign const_partselect_wrapper_in_flat[16] = in_flat[109];
assign const_partselect_wrapper_in_flat[17] = in_flat[110];
assign const_partselect_wrapper_in_flat[18] = in_flat[111];
...
assign arithmetic_reduce_wrapper_in_flat[1] = in_flat[121];
assign arithmetic_reduce_wrapper_in_flat[2] = in_flat[122];
assign arithmetic_reduce_wrapper_in_flat[3] = in_flat[123];
assign arithmetic_reduce_wrapper_in_flat[4] = in_flat[124];
assign arithmetic_reduce_wrapper_in_flat[5] = in_flat[125];
assign arithmetic_reduce_wrapper_in_flat[6] = in_flat[126];
assign arithmetic_reduce_wrapper_in_flat[7] = in_flat[127];
assign arithmetic_reduce_wrapper_in_flat[8] = in_flat[128];
assign arithmetic_reduce_wrapper_in_flat[9] = in_flat[129];
assign arithmetic_reduce_wrapper_in_flat[10] = in_flat[130];
assign arithmetic_reduce_wrapper_in_flat[11] = in_flat[131];
assign arithmetic_reduce_wrapper_in_flat[12] = in_flat[132];
...
assign bitwise_logic_wrapper_in_flat[4] = in_flat[137];
assign bitwise_logic_wrapper_in_flat[5] = in_flat[138];
assign bitwise_logic_wrapper_in_flat[6] = in_flat[139];
...
assign bitwise_reduce_wrapper_in_flat[3] = in_flat[147];
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[148];
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[149];
assign bitwise_reduce_wrapper_in_flat[7] = in_flat[150];
assign logical_op_wrapper_in_flat[1] = in_flat[151];
...
assign relational_wrapper_in_flat[5] = in_flat[156];
assign relational_wrapper_in_flat[6] = in_flat[157];
assign relational_wrapper_in_flat[7] = in_flat[158];
assign select_wrapper_in_flat[0] = in_flat[159];
assign select_wrapper_in_flat[1] = in_flat[160];
...
assign array_wrapper_in_flat[13] = in_flat[197];
assign array_wrapper_in_flat[14] = in_flat[198];
assign array_wrapper_in_flat[15] = in_flat[199];
assign array_wrapper_in_flat[16] = in_flat[200];
assign array_wrapper_in_flat[17] = in_flat[201];
assign cast_wrapper_in_flat[0] = in_flat[202];
assign cast_wrapper_in_flat[2] = in_flat[203];
assign cast_wrapper_in_flat[3] = in_flat[204];
assign cast_wrapper_in_flat[5] = in_flat[205];
assign cast_wrapper_in_flat[6] = in_flat[206];
assign cast_wrapper_in_flat[7] = in_flat[207];
assign cast_wrapper_in_flat[9] = in_flat[208];
assign cast_wrapper_in_flat[10] = in_flat[209];
assign cast_wrapper_in_flat[11] = in_flat[210];
assign conditional_wrapper_in_flat[0] = in_flat[211];
assign conditional_wrapper_in_flat[1] = in_flat[212];
assign conditional_wrapper_in_flat[3] = in_flat[213];
assign conditional_wrapper_in_flat[7] = in_flat[214];
assign conditional_wrapper_in_flat[8] = in_flat[215];
assign partselect_wrapper_in_flat[0] = in_flat[216];
assign partselect_wrapper_in_flat[1] = in_flat[217];
assign partselect_wrapper_in_flat[2] = in_flat[218];
assign partselect_wrapper_in_flat[3] = in_flat[219];
assign partselect_wrapper_in_flat[4] = in_flat[220];
assign partselect_wrapper_in_flat[5] = in_flat[221];
assign partselect_wrapper_in_flat[6] = in_flat[222];
assign partselect_wrapper_in_flat[7] = in_flat[223];
assign partselect_wrapper_in_flat[8] = in_flat[224];
assign partselect_wrapper_in_flat[9] = in_flat[225];
assign partselect_wrapper_in_flat[10] = in_flat[226];
assign partselect_wrapper_in_flat[11] = in_flat[227];
assign partselect_wrapper_in_flat[12] = in_flat[228];
assign partselect_wrapper_in_flat[13] = in_flat[229];
assign partselect_wrapper_in_flat[15] = in_flat[230];
assign partselect_wrapper_in_flat[17] = in_flat[231];
assign partselect_wrapper_in_flat[18] = in_flat[232];
assign width_enum_wrapper_in_flat[3] = in_flat[233];
assign width_struct_wrapper_in_flat[0] = in_flat[234];
...
assign width_logic_wrapper_in_flat[0] = in_flat[255];
assign width_logic_wrapper_in_flat[1] = in_flat[256];
assign width_logic_wrapper_in_flat[2] = in_flat[257];
assign width_logic_wrapper_in_flat[3] = in_flat[258];
assign width_logic_wrapper_in_flat[5] = in_flat[259];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[260];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[261];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[262];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[263];

// Internal MTM connections (module-to-module)
assign const_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[7];
assign cast_wrapper_in_flat[4] = const_arith_wrapper_out_flat[16];
assign const_reduce_wrapper_in_flat[3] = const_arith_wrapper_out_flat[25];
assign const_concat_repl_wrapper_in_flat[2] = const_compare_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[17] = const_compare_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[13];
assign const_arith_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[11];
assign array_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[12];
assign width_struct_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[23];
assign const_nested_wrapper_in_flat[12] = const_logic_wrapper_out_flat[6];
assign select_wrapper_in_flat[8] = const_logic_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[8] = const_logic_wrapper_out_flat[15];
assign arithmetic_reduce_wrapper_in_flat[15] = const_nested_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[0] = const_nested_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[1] = const_nested_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[6] = const_nested_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[15] = const_partselect_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[11] = const_partselect_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[15] = const_reduce_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[0] = const_shift_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[19] = const_shift_wrapper_out_flat[12];
assign arithmetic_reduce_wrapper_in_flat[13] = const_shift_wrapper_out_flat[17];
assign conditional_wrapper_in_flat[2] = const_shift_wrapper_out_flat[19];
assign select_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[20];
assign const_nested_wrapper_in_flat[23] = bitwise_reduce_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[10] = bitwise_reduce_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[1];
assign relational_wrapper_in_flat[4] = select_wrapper_out_flat[1];
assign array_wrapper_in_flat[10] = shift_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[25] = shift_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[5] = shift_wrapper_out_flat[13];
assign width_logic_wrapper_in_flat[6] = shift_wrapper_out_flat[15];
assign bitwise_logic_wrapper_in_flat[7] = array_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[0] = array_wrapper_out_flat[8];
assign numbers_concat_repl_wrapper_in_flat[1] = array_wrapper_out_flat[13];
assign const_arith_wrapper_in_flat[1] = array_wrapper_out_flat[15];
assign const_reduce_wrapper_in_flat[2] = cast_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[12] = cast_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[12] = cast_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[6] = cast_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[1] = cast_wrapper_out_flat[7];
assign select_wrapper_in_flat[10] = conditional_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[2] = conditional_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[14] = partselect_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[0] = partselect_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[6] = partselect_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[20] = partselect_wrapper_out_flat[8];
assign select_wrapper_in_flat[16] = width_enum_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[9] = width_struct_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[10] = width_struct_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[18] = width_struct_wrapper_out_flat[11];
assign const_concat_repl_wrapper_in_flat[5] = width_union_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[22] = width_union_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[16] = width_union_wrapper_out_flat[13];
assign bitwise_reduce_wrapper_in_flat[0] = width_union_wrapper_out_flat[15];
assign partselect_wrapper_in_flat[14] = width_logic_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[3] = width_logic_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[19] = width_logic_wrapper_out_flat[4];
assign cast_wrapper_in_flat[8] = width_logic_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[11] = width_logic_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[3];
assign cast_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[9];
assign const_arith_wrapper_in_flat[15] = numbers_concat_repl_wrapper_out_flat[9];
