...
assign const_compare_wrapper_in_flat[0] = in_flat[9];
assign const_compare_wrapper_in_flat[2] = in_flat[10];
assign const_compare_wrapper_in_flat[3] = in_flat[11];
assign const_compare_wrapper_in_flat[5] = in_flat[12];
assign const_compare_wrapper_in_flat[7] = in_flat[13];
...
assign const_compare_wrapper_in_flat[16] = in_flat[22];
assign const_compare_wrapper_in_flat[19] = in_flat[23];
assign const_compare_wrapper_in_flat[20] = in_flat[24];
assign const_compare_wrapper_in_flat[21] = in_flat[25];
assign const_compare_wrapper_in_flat[22] = in_flat[26];
assign const_compare_wrapper_in_flat[23] = in_flat[27];
assign const_concat_repl_wrapper_in_flat[0] = in_flat[28];
assign const_concat_repl_wrapper_in_flat[1] = in_flat[29];
assign const_concat_repl_wrapper_in_flat[3] = in_flat[30];
assign const_concat_repl_wrapper_in_flat[4] = in_flat[31];
...
assign const_partselect_wrapper_in_flat[18] = in_flat[116];
assign const_partselect_wrapper_in_flat[19] = in_flat[117];
...
assign const_shift_wrapper_in_flat[9] = in_flat[125];
...
assign arithmetic_reduce_wrapper_in_flat[5] = in_flat[130];
...
assign bitwise_logic_wrapper_in_flat[11] = in_flat[146];
assign bitwise_logic_wrapper_in_flat[12] = in_flat[147];
assign bitwise_logic_wrapper_in_flat[14] = in_flat[148];
assign bitwise_logic_wrapper_in_flat[15] = in_flat[149];
...
assign relational_wrapper_in_flat[4] = in_flat[157];
assign relational_wrapper_in_flat[5] = in_flat[158];
assign relational_wrapper_in_flat[6] = in_flat[159];
...
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[259];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[260];

// Internal MTM connections (module-to-module)
assign const_nested_wrapper_in_flat[6] = const_arith_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[3] = const_arith_wrapper_out_flat[1];
assign shift_wrapper_in_flat[6] = const_arith_wrapper_out_flat[11];
assign partselect_wrapper_in_flat[8] = const_arith_wrapper_out_flat[19];
assign const_compare_wrapper_in_flat[17] = const_arith_wrapper_out_flat[32];
assign bitwise_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[39];
assign const_reduce_wrapper_in_flat[3] = const_compare_wrapper_out_flat[4];
assign logical_op_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[16] = const_concat_repl_wrapper_out_flat[18];
assign const_arith_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[20];
assign relational_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[21];
assign partselect_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[13];
assign array_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[19];
assign conditional_wrapper_in_flat[0] = const_logic_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[6] = const_logic_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[2] = const_logic_wrapper_out_flat[5];
assign const_arith_wrapper_in_flat[1] = const_logic_wrapper_out_flat[13];
assign arithmetic_reduce_wrapper_in_flat[14] = const_logic_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[18] = const_nested_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[12] = const_nested_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[1] = const_nested_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[2] = const_nested_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[1];
assign array_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[2];
assign select_wrapper_in_flat[12] = const_partselect_wrapper_out_flat[6];
assign shift_wrapper_in_flat[10] = const_shift_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[8] = const_shift_wrapper_out_flat[0];
assign relational_wrapper_in_flat[1] = const_shift_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[2] = const_shift_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[9] = const_shift_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[10] = const_shift_wrapper_out_flat[16];
assign bitwise_logic_wrapper_in_flat[13] = arithmetic_reduce_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[15] = arithmetic_reduce_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[17] = bitwise_logic_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[15];
assign shift_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[20];
assign width_enum_wrapper_in_flat[0] = logical_op_wrapper_out_flat[0];
assign cast_wrapper_in_flat[8] = logical_op_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[0] = logical_op_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[23] = relational_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[9] = relational_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[28] = relational_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[0] = relational_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[1] = select_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[2] = select_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[2] = shift_wrapper_out_flat[0];
assign select_wrapper_in_flat[1] = shift_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[0] = shift_wrapper_out_flat[5];
assign const_arith_wrapper_in_flat[4] = array_wrapper_out_flat[6];
assign bitwise_logic_wrapper_in_flat[10] = array_wrapper_out_flat[13];
assign shift_wrapper_in_flat[5] = array_wrapper_out_flat[13];
assign width_enum_wrapper_in_flat[1] = cast_wrapper_out_flat[1];
assign select_wrapper_in_flat[6] = cast_wrapper_out_flat[4];
assign shift_wrapper_in_flat[8] = cast_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[14] = cast_wrapper_out_flat[8];
assign array_wrapper_in_flat[14] = cast_wrapper_out_flat[11];
assign width_struct_wrapper_in_flat[8] = conditional_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[2] = conditional_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[6] = partselect_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[1] = width_enum_wrapper_out_flat[0];
assign select_wrapper_in_flat[4] = width_enum_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[5] = width_enum_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[0] = width_struct_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = width_struct_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[9] = width_union_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[8] = width_union_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[5] = width_union_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[1] = width_union_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[4] = width_union_wrapper_out_flat[7];
assign select_wrapper_in_flat[13] = width_logic_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[7] = width_logic_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[14];
