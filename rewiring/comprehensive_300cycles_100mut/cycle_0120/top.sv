...
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[260];

// Internal MTM connections (module-to-module)
assign width_logic_wrapper_in_flat[4] = const_arith_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[1] = const_arith_wrapper_out_flat[10];
assign width_enum_wrapper_in_flat[0] = const_arith_wrapper_out_flat[15];
assign select_wrapper_in_flat[8] = const_arith_wrapper_out_flat[17];
assign relational_wrapper_in_flat[0] = const_arith_wrapper_out_flat[29];
assign logical_op_wrapper_in_flat[1] = const_compare_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[23] = const_compare_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[8];
assign const_shift_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[6];
assign cast_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[13];
assign const_shift_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[20];
assign arithmetic_reduce_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[23];
assign numbers_concat_repl_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[23];
assign const_compare_wrapper_in_flat[21] = const_logic_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[7] = const_shift_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[8] = const_shift_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[9] = const_shift_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[9] = const_shift_wrapper_out_flat[13];
assign numbers_concat_repl_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[1];
assign cast_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[23];
assign relational_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[8] = logical_op_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[25] = relational_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[7] = relational_wrapper_out_flat[1];
assign shift_wrapper_in_flat[5] = select_wrapper_out_flat[3];
assign relational_wrapper_in_flat[6] = select_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[1] = select_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[9] = select_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[6] = shift_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[23] = shift_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[0] = shift_wrapper_out_flat[10];
assign select_wrapper_in_flat[18] = array_wrapper_out_flat[1];
assign shift_wrapper_in_flat[1] = array_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[3] = array_wrapper_out_flat[8];
assign const_logic_wrapper_in_flat[0] = array_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[24] = array_wrapper_out_flat[11];
assign bitwise_reduce_wrapper_in_flat[6] = cast_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[9] = cast_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[2] = cast_wrapper_out_flat[8];
assign array_wrapper_in_flat[4] = cast_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[4] = cast_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[6] = conditional_wrapper_out_flat[0];
assign array_wrapper_in_flat[13] = conditional_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[2] = conditional_wrapper_out_flat[2];
assign select_wrapper_in_flat[6] = conditional_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[1] = partselect_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[22] = partselect_wrapper_out_flat[2];
assign shift_wrapper_in_flat[7] = partselect_wrapper_out_flat[4];
assign shift_wrapper_in_flat[0] = width_enum_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[0] = width_enum_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[0] = width_enum_wrapper_out_flat[2];
assign array_wrapper_in_flat[12] = width_enum_wrapper_out_flat[2];
...
assign const_reduce_wrapper_in_flat[2] = width_struct_wrapper_out_flat[8];
assign const_shift_wrapper_in_flat[6] = width_struct_wrapper_out_flat[10];
assign const_concat_repl_wrapper_in_flat[6] = width_union_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[1] = width_union_wrapper_out_flat[13];
assign select_wrapper_in_flat[16] = width_logic_wrapper_out_flat[1];
assign shift_wrapper_in_flat[3] = width_logic_wrapper_out_flat[1];
assign array_wrapper_in_flat[17] = width_logic_wrapper_out_flat[1];
assign relational_wrapper_in_flat[2] = width_logic_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[3] = width_logic_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[13];
assign relational_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[13];
assign const_arith_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[14];
