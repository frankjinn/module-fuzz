...
assign const_reduce_wrapper_in_flat[3] = in_flat[122];
...
assign const_shift_wrapper_in_flat[3] = in_flat[126];
assign const_shift_wrapper_in_flat[4] = in_flat[127];
assign const_shift_wrapper_in_flat[5] = in_flat[128];
assign const_shift_wrapper_in_flat[6] = in_flat[129];
assign const_shift_wrapper_in_flat[7] = in_flat[130];
assign const_shift_wrapper_in_flat[8] = in_flat[131];
assign const_shift_wrapper_in_flat[9] = in_flat[132];
assign const_shift_wrapper_in_flat[10] = in_flat[133];
assign arithmetic_reduce_wrapper_in_flat[0] = in_flat[134];
...
assign arithmetic_reduce_wrapper_in_flat[7] = in_flat[141];
...
assign arithmetic_reduce_wrapper_in_flat[14] = in_flat[145];
assign arithmetic_reduce_wrapper_in_flat[15] = in_flat[146];
assign bitwise_logic_wrapper_in_flat[0] = in_flat[147];
assign bitwise_logic_wrapper_in_flat[1] = in_flat[148];
assign bitwise_logic_wrapper_in_flat[2] = in_flat[149];
assign bitwise_logic_wrapper_in_flat[3] = in_flat[150];
assign bitwise_logic_wrapper_in_flat[4] = in_flat[151];
assign bitwise_logic_wrapper_in_flat[5] = in_flat[152];
assign bitwise_logic_wrapper_in_flat[6] = in_flat[153];
assign bitwise_logic_wrapper_in_flat[7] = in_flat[154];
assign bitwise_logic_wrapper_in_flat[8] = in_flat[155];
assign bitwise_logic_wrapper_in_flat[11] = in_flat[156];
assign bitwise_logic_wrapper_in_flat[12] = in_flat[157];
assign bitwise_logic_wrapper_in_flat[13] = in_flat[158];
assign bitwise_logic_wrapper_in_flat[14] = in_flat[159];
assign bitwise_logic_wrapper_in_flat[15] = in_flat[160];
assign bitwise_reduce_wrapper_in_flat[0] = in_flat[161];
assign bitwise_reduce_wrapper_in_flat[3] = in_flat[162];
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[163];
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[164];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[165];
assign relational_wrapper_in_flat[0] = in_flat[166];
assign relational_wrapper_in_flat[1] = in_flat[167];
assign relational_wrapper_in_flat[3] = in_flat[168];
assign relational_wrapper_in_flat[4] = in_flat[169];
assign relational_wrapper_in_flat[5] = in_flat[170];
assign relational_wrapper_in_flat[7] = in_flat[171];
assign select_wrapper_in_flat[0] = in_flat[172];
assign select_wrapper_in_flat[2] = in_flat[173];
assign select_wrapper_in_flat[4] = in_flat[174];
assign select_wrapper_in_flat[5] = in_flat[175];
assign select_wrapper_in_flat[6] = in_flat[176];
assign select_wrapper_in_flat[7] = in_flat[177];
assign select_wrapper_in_flat[8] = in_flat[178];
assign select_wrapper_in_flat[9] = in_flat[179];
assign select_wrapper_in_flat[10] = in_flat[180];
assign select_wrapper_in_flat[11] = in_flat[181];
assign select_wrapper_in_flat[12] = in_flat[182];
assign select_wrapper_in_flat[13] = in_flat[183];
assign select_wrapper_in_flat[14] = in_flat[184];
assign select_wrapper_in_flat[15] = in_flat[185];
assign select_wrapper_in_flat[16] = in_flat[186];
assign select_wrapper_in_flat[17] = in_flat[187];
assign select_wrapper_in_flat[19] = in_flat[188];
assign shift_wrapper_in_flat[0] = in_flat[189];
assign shift_wrapper_in_flat[1] = in_flat[190];
assign shift_wrapper_in_flat[2] = in_flat[191];
assign shift_wrapper_in_flat[4] = in_flat[192];
assign shift_wrapper_in_flat[5] = in_flat[193];
assign shift_wrapper_in_flat[6] = in_flat[194];
assign shift_wrapper_in_flat[7] = in_flat[195];
assign shift_wrapper_in_flat[8] = in_flat[196];
assign shift_wrapper_in_flat[9] = in_flat[197];
assign array_wrapper_in_flat[0] = in_flat[198];
assign array_wrapper_in_flat[1] = in_flat[199];
assign array_wrapper_in_flat[2] = in_flat[200];
assign array_wrapper_in_flat[3] = in_flat[201];
assign array_wrapper_in_flat[4] = in_flat[202];
assign array_wrapper_in_flat[5] = in_flat[203];
assign array_wrapper_in_flat[6] = in_flat[204];
assign array_wrapper_in_flat[7] = in_flat[205];
assign array_wrapper_in_flat[8] = in_flat[206];
assign array_wrapper_in_flat[9] = in_flat[207];
assign array_wrapper_in_flat[12] = in_flat[208];
assign array_wrapper_in_flat[13] = in_flat[209];
assign array_wrapper_in_flat[14] = in_flat[210];
assign array_wrapper_in_flat[15] = in_flat[211];
assign array_wrapper_in_flat[16] = in_flat[212];
assign array_wrapper_in_flat[17] = in_flat[213];
assign cast_wrapper_in_flat[0] = in_flat[214];
assign cast_wrapper_in_flat[1] = in_flat[215];
assign cast_wrapper_in_flat[2] = in_flat[216];
assign cast_wrapper_in_flat[7] = in_flat[217];
assign cast_wrapper_in_flat[9] = in_flat[218];
assign cast_wrapper_in_flat[11] = in_flat[219];
assign conditional_wrapper_in_flat[1] = in_flat[220];
assign conditional_wrapper_in_flat[3] = in_flat[221];
assign conditional_wrapper_in_flat[4] = in_flat[222];
assign conditional_wrapper_in_flat[5] = in_flat[223];
assign conditional_wrapper_in_flat[6] = in_flat[224];
assign conditional_wrapper_in_flat[7] = in_flat[225];
assign conditional_wrapper_in_flat[8] = in_flat[226];
assign partselect_wrapper_in_flat[0] = in_flat[227];
assign partselect_wrapper_in_flat[1] = in_flat[228];
assign partselect_wrapper_in_flat[2] = in_flat[229];
assign partselect_wrapper_in_flat[3] = in_flat[230];
assign partselect_wrapper_in_flat[4] = in_flat[231];
assign partselect_wrapper_in_flat[5] = in_flat[232];
assign partselect_wrapper_in_flat[7] = in_flat[233];
assign partselect_wrapper_in_flat[8] = in_flat[234];
assign partselect_wrapper_in_flat[9] = in_flat[235];
assign partselect_wrapper_in_flat[10] = in_flat[236];
assign partselect_wrapper_in_flat[11] = in_flat[237];
assign partselect_wrapper_in_flat[12] = in_flat[238];
assign partselect_wrapper_in_flat[13] = in_flat[239];
assign partselect_wrapper_in_flat[15] = in_flat[240];
assign partselect_wrapper_in_flat[16] = in_flat[241];
assign partselect_wrapper_in_flat[17] = in_flat[242];
assign partselect_wrapper_in_flat[18] = in_flat[243];
assign width_enum_wrapper_in_flat[1] = in_flat[244];
assign width_enum_wrapper_in_flat[3] = in_flat[245];
...
assign width_struct_wrapper_in_flat[5] = in_flat[250];
assign width_struct_wrapper_in_flat[6] = in_flat[251];
assign width_struct_wrapper_in_flat[7] = in_flat[252];
assign width_struct_wrapper_in_flat[9] = in_flat[253];
assign width_struct_wrapper_in_flat[10] = in_flat[254];
assign width_struct_wrapper_in_flat[11] = in_flat[255];
assign width_union_wrapper_in_flat[0] = in_flat[256];
assign width_union_wrapper_in_flat[1] = in_flat[257];
...
assign width_union_wrapper_in_flat[7] = in_flat[262];
assign width_union_wrapper_in_flat[8] = in_flat[263];
assign width_union_wrapper_in_flat[9] = in_flat[264];
assign width_union_wrapper_in_flat[10] = in_flat[265];
assign width_union_wrapper_in_flat[12] = in_flat[266];
...
assign width_logic_wrapper_in_flat[0] = in_flat[270];
assign width_logic_wrapper_in_flat[1] = in_flat[271];
assign width_logic_wrapper_in_flat[2] = in_flat[272];
assign width_logic_wrapper_in_flat[4] = in_flat[273];
assign width_logic_wrapper_in_flat[6] = in_flat[274];
assign width_logic_wrapper_in_flat[7] = in_flat[275];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[276];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[277];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[278];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[279];
assign numbers_concat_repl_wrapper_in_flat[5] = in_flat[280];

// Internal MTM connections (module-to-module)
assign logical_op_wrapper_in_flat[1] = const_arith_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[6];
assign cast_wrapper_in_flat[10] = const_arith_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[15] = const_arith_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[8] = const_compare_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[10];
assign array_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[13];
assign numbers_concat_repl_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[4];
assign select_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[20];
assign const_concat_repl_wrapper_in_flat[0] = const_logic_wrapper_out_flat[11];
assign arithmetic_reduce_wrapper_in_flat[10] = const_logic_wrapper_out_flat[16];
assign conditional_wrapper_in_flat[0] = const_logic_wrapper_out_flat[16];
assign bitwise_logic_wrapper_in_flat[10] = const_nested_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[22] = const_nested_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[5] = const_partselect_wrapper_out_flat[2];
assign array_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[0];
assign cast_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[9] = const_shift_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[7] = const_shift_wrapper_out_flat[12];
assign bitwise_reduce_wrapper_in_flat[2] = const_shift_wrapper_out_flat[13];
assign const_conditional_wrapper_in_flat[4] = const_shift_wrapper_out_flat[15];
assign relational_wrapper_in_flat[6] = const_shift_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[5] = const_shift_wrapper_out_flat[17];
assign width_union_wrapper_in_flat[6] = const_shift_wrapper_out_flat[23];
assign const_conditional_wrapper_in_flat[10] = arithmetic_reduce_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[14] = arithmetic_reduce_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[15];
assign logical_op_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[2];
assign cast_wrapper_in_flat[4] = logical_op_wrapper_out_flat[0];
assign shift_wrapper_in_flat[3] = logical_op_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[2] = relational_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[9] = relational_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[19] = relational_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[11] = relational_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[1] = select_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[6] = shift_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[12] = shift_wrapper_out_flat[9];
assign cast_wrapper_in_flat[8] = shift_wrapper_out_flat[15];
assign width_enum_wrapper_in_flat[2] = array_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[8] = array_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[7] = array_wrapper_out_flat[8];
assign width_logic_wrapper_in_flat[3] = conditional_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[4] = conditional_wrapper_out_flat[3];
assign cast_wrapper_in_flat[6] = partselect_wrapper_out_flat[4];
assign select_wrapper_in_flat[18] = width_enum_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[19] = width_union_wrapper_out_flat[4];
assign relational_wrapper_in_flat[2] = width_union_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[6] = width_union_wrapper_out_flat[14];
assign const_reduce_wrapper_in_flat[0] = width_logic_wrapper_out_flat[1];
assign cast_wrapper_in_flat[3] = width_logic_wrapper_out_flat[2];
assign shift_wrapper_in_flat[10] = width_logic_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[14] = width_logic_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[15] = numbers_concat_repl_wrapper_out_flat[4];
