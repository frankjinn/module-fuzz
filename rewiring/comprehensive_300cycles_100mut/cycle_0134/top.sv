...
assign const_shift_wrapper_in_flat[7] = in_flat[132];
assign const_shift_wrapper_in_flat[8] = in_flat[133];
assign const_shift_wrapper_in_flat[9] = in_flat[134];
assign const_shift_wrapper_in_flat[10] = in_flat[135];
assign arithmetic_reduce_wrapper_in_flat[1] = in_flat[136];
assign arithmetic_reduce_wrapper_in_flat[2] = in_flat[137];
assign arithmetic_reduce_wrapper_in_flat[3] = in_flat[138];
...
assign arithmetic_reduce_wrapper_in_flat[10] = in_flat[144];
assign arithmetic_reduce_wrapper_in_flat[12] = in_flat[145];
assign arithmetic_reduce_wrapper_in_flat[13] = in_flat[146];
assign arithmetic_reduce_wrapper_in_flat[14] = in_flat[147];
assign arithmetic_reduce_wrapper_in_flat[15] = in_flat[148];
assign bitwise_logic_wrapper_in_flat[0] = in_flat[149];
assign bitwise_logic_wrapper_in_flat[1] = in_flat[150];
assign bitwise_logic_wrapper_in_flat[2] = in_flat[151];
assign bitwise_logic_wrapper_in_flat[3] = in_flat[152];
assign bitwise_logic_wrapper_in_flat[4] = in_flat[153];
assign bitwise_logic_wrapper_in_flat[5] = in_flat[154];
assign bitwise_logic_wrapper_in_flat[7] = in_flat[155];
assign bitwise_logic_wrapper_in_flat[8] = in_flat[156];
assign bitwise_logic_wrapper_in_flat[9] = in_flat[157];
assign bitwise_logic_wrapper_in_flat[10] = in_flat[158];
assign bitwise_logic_wrapper_in_flat[11] = in_flat[159];
assign bitwise_logic_wrapper_in_flat[12] = in_flat[160];
assign bitwise_logic_wrapper_in_flat[13] = in_flat[161];
assign bitwise_logic_wrapper_in_flat[14] = in_flat[162];
assign bitwise_logic_wrapper_in_flat[15] = in_flat[163];
assign bitwise_reduce_wrapper_in_flat[0] = in_flat[164];
assign bitwise_reduce_wrapper_in_flat[3] = in_flat[165];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[166];
assign relational_wrapper_in_flat[0] = in_flat[167];
assign relational_wrapper_in_flat[2] = in_flat[168];
...
assign select_wrapper_in_flat[1] = in_flat[173];
assign select_wrapper_in_flat[2] = in_flat[174];
assign select_wrapper_in_flat[3] = in_flat[175];
assign select_wrapper_in_flat[4] = in_flat[176];
assign select_wrapper_in_flat[5] = in_flat[177];
assign select_wrapper_in_flat[7] = in_flat[178];
assign select_wrapper_in_flat[8] = in_flat[179];
assign select_wrapper_in_flat[9] = in_flat[180];
...
assign select_wrapper_in_flat[18] = in_flat[187];
...
assign shift_wrapper_in_flat[3] = in_flat[192];
...
assign shift_wrapper_in_flat[9] = in_flat[196];
assign array_wrapper_in_flat[1] = in_flat[197];
assign array_wrapper_in_flat[2] = in_flat[198];
assign array_wrapper_in_flat[3] = in_flat[199];
assign array_wrapper_in_flat[4] = in_flat[200];
assign array_wrapper_in_flat[5] = in_flat[201];
assign array_wrapper_in_flat[6] = in_flat[202];
assign array_wrapper_in_flat[9] = in_flat[203];
...
assign array_wrapper_in_flat[16] = in_flat[209];
assign array_wrapper_in_flat[17] = in_flat[210];
assign cast_wrapper_in_flat[1] = in_flat[211];
assign cast_wrapper_in_flat[2] = in_flat[212];
assign cast_wrapper_in_flat[4] = in_flat[213];
assign cast_wrapper_in_flat[5] = in_flat[214];
assign cast_wrapper_in_flat[6] = in_flat[215];
assign cast_wrapper_in_flat[7] = in_flat[216];
assign cast_wrapper_in_flat[8] = in_flat[217];
assign cast_wrapper_in_flat[9] = in_flat[218];
assign cast_wrapper_in_flat[10] = in_flat[219];
assign cast_wrapper_in_flat[11] = in_flat[220];
assign conditional_wrapper_in_flat[1] = in_flat[221];
...
assign partselect_wrapper_in_flat[2] = in_flat[226];
assign partselect_wrapper_in_flat[3] = in_flat[227];
assign partselect_wrapper_in_flat[4] = in_flat[228];
assign partselect_wrapper_in_flat[5] = in_flat[229];
assign partselect_wrapper_in_flat[6] = in_flat[230];
assign partselect_wrapper_in_flat[7] = in_flat[231];
assign partselect_wrapper_in_flat[8] = in_flat[232];
...
assign partselect_wrapper_in_flat[17] = in_flat[240];
...
assign width_logic_wrapper_in_flat[2] = in_flat[262];
assign width_logic_wrapper_in_flat[4] = in_flat[263];
assign width_logic_wrapper_in_flat[5] = in_flat[264];
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[265];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[266];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[267];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[268];

// Internal MTM connections (module-to-module)
assign width_struct_wrapper_in_flat[2] = const_arith_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[30] = const_arith_wrapper_out_flat[10];
assign shift_wrapper_in_flat[8] = const_arith_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[2] = const_arith_wrapper_out_flat[17];
assign const_compare_wrapper_in_flat[23] = const_arith_wrapper_out_flat[20];
assign const_nested_wrapper_in_flat[12] = const_arith_wrapper_out_flat[28];
assign width_enum_wrapper_in_flat[1] = const_arith_wrapper_out_flat[37];
assign shift_wrapper_in_flat[10] = const_compare_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[4] = const_compare_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[10] = const_compare_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[18];
assign arithmetic_reduce_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[8];
assign logical_op_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[15];
assign bitwise_reduce_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[18];
assign width_logic_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[20];
assign conditional_wrapper_in_flat[7] = const_logic_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[15] = const_logic_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[4] = const_logic_wrapper_out_flat[8];
assign const_conditional_wrapper_in_flat[0] = const_logic_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[3] = const_logic_wrapper_out_flat[12];
assign conditional_wrapper_in_flat[0] = const_nested_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[2] = const_nested_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[18] = const_partselect_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[11] = const_partselect_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[17] = const_reduce_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[4] = const_shift_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[3] = const_shift_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[15] = const_shift_wrapper_out_flat[19];
assign const_logic_wrapper_in_flat[2] = const_shift_wrapper_out_flat[19];
assign const_concat_repl_wrapper_in_flat[2] = const_shift_wrapper_out_flat[22];
assign width_struct_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[8];
assign const_logic_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[11];
assign numbers_concat_repl_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[18];
assign width_struct_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[0];
assign select_wrapper_in_flat[6] = logical_op_wrapper_out_flat[0];
assign array_wrapper_in_flat[7] = logical_op_wrapper_out_flat[1];
assign cast_wrapper_in_flat[0] = relational_wrapper_out_flat[5];
assign array_wrapper_in_flat[0] = relational_wrapper_out_flat[7];
assign cast_wrapper_in_flat[3] = select_wrapper_out_flat[0];
assign relational_wrapper_in_flat[3] = select_wrapper_out_flat[5];
assign array_wrapper_in_flat[10] = shift_wrapper_out_flat[0];
assign select_wrapper_in_flat[17] = shift_wrapper_out_flat[3];
assign relational_wrapper_in_flat[1] = shift_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[3] = shift_wrapper_out_flat[10];
assign arithmetic_reduce_wrapper_in_flat[0] = array_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[3] = array_wrapper_out_flat[7];
...
assign array_wrapper_in_flat[8] = width_enum_wrapper_out_flat[4];
...
assign partselect_wrapper_in_flat[9] = width_union_wrapper_out_flat[15];
assign const_compare_wrapper_in_flat[21] = width_logic_wrapper_out_flat[0];
assign relational_wrapper_in_flat[5] = width_logic_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[2] = width_logic_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[4];
assign shift_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[10];
assign const_compare_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[11];
assign const_conditional_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[13];
