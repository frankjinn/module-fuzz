...
assign conditional_wrapper_in_flat[1] = in_flat[216];
assign conditional_wrapper_in_flat[2] = in_flat[217];
assign conditional_wrapper_in_flat[3] = in_flat[218];
...
assign const_conditional_wrapper_in_flat[14] = const_arith_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[4] = const_arith_wrapper_out_flat[8];
assign relational_wrapper_in_flat[0] = const_arith_wrapper_out_flat[13];
assign width_union_wrapper_in_flat[2] = const_arith_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[0] = const_arith_wrapper_out_flat[19];
assign const_concat_repl_wrapper_in_flat[6] = const_arith_wrapper_out_flat[21];
assign shift_wrapper_in_flat[4] = const_arith_wrapper_out_flat[27];
assign const_logic_wrapper_in_flat[8] = const_arith_wrapper_out_flat[35];
assign cast_wrapper_in_flat[1] = const_arith_wrapper_out_flat[37];
assign width_union_wrapper_in_flat[15] = const_compare_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[7] = const_compare_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[4] = const_compare_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[17];
assign select_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[21];
assign width_union_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[7] = const_logic_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[6] = const_logic_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[0] = const_logic_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[26] = const_logic_wrapper_out_flat[7];
assign logical_op_wrapper_in_flat[1] = const_nested_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[3] = const_nested_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[0] = const_nested_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[21] = const_reduce_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[5];
assign select_wrapper_in_flat[8] = const_shift_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[9] = const_shift_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[15] = arithmetic_reduce_wrapper_out_flat[0];
assign shift_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[5];
assign shift_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[10];
assign const_arith_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[19];
assign const_conditional_wrapper_in_flat[11] = bitwise_logic_wrapper_out_flat[20];
assign partselect_wrapper_in_flat[4] = bitwise_reduce_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[1];
assign select_wrapper_in_flat[17] = logical_op_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[5] = select_wrapper_out_flat[2];
...
assign width_union_wrapper_in_flat[9] = shift_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[3] = shift_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[5] = shift_wrapper_out_flat[14];
assign const_conditional_wrapper_in_flat[31] = shift_wrapper_out_flat[15];
assign width_enum_wrapper_in_flat[1] = array_wrapper_out_flat[11];
assign relational_wrapper_in_flat[2] = array_wrapper_out_flat[11];
assign relational_wrapper_in_flat[1] = cast_wrapper_out_flat[8];
assign array_wrapper_in_flat[10] = cast_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[5] = conditional_wrapper_out_flat[0];
...
assign partselect_wrapper_in_flat[2] = width_struct_wrapper_out_flat[6];
assign cast_wrapper_in_flat[6] = width_struct_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[10] = width_union_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[4] = width_union_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[9] = width_union_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[0] = width_union_wrapper_out_flat[8];
assign const_concat_repl_wrapper_in_flat[3] = width_union_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[2] = width_union_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[11] = width_logic_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[5] = width_logic_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[8] = width_logic_wrapper_out_flat[5];
assign select_wrapper_in_flat[19] = numbers_concat_repl_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[10];
assign width_enum_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[12];
