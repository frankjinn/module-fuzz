...
assign relational_wrapper_in_flat[4] = in_flat[159];
assign relational_wrapper_in_flat[5] = in_flat[160];
...
assign cast_wrapper_in_flat[9] = in_flat[211];
assign cast_wrapper_in_flat[10] = in_flat[212];
assign conditional_wrapper_in_flat[0] = in_flat[213];
assign conditional_wrapper_in_flat[1] = in_flat[214];
...
assign conditional_wrapper_in_flat[8] = in_flat[220];
...
assign partselect_wrapper_in_flat[12] = in_flat[230];
...
assign shift_wrapper_in_flat[10] = const_arith_wrapper_out_flat[1];
assign array_wrapper_in_flat[2] = const_arith_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[1] = const_arith_wrapper_out_flat[17];
assign relational_wrapper_in_flat[2] = const_arith_wrapper_out_flat[20];
assign const_logic_wrapper_in_flat[4] = const_arith_wrapper_out_flat[22];
assign const_partselect_wrapper_in_flat[17] = const_arith_wrapper_out_flat[23];
assign bitwise_logic_wrapper_in_flat[4] = const_arith_wrapper_out_flat[29];
assign select_wrapper_in_flat[5] = const_arith_wrapper_out_flat[32];
assign bitwise_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[34];
assign const_concat_repl_wrapper_in_flat[4] = const_compare_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[18];
assign cast_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[5];
assign const_arith_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[18];
assign numbers_concat_repl_wrapper_in_flat[5] = const_logic_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[5] = const_logic_wrapper_out_flat[3];
...
assign bitwise_reduce_wrapper_in_flat[0] = const_nested_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[2] = const_nested_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[21] = const_partselect_wrapper_out_flat[0];
assign logical_op_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[13] = const_shift_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[9] = const_shift_wrapper_out_flat[19];
assign partselect_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[10] = arithmetic_reduce_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[8];
assign logical_op_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[2];
assign cast_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[23] = bitwise_logic_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[12];
assign numbers_concat_repl_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[15];
assign relational_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[20];
assign const_shift_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[23];
assign const_partselect_wrapper_in_flat[15] = bitwise_logic_wrapper_out_flat[23];
assign width_enum_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[2] = logical_op_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[3] = relational_wrapper_out_flat[1];
assign shift_wrapper_in_flat[4] = relational_wrapper_out_flat[3];
assign array_wrapper_in_flat[6] = relational_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[0] = relational_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[9] = relational_wrapper_out_flat[7];
assign shift_wrapper_in_flat[0] = select_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[0] = select_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[2] = select_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[2] = select_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[8] = select_wrapper_out_flat[7];
assign array_wrapper_in_flat[13] = shift_wrapper_out_flat[2];
...
assign width_union_wrapper_in_flat[3] = array_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[14] = array_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[5] = array_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[1] = array_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[18] = array_wrapper_out_flat[13];
assign width_union_wrapper_in_flat[0] = cast_wrapper_out_flat[0];
assign shift_wrapper_in_flat[3] = cast_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[2] = cast_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[2] = cast_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[3] = conditional_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[4] = conditional_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[24] = conditional_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[7] = partselect_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[0] = width_enum_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[5] = width_union_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[5] = width_union_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[8] = width_union_wrapper_out_flat[10];
assign width_union_wrapper_in_flat[15] = width_logic_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[7] = numbers_concat_repl_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[14];
assign cast_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[14];
