...
assign width_enum_wrapper_in_flat[2] = in_flat[228];
...
assign width_logic_wrapper_in_flat[5] = const_arith_wrapper_out_flat[11];
assign width_enum_wrapper_in_flat[1] = const_arith_wrapper_out_flat[11];
assign const_shift_wrapper_in_flat[0] = const_arith_wrapper_out_flat[14];
assign const_conditional_wrapper_in_flat[8] = const_arith_wrapper_out_flat[16];
assign select_wrapper_in_flat[2] = const_arith_wrapper_out_flat[24];
assign width_struct_wrapper_in_flat[8] = const_arith_wrapper_out_flat[29];
assign const_nested_wrapper_in_flat[12] = const_arith_wrapper_out_flat[36];
assign const_partselect_wrapper_in_flat[4] = const_compare_wrapper_out_flat[2];
assign shift_wrapper_in_flat[0] = const_compare_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[8] = const_compare_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[15];
assign relational_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[15];
assign width_logic_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[6];
assign shift_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[12];
assign partselect_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[13];
assign const_shift_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[16];
assign const_compare_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[22];
assign const_partselect_wrapper_in_flat[6] = const_logic_wrapper_out_flat[0];
assign cast_wrapper_in_flat[5] = const_logic_wrapper_out_flat[0];
assign array_wrapper_in_flat[4] = const_logic_wrapper_out_flat[14];
assign width_union_wrapper_in_flat[5] = const_logic_wrapper_out_flat[16];
assign const_logic_wrapper_in_flat[1] = const_nested_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[4] = const_nested_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[5] = const_nested_wrapper_out_flat[6];
assign relational_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[4];
assign relational_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[5] = const_shift_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[7] = const_shift_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[1] = const_shift_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[6] = const_shift_wrapper_out_flat[18];
assign shift_wrapper_in_flat[3] = const_shift_wrapper_out_flat[22];
assign select_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[9];
assign const_arith_wrapper_in_flat[14] = arithmetic_reduce_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[21] = bitwise_logic_wrapper_out_flat[19];
assign const_reduce_wrapper_in_flat[3] = bitwise_reduce_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[4] = select_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[1] = select_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[14] = select_wrapper_out_flat[2];
assign cast_wrapper_in_flat[8] = select_wrapper_out_flat[5];
assign shift_wrapper_in_flat[8] = select_wrapper_out_flat[5];
...
assign const_partselect_wrapper_in_flat[8] = array_wrapper_out_flat[15];
assign numbers_concat_repl_wrapper_in_flat[0] = cast_wrapper_out_flat[0];
assign array_wrapper_in_flat[8] = cast_wrapper_out_flat[3];
assign relational_wrapper_in_flat[0] = cast_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[3] = cast_wrapper_out_flat[9];
assign bitwise_reduce_wrapper_in_flat[2] = conditional_wrapper_out_flat[1];
assign numbers_concat_repl_wrapper_in_flat[2] = conditional_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[4] = conditional_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[4] = partselect_wrapper_out_flat[4];
assign select_wrapper_in_flat[1] = partselect_wrapper_out_flat[4];
assign logical_op_wrapper_in_flat[0] = partselect_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[4] = partselect_wrapper_out_flat[8];
assign shift_wrapper_in_flat[5] = width_enum_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[3] = width_enum_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[10] = width_enum_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[4] = width_enum_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[1] = width_enum_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[11] = width_struct_wrapper_out_flat[5];
assign select_wrapper_in_flat[15] = width_struct_wrapper_out_flat[11];
assign cast_wrapper_in_flat[2] = width_union_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[3] = width_union_wrapper_out_flat[3];
assign numbers_concat_repl_wrapper_in_flat[3] = width_union_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[2] = width_union_wrapper_out_flat[8];
assign numbers_concat_repl_wrapper_in_flat[5] = width_logic_wrapper_out_flat[0];
assign width_struct_wrapper_in_flat[0] = width_logic_wrapper_out_flat[0];
assign relational_wrapper_in_flat[7] = width_logic_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[18] = width_logic_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[8];
assign array_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[9];
