...
assign const_reduce_wrapper_in_flat[2] = in_flat[120];
assign const_reduce_wrapper_in_flat[3] = in_flat[121];
...
assign arithmetic_reduce_wrapper_in_flat[15] = const_arith_wrapper_out_flat[14];
assign array_wrapper_in_flat[12] = const_arith_wrapper_out_flat[14];
assign bitwise_logic_wrapper_in_flat[7] = const_arith_wrapper_out_flat[17];
assign select_wrapper_in_flat[4] = const_arith_wrapper_out_flat[35];
assign const_concat_repl_wrapper_in_flat[8] = const_arith_wrapper_out_flat[35];
assign cast_wrapper_in_flat[9] = const_arith_wrapper_out_flat[36];
assign const_conditional_wrapper_in_flat[30] = const_arith_wrapper_out_flat[36];
...
assign const_arith_wrapper_in_flat[8] = const_compare_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[12] = const_compare_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[9];
assign partselect_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[10];
assign bitwise_logic_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[13];
assign cast_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[17];
assign width_struct_wrapper_in_flat[11] = const_logic_wrapper_out_flat[2];
assign relational_wrapper_in_flat[4] = const_logic_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[14] = const_logic_wrapper_out_flat[8];
assign numbers_concat_repl_wrapper_in_flat[1] = const_logic_wrapper_out_flat[11];
assign width_logic_wrapper_in_flat[4] = const_logic_wrapper_out_flat[14];
assign shift_wrapper_in_flat[4] = const_logic_wrapper_out_flat[14];
assign const_arith_wrapper_in_flat[13] = const_nested_wrapper_out_flat[0];
assign select_wrapper_in_flat[18] = const_nested_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[12] = const_nested_wrapper_out_flat[6];
assign array_wrapper_in_flat[3] = const_nested_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[3];
assign width_enum_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[18] = const_reduce_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[4];
assign logical_op_wrapper_in_flat[1] = const_shift_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[10] = arithmetic_reduce_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[23] = arithmetic_reduce_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[13] = bitwise_logic_wrapper_out_flat[14];
assign const_conditional_wrapper_in_flat[13] = bitwise_logic_wrapper_out_flat[22];
assign logical_op_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[3] = relational_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[2] = relational_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[0] = relational_wrapper_out_flat[3];
assign select_wrapper_in_flat[19] = relational_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[18] = relational_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[7] = select_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[0] = shift_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[9] = shift_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[1] = shift_wrapper_out_flat[13];
assign select_wrapper_in_flat[11] = shift_wrapper_out_flat[15];
assign relational_wrapper_in_flat[2] = array_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[1] = array_wrapper_out_flat[4];
assign select_wrapper_in_flat[5] = array_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[5] = array_wrapper_out_flat[15];
assign const_shift_wrapper_in_flat[0] = cast_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[2] = cast_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[3] = cast_wrapper_out_flat[9];
assign bitwise_reduce_wrapper_in_flat[2] = conditional_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[10] = conditional_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[10] = partselect_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[1] = partselect_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[0] = width_enum_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[1] = width_struct_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[15] = width_struct_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[3] = width_struct_wrapper_out_flat[3];
assign const_arith_wrapper_in_flat[12] = width_union_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[26] = width_union_wrapper_out_flat[14];
assign conditional_wrapper_in_flat[1] = width_logic_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[1] = width_logic_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[18] = numbers_concat_repl_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[4];
assign select_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[14];
assign shift_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[17];
