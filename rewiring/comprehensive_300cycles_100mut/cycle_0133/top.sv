...
assign const_logic_wrapper_in_flat[9] = in_flat[81];
...
assign arithmetic_reduce_wrapper_in_flat[12] = in_flat[142];
...
assign relational_wrapper_in_flat[5] = in_flat[164];
...
assign select_wrapper_in_flat[17] = in_flat[180];
...
assign array_wrapper_in_flat[4] = in_flat[195];
assign array_wrapper_in_flat[5] = in_flat[196];
...
assign array_wrapper_in_flat[12] = in_flat[202];
...
assign width_logic_wrapper_in_flat[2] = in_flat[259];
assign width_logic_wrapper_in_flat[3] = in_flat[260];
assign width_logic_wrapper_in_flat[5] = in_flat[261];
assign width_logic_wrapper_in_flat[6] = in_flat[262];
assign numbers_concat_repl_wrapper_in_flat[2] = in_flat[263];
assign numbers_concat_repl_wrapper_in_flat[3] = in_flat[264];

// Internal MTM connections (module-to-module)
assign cast_wrapper_in_flat[5] = const_arith_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[1] = const_arith_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[6] = const_arith_wrapper_out_flat[14];
assign const_nested_wrapper_in_flat[8] = const_arith_wrapper_out_flat[15];
assign width_struct_wrapper_in_flat[9] = const_arith_wrapper_out_flat[21];
assign arithmetic_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[22];
assign shift_wrapper_in_flat[8] = const_arith_wrapper_out_flat[26];
assign const_conditional_wrapper_in_flat[27] = const_arith_wrapper_out_flat[37];
assign width_enum_wrapper_in_flat[3] = const_arith_wrapper_out_flat[37];
assign bitwise_logic_wrapper_in_flat[8] = const_arith_wrapper_out_flat[38];
assign const_logic_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[6];
assign bitwise_reduce_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[10];
assign cast_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[15];
assign bitwise_reduce_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[21];
assign const_partselect_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[22];
assign select_wrapper_in_flat[4] = const_logic_wrapper_out_flat[17];
assign partselect_wrapper_in_flat[6] = const_nested_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[5] = const_nested_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[15] = const_partselect_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[6] = const_shift_wrapper_out_flat[8];
assign select_wrapper_in_flat[3] = const_shift_wrapper_out_flat[21];
assign width_logic_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[1];
assign cast_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[1];
assign relational_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[23] = bitwise_logic_wrapper_out_flat[13];
assign width_union_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[13];
assign numbers_concat_repl_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[18];
assign logical_op_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[20];
assign partselect_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[21];
assign select_wrapper_in_flat[10] = logical_op_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[4] = relational_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[6] = relational_wrapper_out_flat[4];
assign array_wrapper_in_flat[6] = shift_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[3] = shift_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[8] = shift_wrapper_out_flat[9];
assign bitwise_logic_wrapper_in_flat[0] = shift_wrapper_out_flat[11];
assign const_partselect_wrapper_in_flat[10] = array_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[1] = array_wrapper_out_flat[2];
assign relational_wrapper_in_flat[6] = array_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[3] = array_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[5] = array_wrapper_out_flat[10];
assign bitwise_logic_wrapper_in_flat[12] = array_wrapper_out_flat[11];
assign bitwise_reduce_wrapper_in_flat[0] = array_wrapper_out_flat[13];
assign partselect_wrapper_in_flat[2] = array_wrapper_out_flat[14];
assign shift_wrapper_in_flat[0] = cast_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[4] = partselect_wrapper_out_flat[5];
assign logical_op_wrapper_in_flat[0] = partselect_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[7] = width_enum_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[20] = width_enum_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[12] = width_enum_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[31] = width_enum_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[1] = width_struct_wrapper_out_flat[0];
assign shift_wrapper_in_flat[2] = width_struct_wrapper_out_flat[2];
assign cast_wrapper_in_flat[3] = width_struct_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[1] = width_struct_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[5] = width_struct_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[4] = width_union_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[11] = width_union_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[4] = width_union_wrapper_out_flat[14];
assign const_nested_wrapper_in_flat[26] = width_logic_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[0] = width_logic_wrapper_out_flat[4];
assign relational_wrapper_in_flat[1] = width_logic_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[4] = numbers_concat_repl_wrapper_out_flat[13];
