...
assign const_conditional_wrapper_in_flat[1] = in_flat[41];
assign const_conditional_wrapper_in_flat[2] = in_flat[42];
assign const_conditional_wrapper_in_flat[3] = in_flat[43];
assign const_conditional_wrapper_in_flat[4] = in_flat[44];
...
assign const_nested_wrapper_in_flat[10] = in_flat[87];
assign const_nested_wrapper_in_flat[11] = in_flat[88];
assign const_nested_wrapper_in_flat[12] = in_flat[89];
assign const_nested_wrapper_in_flat[14] = in_flat[90];
assign const_nested_wrapper_in_flat[15] = in_flat[91];
assign const_nested_wrapper_in_flat[16] = in_flat[92];
assign const_nested_wrapper_in_flat[17] = in_flat[93];
assign const_nested_wrapper_in_flat[18] = in_flat[94];
assign const_nested_wrapper_in_flat[19] = in_flat[95];
assign const_nested_wrapper_in_flat[20] = in_flat[96];
...
assign const_nested_wrapper_in_flat[26] = in_flat[102];
...
assign const_shift_wrapper_in_flat[2] = in_flat[118];
...
assign arithmetic_reduce_wrapper_in_flat[14] = in_flat[131];
assign arithmetic_reduce_wrapper_in_flat[15] = in_flat[132];
assign bitwise_logic_wrapper_in_flat[0] = in_flat[133];
assign bitwise_logic_wrapper_in_flat[1] = in_flat[134];
assign bitwise_logic_wrapper_in_flat[2] = in_flat[135];
assign bitwise_logic_wrapper_in_flat[3] = in_flat[136];
assign bitwise_logic_wrapper_in_flat[4] = in_flat[137];
assign bitwise_logic_wrapper_in_flat[6] = in_flat[138];
assign bitwise_logic_wrapper_in_flat[8] = in_flat[139];
assign bitwise_logic_wrapper_in_flat[9] = in_flat[140];
assign bitwise_logic_wrapper_in_flat[10] = in_flat[141];
...
assign bitwise_logic_wrapper_in_flat[15] = in_flat[146];
assign bitwise_reduce_wrapper_in_flat[0] = in_flat[147];
assign bitwise_reduce_wrapper_in_flat[1] = in_flat[148];
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[149];
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[150];
assign relational_wrapper_in_flat[0] = in_flat[151];
assign relational_wrapper_in_flat[1] = in_flat[152];
assign relational_wrapper_in_flat[2] = in_flat[153];
assign relational_wrapper_in_flat[3] = in_flat[154];
assign select_wrapper_in_flat[0] = in_flat[155];
assign select_wrapper_in_flat[1] = in_flat[156];
assign select_wrapper_in_flat[2] = in_flat[157];
assign select_wrapper_in_flat[3] = in_flat[158];
assign select_wrapper_in_flat[4] = in_flat[159];
assign select_wrapper_in_flat[5] = in_flat[160];
assign select_wrapper_in_flat[6] = in_flat[161];
assign select_wrapper_in_flat[8] = in_flat[162];
assign select_wrapper_in_flat[9] = in_flat[163];
...
assign conditional_wrapper_in_flat[4] = in_flat[210];
assign conditional_wrapper_in_flat[5] = in_flat[211];
...
assign width_struct_wrapper_in_flat[6] = const_arith_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[7] = const_arith_wrapper_out_flat[15];
assign arithmetic_reduce_wrapper_in_flat[6] = const_arith_wrapper_out_flat[16];
assign partselect_wrapper_in_flat[16] = const_arith_wrapper_out_flat[24];
assign const_compare_wrapper_in_flat[10] = const_arith_wrapper_out_flat[38];
assign width_union_wrapper_in_flat[6] = const_arith_wrapper_out_flat[38];
assign partselect_wrapper_in_flat[18] = const_compare_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[4] = const_compare_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[3] = const_compare_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[5] = const_compare_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[4] = const_compare_wrapper_out_flat[7];
assign width_enum_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[2];
assign array_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[10];
assign const_arith_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[11];
assign const_shift_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[15];
assign select_wrapper_in_flat[14] = const_logic_wrapper_out_flat[10];
assign conditional_wrapper_in_flat[2] = const_logic_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[15] = const_logic_wrapper_out_flat[18];
assign bitwise_logic_wrapper_in_flat[7] = const_nested_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[12] = const_nested_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[3] = const_shift_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[0] = const_shift_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[7] = const_shift_wrapper_out_flat[11];
assign array_wrapper_in_flat[15] = const_shift_wrapper_out_flat[12];
assign const_reduce_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[1] = arithmetic_reduce_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[3];
assign cast_wrapper_in_flat[6] = bitwise_logic_wrapper_out_flat[12];
assign width_logic_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[17] = bitwise_logic_wrapper_out_flat[13];
assign const_conditional_wrapper_in_flat[17] = bitwise_logic_wrapper_out_flat[14];
assign relational_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[2];
assign bitwise_reduce_wrapper_in_flat[6] = logical_op_wrapper_out_flat[2];
assign relational_wrapper_in_flat[5] = select_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[10] = select_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[3] = select_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[24] = shift_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[2] = shift_wrapper_out_flat[4];
assign select_wrapper_in_flat[17] = shift_wrapper_out_flat[8];
assign bitwise_logic_wrapper_in_flat[5] = shift_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[19] = shift_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[0] = shift_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[13] = shift_wrapper_out_flat[15];
assign logical_op_wrapper_in_flat[1] = array_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[4] = array_wrapper_out_flat[11];
assign const_conditional_wrapper_in_flat[13] = cast_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[10] = cast_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[6] = cast_wrapper_out_flat[9];
assign const_arith_wrapper_in_flat[14] = cast_wrapper_out_flat[11];
assign array_wrapper_in_flat[8] = conditional_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[9] = partselect_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[3] = partselect_wrapper_out_flat[5];
assign select_wrapper_in_flat[7] = partselect_wrapper_out_flat[8];
assign logical_op_wrapper_in_flat[0] = width_enum_wrapper_out_flat[1];
assign array_wrapper_in_flat[3] = width_enum_wrapper_out_flat[1];
assign relational_wrapper_in_flat[4] = width_enum_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[0] = width_struct_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[0] = width_struct_wrapper_out_flat[6];
assign relational_wrapper_in_flat[6] = width_struct_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[4] = width_struct_wrapper_out_flat[10];
assign const_compare_wrapper_in_flat[21] = width_union_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[8] = width_union_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[1] = width_union_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[1] = width_union_wrapper_out_flat[8];
assign width_union_wrapper_in_flat[9] = width_logic_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[0] = width_logic_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[7] = width_logic_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[7];
assign arithmetic_reduce_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[22] = numbers_concat_repl_wrapper_out_flat[15];
assign width_struct_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[16];
