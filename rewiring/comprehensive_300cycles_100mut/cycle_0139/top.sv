...
assign bitwise_reduce_wrapper_in_flat[1] = in_flat[160];
assign bitwise_reduce_wrapper_in_flat[2] = in_flat[161];
assign bitwise_reduce_wrapper_in_flat[3] = in_flat[162];
assign bitwise_reduce_wrapper_in_flat[5] = in_flat[163];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[164];
assign bitwise_reduce_wrapper_in_flat[7] = in_flat[165];
assign logical_op_wrapper_in_flat[1] = in_flat[166];
assign relational_wrapper_in_flat[0] = in_flat[167];
assign relational_wrapper_in_flat[1] = in_flat[168];
assign relational_wrapper_in_flat[4] = in_flat[169];
assign relational_wrapper_in_flat[6] = in_flat[170];
assign relational_wrapper_in_flat[7] = in_flat[171];
assign select_wrapper_in_flat[1] = in_flat[172];
assign select_wrapper_in_flat[3] = in_flat[173];
assign select_wrapper_in_flat[6] = in_flat[174];
assign select_wrapper_in_flat[7] = in_flat[175];
assign select_wrapper_in_flat[8] = in_flat[176];
...
assign select_wrapper_in_flat[14] = in_flat[180];
assign select_wrapper_in_flat[15] = in_flat[181];
...
assign conditional_wrapper_in_flat[0] = in_flat[217];
assign conditional_wrapper_in_flat[2] = in_flat[218];
assign conditional_wrapper_in_flat[5] = in_flat[219];
...
assign partselect_wrapper_in_flat[4] = const_arith_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[0] = const_arith_wrapper_out_flat[11];
assign const_concat_repl_wrapper_in_flat[9] = const_arith_wrapper_out_flat[12];
assign cast_wrapper_in_flat[5] = const_arith_wrapper_out_flat[17];
assign const_compare_wrapper_in_flat[20] = const_arith_wrapper_out_flat[23];
assign const_nested_wrapper_in_flat[3] = const_arith_wrapper_out_flat[28];
assign select_wrapper_in_flat[0] = const_compare_wrapper_out_flat[2];
assign array_wrapper_in_flat[1] = const_compare_wrapper_out_flat[7];
assign shift_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[0];
assign cast_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[12];
assign const_conditional_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[16];
assign conditional_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[9];
assign const_shift_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[18];
assign shift_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[21];
assign conditional_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[21];
assign width_struct_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[22];
assign const_partselect_wrapper_in_flat[1] = const_logic_wrapper_out_flat[5];
assign select_wrapper_in_flat[2] = const_logic_wrapper_out_flat[6];
assign conditional_wrapper_in_flat[4] = const_nested_wrapper_out_flat[2];
assign shift_wrapper_in_flat[4] = const_nested_wrapper_out_flat[2];
assign width_enum_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[1];
assign select_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[4] = const_shift_wrapper_out_flat[11];
assign select_wrapper_in_flat[4] = const_shift_wrapper_out_flat[12];
assign width_logic_wrapper_in_flat[3] = const_shift_wrapper_out_flat[20];
assign numbers_concat_repl_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[0];
assign select_wrapper_in_flat[11] = arithmetic_reduce_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[21] = bitwise_logic_wrapper_out_flat[8];
assign partselect_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[15];
assign width_union_wrapper_in_flat[13] = bitwise_logic_wrapper_out_flat[15];
...
assign const_arith_wrapper_in_flat[15] = bitwise_logic_wrapper_out_flat[21];
assign width_struct_wrapper_in_flat[0] = bitwise_reduce_wrapper_out_flat[1];
...
assign const_partselect_wrapper_in_flat[2] = logical_op_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[0] = relational_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[12] = select_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[0] = select_wrapper_out_flat[8];
assign relational_wrapper_in_flat[3] = shift_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[6] = shift_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[9] = array_wrapper_out_flat[0];
assign select_wrapper_in_flat[9] = array_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[1] = array_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[1] = array_wrapper_out_flat[11];
assign conditional_wrapper_in_flat[1] = cast_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[4] = cast_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[1] = cast_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[5] = cast_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[2] = cast_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[3] = cast_wrapper_out_flat[11];
...
assign const_conditional_wrapper_in_flat[19] = partselect_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[8] = partselect_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[13] = partselect_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[3] = width_struct_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[9] = width_union_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[10] = width_union_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[15] = width_union_wrapper_out_flat[3];
assign relational_wrapper_in_flat[5] = width_union_wrapper_out_flat[12];
...
assign width_struct_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[0];
...
assign array_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[8];
