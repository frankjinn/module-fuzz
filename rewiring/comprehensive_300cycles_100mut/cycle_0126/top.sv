...
assign const_logic_wrapper_in_flat[6] = in_flat[77];
...
assign cast_wrapper_in_flat[7] = in_flat[208];
assign cast_wrapper_in_flat[8] = in_flat[209];
...
assign width_union_wrapper_in_flat[11] = const_arith_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[6] = const_arith_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[9] = const_arith_wrapper_out_flat[13];
assign const_conditional_wrapper_in_flat[4] = const_arith_wrapper_out_flat[16];
assign bitwise_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[19];
assign arithmetic_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[22];
assign array_wrapper_in_flat[17] = const_arith_wrapper_out_flat[23];
assign relational_wrapper_in_flat[2] = const_arith_wrapper_out_flat[25];
assign const_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[32];
assign cast_wrapper_in_flat[9] = const_arith_wrapper_out_flat[37];
assign select_wrapper_in_flat[0] = const_arith_wrapper_out_flat[39];
assign partselect_wrapper_in_flat[12] = const_compare_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[12];
assign width_logic_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[20];
assign shift_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[16];
assign arithmetic_reduce_wrapper_in_flat[11] = const_logic_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[32] = const_logic_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[2] = const_logic_wrapper_out_flat[6];
assign cast_wrapper_in_flat[4] = const_logic_wrapper_out_flat[9];
assign const_arith_wrapper_in_flat[12] = const_logic_wrapper_out_flat[12];
assign width_enum_wrapper_in_flat[3] = const_logic_wrapper_out_flat[12];
assign select_wrapper_in_flat[1] = const_logic_wrapper_out_flat[12];
assign width_struct_wrapper_in_flat[7] = const_logic_wrapper_out_flat[16];
assign width_union_wrapper_in_flat[7] = const_logic_wrapper_out_flat[18];
assign shift_wrapper_in_flat[3] = const_nested_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[12] = const_partselect_wrapper_out_flat[1];
assign partselect_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[7] = const_reduce_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[1] = const_shift_wrapper_out_flat[0];
assign array_wrapper_in_flat[13] = const_shift_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[14] = const_shift_wrapper_out_flat[8];
assign bitwise_logic_wrapper_in_flat[0] = const_shift_wrapper_out_flat[15];
assign relational_wrapper_in_flat[7] = const_shift_wrapper_out_flat[16];
assign const_reduce_wrapper_in_flat[0] = const_shift_wrapper_out_flat[19];
assign const_compare_wrapper_in_flat[11] = const_shift_wrapper_out_flat[21];
assign width_enum_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[9];
assign width_logic_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[12];
assign const_conditional_wrapper_in_flat[14] = bitwise_logic_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[0] = select_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[7] = shift_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[4] = shift_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[14] = shift_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[10] = array_wrapper_out_flat[1];
assign shift_wrapper_in_flat[4] = array_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[0] = array_wrapper_out_flat[15];
assign const_reduce_wrapper_in_flat[3] = array_wrapper_out_flat[15];
assign shift_wrapper_in_flat[1] = cast_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[8] = cast_wrapper_out_flat[7];
assign array_wrapper_in_flat[4] = cast_wrapper_out_flat[11];
assign bitwise_reduce_wrapper_in_flat[6] = conditional_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[31] = conditional_wrapper_out_flat[1];
assign logical_op_wrapper_in_flat[1] = partselect_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[5] = width_enum_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[16] = width_struct_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[9] = width_struct_wrapper_out_flat[5];
assign width_union_wrapper_in_flat[15] = width_struct_wrapper_out_flat[8];
assign const_shift_wrapper_in_flat[1] = width_struct_wrapper_out_flat[11];
...
assign bitwise_reduce_wrapper_in_flat[3] = width_union_wrapper_out_flat[6];
assign shift_wrapper_in_flat[6] = width_logic_wrapper_out_flat[3];
assign arithmetic_reduce_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[10];
assign select_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[10];
assign width_struct_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[12];
assign cast_wrapper_in_flat[10] = numbers_concat_repl_wrapper_out_flat[13];
assign array_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[14];
assign relational_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[14];
assign const_reduce_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[17];
