...
assign const_concat_repl_wrapper_in_flat[9] = in_flat[37];
...
assign const_logic_wrapper_in_flat[0] = in_flat[69];
...
assign bitwise_reduce_wrapper_in_flat[0] = in_flat[158];
...
assign relational_wrapper_in_flat[3] = in_flat[165];
assign relational_wrapper_in_flat[4] = in_flat[166];
assign relational_wrapper_in_flat[6] = in_flat[167];
assign relational_wrapper_in_flat[7] = in_flat[168];
assign select_wrapper_in_flat[0] = in_flat[169];
assign select_wrapper_in_flat[1] = in_flat[170];
assign select_wrapper_in_flat[2] = in_flat[171];
assign select_wrapper_in_flat[3] = in_flat[172];
assign select_wrapper_in_flat[4] = in_flat[173];
assign select_wrapper_in_flat[5] = in_flat[174];
assign select_wrapper_in_flat[6] = in_flat[175];
assign select_wrapper_in_flat[7] = in_flat[176];
assign select_wrapper_in_flat[8] = in_flat[177];
assign select_wrapper_in_flat[9] = in_flat[178];
assign select_wrapper_in_flat[10] = in_flat[179];
assign select_wrapper_in_flat[11] = in_flat[180];
assign select_wrapper_in_flat[12] = in_flat[181];
assign select_wrapper_in_flat[13] = in_flat[182];
assign select_wrapper_in_flat[14] = in_flat[183];
assign select_wrapper_in_flat[15] = in_flat[184];
assign select_wrapper_in_flat[18] = in_flat[185];
assign select_wrapper_in_flat[19] = in_flat[186];
assign shift_wrapper_in_flat[0] = in_flat[187];
assign shift_wrapper_in_flat[1] = in_flat[188];
assign shift_wrapper_in_flat[2] = in_flat[189];
assign shift_wrapper_in_flat[3] = in_flat[190];
assign shift_wrapper_in_flat[4] = in_flat[191];
assign shift_wrapper_in_flat[6] = in_flat[192];
assign shift_wrapper_in_flat[7] = in_flat[193];
assign shift_wrapper_in_flat[8] = in_flat[194];
assign shift_wrapper_in_flat[9] = in_flat[195];
assign array_wrapper_in_flat[0] = in_flat[196];
assign array_wrapper_in_flat[1] = in_flat[197];
assign array_wrapper_in_flat[3] = in_flat[198];
...
assign array_wrapper_in_flat[12] = in_flat[203];
assign array_wrapper_in_flat[13] = in_flat[204];
assign array_wrapper_in_flat[14] = in_flat[205];
assign array_wrapper_in_flat[15] = in_flat[206];
assign array_wrapper_in_flat[16] = in_flat[207];
...
assign cast_wrapper_in_flat[3] = in_flat[212];
assign cast_wrapper_in_flat[4] = in_flat[213];
assign cast_wrapper_in_flat[6] = in_flat[214];
assign cast_wrapper_in_flat[7] = in_flat[215];
assign cast_wrapper_in_flat[9] = in_flat[216];
assign cast_wrapper_in_flat[10] = in_flat[217];
assign cast_wrapper_in_flat[11] = in_flat[218];
assign conditional_wrapper_in_flat[3] = in_flat[219];
assign conditional_wrapper_in_flat[4] = in_flat[220];
assign conditional_wrapper_in_flat[5] = in_flat[221];
assign conditional_wrapper_in_flat[7] = in_flat[222];
assign conditional_wrapper_in_flat[8] = in_flat[223];
assign partselect_wrapper_in_flat[0] = in_flat[224];
assign partselect_wrapper_in_flat[2] = in_flat[225];
assign partselect_wrapper_in_flat[3] = in_flat[226];
assign partselect_wrapper_in_flat[4] = in_flat[227];
assign partselect_wrapper_in_flat[5] = in_flat[228];
assign partselect_wrapper_in_flat[7] = in_flat[229];
assign partselect_wrapper_in_flat[8] = in_flat[230];
assign partselect_wrapper_in_flat[9] = in_flat[231];
assign partselect_wrapper_in_flat[10] = in_flat[232];
assign partselect_wrapper_in_flat[11] = in_flat[233];
assign partselect_wrapper_in_flat[12] = in_flat[234];
assign partselect_wrapper_in_flat[13] = in_flat[235];
assign partselect_wrapper_in_flat[15] = in_flat[236];
assign partselect_wrapper_in_flat[16] = in_flat[237];
assign partselect_wrapper_in_flat[17] = in_flat[238];
assign partselect_wrapper_in_flat[18] = in_flat[239];
assign width_enum_wrapper_in_flat[0] = in_flat[240];
assign width_enum_wrapper_in_flat[2] = in_flat[241];
...
assign width_struct_wrapper_in_flat[6] = in_flat[247];
assign width_struct_wrapper_in_flat[7] = in_flat[248];
assign width_struct_wrapper_in_flat[9] = in_flat[249];
...
assign width_union_wrapper_in_flat[2] = in_flat[254];
...
assign width_logic_wrapper_in_flat[0] = in_flat[263];
assign width_logic_wrapper_in_flat[1] = in_flat[264];
assign width_logic_wrapper_in_flat[2] = in_flat[265];
assign width_logic_wrapper_in_flat[4] = in_flat[266];
assign width_logic_wrapper_in_flat[6] = in_flat[267];
assign width_logic_wrapper_in_flat[7] = in_flat[268];
assign numbers_concat_repl_wrapper_in_flat[1] = in_flat[269];
assign numbers_concat_repl_wrapper_in_flat[4] = in_flat[270];

// Internal MTM connections (module-to-module)
assign bitwise_reduce_wrapper_in_flat[7] = const_arith_wrapper_out_flat[23];
assign conditional_wrapper_in_flat[2] = const_arith_wrapper_out_flat[25];
assign width_struct_wrapper_in_flat[8] = const_arith_wrapper_out_flat[35];
assign const_partselect_wrapper_in_flat[16] = const_concat_repl_wrapper_out_flat[1];
assign array_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[12];
assign const_concat_repl_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[14] = const_conditional_wrapper_out_flat[13];
assign numbers_concat_repl_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[22];
assign bitwise_logic_wrapper_in_flat[1] = const_logic_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[3] = const_nested_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[1] = const_nested_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[4] = const_nested_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[1];
assign width_union_wrapper_in_flat[14] = const_shift_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[0] = const_shift_wrapper_out_flat[13];
assign relational_wrapper_in_flat[5] = arithmetic_reduce_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[16] = arithmetic_reduce_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[7];
assign select_wrapper_in_flat[17] = arithmetic_reduce_wrapper_out_flat[9];
assign shift_wrapper_in_flat[5] = bitwise_logic_wrapper_out_flat[14];
assign width_logic_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[20];
assign const_shift_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[20];
assign array_wrapper_in_flat[2] = bitwise_reduce_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[4] = logical_op_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[5] = logical_op_wrapper_out_flat[2];
assign cast_wrapper_in_flat[5] = relational_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[4] = relational_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[1] = relational_wrapper_out_flat[5];
assign select_wrapper_in_flat[16] = relational_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[12] = relational_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[15] = select_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[3] = select_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[9] = select_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[20] = select_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[14] = select_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[3] = shift_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[6] = shift_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[6] = shift_wrapper_out_flat[12];
assign const_reduce_wrapper_in_flat[0] = array_wrapper_out_flat[10];
assign width_logic_wrapper_in_flat[5] = cast_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[2] = cast_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[8] = cast_wrapper_out_flat[8];
assign const_shift_wrapper_in_flat[5] = cast_wrapper_out_flat[11];
assign array_wrapper_in_flat[11] = conditional_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[1] = conditional_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[3] = conditional_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[8] = partselect_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[21] = partselect_wrapper_out_flat[2];
assign array_wrapper_in_flat[9] = partselect_wrapper_out_flat[6];
assign numbers_concat_repl_wrapper_in_flat[5] = partselect_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[9] = width_enum_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[1] = width_struct_wrapper_out_flat[3];
assign logical_op_wrapper_in_flat[0] = width_struct_wrapper_out_flat[10];
assign const_reduce_wrapper_in_flat[1] = width_struct_wrapper_out_flat[11];
assign const_arith_wrapper_in_flat[14] = width_union_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[6] = width_union_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[11] = width_union_wrapper_out_flat[14];
assign shift_wrapper_in_flat[10] = width_logic_wrapper_out_flat[0];
assign array_wrapper_in_flat[4] = width_logic_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[4];
assign cast_wrapper_in_flat[8] = numbers_concat_repl_wrapper_out_flat[16];
assign const_concat_repl_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[16];
