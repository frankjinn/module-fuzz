...
assign const_logic_wrapper_in_flat[4] = in_flat[80];
assign const_logic_wrapper_in_flat[5] = in_flat[81];
...
assign const_partselect_wrapper_in_flat[2] = in_flat[109];
assign const_partselect_wrapper_in_flat[3] = in_flat[110];
...
assign const_reduce_wrapper_in_flat[2] = in_flat[124];
...
assign const_shift_wrapper_in_flat[3] = in_flat[128];
assign const_shift_wrapper_in_flat[4] = in_flat[129];
assign const_shift_wrapper_in_flat[5] = in_flat[130];
assign const_shift_wrapper_in_flat[7] = in_flat[131];
assign const_shift_wrapper_in_flat[8] = in_flat[132];
assign const_shift_wrapper_in_flat[9] = in_flat[133];
assign const_shift_wrapper_in_flat[10] = in_flat[134];
assign arithmetic_reduce_wrapper_in_flat[1] = in_flat[135];
assign arithmetic_reduce_wrapper_in_flat[2] = in_flat[136];
assign arithmetic_reduce_wrapper_in_flat[3] = in_flat[137];
assign arithmetic_reduce_wrapper_in_flat[4] = in_flat[138];
assign arithmetic_reduce_wrapper_in_flat[5] = in_flat[139];
assign arithmetic_reduce_wrapper_in_flat[7] = in_flat[140];
assign arithmetic_reduce_wrapper_in_flat[8] = in_flat[141];
assign arithmetic_reduce_wrapper_in_flat[9] = in_flat[142];
assign arithmetic_reduce_wrapper_in_flat[11] = in_flat[143];
assign arithmetic_reduce_wrapper_in_flat[12] = in_flat[144];
assign arithmetic_reduce_wrapper_in_flat[15] = in_flat[145];
assign bitwise_logic_wrapper_in_flat[0] = in_flat[146];
assign bitwise_logic_wrapper_in_flat[1] = in_flat[147];
...
assign bitwise_logic_wrapper_in_flat[8] = in_flat[151];
assign bitwise_logic_wrapper_in_flat[9] = in_flat[152];
assign bitwise_logic_wrapper_in_flat[10] = in_flat[153];
...
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[159];
...
assign array_wrapper_in_flat[3] = in_flat[191];
...
assign partselect_wrapper_in_flat[14] = in_flat[229];
...
assign numbers_concat_repl_wrapper_in_flat[0] = in_flat[257];
...
assign arithmetic_reduce_wrapper_in_flat[6] = const_arith_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[2] = const_arith_wrapper_out_flat[21];
assign bitwise_logic_wrapper_in_flat[15] = const_arith_wrapper_out_flat[33];
assign const_partselect_wrapper_in_flat[0] = const_arith_wrapper_out_flat[38];
assign cast_wrapper_in_flat[8] = const_compare_wrapper_out_flat[0];
assign array_wrapper_in_flat[10] = const_compare_wrapper_out_flat[1];
assign bitwise_logic_wrapper_in_flat[7] = const_compare_wrapper_out_flat[1];
assign select_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[14];
assign numbers_concat_repl_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[9];
assign const_shift_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[20];
assign partselect_wrapper_in_flat[2] = const_logic_wrapper_out_flat[1];
assign shift_wrapper_in_flat[7] = const_logic_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[5] = const_logic_wrapper_out_flat[10];
assign const_reduce_wrapper_in_flat[3] = const_logic_wrapper_out_flat[10];
assign select_wrapper_in_flat[17] = const_logic_wrapper_out_flat[16];
assign select_wrapper_in_flat[0] = const_nested_wrapper_out_flat[0];
assign const_concat_repl_wrapper_in_flat[5] = const_nested_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[20] = const_partselect_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[17] = const_reduce_wrapper_out_flat[4];
assign partselect_wrapper_in_flat[3] = const_shift_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[4] = const_shift_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[0] = const_shift_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[7] = const_shift_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[6] = const_shift_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[11] = const_shift_wrapper_out_flat[10];
assign bitwise_logic_wrapper_in_flat[2] = const_shift_wrapper_out_flat[19];
assign width_struct_wrapper_in_flat[11] = const_shift_wrapper_out_flat[20];
assign const_compare_wrapper_in_flat[12] = arithmetic_reduce_wrapper_out_flat[4];
assign bitwise_logic_wrapper_in_flat[12] = arithmetic_reduce_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[13];
assign width_enum_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[15];
assign width_union_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[17];
assign array_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[18];
assign const_reduce_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[19];
assign shift_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[21];
assign const_logic_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[2] = logical_op_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[2] = logical_op_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[5] = relational_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[1] = shift_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[1] = shift_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[6] = shift_wrapper_out_flat[12];
assign const_reduce_wrapper_in_flat[0] = shift_wrapper_out_flat[14];
assign cast_wrapper_in_flat[6] = array_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[4] = array_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[15] = array_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[0] = array_wrapper_out_flat[5];
assign shift_wrapper_in_flat[6] = array_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[4] = cast_wrapper_out_flat[1];
assign bitwise_reduce_wrapper_in_flat[5] = cast_wrapper_out_flat[6];
assign relational_wrapper_in_flat[0] = cast_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[11] = conditional_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[2] = partselect_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[9] = partselect_wrapper_out_flat[4];
assign bitwise_reduce_wrapper_in_flat[7] = width_enum_wrapper_out_flat[2];
assign logical_op_wrapper_in_flat[1] = width_enum_wrapper_out_flat[3];
assign relational_wrapper_in_flat[1] = width_enum_wrapper_out_flat[3];
assign select_wrapper_in_flat[9] = width_enum_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[5] = width_struct_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[1] = width_struct_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[13] = width_struct_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[10] = width_struct_wrapper_out_flat[9];
assign select_wrapper_in_flat[13] = width_union_wrapper_out_flat[1];
assign width_enum_wrapper_in_flat[1] = width_union_wrapper_out_flat[3];
assign array_wrapper_in_flat[12] = width_union_wrapper_out_flat[9];
assign cast_wrapper_in_flat[0] = width_union_wrapper_out_flat[12];
assign relational_wrapper_in_flat[4] = width_union_wrapper_out_flat[15];
assign arithmetic_reduce_wrapper_in_flat[13] = width_logic_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[11] = width_logic_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[9];
assign arithmetic_reduce_wrapper_in_flat[14] = numbers_concat_repl_wrapper_out_flat[10];
assign width_enum_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[14];
assign width_struct_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[14];
assign cast_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[15];
assign const_arith_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[15];
assign width_logic_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[16];
