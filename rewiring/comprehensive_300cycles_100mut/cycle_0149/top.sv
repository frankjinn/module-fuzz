...
assign const_conditional_wrapper_in_flat[25] = in_flat[67];
assign const_conditional_wrapper_in_flat[26] = in_flat[68];
assign const_conditional_wrapper_in_flat[27] = in_flat[69];
assign const_conditional_wrapper_in_flat[28] = in_flat[70];
assign const_conditional_wrapper_in_flat[29] = in_flat[71];
...
assign const_logic_wrapper_in_flat[0] = in_flat[76];
assign const_logic_wrapper_in_flat[1] = in_flat[77];
assign const_logic_wrapper_in_flat[2] = in_flat[78];
assign const_logic_wrapper_in_flat[3] = in_flat[79];
...
assign const_partselect_wrapper_in_flat[9] = in_flat[115];
...
assign const_partselect_wrapper_in_flat[19] = in_flat[123];
assign const_reduce_wrapper_in_flat[0] = in_flat[124];
assign const_shift_wrapper_in_flat[0] = in_flat[125];
assign const_shift_wrapper_in_flat[1] = in_flat[126];
assign const_shift_wrapper_in_flat[2] = in_flat[127];
...
assign const_shift_wrapper_in_flat[7] = in_flat[131];
assign const_shift_wrapper_in_flat[8] = in_flat[132];
assign const_shift_wrapper_in_flat[10] = in_flat[133];
...
assign arithmetic_reduce_wrapper_in_flat[6] = in_flat[138];
assign arithmetic_reduce_wrapper_in_flat[7] = in_flat[139];
assign arithmetic_reduce_wrapper_in_flat[8] = in_flat[140];
assign arithmetic_reduce_wrapper_in_flat[10] = in_flat[141];
assign arithmetic_reduce_wrapper_in_flat[11] = in_flat[142];
assign arithmetic_reduce_wrapper_in_flat[13] = in_flat[143];
assign arithmetic_reduce_wrapper_in_flat[15] = in_flat[144];
assign bitwise_logic_wrapper_in_flat[0] = in_flat[145];
assign bitwise_logic_wrapper_in_flat[2] = in_flat[146];
assign bitwise_logic_wrapper_in_flat[3] = in_flat[147];
assign bitwise_logic_wrapper_in_flat[4] = in_flat[148];
assign bitwise_logic_wrapper_in_flat[5] = in_flat[149];
assign bitwise_logic_wrapper_in_flat[6] = in_flat[150];
...
assign bitwise_logic_wrapper_in_flat[10] = in_flat[154];
assign bitwise_logic_wrapper_in_flat[11] = in_flat[155];
assign bitwise_logic_wrapper_in_flat[12] = in_flat[156];
assign bitwise_logic_wrapper_in_flat[13] = in_flat[157];
assign bitwise_logic_wrapper_in_flat[14] = in_flat[158];
assign bitwise_logic_wrapper_in_flat[15] = in_flat[159];
assign bitwise_reduce_wrapper_in_flat[0] = in_flat[160];
assign bitwise_reduce_wrapper_in_flat[1] = in_flat[161];
assign bitwise_reduce_wrapper_in_flat[4] = in_flat[162];
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[163];
assign relational_wrapper_in_flat[0] = in_flat[164];
assign relational_wrapper_in_flat[2] = in_flat[165];
assign relational_wrapper_in_flat[3] = in_flat[166];
assign relational_wrapper_in_flat[7] = in_flat[167];
assign select_wrapper_in_flat[1] = in_flat[168];
assign select_wrapper_in_flat[2] = in_flat[169];
assign select_wrapper_in_flat[3] = in_flat[170];
assign select_wrapper_in_flat[4] = in_flat[171];
assign select_wrapper_in_flat[5] = in_flat[172];
assign select_wrapper_in_flat[6] = in_flat[173];
assign select_wrapper_in_flat[7] = in_flat[174];
...
assign select_wrapper_in_flat[19] = in_flat[180];
assign shift_wrapper_in_flat[1] = in_flat[181];
assign shift_wrapper_in_flat[3] = in_flat[182];
assign shift_wrapper_in_flat[5] = in_flat[183];
assign shift_wrapper_in_flat[6] = in_flat[184];
...
assign cast_wrapper_in_flat[6] = in_flat[202];
assign cast_wrapper_in_flat[7] = in_flat[203];
assign cast_wrapper_in_flat[8] = in_flat[204];
assign cast_wrapper_in_flat[11] = in_flat[205];
assign conditional_wrapper_in_flat[2] = in_flat[206];
...
assign conditional_wrapper_in_flat[8] = in_flat[212];
assign partselect_wrapper_in_flat[0] = in_flat[213];
assign partselect_wrapper_in_flat[1] = in_flat[214];
...
assign partselect_wrapper_in_flat[6] = in_flat[218];
assign partselect_wrapper_in_flat[7] = in_flat[219];
assign partselect_wrapper_in_flat[8] = in_flat[220];
...
assign const_logic_wrapper_in_flat[6] = const_arith_wrapper_out_flat[4];
assign width_struct_wrapper_in_flat[11] = const_arith_wrapper_out_flat[15];
assign const_partselect_wrapper_in_flat[2] = const_arith_wrapper_out_flat[15];
assign const_compare_wrapper_in_flat[1] = const_arith_wrapper_out_flat[18];
assign shift_wrapper_in_flat[7] = const_arith_wrapper_out_flat[20];
assign width_logic_wrapper_in_flat[0] = const_arith_wrapper_out_flat[23];
assign relational_wrapper_in_flat[6] = const_arith_wrapper_out_flat[26];
assign select_wrapper_in_flat[14] = const_arith_wrapper_out_flat[32];
assign const_shift_wrapper_in_flat[3] = const_arith_wrapper_out_flat[39];
assign partselect_wrapper_in_flat[2] = const_arith_wrapper_out_flat[39];
assign select_wrapper_in_flat[12] = const_compare_wrapper_out_flat[4];
assign shift_wrapper_in_flat[9] = const_compare_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[16] = const_concat_repl_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[6];
assign arithmetic_reduce_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[7];
assign bitwise_reduce_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[15];
assign select_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[16];
assign width_struct_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[1];
assign relational_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[8];
assign array_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[14];
assign cast_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[19];
assign partselect_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[19];
assign bitwise_reduce_wrapper_in_flat[7] = const_logic_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[4] = const_logic_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[1] = const_logic_wrapper_out_flat[4];
assign numbers_concat_repl_wrapper_in_flat[5] = const_logic_wrapper_out_flat[8];
assign shift_wrapper_in_flat[2] = const_logic_wrapper_out_flat[16];
assign select_wrapper_in_flat[10] = const_logic_wrapper_out_flat[18];
assign shift_wrapper_in_flat[4] = const_nested_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[0] = const_nested_wrapper_out_flat[2];
assign select_wrapper_in_flat[18] = const_nested_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[10] = const_reduce_wrapper_out_flat[1];
assign select_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[11] = const_shift_wrapper_out_flat[3];
assign width_union_wrapper_in_flat[4] = const_shift_wrapper_out_flat[5];
assign select_wrapper_in_flat[9] = const_shift_wrapper_out_flat[7];
assign width_logic_wrapper_in_flat[1] = const_shift_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[0] = const_shift_wrapper_out_flat[19];
assign const_nested_wrapper_in_flat[23] = const_shift_wrapper_out_flat[21];
assign array_wrapper_in_flat[6] = arithmetic_reduce_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[12] = bitwise_logic_wrapper_out_flat[6];
assign cast_wrapper_in_flat[9] = bitwise_logic_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[17];
assign logical_op_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[21];
assign width_union_wrapper_in_flat[10] = bitwise_reduce_wrapper_out_flat[2];
assign cast_wrapper_in_flat[4] = bitwise_reduce_wrapper_out_flat[2];
assign array_wrapper_in_flat[12] = logical_op_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[14] = logical_op_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[1] = relational_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[1] = relational_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[2] = relational_wrapper_out_flat[3];
assign partselect_wrapper_in_flat[10] = relational_wrapper_out_flat[6];
assign cast_wrapper_in_flat[2] = relational_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[13] = relational_wrapper_out_flat[7];
assign array_wrapper_in_flat[3] = select_wrapper_out_flat[0];
assign shift_wrapper_in_flat[0] = select_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[5] = shift_wrapper_out_flat[7];
assign numbers_concat_repl_wrapper_in_flat[3] = shift_wrapper_out_flat[9];
assign numbers_concat_repl_wrapper_in_flat[0] = cast_wrapper_out_flat[7];
assign width_union_wrapper_in_flat[15] = cast_wrapper_out_flat[8];
assign bitwise_reduce_wrapper_in_flat[3] = conditional_wrapper_out_flat[3];
assign array_wrapper_in_flat[4] = partselect_wrapper_out_flat[1];
assign const_reduce_wrapper_in_flat[1] = partselect_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[19] = partselect_wrapper_out_flat[2];
assign array_wrapper_in_flat[5] = width_enum_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[1] = width_enum_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[2] = width_struct_wrapper_out_flat[4];
assign logical_op_wrapper_in_flat[0] = width_struct_wrapper_out_flat[11];
assign relational_wrapper_in_flat[1] = width_struct_wrapper_out_flat[11];
assign array_wrapper_in_flat[10] = width_union_wrapper_out_flat[10];
assign relational_wrapper_in_flat[4] = width_logic_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[15] = width_logic_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[15];
