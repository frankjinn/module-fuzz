...
assign const_logic_wrapper_in_flat[9] = in_flat[76];
...
assign const_reduce_wrapper_in_flat[3] = in_flat[118];
...
assign select_wrapper_in_flat[0] = in_flat[167];
...
assign shift_wrapper_in_flat[3] = in_flat[184];
assign shift_wrapper_in_flat[4] = in_flat[185];
assign shift_wrapper_in_flat[5] = in_flat[186];
assign shift_wrapper_in_flat[6] = in_flat[187];
assign shift_wrapper_in_flat[7] = in_flat[188];
assign shift_wrapper_in_flat[8] = in_flat[189];
assign shift_wrapper_in_flat[10] = in_flat[190];
assign array_wrapper_in_flat[0] = in_flat[191];
assign array_wrapper_in_flat[1] = in_flat[192];
assign array_wrapper_in_flat[2] = in_flat[193];
assign array_wrapper_in_flat[3] = in_flat[194];
...
assign array_wrapper_in_flat[10] = in_flat[199];
assign array_wrapper_in_flat[11] = in_flat[200];
...
assign cast_wrapper_in_flat[9] = in_flat[210];
...
assign cast_wrapper_in_flat[8] = const_arith_wrapper_out_flat[15];
assign relational_wrapper_in_flat[3] = const_arith_wrapper_out_flat[20];
assign const_conditional_wrapper_in_flat[3] = const_arith_wrapper_out_flat[28];
assign conditional_wrapper_in_flat[5] = const_compare_wrapper_out_flat[0];
assign cast_wrapper_in_flat[3] = const_compare_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[14] = const_compare_wrapper_out_flat[4];
assign width_logic_wrapper_in_flat[6] = const_compare_wrapper_out_flat[5];
assign numbers_concat_repl_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[1];
assign cast_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[17] = const_concat_repl_wrapper_out_flat[9];
assign select_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[10];
assign shift_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[12];
assign arithmetic_reduce_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[12];
assign partselect_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[17];
assign width_union_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[1];
assign relational_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[9];
assign width_struct_wrapper_in_flat[3] = const_logic_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[4] = const_logic_wrapper_out_flat[12];
assign cast_wrapper_in_flat[4] = const_logic_wrapper_out_flat[14];
assign width_union_wrapper_in_flat[5] = const_nested_wrapper_out_flat[6];
assign width_logic_wrapper_in_flat[3] = const_nested_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[12] = const_partselect_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[6];
assign logical_op_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[9] = const_shift_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[12] = const_shift_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[2] = const_shift_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[2] = const_shift_wrapper_out_flat[11];
assign const_logic_wrapper_in_flat[2] = const_shift_wrapper_out_flat[13];
assign conditional_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[4] = arithmetic_reduce_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[29] = arithmetic_reduce_wrapper_out_flat[7];
assign shift_wrapper_in_flat[9] = arithmetic_reduce_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[3] = arithmetic_reduce_wrapper_out_flat[9];
assign partselect_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[4];
...
assign width_struct_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[18] = bitwise_logic_wrapper_out_flat[16];
assign const_shift_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[16];
assign bitwise_reduce_wrapper_in_flat[6] = relational_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[4] = relational_wrapper_out_flat[4];
assign select_wrapper_in_flat[3] = relational_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[1] = select_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[0] = select_wrapper_out_flat[7];
assign cast_wrapper_in_flat[5] = shift_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[2] = shift_wrapper_out_flat[7];
assign relational_wrapper_in_flat[5] = shift_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[22] = shift_wrapper_out_flat[10];
assign const_compare_wrapper_in_flat[20] = shift_wrapper_out_flat[12];
assign select_wrapper_in_flat[17] = array_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[21] = array_wrapper_out_flat[15];
assign bitwise_reduce_wrapper_in_flat[5] = cast_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[21] = cast_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[8] = cast_wrapper_out_flat[7];
assign array_wrapper_in_flat[12] = cast_wrapper_out_flat[11];
assign width_union_wrapper_in_flat[14] = cast_wrapper_out_flat[11];
assign width_enum_wrapper_in_flat[2] = conditional_wrapper_out_flat[0];
assign array_wrapper_in_flat[8] = conditional_wrapper_out_flat[0];
assign numbers_concat_repl_wrapper_in_flat[5] = partselect_wrapper_out_flat[2];
assign cast_wrapper_in_flat[11] = partselect_wrapper_out_flat[6];
assign width_union_wrapper_in_flat[12] = width_enum_wrapper_out_flat[2];
assign shift_wrapper_in_flat[0] = width_struct_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[5] = width_struct_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[4] = width_struct_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[12] = width_struct_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[7] = width_struct_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[0] = width_union_wrapper_out_flat[6];
assign array_wrapper_in_flat[4] = width_logic_wrapper_out_flat[0];
assign select_wrapper_in_flat[4] = width_logic_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[8];
assign const_shift_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[12];
assign arithmetic_reduce_wrapper_in_flat[14] = numbers_concat_repl_wrapper_out_flat[13];
