...
assign const_conditional_wrapper_in_flat[0] = in_flat[44];
...
assign bitwise_logic_wrapper_in_flat[13] = in_flat[148];
...
assign bitwise_reduce_wrapper_in_flat[6] = in_flat[153];
...
assign width_logic_wrapper_in_flat[5] = const_arith_wrapper_out_flat[12];
assign cast_wrapper_in_flat[6] = const_arith_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[14] = const_arith_wrapper_out_flat[22];
assign width_enum_wrapper_in_flat[3] = const_arith_wrapper_out_flat[24];
assign arithmetic_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[26];
assign const_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[28];
assign bitwise_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[30];
assign numbers_concat_repl_wrapper_in_flat[3] = const_arith_wrapper_out_flat[32];
assign const_conditional_wrapper_in_flat[9] = const_arith_wrapper_out_flat[39];
assign bitwise_logic_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[9];
assign select_wrapper_in_flat[13] = const_concat_repl_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[17] = const_concat_repl_wrapper_out_flat[15];
assign width_union_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[19];
assign relational_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[15];
assign partselect_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[16];
assign conditional_wrapper_in_flat[1] = const_nested_wrapper_out_flat[0];
assign cast_wrapper_in_flat[5] = const_nested_wrapper_out_flat[0];
assign width_logic_wrapper_in_flat[6] = const_nested_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[18] = const_nested_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[3] = const_nested_wrapper_out_flat[7];
assign bitwise_logic_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[15] = const_reduce_wrapper_out_flat[2];
assign width_logic_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[3];
assign cast_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[4];
assign width_enum_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[23] = const_shift_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[10] = const_shift_wrapper_out_flat[10];
assign cast_wrapper_in_flat[11] = const_shift_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[4] = const_shift_wrapper_out_flat[14];
assign logical_op_wrapper_in_flat[0] = arithmetic_reduce_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[26] = arithmetic_reduce_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[3] = bitwise_logic_wrapper_out_flat[0];
assign cast_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[5];
assign bitwise_reduce_wrapper_in_flat[1] = bitwise_logic_wrapper_out_flat[12];
assign array_wrapper_in_flat[12] = bitwise_logic_wrapper_out_flat[14];
assign const_logic_wrapper_in_flat[2] = bitwise_logic_wrapper_out_flat[18];
assign const_arith_wrapper_in_flat[7] = bitwise_logic_wrapper_out_flat[23];
assign const_compare_wrapper_in_flat[17] = bitwise_reduce_wrapper_out_flat[1];
assign cast_wrapper_in_flat[1] = bitwise_reduce_wrapper_out_flat[2];
assign shift_wrapper_in_flat[7] = logical_op_wrapper_out_flat[0];
assign relational_wrapper_in_flat[6] = logical_op_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[6] = relational_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[22] = relational_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[4] = select_wrapper_out_flat[2];
...
assign array_wrapper_in_flat[1] = select_wrapper_out_flat[6];
assign bitwise_logic_wrapper_in_flat[0] = select_wrapper_out_flat[7];
assign width_struct_wrapper_in_flat[7] = shift_wrapper_out_flat[0];
assign relational_wrapper_in_flat[7] = shift_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[2] = array_wrapper_out_flat[6];
assign width_enum_wrapper_in_flat[1] = array_wrapper_out_flat[13];
assign arithmetic_reduce_wrapper_in_flat[7] = cast_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[7] = cast_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[7] = cast_wrapper_out_flat[8];
assign conditional_wrapper_in_flat[2] = cast_wrapper_out_flat[9];
assign logical_op_wrapper_in_flat[1] = conditional_wrapper_out_flat[0];
assign shift_wrapper_in_flat[0] = partselect_wrapper_out_flat[1];
assign width_struct_wrapper_in_flat[0] = partselect_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[23] = partselect_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[32] = width_enum_wrapper_out_flat[0];
assign arithmetic_reduce_wrapper_in_flat[14] = width_enum_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[20] = width_struct_wrapper_out_flat[10];
assign array_wrapper_in_flat[16] = width_union_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[10] = width_union_wrapper_out_flat[5];
assign bitwise_logic_wrapper_in_flat[1] = width_union_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[6] = width_union_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[0] = width_union_wrapper_out_flat[13];
assign arithmetic_reduce_wrapper_in_flat[1] = width_logic_wrapper_out_flat[2];
assign conditional_wrapper_in_flat[4] = width_logic_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[0];
assign width_enum_wrapper_in_flat[2] = numbers_concat_repl_wrapper_out_flat[3];
assign shift_wrapper_in_flat[9] = numbers_concat_repl_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[11] = numbers_concat_repl_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[12];
assign bitwise_reduce_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[12];
assign width_struct_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[15];
