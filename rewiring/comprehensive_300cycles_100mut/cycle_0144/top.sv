...
assign const_reduce_wrapper_in_flat[2] = in_flat[118];
...
assign arithmetic_reduce_wrapper_in_flat[3] = in_flat[128];
assign arithmetic_reduce_wrapper_in_flat[4] = in_flat[129];
...
assign logical_op_wrapper_in_flat[1] = in_flat[156];
...
assign width_enum_wrapper_in_flat[0] = in_flat[229];
...
assign arithmetic_reduce_wrapper_in_flat[11] = const_arith_wrapper_out_flat[5];
assign width_enum_wrapper_in_flat[2] = const_arith_wrapper_out_flat[7];
assign select_wrapper_in_flat[0] = const_arith_wrapper_out_flat[22];
assign array_wrapper_in_flat[6] = const_arith_wrapper_out_flat[26];
assign const_nested_wrapper_in_flat[25] = const_arith_wrapper_out_flat[29];
assign const_reduce_wrapper_in_flat[3] = const_arith_wrapper_out_flat[34];
assign width_struct_wrapper_in_flat[6] = const_arith_wrapper_out_flat[39];
assign const_logic_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[13];
assign bitwise_reduce_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[14];
assign logical_op_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[16];
assign const_arith_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[19];
assign cast_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[15] = const_logic_wrapper_out_flat[5];
assign select_wrapper_in_flat[8] = const_logic_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[5] = const_logic_wrapper_out_flat[7];
assign partselect_wrapper_in_flat[1] = const_logic_wrapper_out_flat[8];
assign numbers_concat_repl_wrapper_in_flat[2] = const_logic_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[0] = const_logic_wrapper_out_flat[11];
assign width_struct_wrapper_in_flat[7] = const_logic_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[0] = const_logic_wrapper_out_flat[15];
assign width_enum_wrapper_in_flat[1] = const_nested_wrapper_out_flat[2];
assign select_wrapper_in_flat[6] = const_nested_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[9] = const_nested_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[5];
assign relational_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[1] = const_partselect_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[1] = const_reduce_wrapper_out_flat[0];
assign partselect_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[0];
assign bitwise_logic_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[0];
assign conditional_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[0];
assign shift_wrapper_in_flat[2] = const_reduce_wrapper_out_flat[3];
assign width_logic_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[6] = const_shift_wrapper_out_flat[16];
assign const_compare_wrapper_in_flat[16] = const_shift_wrapper_out_flat[23];
assign shift_wrapper_in_flat[6] = const_shift_wrapper_out_flat[23];
assign cast_wrapper_in_flat[8] = arithmetic_reduce_wrapper_out_flat[2];
assign select_wrapper_in_flat[10] = arithmetic_reduce_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[0] = bitwise_logic_wrapper_out_flat[5];
assign partselect_wrapper_in_flat[8] = bitwise_logic_wrapper_out_flat[13];
assign partselect_wrapper_in_flat[14] = bitwise_reduce_wrapper_out_flat[0];
assign const_arith_wrapper_in_flat[7] = bitwise_reduce_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[19] = bitwise_reduce_wrapper_out_flat[2];
assign partselect_wrapper_in_flat[7] = logical_op_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[6] = logical_op_wrapper_out_flat[0];
assign bitwise_reduce_wrapper_in_flat[1] = logical_op_wrapper_out_flat[1];
assign array_wrapper_in_flat[15] = logical_op_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[4] = logical_op_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[6] = relational_wrapper_out_flat[3];
assign conditional_wrapper_in_flat[7] = select_wrapper_out_flat[3];
assign bitwise_logic_wrapper_in_flat[14] = select_wrapper_out_flat[8];
assign width_struct_wrapper_in_flat[8] = select_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[22] = shift_wrapper_out_flat[1];
assign width_logic_wrapper_in_flat[4] = shift_wrapper_out_flat[9];
assign const_logic_wrapper_in_flat[0] = array_wrapper_out_flat[2];
assign numbers_concat_repl_wrapper_in_flat[1] = array_wrapper_out_flat[11];
assign bitwise_logic_wrapper_in_flat[15] = cast_wrapper_out_flat[2];
assign select_wrapper_in_flat[3] = cast_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[11] = cast_wrapper_out_flat[7];
assign shift_wrapper_in_flat[5] = cast_wrapper_out_flat[8];
assign bitwise_logic_wrapper_in_flat[4] = conditional_wrapper_out_flat[0];
assign relational_wrapper_in_flat[1] = conditional_wrapper_out_flat[1];
assign const_compare_wrapper_in_flat[17] = partselect_wrapper_out_flat[3];
assign relational_wrapper_in_flat[2] = partselect_wrapper_out_flat[7];
assign relational_wrapper_in_flat[6] = width_enum_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[21] = width_enum_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[17] = width_enum_wrapper_out_flat[3];
assign width_struct_wrapper_in_flat[9] = width_enum_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[10] = width_struct_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[13] = width_struct_wrapper_out_flat[3];
assign bitwise_reduce_wrapper_in_flat[5] = width_union_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[5] = width_union_wrapper_out_flat[4];
assign array_wrapper_in_flat[17] = width_union_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[6] = numbers_concat_repl_wrapper_out_flat[4];
assign conditional_wrapper_in_flat[1] = numbers_concat_repl_wrapper_out_flat[5];
assign width_logic_wrapper_in_flat[5] = numbers_concat_repl_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[11];
