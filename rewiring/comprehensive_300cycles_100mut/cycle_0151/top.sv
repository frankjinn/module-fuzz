...
assign const_nested_wrapper_in_flat[13] = const_arith_wrapper_out_flat[0];
assign select_wrapper_in_flat[10] = const_arith_wrapper_out_flat[4];
assign arithmetic_reduce_wrapper_in_flat[12] = const_arith_wrapper_out_flat[10];
assign shift_wrapper_in_flat[5] = const_arith_wrapper_out_flat[19];
assign const_conditional_wrapper_in_flat[19] = const_arith_wrapper_out_flat[19];
assign width_enum_wrapper_in_flat[3] = const_arith_wrapper_out_flat[32];
assign cast_wrapper_in_flat[5] = const_arith_wrapper_out_flat[34];
assign logical_op_wrapper_in_flat[1] = const_compare_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[15] = const_compare_wrapper_out_flat[2];
assign width_struct_wrapper_in_flat[6] = const_compare_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[3] = const_compare_wrapper_out_flat[7];
assign const_shift_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[8];
assign cast_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[17] = const_conditional_wrapper_out_flat[4];
assign select_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[5];
assign arithmetic_reduce_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[13];
assign width_logic_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[15];
assign width_union_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[16];
assign const_reduce_wrapper_in_flat[2] = const_logic_wrapper_out_flat[0];
assign shift_wrapper_in_flat[3] = const_nested_wrapper_out_flat[5];
assign conditional_wrapper_in_flat[4] = const_partselect_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[6];
assign const_concat_repl_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[7];
assign conditional_wrapper_in_flat[6] = const_shift_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[3] = const_shift_wrapper_out_flat[6];
assign partselect_wrapper_in_flat[10] = const_shift_wrapper_out_flat[9];
assign const_shift_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[2];
assign cast_wrapper_in_flat[2] = arithmetic_reduce_wrapper_out_flat[8];
assign array_wrapper_in_flat[14] = arithmetic_reduce_wrapper_out_flat[9];
assign const_concat_repl_wrapper_in_flat[4] = bitwise_logic_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[17] = bitwise_logic_wrapper_out_flat[9];
...
assign const_concat_repl_wrapper_in_flat[2] = logical_op_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[7] = logical_op_wrapper_out_flat[2];
assign bitwise_logic_wrapper_in_flat[4] = relational_wrapper_out_flat[5];
assign shift_wrapper_in_flat[7] = select_wrapper_out_flat[0];
assign width_union_wrapper_in_flat[5] = select_wrapper_out_flat[1];
assign arithmetic_reduce_wrapper_in_flat[7] = select_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[24] = select_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[6] = select_wrapper_out_flat[8];
assign width_enum_wrapper_in_flat[2] = select_wrapper_out_flat[8];
assign arithmetic_reduce_wrapper_in_flat[10] = shift_wrapper_out_flat[4];
assign const_compare_wrapper_in_flat[16] = shift_wrapper_out_flat[7];
assign relational_wrapper_in_flat[3] = shift_wrapper_out_flat[10];
assign array_wrapper_in_flat[3] = shift_wrapper_out_flat[10];
assign bitwise_reduce_wrapper_in_flat[0] = shift_wrapper_out_flat[11];
assign width_enum_wrapper_in_flat[0] = shift_wrapper_out_flat[13];
assign cast_wrapper_in_flat[7] = array_wrapper_out_flat[5];
assign width_struct_wrapper_in_flat[11] = cast_wrapper_out_flat[4];
assign width_union_wrapper_in_flat[11] = cast_wrapper_out_flat[5];
assign relational_wrapper_in_flat[4] = cast_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[9] = cast_wrapper_out_flat[6];
...
assign const_logic_wrapper_in_flat[2] = conditional_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[0] = partselect_wrapper_out_flat[1];
assign conditional_wrapper_in_flat[8] = partselect_wrapper_out_flat[5];
...
assign partselect_wrapper_in_flat[12] = width_enum_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[2] = width_struct_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[4] = width_struct_wrapper_out_flat[4];
assign logical_op_wrapper_in_flat[0] = width_struct_wrapper_out_flat[6];
assign width_struct_wrapper_in_flat[4] = width_union_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[1] = width_union_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[14] = width_union_wrapper_out_flat[10];
assign const_logic_wrapper_in_flat[0] = width_union_wrapper_out_flat[12];
assign const_shift_wrapper_in_flat[10] = width_union_wrapper_out_flat[15];
assign bitwise_logic_wrapper_in_flat[7] = width_logic_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[16] = width_logic_wrapper_out_flat[2];
assign arithmetic_reduce_wrapper_in_flat[9] = width_logic_wrapper_out_flat[2];
assign select_wrapper_in_flat[4] = width_logic_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[8] = width_logic_wrapper_out_flat[4];
assign relational_wrapper_in_flat[0] = numbers_concat_repl_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[13] = numbers_concat_repl_wrapper_out_flat[2];
assign width_union_wrapper_in_flat[3] = numbers_concat_repl_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[12] = numbers_concat_repl_wrapper_out_flat[8];
