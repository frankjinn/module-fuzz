...
assign const_reduce_wrapper_in_flat[1] = in_flat[130];
...
assign const_compare_wrapper_in_flat[12] = const_arith_wrapper_out_flat[18];
assign const_conditional_wrapper_in_flat[23] = const_arith_wrapper_out_flat[23];
assign const_reduce_wrapper_in_flat[0] = const_compare_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[13] = const_compare_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[22] = const_compare_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[21];
assign const_shift_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[5] = const_logic_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[15] = const_logic_wrapper_out_flat[18];
assign const_reduce_wrapper_in_flat[2] = const_nested_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[10] = const_shift_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[8] = const_shift_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[22] = const_shift_wrapper_out_flat[17];
