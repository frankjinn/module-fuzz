...
assign const_nested_wrapper_in_flat[14] = const_arith_wrapper_out_flat[20];
assign const_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[29];
assign const_shift_wrapper_in_flat[6] = const_arith_wrapper_out_flat[31];
assign const_concat_repl_wrapper_in_flat[3] = const_compare_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[1] = const_compare_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[32] = const_concat_repl_wrapper_out_flat[6];
assign const_partselect_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[13];
assign const_concat_repl_wrapper_in_flat[1] = const_logic_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[2] = const_logic_wrapper_out_flat[12];
assign const_compare_wrapper_in_flat[5] = const_nested_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[0] = const_nested_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[6] = const_partselect_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[16] = const_reduce_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[3] = const_reduce_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[16] = const_shift_wrapper_out_flat[19];
assign const_compare_wrapper_in_flat[10] = const_shift_wrapper_out_flat[22];
