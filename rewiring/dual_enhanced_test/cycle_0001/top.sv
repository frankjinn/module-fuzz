...
assign const_nested_wrapper_in_flat[13] = in_flat[101];
assign const_nested_wrapper_in_flat[14] = in_flat[102];
assign const_nested_wrapper_in_flat[15] = in_flat[103];
assign const_nested_wrapper_in_flat[16] = in_flat[104];
assign const_nested_wrapper_in_flat[17] = in_flat[105];
...
assign const_logic_wrapper_in_flat[9] = const_arith_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[7] = const_arith_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[3] = const_arith_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[18] = const_arith_wrapper_out_flat[17];
assign const_conditional_wrapper_in_flat[21] = const_compare_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[11];
assign const_arith_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[15];
assign const_shift_wrapper_in_flat[6] = const_conditional_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[20] = const_logic_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[16] = const_logic_wrapper_out_flat[15];
...
assign const_shift_wrapper_in_flat[9] = const_nested_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[9] = const_nested_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[15] = const_shift_wrapper_out_flat[13];
