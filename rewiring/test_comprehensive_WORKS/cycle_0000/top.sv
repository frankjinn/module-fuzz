...
assign param_wrapper_in_flat[0] = in_flat[287];
assign partselect_wrapper_in_flat[0] = in_flat[288];
assign partselect_wrapper_in_flat[1] = in_flat[289];
assign partselect_wrapper_in_flat[2] = in_flat[290];
assign partselect_wrapper_in_flat[3] = in_flat[291];
assign partselect_wrapper_in_flat[4] = in_flat[292];
assign partselect_wrapper_in_flat[5] = in_flat[293];
assign partselect_wrapper_in_flat[7] = in_flat[294];
assign partselect_wrapper_in_flat[8] = in_flat[295];
assign partselect_wrapper_in_flat[9] = in_flat[296];
assign partselect_wrapper_in_flat[10] = in_flat[297];
assign partselect_wrapper_in_flat[11] = in_flat[298];
assign partselect_wrapper_in_flat[12] = in_flat[299];
assign partselect_wrapper_in_flat[13] = in_flat[300];
assign partselect_wrapper_in_flat[14] = in_flat[301];
assign partselect_wrapper_in_flat[15] = in_flat[302];
assign partselect_wrapper_in_flat[16] = in_flat[303];
assign partselect_wrapper_in_flat[17] = in_flat[304];
assign partselect_wrapper_in_flat[18] = in_flat[305];
assign width_enum_wrapper_in_flat[1] = in_flat[306];
assign width_enum_wrapper_in_flat[2] = in_flat[307];
assign width_enum_wrapper_in_flat[3] = in_flat[308];
assign width_struct_wrapper_in_flat[0] = in_flat[309];
assign width_struct_wrapper_in_flat[1] = in_flat[310];
assign width_struct_wrapper_in_flat[2] = in_flat[311];
assign width_struct_wrapper_in_flat[3] = in_flat[312];
assign width_struct_wrapper_in_flat[4] = in_flat[313];
assign width_struct_wrapper_in_flat[5] = in_flat[314];
assign width_struct_wrapper_in_flat[6] = in_flat[315];
assign width_struct_wrapper_in_flat[7] = in_flat[316];
assign width_struct_wrapper_in_flat[8] = in_flat[317];
assign width_struct_wrapper_in_flat[9] = in_flat[318];
assign width_struct_wrapper_in_flat[10] = in_flat[319];
assign width_struct_wrapper_in_flat[11] = in_flat[320];
assign width_union_wrapper_in_flat[0] = in_flat[321];
assign width_union_wrapper_in_flat[1] = in_flat[322];
assign width_union_wrapper_in_flat[2] = in_flat[323];
assign width_union_wrapper_in_flat[3] = in_flat[324];
assign width_union_wrapper_in_flat[4] = in_flat[325];
assign width_union_wrapper_in_flat[5] = in_flat[326];
assign width_union_wrapper_in_flat[6] = in_flat[327];
assign width_union_wrapper_in_flat[7] = in_flat[328];
assign width_union_wrapper_in_flat[8] = in_flat[329];
assign width_union_wrapper_in_flat[9] = in_flat[330];
assign width_union_wrapper_in_flat[10] = in_flat[331];
assign width_union_wrapper_in_flat[11] = in_flat[332];
assign width_union_wrapper_in_flat[12] = in_flat[333];
assign width_union_wrapper_in_flat[13] = in_flat[334];
assign width_union_wrapper_in_flat[14] = in_flat[335];
assign width_union_wrapper_in_flat[15] = in_flat[336];
assign width_logic_wrapper_in_flat[0] = in_flat[337];
assign width_logic_wrapper_in_flat[1] = in_flat[338];
assign width_logic_wrapper_in_flat[2] = in_flat[339];
assign width_logic_wrapper_in_flat[3] = in_flat[340];
assign width_logic_wrapper_in_flat[4] = in_flat[341];
assign width_logic_wrapper_in_flat[5] = in_flat[342];
assign width_logic_wrapper_in_flat[6] = in_flat[343];
assign width_logic_wrapper_in_flat[7] = in_flat[344];
...
assign arith_wrapper_in_flat[0] = partselect_wrapper_out_flat[3];
