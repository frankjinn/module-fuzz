...
assign const_shift_wrapper_in_flat[5] = const_arith_wrapper_out_flat[19];
assign const_logic_wrapper_in_flat[9] = const_arith_wrapper_out_flat[21];
assign const_conditional_wrapper_in_flat[31] = const_arith_wrapper_out_flat[36];
assign const_arith_wrapper_in_flat[11] = const_compare_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[30] = const_compare_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[16];
assign const_logic_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[15];
assign const_reduce_wrapper_in_flat[2] = const_logic_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[2] = const_logic_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[3] = const_nested_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[10] = const_nested_wrapper_out_flat[6];
...
assign const_logic_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[21] = const_shift_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[12] = const_shift_wrapper_out_flat[18];
