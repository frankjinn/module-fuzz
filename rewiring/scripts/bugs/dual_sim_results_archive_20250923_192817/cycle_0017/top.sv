...
assign const_shift_wrapper_in_flat[2] = const_arith_wrapper_out_flat[35];
assign const_compare_wrapper_in_flat[19] = const_arith_wrapper_out_flat[37];
assign const_conditional_wrapper_in_flat[33] = const_arith_wrapper_out_flat[38];
assign const_nested_wrapper_in_flat[18] = const_compare_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[3] = const_compare_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[8] = const_concat_repl_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[27] = const_concat_repl_wrapper_out_flat[10];
assign const_arith_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[21];
assign const_reduce_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[22] = const_conditional_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[22];
assign const_logic_wrapper_in_flat[7] = const_nested_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[19] = const_partselect_wrapper_out_flat[6];
assign const_logic_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[21] = const_shift_wrapper_out_flat[1];
assign const_conditional_wrapper_in_flat[21] = const_shift_wrapper_out_flat[15];
assign const_partselect_wrapper_in_flat[7] = const_shift_wrapper_out_flat[20];
