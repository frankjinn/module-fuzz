...
assign const_partselect_wrapper_in_flat[0] = const_arith_wrapper_out_flat[29];
assign const_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[33];
assign const_shift_wrapper_in_flat[4] = const_arith_wrapper_out_flat[37];
assign const_nested_wrapper_in_flat[23] = const_compare_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[18] = const_concat_repl_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[16] = const_conditional_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[0] = const_logic_wrapper_out_flat[10];
assign const_conditional_wrapper_in_flat[23] = const_partselect_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[9] = const_reduce_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[16] = const_reduce_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[2] = const_shift_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[3] = const_shift_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[9] = const_shift_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[11] = const_shift_wrapper_out_flat[23];
