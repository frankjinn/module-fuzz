...
assign const_concat_repl_wrapper_in_flat[1] = const_arith_wrapper_out_flat[16];
assign const_shift_wrapper_in_flat[1] = const_arith_wrapper_out_flat[24];
assign const_compare_wrapper_in_flat[13] = const_arith_wrapper_out_flat[29];
assign const_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[37];
assign const_nested_wrapper_in_flat[8] = const_arith_wrapper_out_flat[38];
assign const_partselect_wrapper_in_flat[8] = const_arith_wrapper_out_flat[39];
assign const_logic_wrapper_in_flat[0] = const_compare_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[18] = const_compare_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[18] = const_compare_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[2] = const_logic_wrapper_out_flat[15];
assign const_partselect_wrapper_in_flat[17] = const_logic_wrapper_out_flat[16];
assign const_reduce_wrapper_in_flat[1] = const_nested_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[7] = const_partselect_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[28] = const_partselect_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[29] = const_reduce_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[9] = const_shift_wrapper_out_flat[11];
...
assign const_compare_wrapper_in_flat[21] = const_shift_wrapper_out_flat[23];
