...
assign const_concat_repl_wrapper_in_flat[0] = const_arith_wrapper_out_flat[16];
assign const_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[28];
assign const_nested_wrapper_in_flat[15] = const_arith_wrapper_out_flat[31];
assign const_reduce_wrapper_in_flat[2] = const_compare_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[23] = const_compare_wrapper_out_flat[3];
...
assign const_partselect_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[9];
assign const_arith_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[14];
assign const_nested_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[14];
assign const_partselect_wrapper_in_flat[16] = const_logic_wrapper_out_flat[5];
assign const_shift_wrapper_in_flat[5] = const_logic_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[12] = const_logic_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[3] = const_nested_wrapper_out_flat[2];
assign const_concat_repl_wrapper_in_flat[6] = const_nested_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[17] = const_shift_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[26] = const_shift_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[0] = const_shift_wrapper_out_flat[12];
assign const_conditional_wrapper_in_flat[16] = const_shift_wrapper_out_flat[17];
assign const_concat_repl_wrapper_in_flat[9] = const_shift_wrapper_out_flat[21];
