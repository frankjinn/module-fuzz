...
assign const_compare_wrapper_in_flat[9] = const_arith_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[15] = const_arith_wrapper_out_flat[18];
assign const_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[24];
assign const_logic_wrapper_in_flat[4] = const_arith_wrapper_out_flat[32];
assign const_nested_wrapper_in_flat[1] = const_compare_wrapper_out_flat[1];
assign const_logic_wrapper_in_flat[3] = const_compare_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[1] = const_compare_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[20] = const_concat_repl_wrapper_out_flat[11];
assign const_nested_wrapper_in_flat[26] = const_concat_repl_wrapper_out_flat[19];
assign const_partselect_wrapper_in_flat[16] = const_logic_wrapper_out_flat[2];
...
assign const_conditional_wrapper_in_flat[2] = const_nested_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[21] = const_partselect_wrapper_out_flat[7];
assign const_concat_repl_wrapper_in_flat[8] = const_reduce_wrapper_out_flat[5];
assign const_arith_wrapper_in_flat[2] = const_shift_wrapper_out_flat[14];
assign const_nested_wrapper_in_flat[0] = const_shift_wrapper_out_flat[17];
assign const_compare_wrapper_in_flat[1] = const_shift_wrapper_out_flat[18];
