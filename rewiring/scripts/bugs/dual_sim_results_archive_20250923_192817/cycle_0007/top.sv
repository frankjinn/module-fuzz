...
assign const_concat_repl_wrapper_in_flat[3] = const_arith_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[30];
assign const_nested_wrapper_in_flat[10] = const_compare_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[8];
assign const_partselect_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[14];
assign const_logic_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[16];
assign const_compare_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[14];
assign const_nested_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[21];
assign const_reduce_wrapper_in_flat[3] = const_logic_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[18] = const_logic_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[21] = const_logic_wrapper_out_flat[9];
assign const_nested_wrapper_in_flat[25] = const_logic_wrapper_out_flat[14];
assign const_conditional_wrapper_in_flat[18] = const_logic_wrapper_out_flat[18];
assign const_conditional_wrapper_in_flat[11] = const_partselect_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[0] = const_reduce_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[24] = const_reduce_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[7] = const_shift_wrapper_out_flat[8];
assign const_arith_wrapper_in_flat[13] = const_shift_wrapper_out_flat[15];
