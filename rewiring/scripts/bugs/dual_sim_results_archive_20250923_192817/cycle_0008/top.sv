...
assign const_conditional_wrapper_in_flat[10] = const_arith_wrapper_out_flat[12];
assign const_concat_repl_wrapper_in_flat[5] = const_arith_wrapper_out_flat[25];
assign const_shift_wrapper_in_flat[7] = const_arith_wrapper_out_flat[31];
assign const_nested_wrapper_in_flat[11] = const_arith_wrapper_out_flat[32];
assign const_compare_wrapper_in_flat[23] = const_arith_wrapper_out_flat[36];
assign const_logic_wrapper_in_flat[3] = const_arith_wrapper_out_flat[39];
assign const_shift_wrapper_in_flat[4] = const_compare_wrapper_out_flat[4];
assign const_shift_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[15] = const_logic_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[5] = const_logic_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[22] = const_nested_wrapper_out_flat[2];
assign const_conditional_wrapper_in_flat[20] = const_nested_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[2] = const_nested_wrapper_out_flat[5];
...
assign const_conditional_wrapper_in_flat[25] = const_reduce_wrapper_out_flat[1];
assign const_concat_repl_wrapper_in_flat[7] = const_reduce_wrapper_out_flat[5];
assign const_partselect_wrapper_in_flat[2] = const_shift_wrapper_out_flat[1];
