...
def wrap_mutation_counters(fr) -> Tuple[dict, callable]:
    ...
    # Correct method binding with self parameter
...
def main():
    ...
    ap.add_argument("--verilator-flags", default="--trace -Wno-TIMESCALEMOD -Wno-WIDTHTRUNC", help="Extra flags to pass to Verilator (single string).")
