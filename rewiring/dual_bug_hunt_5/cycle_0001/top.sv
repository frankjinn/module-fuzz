...
assign const_conditional_wrapper_in_flat[25] = in_flat[70];
assign const_conditional_wrapper_in_flat[26] = in_flat[71];
...
assign const_reduce_wrapper_in_flat[0] = const_arith_wrapper_out_flat[11];
assign const_concat_repl_wrapper_in_flat[2] = const_arith_wrapper_out_flat[14];
assign const_conditional_wrapper_in_flat[17] = const_arith_wrapper_out_flat[23];
assign const_logic_wrapper_in_flat[5] = const_arith_wrapper_out_flat[34];
assign const_partselect_wrapper_in_flat[7] = const_arith_wrapper_out_flat[38];
assign const_partselect_wrapper_in_flat[18] = const_compare_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[12] = const_concat_repl_wrapper_out_flat[17];
assign const_compare_wrapper_in_flat[16] = const_concat_repl_wrapper_out_flat[17];
assign const_logic_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[17];
assign const_partselect_wrapper_in_flat[11] = const_conditional_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[16];
assign const_shift_wrapper_in_flat[4] = const_logic_wrapper_out_flat[10];
assign const_reduce_wrapper_in_flat[2] = const_logic_wrapper_out_flat[16];
assign const_shift_wrapper_in_flat[10] = const_nested_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[19] = const_partselect_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[5] = const_reduce_wrapper_out_flat[0];
