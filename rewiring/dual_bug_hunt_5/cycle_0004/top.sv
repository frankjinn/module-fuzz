...
assign const_partselect_wrapper_in_flat[13] = const_arith_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[13];
assign const_shift_wrapper_in_flat[5] = const_arith_wrapper_out_flat[16];
assign const_logic_wrapper_in_flat[0] = const_arith_wrapper_out_flat[31];
assign const_compare_wrapper_in_flat[10] = const_arith_wrapper_out_flat[39];
assign const_arith_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[3];
assign const_shift_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[24] = const_concat_repl_wrapper_out_flat[13];
assign const_arith_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[1];
...
assign const_compare_wrapper_in_flat[20] = const_nested_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[10] = const_partselect_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[14] = const_shift_wrapper_out_flat[4];
