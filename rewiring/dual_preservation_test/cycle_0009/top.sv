...
assign const_concat_repl_wrapper_in_flat[1] = const_arith_wrapper_out_flat[18];
assign const_shift_wrapper_in_flat[0] = const_arith_wrapper_out_flat[36];
assign const_partselect_wrapper_in_flat[4] = const_compare_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[3] = const_concat_repl_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[16];
assign const_concat_repl_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[18] = const_conditional_wrapper_out_flat[8];
...
assign const_partselect_wrapper_in_flat[9] = const_logic_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[3] = const_logic_wrapper_out_flat[14];
...
assign const_concat_repl_wrapper_in_flat[9] = const_shift_wrapper_out_flat[3];
assign const_conditional_wrapper_in_flat[19] = const_shift_wrapper_out_flat[6];
