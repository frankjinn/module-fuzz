...
assign const_shift_wrapper_in_flat[4] = const_arith_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[13] = const_arith_wrapper_out_flat[24];
assign const_compare_wrapper_in_flat[6] = const_arith_wrapper_out_flat[39];
assign const_partselect_wrapper_in_flat[8] = const_compare_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[7];
assign const_arith_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[14];
assign const_shift_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[16];
assign const_partselect_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[17];
assign const_reduce_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[12];
assign const_nested_wrapper_in_flat[24] = const_conditional_wrapper_out_flat[17];
assign const_conditional_wrapper_in_flat[7] = const_logic_wrapper_out_flat[4];
assign const_nested_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[9] = const_partselect_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[17] = const_shift_wrapper_out_flat[14];
assign const_logic_wrapper_in_flat[1] = const_shift_wrapper_out_flat[17];
assign const_compare_wrapper_in_flat[4] = const_shift_wrapper_out_flat[22];
