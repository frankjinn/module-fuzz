...
assign const_partselect_wrapper_in_flat[11] = const_arith_wrapper_out_flat[22];
assign const_compare_wrapper_in_flat[2] = const_arith_wrapper_out_flat[36];
assign const_conditional_wrapper_in_flat[10] = const_compare_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[3] = const_compare_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[6];
...
assign const_compare_wrapper_in_flat[8] = const_partselect_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[21] = const_partselect_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[5];
...
assign const_logic_wrapper_in_flat[7] = const_shift_wrapper_out_flat[2];
