...
assign adder_wrapper_in_flat[2] = in_flat[7];
assign adder_wrapper_in_flat[3] = in_flat[8];

// Internal MTM connections (module-to-module)
assign multiplier_wrapper_in_flat[2] = subtractor_wrapper_out_flat[0];
assign adder_wrapper_in_flat[0] = multiplier_wrapper_out_flat[3];
assign subtractor_wrapper_in_flat[2] = adder_wrapper_out_reg[1];

// External outputs (MTO + MTM wires)
assign out_flat[0] = subtractor_wrapper_out_flat[0];
assign out_flat[1] = subtractor_wrapper_out_flat[1];
assign out_flat[2] = subtractor_wrapper_out_flat[2];
...
assign out_flat[8] = adder_wrapper_out_reg[0];
assign out_flat[9] = adder_wrapper_out_reg[1];
assign out_flat[10] = adder_wrapper_out_reg[2];
