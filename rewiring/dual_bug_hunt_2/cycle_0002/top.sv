...
assign const_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[17];
assign const_shift_wrapper_in_flat[4] = const_arith_wrapper_out_flat[25];
assign const_logic_wrapper_in_flat[4] = const_arith_wrapper_out_flat[26];
assign const_compare_wrapper_in_flat[23] = const_arith_wrapper_out_flat[35];
assign const_concat_repl_wrapper_in_flat[5] = const_compare_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[3] = const_compare_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[2];
assign const_partselect_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[21];
assign const_shift_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[2] = const_logic_wrapper_out_flat[0];
assign const_reduce_wrapper_in_flat[0] = const_logic_wrapper_out_flat[0];
assign const_compare_wrapper_in_flat[21] = const_logic_wrapper_out_flat[11];
assign const_reduce_wrapper_in_flat[3] = const_partselect_wrapper_out_flat[5];
assign const_nested_wrapper_in_flat[4] = const_reduce_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[8] = const_shift_wrapper_out_flat[8];
assign const_nested_wrapper_in_flat[21] = const_shift_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[4] = const_shift_wrapper_out_flat[15];
assign const_concat_repl_wrapper_in_flat[4] = const_shift_wrapper_out_flat[22];
