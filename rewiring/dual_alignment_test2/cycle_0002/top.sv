...
assign const_concat_repl_wrapper_in_flat[4] = const_arith_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[26] = const_arith_wrapper_out_flat[24];
assign const_shift_wrapper_in_flat[4] = const_arith_wrapper_out_flat[37];
assign const_logic_wrapper_in_flat[8] = const_arith_wrapper_out_flat[39];
assign const_conditional_wrapper_in_flat[4] = const_compare_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[8] = const_compare_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[11] = const_concat_repl_wrapper_out_flat[15];
...
assign const_shift_wrapper_in_flat[5] = const_logic_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[19] = const_logic_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[21] = const_logic_wrapper_out_flat[13];
assign const_concat_repl_wrapper_in_flat[1] = const_logic_wrapper_out_flat[17];
assign const_compare_wrapper_in_flat[18] = const_nested_wrapper_out_flat[0];
assign const_partselect_wrapper_in_flat[14] = const_nested_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[3] = const_nested_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[2] = const_partselect_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[5] = const_shift_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[3] = const_shift_wrapper_out_flat[17];
assign const_nested_wrapper_in_flat[25] = const_shift_wrapper_out_flat[18];
assign const_compare_wrapper_in_flat[20] = const_shift_wrapper_out_flat[20];
