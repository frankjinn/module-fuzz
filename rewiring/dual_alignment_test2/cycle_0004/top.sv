...
assign const_logic_wrapper_in_flat[7] = const_arith_wrapper_out_flat[28];
assign const_nested_wrapper_in_flat[5] = const_arith_wrapper_out_flat[36];
assign const_concat_repl_wrapper_in_flat[0] = const_compare_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[8] = const_compare_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[1] = const_compare_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[9] = const_conditional_wrapper_out_flat[10];
assign const_shift_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[16];
assign const_logic_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[21];
assign const_concat_repl_wrapper_in_flat[4] = const_logic_wrapper_out_flat[18];
assign const_partselect_wrapper_in_flat[16] = const_nested_wrapper_out_flat[3];
assign const_logic_wrapper_in_flat[6] = const_nested_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[9] = const_reduce_wrapper_out_flat[0];
...
assign const_reduce_wrapper_in_flat[3] = const_shift_wrapper_out_flat[4];
assign const_arith_wrapper_in_flat[13] = const_shift_wrapper_out_flat[10];
