...
assign const_conditional_wrapper_in_flat[9] = in_flat[55];
...
assign const_nested_wrapper_in_flat[20] = in_flat[105];
assign const_nested_wrapper_in_flat[21] = in_flat[106];
assign const_nested_wrapper_in_flat[22] = in_flat[107];
assign const_nested_wrapper_in_flat[23] = in_flat[108];
assign const_nested_wrapper_in_flat[24] = in_flat[109];
assign const_nested_wrapper_in_flat[25] = in_flat[110];
assign const_nested_wrapper_in_flat[26] = in_flat[111];
assign const_partselect_wrapper_in_flat[0] = in_flat[112];
assign const_partselect_wrapper_in_flat[1] = in_flat[113];
assign const_partselect_wrapper_in_flat[2] = in_flat[114];
assign const_partselect_wrapper_in_flat[3] = in_flat[115];
assign const_partselect_wrapper_in_flat[4] = in_flat[116];
assign const_partselect_wrapper_in_flat[5] = in_flat[117];
assign const_partselect_wrapper_in_flat[6] = in_flat[118];
...
assign const_partselect_wrapper_in_flat[14] = in_flat[125];
assign const_partselect_wrapper_in_flat[15] = in_flat[126];
assign const_partselect_wrapper_in_flat[16] = in_flat[127];
assign const_partselect_wrapper_in_flat[17] = in_flat[128];
assign const_partselect_wrapper_in_flat[18] = in_flat[129];
assign const_reduce_wrapper_in_flat[2] = in_flat[130];
assign const_shift_wrapper_in_flat[0] = in_flat[131];
assign const_shift_wrapper_in_flat[1] = in_flat[132];
assign const_shift_wrapper_in_flat[2] = in_flat[133];
...
assign const_shift_wrapper_in_flat[7] = const_arith_wrapper_out_flat[2];
assign const_logic_wrapper_in_flat[6] = const_arith_wrapper_out_flat[3];
assign const_compare_wrapper_in_flat[4] = const_arith_wrapper_out_flat[38];
assign const_partselect_wrapper_in_flat[12] = const_compare_wrapper_out_flat[7];
assign const_conditional_wrapper_in_flat[25] = const_concat_repl_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[0] = const_concat_repl_wrapper_out_flat[12];
assign const_arith_wrapper_in_flat[10] = const_concat_repl_wrapper_out_flat[18];
assign const_shift_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[20];
assign const_nested_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[20];
assign const_logic_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[4];
assign const_reduce_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[20];
assign const_partselect_wrapper_in_flat[19] = const_logic_wrapper_out_flat[15];
assign const_compare_wrapper_in_flat[16] = const_logic_wrapper_out_flat[16];
assign const_arith_wrapper_in_flat[2] = const_nested_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[3] = const_nested_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[1] = const_shift_wrapper_out_flat[6];
assign const_conditional_wrapper_in_flat[10] = const_shift_wrapper_out_flat[14];
