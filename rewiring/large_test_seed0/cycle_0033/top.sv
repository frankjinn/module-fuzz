...
assign const_reduce_wrapper_in_flat[2] = in_flat[131];
...
assign const_shift_wrapper_in_flat[2] = in_flat[135];
assign const_shift_wrapper_in_flat[3] = in_flat[136];
assign const_shift_wrapper_in_flat[4] = in_flat[137];
assign const_shift_wrapper_in_flat[5] = in_flat[138];
...
assign const_compare_wrapper_in_flat[15] = const_arith_wrapper_out_flat[15];
assign const_shift_wrapper_in_flat[6] = const_arith_wrapper_out_flat[24];
assign const_conditional_wrapper_in_flat[16] = const_compare_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[3] = const_compare_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[9];
assign const_conditional_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[9];
assign const_partselect_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[19];
assign const_arith_wrapper_in_flat[2] = const_logic_wrapper_out_flat[7];
assign const_reduce_wrapper_in_flat[1] = const_nested_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[9] = const_shift_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[19] = const_shift_wrapper_out_flat[13];
assign const_compare_wrapper_in_flat[13] = const_shift_wrapper_out_flat[20];
