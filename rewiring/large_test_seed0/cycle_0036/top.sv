...
assign const_nested_wrapper_in_flat[24] = in_flat[107];
assign const_nested_wrapper_in_flat[25] = in_flat[108];
assign const_nested_wrapper_in_flat[26] = in_flat[109];
assign const_partselect_wrapper_in_flat[0] = in_flat[110];
...
assign const_reduce_wrapper_in_flat[0] = in_flat[126];
...
assign const_shift_wrapper_in_flat[6] = const_arith_wrapper_out_flat[5];
assign const_logic_wrapper_in_flat[1] = const_arith_wrapper_out_flat[10];
assign const_partselect_wrapper_in_flat[1] = const_arith_wrapper_out_flat[11];
assign const_compare_wrapper_in_flat[13] = const_arith_wrapper_out_flat[15];
assign const_conditional_wrapper_in_flat[0] = const_arith_wrapper_out_flat[32];
assign const_logic_wrapper_in_flat[2] = const_compare_wrapper_out_flat[0];
assign const_conditional_wrapper_in_flat[1] = const_compare_wrapper_out_flat[0];
assign const_shift_wrapper_in_flat[10] = const_compare_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[5] = const_concat_repl_wrapper_out_flat[0];
assign const_nested_wrapper_in_flat[9] = const_concat_repl_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[1] = const_concat_repl_wrapper_out_flat[6];
assign const_shift_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[6];
assign const_reduce_wrapper_in_flat[2] = const_conditional_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[4] = const_conditional_wrapper_out_flat[11];
assign const_conditional_wrapper_in_flat[30] = const_logic_wrapper_out_flat[10];
assign const_logic_wrapper_in_flat[0] = const_nested_wrapper_out_flat[2];
assign const_arith_wrapper_in_flat[9] = const_nested_wrapper_out_flat[3];
assign const_partselect_wrapper_in_flat[6] = const_reduce_wrapper_out_flat[5];
assign const_reduce_wrapper_in_flat[3] = const_shift_wrapper_out_flat[16];
assign const_partselect_wrapper_in_flat[10] = const_shift_wrapper_out_flat[22];
