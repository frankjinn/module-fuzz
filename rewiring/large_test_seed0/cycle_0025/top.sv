...
assign const_reduce_wrapper_in_flat[2] = in_flat[125];
assign const_shift_wrapper_in_flat[0] = in_flat[126];
assign const_shift_wrapper_in_flat[1] = in_flat[127];
...
assign const_logic_wrapper_in_flat[8] = const_arith_wrapper_out_flat[20];
assign const_nested_wrapper_in_flat[19] = const_arith_wrapper_out_flat[20];
assign const_concat_repl_wrapper_in_flat[8] = const_arith_wrapper_out_flat[24];
assign const_compare_wrapper_in_flat[17] = const_arith_wrapper_out_flat[28];
assign const_compare_wrapper_in_flat[4] = const_concat_repl_wrapper_out_flat[7];
assign const_logic_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[18] = const_concat_repl_wrapper_out_flat[20];
assign const_partselect_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[21];
assign const_nested_wrapper_in_flat[21] = const_conditional_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[1] = const_conditional_wrapper_out_flat[14];
assign const_compare_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[16];
assign const_arith_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[16];
assign const_compare_wrapper_in_flat[5] = const_logic_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[17] = const_logic_wrapper_out_flat[2];
assign const_reduce_wrapper_in_flat[3] = const_logic_wrapper_out_flat[13];
assign const_nested_wrapper_in_flat[1] = const_logic_wrapper_out_flat[18];
assign const_conditional_wrapper_in_flat[16] = const_shift_wrapper_out_flat[9];
assign const_arith_wrapper_in_flat[9] = const_shift_wrapper_out_flat[12];
assign const_concat_repl_wrapper_in_flat[4] = const_shift_wrapper_out_flat[15];
