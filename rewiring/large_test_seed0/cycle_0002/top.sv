...
assign const_concat_repl_wrapper_in_flat[7] = const_arith_wrapper_out_flat[2];
assign const_compare_wrapper_in_flat[0] = const_arith_wrapper_out_flat[17];
assign const_partselect_wrapper_in_flat[13] = const_arith_wrapper_out_flat[27];
assign const_shift_wrapper_in_flat[6] = const_arith_wrapper_out_flat[32];
assign const_partselect_wrapper_in_flat[10] = const_compare_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[17] = const_concat_repl_wrapper_out_flat[5];
assign const_compare_wrapper_in_flat[20] = const_concat_repl_wrapper_out_flat[7];
assign const_nested_wrapper_in_flat[18] = const_concat_repl_wrapper_out_flat[17];
assign const_logic_wrapper_in_flat[3] = const_conditional_wrapper_out_flat[2];
assign const_shift_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[6];
assign const_arith_wrapper_in_flat[13] = const_conditional_wrapper_out_flat[17];
assign const_compare_wrapper_in_flat[15] = const_conditional_wrapper_out_flat[18];
assign const_shift_wrapper_in_flat[7] = const_logic_wrapper_out_flat[7];
assign const_compare_wrapper_in_flat[17] = const_logic_wrapper_out_flat[9];
assign const_reduce_wrapper_in_flat[2] = const_logic_wrapper_out_flat[17];
assign const_nested_wrapper_in_flat[20] = const_partselect_wrapper_out_flat[5];
assign const_concat_repl_wrapper_in_flat[8] = const_shift_wrapper_out_flat[5];
