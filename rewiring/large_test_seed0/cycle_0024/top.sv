...
assign const_conditional_wrapper_in_flat[13] = const_arith_wrapper_out_flat[3];
assign const_nested_wrapper_in_flat[10] = const_arith_wrapper_out_flat[10];
assign const_reduce_wrapper_in_flat[2] = const_arith_wrapper_out_flat[24];
assign const_compare_wrapper_in_flat[2] = const_arith_wrapper_out_flat[30];
assign const_partselect_wrapper_in_flat[15] = const_arith_wrapper_out_flat[31];
assign const_shift_wrapper_in_flat[0] = const_arith_wrapper_out_flat[38];
assign const_partselect_wrapper_in_flat[10] = const_compare_wrapper_out_flat[3];
assign const_concat_repl_wrapper_in_flat[4] = const_compare_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[7] = const_concat_repl_wrapper_out_flat[9];
assign const_compare_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[10];
assign const_nested_wrapper_in_flat[20] = const_conditional_wrapper_out_flat[10];
assign const_shift_wrapper_in_flat[5] = const_conditional_wrapper_out_flat[19];
assign const_arith_wrapper_in_flat[3] = const_logic_wrapper_out_flat[5];
assign const_conditional_wrapper_in_flat[31] = const_logic_wrapper_out_flat[17];
assign const_concat_repl_wrapper_in_flat[5] = const_nested_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[0] = const_partselect_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[9] = const_shift_wrapper_out_flat[12];
assign const_partselect_wrapper_in_flat[14] = const_shift_wrapper_out_flat[20];
