...
assign const_reduce_wrapper_in_flat[1] = const_arith_wrapper_out_flat[1];
assign const_arith_wrapper_in_flat[4] = const_compare_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[2] = const_concat_repl_wrapper_out_flat[4];
assign const_partselect_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[19];
assign const_shift_wrapper_in_flat[10] = const_conditional_wrapper_out_flat[0];
assign const_logic_wrapper_in_flat[8] = const_conditional_wrapper_out_flat[12];
assign const_concat_repl_wrapper_in_flat[7] = const_conditional_wrapper_out_flat[20];
assign const_concat_repl_wrapper_in_flat[4] = const_logic_wrapper_out_flat[1];
assign const_shift_wrapper_in_flat[9] = const_logic_wrapper_out_flat[7];
assign const_partselect_wrapper_in_flat[12] = const_logic_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[19] = const_nested_wrapper_out_flat[2];
assign const_nested_wrapper_in_flat[23] = const_partselect_wrapper_out_flat[1];
assign const_partselect_wrapper_in_flat[4] = const_shift_wrapper_out_flat[1];
assign const_nested_wrapper_in_flat[3] = const_shift_wrapper_out_flat[8];
assign const_compare_wrapper_in_flat[10] = const_shift_wrapper_out_flat[13];
