...
assign const_conditional_wrapper_in_flat[29] = const_arith_wrapper_out_flat[4];
assign const_concat_repl_wrapper_in_flat[6] = const_arith_wrapper_out_flat[27];
assign const_nested_wrapper_in_flat[1] = const_arith_wrapper_out_flat[34];
assign const_logic_wrapper_in_flat[6] = const_concat_repl_wrapper_out_flat[15];
assign const_nested_wrapper_in_flat[15] = const_concat_repl_wrapper_out_flat[16];
assign const_partselect_wrapper_in_flat[18] = const_conditional_wrapper_out_flat[8];
assign const_reduce_wrapper_in_flat[0] = const_conditional_wrapper_out_flat[13];
assign const_partselect_wrapper_in_flat[4] = const_logic_wrapper_out_flat[4];
assign const_logic_wrapper_in_flat[9] = const_nested_wrapper_out_flat[3];
assign const_reduce_wrapper_in_flat[2] = const_nested_wrapper_out_flat[4];
assign const_conditional_wrapper_in_flat[22] = const_nested_wrapper_out_flat[6];
assign const_compare_wrapper_in_flat[20] = const_partselect_wrapper_out_flat[6];
assign const_nested_wrapper_in_flat[19] = const_shift_wrapper_out_flat[14];
assign const_arith_wrapper_in_flat[11] = const_shift_wrapper_out_flat[16];
assign const_conditional_wrapper_in_flat[28] = const_shift_wrapper_out_flat[23];
assign const_concat_repl_wrapper_in_flat[9] = const_shift_wrapper_out_flat[23];
